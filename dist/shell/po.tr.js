(function(l, e) {
    ...
    "$0 Block Device": [ null, "$0 Blok Device" ],
    "$0 Chunk Size": [ null, "" ],
    "$0 Disks": [ null, "" ],
    "$0 Template": [ null, "" ],
    "$0 bit": [ "$0 bits", "", "" ],
    ...
    "$0 week": [ "$0 weeks", "", "" ],
    "$0 year": [ "$0 years", "", "" ],
    "$0% Free": [ "$0% Free", "Boş", "Boş" ],
    "$0% Used": [ "$0% Used", "Kullanılmış", "Kullanılmış" ],
    "$0, $1 free": [ null, "" ],
    $mtu: [ null, "" ],
    "$name (from $host)": [ null, "" ],
    ...
    "4 KiB": [ null, "" ],
    "4 min": [ null, "" ],
    "40 Minutes": [ null, "40 dakika" ],
    "4th": [ null, "" ],
    "5 Minutes": [ null, "5 dakika" ],
    "5 min": [ null, "" ],
    "5 minutes": [ null, "5 dakika" ],
    "512 KiB": [ null, "" ],
    "5th": [ null, "" ],
    "6 hours": [ null, "6 saat" ],
    "60 Minutes": [ null, "60 dakika" ],
    "64 KiB": [ null, "" ],
    "6th": [ null, "" ],
    "7th": [ null, "" ],
    "8 KiB": [ null, "" ],
    ...
    "A user interface for GNU/Linux servers": [ null, "GNU/Linux sunucular için bir kullanıcı arayüzü" ],
    ARP: [ null, "ARP" ],
    "ARP Monitoring": [ null, "ARP İzleme" ],
    "ARP Ping": [ null, "" ],
    "AWS Elastic Block Store": [ null, "" ],
    "About Cockpit": [ null, "Kokpit Hakkında" ],
    Access: [ null, "Erişim" ],
    "Access Modes": [ null, "Erişim" ],
    "Access Policy": [ null, "" ],
    "Access denied": [ null, "" ],
    "Account Settings": [ null, "Hesap Ayarları" ],
    "Account not available or cannot be edited.": [ null, "" ],
    Accounts: [ null, "" ],
    Activate: [ null, "Aktifleştir" ],
    "Activating $target": [ null, "" ],
    "Activation Key": [ null, "" ],
    Active: [ null, "Aktif" ],
    "Active Backup": [ null, "Aktif Yedekleme" ],
    Actual: [ null, "" ],
    ...
    "Add Disks": [ null, "Disk Ekle" ],
    "Add Group": [ null, "" ],
    "Add Kubernetes Node": [ null, "Kubernetes Düğümleri" ],
    "Add Machine to Dashboard": [ null, "" ],
    "Add Member": [ null, "" ],
    "Add Membership": [ null, "Üyeler" ],
    "Add New Cluster": [ null, "" ],
    "Add New User": [ null, "" ],
    "Add Role": [ null, "Roller" ],
    "Add Storage": [ null, "" ],
    "Add Team": [ null, "" ],
    "Add User": [ null, "" ],
    "Add VLAN": [ null, "" ],
    ...
    "At least one disk is needed.": [ null, "En azından bir disk gerekli" ],
    "At specific time": [ null, "" ],
    "Audit log": [ null, "" ],
    Authenticating: [ null, "Yetkilendiriliyor" ],
    Authentication: [ null, "Yetkilendirme" ],
    "Authentication Failed": [ null, "" ],
    "Authentication required": [ null, "" ],
    Author: [ null, "Yazar" ],
    "Author:": [ null, "" ],
    "Authorized Public SSH Keys": [ null, "Yetkilendirilmiş Açık SSH Anahtarları" ],
    Automatic: [ null, "Otomatik" ],
    "Automatic (DHCP only)": [ null, "Otomatik (Sadece DHCP)" ],
    "Automatic (DHCP)": [ null, "Otomatik (DHCP)" ],
    ...
    "Bad data passed for passwd1 mechanism": [ null, "passwd1 düzeneği için kötü veri geçti" ],
    Balancer: [ null, "" ],
    "Block Device": [ null, "Blok Aygıtı" ],
    "Block device for filesystems": [ null, "" ],
    Blocked: [ null, "Bloklanmış" ],
    Bond: [ null, "Bond" ],
    "Bond Settings": [ null, "" ],
    "Boot ID": [ null, "" ],
    Bridge: [ null, "Köprü" ],
    ...
    "CPU priority": [ null, "CPU önceliği" ],
    "CPU usage:": [ null, "" ],
    Cached: [ null, "Belleklenmiş" ],
    "Can&rsquo;t connect to Docker": [ null, "Docker'a bağlanılamadı" ],
    "Can't delete while unlocked": [ null, "" ],
    Cancel: [ null, "İptal" ],
    "Cannot connect to an unknown machine": [ null, "Bilinmeyen bir makineye bağlanılamıyor" ],
    ...
    Capacity: [ null, "Kapasite" ],
    Carrier: [ null, "Taşıyıcı" ],
    "Ceph Filesystem Mount": [ null, "Dosya sistemi tipi" ],
    "Ceph Monitors": [ null, "Depo" ],
    Change: [ null, "" ],
    "Change Host Name": [ null, "" ],
    "Change Password": [ null, "" ],
    "Change Performance Profile": [ null, "Başarım Profilini Değiştir" ],
    "Change Profile": [ null, "Profil Değiştir" ],
    ...
    "Checking IP": [ null, "IP kontrol ediliyor" ],
    ...
    Cinder: [ null, "" ],
    Claim: [ null, "" ],
    "Claim Name": [ null, "Konteyner İsmi" ],
    ...
    Commit: [ null, "" ],
    "Commit Image": [ null, "" ],
    "Communication with tuned has failed": [ null, "tuned ile iletişim başarısız" ],
    "Compatible with all systems and devices (MBR)": [ null, "" ],
    "Compatible with modern system and hard disks > 2TB (GPT)": [ null, "" ],
    "Computer OU": [ null, "" ],
    Configuration: [ null, "" ],
    Configure: [ null, "Ayarla" ],
    "Configure Flannel networking": [ null, "" ],
    "Configure Kubelet and Proxy": [ null, "" ],
    "Configure storage...": [ null, "" ],
    Configuring: [ null, "Ayarlanıyor" ],
    "Configuring IP": [ null, "IP ayarlanıyor" ],
    Confirm: [ null, "Onayla" ],
    "Confirm New Password": [ null, "Yeni Parolayı Onayla" ],
    "Confirm passphrase": [ null, "Parolayı onayla" ],
    Connect: [ null, "" ],
    "Connect automatically": [ null, "Otomatik bağlan" ],
    "Connecting simultaneously to more than {{ limit }} machines is unsupported.": [ null, "" ],
    "Connecting to Docker": [ null, "Docker'a bağlanılıyor" ],
    "Connecting to OSTree": [ null, "" ],
    "Connecting to the machine": [ null, "Makineye bağlanılıyor" ],
    "Connecting...": [ null, "" ],
    "Connection Error": [ null, "Docker'a bağlanılıyor" ],
    "Connection Error: $0": [ null, "Docker'a bağlanılıyor" ],
    "Connection Settings": [ null, "Hesap Ayarları" ],
    "Connection has timed out.": [ null, "" ],
    "Connection will be lost": [ null, "" ],
    Container: [ null, "Konteyner" ],
    "Container Administrator": [ null, "Konteyner Yöneticisi" ],
    "Container ID": [ null, "" ],
    "Container Name": [ null, "Konteyner İsmi" ],
    "Container Runtime Version": [ null, "" ],
    "Container is currently marked as not running, but regular stopping failed.": [ null, "" ],
    "Container is currently running.": [ null, "Konteyner şu an çalışıyor." ],
    "Container:": [ null, "" ],
    Containers: [ null, "Konteynerler" ],
    Content: [ null, "İçerik" ],
    Control: [ null, "" ],
    "Could not add all disks": [ null, "" ],
    "Could not contact {{host}}": [ null, "" ],
    "Could not list services": [ null, "Servisler listelenemedi" ],
    "Could not reset the storage pool": [ null, "" ],
    "Couldn't change user groups": [ null, "Kullanıcı kümeleri değiştirilemedi" ],
    "Couldn't change user password": [ null, "Kullanıcı parolası değiştirilemedi" ],
    ...
    "Couldn't connect to the machine": [ null, "Makineye bağlanılamadı" ],
    "Couldn't create new users": [ null, "Yeni kullanıcılar oluşturulamadı" ],
    ...
    "Couldn't list local users": [ null, "Yerel kullanıcılar listelenemedi" ],
    "Couldn't list users": [ null, "Kullanıcılar listelenemedi" ],
    "Couldn't load user data": [ null, "Kullanıcı verisi yüklenemedi" ],
    Create: [ null, "Yarat" ],
    "Create Logical Volume": [ null, "Mantıksal Bölümü Yeniden İsimlendir" ],
    "Create New Account": [ null, "Yeni Hesap Yarat" ],
    "Create Partition": [ null, "" ],
    "Create RAID Device": [ null, "RAID Yarat" ],
    "Create Snapshot": [ null, "" ],
    "Create Thin Volume": [ null, "" ],
    "Create Timer": [ null, "" ],
    "Create Timers": [ null, "" ],
    "Create Volume Group": [ null, "Volume Grubu Yarat" ],
    ...
    "Current boot": [ null, "" ],
    Custom: [ null, "Özel" ],
    "Custom (Enter filesystem type)": [ null, "Özel (Dosya sistemi tipi girin)" ],
    "Custom URL": [ null, "" ],
    "DISK IS FAILING": [ null, "DİSK BOZULUYOR" ],
    DNS: [ null, "DNS" ],
    "DNS $val": [ null, "" ],
    "DNS Policy": [ null, "" ],
    "DNS Search Domains": [ null, "DNS Search Domains" ],
    "DNS Search Domains $val": [ null, "" ],
    Dashboard: [ null, "" ],
    "Data Used": [ null, "" ],
    Deactivate: [ null, "Deaktifleştir" ],
    Deactivating: [ null, "Deaktif ediliyor" ],
    "Deactivating $target": [ null, "" ],
    Default: [ null, "Ön tanımlı" ],
    Delay: [ null, "Gecikme" ],
    Delete: [ null, "Sil" ],
    "Delete $0": [ null, "Sil: $0" ],
    "Delete '{{ name }}'": [ null, "" ],
    "Delete Files": [ null, "Dosyaları Sil" ],
    "Delete Node": [ null, "Sil" ],
    "Delete Persistent Volume": [ null, "" ],
    "Delete Persistent Volume Claim": [ null, "" ],
    "Delete Project": [ null, "Dosyaları Sil" ],
    "Delete Selected": [ null, "Dosyaları Sil" ],
    ...
    "Deleting a RAID device will erase all data on it.": [ null, "Bir RAID cihazını silmek üstündeki tüm veriyi silecektir." ],
    "Deleting a container will erase all data in it.": [ null, "Bir konteyneri silmek içindeki veriyi de silecektir." ],
    ...
    Deploy: [ null, "Devreye Al" ],
    "Deploy Application": [ null, "Uygulamayı Devreye Al" ],
    ...
    Directory: [ null, "" ],
    Disable: [ null, "" ],
    "Disable tuned": [ null, "tuned'i devre dışı bırak" ],
    Disabled: [ null, "Etkin değil" ],
    Disconnected: [ null, "Bağlantı kesildi" ],
    Disk: [ null, "Diskler" ],
    "Disk I/O": [ null, "" ],
    "Disk Utilization: $0%": [ null, "" ],
    "Disk is OK": [ null, "Disk durumu iyi" ],
    Disks: [ null, "Diskler" ],
    ...
    "Docker is not installed or activated on the system": [ null, "Docker sistemde yüklü ya da aktif değil" ],
    Domain: [ null, "" ],
    ...
    "Don't Repeat": [ null, "" ],
    "Don't overwrite existing data": [ null, "Mevcut verinin üstüne yazma" ],
    ...
    Enabled: [ null, "" ],
    "Encrypted EXT4 (LUKS)": [ null, "Şifreli EXT4 (LUKS)" ],
    "Encrypted XFS (LUKS)": [ null, "Şifreli XFS (LUKS)" ],
    Encryption: [ null, "" ],
    "Encryption Options": [ null, "Şifreleme seçenekleri" ],
    Endpoint: [ null, "" ],
    "Endpoint Name": [ null, "" ],
    Endpoints: [ null, "" ],
    Ends: [ null, "" ],
    "Enforce policy:": [ null, "" ],
    "Enter IP address or host name": [ null, "IP adresi ya da ana makine adı gir" ],
    ...
    "Error message from Docker:": [ null, "Docker'dan hata mesajı:" ],
    "Error saving authorized keys: ": [ null, "Yetkilendirilmiş anahtarın kaydedilmesinde hata:" ],
    "Error while connecting.": [ null, "Bağlanırken hata." ],
    "Error while deleting alert: $0": [ null, "" ],
    "Error while setting SELinux mode: '$0'": [ null, "SELinux kipi belirlenirken hata: '$0'" ],
    "Error writing kubectl config": [ null, "" ],
    Errors: [ null, "" ],
    "Ethernet MTU": [ null, "" ],
    Ethtool: [ null, "" ],
    Everything: [ null, "" ],
    "Excellent password": [ null, "Mükemmel Parola" ],
    ...
    FAILED: [ null, "OLMADI" ],
    Failed: [ null, "" ],
    "Failed to add machine: $0": [ null, "Makine ekleme başarısız: $0" ],
    "Failed to change password": [ null, "Parola değişimi başarısız oldu" ],
    "Failed to delete alert: $0": [ null, "" ],
    "Failed to disable tuned": [ null, "tuned'i devre dışı bırakma başarısız" ],
    "Failed to disable tuned profile": [ null, "tuned profilini devre dışı bırakma başarısız" ],
    "Failed to edit machine: $0": [ null, "Makine düzenleme başarısız:  $0" ],
    "Failed to enable tuned": [ null, "tuned'i etkinleştirme başarısız" ],
    "Failed to load authorized keys.": [ null, "Yetkilendirilmiş anahtarların yüklemesi başarısız oldu." ],
    ...
    "Filesystem Type": [ null, "Dosya sistemi tipi" ],
    "Filesystem type": [ null, "Dosya sistemi tipi" ],
    Filesystems: [ null, "Dosya Sistemleri" ],
    Fingerprint: [ null, "" ],
    Flex: [ null, "" ],
    Flocker: [ null, "kilitlendi" ],
    "Flocker Dataset Name": [ null, "" ],
    "Force Delete": [ null, "Zorla Sil" ],
    "Force Restart": [ null, "" ],
    "Force Shut Down": [ null, "" ],
    Format: [ null, "Biçimlendir" ],
    "Format $0": [ null, "" ],
    "Format Disk $0": [ null, "" ],
    "Formatting a disk will erase all data on it.": [ null, "Bir diski biçimlendirmek üstünde yer alan veriyi silecektir." ],
    "Formatting a storage device will erase all data on it.": [ null, "" ],
    "Forward delay $forward_delay": [ null, "" ],
    Free: [ null, "Boş" ],
    "Free Space": [ null, "" ],
    Friday: [ null, "" ],
    "Full Name": [ null, "Tam İsim" ],
    "GCE Persistent Disk": [ null, "" ],
    "Gateway:": [ null, "" ],
    General: [ null, "Genel" ],
    "Generating report": [ null, "" ],
    "Get new image": [ null, "" ],
    "Git Repository": [ null, "Depo" ],
    "Gluster FS": [ null, "" ],
    GlusterFS: [ null, "" ],
    "Go to": [ null, "" ],
    "Go to now": [ null, "Şimdiye git" ],
    "Good Signature": [ null, "" ],
    "Grant additional push or admin access to specific members below.": [ null, "" ],
    "Group Members": [ null, "Üyeler" ],
    ...
    Hours: [ null, "" ],
    "I/O Wait": [ null, "I/O Beklemesi" ],
    "ID:": [ null, "" ],
    IP: [ null, "" ],
    "IP Address": [ null, "" ],
    "IP Address:": [ null, "Adres" ],
    "IP Prefix Length:": [ null, "Ön ek uzunluğu" ],
    "IP Settings": [ null, "" ],
    IPv4: [ null, "IPv4" ],
    "IPv4 Settings": [ null, "IPv4 Ayarları" ],
    IPv6: [ null, "IPv6" ],
    "IPv6 Settings": [ null, "IPv6 Ayarları" ],
    ISCSI: [ null, "" ],
    Id: [ null, "" ],
    "Id $id": [ null, "" ],
    "Id:": [ null, "" ],
    ...
    Ignore: [ null, "Yoksay" ],
    Image: [ null, "Kalıp" ],
    "Image $0": [ null, "Kalıp $0" ],
    "Image ID": [ null, "" ],
    "Image Name": [ null, "Kalıp $0" ],
    "Image Registry": [ null, "" ],
    "Image Search": [ null, "" ],
    "Image Stream": [ null, "" ],
    "Image commands": [ null, "" ],
    ...
    Instantiate: [ null, "" ],
    Interface: [ null, "Arayüzler" ],
    Interfaces: [ null, "Arayüzler" ],
    "Internal error": [ null, "" ],
    "Invalid Signature": [ null, "" ],
    "Invalid credentials": [ null, "" ],
    "Invalid date format": [ null, "Geçersiz tarih biçimi" ],
    "Invalid date format and invalid time format": [ null, "Geçersiz tarih ve geçersiz zaman biçimi" ],
    "Invalid date format.": [ null, "" ],
    "Invalid file permissions": [ null, "Geçersiz dosya izinleri" ],
    "Invalid key": [ null, "Geçersiz anahtar" ],
    "Invalid number.": [ null, "" ],
    "Invalid port": [ null, "Geçersiz port" ],
    "Invalid time format": [ null, "Geçersiz zaman biçimi" ],
    ...
    Kernel: [ null, "Çekirdek" ],
    "Kernel Version": [ null, "Sürüm" ],
    "Key Ring Path": [ null, "" ],
    "Kubelet Version": [ null, "" ],
    "Kubernetes Cluster": [ null, "Kubernetes kümesi" ],
    "LACP Key": [ null, "" ],
    Labels: [ null, "Etiketler" ],
    "Last 24 hours": [ null, "" ],
    "Last 7 days": [ null, "" ],
    "Last Heartbeat": [ null, "" ],
    "Last Login": [ null, "Son Giriş" ],
    ...
    "Local Disks": [ null, "" ],
    Lock: [ null, "Kilitle" ],
    "Lock Account": [ null, "Hesabı Kilitle" ],
    "Locking $target": [ null, "" ],
    "Log In": [ null, "" ],
    "Log in again": [ null, "" ],
    "Log in to {{host}}": [ null, "" ],
    ...
    "Log messages": [ null, "" ],
    "Log out": [ null, "Çıkış Yap" ],
    "Logged In": [ null, "Giriş Yapıldı" ],
    "Logical Unit Number": [ null, "Mantıksal Bölüm" ],
    "Logical Volume": [ null, "Mantıksal Bölüm" ],
    ...
    Logs: [ null, "" ],
    "Lost connection. Trying to reconnect": [ null, "Bağlantı koptu. Tekrar bağlanmaya çalışıyor" ],
    "MAC Address:": [ null, "Adres" ],
    "MII (Recommended)": [ null, "" ],
    MTU: [ null, "" ],
    "MTU must be a positive number": [ null, "Boyut belirtilmeli" ],
    "Machine ID": [ null, "" ],
    "Machine SSH Key Fingerprints": [ null, "" ],
    Machines: [ null, "Makineler" ],
    Manifest: [ null, "" ],
    Manual: [ null, "Elle" ],
    Manually: [ null, "Elle" ],
    ...
    "Memory limit": [ null, "Bellek limiti" ],
    "Memory usage:": [ null, "" ],
    "Memory:": [ null, "" ],
    Message: [ null, "" ],
    "Message to logged in users": [ null, "Giriş yapmış kullanıcılara mesaj" ],
    Metadata: [ null, "" ],
    "Metadata Used": [ null, "" ],
    MiB: [ null, "" ],
    ...
    Monday: [ null, "" ],
    "Monitoring Interval": [ null, "İzleme Sıklığı" ],
    "Monitoring Targets": [ null, "İzleme Hedefleri" ],
    Monitors: [ null, "ARP İzleme" ],
    More: [ null, "Daha fazla" ],
    Mount: [ null, "Bağla" ],
    "Mount Location": [ null, "Bağlama Seçenekleri" ],
    "Mount Options": [ null, "Bağlama Seçenekleri" ],
    "Mount Point": [ null, "Bağlama Noktası" ],
    "Mount container volumes": [ null, "" ],
    "Mounted At": [ null, "" ],
    Mounting: [ null, "" ],
    "Mounting $target": [ null, "" ],
    NFS: [ null, "DNS" ],
    "NFS Mount": [ null, "Bağla" ],
    "NSNA Ping": [ null, "" ],
    "NTFS - Compatible with most systems": [ null, "NTFS - Çoğu sistemle uyumlu" ],
    "NTP Server": [ null, "" ],
    Name: [ null, "İsim" ],
    ...
    Never: [ null, "Asla" ],
    "New Group": [ null, "" ],
    "New Password": [ null, "Yeni Parola" ],
    "New Project": [ null, "" ],
    "New image stream": [ null, "" ],
    "New password was not accepted": [ null, "Yeni parola kabul edilmedi" ],
    "New project": [ null, "" ],
    Next: [ null, "Sonraki" ],
    "Next Run": [ null, "Sonraki" ],
    Nice: [ null, "Nice" ],
    No: [ null, "Hayır" ],
    "No Delay": [ null, "Gecikme yok" ],
    "No Deployments": [ null, "" ],
    "No Filesystem": [ null, "Dosya sistemi yok" ],
    ...
    "No host keys found.": [ null, "Bulunamadı" ],
    ...
    "No real name specified": [ null, "Gerçek ad belirtilmedi" ],
    ...
    "No such file or directory": [ null, "Böyle bir dosya ya da dizin yok" ],
    "No user name specified": [ null, "Kullanıcı adı belirtilmedi" ],
    "No users are present.": [ null, "Kullanıcı adı belirtilmedi" ],
    "No volume groups created": [ null, "" ],
    "No volumes are present.": [ null, "" ],
    "No volumes in use": [ null, "" ],
    Node: [ null, "Düğüm" ],
    Nodes: [ null, "Düğümler" ],
    "Nodes are the machines that run your containers.": [ null, "Düğümler, konteynerlerinizi çalıştıran makinelerdir." ],
    None: [ null, "Hiçbiri" ],
    "Not Ready": [ null, "Hazır değil" ],
    "Not a valid number of replicas": [ null, "" ],
    "Not a valid private key": [ null, "Geçerli bir özel anahtar değil" ],
    "Not a valid value for Host": [ null, "" ],
    "Not authorized to access Docker on this system": [ null, "Bu sistem üzerinde Docker'e erişim yetkisi yok" ],
    "Not authorized to update software on this system": [ null, "" ],
    "Not available": [ null, "" ],
    "Not connected": [ null, "Bağlı değil" ],
    "Not deployed": [ null, "" ],
    "Not deployed        ": [ null, "" ],
    "Not found": [ null, "Bulunamadı" ],
    "Not permitted to perform this action.": [ null, "" ],
    "Not running": [ null, "Çalışmıyor" ],
    ...
    "OS $0 not found": [ null, "" ],
    "OS Type:": [ null, "" ],
    "OS Versions": [ null, "Sürüm" ],
    "OSTree is not available on this system": [ null, "" ],
    "Occurred $0": [ null, "" ],
    "Occurred between $0 and $1": [ null, "" ],
    Off: [ null, "Kapalı" ],
    Ok: [ null, "" ],
    "Old Password": [ null, "Eski Parola" ],
    "Old password not accepted": [ null, "Eski parola kabul edilmedi" ],
    On: [ null, "Açık" ],
    "On Failure": [ null, "" ],
    "On failure, retry $0 time": [ "On failure, retry $0 times", "", "" ],
    "One Time Password": [ null, "Tek Seferlik Parola" ],
    ...
    Options: [ null, "Seçenekler" ],
    Organization: [ null, "" ],
    "Other Devices": [ null, "Diğer Aygıtlar" ],
    Overview: [ null, "Servis" ],
    "Overwrite existing data with zeros": [ null, "Mevcut veriyi sıfırlarla tekrar yaz" ],
    "PD Name": [ null, "İsim" ],
    Packages: [ null, "" ],
    Parent: [ null, "Ana" ],
    "Parent $parent": [ null, "" ],
    "Part of ": [ null, "Parçası: " ],
    Partition: [ null, "" ],
    Partitioning: [ null, "" ],
    Passive: [ null, "" ],
    Passphrase: [ null, "Parola" ],
    "Passphrase cannot be empty": [ null, "" ],
    "Passphrases do not match": [ null, "Parolalar eşleşmiyor" ],
    Password: [ null, "Parola" ],
    "Password is not acceptable": [ null, "Parola kabul edilebilir değil" ],
    "Password is too weak": [ null, "Parola çok güçsüz" ],
    "Password not accepted": [ null, "Parola kabul edilmedi" ],
    ...
    "Please provide a valid address": [ null, "Bir adres girin" ],
    ...
    "Please provide a valid name": [ null, "Bir adres girin" ],
    ...
    "Please provide a valid target": [ null, "Bir adres girin" ],
    ...
    "Please type an address": [ null, "Bir adres girin" ],
    Pod: [ null, "Pod" ],
    "Pod Address": [ null, "" ],
    "Pod Endpoints": [ null, "" ],
    "Pod Replicated": [ null, "" ],
    ...
    Ports: [ null, "Portlar" ],
    "Ports:": [ null, "" ],
    "Power Options": [ null, "Güç Seçenekleri" ],
    "Prefix length": [ null, "Ön ek uzunluğu" ],
    "Prefix length or Netmask": [ null, "Ön ek uzunluğu ya da ağ maskesi" ],
    Preparing: [ null, "Hazırlanıyor" ],
    Preset: [ null, "" ],
    "Preset Forcefully": [ null, "" ],
    "Pretty Host Name": [ null, "" ],
    Primary: [ null, "Öncelikli" ],
    Priority: [ null, "Öncelik" ],
    "Priority $priority": [ null, "Öncelik $priority" ],
    ...
    "RAID Device": [ null, "RAID Aygıtı" ],
    "RAID Device $0": [ null, "" ],
    "RAID Devices": [ null, "RAID Aygıtları" ],
    "RAID Level": [ null, "RAID Level" ],
    "RAID Member": [ null, "" ],
    "Rados Block Device": [ null, "Blok Aygıtı" ],
    "Read Only": [ null, "Hazır" ],
    "Read and write from a single node": [ null, "" ],
    "Read and write from multiple nodes": [ null, "" ],
    "Read only from multiple nodes": [ null, "" ],
    ReadOnly: [ null, "Hazır" ],
    ReadWrite: [ null, "Okunuyor" ],
    Reading: [ null, "Okunuyor" ],
    Ready: [ null, "Hazır" ],
    "Real Host Name": [ null, "Gerçek Host İsmi" ],
    ...
    Register: [ null, "" ],
    "Register New Volume": [ null, "Mantıksal Bölümü Yeniden Boyurlandır" ],
    ...
    "Remote;Administration;": [ null, "Uzak;Yönetim;" ],
    Removals: [ null, "" ],
    Remove: [ null, "Kaldır" ],
    "Remove $0": [ null, "" ],
    "Remove Group": [ null, "Kaldır" ],
    "Remove Member": [ null, "RAID Üyesi" ],
    "Remove Role": [ null, "Kaldır" ],
    "Remove User": [ null, "Kaldır" ],
    ...
    Rename: [ null, "Yeniden İsimlendir" ],
    ...
    "Repeat Yearly": [ null, "" ],
    Replicas: [ null, "" ],
    "Replication Controller": [ null, "Replikasyon Kontrolörü" ],
    "Replication Controllers": [ null, "Replikasyon Kontrolörleri" ],
    "Replication controllers dynamically create instances of pods from templates, and remove pods when necessary.": [ null, "" ],
    Repository: [ null, "Depo" ],
    "Repository URL": [ null, "Depo" ],
    Requested: [ null, "" ],
    Requests: [ null, "" ],
    "Requires Authentication": [ null, "Yetkilendirme" ],
    Reset: [ null, "" ],
    "Reset Storage Pool": [ null, "" ],
    "Resetting the storage pool will erase all containers and release disks in the pool.": [ null, "" ],
    Resize: [ null, "Yeniden Boyutlandır" ],
    "Resize Filesystem": [ null, "Dosya Sistemini Yeniden Boyutlandır" ],
    "Resize Logical Volume": [ null, "Mantıksal Bölümü Yeniden Boyurlandır" ],
    "Resizing $target": [ null, "" ],
    Restart: [ null, "Yeniden başlat" ],
    "Restart Count": [ null, "" ],
    "Restart Policy": [ null, "" ],
    "Restart Policy:": [ null, "" ],
    Retain: [ null, "" ],
    ...
    Route: [ null, "Yönlendirmeler" ],
    Routes: [ null, "Yönlendirmeler" ],
    Run: [ null, "" ],
    "Run Image": [ null, "" ],
    Runner: [ null, "" ],
    Running: [ null, "Çalışıyor" ],
    ...
    "STP Priority": [ null, "STP Önceliği" ],
    Saturday: [ null, "" ],
    Save: [ null, "" ],
    ...
    Seconds: [ null, "" ],
    Secret: [ null, "" ],
    "Secret File": [ null, "Aygıt dosyası" ],
    "Secret Name": [ null, "Kullanıcı Adı" ],
    "Secret Volume": [ null, "Volume Grubu Yarat" ],
    "Secure Shell Keys": [ null, "" ],
    "Securely erasing $target": [ null, "" ],
    Select: [ null, "" ],
    "Select Manifest File...": [ null, "" ],
    "Select an object to see more details.": [ null, "Daha fazla ayrıntı için bir obje seçin." ],
    "Select the users that you would like to be synchronized with {{#strong}}{{host}}{{/strong}}": [ null, "" ],
    Sending: [ null, "" ],
    Server: [ null, "Servis" ],
    "Server Address": [ null, "" ],
    "Server Administrator": [ null, "Sunucu Yöneticisi" ],
    ...
    Set: [ null, "" ],
    "Set Host name": [ null, "Host ismi ayarla" ],
    "Set Password": [ null, "Parola Belirle" ],
    "Set Time": [ null, "Zamanı Ayarla" ],
    "Set container environment variables": [ null, "" ],
    "Set to": [ null, "Zamanı Ayarla" ],
    "Setting deviates from the configured state and will revert on the next boot.": [ null, "" ],
    "Setting up loop device $target": [ null, "" ],
    "Share Name": [ null, "Kullanıcı Adı" ],
    Shared: [ null, "Paylaşılan" ],
    "Shared: Allow any authenticated user to pull images": [ null, "" ],
    Shell: [ null, "" ],
    "Show all Containers": [ null, "Konteynerler" ],
    "Show all Deployment Configs": [ null, "" ],
    "Show all Nodes": [ null, "" ],
    "Show all Persistent Volumes": [ null, "" ],
    "Show all Pod Containers": [ null, "Konteynerler" ],
    "Show all Pods": [ null, "" ],
    "Show all Projects": [ null, "" ],
    "Show all Replication Controllers": [ null, "Replikasyon Kontrolörleri" ],
    "Show all Routes": [ null, "" ],
    "Show all Services": [ null, "Servisler" ],
    ...
    "Size must be a number": [ null, "Boyut belirtilmeli" ],
    ...
    Spare: [ null, "Yedek" ],
    "Specific Time": [ null, "Özel Bir Zamanda" ],
    Start: [ null, "Başlat" ],
    "Start Docker": [ null, "Docker'ı Başlat" ],
    ...
    Stop: [ null, "Durdur" ],
    "Stop Scrubbing": [ null, "" ],
    Stopped: [ null, "Durduruldu" ],
    "Stopping RAID Device $target": [ null, "" ],
    "Stopping swapspace $target": [ null, "" ],
    Storage: [ null, "Depolama" ],
    "Storage Log": [ null, "" ],
    "Storage Logs": [ null, "" ],
    "Storage pool": [ null, "Depolama" ],
    "Store Performance Data": [ null, "" ],
    "Store passphrase": [ null, "Parolayı sakla" ],
    "Stored Passphrase": [ null, "Saklı Parolalar" ],
    "Stored passphrase": [ null, "" ],
    Strategy: [ null, "" ],
    Subscriptions: [ null, "" ],
    Sunday: [ null, "" ],
    Swap: [ null, "" ],
    "Swap Used": [ null, "Kullanılan Swap" ],
    "Switch off $0": [ null, "" ],
    "Switch on $0": [ null, "" ],
    ...
    "The address contains invalid characters": [ null, "Adres geçersiz karakterler içeriyor" ],
    ...
    "The key you provided was not valid.": [ null, "Sağladığınız anahtar geçerli değil." ],
    "The last physical volume of a volume group cannot be removed.": [ null, "" ],
    "The machine is restarting": [ null, "Makine yeniden başlatılıyor" ],
    ...
    "The passwords do not match": [ null, "Parolalar eşleşmişyor" ],
    "The passwords do not match.": [ null, "Parolalar uyuşmuyor." ],
    ...
    "The user <b>$0</b> is not permitted to modify accounts": [ null, "<b>$0</b> kullanıcısı hesapları düzenlemek için yetkili değil" ],
    ...
    "There are no authorized public keys for this account.": [ null, "Bu hesap için yetkilendirilmiş açık anahtar yok." ],
    ...
    "This machine has already been added.": [ null, "Bu makine zaten eklenmiş." ],
    "This may take a while": [ null, "Bu biraz zaman alabilir" ],
    ...
    "This system is using a custom profile": [ null, "Bu sistem özel profil kullanıyor" ],
    "This system is using the recommended profile": [ null, "Bu sistem önerilen profili kullanıyor" ],
    ...
    "This user name already exists": [ null, "Böyle bir kullanıcı adı zaten var" ],
    ...
    "Try Restart": [ null, "" ],
    "Try again": [ null, "Tekrar Dene" ],
    "Try to reconnect": [ null, "" ],
    "Trying to synchronize with {{Server}}": [ null, "" ],
    Tuesday: [ null, "" ],
    "Tuned has failed to start": [ null, "Tuned başlatılırken başarısız oldu" ],
    "Tuned is not available": [ null, "Tuned uygun değil" ],
    "Tuned is not running": [ null, "Tuned çalışmıyor" ],
    "Tuned is off": [ null, "Tuned kapalı" ],
    Type: [ null, "Tip" ],
    ...
    "Unable to delete root account": [ null, "Kök hesabı silinemiyor" ],
    ...
    "Unable to rename root account": [ null, "Kök hesabı yeniden adlandırılamıyor" ],
    "Unable to run fix: %0": [ null, "" ],
    "Unable to start setroubleshootd": [ null, "setroubleshootd başlatılamıyor" ],
    Unavailable: [ null, "" ],
    "Unexpected error": [ null, "Beklenmeyen hata" ],
    Unknown: [ null, "Bilinmiyor" ],
    'Unknown "$0"': [ null, "" ],
    "Unknown ($0)": [ null, "Bilinmiyor ($)" ],
    "Unknown Host Key": [ null, "" ],
    "Unknown configuration": [ null, "Bilinmeyen konfigrasyon" ],
    "Unknown host name": [ null, "" ],
    "Unless Stopped": [ null, "Durduruldu" ],
    Unlock: [ null, "Kilidi Aç" ],
    "Unlock Key": [ null, "" ],
    ...
    Used: [ null, "Kullanılmış" ],
    User: [ null, "Kullanıcı" ],
    "User Name": [ null, "Kullanıcı Adı" ],
    "User Password": [ null, "Kullanıcı Parolası" ],
    "User name": [ null, "" ],
    "User or Group": [ null, "" ],
    Username: [ null, "Kullanıcı Adı" ],
    Users: [ null, "" ],
    "Using available credentials": [ null, "" ],
    "VFAT - Compatible with all systems and devices": [ null, "VFAT - Tüm sistemler ve cihazlarla uyumlu" ],
    VLAN: [ null, "VLAN" ],
    "VLAN Id": [ null, "VLAN id" ],
    "VLAN Settings": [ null, "" ],
    "Validating key": [ null, "Anahtar doğrulanıyor" ],
    Version: [ null, "Sürüm" ],
    "Very securely erasing $target": [ null, "" ],
    "Virtual Machines": [ null, "" ],
    Volume: [ null, "Mantıksal Bölüm" ],
    "Volume Group": [ null, "" ],
    "Volume Group $0": [ null, "" ],
    "Volume Groups": [ null, "" ],
    "Volume ID": [ null, "" ],
    "Volume Name": [ null, "Tam İsim" ],
    "Volume Type": [ null, "" ],
    Volumes: [ null, "" ],
    Waiting: [ null, "Bekleniyor" ],
    ...
    When: [ null, "" ],
    "With terminal": [ null, "Terminal ile" ],
    "Write-mostly": [ null, "" ],
    Writing: [ null, "Yazılıyor" ],
    "Writing objects": [ null, "" ],
    "XFS - Red Hat Enterprise Linux 7 default": [ null, "XFS - Red Hat Enterprise Linux 7 ön tanımlı" ],
    XOR: [ null, "XOR" ],
    Yes: [ null, "Evet" ],
    ...
    "You are currently connected directly to this server. You cannot delete it.": [ null, "Şu an bu sunucuya doğrudan bağlısınız. Silme işlemi yapamazsınız." ],
    ...
    "You do not have permission to view the authorized public keys for this account.": [ null, "Bu hesabın yetkilendirilmiş açık anahtarlarını görmeniz için izniniz yok." ],
    ...
    "ext4 - Red Hat Enterprise Linux 6 default": [ null, "ext4 - Red Hat Enterprise Linux 6 ön tanımlı" ],
    ...
    shares: [ null, "Paylaşılan" ],
    "solution details": [ null, "" ],
    "to host path": [ null, "Host" ],
    "to host port": [ null, "" ],
    undefined: [ null, "" ],
    unknown: [ null, "Bilinmiyor" ],
    "unknown target": [ null, "" ],
    ...
    "storage-id-descOther Data": [ null, "Diğer Veri" ],
    "storage-id-descSwap Space": [ null, "Swap Alanı" ],
    "storage-id-descUnrecognized Data": [ null, "Tanımlanamayan Veri" ],
    "memory$0 byte": [ "$0 bytes", "", "" ],
    "disk-non-rotational$0 disk is missing": [ "$0 disks are missing", "", "" ],
    "page-titleAccounts": [ null, "Hesaplar" ],
    "page-titleCPU Status": [ null, "CPU Durumu" ],
    "page-titleContainers": [ null, "Konteynerler" ],
    "page-titleMemory": [ null, "Bellek" ],
    "page-titleNetworking": [ null, "" ],
    "storageAssessment": [ null, "" ],
    "storageBitmap": [ null, "Bitmap" ],
    "storageCapacity": [ null, "Kapasite" ],
    "storageDevice": [ null, "Aygıt" ],
    "storageDevice File": [ null, "Aygıt dosyası" ],
    "storageDrive": [ null, "Sürücü" ],
    "storageFirmware Version": [ null, "Firmware Sürümü" ],
    "storageHard Disk": [ null, "Sabit Disk" ],
    "storageModel": [ null, "Model" ],
    "storageMultipathed Devices": [ null, "" ],
    "storageOptical Drive": [ null, "Optik Sürücü" ],
    "storageRAID Level": [ null, "RAID Seviyesi" ],
    "storageRemovable Drive": [ null, "Çıkarılabilir Disk" ],
    "storageSerial Number": [ null, "Seri Numarası" ],
    "storageSolid-State Disk": [ null, "SSD Disk" ],
    "storageState": [ null, "Durum" ],
