(function(l, e) {
    ...
    "(<b>Ctrl-Shift-J</b> in most browsers).": [ null, "(Çoğu tarayıcıda <b>Ctrl-Shift-J</b>)." ],
    "1 MiB": [ null, "" ],
    ...
    "Cockpit had an unexpected internal error. <br/><br/>": [ null, "Cockpit'te beklenmedik bir iç hata var. <br/><br/>" ],
    ...
    "Error while deleting alert": [ null, "Uyarıyı silerken hata" ],
    ...
    "Failed to delete alert": [ null, "Uyarı silme başarısız" ],
    ...
    "Fibre Channel": [ null, "" ],
    "Filesystem Options": [ null, "Dosya Sistemi Seçenekleri" ],
    ...
    "Logical Volumes": [ null, "Mantıksal Bölümler" ],
    Login: [ null, "" ],
    "Login Password": [ null, "" ],
    "Login commands": [ null, "" ],
    "Login failed": [ null, "" ],
    ...
    "Renamee Logical Volume": [ null, "Mantıksal Bölümü Yeniden İsimlendir" ],
    ...
    "The javascript console contains details about this error ": [ null, "Javascript uçbirimi bu hatayla ilgili ayrıntıları içeriyor" ],
    ...
    "Unable to get alert": [ null, "Uyarı alınamıyor" ],
    ...
    "You can try restarting Cockpit by pressing refresh in your browser. ": [ null, "Tarayıcınızda yenileye basarak Cockpit'i yeniden başlatmayı deneyebilirsiniz." ],
    ...
    "iSCSI Targets": [ null, "" ],
    inactive: [ null, "" ],
    locked: [ null, "kilitlendi" ],
    "mounted on $0": [ null, "$0 noktasında bağlı" ],
    no: [ null, "" ],
    none: [ null, "hiç biri" ],
    "not mounted": [ null, "bağlı değil" ],
    "pending volume claims": [ null, "" ],
    recommended: [ null, "" ],
    ...
    "storage-id-descEncrypted": [ null, "Şifreli" ],
    "storage-id-descLUKS Encrypted": [ null, "LUKS Şifreli" ],
    ...
    "storage-id-descRAID Member": [ null, "RAID Üyesi" ],
