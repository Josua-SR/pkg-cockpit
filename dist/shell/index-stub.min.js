!function(n) {
    ...
    !function() {
        ...
        function o() {
            function n(n) {
                n.key === c && n.storageArea === window.sessionStorage && o(JSON.parse(n.newValue));
            }
            function t(n, e, t) {
            ...
            function o(n, e) {
                if (n) {
                    var o = !p.ready;
                    p.ready = !0, v = n, h = null, e && !g && (g = window.setTimeout(function() {
                        g = null, window.sessionStorage.setItem(c, JSON.stringify(v));
                    }, 10));
                    var a, i = {}, l = n.content || {}, d = n.overlay || {};
                    for (a in l) i[a] = !0;
                    for (a in d) i[a] = !0;
                    var u, f, b = [];
                    for (a in i) {
                        var w = m[a] || {}, y = w.connection_string;
                        l[a] && l[a].color && d[a] && delete d[a].color, u = t(w, l[a], d[a]), u.key = a, 
                        u.address || (u.address = a), u.connection_string = p.generate_connection_string(u.user, u.port, u.address), 
                        ...
                        u.avatar || (u.avatar = "../shell/images/server-small.png"), b.push([ a in m ? "updated" : "added", [ u, a, y ] ]), 
                        m[a] = u;
                    }
                    for (a in m) a in i || (u = m[a], delete m[a], delete d[a], b.push([ "removed", [ u, a ] ]));
                    var _, k = s(p), x = b.length;
                    for (_ = 0; _ < x; _++) k.triggerHandler(b[_][0], b[_][1]);
                    o && s(p).triggerHandler("ready");
                }
            }
            function a(n, t, o) {
                var a = e(t), i = s.extend({}, n, o);
                return window.sessionStorage.setItem(a, JSON.stringify(i)), p.overlay(t, o), r.when([]);
            }
            function d(n, e) {
                var t = {};
                for (var o in e) null !== e[o] && (t[o] = r.variant("visible" == o ? "b" : "s", e[o]));
                var a = r.dbus(null, {
                    bus: "internal",
                    superuser: "try"
                }), s = a.call("/machines", "cockpit.Machines", "Update", [ "99-webui.json", n, t ]).done(function() {
                    var t, o = {};
                    for (t in e) o[t] = null;
                    p.overlay(n, o);
                }).fail(function(n) {
                    console.error("failed to call cockpit.Machines.Update(): ", n);
                });
                return s;
            }
            function u(n) {
                var e, t, o = i.colors.parse(n);
                for (e in m) if (t = m[e], t.color && i.colors.parse(t.color) == o) return !0;
                return !1;
            }
            function f(n, e) {
            ...
            window.addEventListener("storage", n), window.setTimeout(function() {
                var n = window.sessionStorage.getItem(c);
                !p.ready && n && o(JSON.parse(n));
            });
            var g = null;
            p.add_key = function(n) {
                var e = r.file(l, {
                    superuser: "try"
                });
                ...
                var t = p.split_connection_string(n), o = t.address;
                t = s.extend({
                    visible: !0,
                    color: e || p.unused_color()
                }, t);
                var a = p.lookup(o);
                return a && (a.on_disk = !0), p.change(t.address, t);
            }, p.unused_color = function() {
                var n, e = i.colors.length;
                for (n = 0; n < e; n++) if (!u(i.colors[n])) return i.colors[n];
                return "gray";
            }, p.change = function(n, e) {
                var t, o, s, i = p.lookup(n);
                if (e.label) {
                    var l = n;
                ...
                return t = i && !i.on_disk ? a(i, n, e) : d(n, e), s ? r.all(s, t) : t;
            }, p.data = function(n) {
                var e, t = {};
                for (e in n) t[e] = s.extend({}, v.overlay[e] || {}), f(t[e], {
                    on_disk: !0
                });
                for (e in m) n && !n[e] && (t[e] = s.extend({}, v.overlay[e] || {}), f(t[e], {
                    on_disk: null
                }));
                o({
                    content: n,
                    overlay: s.extend({}, v.overlay, t)
                }, !0);
            }, p.overlay = function(n, e) {
                var t = {};
                t[n] = s.extend({}, v.overlay[n] || {}), f(t[n], e), o({
                    content: v.content,
                    overlay: s.extend({}, v.overlay, t)
                }, !0);
                ...
                get: function() {
                    ...
                    if (!h) {
                        h = [];
                        for (n in m) m[n].visible && h.push(m[n]);
                        h.sort(function(n, e) {
                ...
                var e = p.split_connection_string(n);
                return m[e.address || "localhost"] || null;
            }, p.generate_connection_string = function(n, e, t) {
                var o = t;
                return n && (o = n + "@" + o), e && (o = o + ":" + e), o;
            }, p.split_connection_string = function(n) {
                var e = {}, t = -1, o = -1;
        ...
        function a(n, e) {
            function t(e, t) {
                var o, a, s, r = e.split("/");
                r[0] == d && 2 === r.length && (o = r[1], t && (a = JSON.parse(t), s = n.lookup(o), 
                s && s.on_disk ? s.visible || n.change(o, {
                    visible: !0
                }) : n.overlay(o, a), f.connect(o)));
            }
            function o() {
                var n;
                for (p = !0, n = 0; n < window.sessionStorage.length; n++) {
            ...
            function l(e, t, o, a) {
                if (t || (t = n.lookup(o))) {
                    ...
                    t.visible ? a && t.connection_string != a ? (r.kill(a), f.disconnect(o), f.connect(o)) : t.problem || f.connect(o) : f.disconnect(o);
                }
            }
            function c(n, e, t) {
                f.disconnect(t);
            }
            var u, f = this, p = !1, h = {}, m = {};
            if (window.addEventListener("storage", a), s(n).on("added", l), s(n).on("updated", l), 
            s(n).on("removed", c), f.connect = function(e) {
                function t() {
                ...
                function o() {
                    g = s.ajax({
                        ...
                        console.warn("failed to load manifests from " + c.connection_string + ": " + n);
                    }).always(function() {
                        g = null, t();
                    });
                }
                ...
                if (c) {
                    ...
                    if (!d) {
                        ...
                        d = r.channel(u), h[e] = d;
                        var p, v = "localhost" === e, g = null, b = v, w = null;
                        c.manifests || (p = c.checksum ? "../../" + c.checksum + "/manifests.json" : "../../@" + encodeURI(c.connection_string) + "/manifests.json"), 
                        v ? p && (o(), a()) : (d.send("x"), s(d).on("message", function() {
                            b = !0, p && o(), a(), t();
            ...
            }, f.disconnect = function(n) {
                if ("localhost" !== n) {
                    var e = h[n];
                    delete h[n], e && (e.close(), s(e).off());
                    var t = m[n];
                    delete m[n], t && (t.client.close(), s(t).off());
                }
                ...
                s(n).off("added", l), s(n).off("changed", l), s(n).off("removed", c), n = null, 
                ...
                s(v).on("changed", function(e) {
                    var t, a = v.Machines, s = {};
                    for (var r in a) {
                        t = {};
                        for (var i in a[r]) t[i] = a[r][i].v;
                        s[r] = t;
                    }
                    n.data(s), p || o();
                });
        ...
        var s = t(7), r = t(8), i = {}, l = "/var/lib/cockpit/known_hosts", c = r.sessionStorage.prefixedKey("v2-machines.json"), d = r.sessionStorage.prefixedKey("v1-session-machine");
        ...
        }, i.known_hosts_path = l, r.transport.wait(function() {
    ...
    !function() {
        ...
        var m = t(7), v = t(8), g = t(16), b = t(6), w = t(9), y = t(18), _ = t(19), k = t(20), x = t(21), C = t(22), E = t(23), T = t(24), j = t(25), O = t(26), S = v.gettext, A = {
    ...
    !function() {
        ...
        var r = t(7), i = t(8), l = t(28), c = i.gettext, d = window.location.pathname.indexOf(".html") !== -1;
        n.exports = {
    ...
    !function() {
        ...
        function a(n) {
            ...
            function u(t) {
                if (t.origin === h) {
                    var o = !1, a = t.data, s = t.source;
                    if (s && "string" == typeof a) {
                        var r, u = v[s.name];
                        if (0 === a.length) return void (u && i(u));
                        if ("\n" == a[0]) if (r = JSON.parse(a.substring(1)), "init" === r.command) {
                            if (u && i(u), u = l(s)) {
                                var p = c.extend({}, d.transport.options, {
                                    command: "init",
                                    host: u.default_host,
                                    "channel-seed": u.channel_seed
                                });
                                s.postMessage("\n" + JSON.stringify(p), h), u.inited = !0, s.frameElement != n.current_frame() && f.hint(s.frameElement.contentWindow, {
                                    hidden: !0
                                });
                            }
                        } else {
                            if ("jump" === r.command) return void e(s, r);
                            if ("logout" == r.command || "kill" == r.command) o = !0; else {
                                if ("hint" === r.command) return void ("restart" == r.hint ? r.host != d.transport.host && n.expect_restart(r.host) : d.hint(r.hint, r));
                                if ("oops" == r.command) return void n.show_oops();
                                if (void 0 === r.channel && !o) return;
                                "open" == r.command && (r.group = s.name, a = "\n" + JSON.stringify(r));
                            }
                        }
                        return u ? void d.transport.inject(a, !0) : void console.warn("child frame " + s.name + " sending data without init");
                    }
                }
            }
        ...
        var l, c = t(7), d = t(8), u = window.location.pathname.indexOf(".html") !== -1, f = d.gettext;
    ...
    "use strict";
    !function() {
        var n = t(7), e = t(8), o = t(6), a = t(15), s = t(27), r = "Cockpit", i = e.manifests.shell || {};
        i.title && (r = i.title);
        var l = {
        ...
        s.machines_index(l, c, d, u);
        var f = e.localStorage.getItem("login-data", !0);
        if (f) {
            var p = JSON.parse(f);
            n("#content-user-name").text(p.displayName);
        }
    }();
} ]);
