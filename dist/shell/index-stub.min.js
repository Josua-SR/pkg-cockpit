!function(n) {
            ...
            s(n).on("removed", d), p.connect = function(e) {
                ...
                if (l) {
                    ...
                    if (!d) {
                        ...
                        !l.on_disk && l.host_key && (u["temp-session"] = !1, u["host-key"] = l.host_key), 
                        d = r.channel(u), m[e] = d;
        ...
        !function() {
            function e() {
                ...
                s.user().done(function(e) {
                    ...
                    var v = window.setTimeout(function() {
                        m = i("Prompting via ssh-keygen timed out"), g.close("terminated");
                    }, 1e4), g = s.spawn([ "ssh-keygen", "-p", "-f", n ], {
                        pty: !0,
                        environ: [ "LC_ALL=C" ],
                        err: "out",
                        directory: l.path
                        ...
                        void g.input(e + "\n", !0);
                        for (r = 0; r < d.length; r++) if (d[r].test(p)) return p = "", g.input(t + "\n", !0), 
                        m = i("Failed to change password"), void (h = !0);
                        for (r = 0; h && r < u.length; r++) if (u[r].test(p)) return void (m = i("New password was not accepted"));
                    });
                    return f.promise();
                }, l.load = function(e, t) {
                    var o = /.*Enter passphrase for .*/, r = /.*UNPROTECTED PRIVATE KEY FILE.*/, c = /.*Bad passphrase.*/, d = a.Deferred(), u = "", f = "", p = i("Not a valid private key"), h = window.setTimeout(function() {
                        p = i("Prompting via ssh-add timed out"), m.close("terminated");
                    }, 1e4), m = s.spawn([ "ssh-add", e ], {
                        pty: !0,
                        environ: [ "LC_ALL=C" ],
                        err: "out",
                        directory: l.path
                        ...
                        console.log(f), "ProcessError" == n.constructor.name && (n = new Error(p)), d.reject(n);
                    }).stream(function(n) {
                        u += n, f += n, r.test(u) ? (p = i("Invalid file permissions"), u = "") : o.test(u) ? (u = "", 
                        p = i("Password not accepted"), m.input(t + "\n", !0)) : c.test(u) && (u = "", m.input("\n", !0));
                    });
                    return d.promise();
                }, l.unload = function(e) {
            ...
            function o() {
                ...
                a("#credential-authorize button").on("click", function(n) {
                    a("#credential-authorize").remove(), s.drop_privileges(!1), n.preventDefault();
    ...
    !function() {
        function e(n) {
            ...
            return e.find('[translatable="yes"]').each(function(e, t) {
                ...
                m(t).removeAttr("translatable").text(a), n.replace(o, t.outerHTML);
            }), g.parse(n), n;
        }
        function o(n, e) {
            var t = n.lookup(e);
        ...
        function a(n, e, t, a) {
            ...
            i.try_to_connect = function(n, e) {
                ...
                a && a.host_key && !a.on_disk && (o["temp-session"] = !1, o["host-key"] = a.host_key);
                var s = v.channel(o);
                ...
                }, n, t), a = g.render(L[e], o);
                i.get_sel(".modal-content").html(a);
        ...
        function f(n) {
            ...
            function t() {
                ...
                a || (i.user && i.user.name && (t.user = i.user.name), t["temp-session"] = !1)), 
        ...
        var m = t(3), v = t(4), g = t(14), b = t(2), w = t(5), y = t(15), _ = t(16), k = t(17), x = t(18), C = t(19), E = t(20), T = t(21), j = t(22), O = t(23), S = v.gettext, A = {
    ...
    !function() {
        ...
        function a(n) {
            ...
            function a(n) {
                ...
                p.items[n.component];
                delete n.sidebar, r("#machine-link span").text(u), r(".dashboard-link").length < 2 && r("#content-navbar").toggleClass("hidden", !0);
            }
            function s(n) {
        ...
        var r = t(3), i = t(4), l = t(25), c = i.gettext, d = window.location.pathname.indexOf(".html") !== -1;
        n.exports = {
            ...
            function u(t) {
                if (t.origin === h) {
                    ...
                    if (a && "string" == typeof o) {
                        ...
                        if ("\n" == o[0]) {
                            var r = JSON.parse(o.substring(1));
                            if ("init" === r.command) {
                                if (s && i(s), s = l(a)) {
                                    ...
                                    a.postMessage("\n" + JSON.stringify(u), h), s.inited = !0, a.frameElement != n.current_frame() && f.hint(a.frameElement.contentWindow, {
                                        hidden: !0
                                    });
                                }
                            } else {
                                if ("jump" === r.command) return void e(a, r);
                                if ("hint" === r.command) return void ("restart" == r.hint && r.host != d.transport.host && n.expect_restart(r.host));
                                if ("oops" == r.command) return void n.show_oops();
                                if (void 0 === r.channel) return;
                                "open" == r.command && (r.group = a.name, o = "\n" + JSON.stringify(r));
                            }
                        }
                        return s ? void d.transport.inject(o) : void console.warn("child frame " + a.name + " sending data without init");
                    }
                }
            }
            var f = this, p = 0, h = d.transport.origin, m = {}, v = {};
            d.transport.filter(function(n, e, t) {
                var o, a, s;
                if (t) {
                    if (void 0 !== t.channel) for (o in m) m[o].window.postMessage(n, h);
                    return !0;
                }
                if (e) return s = e.indexOf("!"), !(s !== -1 && (o = e.substring(0, s + 1), a = m[o])) || (a.window.postMessage(n, h), 
                !1);
            }), f.start = function(n) {
    ...
    "use strict";
    !function() {
        var n = t(3), e = t(4), o = t(2), a = t(13), s = t(24), r = "Cockpit", i = e.manifests.shell || {};
        i.title && (r = i.title);
        var l = {
