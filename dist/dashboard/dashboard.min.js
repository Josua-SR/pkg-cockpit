!function(t) {
    ...
    !function(a, r) {
        ...
        function s(e, o) {
            function a() {
                if (C && !S) for (;T.length; ) delete M[T.pop()]; else T = [];
                C = !1, S = !1;
            }
            o = o || t.tags, e = e || "", "string" == typeof o && (o = o.split(y));
            for (var s, u, f, h, p, m, g = r(o), v = new d(e), _ = [], M = [], T = [], C = !1, S = !1; !v.eos(); ) {
                if (s = v.pos, f = v.scanUntil(g[0])) for (var z = 0, A = f.length; z < A; ++z) h = f.charAt(z), 
                n(h) ? T.push(M.length) : S = !0, M.push([ "text", h, s, s + 1 ]), s += 1, "\n" === h && a();
                if (!v.scan(g[0])) break;
                if (C = !0, u = v.scan(k) || "name", v.scan(b), "=" === u ? (f = v.scanUntil(x), 
                v.scan(x), v.scanUntil(g[1])) : "{" === u ? (f = v.scanUntil(new RegExp("\\s*" + i("}" + o[1]))), 
                v.scan(w), v.scanUntil(g[1]), u = "&") : f = v.scanUntil(g[1]), !v.scan(g[1])) throw new Error("Unclosed tag at " + v.pos);
                if (p = [ u, f, s, v.pos ], M.push(p), "#" === u || "^" === u) _.push(p); else if ("/" === u) {
                    if (m = _.pop(), !m) throw new Error('Unopened section "' + f + '" at ' + s);
                    if (m[1] !== f) throw new Error('Unclosed section "' + m[1] + '" at ' + s);
                } else "name" === u || "{" === u || "&" === u ? S = !0 : "=" === u && (g = r(o = f.split(y)));
            }
            if (m = _.pop()) throw new Error('Unclosed section "' + m[1] + '" at ' + v.pos);
            return c(l(M));
        }
        function l(t) {
        ...
        var h = RegExp.prototype.test, p = /\S/, m = Object.prototype.toString, g = Array.isArray || function(t) {
        ...
        d.prototype.eos = function() {
            ...
            s[0]) {
              case "#":
                ...
                if (g(l)) for (var h = 0, p = l.length; h < p; ++h) c += this.renderTokens(s[4], n.push(l[h]), i, a); else if ("object" == typeof l || "string" == typeof l) c += this.renderTokens(s[4], n.push(l), i, a); else if (o(l)) {
              ...
              case "^":
                l = n.lookup(s[1]), (!l || g(l) && 0 === l.length) && (c += this.renderTokens(s[4], n, i, a));
                break;
    ...
    r.plot = function(t, e, n) {
        ...
        function b(t, e, n) {
            for (var o = null, i = !1, a = 0; a < C.length; a++) if (i = C[a].hover_hit(e, n)) {
                o = C[a];
                break;
            }
            v(o, i);
    ...
    !function(t) {
        ...
        function n(n, i, a, r) {
            ...
            function b() {
                ...
                for (n = 0; n < ot.length; ++n) {
                    ...
                    if (r.bars.show) {
                        ...
                        r.bars.horizontal ? (_ += C, T += C + r.bars.barWidth) : (k += C, M += C + r.bars.barWidth);
                    }
                    e(r.xaxis, k, M), e(r.yaxis, _, T);
                }
            ...
            function x() {
                it.grid.hoverable && (st.mousemove(q), st.bind("mouseleave", J)), it.grid.clickable && st.click(B), 
                s(mt.bindEvents, [ st ]);
            }
            function w() {
                bt && clearTimeout(bt), st.unbind("mousemove", q), st.unbind("mouseleave", J), st.unbind("click", B), 
                s(mt.shutdown, [ st ]);
            }
            function k(t) {
                function e(t) {
            ...
            function O() {
                ...
                var t = it.grid;
                t.show && t.backgroundColor && D(), t.show && !t.aboveData && j();
                for (var e = 0; e < ot.length; ++e) s(mt.drawSeries, [ lt, ot[e] ]), N(ot[e]);
                s(mt.draw, [ lt ]), t.show && t.aboveData && j(), at.render(), X();
            }
            function W(t, e) {
            ...
            function N(t) {
                t.lines.show && P(t), t.bars.show && R(t), t.points.show && L(t);
            }
            function P(t) {
                ...
                for (o = ot.length - 1; o >= 0; --o) if (n(ot[o])) {
                    ...
                    if (c.bars.show && !l) {
                        ...
                        for (_ = k + c.bars.barWidth, i = 0; i < f.length; i += a) {
                            ...
                            null != v && (ot[o].bars.horizontal ? h <= Math.max(M, v) && h >= Math.min(M, v) && p >= b + k && p <= b + _ : h >= v + k && h <= v + _ && p >= Math.min(M, b) && p <= Math.max(M, b)) && (l = [ o, i / a ]);
                        }
                    }
                }
            ...
            function q(t) {
                it.grid.hoverable && G("plothover", t, function(t) {
            ...
            gt.setData = d, gt.setupGrid = S, gt.draw = O, gt.getPlaceholder = function() {
                ...
                return it;
            }, gt.highlight = K, gt.unhighlight = Q, gt.triggerRedrawOverlay = X, gt.pointOffset = function(t) {
                return {
    ...
    function o(t, e, n) {
        ...
        function s(t, o, i, a) {
            ...
            var s = 2 * z;
            if (a) i = r(s, i, C), t = r(0, t, e - i), o = r(0, o, n - i); else if (t < 0 || o < 0 || t + i > e || o + i > n || i < s) return;
        ...
        function u(t, e, n) {
            ...
            return A ? a.drawImage(v, w, k, _, _, 0, 0, t, e) : a.drawImage(v, 0, 0, C, C, 0, 0, t, e), 
            o.toDataURL(n);
        }
        function f() {
            var t, e, n;
