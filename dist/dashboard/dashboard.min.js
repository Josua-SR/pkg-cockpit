!function(t) {
    ...
    var l = n(2), c = n(3), d = n(4), u = n(5), f = n(9), h = n(10);
    n(17);
    var p = n(28), m = c.gettext;
    c.gettext;
    ...
    !function() {
        function e(t) {
            ...
            return e.find('[translatable="yes"]').each(function(e, n) {
                ...
                m(n).removeAttr("translatable").text(i), t.replace(o, n.outerHTML);
            }), v.parse(t), t;
        }
        function o(t, e) {
            var n = t.lookup(e);
        ...
        function i(t, e, n, i) {
            ...
            s.try_to_connect = function(t, e) {
                ...
                i && i.host_key && !i.on_disk && (o["temp-session"] = !1, o["host-key"] = i.host_key);
                var a = g.channel(o);
                ...
                }, t, n), i = v.render(I[e], o);
                s.get_sel(".modal-content").html(i);
        ...
        function f(t) {
            ...
            function n() {
                ...
                i || (s.user && s.user.name && (n.user = s.user.name), n["temp-session"] = !1)), 
        ...
        var m = n(2), g = n(3), v = n(4), b = n(9), y = n(11), x = n(19), w = n(20), k = n(21), _ = n(22), C = n(23), T = n(24), M = n(25), S = n(26), z = n(27), A = g.gettext, E = {
        ...
        !function() {
            function e() {
                ...
                a.user().done(function(e) {
                    ...
                    var g = window.setTimeout(function() {
                    ...
                    }, 1e4), v = a.spawn([ "ssh-keygen", "-p", "-f", t ], {
                        pty: !0,
                        environ: [ "LC_ALL=C" ],
                        err: "out",
                        directory: l.path
                        ...
                        void v.input(e + "\n", !0);
                        for (r = 0; r < d.length; r++) if (d[r].test(h)) return h = "", v.input(n + "\n", !0), 
                        m = s("Failed to change password"), void (p = !0);
                        for (r = 0; p && r < u.length; r++) if (u[r].test(h)) return void (m = s("New password was not accepted"));
                    });
                    return f.promise();
                }, l.load = function(e, n) {
                    var o = /.*Enter passphrase for .*/, r = /.*UNPROTECTED PRIVATE KEY FILE.*/, c = /.*Bad passphrase.*/, d = i.Deferred(), u = "", f = "", h = s("Not a valid private key"), p = window.setTimeout(function() {
                        h = s("Prompting via ssh-add timed out"), m.close("terminated");
                    }, 1e4), m = a.spawn([ "ssh-add", e ], {
                        pty: !0,
                        environ: [ "LC_ALL=C" ],
                        err: "out",
                        directory: l.path
                        ...
                        console.log(f), "ProcessError" == t.constructor.name && (t = new Error(h)), d.reject(t);
                    }).stream(function(t) {
                        u += t, f += t, r.test(u) ? (h = s("Invalid file permissions"), u = "") : o.test(u) ? (u = "", 
                        h = s("Password not accepted"), m.input(n + "\n", !0)) : c.test(u) && (u = "", m.input("\n", !0));
                    });
                    return d.promise();
                }, l.unload = function(e) {
            ...
            function o() {
                ...
                i("#credential-authorize button").on("click", function(t) {
                    i("#credential-authorize").remove(), a.drop_privileges(!1), t.preventDefault();
