!function(t) {
    ...
    var l = n(6), c = n(7), d = n(8), u = n(10), f = n(14), h = n(15);
    n(20);
    var p = n(31), m = c.gettext;
    ...
    !function(a, r) {
        ...
        function s(e, o) {
            function a() {
                if (T && !S) for (;M.length; ) delete C[M.pop()]; else M = [];
                T = !1, S = !1;
            }
            o = o || t.tags, e = e || "", "string" == typeof o && (o = o.split(y));
            for (var s, u, f, h, p, m, g = r(o), v = new d(e), _ = [], C = [], M = [], T = !1, S = !1; !v.eos(); ) {
                if (s = v.pos, f = v.scanUntil(g[0])) for (var z = 0, A = f.length; z < A; ++z) h = f.charAt(z), 
                n(h) ? M.push(C.length) : S = !0, C.push([ "text", h, s, s + 1 ]), s += 1, "\n" === h && a();
                if (!v.scan(g[0])) break;
                if (T = !0, u = v.scan(k) || "name", v.scan(b), "=" === u ? (f = v.scanUntil(x), 
                ...
                if (p = [ u, f, s, v.pos ], C.push(p), "#" === u || "^" === u) _.push(p); else if ("/" === u) {
    ...
    r.plot = function(t, e, n) {
        ...
        var k, _, C = {}, M = {}, T = [], S = [], z = null, A = !1, E = 0, I = null, O = !1;
    ...
    !function(t) {
        ...
        function n(n, i, a, r) {
            ...
            function O() {
                ...
                for (var e = 0; e < ot.length; ++e) s(mt.drawSeries, [ lt, ot[e] ]), F(ot[e]);
            ...
            function F(t) {
                t.lines.show && N(t), t.bars.show && R(t), t.points.show && L(t);
            }
            function N(t) {
            ...
            function q(t) {
                it.grid.hoverable && X("plothover", t, function(t) {
    ...
    !function() {
        ...
        function o() {
            function t(t) {
                t.key === c && t.storageArea === window.sessionStorage && o(JSON.parse(t.newValue));
            }
            function n(t, e, n) {
            ...
            function d(t, e) {
                ...
                var i = r.dbus(null, {
                    bus: "internal",
                    superuser: "try"
                }), a = i.call("/machines", "cockpit.Machines", "Update", [ "99-webui.json", t, n ]).done(function() {
                    var n, o = {};
                    for (n in e) o[n] = null;
                    h.overlay(t, o);
                }).fail(function(t) {
        ...
        function i(t, e) {
            ...
            function l(e, n, o, i) {
                if (n || (n = t.lookup(o))) {
                    ...
                    n.visible ? i && n.connection_string != i ? (r.kill(i), f.disconnect(o), f.connect(o)) : n.problem || f.connect(o) : f.disconnect(o);
                }
            }
            function c(t, e, n) {
                f.disconnect(n);
            }
            var u, f = this, h = !1, p = {}, m = {}, g = {};
            if (window.addEventListener("storage", i), a(t).on("added", l), a(t).on("updated", l), 
            a(t).on("removed", c), f.connect = function(e) {
                function n() {
                ...
                if (d) {
                    ...
                    if (!u) {
                        ...
                        !d.on_disk && d.host_key && (h["temp-session"] = !1, h.session = "shared", h["host-key"] = d.host_key, 
                        h["unknown-host"] = "1"), u = r.channel(h), p[e] = u;
                        ...
                        b ? (v && o(), i(), c()) : (u.send("x"), a(u).on("message", function() {
                            x = !0, v && o(), i(), c(), n();
            ...
            }, f.disconnect = function(t) {
                if ("localhost" !== t) {
                    var e = p[t];
                    delete p[t], e && (e.close(), a(e).off());
                    var n = m[t];
                    delete m[t], n && (n.client.close(), a(n).off());
                    var o = g[t];
                    delete g[t], o && o.close();
                }
            }, f.expect_restart = function(e) {
                ...
                u && u.close(), u = null, window.removeEventListener("storage", i);
                var e = Object.keys(p);
                e.forEach(f.disconnect);
            }, e) o(), t.data({}); else {
                var v = r.dbus(null, {
                    bus: "internal"
                }).proxy("cockpit.Machines", "/machines");
                a(v).on("changed", function(e) {
                    var n, i = v.Machines, a = {};
                    for (var r in i) {
                        n = {};
        ...
        var a = n(6), r = n(7), s = {}, l = "/etc/ssh/ssh_known_hosts", c = r.sessionStorage.prefixedKey("v2-machines.json"), d = r.sessionStorage.prefixedKey("v1-session-machine");
    ...
    !function() {
        ...
        function i(t, e, n, i) {
            ...
            function r(t, e) {
                var n = x;
                y !== t && (x = "add-machine" == t ? new c(s) : "sync-users" == t ? new h(s) : "unknown-hostkey" == t || "unknown-host" == t ? new u(s, t) : "invalid-hostkey" == t ? new u(s, t) : "change-auth" == t ? new f(s) : "change-port" == t ? new d(s) : new l(s), 
            ...
            s.try_to_connect = function(t, e) {
                ...
                o["host-key"] = i.host_key, o["unknown-host"] = "1");
                var a = g.channel(o);
        ...
        function u(t, e) {
            ...
            function o() {
                var i, l = null, c = {}, d = e, u = b.known_hosts_path;
        ...
        var m = n(6), g = n(7), v = n(8), b = n(14), y = n(16), x = n(22), w = n(23), k = n(24), _ = n(25), C = n(26), M = n(27), T = n(28), S = n(29), z = n(30), A = g.gettext, E = {
