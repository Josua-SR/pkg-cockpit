!function(t) {
    ...
    !function(a, r) {
        ...
        function s(e, o) {
            ...
            for (var s, u, f, m, y, x, w = r(o), k = new d(e), _ = [], C = [], M = [], T = !1, S = !1; !k.eos(); ) {
                if (s = k.pos, f = k.scanUntil(w[0])) for (var z = 0, A = f.length; z < A; ++z) m = f.charAt(z), 
                n(m) ? M.push(C.length) : S = !0, C.push([ "text", m, s, s + 1 ]), s += 1, "\n" === m && a();
                if (!k.scan(w[0])) break;
                if (T = !0, u = k.scan(b) || "name", k.scan(h), "=" === u ? (f = k.scanUntil(g), 
    ...
    r.plot = function(t, e, n) {
        ...
        function v(t, e) {
            I != t ? (I && I.hover(!1), I = t, W = e, I && I.hover(W)) : W != e && (W = e, I && I.hover(W));
        }
        function b(t, e, n) {
        ...
        var k, _, C = {}, M = {}, T = [], S = [], z = null, A = !1, E = 0, I = null, W = !1;
    ...
    !function(t) {
        ...
        function n(n, i, a, r) {
            ...
            function x() {
                it.grid.hoverable && (st.mousemove(q), st.bind("mouseleave", J)), it.grid.clickable && st.click(X), 
                s(mt.bindEvents, [ st ]);
            }
            function w() {
                bt && clearTimeout(bt), st.unbind("mousemove", q), st.unbind("mouseleave", J), st.unbind("click", X), 
                s(mt.shutdown, [ st ]);
            }
            function k(t) {
                function e(t) {
            ...
            gt.setData = d, gt.setupGrid = S, gt.draw = W, gt.getPlaceholder = function() {
                return n;
            ...
            }, gt.hooks = mt, l(gt), c(a), y(), d(i), S(), W(), x();
            var vt = [], bt = null;
        }
        function o(t, e) {
    ...
    !function() {
        ...
        function o() {
            ...
            function d(t, e) {
                var n = {};
                for (var o in e) null !== e[o] && (n[o] = r.variant("visible" == o ? "b" : "s", e[o]));
                var i = r.dbus(null, {
                    bus: "internal",
                    superuser: "try"
            ...
            a(t).on("removed", c), f.connect = function(e) {
                ...
                function o() {
                    v = a.ajax({
                        ...
                        console.warn("failed to load manifests from " + c.connection_string + ": " + t);
                    }).always(function() {
                        v = null, n();
                    });
                }
                ...
                if (c) {
                    ...
                    if (!d) {
                        ...
                        u["unknown-host"] = "1"), d = r.channel(u), p[e] = d;
                        var h, g = "localhost" === e, v = null, b = g, y = null;
                        c.manifests || (h = c.checksum ? "../../" + c.checksum + "/manifests.json" : "../../@" + encodeURI(c.connection_string) + "/manifests.json"), 
                        g ? h && (o(), i()) : (d.send("x"), a(d).on("message", function() {
                            b = !0, h && o(), i(), n();
                        }).on("close", function(n, o) {
                            var i = t.lookup(e);
                            b = !1, o.problem || !i || i.visible ? s(e, "failed", o.problem || "disconnected") : s(e, null, null), 
