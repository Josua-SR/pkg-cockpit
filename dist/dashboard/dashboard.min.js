!function(t) {
    ...
    function o(t, e, n) {
        ...
        if (o) {
            ...
            }), a.modal("show"), v.stop_cropping(), v.load_data(o.avatar || "images/server-large.png").fail(function() {
    ...
    var l = n(2), c = n(3), d = n(4), u = n(6), f = n(10), h = n(11), p = n(26).cpu_ram_info;
    n(16);
    ...
    l(x).on("changed", i), a.prototype = {
        ...
        setup: function() {
            function t(t) {
                ...
                v = t, l(".dashboard-plot").hide(), l(y[t].selector).show(), r();
            }
            function e() {
                var t = !1, o = {};
                l.each(w, function(t) {
                    ...
                    var i = l(this), a = i.attr("data-address"), r = m.machines.lookup(a), c = m.infos[a];
                    if (r && "connected" == r.state) return c ? void (c !== !0 && (delete o[a], w[a] || (w[a] = s(a, c)), 
                    ...
                    }))) : (m.infos[a] = !0, void p(r.connection_string).done(function(t) {
                        m.infos[a] = t, e();
                    }));
                }), l.each(o, function(t) {
            ...
            function s(t, e) {
                ...
                return y.forEach(function(t) {
                    if (m.plots[i]) {
                        var a = t.plot;
                        t.plot.apply && (a = t.plot(e)), o.push(m.plots[i].add_metrics_sum_series(l.extend({
            ...
            var x = a(l("#dashboard-hosts .list-group"));
    ...
    !function(n, r) {
        ...
        function l(e, n) {
            ...
            a(n || t.tags);
            for (var C, M, T, S, z, A, I = new u(e); !I.eos(); ) {
                if (C = I.pos, T = I.scanUntil(s)) for (var E = 0, O = T.length; E < O; ++E) S = T.charAt(E), 
                r(S) ? g.push(p.length) : b = !0, p.push([ "text", S, C, C + 1 ]), C += 1, "\n" === S && i();
                if (!I.scan(s)) break;
                if (v = !0, M = I.scan(_) || "name", I.scan(y), "=" === M ? (T = I.scanUntil(w), 
                I.scan(w), I.scanUntil(l)) : "{" === M ? (T = I.scanUntil(f), I.scan(k), I.scanUntil(l), 
                M = "&") : T = I.scanUntil(l), !I.scan(l)) throw new Error("Unclosed tag at " + I.pos);
                if (z = [ M, T, C, I.pos ], p.push(z), "#" === M || "^" === M) h.push(z); else if ("/" === M) {
                    if (A = h.pop(), !A) throw new Error('Unopened section "' + T + '" at ' + C);
                    if (A[1] !== T) throw new Error('Unclosed section "' + A[1] + '" at ' + C);
                } else "name" === M || "{" === M || "&" === M ? b = !0 : "=" === M && a(T);
            }
    ...
    function o(t, e, n, o) {
        ...
        function l() {
            g && v.width() > 0 && v.height() > 0 ? (h ? u() : (a(), h = i.plot(b, n, m)), y && window.clearInterval(y)) : y || (y = window.setInterval(l, 500));
        }
        function c() {
            g = !1;
        }
    ...
    r.plot = function(t, e, n) {
        function o() {
            if (0 !== t.height() && 0 !== t.width()) {
                ...
                z.draw(), C.post_hook && C.post_hook(z);
            }
        }
        function r() {
        ...
        function u() {
            ...
            C = {}, T = [], S = [], z = null, i(t).empty(), i(t).data("flot_data", null);
        }
        function f() {
        ...
        function m(t, e) {
            ...
            function h() {
                function n() {
                    g.archives && !M.archives && (M.archives = !0, i(M).triggerHandler("changed"));
                }
        ...
        function g(t, e) {
            ...
            function r() {
                function t() {
                    f.archives && !M.archives && (M.archives = !0, i(M).triggerHandler("changed"));
                }
                f && f.close(), f = a.metrics(k, p), i(f).on("changed", t), t(), I++;
        ...
        function b(t, e, n) {
            for (var o = null, i = !1, a = 0; a < T.length; a++) if (i = T[a].hover_hit(e, n)) {
                o = T[a];
                break;
            }
            v(o, i);
        ...
        function x(t, e) {
            e && i(M).triggerHandler("zoomstart", []);
        }
        function w(t, e) {
            z.clearSelection(!0), i(M).triggerHandler("zoom", [ (e.xaxis.to - e.xaxis.from) / 1e3, e.xaxis.to / 1e3 ]);
        }
        var k, _, C = {}, M = {}, T = [], S = [], z = null, A = !1, I = 0, E = null, O = !1;
        return i(t).on("plothover", b), i(t).on("mouseleave", y), i(t).on("plotselecting", x), 
        i(t).on("plotselected", w), i(t).data("flot_data", S), c(e, n), i.extend(M, {
            archives: !1,
            start_walking: s,
            stop_walking: l,
            refresh: r,
    ...
    !function(t) {
        ...
        function n(n, i, a, r) {
            ...
            function b() {
                ...
                for (n = 0; n < ot.length; ++n) {
                    ...
                    if (r.bars.show) {
                        ...
                        r.bars.horizontal ? (_ += T, M += T + r.bars.barWidth) : (k += T, C += T + r.bars.barWidth);
                    }
                    e(r.xaxis, k, C), e(r.yaxis, _, M);
                }
            ...
            function O() {
                ...
                var t = it.grid;
                t.show && t.backgroundColor && W(), t.show && !t.aboveData && D();
                for (var e = 0; e < ot.length; ++e) s(mt.drawSeries, [ lt, ot[e] ]), N(ot[e]);
                s(mt.draw, [ lt ]), t.show && t.aboveData && D(), at.render(), V();
            }
            function P(t, e) {
            ...
            function N(t) {
                t.lines.show && F(t), t.bars.show && $(t), t.points.show && L(t);
            }
            function F(t) {
            ...
            function L(t) {
                ...
                lt.lineWidth = n, lt.strokeStyle = t.color, e(t.datapoints, i, R(t.points, t.color), 0, !1, t.xaxis, t.yaxis, a), 
                lt.restore();
            }
    ...
    !function() {
        ...
        function o() {
            ...
            function o(t, e) {
                if (t) {
                    ...
                    var w, k = a(h), _ = b.length;
                    for (w = 0; w < _; w++) k.triggerHandler(b[w][0], b[w][1]);
                    o && a(h).triggerHandler("ready");
                }
            }
            function i(t, n, o) {
                var i = e(n), s = a.extend({}, t, o);
                return window.sessionStorage.setItem(i, JSON.stringify(s)), h.overlay(n, o), r.when([]);
            }
            function d(t, e) {
                var n = {};
            ...
            h.add_key = function(t) {
                ...
                var e, n = {};
                for (e in t) n[e] = a.extend({}, g.overlay[e] || {}), f(n[e], {
                    on_disk: !0
                });
                for (e in m) t && !t[e] && (n[e] = a.extend({}, g.overlay[e] || {}), f(n[e], {
                    on_disk: null
                }));
                o({
                    content: t,
                ...
                var n = {};
                n[t] = a.extend({}, g.overlay[t] || {}), f(n[t], e), o({
                    content: g.content,
                    overlay: a.extend({}, g.overlay, n)
                }, !0);
            ...
            a(t).on("removed", c), u.connect = function(e) {
                ...
                if (d) {
                    ...
                    if (!f) {
                        ...
                        b ? (v && o(), i(), c()) : (f.send("x"), a(f).on("message", function() {
                            x = !0, v && o(), i(), c(), n();
        ...
        var a = n(2), r = n(3), s = {}, l = "/etc/ssh/ssh_known_hosts", c = r.sessionStorage.prefixedKey("v2-machines.json"), d = r.sessionStorage.prefixedKey("v1-session-machine");
    ...
    !function() {
        ...
        function i(t, e, n, i) {
            ...
            h.try_to_connect = function(t, e) {
                ...
                var n;
                e.problem && "close" == e.command && (n = h.codes[e.problem]), n && y !== n ? r(n, e) : p(t).dialog("failure", m.message(e));
        ...
        function d(t, e) {
            ...
            function o() {
                ...
                a && (r = a["host-key"], i = a["host-fingerprint"], a["invalid-hostkey-file"] && (u = a["invalid-hostkey-file"])), 
                t.render({
        ...
        n(16);
        var y = n(17), x = n(18), w = n(19), k = n(20), _ = n(21), C = n(22), M = n(23), T = n(24), S = n(25), z = m.gettext, A = {
        ...
        !function() {
            function e() {
                function t() {
                    ...
                    })), u || (window.clearTimeout(f), f = null, u = i.script(a, [ c.path ], {
                        err: "message"
                    }).always(function() {
                ...
                i.user().done(function(e) {
                    ...
                    var r, l = [ /.*Enter old passphrase: $/ ], d = [ /.*Enter new passphrase.*/, /.*Enter same passphrase again: $/ ], u = [ /.*failed: passphrase is too short.*/ ], f = o.Deferred(), h = "", p = !1, m = s("No such file or directory");
                    if (n !== a) return f.reject(new Error(s("The passwords do not match."))), f.promise();
                    ...
                    return g = i.spawn([ "ssh-keygen", "-p", "-f", t ], {
                        ...
                        for (h += t, r = 0; r < l.length; r++) if (l[r].test(h)) return h = "", m = s("Old password not accepted"), 
                        void this.input(e + "\n", !0);
                    ...
                    var a, r = /.*Enter passphrase for .*/, l = /.*UNPROTECTED PRIVATE KEY FILE.*/, d = /.*Bad passphrase.*/, u = o.Deferred(), f = "", h = "", p = s("Not a valid private key"), m = !1, g = window.setTimeout(function() {
                    ...
                    return a = i.spawn([ "ssh-add", e ], {
                        ...
                        f += t, h += t, l.test(f) ? (p = s("Invalid file permissions"), f = "") : r.test(f) ? (f = "", 
            ...
            var o = n(2), i = n(3), a = n(14), r = n(15), s = i.gettext;
            t.exports = {
    ...
    function i(t) {
        var e, n = f[t];
        return n || (e = d.default.defer(), f[t] = n = e.promise(), d.default.spawn([ "cat", "/proc/meminfo", "/proc/cpuinfo" ], {
            host: t
        }).done(function(t) {
            var n = {}, o = t.match(/MemTotal:[^0-9]*([0-9]+) [kK]B/), i = o && parseInt(o[1], 10);
            i && (n.memory = 1024 * i), o = t.match(/^model name\s*:\s*(.*)$/m), o && (n.cpu_model = o[1]), 
            n.cpus = 0;
            for (var a = /^processor/gm; a.test(t); ) n.cpus += 1;
            e.resolve(n);
        }).fail(function() {
            e.reject();
        })), n;
    ...
    function a(t) {
        ...
        return t.split("\n").map(function(t) {
            ...
            if (!(n <= 0)) {
                ...
                e[o] = i, "chassis_type" === o && (e[o + "_str"] = h[parseInt(i)] || h[2]);
            }
        }), e;
    }
    function r(t) {
    ...
    function o(t, e, n) {
        ...
        function u(t, e, n) {
            ...
            return A ? a.drawImage(v, w, k, _, _, 0, 0, t, e) : a.drawImage(v, 0, 0, T, T, 0, 0, t, e), 
            o.toDataURL(n);
        }
        function f() {
            var t, e, n;
