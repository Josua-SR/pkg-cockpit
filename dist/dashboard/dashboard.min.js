!function(t) {
    ...
    function o(t, e, n) {
        ...
        if (o) {
            ...
            l("#host-edit-sync-users").off("click"), l("#host-edit-sync-users").on("click", function() {
                ...
                l("#host-edit-fail").text(m("Can't load image")).show();
            });
        }
    }
    function i() {
    ...
    !function(t) {
        ...
        function n(n, i, a, r) {
            ...
            function x() {
                it.grid.hoverable && (st.mousemove(q), st.bind("mouseleave", J)), it.grid.clickable && st.click(V), 
                s(mt.bindEvents, [ st ]);
            }
            function w() {
                bt && clearTimeout(bt), st.unbind("mousemove", q), st.unbind("mouseleave", J), st.unbind("click", V), 
                s(mt.shutdown, [ st ]);
            }
            function k(t) {
                function e(t) {
            ...
            function O() {
                ...
                s(mt.draw, [ lt ]), t.show && t.aboveData && j(), at.render(), G();
            }
            function W(t, e) {
