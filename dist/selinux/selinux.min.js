!function(e) {
    ...
    "use strict";
    var a = n(6), s = a.gettext, r = n(7), i = n(8), d = n(131), o = n(132), _ = function(e) {
        function t(e) {
            n.capabilities = e, M();
        }
        var n = {};
        ...
        var m = function(e, t) {
            ...
            r.render(r.createElement(o.SETroubleshootPage, {
        ...
        var L = function(e) {
            n.client.getAlert(e).done(function(t) {
                f(e, t.summary, t.reportCount, t), M();
            }).fail(function(t) {
                f(e, void 0, void 0, null), M();
            });
        };
        n.getAlertDetails = L;
        var y = function() {
            ...
            null !== n.connecting && (n.error = s("Not connected"), M());
        };
        return n.connectionTimeout = 5e3, n.tryConnect = function() {
            ...
            M(), n.client.init(t).done(function(e) {
                n.connected = !0, window.clearTimeout(n.connecting), n.connecting = null, M(), n.client.handleAlert(n.handleAlert), 
                n.client.getAlerts().done(p).fail(function() {
                    console.error("Unable to get setroubleshootd messages"), y();
                });
            }).fail(function(e) {
                n.connected = !1, window.clearTimeout(n.connecting), n.connecting = null, M();
            }));
        }, M(), n.tryConnect(), n;
    };
    ...
    !function(t, n) {
        ...
        function t(e, t, n) {
            ...
            return a ? a === Ie ? s = o(e, t, n) : a === Ue ? s = y(e, t, n) : a === Je ? s = M(e, t, n) : a === Ge && (s = document.createComment("react-text: " + (e.uid || de()))) : s = document.createTextNode(e), 
            s;
        }
        function n(e, t, n, s) {
            var r = e.vtype;
        ...
        function m(e, t, n, a, s) {
            if (a.vchildren) {
                ...
                if (0 !== o) if (0 !== _) {
                    ...
                    for (var M = 0; M < _; M++) {
                        var g = l[M];
                        g ? g.vnode.vtype === Ie && m(e, g.vnode, g.newVnode, g.node, g.parentContext) : (h || (h = []), 
                        se(h, {
                            vnode: d[M],
                            parentNode: a,
                            parentContext: s,
        ...
        var ze = "dangerouslySetInnerHTML", Ne = "http://www.w3.org/2000/svg", Re = "liteid", Ie = 2, Je = 3, Ue = 4, Ge = 5, Ve = 1, $e = 9, Be = 11, qe = null, Ke = [], Ze = [], Qe = {
            updaters: [],
            isPending: !1,
            add: function(e) {
                se(this.updaters, e);
    ...
    "use strict";
    var a = n(6), s = a.gettext, r = n(9), i = {}, d = "org.fedoraproject.Setroubleshootd", o = "org.fedoraproject.SetroubleshootdIface", _ = "/org/fedoraproject/Setroubleshootd", u = "org.fedoraproject.SetroubleshootFixit", l = u, m = "/org/fedoraproject/SetroubleshootFixit/object";
    i.init = function(e) {
        function t(e, t, n) {
    ...
    (function(e) {
        !function(t, n) {
            ...
            function tt(e, t) {
                var n;
                return e && (n = d(t) ? st(e) : nt(e, t), n && (Ws = n)), Ws._abbr;
            }
            function nt(e, t) {
                if (null !== t) {
                    var n = Cs;
                    ...
                    n = zs[e]._config; else if (null != t.parentLocale) {
                        if (null == zs[t.parentLocale]) return Ns[t.parentLocale] || (Ns[t.parentLocale] = []), 
                        Ns[t.parentLocale].push({
                            name: e,
                            config: t
                        }), null;
                        n = zs[t.parentLocale]._config;
                    }
                    return zs[e] = new x(H(n, t)), Ns[e] && Ns[e].forEach(function(e) {
                        nt(e.name, e.config);
                    }), tt(e), zs[e];
                }
            ...
            function yt(e) {
                ...
                for (s = $(e._f, e._locale).match(Ja) || [], n = 0; n < s.length; n++) r = s[n], 
            ...
            var Wa = {
                ...
                y: "a year",
                yy: "%d years"
            }, Ra = {}, Ia = {}, Ja = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, Ua = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Ga = {}, Va = {}, $a = /\d/, Ba = /\d\d/, qa = /\d{3}/, Ka = /\d{4}/, Za = /[+-]?\d{6}/, Qa = /\d\d?/, Xa = /\d\d\d\d?/, es = /\d\d\d\d\d\d?/, ts = /\d{1,3}/, ns = /\d{1,4}/, as = /[+-]?\d{1,6}/, ss = /\d+/, rs = /[+-]?\d+/, is = /Z|[+-]\d\d:?\d\d/gi, ds = /Z|[+-]\d\d(?::?\d\d)?/gi, os = /[+-]?\d+(\.\d{1,3})?/, _s = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, us = {}, ls = {}, ms = 0, cs = 1, hs = 2, Ms = 3, fs = 4, ps = 5, Ls = 6, ys = 7, Ys = 8;
            J("Y", 0, 0, function() {
                var e = this.year();
                return e <= 9999 ? "" + e : "+" + e;
            }), J(0, [ "YY", 2 ], 0, function() {
            ...
            ur.utcOffset = Rt, ur.utc = Jt, ur.local = Ut, ur.parseZone = Gt, ur.hasAlignedHourOffset = Vt, 
            ...
            jr.lang = sr, J("X", 0, 0, "unix"), J("x", 0, 0, "valueOf"), B("x", rs), B("X", os), 
            Q("X", function(e, t, n) {
                n._d = new Date(1e3 * parseFloat(e, 10));
            }), Q("x", function(e, t, n) {
                n._d = new Date(g(e));
            }), t.version = "2.20.1", a(bt), t.fn = ur, t.min = Ht, t.max = xt, t.now = Zs, 
    ...
    var i = n(6), d = a(i), o = 1e4, _ = "sestatus", u = {
        enabled: void 0,
        enforcing: !1,
        configEnforcing: !1
    };
    ...
    "use strict";
    var a = n(6), s = a.gettext, r = n(7), i = n(133), d = n(136).OnOffSwitch, o = r.createClass({
