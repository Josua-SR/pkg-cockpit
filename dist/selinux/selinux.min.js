!function(e) {
    ...
    var a = n(2), r = a.gettext, s = n(3), i = n(4), o = n(93), d = n(94), u = function(e) {
        ...
        var M = function(e, t, a, r) {
            ...
            var t, a;
            for (t = 0; t != e.length; ++t) a = e[t], M(a.localId, a.summary, a.reportCount, void 0), 
        ...
        var L = function(e) {
            n.client.getAlert(e).done(function(t) {
                M(e, t.summary, t.reportCount, t), p();
            }).fail(function(t) {
                M(e, void 0, void 0, null), p();
            });
        };
        n.getAlertDetails = L;
        var y = function() {
    ...
    !function(t, n) {
        ...
        function s(e, t) {
            var n = e.vtype;
            n === ve ? u(e, t) : n === De ? M(e, t) : n === ke && m(e, t);
        }
        function i(e, t, n) {
        ...
        function d(e, t, n, a) {
            var i = e.props, u = e.type, _ = t.props, m = i.dangerouslySetInnerHTML && i.dangerouslySetInnerHTML.__html, c = _.children, h = n.vchildren, M = n.childNodes, f = n.namespaceURI, L = u.indexOf("-") >= 0 || null != i.is, y = h.length, Y = n.vchildren = [];
            Be(c) ? R(c, o, Y) : o(c, Y);
            var g = Y.length;
            if (null == m && y) {
                ...
                e: for (var w = 0; w < y; w++) {
                    var b = h[w];
                    if (null !== b) {
                        for (var x = b.type, j = b.key, E = b.refs, P = M[w], S = 0; S < g; S++) if (!T[S]) {
                            var H = Y[S];
                ...
                for (var w = 0; w < g; w++) {
                    ...
                    if (W) {
                        ...
                        if (H !== b) {
                            var O = H.vtype;
                            O ? O === ve ? F = d(b, H, F, a) : O === De ? F = p(b, H, F, a) : O === ke && (F = l(b, H, F, a)) : F.nodeValue = H;
                        }
                        var C = M[w];
                        C !== F && n.insertBefore(F, C || null);
                    } else {
                        var F = r(H, a, f);
                        n.insertBefore(F, M[w] || null);
                    }
                }
                K(n, i, _, L);
            } else {
        ...
        function Y(e, t, n, a) {
            ...
            i = r(t, a, n.namespaceURI), n.parentNode.replaceChild(i, n); else if (e !== t) {
                var o = e.vtype;
                o === ve ? i = d(e, t, n, a) : o === De ? i = p(e, t, n, a) : o === ke && (i = l(e, t, n, a));
            }
            return i;
        }
        function g() {
        ...
        function ie(a, r, s) {
            ...
            var h = arguments.length, p = s;
            if (h > 3) {
                p = Array(h - 2);
                for (var M = 2; M < h; M++) p[M - 2] = arguments[M];
            }
            void 0 !== p && (_.children = p);
            var f = i(a, _);
        ...
        !function(t, n) {
            ...
            function Se(e) {
                ...
                return e._locale = e._locale || w(e._l), null === t || void 0 === n && "" === t ? c({
                    nullInput: !0
                }) : ("string" == typeof t && (e._i = t = e._locale.preparse(t)), M(t) ? new p(ee(t)) : (r(n) ? Te(e) : n ? ke(e) : s(t) ? e._d = t : He(e), 
                e));
            }
            function He(e) {
                var n = e._i;
            ...
            function ze(e, n) {
                var a, r;
                return n._isUTC ? (a = n.clone(), r = (M(e) || s(e) ? +e : +je(e)) - +a, a._d.setTime(+a._d + r), 
            ...
            function it(e, t) {
                var n;
                return t = S("undefined" != typeof t ? t : "millisecond"), "millisecond" === t ? (e = M(e) ? e : je(e), 
                +this > +e) : (n = M(e) ? +e : +je(e), n < +this.clone().startOf(t));
            }
            function ot(e, t) {
                var n;
                return t = S("undefined" != typeof t ? t : "millisecond"), "millisecond" === t ? (e = M(e) ? e : je(e), 
                +this < +e) : (n = M(e) ? +e : +je(e), +this.clone().endOf(t) < n);
            }
            function dt(e, t, n) {
            ...
            function ut(e, t) {
                var n;
                return t = S(t || "millisecond"), "millisecond" === t ? (e = M(e) ? e : je(e), +this === +e) : (n = +je(e), 
            ...
            var pa = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), Ma = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), fa = {};
            ...
            Ja.from = pt, Ja.fromNow = Mt, Ja.to = ft, Ja.toNow = Lt, Ja.get = P, Ja.invalidAt = xt, 
            ...
            Ja.quarter = Ja.quarters = Ot, Ja.month = X, Ja.daysInMonth = Q, Ja.week = Ja.weeks = pe, 
            Ja.isoWeek = Ja.isoWeeks = Me, Ja.weeksInYear = Ft, Ja.isoWeeksInYear = Wt, Ja.date = Ea, 
            ...
            Za._monthsShort = Ma, Za.monthsParse = Z, Za.week = me, Za._week = ka, Za.firstDayOfYear = he, 
            ...
            var Ka = Math.abs, Xa = bn("ms"), Qa = bn("s"), er = bn("m"), tr = bn("h"), nr = bn("d"), ar = bn("w"), rr = bn("M"), sr = bn("y"), ir = Hn("milliseconds"), or = Hn("seconds"), dr = Hn("minutes"), ur = Hn("hours"), _r = Hn("days"), lr = Hn("months"), mr = Hn("years"), cr = Math.round, hr = {
                ...
                d: 26,
                M: 11
            }, pr = Math.abs, Mr = We.prototype;
            Mr.abs = fn, Mr.add = yn, Mr.subtract = Yn, Mr.as = Tn, Mr.asMilliseconds = Xa, 
            ...
            Mr.weeks = xn, Mr.months = lr, Mr.years = mr, Mr.humanize = An, Mr.toISOString = Wn, 
            Mr.toString = Wn, Mr.toJSON = Wn, Mr.locale = yt, Mr.localeData = Yt, Mr.toIsoString = ne("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Wn), 
            Mr.lang = ja, W("X", 0, 0, "unix"), W("x", 0, 0, "valueOf"), U("x", na), U("X", ra), 
            G("X", function(e, t, n) {
            ...
            t.weekdaysMin = Mn, t.defineLocale = T, t.weekdaysShort = pn, t.normalizeUnits = S, 
    ...
    "use strict";
    var a = n(2), r = a.gettext, s = n(3), i = (n(5), n(95)), o = n(100).OnOffSwitch, d = s.createClass({
        ...
        render: function() {
            ...
            if (this.props.connected) {
                var t, n = this.props.entries.map(function(t) {
                    ...
                    var o;
                    t.details && (o = e.handleDeleteAlert.bind(e, t.details.localId));
                    var _ = s.createElement("button", {
                        title: "Dismiss",
                        className: "pficon pficon-delete btn btn-danger",
                        onClick: o,
                        disabled: !o || !e.props.deleteAlert
                    }), l = [ {
                        name: r("Solutions"),
                        renderer: d,
                        data: t
            ...
            var o, l;
            return this.props.connecting ? (o = s.createElement("div", {
                className: "spinner spinner-lg"
            }), l = r("Connecting...")) : (o = s.createElement("i", {
    ...
    var s = r.createClass({
        ...
        render: function() {
            ...
            if (this.state.expanded) {
                ...
                }, m)), _ === this.state.activeTab ? p.push(r.createElement("div", {
                    className: "listing-ct-body",
                    key: _
                }, c)) : p.push(r.createElement("div", {
                    className: "listing-ct-body",
                    key: _,
                    hidden: !0
                }, c)));
