!function(e) {
    ...
    !function(t, n) {
        ...
        function e(e, t, n, r, a) {
            ...
            return e !== We && e !== He || (o.uid = le()), o;
        }
        function t(e, t, n) {
            var r = e.vtype, a = null;
            return r ? r === Ve ? a = s(e, t, n) : r === He ? a = y(e, t, n) : r === We ? a = h(e, t, n) : r === $e && (a = document.createComment("react-text: " + (e.uid || le()))) : a = document.createTextNode(e), 
            a;
        }
        function n(e, t, n, a) {
            var o = e.vtype;
        ...
        function a(e) {
            if (e) {
                ...
                e.shouldIgnore || (t.vtype ? t.vtype === Ve ? f(t, e.newVnode, n, e.parentContext) : t.vtype === We ? n = g(t, e.newVnode, n, e.parentContext) : t.vtype === He && (n = b(t, e.newVnode, n, e.parentContext)) : n.replaceData(0, n.length, e.newVnode));
        ...
        function l(e, t) {
            var n = e.vtype;
            n === Ve ? m(e, t) : n === He ? E(e, t) : n === We && v(e, t);
        }
        function s(e, t, n) {
        ...
        function f(e, t, n) {
            ...
            return de(n, e.props, t.props, r), e.ref !== t.ref && (I(e.refs, e.ref, n), O(t.refs, t.ref, n)), 
            n;
        }
        function m(e, t) {
        ...
        function se(e, t, n, r) {
            Nt.test(t) ? D(e, t, n) : "style" === t ? H(e.style, n) : t === je ? n && null != n.__html && (e.innerHTML = n.__html) : r ? null == n ? e.removeAttribute(t) : e.setAttribute(t, "" + n) : J(e, t, n);
        }
        function ce(e, t, n, r) {
        ...
        function me(e, n, r, a) {
            ...
            Tt[o] = !0;
            var l = null, s = null;
            if (l = Ct[o]) s = S(l, e, n.firstChild, a); else {
            ...
            var p = null;
            return "object" == typeof i ? p = me(i.vnode, n, i.callback, i.parentContext) : e.vtype === Ve ? p = s : e.vtype === He && (p = s.cache[e.uid]), 
        ...
        var je = "dangerouslySetInnerHTML", Be = "http://www.w3.org/2000/svg", ze = "liteid", Ve = 2, We = 3, He = 4, $e = 5, Ge = 1, qe = 9, Ye = 11, Xe = null, Ke = [], Je = [], Ze = {
            updaters: [],
            isPending: !1,
            add: function(e) {
                ae(this.updaters, e);
        ...
        F.prototype = {
            ...
            forceUpdate: function(e) {
                ...
                if (n.isMounted) {
                    ...
                    var d = x(this), f = S(p, d, u, w(this, c));
        ...
        Ft.prototype = F.prototype, Me.prototype = Object.create(F.prototype), Me.prototype.constructor = Me, 
        Me.prototype.isPureReactComponent = !0, Me.prototype.shouldComponentUpdate = De;
        var Ut = ie({
            version: "0.15.1",
            cloneElement: Ee,
            isValidElement: be,
    ...
    function o(e, t, n) {
        ...
        }), n && (r = m.watch(e), o.push(r), m.addEventListener("notify", function(t) {
            e in t.detail && f in t.detail[e] && n(t.detail[e][f], e);
        })), o.push(m.subscribe({
            interface: f,
            path: e,
            member: "Finished"
    ...
    function i(e, t, n, r) {
        return new Promise(function(a, i) {
            m.call("/org/freedesktop/PackageKit", "org.freedesktop.PackageKit", "CreateTransaction", [], {
                timeout: 5e3
            }).done(function(l) {
                var s = l[0], c = void 0;
                (n || r) && (c = o(s, n, r)), c || (c = p.default.resolve()), c.done(function() {
                    e ? m.call(s, f, e, t).done(function() {
                        return a(s);
                    }).fail(i) : a(s);
                }).fail(i);
            }).fail(i);
    ...
    function l(e, t, n, r) {
        ...
        return new Promise(function(a, o) {
            function l(e, t) {
                function r() {
                    m.call(t, f, "Cancel", []), s = !0;
                }
                n && ("Status" in e && (c = e.Status), p.waiting = u && (c === d.STATUS_WAIT || c === d.STATUS_WAITING_FOR_LOCK), 
                "Percentage" in e && e.Percentage <= 100 && (p.percentage = e.Percentage), "AllowCancel" in e && (p.cancel = e.AllowCancel ? r : null), 
                n(p));
            }
            var s = !1, c = void 0, u = !1, p = {
                waiting: !1,
                percentage: 0,
                cancel: null
            };
    ...
    function s(e, t) {
        return e == d.INFO_SECURITY ? "pficon pficon-security" + (t ? " severity-" + t : "") : e >= d.INFO_NORMAL ? "fa fa-bug" : "pficon pficon-enhancement";
    }
    function c(e) {
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.dbus_client = t.transactionInterface = t.Enum = void 0, t.watchTransaction = o, 
    t.transaction = i, t.cancellableTransaction = l, t.getSeverityIcon = s, t.watchRedHatSubscription = c;
    var u = n(2), p = r(u), d = t.Enum = {
        EXIT_SUCCESS: 1,
        EXIT_FAILED: 2,
        EXIT_CANCELLED: 3,
    ...
    }, f = t.transactionInterface = "org.freedesktop.PackageKit.Transaction", m = t.dbus_client = p.default.dbus("org.freedesktop.PackageKit", {
        superuser: "try",
        track: !0
    }), h = [ 0, 3, 4 ];
}, function(e, t, n) {
