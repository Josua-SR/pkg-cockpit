!function(e) {
    ...
    var c = n(2), u = r(c), p = n(3), d = r(p), f = n(4), m = r(f), h = n(11), g = r(h), v = n(14), _ = r(v);
    n(9);
    ...
    !function(t, n) {
        ...
        function me(e, n, r, a) {
            ...
            Tt[o] = !0;
            var l = null, s = null;
            if (l = Ct[o]) s = O(l, e, n.firstChild, a); else {
            ...
            var p = null;
            return "object" == typeof i ? p = me(i.vnode, n, i.callback, i.parentContext) : e.vtype === ze ? p = s : e.vtype === He && (p = s.cache[e.uid]), 
        ...
        F.prototype = {
            ...
            forceUpdate: function(e) {
                ...
                if (n.isMounted) {
                    ...
                    var d = x(this), f = O(p, d, u, w(this, c));
        ...
        var lt = /^-?\d+(\.\d+)?$/, st = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", ct = st + "\\-.0-9\\uB7\\u0300-\\u036F\\u203F-\\u2040", ut = new RegExp("^[" + st + "][" + ct + "]*$"), pt = RegExp.prototype.test.bind(new RegExp("^(data|aria)-[" + ct + "]*$")), dt = {}, ft = 1, mt = 4, ht = 8, gt = 24, vt = 32, _t = {
            props: {
                accept: 0,
                acceptCharset: 0,
                accessKey: 0,
    ...
    function u(e, t, n) {
        function r(n, r) {
            ...
            t.ErrorCode && t.ErrorCode("close", v("PackageKit crashed")), t.Finished && t.Finished(_.EXIT_FAILED);
        }
        var a, o = [], i = s();
        return i.addEventListener("close", r), t && Object.keys(t).forEach(function(n) {
            ...
            e in t.detail && y in t.detail[e] && n(t.detail[e][y], e);
        })), o.push(i.subscribe({
            interface: y,
            path: e,
            member: "Finished"
    ...
    function p(e, t, n, r) {
        return new Promise(function(a, o) {
            c("/org/freedesktop/PackageKit", "org.freedesktop.PackageKit", "CreateTransaction", [], {
                ...
                var l = i[0], s = void 0;
                (n || r) && (s = u(l, n, r)), s || (s = g.default.resolve()), s.done(function() {
                    e ? c(l, y, e, t).done(function() {
                        return a(l);
                    }).fail(o) : a(l);
                }).fail(o);
            }).fail(o);
    ...
    function d(e, t, n, r) {
        ...
        return new Promise(function(a, o) {
            ...
            window.setTimeout(function() {
                u = !0, i({});
            }, 1e3), p(e, t, Object.assign({
                ErrorCode: function(e, t) {
                    n = null, o(new E(l ? "cancelled" : e, t));
                },
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.TransactionError = t.transactionInterface = t.Enum = void 0, t.call = c, t.watchTransaction = u, 
    t.transaction = p, t.cancellableTransaction = d, t.getSeverityIcon = f, t.watchRedHatSubscription = m;
    var h = n(2), g = r(h), v = g.default.gettext, _ = t.Enum = {
        EXIT_SUCCESS: 1,
        EXIT_FAILED: 2,
        EXIT_CANCELLED: 3,
    ...
    }, y = t.transactionInterface = "org.freedesktop.PackageKit.Transaction", b = null, E = t.TransactionError = function(e) {
        function t(e, n) {
            a(this, t);
