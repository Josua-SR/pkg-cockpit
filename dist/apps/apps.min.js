!function(e) {
    ...
    var l = function() {
    ...
    }(p.default.Component), v = [ "appstream-data" ], y = function(e) {
        function t() {
            a(this, t);
            var e = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this));
            return e.state = {
        ...
        return i(t, e), l(t, [ {
            ...
            value: function() {
                function e() {
                    f.default.refresh(t.props.metainfo_db.origin_files, v, function(e) {
                        return t.setState({
                            progress: e
                        });
                    }).always(function() {
    ...
    function u(e, t, n) {
        ...
        function s() {
            return r("SearchFiles", [ h, e ], a(0, 5, n), i);
        }
        function c() {
            return r("RefreshCache", [ !0 ], a(5, 70, n));
        }
        function u() {
            return r("GetUpdates", [ 0 ], a(75, 5, n), l).then(function() {
                if (m.length > 0) return r("UpdatePackages", [ 0, m ], a(80, 15, n));
            });
        }
        function d() {
            if (t.length > 0) return o("Resolve", y | _ | v | g, t, a(95, 1, n)).then(function(e) {
                if (e.length > 0) return r("InstallPackages", [ 0, e ], a(96, 4, n)).catch(function(e, t) {
                    if (t != b) return p.reject(e, t);
                });
            });
        }
        var f = {}, m = [];
        return s().then(c).then(u).then(d);
    }
