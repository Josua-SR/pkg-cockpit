!function(e) {
    ...
    function a() {
        m.default.render(d.default.createElement(g.default.ApplicationList, {
            metainfo_db: E
        }), document.getElementById("list"));
    }
    function o() {
        m.default.render(d.default.createElement(v.default.Application, {
            metainfo_db: E,
    ...
    var c = n(2), u = r(c), p = n(3), d = r(p), f = n(3), m = r(f), h = n(4), g = r(h), _ = n(12), v = r(_), y = n(15), b = r(y);
    n(9);
    var E = b.default.get_metainfo_db();
    document.addEventListener("DOMContentLoaded", function() {
        u.default.translate(), E.addEventListener("changed", function() {
            a(), o();
    ...
    !function(t, n) {
        ...
        function e(e, t, n, r, a) {
            ...
            return e !== Be && e !== Ge || (o.uid = le()), o;
        }
        function t(e, t, n) {
            var r = e.vtype, a = null;
            return r ? r === We ? a = s(e, t, n) : r === Ge ? a = y(e, t, n) : r === Be ? a = h(e, t, n) : r === He && (a = document.createComment("react-text: " + (e.uid || le()))) : a = document.createTextNode(e), 
            a;
        }
        function n(e, t, n, a) {
            var o = e.vtype;
            if (o === Ge) return b(e, t, n, a);
            if (o === Be) return g(e, t, n, a);
            if (o !== We) return n;
        ...
        function a(e) {
            if (e) {
                ...
                e.shouldIgnore || (t.vtype ? t.vtype === We ? f(t, e.newVnode, n, e.parentContext) : t.vtype === Be ? n = g(t, e.newVnode, n, e.parentContext) : t.vtype === Ge && (n = b(t, e.newVnode, n, e.parentContext)) : n.replaceData(0, n.length, e.newVnode));
        ...
        function l(e, t) {
            var n = e.vtype;
            n === We ? m(e, t) : n === Ge ? E(e, t) : n === Be && _(e, t);
        }
        function s(e, t, n) {
        ...
        function d(e, t, n, r, a) {
            if (r.vchildren) {
                ...
                if (0 !== s) if (0 !== c) {
                    for (var p = Array(c), f = null, m = null, h = 0; h < s; h++) for (var g = i[h], _ = 0; _ < c; _++) if (!p[_]) {
                        var v = l[_];
                        if (g === v) {
                            p[_] = {
                                shouldIgnore: L(r),
                    ...
                    for (var h = 0; h < s; h++) {
                        var y = i[h];
                        if (null !== y) {
                            for (var b = !0, _ = 0; _ < c; _++) if (!p[_]) {
                                var E = l[_];
                                if (E.type === y.type && E.key === y.key && E.refs === y.refs) {
                                    p[_] = {
                                        vnode: y,
                                        newVnode: E,
                                        node: o[h],
                    ...
                    for (var h = 0; h < c; h++) {
                        var k = p[h];
                        k ? k.vnode.vtype === We && d(e, k.vnode, k.newVnode, k.node, k.parentContext) : (m || (m = []), 
                        ae(m, {
                            vnode: l[h],
                            parentNode: r,
                            parentContext: a,
        ...
        function f(e, t, n) {
            ...
            return de(n, e.props, t.props, r), e.ref !== t.ref && (I(e.refs, e.ref, n), S(t.refs, t.ref, n)), 
            n;
        }
        function m(e, t) {
        ...
        function b(e, t, n, r) {
            ...
            return e.ref !== t.ref && (I(e.refs, e.ref, o), S(t.refs, t.ref, o)), i.emitUpdate(c, u), 
            l.node;
        }
        function E(e, t) {
        ...
        function S(e, t, n) {
            null != t && n && (n.nodeName && !n.getDOMNode && (n.getDOMNode = P), ee(t) ? t(n) : e && (e[t] = n));
        }
        function I(e, t, n) {
        ...
        function L(e) {
            ...
            if (t) for (var r = 0; r < t.length; r++) {
                var a = t[r];
                if ((a.vtype === Ge || a.vtype === Be) && a.type.contextTypes) return !1;
            }
        ...
        function $(e, t, n) {
            if (t !== n) {
                ...
                for (var r in t) n.hasOwnProperty(r) ? n[r] !== t[r] && q(e, r, n[r]) : e[r] = "";
                for (var r in n) t.hasOwnProperty(r) || q(e, r, n[r]);
            }
        }
        function Y(e, t) {
        ...
        function X(e) {
            ...
            for (var o in t) if (t.hasOwnProperty(o)) {
                ...
                dt[o] = {
                    ...
                    hasPositiveNumericValue: K(i, gt),
                    hasOverloadedBooleanValue: K(i, _t)
                };
            }
        }
        function K(e, t) {
        ...
        function se(e, t, n, r) {
            Nt.test(t) ? M(e, t, n) : "style" === t ? G(e.style, n) : t === je ? n && null != n.__html && (e.innerHTML = n.__html) : r ? null == n ? e.removeAttribute(t) : e.setAttribute(t, "" + n) : J(e, t, n);
        }
        function ce(e, t, n, r) {
            Nt.test(t) ? j(e, t) : "style" === t ? H(e.style, n) : t === je ? e.innerHTML = "" : r ? e.removeAttribute(t) : Z(e, t);
        }
        function ue(e, t, n, r, a) {
            if ("value" !== t && "checked" !== t || (r = e[t]), n !== r) return void 0 === n ? void ce(e, t, r, a) : void ("style" === t ? $(e.style, r, n) : se(e, t, n, a));
        }
        function pe(e, t, n) {
        ...
        function me(e, n, r, a) {
            ...
            Tt[o] = !0;
            var l = null, s = null;
            if (l = Ot[o]) s = C(l, e, n.firstChild, a); else {
            ...
            Ot[o] = e;
            var u = Ze.isPending;
            Ze.isPending = !0, O(), i = Tt[o], delete Tt[o];
            var p = null;
            return "object" == typeof i ? p = me(i.vnode, n, i.callback, i.parentContext) : e.vtype === We ? p = s : e.vtype === Ge && (p = s.cache[e.uid]), 
        ...
        function _e(e) {
            ...
            var t = e[Ve], n = null;
            return !!(n = Ot[t]) && (l(n, e.firstChild), e.removeChild(e.firstChild), delete Ot[t], 
            !0);
        }
        function ve(e) {
        ...
        function ye(t, n, r) {
            ...
            if ("string" == typeof t) a = We; else {
                ...
                a = t.prototype && t.prototype.isReactComponent ? Ge : Be;
            }
            var o = null, i = null, l = {};
        ...
        function Ee(e, t) {
            ...
            var c = ye.apply(void 0, [ n, o ].concat(l));
        ...
        function Ne(e, t, n) {
            ...
            return r.forEach(function(e) {
                ...
                if (null != t && "boolean" != typeof t) {
                    ...
                    0 !== a[n] && (n += ":" + r), i || (n = Pe(t.key || "") + "/" + n), t = Ee(t, {
                        key: n
                    }), ae(o, t);
                }
            }), o;
        ...
        function Fe(e) {
            function t(n, r) {
                F.call(this, n, r), this.constructor = t, e.autobind !== !1 && Le(this, t.prototype), 
        ...
        var je = "dangerouslySetInnerHTML", ze = "http://www.w3.org/2000/svg", Ve = "liteid", We = 2, Be = 3, Ge = 4, He = 5, $e = 1, Ye = 9, qe = 11, Xe = null, Ke = [], Je = [], Ze = {
            updaters: [],
            isPending: !1,
            add: function(e) {
                ae(this.updaters, e);
        ...
        F.prototype = {
            ...
            forceUpdate: function(e) {
                ...
                if (n.isMounted) {
                    ...
                    var d = x(this), f = C(p, d, u, w(this, c));
                    f !== u && (f.cache = f.cache || {}, A(f.cache, u.cache, f)), n.vnode = d, n.node = f, 
                    O(), this.componentDidUpdate && this.componentDidUpdate(r, a, o), e && e.call(this), 
        ...
        var lt = /^-?\d+(\.\d+)?$/, st = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", ct = st + "\\-.0-9\\uB7\\u0300-\\u036F\\u203F-\\u2040", ut = new RegExp("^[" + st + "][" + ct + "]*$"), pt = RegExp.prototype.test.bind(new RegExp("^(data|aria)-[" + ct + "]*$")), dt = {}, ft = 1, mt = 4, ht = 8, gt = 24, _t = 32, vt = {
            props: {
                accept: 0,
                acceptCharset: 0,
                accessKey: 0,
        ...
        Object.keys(Et).map(function(e) {
            kt.props[e] = 0, Et[e] && (kt.domAttrs[e] = Et[e]);
        }), X(vt), X(kt);
        var xt = Array.isArray, wt = 0, Nt = /^on/i;
        Object.freeze || (Object.freeze = ne);
        var Tt = {}, Ot = {}, Ct = Object.freeze({
            render: he,
        ...
        Ft.prototype = F.prototype, De.prototype = Object.create(F.prototype), De.prototype.constructor = De, 
        ...
        return Ut.__SECRET_DOM_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Ct, Ut;
    });
}, function(e, t, n) {
    "use strict";
    function r(e) {
    ...
    }(), s = n(2), c = r(s), u = n(3), p = r(u), d = n(5), f = r(d), m = n(7), h = c.default.gettext, g = function(e) {
        function t() {
            a(this, t);
    ...
    }(p.default.Component), _ = function(e) {
        function t() {
            a(this, t);
            var e = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this));
            return e.state = {
        ...
        return i(t, e), l(t, [ {
            ...
            value: function() {
                function e() {
                    ...
                    f.default.refresh(t.props.metainfo_db.origin_files, e.appstream_config_packages || [], e.appstream_data_packages || [], function(e) {
                        return t.setState({
                            progress: e
                        });
                    }).finally(function() {
                ...
                return this.state.progress ? (a = p.default.createElement(m.ProgressBar, {
                    ...
                    className: s
                }, p.default.createElement("caption", null, p.default.createElement("table", null, p.default.createElement("tbody", null, p.default.createElement("tr", null, p.default.createElement("td", null, p.default.createElement("h2", null, h("Applications"))), p.default.createElement("td", null, a), p.default.createElement("td", null, o))))), p.default.createElement("tbody", null, l));
            }
        } ]), t;
    }(p.default.Component);
    e.exports = {
    ...
    function l(e, t, n, r) {
        return i(e, t, [ n ], r).then(function(e) {
            return 0 === e.length ? Promise.reject(new h.TransactionError("not-found", "Can't resolve package")) : e[0];
        });
    }
    function s() {
        return f.default.dbus(null, {
            bus: "internal"
        }).call("/packages", "cockpit.Packages", "Reload", []);
    }
    function c(e, t) {
        return l("Resolve", h.Enum.FILTER_ARCH | h.Enum.FILTER_NOT_SOURCE | h.Enum.FILTER_NEWEST, e, o(0, 1, t)).then(function(e) {
            return h.cancellableTransaction("InstallPackages", [ 0, [ e ] ], o(1, 99, t)).then(s);
        });
    }
    function u(e, t) {
        return l("SearchFiles", h.Enum.FILTER_INSTALLED, e, o(0, 1, t)).then(function(e) {
            return h.cancellableTransaction("RemovePackages", [ 0, [ e ], !0, !1 ], o(1, 99, t)).then(s);
        });
    }
    function p(e, t, n, r) {
        function a() {
            return h.cancellableTransaction("SearchFiles", [ h.Enum.FILTER_INSTALLED, e ], o(5, 1, r), {
                Package: function(e, t) {
                    var n = t.split(";")[0];
                    u[n] = !0;
                }
        ...
        function l() {
            return h.cancellableTransaction("RefreshCache", [ !0 ], o(6, 69, r));
        }
        function s() {
            return h.cancellableTransaction("GetUpdates", [ 0 ], o(75, 5, r), {
                Package: function(e, t) {
                    var n = t.split(";")[0];
                    n in u && p.push(t);
                }
            }).then(function() {
                if (p.length > 0) return h.cancellableTransaction("UpdatePackages", [ 0, p ], o(80, 15, r));
            });
        }
        function c(e, t) {
            return e.length > 0 ? i("Resolve", h.Enum.FILTER_ARCH | h.Enum.FILTER_NOT_SOURCE | h.Enum.FILTER_NEWEST | h.Enum.FILTER_NOT_INSTALLED, e, o(t, 1, r)).then(function(e) {
                if (e.length > 0) return h.cancellableTransaction("InstallPackages", [ 0, e ], o(t + 1, 4, r)).catch(function(e) {
                    if (e.code != h.Enum.ERROR_ALREADY_INSTALLED) return Promise.reject(e);
                });
            }) : Promise.resolve();
        }
        var u = {}, p = [];
        return c(t, 0).then(a).then(l).then(s).then(function() {
            return c(n, 95);
        });
    }
    var d = n(2), f = a(d), m = n(6), h = r(m);
    e.exports = {
        install: c,
        remove: u,
        refresh: p
    ...
    function s() {
        return null === x && (x = y.default.dbus("org.freedesktop.PackageKit", {
            superuser: "try",
            track: !0
    ...
    function d(e, t, n, r) {
        return new Promise(function(a, o) {
            c("/org/freedesktop/PackageKit", "org.freedesktop.PackageKit", "CreateTransaction", []).done(function(i) {
                var l = i[0], s = void 0;
                (n || r) && (s = p(l, n, r)), s || (s = y.default.resolve()), s.done(function() {
                    e ? c(l, k, e, t).done(function() {
                        return a(l);
                    }).fail(o) : a(l);
                }).fail(o);
            }).fail(o);
        ...
        return new Promise(function(a, o) {
            ...
            window.setTimeout(function() {
                ...
                ErrorCode: function(e, t) {
                    n = null, o(new w(l ? "cancelled" : e, t));
                },
    ...
    function g(e, t) {
        ...
        function r() {
            i.missing_ids = [];
            var n = {};
            return f("Resolve", [ E.FILTER_ARCH | E.FILTER_NOT_SOURCE | E.FILTER_NEWEST, e ], t, {
                Package: function(e, t) {
        ...
        function a(e) {
            ...
            e.missing_ids.length > 0 && 0 === e.unavailable_names.length ? f("InstallPackages", [ E.TRANSACTION_FLAG_SIMULATE, e.missing_ids ], t, {
    ...
    t.watchTransaction = p, t.transaction = d, t.cancellableTransaction = f, t.getSeverityIcon = m, 
    t.watchRedHatSubscription = h, t.check_missing_packages = g, t.install_missing_packages = _;
    var v = n(2), y = r(v), b = y.default.gettext, E = t.Enum = {
        EXIT_SUCCESS: 1,
        EXIT_FAILED: 2,
        EXIT_CANCELLED: 3,
    ...
    }, k = t.transactionInterface = "org.freedesktop.PackageKit.Transaction", x = null, w = t.TransactionError = function(e) {
        function t(e, n) {
            a(this, t);
    ...
    t.icon_url = o;
    var i = n(2), l = r(i), s = n(3), c = r(s), u = n(8), p = l.default.gettext;
    t.ProgressBar = function(e) {
        ...
        "cancelled" != e.code && ("not-found" == e.code && (e.detail = p("No installation package found for this application.")), 
    ...
    var l = a.createClass({
        ...
        function n() {
            null !== d.props && void 0 !== d.props || (d.props = {}), d.props.footer = a.createElement(l, d.footerProps), 
            d.render();
        }
        ...
        var u, p = function() {
            u && u.apply(this, arguments), o.unmountComponentAtNode(c), c.remove();
        }, d = {};
        return d.props = null, d.footerProps = null, d.render = function() {
            d.props.footer = a.createElement(l, d.footerProps), o.render(a.createElement(s, d.props), c);
            ...
            d.footerProps.dialog_done != p && (u = d.footerProps.dialog_done, d.footerProps.dialog_done = p), 
            n();
    ...
    }(), s = n(2), c = r(s), u = n(3), p = r(u), d = n(5), f = r(d), m = n(7);
    n(13);
            ...
            value: function() {
                ...
                function a(e) {
                    return e ? e.map(function(e, t) {
                        return "ul" == e.tag ? p.default.createElement("ul", {
                            key: "paragraph-" + t
                        }, e.items.map(function(e) {
                            return p.default.createElement("li", {
                                key: e
                            }, e);
                        })) : "ol" == e.tag ? p.default.createElement("ol", {
                            key: "paragraph-" + t
                        }, e.items.map(function(e) {
                            return p.default.createElement("li", {
                                key: e
                ...
                function o() {
                    ...
                    }, a(l.description)), p.default.createElement("center", null, l.screenshots.map(function(e, t) {
    ...
    var a = n(2), o = n(16), i = n(17), l = n(18), s = null;
    e.exports = {
        get_metainfo_db: r
    };
}, function(e, t, n) {
