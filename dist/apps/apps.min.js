!function(e) {
    ...
    !function(t, n) {
        ...
        function Me(e) {
            function t(n, r) {
                M.call(this, n, r), this.constructor = t, e.autobind !== !1 && Re(this, t.prototype), 
    ...
    function r(e, t, n, r) {
        var a = p.defer();
        return d.call("/org/freedesktop/PackageKit", "org.freedesktop.PackageKit", "CreateTransaction", []).done(function(o) {
            function i() {
                s.Cancel(), c = !0;
            }
            function l() {
                if (n && "pending" == a.promise().state()) {
                    ...
                    !u || s.Status != f && s.Status != m || (e.waiting = !0), void 0 !== s.Percentage && 101 !== s.Percentage && (e.percentage = s.Percentage), 
                    s.AllowCancel && (e.cancel = i), n(e);
                }
            }
            var s = d.proxy("org.freedesktop.PackageKit.Transaction", o[0]), c = !1, u = !1;
    ...
    function i(e, t, n, r) {
        return o(e, t, [ n ], r).then(function(e) {
            return 0 === e.length ? p.reject("Can't resolve package", "not-found") : e[0];
        });
    }
    function l() {
        return p.dbus(null, {
    ...
    function s(e, t) {
        return i("Resolve", y | _ | v, e, a(0, 1, t)).then(function(e) {
            return r("InstallPackages", [ 0, [ e ] ], a(1, 99, t)).then(l);
        });
    }
    function c(e, t) {
        return i("SearchFiles", h, e, a(0, 1, t)).then(function(e) {
            return r("RemovePackages", [ 0, [ e ], !0, !1 ], a(1, 99, t)).then(l);
        });
    }
    function u(e, t, n, i) {
        function l(e, t) {
        ...
        function c() {
            return r("SearchFiles", [ h, e ], a(5, 1, i), l);
        }
        function u() {
            return r("RefreshCache", [ !0 ], a(6, 69, i));
        }
        function d() {
            return r("GetUpdates", [ 0 ], a(75, 5, i), s).then(function() {
                if (x.length > 0) return r("UpdatePackages", [ 0, x ], a(80, 15, i));
            });
        }
        function f(e, t) {
            return e.length > 0 ? o("Resolve", y | _ | v | g, e, a(t, 1, i)).then(function(e) {
                if (e.length > 0) return r("InstallPackages", [ 0, e ], a(t + 1, 4, i)).catch(function(e, t) {
                    if (t != b) return p.reject(e, t);
                });
            }) : p.resolve();
        }
        var m = {}, x = [];
        return f(t, 0).then(c).then(u).then(d).then(function() {
            return f(n, 95);
        });
    }
    var p = n(2), d = p.dbus("org.freedesktop.PackageKit", {
        superuser: "try"
    }), f = 1, m = 30, h = 4, g = 8, v = 65536, y = 1 << 18, _ = 1 << 21, b = 9;
    e.exports = {
        install: s,
        remove: c,
        refresh: u
