!function(e) {
    ...
    !function(t, n) {
        ...
        function e(e, t, n, r, a) {
            ...
            return e !== $e && e !== We || (o.uid = le()), o;
        }
        function t(e, t, n) {
            var r = e.vtype, a = null;
            return r ? r === Ve ? a = s(e, t, n) : r === We ? a = _(e, t, n) : r === $e ? a = h(e, t, n) : r === qe && (a = document.createComment("react-text: " + (e.uid || le()))) : a = document.createTextNode(e), 
            a;
        }
        function n(e, t, n, a) {
            var o = e.vtype;
            if (o === We) return b(e, t, n, a);
            if (o === $e) return g(e, t, n, a);
            if (o !== Ve) return n;
        ...
        function a(e) {
            if (e) {
                ...
                e.shouldIgnore || (t.vtype ? t.vtype === Ve ? f(t, e.newVnode, n, e.parentContext) : t.vtype === $e ? n = g(t, e.newVnode, n, e.parentContext) : t.vtype === We && (n = b(t, e.newVnode, n, e.parentContext)) : n.replaceData(0, n.length, e.newVnode));
        ...
        function l(e, t) {
            var n = e.vtype;
            n === Ve ? m(e, t) : n === We ? x(e, t) : n === $e && v(e, t);
        }
        function s(e, t, n) {
        ...
        function M(e) {
            ...
            if (t) for (var r = 0; r < t.length; r++) {
                var a = t[r];
                if ((a.vtype === We || a.vtype === $e) && a.type.contextTypes) return !1;
            }
        ...
        function H(e, t, n) {
            if (t !== n) {
                ...
                for (var r in t) n.hasOwnProperty(r) ? n[r] !== t[r] && G(e, r, n[r]) : e[r] = "";
                for (var r in n) t.hasOwnProperty(r) || G(e, r, n[r]);
            }
        }
        function X(e, t) {
        ...
        function se(e, t, n, r) {
            Nt.test(t) ? F(e, t, n) : "style" === t ? W(e.style, n) : t === je ? n && null != n.__html && (e.innerHTML = n.__html) : r ? null == n ? e.removeAttribute(t) : e.setAttribute(t, "" + n) : K(e, t, n);
        }
        function ce(e, t, n, r) {
            Nt.test(t) ? j(e, t) : "style" === t ? q(e.style, n) : t === je ? e.innerHTML = "" : r ? e.removeAttribute(t) : Z(e, t);
        }
        function ue(e, t, n, r, a) {
            if ("value" !== t && "checked" !== t || (r = e[t]), n !== r) return void 0 === n ? void ce(e, t, r, a) : void ("style" === t ? H(e.style, r, n) : se(e, t, n, a));
        }
        function pe(e, t, n) {
        ...
        function fe(e) {
            return !(!e || e.nodeType !== He && e.nodeType !== Xe && e.nodeType !== Ge);
        }
        function me(e, n, r, a) {
            ...
            var p = null;
            return "object" == typeof i ? p = me(i.vnode, n, i.callback, i.parentContext) : e.vtype === Ve ? p = s : e.vtype === We && (p = s.cache[e.uid]), 
        ...
        function _e(t, n, r) {
            ...
            if ("string" == typeof t) a = Ve; else {
                ...
                a = t.prototype && t.prototype.isReactComponent ? We : $e;
            }
            var o = null, i = null, l = {};
        ...
        var je = "dangerouslySetInnerHTML", ze = "http://www.w3.org/2000/svg", Be = "liteid", Ve = 2, $e = 3, We = 4, qe = 5, He = 1, Xe = 9, Ge = 11, Ye = null, Je = [], Ke = [], Ze = {
            updaters: [],
            isPending: !1,
            add: function(e) {
                ae(this.updaters, e);
        ...
        return Dt.__SECRET_DOM_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Ot, Dt;
    });
}, function(e, t, n) {
    "use strict";
    function r(e) {
    ...
    var h = c.default.gettext, g = function(e) {
        ...
        return i(t, e), l(t, [ {
            ...
            value: function() {
                ...
                function t() {
                    e(f.default.install, i.pkgname, h("Installing"));
                }
                function n() {
                    e(f.default.remove, i.file, h("Removing"));
                }
                function r(e) {
                ...
                function a() {
                    if (!i) return u.ready ? p.default.createElement("div", null, h("Unknown Application")) : p.default.createElement("div", {
                        className: "spinner"
                    });
                    var e, a;
                    return s.progress ? (e = p.default.createElement(m.ProgressBar, {
                        title: l.state.progress_title,
                        data: l.state.progress
                    }), a = p.default.createElement(m.CancelButton, {
                        data: l.state.progress
                    })) : i.installed ? (e = p.default.createElement("a", {
                        onClick: (0, m.left_click)(function() {
                            return (0, m.launch)(i);
                        })
                    }, h("Go to Application")), a = p.default.createElement("button", {
                        className: "btn btn-danger",
                        onClick: (0, m.left_click)(n)
                    }, h("Remove"))) : (e = null, a = p.default.createElement("button", {
                        className: "btn btn-default",
                        onClick: (0, m.left_click)(t)
                        ...
                        src: (0, m.icon_url)(i.icon)
                    })), p.default.createElement("td", null, i.summary), p.default.createElement("td", null, e), p.default.createElement("td", null, a)))), p.default.createElement("div", {
                        className: "app-description"
                    }, r(i.description)), p.default.createElement("center", null, i.screenshots.map(function(e) {
                ...
                var i, l = this, s = this.state, u = this.props.metainfo_db;
                return this.props.id ? (i = u.components[this.props.id], p.default.createElement("div", null, p.default.createElement("ol", {
                    className: "breadcrumb"
                }, p.default.createElement("li", null, p.default.createElement("a", {
                    onClick: (0, m.left_click)(o)
                }, h("Applications"))), p.default.createElement("li", {
                    className: "active"
                }, i ? i.name : this.props.id)), a())) : null;
            }
        } ]), t;
    }(p.default.Component);
    e.exports = {
    ...
    function r() {
        if (!l) {
            ...
            }).input(o).stream(function(t) {
                var n, r;
                e += t, n = e.split("\n"), e = n[n.length - 1], n.length >= 2 && (r = JSON.parse(n[n.length - 2]), 
                l.components = r.components, l.origin_files = r.origin_files, l.ready = !0, l.dispatchEvent("changed"));
            }).fail(function(e) {
    ...
    var a = n(2), o = n(14), i = [ "sh", "-ec", "exec $(which python3 2>/dev/null || which python) $@", "--", "-" ], l = null;
    e.exports = {
        get_metainfo_db: r
    };
}, function(e, t) {
