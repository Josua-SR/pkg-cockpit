(function(e) {
    ...
    function x() {
        function t(t, n) {
            ...
            try {
                ...
                b(a(c("The web browser configuration prevents Cockpit from running (inaccessible $0)"), t));
                throw i;
            }
            if (o === undefined) {
        ...
        return ("MozWebSocket" in window || t("WebSocket", window)) && t("XMLHttpRequest", window) && t("sessionStorage", window) && t("JSON", window) && t("defineProperty", Object) && t("console", window) && t("pushState", window.history) && t("textContent", document);
    }
    function T(e) {
    ...
    function C() {
        ...
        if (!x()) return;
        h("show-other-login-options").addEventListener("click", O);
        h("show-other-login-options").addEventListener("keypress", O);
            ...
            if (i.readyState != 4) {
                ...
                if (s && s.toLowerCase().indexOf("x-conversation") === 0) {
                    ...
                    if (i.statusText.indexOf("authentication-not-supported") > -1) {
                        ...
                        b(a(c("The server refused to authenticate '$0' using password authentication, and no other supported authentication methods are available."), n));
