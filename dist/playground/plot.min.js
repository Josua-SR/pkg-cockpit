!function(t) {
    ...
    function i(t, e, n, i) {
        ...
        function s() {
            g && x.width() > 0 && x.height() > 0 ? (d ? f() : (r(), d = o.plot(v, n, p)), b && window.clearInterval(b)) : b || (b = window.setInterval(s, 500));
        }
        function c() {
            g = !1;
        }
    ...
    a.plot = function(t, e, n) {
        function i() {
            if (0 !== t.height() && 0 !== t.width()) {
                ...
                C.draw(), _.post_hook && _.post_hook(C);
            }
        }
        function a() {
