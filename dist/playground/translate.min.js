!function(t) {
    ...
    40: function(t, e, n) {
        "use strict";
        var r = n(4), i = n(2), o = n(41), a = n(43);
        n(44);
        var s = i.gettext, u = i.gettext;
        r(function() {
            i.translate();
            var t = s("Empty");
            r("#underscore-empty").text(t), t = s("verb", "Empty"), r("#underscore-context-empty").text(t), 
            t = u("verb", "Empty"), r("#cunderscore-context-empty").text(t), t = i.gettext("Control"), 
            r("#gettext-control").text(t), t = i.gettext("key", "Control"), r("#gettext-context-control").text(t), 
            t = i.ngettext("$0 disk is missing", "$0 disks are missing", 1), r("#ngettext-disks-1").text(t), 
            t = i.ngettext("$0 disk is missing", "$0 disks are missing", 2), r("#ngettext-disks-2").text(t), 
            t = i.ngettext("disk-non-rotational", "$0 disk is missing", "$0 disks are missing", 1), 
            r("#ngettext-context-disks-1").text(t), t = i.ngettext("disk-non-rotational", "$0 disk is missing", "$0 disks are missing", 2), 
            r("#ngettext-context-disks-2").text(t);
            var e = r("#mustache-input").text(), n = o.render(e);
            r("#mustache-output").empty().append(n);
            var c = a.module("playgroundTranslate", [ "gettext" ]);
            c.run([ "$rootScope", function(t) {
                i.transport.wait(function() {
                    t.$digest(), r("body").show();
                });
            } ]), a.bootstrap(document, [ "playgroundTranslate" ]);
        });
    },
    41: function(t, e, n) {
        "use strict";
        ...
        var i = n(2), o = n(42), a = {};
        t.exports = i.extend({}, o, {
            render: function(t, e, n) {
                return e || (e = {}), r(o.render(t, e, n));
            },
            to_html: function(t, e, n, i) {
                return e || (e = {}), r(o.to_html(t, e, n, i));
            },
            clearCache: function() {
	 ...
	 */
        !function(n, a) {
            "object" == typeof e && e && "string" != typeof e.nodeName ? a(e) : (i = [ e ], 
            r = a, o = "function" == typeof r ? r.apply(e, i) : r, !(void 0 !== o && (t.exports = o)));
        }(this, function(t) {
            function e(t) {
            ...
            function u(e, n) {
                function i() {
                    if (g && !m) for (;v.length; ) delete d[v.pop()]; else v = [];
                    g = !1, m = !1;
                }
                function o(t) {
                    if ("string" == typeof t && (t = t.split(w, 2)), !$(t) || 2 !== t.length) throw new Error("Invalid tags: " + t);
                    s = new RegExp(r(t[0]) + "\\s*"), u = new RegExp("\\s*" + r(t[1])), h = new RegExp("\\s*" + r("}" + t[1]));
                }
                if (!e) return [];
                var s, u, h, p = [], d = [], v = [], g = !1, m = !1;
                o(n || t.tags);
                for (var C, k, E, A, T, O, M = new f(e); !M.eos(); ) {
                    if (C = M.pos, E = M.scanUntil(s)) for (var N = 0, V = E.length; N < V; ++N) A = E.charAt(N), 
                    a(A) ? v.push(d.length) : m = !0, d.push([ "text", A, C, C + 1 ]), C += 1, "\n" === A && i();
                    if (!M.scan(s)) break;
                    if (g = !0, k = M.scan(S) || "name", M.scan(y), "=" === k ? (E = M.scanUntil(b), 
                    M.scan(b), M.scanUntil(u)) : "{" === k ? (E = M.scanUntil(h), M.scan(x), M.scanUntil(u), 
                    k = "&") : E = M.scanUntil(u), !M.scan(u)) throw new Error("Unclosed tag at " + M.pos);
                    if (T = [ k, E, C, M.pos ], d.push(T), "#" === k || "^" === k) p.push(T); else if ("/" === k) {
                        if (O = p.pop(), !O) throw new Error('Unopened section "' + E + '" at ' + C);
                        if (O[1] !== E) throw new Error('Unclosed section "' + O[1] + '" at ' + C);
                    } else "name" === k || "{" === k || "&" === k ? m = !0 : "=" === k && o(E);
                }
                if (O = p.pop()) throw new Error('Unclosed section "' + O[1] + '" at ' + M.pos);
                return l(c(d));
            }
            function c(t) {
                for (var e, n, r = [], i = 0, o = t.length; i < o; ++i) e = t[i], e && ("text" === e[0] && n && "text" === n[0] ? (n[1] += e[1], 
                n[3] = e[3]) : (r.push(e), n = e));
                return r;
            }
            function l(t) {
                for (var e, n, r = [], i = r, o = [], a = 0, s = t.length; a < s; ++a) switch (e = t[a], 
                e[0]) {
                  case "#":
                  case "^":
            ...
            var d = Object.prototype.toString, $ = Array.isArray || function(t) {
                return "[object Array]" === d.call(t);
            }, v = RegExp.prototype.test, g = /\S/, m = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
                '"': "&quot;",
            ...
            f.prototype.eos = function() {
                ...
                var n, r = this.cache;
                if (r.hasOwnProperty(t)) n = r[t]; else {
                    for (var o, a, s = this, u = !1; s; ) {
                        if (t.indexOf(".") > 0) for (n = s.view, o = t.split("."), a = 0; null != n && a < o.length; ) a === o.length - 1 && (u = i(n, o[a])), 
                        n = n[o[a++]]; else n = s.view[t], u = i(s.view, t);
                        if (u) break;
                        s = s.parent;
                    }
                    r[t] = n;
                ...
                var n = this.cache, r = n[t];
                return null == r && (r = n[t] = u(t, e)), r;
            }, p.prototype.render = function(t, e, n) {
                var r = this.parse(t), i = e instanceof h ? e : new h(e);
                return this.renderTokens(r, i, n, t);
            }, p.prototype.renderTokens = function(t, e, n, r) {
                for (var i, o, a, s = "", u = 0, c = t.length; u < c; ++u) a = void 0, i = t[u], 
                o = i[0], "#" === o ? a = this.renderSection(i, e, n, r) : "^" === o ? a = this.renderInverted(i, e, n, r) : ">" === o ? a = this.renderPartial(i, e, n, r) : "&" === o ? a = this.unescapedValue(i, e) : "name" === o ? a = this.escapedValue(i, e) : "text" === o && (a = this.rawValue(i)), 
                void 0 !== a && (s += a);
                return s;
                ...
                var a = this, s = "", u = n.lookup(t[1]);
                if (u) {
                    if ($(u)) for (var c = 0, l = u.length; c < l; ++c) s += this.renderTokens(t[4], n.push(u[c]), r, i); else if ("object" == typeof u || "string" == typeof u || "number" == typeof u) s += this.renderTokens(t[4], n.push(u), r, i); else if (e(u)) {
                        if ("string" != typeof i) throw new Error("Cannot use higher-order sections without the original template");
                        u = u.call(n.view, i.slice(t[3], t[5]), o), null != u && (s += u);
                    } else s += this.renderTokens(t[4], n, r, i);
                    return s;
                }
            }, p.prototype.renderInverted = function(t, e, n, r) {
                var i = e.lookup(t[1]);
                if (!i || $(i) && 0 === i.length) return this.renderTokens(t[4], e, n, r);
            ...
            return t.clearCache = function() {
                ...
                return C.render(t, e, r);
            }, t.to_html = function(n, r, i, o) {
                var a = t.render(n, r, i);
                return e(o) ? void o(a) : a;
            }, t.escape = s, t.Scanner = f, t.Context = h, t.Writer = p, t;
        });
    },
    43: function(t, e, n) {
        /**
	 ...
	 */
        !function(t, e, n) {
            ...
            function i(t) {
                ...
                return !(t.nodeType !== wr || !e) || (w(t) || pr(t) || 0 === e || "number" == typeof e && e > 0 && e - 1 in t);
            }
            function o(t, e, n) {
                var r, a;
                if (t) if (S(t)) for (r in t) "prototype" == r || "length" == r || "name" == r || t.hasOwnProperty && !t.hasOwnProperty(r) || e.call(n, t[r], r, t); else if (pr(t) || i(t)) {
            ...
            function R(t, e, n, r) {
                if (k(t) || E(t)) throw cr("cpws", "Can't copy! Making copies of Window or Scope instances is not supported.");
                if (e) {
                    ...
                    if (pr(t)) {
                        ...
                        for (var c in t) t.hasOwnProperty(c) && (a = R(t[c], null, n, r), y(t[c]) && (n.push(t[c]), 
                        r.push(a)), e[c] = a);
                        l(e, u);
                    }
                } else if (e = t, t) if (pr(t)) e = R(t, [], n, r); else if (x(t)) e = new Date(t.getTime()); else if (C(t)) e = new RegExp(t.source, t.toString().match(/[^\/]*$/)[0]), 
            ...
            function I(t, e) {
                ...
                if (a == s && "object" == a) {
                    if (!pr(t)) {
                        ...
                        if (E(t) || E(e) || k(t) || k(e) || pr(e) || x(e) || C(e)) return !1;
                        o = {};
            ...
            function L(t, r) {
                var i = r;
                return "string" == typeof t && "$" === t.charAt(0) && "$" === t.charAt(1) ? i = n : k(r) ? i = "$WINDOW" : r && e === r ? i = "$DOCUMENT" : E(r) && (i = "$SCOPE"), 
                i;
            }
            function H(t, e) {
                return "undefined" == typeof t ? n : (b(e) || (e = e ? 2 : null), JSON.stringify(t, L, e));
            }
            function B(t) {
            ...
            function z(t) {
                ...
                try {
                    return t[0].nodeType === xr ? Zn(e) : e.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function(t, e) {
                        return "<" + Zn(e);
                    });
                } catch (t) {
                    return Zn(e);
            ...
            function W(t) {
                ...
                return o((t || "").split("&"), function(t) {
                    if (t && (e = t.replace(/\+/g, "%20").split("="), n = G(e[0]), m(n))) {
                        var i = !m(e[1]) || G(e[1]);
                        Kn.call(r, n) ? pr(r[n]) ? r[n].push(i) : r[n] = [ r[n], i ] : r[n] = i;
                    }
                }), r;
            }
            function Y(t) {
            ...
            function K(t, e) {
                var n, r, i = gr.length;
                for (t = nr(t), r = 0; r < i; ++r) if (n = gr[r] + e, w(n = t.attr(n))) return n;
                return null;
            }
            function X(t, e) {
                var n, r, i = {};
            ...
            function Q(n, r, i) {
                ...
                t && !c.test(t.name) ? s() : (t.name = t.name.replace(c, ""), lr.resumeBootstrap = function(t) {
                    return o(t, function(t) {
                        r.push(t);
                    }), s();
                }, void (S(lr.resumeDeferredBootstrap) && lr.resumeDeferredBootstrap()));
            }
            function tt() {
            ...
            function ot(t, e, n) {
                return n && pr(t) && (t = t[t.length - 1]), it(S(t), e, "not a function, got " + (t && "object" == typeof t ? t.constructor.name || "Object" : typeof t)), 
                t;
            }
            function at(t, e) {
            ...
            function mt(t, e) {
                ...
                if (vt(t)) u.push(e.createTextNode(t)); else {
                    for (n = n || s.appendChild(e.createElement("div")), r = (_r.exec(t) || [ "", "" ])[1].toLowerCase(), 
                    i = Ur[r] || Ur._default, n.innerHTML = i[1] + t.replace(Ir, "<$1></$2>") + i[2], 
            ...
            function yt(t, n) {
                n = n || e;
                var r;
                return (r = Pr.exec(t)) ? [ n.createElement(r[1]) ] : (r = mt(t, n)) ? r.childNodes : [];
            }
            function wt(t) {
            ...
            function St(t, e, n, r) {
                if (m(r)) throw Dr("offargs", "jqLite#off() does not support the `selector` argument");
                var i = kt(t), a = i && i.events, s = i && i.handle;
                if (s) if (e) o(e.split(" "), function(e) {
                    ...
                    Mr(t, e, s), delete a[e];
                }); else for (e in a) "$destroy" !== e && Mr(t, e, s), delete a[e];
            }
            function Ct(t, e) {
                var r = t.ng339, i = r && Ar[r];
                if (i) {
                    if (e) return void delete i.data[e];
                    i.handle && (i.events.$destroy && i.handle({}, "$destroy"), St(t)), delete Ar[r], 
                    t.ng339 = n;
                }
            }
            function kt(t, e) {
                var r = t.ng339, i = r && Ar[r];
                return e && !i && (t.ng339 = r = dt(), i = Ar[r] = {
                    events: {},
                    data: {},
                    handle: n
                }), i;
            ...
            function Et(t, e, n) {
                if (gt(t)) {
                    var r = m(n), i = !r && e && !y(e), o = !e, a = kt(t, !i), s = a && a.data;
                    if (r) s[e] = n; else {
                        if (o) return s;
                        if (i) return s && s[e];
                        f(s, e);
            ...
            function Lt(t) {
                var e = t.toString().replace(Wr, ""), n = e.match(Br);
            ...
            function Ht(t, e, n) {
                ...
                if ("function" == typeof t) {
                    if (!(r = t.$inject)) {
                        if (r = [], t.length) {
                            if (e) throw w(n) && n || (n = t.name || Lt(t)), Yr("strictdi", "{0} is not using explicit annotation and cannot be invoked in strict mode", n);
                            i = t.toString().replace(Wr, ""), a = i.match(Br), o(a[1].split(zr), function(t) {
                ...
                } else pr(t) ? (s = t.length - 1, ot(t[s], "fn"), r = t.slice(0, s)) : ot(t, "fn", !0);
                return r;
            }
            function Bt(t, e) {
                function r(t) {
                ...
                function i(t, e) {
                    if (at(t, "service"), (S(e) || pr(e)) && (e = E.instantiate(e)), !e.$get) throw Yr("pget", "Provider '{0}' must define $get factory method.", t);
                    return k[t + b] = e;
                }
                function a(t, e) {
                    return function() {
                        var n = T.invoke(e, this);
                        if (g(n)) throw Yr("undef", "Provider '{0}' must return a value from $get factory method.", t);
                        return n;
                    };
                }
                function s(t, e, n) {
                ...
                function f(t, e) {
                    at(t, "constant"), k[t] = e, A[t] = e;
                }
                function h(t, e) {
                    var n = E.get(t + b), r = n.$get;
                    n.$get = function() {
                        var t = T.invoke(r, n);
                ...
                function p(t) {
                    ...
                    return o(t, function(t) {
                        ...
                        if (!C.get(t)) {
                            C.put(t, !0);
                            try {
                                w(t) ? (e = ir(t), n = n.concat(p(e.requires)).concat(e._runBlocks), r(e._invokeQueue), 
                                r(e._configBlocks)) : S(t) ? n.push(E.invoke(t)) : pr(t) ? n.push(E.invoke(t)) : ot(t, "module");
                            } catch (e) {
                                throw pr(t) && (t = t[t.length - 1]), e.message && e.stack && e.stack.indexOf(e.message) == -1 && (e = e.message + "\n" + e.stack), 
                                Yr("modulerr", "Failed to instantiate module {0} due to:\n{1}", t, e.stack || e.message || e);
                            }
                        }
                    }), n;
                }
                function $(t, n) {
                    function r(e, r) {
                        if (t.hasOwnProperty(e)) {
                            if (t[e] === m) throw Yr("cdep", "Circular dependency found: {0}", e + " <- " + x.join(" <- "));
                            return t[e];
                        }
                        try {
                            return x.unshift(e), t[e] = m, t[e] = n(e, r);
                        } catch (n) {
                            throw t[e] === m && delete t[e], n;
                        } finally {
                            x.shift();
                        }
                    }
                    ...
                    function o(t, e, n) {
                        var r = Object.create((pr(t) ? t[t.length - 1] : t).prototype || null), o = i(t, r, e, n);
                        return y(o) || S(o) ? o : r;
                    }
                    return {
                        invoke: i,
                        ...
                        has: function(e) {
                            return k.hasOwnProperty(e + b) || t.hasOwnProperty(e);
                        }
                    };
                }
                e = e === !0;
                var m = {}, b = "Provider", x = [], C = new Ft([], !0), k = {
                    $provide: {
                        provider: r(i),
                        factory: r(s),
                        service: r(c),
            ...
            function Wt(t, e, r, i) {
                ...
                function f() {
                    T = l(), T = g(T) ? null : T, I(T, P) && (T = P), P = T;
                }
                function h() {
                    M === $.url() && O === T || (M = $.url(), O = T, o(j, function(t) {
                        t($.url(), T);
                    }));
                }
                function p(t) {
                ...
                var $ = this, v = e[0], m = t.location, y = t.history, b = t.setTimeout, x = t.clearTimeout, S = {};
                $.isMock = !1;
                var C = 0, k = [];
                ...
                $.addPollFn = function(t) {
                    return g(E) && u(100, b), A.push(t), t;
                };
                var T, O, M = m.href, N = e.find("base"), V = null;
                f(), O = T, $.url = function(e, n, r) {
                    if (g(r) && (r = null), m !== t.location && (m = t.location), y !== t.history && (y = t.history), 
                    e) {
                        var o = O === r;
                        if (M === e && (!i.history || o)) return $;
                        var a = M && be(M) === be(e);
                        return M = e, O = r, !i.history || a && o ? (a && !V || (V = e), n ? m.replace(e) : a ? m.hash = s(e) : m.href = e) : (y[n ? "replaceState" : "pushState"](r, "", e), 
                        f(), O = T), $;
                    }
                ...
                $.onUrlChange = function(e) {
                    return D || (i.history && nr(t).on("popstate", c), nr(t).on("hashchange", c), D = !0), 
                    j.push(e), e;
                ...
                $.cookies = function(t, e) {
                    var i, o, a, s, u;
                    if (!t) {
                        if (v.cookie !== _) for (_ = v.cookie, o = _.split("; "), R = {}, s = 0; s < o.length; s++) a = o[s], 
                        u = a.indexOf("="), u > 0 && (t = p(a.substring(0, u)), R[t] === n && (R[t] = p(a.substring(u + 1))));
                        return R;
                    }
                    e === n ? v.cookie = encodeURIComponent(t) + "=;path=" + U + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : w(e) && (i = (v.cookie = encodeURIComponent(t) + "=" + encodeURIComponent(e) + ";path=" + U).length + 1, 
                    i > 4096 && r.warn("Cookie '" + t + "' possibly not set or overflowed because it was too large (" + i + " > 4096 bytes)!"));
                }, $.defer = function(t, e) {
                    var n;
                    return C++, n = b(function() {
                        delete S[n], a(t);
                    }, e || 0), S[n] = !0, n;
                }, $.defer.cancel = function(t) {
                    return !!S[t] && (delete S[t], x(t), a(d), !0);
                };
            }
            function Yt() {
            ...
            function Kt(t, r) {
                ...
                var a = {}, s = "Directive", c = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/, l = /(([\w\-]+)(?:\:([^;]+))?;?)/, h = j("ngSrc,ngSrcset,src,srcset"), g = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, b = /^(on[a-z]+|formaction)$/;
                this.directive = function e(n, r) {
                    return at(n, "directive"), w(n) ? (it(r, "directiveFactory"), a.hasOwnProperty(n) || (a[n] = [], 
                ...
                this.debugInfoEnabled = function(t) {
                ...
                }, this.$get = [ "$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(t, r, i, u, v, m, C, k, A, T, O) {
                    function M(t, e) {
                        try {
                            t.addClass(e);
                        } catch (t) {}
                    ...
                    function N(t, e, n, r, i) {
                        ...
                        return function(e, n, r) {
                            ...
                            var c;
                            if (c = "html" !== s ? nr(X(s, nr("<div>").append(t).html())) : n ? qr.clone.call(t) : t, 
                    ...
                    function j(t, e, r, i, o, a) {
                        function s(t, r, i, o) {
                            ...
                            if (d) {
                                var g = r.length;
                                for (v = new Array(g), l = 0; l < $.length; l += 3) h = $[l], v[h] = r[h];
                            } else v = r;
                            for (l = 0, f = $.length; l < f; ) u = v[$[l++]], a = $[l++], s = $[l++], a ? (a.scope ? (c = t.$new(), 
                            N.$$addScopeInfo(nr(u), c)) : c = t, p = a.transcludeOnThisElement ? R(t, a.transclude, o, a.elementTranscludeOnThisElement) : !a.templateOnThisElement && o ? o : !o && e ? R(t, e) : null, 
                            a(s, c, u, i, p)) : s && s(t, u.childNodes, n, o);
                        }
                        for (var u, c, l, f, h, p, d, $ = [], v = 0; v < t.length; v++) u = new at(), c = _(t[v], [], u, 0 === v ? i : n, o), 
                        l = c.length ? L(c, t[v], u, e, r, null, [], [], a) : null, l && l.scope && N.$$addScopeClass(u.$$element), 
                        h = l && l.terminal || !(f = t[v].childNodes) || !f.length ? null : j(f, l ? (l.transcludeOnThisElement || !l.templateOnThisElement) && l.transclude : e), 
                    ...
                    function _(t, e, n, r, i) {
                        ...
                        switch (s) {
                          case wr:
                            B(e, Xt(D(t)), "E", r, i);
                            for (var f, h, p, d, $, v, g = t.attributes, m = 0, b = g && g.length; m < b; m++) {
                                var x = !1, S = !1;
                                f = g[m], h = f.name, $ = dr(f.value), d = Xt(h), (v = ft.test(d)) && (h = h.replace(Xr, "").substr(8).replace(/_(.)/g, function(t, e) {
                                    return e.toUpperCase();
                                }));
                                var C = d.replace(/(Start|End)$/, "");
                                G(C) && d === C + "Start" && (x = h, S = h.substr(0, h.length - 5) + "end", h = h.substr(0, h.length - 6)), 
                                p = Xt(h.toLowerCase()), u[p] = h, !v && n.hasOwnProperty(p) || (n[p] = $, Rt(t, p) && (n[p] = !0)), 
                                tt(t, e, $, p, v), B(e, p, "A", r, i, x, S);
                            }
                            if (a = t.className, y(a) && (a = a.animVal), w(a) && "" !== a) for (;o = l.exec(a); ) p = Xt(o[2]), 
                            B(e, p, "C", r, i) && (n[p] = dr(o[3])), a = a.substr(o.index + o[0].length);
                            break;
                          ...
                          case Sr:
                            try {
                                o = c.exec(t.nodeValue), o && (p = Xt(o[1]), B(e, p, "M", r, i) && (n[p] = dr(o[2])));
                            } catch (t) {}
                        }
                        return e.sort(J), e;
                    }
                    function U(t, e, n) {
                        ...
                        if (e && t.hasAttribute && t.hasAttribute(e)) {
                            do {
                                ...
                                t.nodeType == wr && (t.hasAttribute(e) && i++, t.hasAttribute(n) && i--), r.push(t), 
                                t = t.nextSibling;
                            } while (i > 0);
                        } else r.push(t);
                        return nr(r);
                    ...
                    function L(t, a, s, u, c, l, f, h, p) {
                        function d(t, e, n, r) {
                            t && (n && (t = F(t, n, r)), t.require = k.require, t.directiveName = A, (D === k || k.$$isolateScope) && (t = rt(t, {
                                isolateScope: !0
                            })), f.push(t)), e && (n && (e = F(e, n, r)), e.require = k.require, e.directiveName = A, 
                            (D === k || k.$$isolateScope) && (e = rt(e, {
                                isolateScope: !0
                            })), h.push(e));
                        }
                        function $(t, e, n, r) {
                            ...
                            if (w(e)) {
                                ...
                                i = i || c[s]("$" + e + "Controller"), !i && !u) throw Kr("ctreq", "Controller '{0}', required by directive '{1}', can't be found!", e, t);
                                return i || null;
                            }
                        ...
                        function b(t, e, i, u, c) {
                            function l(t, e, r) {
                                var i;
                                return E(t) || (r = e, e = t, t = n), G && (i = b), r || (r = G ? S.parent() : S), 
                                c(t, e, i, r, O);
                            }
                            var p, d, g, y, w, b, x, S, k;
                            if (a === i ? (k = s, S = s.$$element) : (S = nr(i), k = new at(S, s)), D && (w = e.$new(!0)), 
                            c && (x = l, x.$$boundTransclude = c), j && (C = {}, b = {}, o(j, function(t) {
                                var n, r = {
                                    $scope: t === D || t.$$isolateScope ? w : e,
                                    $element: S,
                                    $attrs: k,
                                    $transclude: x
                                };
                                y = t.controller, "@" == y && (y = k[t.name]), n = m(y, r, !0, t.controllerAs), 
                                b[t.name] = n, G || S.data("$" + t.name + "Controller", n.instance), C[t.name] = n;
                            })), D) {
                                N.$$addScopeInfo(S, w, !0, !(P && (P === D || P === D.$$originalDirective))), N.$$addScopeClass(S, !0);
                                var A = C && C[D.name], T = w;
                                A && A.identifier && D.bindToController === !0 && (T = A.instance), o(w.$$isolateBindings = D.$$isolateBindings, function(t, n) {
                                    var i, o, a, s, u = t.attrName, c = t.optional, l = t.mode;
                                    switch (l) {
                                      case "@":
                                        k.$observe(u, function(t) {
                                            T[n] = t;
                                        }), k.$$observers[u].$$scope = e, k[u] && (T[n] = r(k[u])(e));
                                        break;

                                      case "=":
                                        if (c && !k[u]) return;
                                        o = v(k[u]), s = o.literal ? I : function(t, e) {
                                            return t === e || t !== t && e !== e;
                                        }, a = o.assign || function() {
                                            throw i = T[n] = o(e), Kr("nonassign", "Expression '{0}' used with directive '{1}' is non-assignable!", k[u], D.name);
                                        }, i = T[n] = o(e);
                                        var f = function(t) {
                                        ...
                                        f.$stateful = !0;
                                        var h;
                                        h = t.collection ? e.$watchCollection(k[u], f) : e.$watch(v(k[u], f), null, o.literal), 
                                        w.$on("$destroy", h);
                                        break;

                                      case "&":
                                        o = v(k[u]), T[n] = function(t) {
                                            return o(e, t);
                                        };
                                    }
                                });
                            ...
                            for (C && (o(C, function(t) {
                                t();
                            }), C = null), p = 0, d = f.length; p < d; p++) g = f[p], ot(g, g.isolateScope ? w : e, S, k, g.require && $(g.directiveName, g.require, S, b), x);
                            var O = e;
                            for (D && (D.template || null === D.templateUrl) && (O = w), t && t(O, i.childNodes, n, c), 
                            p = h.length - 1; p >= 0; p--) g = h[p], ot(g, g.isolateScope ? w : e, S, k, g.require && $(g.directiveName, g.require, S, b), x);
                        }
                        p = p || {};
                        for (var x, C, k, A, T, O, M, V = -Number.MAX_VALUE, j = p.controllerDirectives, D = p.newIsolateScopeDirective, P = p.templateDirective, R = p.nonTlbTranscludeDirective, L = !1, B = !1, G = p.hasElementTranscludeDirective, J = s.$$element = nr(a), K = l, Q = u, tt = 0, nt = t.length; tt < nt; tt++) {
                            k = t[tt];
                            var it = k.$$start, st = k.$$end;
                            if (it && (J = U(a, it, st)), T = n, V > k.priority) break;
                            if ((M = k.scope) && (k.templateUrl || (y(M) ? (Z("new/isolated scope", D || x, k, J), 
                            D = k) : Z("new/isolated scope", D, k, J)), x = x || k), A = k.name, !k.templateUrl && k.controller && (M = k.controller, 
                            j = j || {}, Z("'" + A + "' controller", j[A], k, J), j[A] = k), (M = k.transclude) && (L = !0, 
                            k.$$tlb || (Z("transclusion", R, k, J), R = k), "element" == M ? (G = !0, V = k.priority, 
                            T = J, J = s.$$element = nr(e.createComment(" " + A + ": " + s[A] + " ")), a = J[0], 
                            et(c, q(T), a), Q = N(T, u, V, K && K.name, {
                                nonTlbTranscludeDirective: R
                            })) : (T = nr(bt(a)).contents(), J.empty(), Q = N(T, u))), k.template) if (B = !0, 
                            Z("template", P, k, J), P = k, M = S(k.template) ? k.template(J, s) : k.template, 
                            M = lt(M), k.replace) {
                                if (K = k, T = vt(M) ? [] : te(X(k.templateNamespace, dr(M))), a = T[0], 1 != T.length || a.nodeType !== wr) throw Kr("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", A, "");
                                et(c, J, a);
                                var ut = {
                                    $attr: {}
                                }, ct = _(a, [], ut), ft = t.splice(tt + 1, t.length - (tt + 1));
                                D && H(ct), t = t.concat(ct).concat(ft), W(s, ut), nt = t.length;
                            } else J.html(M);
                            if (k.templateUrl) B = !0, Z("template", P, k, J), P = k, k.replace && (K = k), 
                            b = Y(t.splice(tt, t.length - tt), J, s, c, L && Q, f, h, {
                                controllerDirectives: j,
                                newIsolateScopeDirective: D,
                                templateDirective: P,
                                nonTlbTranscludeDirective: R
                            }), nt = t.length; else if (k.compile) try {
                                O = k.compile(J, s, Q), S(O) ? d(null, O, it, st) : O && d(O.pre, O.post, it, st);
                            } catch (t) {
                                i(t, z(J));
                            }
                            k.terminal && (b.terminal = !0, V = Math.max(V, k.priority));
                        }
                        return b.scope = x && x.scope === !0, b.transcludeOnThisElement = L, b.elementTranscludeOnThisElement = G, 
                    ...
                    function B(e, r, o, u, c, l, f) {
                        if (r === c) return null;
                        var h = null;
                        if (a.hasOwnProperty(r)) for (var d, $ = t.get(r + s), v = 0, g = $.length; v < g; v++) try {
                            d = $[v], (u === n || u > d.priority) && d.restrict.indexOf(o) != -1 && (l && (d = p(d, {
                                $$start: l,
                                $$end: f
                            })), e.push(d), h = d);
                        } catch (t) {
                    ...
                    function Y(t, e, n, r, i, a, s, c) {
                        var l, f, h = [], d = e[0], $ = t.shift(), v = p($, {
                            ...
                            replace: null,
                            $$originalDirective: $
                        }), g = S($.templateUrl) ? $.templateUrl(e, n) : $.templateUrl, m = $.templateNamespace;
                        return e.empty(), u(g).then(function(u) {
                            var p, w, b, x;
                            if (u = lt(u), $.replace) {
                                if (b = vt(u) ? [] : te(X(m, dr(u))), p = b[0], 1 != b.length || p.nodeType !== wr) throw Kr("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", $.name, g);
                                w = {
                                    $attr: {}
                                }, et(r, e, p);
                                var S = _(p, [], w);
                                y($.scope) && H(S), t = S.concat(t), W(n, w);
                            } else p = d, e.html(u);
                            for (t.unshift(v), l = L(t, p, n, i, e, $, a, s, c), o(r, function(t, n) {
                                t == p && (r[n] = e[0]);
                            }), f = j(e[0].childNodes, i); h.length; ) {
                                var C = h.shift(), k = h.shift(), E = h.shift(), A = h.shift(), T = e[0];
                                if (!C.$$destroyed) {
                                    if (k !== d) {
                                        var O = k.className;
                                        c.hasElementTranscludeDirective && $.replace || (T = bt(p)), et(E, nr(k), T), M(nr(T), O);
                                    }
                                    x = l.transcludeOnThisElement ? R(C, l.transclude, A) : A, l(f, C, T, r, x);
                                }
                            }
                            h = null;
                        }), function(t, e, n, r, i) {
                            var o = i;
                            e.$$destroyed || (h ? h.push(e, n, r, o) : (l.transcludeOnThisElement && (o = R(e, l.transclude, i)), 
                            l(f, e, n, r, o)));
                        };
                    }
                    function J(t, e) {
                    ...
                    function Z(t, e, n, r) {
                        if (e) throw Kr("multidir", "Multiple directives [{0}, {1}] asking for {2} on: {3}", e.name, n.name, t, z(r));
                    }
                    function K(t, e) {
                        var n = r(e, !0);
                        n && t.push({
                    ...
                    function tt(t, e, n, i, o) {
                        ...
                        var s = r(n, !0, a, o);
                        if (s) {
                            if ("multiple" === i && "select" === D(t)) throw Kr("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", z(t));
                            e.push({
                                priority: 100,
                                compile: function() {
                                    return {
                                        pre: function(t, e, u) {
                                            ...
                                            if (b.test(i)) throw Kr("nodomevents", "Interpolations for HTML DOM event attributes are disallowed.  Please use the ng- versions (such as ng-click instead of onclick) instead.");
                                            var l = u[i];
                    ...
                    at.prototype = {
                        ...
                        $set: function(t, e, r, a) {
                            var s, u = this.$$element[0], c = Rt(u, t), l = _t(u, t), f = t;
                            ...
                            s = D(this.$$element), "a" === s && "href" === t || "img" === s && "src" === t) this[t] = e = O(e, "src" === t); else if ("img" === s && "srcset" === t) {
                                for (var h = "", p = dr(e), d = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, $ = /\s/.test(p) ? d : /(,)/, v = p.split($), g = Math.floor(v.length / 2), m = 0; m < g; m++) {
                                    var y = 2 * m;
                                    h += O(dr(v[y]), !0), h += " " + dr(v[y + 1]);
                                }
                                var w = dr(v[2 * m]).split(/\s/);
                                h += O(dr(w[0]), !0), 2 === w.length && (h += " " + dr(w[1])), this[t] = e = h;
                            }
                    ...
                    } : d, N.$$addBindingClass = x ? function(t) {
                        M(t, "ng-binding");
                    } : d, N.$$addScopeInfo = x ? function(t, e, n, r) {
                        var i = n ? r ? "$isolateScopeNoTemplate" : "$isolateScope" : "$scope";
                        t.data(i, e);
                    } : d, N.$$addScopeClass = x ? function(t, e) {
                ...
                this.register = function(e, n) {
                    ...
                    return function(r, u, c, l) {
                        ...
                        if (c = c === !0, l && w(l) && ($ = l), w(r)) {
                            if (p = r.match(i), !p) throw Qr("ctrlfmt", "Badly formed controller string '{0}'. Must match `__name__ as __id__` or `__name__`.", r);
                            d = p[1], $ = $ || p[3], r = t.hasOwnProperty(d) ? t[d] : st(u.$scope, d, !0) || (e ? st(a, d, !0) : n), 
                            ot(r, d, !0);
                        }
                        if (c) {
                            var v = (pr(r) ? r[r.length - 1] : r).prototype;
            ...
            function ae(t) {
                var e, n, r, i = ct();
                return t ? (o(t.split("\n"), function(t) {
                    r = t.indexOf(":"), e = Zn(dr(t.substr(0, r))), n = dr(t.substr(r + 1)), e && (i[e] = i[e] ? i[e] + ", " + n : n);
                }), i) : i;
            }
            function se(t) {
                var e = y(t) ? t : n;
                ...
                this.$get = [ "$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(a, u, c, l, h, p) {
                    function d(e) {
                        ...
                        function s(e) {
                            ...
                            o = f({}, o.common, o[Zn(e.method)]);
                            t: for (n in o) {
                                r = Zn(n);
                                for (i in s) if (Zn(i) === r) continue t;
                                s[n] = o[n];
                            }
                            return a(s);
                        }
                        ...
                        return p.success = function(t) {
                            return ot(t, "fn"), p.then(function(e) {
                                t(e.data, e.status, e.headers, u);
                            }), p;
                        }, p.error = function(t) {
                            return ot(t, "fn"), p.then(null, function(e) {
                                t(e.data, e.status, e.headers, u);
                            }), p;
                        }, p;
                    }
                    ...
                    function b(r, i) {
                        ...
                        var p, $, v = h.defer(), w = v.promise, b = r.headers, x = C(r.url, r.params);
                        if (d.pendingRequests.push(r), w.then(f, f), !r.cache && !t.cache || r.cache === !1 || "GET" !== r.method && "JSONP" !== r.method || (p = y(r.cache) ? r.cache : y(t.cache) ? t.cache : k), 
                        p && ($ = p.get(x), m($) ? N($) ? $.then(c, c) : pr($) ? s($[1], $[0], _($[2]), $[3]) : s($, 200, {}, "OK") : p.put(x, w)), 
                        g($)) {
                    ...
                    function C(t, e) {
                        ...
                        return s(e, function(t, e) {
                            null === t || g(t) || (pr(t) || (t = [ t ]), o(t, function(t) {
                    ...
                    return o(i, function(t) {
                        E.unshift(w(t) ? p.get(t) : p.invoke(t));
                ...
                return function(a, u, c, l, f, h, p, $) {
                    ...
                    if (t.$$incOutstandingRequestCount(), u = u || t.url(), "jsonp" == Zn(a)) {
                        ...
                        b.open(a, u, !0), o(f, function(t, e) {
                            ...
                            0 === n && (n = e ? 200 : "file" == on(u).protocol ? 404 : 0), g(l, n, e, b.getAllResponseHeaders(), t);
                        };
                        var x = function() {
                            g(l, -1, null, null, "");
                        };
                    ...
                    if (h > 0) var S = r(v, h); else N(h) && h.then(v);
                };
            }
            function de() {
                var t = "{{", e = "}}";
                this.startSymbol = function(e) {
                    ...
                    function a(o, a, h, p) {
                        ...
                        p = !!p;
                        for (var v, y, w, b = 0, x = [], C = [], k = o.length, E = [], A = []; b < k; ) {
                            if ((v = o.indexOf(t, b)) == -1 || (y = o.indexOf(e, v + s)) == -1) {
                                b !== k && E.push(d(o.substring(b)));
                                break;
                            }
                            b !== v && E.push(d(o.substring(b, v))), w = o.substring(v + s, y), x.push(w), C.push(n(w, $)), 
                            b = y + u, A.push(E.length), E.push("");
                        }
                        if (h && E.length > 1) throw oi("noconcat", "Error while interpolating: {0}\nStrict Contextual Escaping disallows interpolations that concatenate multiple expressions when a trusted value is required.  See http://docs.angularjs.org/api/ng.$sce", o);
                        if (!a || x.length) {
                            var T = function(t) {
            ...
            function ke(t, e, r) {
                this.$$html5 = !0, r = r || "", me(t, this), this.$$parse = function(t) {
                    ...
                    var a, s, u;
                    return (a = we(t, i)) !== n ? (s = a, u = (a = we(r, a)) !== n ? e + (we("/", a) || a) : t + s) : (a = we(e, i)) !== n ? u = e + a : e == i + "/" && (u = e), 
                    u && this.$$parse(u), !!u;
                };
            }
            function Ee(t, e, n) {
                me(t, this), this.$$parse = function(r) {
                    ...
                    g(a) || "#" !== a.charAt(0) ? this.$$html5 ? o = a : (o = "", g(a) && (t = r, this.replace())) : (o = we(n, a), 
                    g(o) && (o = a)), ye(o, this), this.$$path = i(this.$$path, o, t), this.$$compose();
                }, this.$$compose = function() {
                    var e = Y(this.$$search), r = this.$$hash ? "#" + J(this.$$hash) : "";
            ...
            function Ae(t, e, n) {
                this.$$html5 = !0, Ee.apply(this, arguments), this.$$parseLinkUrl = function(r, i) {
                    if (i && "#" === i[0]) return this.hash(i.slice(1)), !0;
                    var o, a;
                    return t == be(r) ? o = r : (a = we(e, r)) ? o = t + n + a : e === r + "/" && (o = e), 
                    o && this.$$parse(o), !!o;
                }, this.$$compose = function() {
                    var e = Y(this.$$search), r = this.$$hash ? "#" + J(this.$$hash) : "";
                ...
                this.hashPrefix = function(e) {
                    ...
                    o.on("click", function(t) {
                        if (e.rewriteLinks && !t.ctrlKey && !t.metaKey && !t.shiftKey && 2 != t.which && 2 != t.button) {
                            ...
                            $.test(s) || !s || i.attr("target") || t.isDefaultPrevented() || c.$$parseLinkUrl(s, u) && (t.preventDefault(), 
                    ...
                    return r.onUrlChange(function(t, e) {
                        return g(we(d, t)) ? void (a.location.href = t) : (n.$evalAsync(function() {
            ...
            function Pe(t, e) {
                if (t) {
                    if (t.constructor === t) throw li("isecfn", "Referencing Function in Angular expressions is disallowed! Expression: {0}", e);
                    if (t === fi || t === hi || t === pi) throw li("isecff", "Referencing call, apply or bind in Angular expressions is disallowed! Expression: {0}", e);
                }
            }
            function Re(t) {
                return t.constant;
            ...
            function Ue(t, e, r, i, o, a, s) {
                ...
                var u = function(t) {
                    return De(t, a);
                }, c = s || Ie(t) ? u : $, l = s || Ie(e) ? u : $, f = s || Ie(r) ? u : $, h = s || Ie(i) ? u : $, p = s || Ie(o) ? u : $;
                return function(a, s) {
            ...
            function Fe(t, e, r) {
                var i = e.expensiveChecks, a = i ? wi : yi, s = a[t];
                if (s) return s;
                var u = t.split("."), c = u.length;
                if (e.csp) s = c < 6 ? Ue(u[0], u[1], u[2], u[3], u[4], r, i) : function(t, e) {
                    var o, a = 0;
                    do o = Ue(u[a++], u[a++], u[a++], u[a++], u[a++], r, i)(t, e), e = n, t = o; while (a < c);
                    return o;
                }; else {
                    var l = "";
                    i && (l += "s = eso(s, fe);\nl = eso(l, fe);\n");
            ...
            function Le(t) {
                return S(t.valueOf) ? t.valueOf() : bi.call(t);
            }
            function He() {
                var t = ct(), e = ct();
                        ...
                        switch (typeof r) {
                          case "string":
                            ...
                            if (s = m[g], !s) {
                                ...
                                var y = a ? $ : p, w = new gi(y), b = new mi(w, n, y);
            ...
            function Ge(t, e) {
                ...
                return m.defer = p, m.reject = d, m.when = g, m.all = f, m;
            }
            function We() {
                ...
                this.digestTtl = function(t) {
                    ...
                    p.prototype = {
                        ...
                        $watch: function(t, e, n) {
                            ...
                            return a = null, S(e) || (s.fn = d), o || (o = i.$$watchers = []), o.unshift(s), 
                            function() {
                                P(o, s), a = null;
                            };
                        },
                        ...
                        $digest: function() {
                            var t, r, i, o, c, l, h, p, d, g, m = e, y = this, x = [];
                            ...
                            do {
                                ...
                                t: do {
                                    if (o = p.$$watchers) for (c = o.length; c--; ) try {
                                        if (t = o[c]) if ((r = t.get(p)) === (i = t.last) || (t.eq ? I(r, i) : "number" == typeof r && "number" == typeof i && isNaN(r) && isNaN(i))) {
                                            if (t === a) {
                                                l = !1;
                                                break t;
                                            }
                                        } else l = !0, a = t, t.last = t.eq ? R(r, null) : r, t.fn(r, i === w ? r : i, p), 
                                        m < 5 && (d = 4 - m, x[d] || (x[d] = []), x[d].push({
                                ...
                                if ((l || k.length) && !m--) throw v(), n("infdig", "{0} $digest() iterations reached. Aborting!\nWatchers fired in the last 5 iterations: {1}", e, x);
                            } while (l || k.length);
                            for (v(); E.length; ) try {
                                E.shift()();
                            } catch (t) {
                        ...
                        $on: function(t, e) {
                            ...
                            return function() {
                                var r = n.indexOf(e);
                                r !== -1 && (n[r] = null, m(i, 1, t));
                            };
                        },
                        $emit: function(t, e) {
                            var n, r, i, o = [], a = this, s = !1, c = {
                                name: t,
                                targetScope: a,
                        ...
                        $broadcast: function(t, e) {
                            ...
                            for (var a, s, c, l = U([ o ], arguments, 1); r = i; ) {
                                for (o.currentScope = r, a = r.$$listeners[t] || [], s = 0, c = a.length; s < c; s++) if (a[s]) try {
                                    a[s].apply(null, l);
                                } catch (t) {
                                    u(t);
                    ...
                    var C = new p(), k = C.$$asyncQueue = [], E = C.$$postDigestQueue = [], A = C.$$applyAsyncQueue = [];
                    return C;
                } ];
            }
            function Je() {
            ...
            function tn() {
                this.$get = [ "$window", "$document", function(t, e) {
                    var n, r, i = {}, o = h((/android (\d+)/.exec(Zn((t.navigator || {}).userAgent)) || [])[1]), a = /Boxee/i.test((t.navigator || {}).userAgent), s = e[0] || {}, u = /^(Moz|webkit|ms)(?=[A-Z])/, c = s.body && s.body.style, l = !1, f = !1;
                    if (c) {
            ...
            function un(t) {
                ...
                } ], e("currency", hn), e("date", kn), e("filter", cn), e("json", En), e("limitTo", An), 
                e("lowercase", Mi), e("number", pn), e("orderBy", Tn), e("uppercase", Ni);
            }
            function cn() {
            ...
            function ln(t, e, n) {
                ...
                return e === !0 ? e = I : S(e) || (e = function(t, e) {
                    return !g(t) && (null === t || null === e ? t === e : !y(t) && !y(e) && (t = Zn("" + t), 
                    e = Zn("" + e), t.indexOf(e) !== -1));
                }), r = function(r) {
            ...
            function dn(t, e, n, r, i) {
                ...
                if (c) i > 0 && t < 1 && (s = t.toFixed(i), t = parseFloat(s)); else {
                    ...
                    h = h[1] || "";
                    var d, $ = 0, v = e.lgSize, m = e.gSize;
                    if (p.length >= v + m) for ($ = p.length - v, d = 0; d < $; d++) ($ - d) % m === 0 && 0 !== d && (s += n), 
                    s += p.charAt(d);
            ...
            function gn(t, e) {
                return function(n, r) {
                    var i = n["get" + t](), o = Xn(e ? "SHORT" + t : t);
                    return r[o][i];
                };
            }
            function mn(t) {
            ...
            function bn(t) {
                return function(e) {
                    var n = yn(e.getFullYear()), r = wn(e), i = +r - +n, o = 1 + Math.round(i / 6048e5);
                    return $n(o, t);
                };
            }
            function xn(t, e) {
            ...
            function kn(t) {
                ...
                return function(n, r, i) {
                    var a, s, u = "", c = [];
                    if (r = r || "mediumDate", r = t.DATETIME_FORMATS[r] || r, w(n) && (n = Oi.test(n) ? h(n) : e(n)), 
            ...
            function An() {
                return function(t, e) {
                    return b(t) && (t = t.toString()), pr(t) || w(t) ? (e = Math.abs(Number(e)) === 1 / 0 ? Number(e) : h(e), 
            ...
            function Nn(t, e, r, i, a) {
                var s = this, u = [], c = s.$$parentForm = t.parent().controller("form") || Di;
                ...
                c.$addControl(s), s.$rollbackViewValue = function() {
                    ...
                    i.removeClass(t, go), i.addClass(t, mo), s.$dirty = !0, s.$pristine = !1, c.$setDirty();
                }, s.$setPristine = function() {
                    i.setClass(t, go, mo + " " + Pi), s.$dirty = !1, s.$pristine = !0, s.$submitted = !1, 
                    o(u, function(t) {
                        t.$setPristine();
                    });
            ...
            function Pn(t, e) {
                ...
                if (w(t)) {
                    ...
                    var n = zi.exec(t);
                    if (n) {
                        var r = +n[1], i = +n[2], o = 0, a = 0, s = 0, u = 0, c = yn(r), l = 7 * (i - 1);
            ...
            function Un(t, e, r, i, o, a) {
                if (In(t, e, r, i), Dn(t, e, r, i, o, a), i.$$parserName = "number", i.$parsers.push(function(t) {
            ...
            function qn(t, e, n, r, i, o) {
                Dn(t, e, n, r, i, o), Vn(r), r.$$parserName = "url", r.$validators.url = function(t, e) {
                    var n = t || e;
                    return r.$isEmpty(n) || qi.test(n);
                };
            }
            function Fn(t, e, n, r, i, o) {
                Dn(t, e, n, r, i, o), Vn(r), r.$$parserName = "email", r.$validators.email = function(t, e) {
                    var n = t || e;
            ...
            function Gn(t) {
                function e(t, e, u) {
                    ...
                    f(s.$$success, t, u)), s.$pending ? (o(bo, !0), s.$valid = s.$invalid = n, a("", null)) : (o(bo, !1), 
                    s.$valid = Wn(s.$error), s.$invalid = !s.$valid, a("", s.$valid));
                    var c;
            ...
            var Yn = /^\/(.+)\/([a-z]*)$/, Jn = "validity", Zn = function(t) {
                return w(t) ? t.toLowerCase() : t;
            }, Kn = Object.prototype.hasOwnProperty, Xn = function(t) {
            ...
            "i" !== "I".toLowerCase() && (Zn = Qn, Xn = tr);
            var er, nr, rr, ir, or = [].slice, ar = [].splice, sr = [].push, ur = Object.prototype.toString, cr = r("ng"), lr = t.angular || (t.angular = {}), fr = 0;
            er = e.documentMode, d.$inject = [], $.$inject = [];
            var hr, pr = Array.isArray, dr = function(t) {
                return w(t) ? t.trim() : t;
            }, $r = function(t) {
                return t.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g, "\\$1").replace(/\x08/g, "\\x08");
            }, vr = function() {
                if (m(vr.isActive_)) return vr.isActive_;
            ...
            }, gr = [ "ng-", "data-ng-", "ng:", "x-ng-" ], mr = /[A-Z]/g, yr = !1, wr = 1, br = 2, xr = 3, Sr = 8, Cr = 9, kr = 11, Er = {
                full: "1.3.20",
                major: 1,
                minor: 3,
                dot: 20,
            ...
            wt.expando = "ng339";
            var Ar = wt.cache = {}, Tr = 1, Or = function(t, e, n) {
            ...
            var Nr = /([\:\-\_]+(.))/g, Vr = /^moz([A-Z])/, jr = {
                mouseleave: "mouseout",
                mouseenter: "mouseover"
            }, Dr = r("jqLite"), Pr = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Rr = /<|&#?\w+;/, _r = /<([\w:]+)/, Ir = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ur = {
            ...
            o({
                ...
                inheritedData: Vt,
                scope: function(t) {
                    return nr.data(t, "$scope") || Vt(t.parentNode || t, [ "$isolateScope", "$scope" ]);
                },
                ...
                hasClass: At,
                css: function(t, e, n) {
                    return e = $t(e), m(n) ? void (t.style[e] = n) : t.style[e];
                },
                attr: function(t, e, r) {
                    var i = t.nodeType;
                    if (i !== xr && i !== br && i !== Sr) {
                        var o = Zn(e);
                        if (Fr[o]) {
                            if (!m(r)) return t[e] || (t.attributes.getNamedItem(e) || d).specified ? o : n;
                ...
                wt.prototype[e] = function(e, r) {
                    ...
                    if (t !== jt && (2 == t.length && t !== At && t !== Nt ? e : r) === n) {
                        if (y(e)) {
                            for (i = 0; i < a; i++) if (t === Et) t(this[i], e); else for (o in e) t(this[i], o, e[o]);
                            return this;
                        }
                ...
                on: function t(e, n, r, i) {
                    if (m(i)) throw Dr("onargs", "jqLite#on() does not support the `selector` or `eventData` parameters");
                    if (gt(e)) {
                        var o = kt(e, !0), a = o.events, s = o.handle;
                        s || (s = o.handle = It(e, a));
                        for (var u = n.indexOf(" ") >= 0 ? n.split(" ") : [ n ], c = u.length; c--; ) {
                            n = u[c];
                            var l = a[n];
                            l || (a[n] = [], "mouseenter" === n || "mouseleave" === n ? t(e, jr[n], function(t) {
                                var e = this, r = t.relatedTarget;
                                r && (r === e || e.contains(r)) || s(t, n);
                            }) : "$destroy" !== n && Or(e, n, s), l = a[n]), l.push(r);
                        }
                    }
                },
                off: St,
                ...
                triggerHandler: function(t, e, n) {
                    var r, i, a, s = e.type || e, u = kt(t), c = u && u.events, l = c && c[s];
                    l && (r = {
                        preventDefault: function() {
                ...
                wt.prototype[e] = function(e, n, r) {
                    ...
                    m(i) && (i = nr(i))) : Mt(i, t(this[o], e, n, r));
                    return m(i) ? i : this;
                }, wt.prototype.bind = wt.prototype.on, wt.prototype.unbind = wt.prototype.off;
            }), Ft.prototype = {
                put: function(t, e) {
                    this[qt(t, this.nextUid)] = e;
                },
                get: function(t) {
                    return this[qt(t, this.nextUid)];
                },
                remove: function(t) {
                    var e = this[t = qt(t, this.nextUid)];
                    return delete this[t], e;
                }
            };
            var Br = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, zr = /,/, Gr = /^\s*(_?)(\S+?)\1\s*$/, Wr = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Yr = r("$injector");
            Bt.$$annotate = Ht;
            var Jr = r("$animate"), Zr = [ "$provide", function(t) {
                this.$$selectors = {}, this.register = function(e, n) {
                    ...
                    return {
                        ...
                        $$addClassImmediately: function(t, e, n) {
                            return t = nr(t), e = w(e) ? e : pr(e) ? e.join(" ") : "", o(t, function(t) {
                                Ot(t, e);
                            }), u(t, n), s();
                        },
                        ...
                        setClass: function(t, e, n, o) {
                            ...
                            var f = l.classes;
                            return e = pr(e) ? e : e.split(" "), n = pr(n) ? n : n.split(" "), a(f, e, !0), 
            ...
            var Xr = /^((?:x|data)[\:\-_])/i, Qr = r("$controller"), ti = "application/json", ei = {
                ...
                search: function(t, e) {
                    switch (arguments.length) {
                      ...
                      case 1:
                        if (w(t) || b(t)) t = t.toString(), this.$$search = W(t); else {
            ...
            o([ Ae, Ee, ke ], function(t) {
                t.prototype = Object.create(ci), t.prototype.state = function(e) {
                    if (!arguments.length) return this.$$state;
                    if (t !== ke || !this.$$html5) throw ui("nostate", "History API state support is available only in HTML5 mode and only in browsers supporting HTML5 History API");
                    return this.$$state = g(e) ? null : e, this;
                };
            });
            var li = r("$parse"), fi = Function.prototype.call, hi = Function.prototype.apply, pi = Function.prototype.bind, di = ct();
            o({
                null: function() {
                    return null;
                },
            ...
            mi.ZERO = f(function() {
                ...
                filter: function(t) {
                    ...
                    return f(function(o, a) {
                        ...
                        constant: !i.$stateful && o.every(Re),
                        inputs: !i.$stateful && o
                    });
                },
                expression: function() {
                ...
                unary: function() {
                    var t;
                    return this.expect("+") ? this.primary() : (t = this.expect("-")) ? this.binaryFn(mi.ZERO, t.text, this.unary()) : (t = this.expect("!")) ? this.unaryFn(t.text, this.unary()) : this.primary();
                },
                ...
                objectIndex: function(t) {
                    ...
                    return this.consume("]"), f(function(i, o) {
                        ...
                        assign: function(n, i, o) {
                            var a = Ve(je(r(n, o), e), e), s = De(t(n, o), e);
                ...
                functionCall: function(t, e) {
                    ...
                    return function(a, s) {
                        var u = e ? e(a, s) : m(e) ? n : a, c = t(a, s, u) || d;
                        if (o) for (var l = r.length; l--; ) o[l] = De(r[l](a, s), i);
                        De(u, i), Pe(c, i);
            ...
            var yi = ct(), wi = ct(), bi = Object.prototype.valueOf, xi = r("$sce"), Si = {
                HTML: "html",
                CSS: "css",
                URL: "url",
                RESOURCE_URL: "resourceUrl",
                JS: "js"
            }, Kr = r("$compile"), Ci = e.createElement("a"), ki = on(t.location.href);
            un.$inject = [ "$provide" ], hn.$inject = [ "$locale" ], pn.$inject = [ "$locale" ];
            var Ei = ".", Ai = {
                yyyy: vn("FullYear", 4),
                ...
                GGG: Sn,
                GGGG: Cn
            }, Ti = /((?:[^yMdHhmsaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|G+|w+))(.*)/, Oi = /^\-?\d+$/;
            kn.$inject = [ "$locale" ];
            var Mi = v(Zn), Ni = v(Xn);
            Tn.$inject = [ "$parse" ];
            var Vi = v({
                        ...
                        compile: function(r, i) {
                            ...
                            return {
                                pre: function(t, r, i, a) {
                                    ...
                                    var u = a.$$parentForm;
                                    o && (_e(t, null, a.$name, a, a.$name), i.$observe(o, function(e) {
                                        a.$name !== e && (_e(t, null, a.$name, n, a.$name), u.$$renameControl(a, e), _e(t, null, a.$name, a, a.$name));
                                    })), r.on("$destroy", function() {
                                        u.$removeControl(a), o && _e(t, null, i[o], n, a.$name), f(a, Di);
                                    });
                                }
                            };
                        }
            ...
            }, _i = Ri(), Ii = Ri(!0), Ui = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, qi = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Fi = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Li = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Hi = /^(\d{4})-(\d{2})-(\d{2})$/, Bi = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, zi = /^(\d{4})-W(\d\d)$/, Gi = /^(\d{4})-(\d\d)$/, Wi = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Yi = {
                text: jn,
                date: _n("date", Hi, Rn(Hi, [ "yyyy", "MM", "dd" ]), "yyyy-MM-dd"),
                "datetime-local": _n("datetimelocal", Bi, Rn(Bi, [ "yyyy", "MM", "dd", "HH", "mm", "ss", "sss" ]), "yyyy-MM-ddTHH:mm:ss.sss"),
                time: _n("time", Wi, Rn(Wi, [ "HH", "mm", "ss", "sss" ]), "HH:mm:ss.sss"),
                week: _n("week", zi, Pn, "yyyy-Www"),
                month: _n("month", Gi, Rn(Gi, [ "yyyy", "MM" ]), "yyyy-MM"),
                number: Un,
                url: qn,
                email: Fn,
                radio: Ln,
                ...
                return {
                    ...
                    link: {
                        pre: function(i, o, a, s) {
                            s[0] && (Yi[Zn(a.type)] || Yi.text)(i, o, a, s[0], e, t, n, r);
                        }
                    }
                };
            ...
            }), no = zn("", !0), ro = zn("Odd", 0), io = zn("Even", 1), oo = On({
                compile: function(t, e) {
            ...
            var co = [ "$animate", function(t) {
                ...
                return {
                    ...
                    link: function(t, e, r, i) {
                        var a = e.attr(r.$attr.ngList) || ", ", s = "false" !== r.ngTrim, u = s ? dr(a) : a, c = function(t) {
                            if (!g(t)) {
                                var e = [];
            ...
            }, $o = "ng-valid", vo = "ng-invalid", go = "ng-pristine", mo = "ng-dirty", yo = "ng-untouched", wo = "ng-touched", bo = "ng-pending", xo = r("ngModel"), So = [ "$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(t, e, r, i, a, s, u, c, l, f) {
                ...
                this.$$setOptions = function(t) {
                    ...
                    } else if (!p.assign) throw xo("nonassign", "Expression '{0}' is non-assignable. Element: {1}", r.ngModel, z(i));
                }, this.$render = d, this.$isEmpty = function(t) {
                    return g(t) || "" === t || null === t || t !== t;
                };
                var C = i.inheritedData("$formController") || Di, k = 0;
                Gn({
                    ctrl: this,
                    $element: i,
                    set: function(t, e) {
                    ...
                    x.$dirty = !1, x.$pristine = !0, s.removeClass(i, mo), s.addClass(i, go);
                }, this.$setDirty = function() {
                    x.$dirty = !0, x.$pristine = !1, s.removeClass(i, go), s.addClass(i, mo), C.$setDirty();
                    ...
                    function s() {
                        ...
                        o(x.$asyncValidators, function(o, a) {
                            var s = o(t, e);
                            if (!N(s)) throw xo("$asyncValidators", "Expected asynchronous validator to return a promise but got '{0}' instead.", s);
                    ...
                    i && m(i.debounce) && (n = i.debounce, b(n) ? r = n : b(n[e]) ? r = n[e] : b(n.default) && (r = n.default)), 
                ...
                return {
                    ...
                    controller: [ "$scope", "$attrs", function(t, e) {
                        ...
                        this.$options.updateOn = dr(this.$options.updateOn.replace(ko, function() {
                ...
                return {
                    ...
                    link: function(i, a, s) {
                        ...
                        var c, l = s.count, f = s.$attr.when && a.attr(s.$attr.when), h = s.offset || 0, p = i.$eval(f) || {}, d = {}, $ = e.startSymbol(), v = e.endSymbol(), g = $ + l + "-" + h + v, m = lr.noop;
                        o(s, function(t, e) {
                            var n = r.exec(e);
                            if (n) {
                                var i = (n[1] ? "-" : "") + Zn(n[2]);
                            ...
                            r || n in p || (n = t.pluralCat(n - h)), n === c || r && isNaN(c) || (m(), m = i.$watch(d[n], u), 
                            c = n);
                        });
                    }
                };
                ...
                return {
                    ...
                    compile: function(r, h) {
                        ...
                        return y ? x = t(y) : (C = function(t, e) {
                            ...
                            x && (S = function(e, n, r) {
                                return b && (E[b] = e), E[w] = n, E.$index = r, x(t, E);
                            });
                            var v = ct();
                            t.$watchCollection(g, function(r) {
                                var h, g, y, x, E, A, T, O, M, N, V, j, D = e[0], P = ct();
                                if (m && (t[m] = r), i(r)) M = r, O = S || C; else {
                                    O = S || k, M = [];
                                    for (var R in r) r.hasOwnProperty(R) && "$" != R.charAt(0) && M.push(R);
                                    M.sort();
                                }
                                for (x = M.length, V = new Array(x), h = 0; h < x; h++) if (E = r === M ? h : M[h], 
                                A = r[E], T = O(E, A, h), v[T]) N = v[T], delete v[T], P[T] = N, V[h] = N; else {
                                    if (P[T]) throw o(V, function(t) {
                                        t && t.scope && (v[t.id] = t);
                                    }), u("dupes", "Duplicates in a repeater are not allowed. Use 'track by' expression to specify unique keys. Repeater: {0}, Duplicate key: {1}, Duplicate value: {2}", p, T, A);
                                    V[h] = {
                                        id: T,
                                        scope: n,
                                        clone: n
                                ...
                                for (var _ in v) {
                                    if (N = v[_], j = ut(N.clone), a.leave(j), j[0].parentNode) for (h = 0, g = j.length; h < g; h++) j[h][s] = !0;
                                    N.scope.$destroy();
                                }
                                for (h = 0; h < x; h++) if (E = r === M ? h : M[h], A = r[E], N = V[h], N.scope) {
                                    y = D;
                                    do y = y.nextSibling; while (y && y[s]);
                                    l(N) != y && a.move(ut(N.clone), null, nr(D)), D = f(N), c(N.scope, h, w, A, b, E, x);
                                } else $(function(t, e) {
                                    N.scope = e;
                                    var n = d.cloneNode(!1);
                                    t[t.length++] = n, a.enter(t, null, nr(D)), D = n, N.clone = t, P[N.id] = N, c(N.scope, h, w, A, b, E, x);
                                });
                                v = P;
                            });
                        };
            ...
            } ], Mo = "ng-hide", No = "ng-hide-animate", Vo = [ "$animate", function(t) {
                return {
                    restrict: "A",
                    multiElement: !0,
                    link: function(e, n, r) {
                        e.$watch(r.ngShow, function(e) {
                            t[e ? "removeClass" : "addClass"](n, Mo, {
                                tempClasses: No
                            });
                        });
                    }
                ...
                return {
                    ...
                    link: function(e, n, r) {
                        e.$watch(r.ngHide, function(e) {
                            t[e ? "addClass" : "removeClass"](n, Mo, {
                                tempClasses: No
                            });
                        });
                    }
                };
            } ], Do = On(function(t, e, n) {
                ...
                return {
                    ...
                    link: function(s, u, c, l) {
                        function f(t, e, n, r) {
                            n.$render = function() {
                                var t = n.$viewValue;
                                r.hasOption(t) ? (C.parent() && C.remove(), e.val(t), "" === t && d.prop("selected", !0)) : null == t && d ? e.val("") : r.renderUnknownOption(t);
                        ...
                        function p(e, s, u) {
                            ...
                            function h() {
                                ...
                                if (n && pr(n)) {
                                    ...
                                    for (var r = 0, i = n.length; r < i; r++) t[r] = c(E, r, n[r]);
                                    return t;
                                }
                                if (n) {
                                    t = {};
                                    for (var o in n) n.hasOwnProperty(o) && (t[o] = c(E, o, n[o]));
                                }
                                return t;
                            }
                            function p(t) {
                                ...
                                } else e = new Ft(t); else P && (t = c(P, null, t));
                                return function(n, r) {
                                    var i;
                                    return i = P ? P : O ? O : V, g ? m(e.remove(c(i, n, r))) : t === c(i, n, r);
                                };
                            }
                            function d() {
                                b || (e.$$postDigest(C), b = !0);
                            }
                            function v(t, e, n) {
                                t[e] = t[e] || 0, t[e] += n ? 1 : -1;
                            }
                            function C() {
                                b = !1;
                                var t, n, r, i, l, f, h, d, y, C, k, A, T, O, V, D, U, q = {
                                    "": []
                                }, F = [ "" ], L = u.$viewValue, H = j(e) || [], B = M ? a(H) : H, z = {}, G = p(L), W = !1;
                                for (R = {}, A = 0; C = B.length, A < C; A++) h = A, M && (h = B[A], "$" === h.charAt(0)) || (d = H[h], 
                                t = c(N, h, d) || "", (n = q[t]) || (n = q[t] = [], F.push(t)), T = G(h, d), W = W || T, 
                                D = c(E, h, d), D = m(D) ? D : "", U = P ? P(e, I) : M ? B[A] : A, P && (R[U] = h), 
                                n.push({
                                    id: U,
                                    label: D,
                                    selected: T
                                }));
                                for (g || (w || null === L ? q[""].unshift({
                                    id: "",
                                    label: "",
                                    selected: !W
                                }) : W || q[""].unshift({
                                    ...
                                    label: "",
                                    selected: !0
                                })), k = 0, y = F.length; k < y; k++) {
                                    for (t = F[k], n = q[t], _.length <= k ? (i = {
                                        element: S.clone().attr("label", t),
                                        label: n.label
                                    }, l = [ i ], _.push(l), s.append(i.element)) : (l = _[k], i = l[0], i.label != t && i.element.attr("label", i.label = t)), 
                                    O = null, A = 0, C = n.length; A < C; A++) r = n[A], (f = l[A + 1]) ? (O = f.element, 
                                    f.label !== r.label && (v(z, f.label, !1), v(z, r.label, !0), O.text(f.label = r.label), 
                                    O.prop("label", f.label)), f.id !== r.id && O.val(f.id = r.id), O[0].selected !== r.selected && (O.prop("selected", f.selected = r.selected), 
                                    er && O.prop("selected", f.selected))) : ("" === r.id && w ? V = w : (V = x.clone()).val(r.id).prop("selected", r.selected).attr("selected", r.selected).prop("label", r.label).text(r.label), 
                                    l.push(f = {
                                        element: V,
                                        label: r.label,
                                        id: r.id,
                                        selected: r.selected
                                    }), v(z, r.label, !0), O ? O.after(V) : i.element.append(V), O = V);
                                    for (A++; l.length > A; ) r = l.pop(), v(z, r.label, !1), r.element.remove();
                                }
                                for (;_.length > k; ) {
                                    for (n = _.pop(), A = 1; A < n.length; ++A) v(z, n[A].label, !1);
                                    n[0].element.remove();
                                }
                                o(z, function(t, e) {
                            ...
                            var k;
                            if (!(k = y.match(i))) throw qo("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", y, z(s));
                            var E = r(k[2] || k[1]), A = k[4] || k[6], T = / as /.test(k[0]) && k[1], O = T ? r(T) : null, M = k[5], N = r(k[3] || ""), V = r(k[2] ? k[1] : A), j = r(k[7]), D = k[8], P = D ? r(k[8]) : null, R = {}, _ = [ [ {
                                element: s,
                                label: ""
                            } ] ], I = {};
                            w && (t(w)(e), w.removeClass("ng-scope"), w.remove()), s.empty(), s.on("change", l), 
                            u.$render = C, e.$watchCollection(j, d), e.$watchCollection(h, d), g && e.$watchCollection(function() {
                                return u.$modelValue;
                            }, d);
                        }
                        if (l[1]) {
                            for (var d, $ = l[0], v = l[1], g = c.multiple, y = c.ngOptions, w = !1, b = !1, x = nr(e.createElement("option")), S = nr(e.createElement("optgroup")), C = x.clone(), k = 0, E = u.children(), A = E.length; k < A; k++) if ("" === E[k].value) {
                                d = w = E.eq(k);
                                break;
                            }
                            $.init(v, w, C), g && (v.$isEmpty = function(t) {
                                return !t || 0 === t.length;
                            }), y ? p(s, u, v) : g ? h(s, u, v) : f(s, u, v, $);
                        }
                    }
                };
            ...
            pt(lr), void nr(e).ready(function() {
                X(e, Q);
            }));
    ...
    44: function(t, e) {
        angular.module("gettext", []), angular.module("gettext").constant("gettext", function(t) {
            return t;
        }), angular.module("gettext").factory("gettextCatalog", [ "gettextPlurals", "gettextFallbackLanguage", "$http", "$cacheFactory", "$interpolate", "$rootScope", function(t, e, n, r, i, o) {
            function a() {
                o.$broadcast("gettextLanguageChanged");
            }
            var s, u = "$$noContext", c = '<span id="test" title="test" class="tested">test</span>', l = angular.element("<span>" + c + "</span>").html() !== c, f = function(t) {
                return s.debug && s.currentLanguage !== s.baseLanguage ? s.debugPrefix + t : t;
            }, h = function(t) {
                return s.showTranslatedMarkers ? s.translatedMarkerPrefix + t + s.translatedMarkerSuffix : t;
            };
            return s = {
                debug: !1,
                debugPrefix: "[MISSING]: ",
                ...
                setCurrentLanguage: function(t) {
                    this.currentLanguage = t, a();
                },
                getCurrentLanguage: function() {
                    return this.currentLanguage;
                },
                setStrings: function(e, n) {
                    this.strings[e] || (this.strings[e] = {});
                    var r = t(e, 1);
                    for (var i in n) {
                        var o = n[i];
                        if (l && (i = angular.element("<span>" + i + "</span>").html()), angular.isString(o) || angular.isArray(o)) {
                            var s = {};
                            s[u] = o, o = s;
                        }
                        this.strings[e][i] || (this.strings[e][i] = {});
                        for (var c in o) {
                            var f = o[c];
                            angular.isArray(f) ? this.strings[e][i][c] = f : (this.strings[e][i][c] = [], this.strings[e][i][c][r] = f);
                        }
                    }
                    a();
                },
                getStringFormFor: function(e, n, r, i) {
                    if (!e) return null;
                    var o = this.strings[e] || {}, a = o[n] || {}, s = a[i || u] || [];
                    return s[t(e, r)];
                },
                getString: function(t, n, r) {
                    var o = e(this.currentLanguage);
                    return t = this.getStringFormFor(this.currentLanguage, t, 1, r) || this.getStringFormFor(o, t, 1, r) || f(t), 
                    t = n ? i(t)(n) : t, h(t);
                },
                getPlural: function(t, n, r, o, a) {
                    var s = e(this.currentLanguage);
                    return n = this.getStringFormFor(this.currentLanguage, n, t, a) || this.getStringFormFor(s, n, t, a) || f(1 === t ? n : r), 
                    o && (o.$count = t, n = i(n)(o)), h(n);
                },
                loadRemote: function(t) {
                    return n({
                        ...
                        var e = t.data;
                        for (var n in e) s.setStrings(n, e[n]);
                        return t;
                    });
                }
            };
        } ]), angular.module("gettext").directive("translate", [ "gettextCatalog", "$parse", "$animate", "$compile", "$window", "gettextUtil", function(t, e, n, r, i, o) {
            function a(t) {
                return o.lcFirst(t.replace(l, ""));
            }
            function s(t, e, n) {
                var r = Object.keys(e).filter(function(t) {
                    return o.startsWith(t, l) && t !== l;
                });
                if (!r.length) return null;
                var i = angular.extend({}, t), s = [];
                return r.forEach(function(r) {
                    var o = t.$watch(e[r], function(t) {
                        var e = a(r);
                        i[e] = t, n(i);
                    });
                    s.push(o);
            ...
            var u = angular.$$lowercase || angular.lowercase, c = parseInt((/msie (\d+)/.exec(u(i.navigator.userAgent)) || [])[1], 10), l = "translateParams";
            return {
                restrict: "AE",
                terminal: !0,
                compile: function(i, a) {
                    o.assert(!a.translatePlural || a.translateN, "translate-n", "translate-plural"), 
                    o.assert(!a.translateN || a.translatePlural, "translate-plural", "translate-n");
                    var u = o.trim(i.html()), l = a.translatePlural, f = a.translateContext;
                    return c <= 8 && "<!--IE fix-->" === u.slice(-13) && (u = u.slice(0, -13)), {
                        post: function(i, a, c) {
                            function h(e) {
                                e = e || null;
                                var s;
                                l ? (i = d || (d = i.$new()), i.$count = p(i), s = t.getPlural(i.$count, u, l, e, f)) : s = t.getString(u, e, f);
                                var c = a.contents();
                                if (c || s) {
                                    if (s === o.trim(c.html())) return void ($ && r(c)(i));
                                    var h = angular.element("<span>" + s + "</span>");
                                    r(h.contents())(i);
                                    var v = h.contents();
                                    n.enter(v, a), n.leave(c);
                                }
                            }
                            var p = e(c.translateN), d = null, $ = !0, v = s(i, c, h);
                            h(v), $ = !1, c.translateN && i.$watch(c.translateN, function() {
                                h(v);
            ...
            function t(t, e, n) {
                if (!t) throw new Error("You should add a " + e + " attribute whenever you add a " + n + " attribute.");
            }
            function e(t, e) {
