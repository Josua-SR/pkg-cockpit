!function(e) {
    ...
    !function() {
        ...
        var a = n(2), r = n(3), i = n(129);
        n(130), n(132), n(133), n(131);
        var s = n(134);
        n(135);
        var o = a.gettext;
        a.translate(), i.module("ostree", [ "ngRoute", "gettext", "ui.cockpit", "ostree.remotes" ]).config([ "$routeProvider", function(e) {
            e.when("/", {
            ...
            function r(e) {
                var t = null, r = !1;
                "access-denied" === e.problem ? t = o("Not authorized to update software on this system") : "not-found" === e.problem ? (t = o("OSTree is not available on this system"), 
                r = !0) : t = a.message(e), n({
                    state: "failed",
                    failure: e,
                    message: t,
            ...
            function i() {
                window.clearTimeout(d), d = null, s.os_list && 0 === s.os_list.length ? n({
                    state: "empty",
                    message: o("No OSTree deployments found"),
                    failure: !0
            ...
            }, 1e3), s.addEventListener("connectionLost", l), s.addEventListener("changed", i), 
            u(s.connect()), e.reconnect = function() {
                n({
                    state: "connecting"
                }), u(s.connect());
            }, e.$on("$destroy", function() {
                s.removeEventListener("connectionLost", l), s.removeEventListener("changed", i);
            });
        } ]).controller("indexController", [ "$scope", function(t) {
            function n() {
                t.$applyAsync(function() {
                    t.runningMethod = s.running_method, t.os_list = s.os_list, s.os_list ? t.os && s.get_os_proxy(t.os) || t.displayOS(s.os_list[0]) : t.displayOS(null);
                });
            }
            t.os = null, t.track_id = e, t.displayOS = function(e) {
                t.os = e, t.currentOrigin = s.get_default_origin(e);
            }, t.knownVersions = function() {
                var e = t.currentOrigin || {};
                return s.known_versions_for(t.os, e.remote, e.branch);
            }, t.itemMatches = function(e, t) {
                return s.item_matches(e, t);
            }, t.$on("changeOrigin", function(e, n, a) {
                t.$applyAsync(function() {
                    var e = {
                        remote: n,
                        branch: a
                    }, r = s.get_default_origin(t.os) || {};
                    e.branch || (e.branch = r.branch), e.remote || (e.remote = r.remote), t.currentOrigin = e;
                });
            }), s.connect().done(function() {
                s.addEventListener("changed", n), n();
            }), t.$on("$destroy", function() {
                s.removeEventListener("changed", n);
            });
        } ]).factory("$exceptionHandler", [ "$log", function(e) {
            return function(t, n) {
                a.oops(), e.error.apply(e, arguments);
            };
            ...
            return {
                ...
                link: function(r, i, u) {
                    function l(e, t) {
                        r.isRunning = !0, s.cache_update_for(r.os, e, t).always(function() {
                            r.$applyAsync(function() {
                                r.isRunning = !1;
                            });
                        });
                    }
                    r.error = null, r.progressMsg = null, r.isRunning = !1, r.branches = {}, r.$watch("currentOrigin.remote", function(e) {
                        var t = {
                            remote: e
                        };
                        return e ? void (r.branches.remote !== e && (r.isRunning = !0, n.listBranches(e).then(function(e) {
                            t.list = e;
                        }, function(e) {
                            t.error = a.message(e);
                        }).then(function() {
                            r.$applyAsync(function() {
                                r.branches = t, r.isRunning = !1;
                            });
                        }))) : void (r.branches = {});
                    }), r.$watch("runningMethod", function() {
                        var e = "DownloadUpdateRpmDiff:" + r.os, t = "DownloadRebaseRpmDiff:" + r.os;
                        r.isRunning = e === s.running_method || t === s.running_method;
                    }), r.checkForUpgrades = function() {
                        var e = r.currentOrigin || {};
                        r.error = null, r.progressMsg = o("Checking for updates");
                        var n = s.check_for_updates(r.os, e.remote, e.branch);
                        t(n, r);
                    }, r.switchBranch = function(e) {
                        r.currentOrigin && (r.error = null, l(r.currentOrigin.remote, e), r.$emit("changeOrigin", r.currentOrigin.remote, e));
                    }, r.changeRepository = function() {
                        r.error = null;
                        var t = e.open({
                            animation: !1,
                        ...
                        return t.then(function(e) {
                            r.branches = e.branches, r.$emit("changeOrigin", e.remote, e.branch);
                        }), t;
                    };
                }
            };
            ...
            return {
                ...
                link: function(n, r, i) {
                    function o() {
                        var e = "";
                        s.item_matches(n.item, "CachedUpdate") ? e = "Deploy:" : s.item_matches(n.item, "RollbackDeployment") ? e = "Rollback:" : n.item.id || (e = "Rebase:"), 
                        n.item && n.item.osname && (e += n.item.osname.v), n.isRunning = e === s.running_method;
                    }
                    function u() {
                        n.$digest();
                    }
                    n.error = null, n.progressMsg = null, n.id = e(n.item), n.active = "tree", n.matches = function(e) {
                        return s.item_matches(n.item, e);
                    }, n.packages = s.packages(n.item), n.packages.addEventListener("changed", u), n.$on("$destroy", function() {
                        n.packages.removeEventListener("changed", u);
                    }), n.signature_obj = s.signature_obj, n.isRunning = !1, o(), n.$watch("runningMethod", o), 
                    n.isUpdate = function() {
                        ...
                        return n.item && !n.item.id && !s.item_matches(n.item, "BootedDeployment", "origin") && !n.matches("RollbackDeployment") && !n.matches("DefaultDeployment");
                        ...
                        n.error = null;
                        var r = {
                            reboot: a.variant("b", !0)
                        }, i = s.run_transaction("Rollback", [ r ], e);
                        t(i, n);
                    }, n.doUpgrade = function(e, r) {
                        n.error = null;
                        var i = {
                            reboot: a.variant("b", !0)
                        }, o = s.run_transaction("Deploy", [ r, i ], e);
                        t(o, n);
                    }, n.doRebase = function(e, r, i) {
                        n.error = null;
                        var o = {
                            reboot: a.variant("b", !0),
                            revision: a.variant("s", i)
                        }, u = s.run_transaction("Rebase", [ o, r, [] ], e);
                        t(u, n);
                    };
                }
            };
            ...
            return function(e) {
                var t = a.ngettext(o("$0 package"), o("$0 packages"), e);
                return a.format(t, e);
            };
        }).filter("releaseName", function() {
            return function(e) {
                var t = "";
                if (e && e.osname) return e.version && (t = e.version.v), a.format("$0 $1", e.osname.v, t);
            };
        }).filter("timeAgo", function() {
            return function(e) {
                return e ? r.unix(e).fromNow() : "";
            };
    ...
    (function(e) {
        !function(t, n) {
            ...
            function p(e) {
                if (null == e._isValid) {
                    var t = f(e), n = xa.call(t.parsedDateParts, function(e) {
                        return null != e;
            ...
            function M(e, t) {
                ...
                o(t._pf) || (e._pf = f(t)), o(t._locale) || (e._locale = t._locale), Ha.length > 0) for (n = 0; n < Ha.length; n++) a = Ha[n], 
                r = t[a], o(r) || (e[a] = r);
                return e;
            }
            function y(e) {
                M(this, e), this._d = new Date(null != e._d ? e._d.getTime() : NaN), this.isValid() || (this._d = new Date(NaN)), 
                ja === !1 && (ja = !0, t.updateOffset(this), ja = !1);
            }
            function v(e) {
            ...
            function D(e, n) {
                null != t.deprecationHandler && t.deprecationHandler(e, n), Oa[e] || (k(n), Oa[e] = !0);
            }
            function b(e) {
            ...
            function V(e) {
                ...
                for (t = 0, n = a.length; t < n; t++) qa[a[t]] ? a[t] = qa[a[t]] : a[t] = z(a[t]);
                return function(t) {
                    var r, i = "";
            ...
            function q(e, t) {
                return e.isValid() ? (t = J(t, e.localeData()), Va[t] = Va[t] || V(t), Va[t](e)) : e.localeData().invalidDate();
            }
            function J(e, t) {
                function n(e) {
                ...
                var a = 5;
                for (za.lastIndex = 0; a >= 0 && za.test(e); ) e = e.replace(za, n), za.lastIndex = 0, 
                a -= 1;
                return e;
            }
            function G(e, t, n) {
                dr[e] = b(t) ? t : function(e, a) {
                    return e && n ? n : t;
                };
            }
            function B(e, t) {
                return c(dr, e) ? dr[e](t._strict, t._locale) : new RegExp(K(e));
            }
            function K(e) {
            ...
            function ce(e, t) {
                return e ? r(this._months) ? this._months[e.month()] : this._months[(this._months.isFormat || $r).test(t) ? "format" : "standalone"][e.month()] : r(this._months) ? this._months : this._months.standalone;
            }
            function me(e, t) {
                return e ? r(this._monthsShort) ? this._monthsShort[e.month()] : this._monthsShort[$r.test(t) ? "format" : "standalone"][e.month()] : r(this._monthsShort) ? this._monthsShort : this._monthsShort.standalone;
            }
            function _e(e, t, n) {
                ...
                return n ? "MMM" === t ? (r = Lr.call(this._shortMonthsParse, s), r !== -1 ? r : null) : (r = Lr.call(this._longMonthsParse, s), 
                r !== -1 ? r : null) : "MMM" === t ? (r = Lr.call(this._shortMonthsParse, s), r !== -1 ? r : (r = Lr.call(this._longMonthsParse, s), 
                r !== -1 ? r : null)) : (r = Lr.call(this._longMonthsParse, s), r !== -1 ? r : (r = Lr.call(this._shortMonthsParse, s), 
                r !== -1 ? r : null));
            }
            function he(e, t, n) {
                var a, r, i;
            ...
            function fe(e, t) {
                ...
                if ("string" == typeof t) if (/^\d+$/.test(t)) t = Y(t); else if (t = e.localeData().monthsParse(t), 
                !u(t)) return e;
            ...
            function Me(e) {
                return this._monthsParseExact ? (c(this, "_monthsRegex") || ve.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (c(this, "_monthsShortRegex") || (this._monthsShortRegex = Dr), 
                this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex);
            }
            function ye(e) {
                return this._monthsParseExact ? (c(this, "_monthsRegex") || ve.call(this), e ? this._monthsStrictRegex : this._monthsRegex) : (c(this, "_monthsRegex") || (this._monthsRegex = br), 
            ...
            function $e(e, t, n) {
                var a = 7 + t - n, r = (7 + Ye(e, 0, a).getUTCDay() - t) % 7;
                return -r + a - 1;
            }
            function ke(e, t, n, a, r) {
                var i, s, o = (7 + n - a) % 7, u = $e(e, a, r), l = 1 + 7 * (t - 1) + o + u;
                return l <= 0 ? (i = e - 1, s = te(i) + l) : l > te(e) ? (i = e + 1, s = l - te(e)) : (i = e, 
                s = l), {
                    year: i,
                    dayOfYear: s
                };
            ...
            function we(e, t, n) {
                var a, r, i = $e(e.year(), t, n), s = Math.floor((e.dayOfYear() - i - 1) / 7) + 1;
            ...
            function Pe(e, t, n) {
                ...
                return n ? "dddd" === t ? (r = Lr.call(this._weekdaysParse, s), r !== -1 ? r : null) : "ddd" === t ? (r = Lr.call(this._shortWeekdaysParse, s), 
                r !== -1 ? r : null) : (r = Lr.call(this._minWeekdaysParse, s), r !== -1 ? r : null) : "dddd" === t ? (r = Lr.call(this._weekdaysParse, s), 
                r !== -1 ? r : (r = Lr.call(this._shortWeekdaysParse, s), r !== -1 ? r : (r = Lr.call(this._minWeekdaysParse, s), 
                r !== -1 ? r : null))) : "ddd" === t ? (r = Lr.call(this._shortWeekdaysParse, s), 
                r !== -1 ? r : (r = Lr.call(this._weekdaysParse, s), r !== -1 ? r : (r = Lr.call(this._minWeekdaysParse, s), 
                r !== -1 ? r : null))) : (r = Lr.call(this._minWeekdaysParse, s), r !== -1 ? r : (r = Lr.call(this._weekdaysParse, s), 
                r !== -1 ? r : (r = Lr.call(this._shortWeekdaysParse, s), r !== -1 ? r : null)));
            }
            function Fe(e, t, n) {
                var a, r, i;
            ...
            function Ie(e) {
                return this._weekdaysParseExact ? (c(this, "_weekdaysRegex") || Ve.call(this), e ? this._weekdaysStrictRegex : this._weekdaysRegex) : (c(this, "_weekdaysRegex") || (this._weekdaysRegex = jr), 
                this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex);
            }
            function Ue(e) {
                return this._weekdaysParseExact ? (c(this, "_weekdaysRegex") || Ve.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (c(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Or), 
                this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
            }
            function ze(e) {
                return this._weekdaysParseExact ? (c(this, "_weekdaysRegex") || Ve.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (c(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Er), 
            ...
            function Ve() {
                ...
                var t, n, a, r, i, s = [], o = [], u = [], l = [];
                for (t = 0; t < 7; t++) n = _([ 2e3, 1 ]).day(t), a = this.weekdaysMin(n, ""), r = this.weekdaysShort(n, ""), 
                i = this.weekdays(n, ""), s.push(a), o.push(r), u.push(i), l.push(a), l.push(r), 
                l.push(i);
                for (s.sort(e), o.sort(e), u.sort(e), l.sort(e), t = 0; t < 7; t++) o[t] = Z(o[t]), 
                u[t] = Z(u[t]), l[t] = Z(l[t]);
            ...
            function nt(e, t) {
                if (null !== t) {
                    ...
                    a = Wr[e]._config; else if (null != t.parentLocale) if (null != Wr[t.parentLocale]) a = Wr[t.parentLocale]._config; else {
                        if (n = et(t.parentLocale), null == n) return Nr[t.parentLocale] || (Nr[t.parentLocale] = []), 
                        Nr[t.parentLocale].push({
                            name: e,
                            config: t
                        }), null;
                        a = n._config;
                    }
                    return Wr[e] = new x(S(a, t)), Nr[e] && Nr[e].forEach(function(e) {
                        nt(e.name, e.config);
                    }), tt(e), Wr[e];
                }
            ...
            function at(e, t) {
                if (null != t) {
                    var n, a, r = Fr;
                    a = et(e), null != a && (r = a._config), t = S(r, t), n = new x(t), n.parentLocale = Wr[e], 
                    Wr[e] = n, tt(e);
            ...
            function st(e) {
                var t, n = e._a;
                return n && f(e).overflow === -2 && (t = n[_r] < 0 || n[_r] > 11 ? _r : n[hr] < 1 || n[hr] > de(n[mr], n[_r]) ? hr : n[fr] < 0 || n[fr] > 24 || 24 === n[fr] && (0 !== n[pr] || 0 !== n[gr] || 0 !== n[Mr]) ? fr : n[pr] < 0 || n[pr] > 59 ? pr : n[gr] < 0 || n[gr] > 59 ? gr : n[Mr] < 0 || n[Mr] > 999 ? Mr : -1, 
                f(e)._overflowDayOfYear && (t < mr || t > hr) && (t = hr), f(e)._overflowWeeks && t === -1 && (t = yr), 
                f(e)._overflowWeekday && t === -1 && (t = vr), f(e).overflow = t), e;
            }
            function ot(e, t, n) {
            ...
            function lt(e) {
                var t, n, a, r, i, s = [];
                if (!e._d) {
                    for (a = ut(e), e._w && null == e._a[hr] && null == e._a[_r] && dt(e), null != e._dayOfYear && (i = ot(e._a[mr], a[mr]), 
                    (e._dayOfYear > te(i) || 0 === e._dayOfYear) && (f(e)._overflowDayOfYear = !0), 
                    n = Ye(i, 0, e._dayOfYear), e._a[_r] = n.getUTCMonth(), e._a[hr] = n.getUTCDate()), 
                    t = 0; t < 3 && null == e._a[t]; ++t) e._a[t] = s[t] = a[t];
                    for (;t < 7; t++) e._a[t] = s[t] = null == e._a[t] ? 2 === t ? 1 : 0 : e._a[t];
                    24 === e._a[fr] && 0 === e._a[pr] && 0 === e._a[gr] && 0 === e._a[Mr] && (e._nextDay = !0, 
                    e._a[fr] = 0), e._d = (e._useUTC ? Ye : Le).apply(null, s), r = e._useUTC ? e._d.getUTCDay() : e._d.getDay(), 
                    null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), e._nextDay && (e._a[fr] = 24), 
                    e._w && "undefined" != typeof e._w.d && e._w.d !== r && (f(e).weekdayMismatch = !0);
                }
            }
            function dt(e) {
                var t, n, a, r, i, s, o, u;
                if (t = e._w, null != t.GG || null != t.W || null != t.E) i = 1, s = 4, n = ot(t.GG, e._a[mr], we(bt(), 1, 4).year), 
                a = ot(t.W, 1), r = ot(t.E, 1), (r < 1 || r > 7) && (u = !0); else {
                    i = e._locale._week.dow, s = e._locale._week.doy;
                    var l = we(bt(), i, s);
                    n = ot(t.gg, e._a[mr], l.year), a = ot(t.w, l.week), null != t.d ? (r = t.d, (r < 0 || r > 6) && (u = !0)) : null != t.e ? (r = t.e + i, 
                    (t.e < 0 || t.e > 6) && (u = !0)) : r = i;
                }
                a < 1 || a > De(n, i, s) ? f(e)._overflowWeeks = !0 : null != u ? f(e)._overflowWeekday = !0 : (o = ke(n, a, r, i, s), 
                e._a[mr] = o.year, e._dayOfYear = o.dayOfYear);
            }
            function ct(e) {
                var t, n, a, r, i, s, o = e._i, u = Rr.exec(o) || Ir.exec(o);
                if (u) {
                    for (f(e).iso = !0, t = 0, n = zr.length; t < n; t++) if (zr[t][1].exec(u[1])) {
                        r = zr[t][0], a = zr[t][2] !== !1;
                        break;
                    }
                    if (null == r) return void (e._isValid = !1);
                    if (u[3]) {
                        for (t = 0, n = Vr.length; t < n; t++) if (Vr[t][1].exec(u[3])) {
                            i = (u[2] || " ") + Vr[t][0];
                            break;
                        }
                    ...
                    if (u[4]) {
                        if (!Ur.exec(u[4])) return void (e._isValid = !1);
                        s = "Z";
                    }
                    e._f = r + (i || "") + (s || ""), yt(e);
                } else e._isValid = !1;
            ...
            function ft(e, t, n) {
                if (e) {
                    var a = xr.indexOf(e), r = new Date(t[0], t[1], t[2]).getDay();
                    if (a !== r) return f(n).weekdayMismatch = !0, n._isValid = !1, !1;
                }
                return !0;
            }
            function pt(e, t, n) {
            ...
            function gt(e) {
                var t = Jr.exec(ht(e._i));
                if (t) {
                    var n = mt(t[4], t[3], t[2], t[5], t[6], t[7]);
                    if (!ft(t[1], n, e)) return;
                    e._a = n, e._tzm = pt(t[8], t[9], t[10]), e._d = Ye.apply(null, e._a), e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), 
                    f(e).rfc2822 = !0;
                } else e._isValid = !1;
            }
            function Mt(e) {
                ...
                gt(e), e._isValid === !1 && (delete e._isValid, t.createFromInputFallback(e)))));
            }
            function yt(e) {
                if (e._f === t.ISO_8601) return void ct(e);
                if (e._f === t.RFC_2822) return void gt(e);
                e._a = [], f(e).empty = !0;
                var n, a, r, i, s, o = "" + e._i, u = o.length, l = 0;
                for (r = J(e._f, e._locale).match(Ua) || [], n = 0; n < r.length; n++) i = r[n], 
                a = (o.match(B(i, e)) || [])[0], a && (s = o.substr(0, o.indexOf(a)), s.length > 0 && f(e).unusedInput.push(s), 
                o = o.slice(o.indexOf(a) + a.length), l += a.length), qa[i] ? (a ? f(e).empty = !1 : f(e).unusedTokens.push(i), 
                ee(i, a, e)) : e._strict && !a && f(e).unusedTokens.push(i);
                f(e).charsLeftOver = u - l, o.length > 0 && f(e).unusedInput.push(o), e._a[fr] <= 12 && f(e).bigHour === !0 && e._a[fr] > 0 && (f(e).bigHour = void 0), 
                f(e).parsedDateParts = e._a.slice(0), f(e).meridiem = e._meridiem, e._a[fr] = vt(e._locale, e._a[fr], e._meridiem), 
                lt(e), st(e);
            }
            function vt(e, t, n) {
                var a;
            ...
            function Lt(e) {
                ...
                for (r = 0; r < e._f.length; r++) i = 0, t = M({}, e), null != e._useUTC && (t._useUTC = e._useUTC), 
                t._f = e._f[r], yt(t), p(t) && (i += f(t).charsLeftOver, i += 10 * f(t).unusedTokens.length, 
            ...
            function kt(e) {
                var t = e._i, n = e._f;
                return e._locale = e._locale || rt(e._l), null === t || void 0 === n && "" === t ? g({
                    nullInput: !0
                }) : ("string" == typeof t && (e._i = t = e._locale.preparse(t)), v(t) ? new y(st(t)) : (l(t) ? e._d = t : r(n) ? Lt(e) : n ? yt(e) : wt(e), 
                p(e) || (e._d = null), e));
            }
            function wt(e) {
                var n = e._i;
                o(n) ? e._d = new Date(t.now()) : l(n) ? e._d = new Date(n.valueOf()) : "string" == typeof n ? Mt(e) : r(n) ? (e._a = d(n.slice(0), function(e) {
                    return parseInt(e, 10);
                }), lt(e)) : i(n) ? Yt(e) : u(n) ? e._d = new Date(n) : t.createFromInputFallback(e);
            }
            function Dt(e, t, n, a, o) {
                var u = {};
                return n !== !0 && n !== !1 || (a = n, n = void 0), (i(e) && s(e) || r(e) && 0 === e.length) && (e = void 0), 
                u._isAMomentObject = !0, u._useUTC = u._isUTC = o, u._l = n, u._i = e, u._f = t, 
                u._strict = a, $t(u);
            }
            function bt(e, t, n, a) {
                return Dt(e, t, n, a, !1);
            ...
            function Ht(e) {
                for (var t in e) if (Lr.call(Qr, t) === -1 || null != e[t] && isNaN(e[t])) return !1;
                for (var n = !1, a = 0; a < Qr.length; ++a) if (e[Qr[a]]) {
                    if (n) return !1;
                    parseFloat(e[Qr[a]]) !== Y(e[Qr[a]]) && (n = !0);
                }
                return !0;
            }
            function jt() {
            ...
            function Et(e) {
                var t = W(e), n = t.year || 0, a = t.quarter || 0, r = t.month || 0, i = t.week || 0, s = t.day || 0, o = t.hour || 0, u = t.minute || 0, l = t.second || 0, d = t.millisecond || 0;
                this._isValid = Ht(t), this._milliseconds = +d + 1e3 * l + 6e4 * u + 1e3 * o * 60 * 60, 
            ...
            function Ft(e, t) {
                ...
                var a = n[n.length - 1] || [], r = (a + "").match(Xr) || [ "-", 0, 0 ], i = +(60 * r[1]) + Y(r[2]);
                return 0 === i ? 0 : "+" === r[0] ? i : -i;
            }
            function Wt(e, n) {
                var a, r;
                return n._isUTC ? (a = n.clone(), r = (v(e) || l(e) ? e.valueOf() : bt(e).valueOf()) - a.valueOf(), 
                a._d.setTime(a._d.valueOf() + r), t.updateOffset(a, !1), a) : bt(e).local();
            }
            function Nt(e) {
            ...
            function Rt(e, n, a) {
                ...
                if (null != e) {
                    if ("string" == typeof e) {
                        if (e = Ft(or, e), null === e) return this;
                    } else Math.abs(e) < 16 && !a && (e *= 60);
                    return !this._isUTC && n && (r = Nt(this)), this._offset = e, this._isUTC = !0, 
                    null != r && this.add(r, "m"), i !== e && (!n || this._changeInProgress ? an(this, Qt(e - i, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, 
            ...
            function Qt(e, t) {
                ...
                return Ct(e) ? i = {
                    ...
                    d: e._days,
                    M: e._months
                } : u(e) ? (i = {}, t ? i[t] = e : i.milliseconds = e) : (s = ei.exec(e)) ? (n = "-" === s[1] ? -1 : 1, 
                i = {
                    y: 0,
                    d: Y(s[hr]) * n,
                    h: Y(s[fr]) * n,
                    ...
                    m: Xt(s[7], n),
                    s: Xt(s[8], n)
                }) : null == i ? i = {} : "object" == typeof i && ("from" in i || "to" in i) && (r = tn(bt(i.from), bt(i.to)), 
                i = {}, i.ms = r.milliseconds, i.M = r.months), a = new Et(i), Ct(e) && c(e, "_locale") && (a._locale = e._locale), 
                a;
            }
            function Xt(e, t) {
            ...
            function nn(e, t) {
                return function(n, a) {
                    ...
                    i = n, n = a, a = i), n = "string" == typeof n ? +n : n, r = Qt(n, a), an(this, r, e), 
                    this;
                };
            }
            function an(e, n, a, r) {
                var i = n._milliseconds, s = At(n._days), o = At(n._months);
                e.isValid() && (r = null == r || r, o && fe(e, ie(e, "Month") + o * a), s && se(e, "Date", ie(e, "Date") + s * a), 
            ...
            function sn(e, n) {
                var a = e || bt(), r = Wt(a, this).startOf("day"), i = t.calendarFormat(this, r) || "sameElse", s = n && (b(n[i]) ? n[i].call(this, a) : n[i]);
                return this.format(s || this.localeData().calendar(i, this, bt(a)));
            }
            function on() {
                return new y(this);
            }
            ...
            function cn(e, t) {
                var n, a = v(e) ? e : bt(e);
                return !(!this.isValid() || !a.isValid()) && (t = F(t || "millisecond"), "millisecond" === t ? this.valueOf() === a.valueOf() : (n = a.valueOf(), 
            ...
            function gn(e) {
                ...
                return n.year() < 0 || n.year() > 9999 ? q(n, t ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : b(Date.prototype.toISOString) ? t ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", q(n, "Z")) : q(n, t ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ");
            }
            function Mn() {
            ...
            function vn(e, t) {
                return this.isValid() && (v(e) && e.isValid() || bt(e).isValid()) ? Qt({
                    to: this,
                    from: e
            ...
            function Un(e, t, n, a, r) {
                var i;
                return null == e ? we(this, a, r).year : (i = De(e, a, r), t > i && (t = i), zn.call(this, e, t, n, a, r));
            }
            function zn(e, t, n, a, r) {
                var i = ke(e, t, n, a, r), s = Ye(i.year, 0, i.dayOfYear);
            ...
            function ta(e, t, n, a) {
                "boolean" == typeof e ? (u(t) && (n = t, t = void 0), t = t || "") : (t = e, n = t, 
                e = !1, u(t) && (n = t, t = void 0), t = t || "");
                var r = rt(), i = e ? r._week.dow : 0;
                if (null != n) return Xn(t, (n + i) % 7, a, "day");
                var s, o = [];
                for (s = 0; s < 7; s++) o[s] = Xn(t, (s + i) % 7, a, "day");
                return o;
            }
            function na(e, t) {
            ...
            function ma() {
                ...
                return i >= 0 && s >= 0 && o >= 0 || i <= 0 && s <= 0 && o <= 0 || (i += 864e5 * ca(ha(o) + s), 
                s = 0, o = 0), u.milliseconds = i % 1e3, e = L(i / 1e3), u.seconds = e % 60, t = L(e / 60), 
                u.minutes = t % 60, n = L(t / 60), u.hours = n % 24, s += L(n / 24), r = L(_a(s)), 
                o += r, s -= ca(ha(r)), a = L(o / 12), o %= 12, u.days = s, u.months = o, u.years = a, 
                this;
            }
            function _a(e) {
            ...
            function fa(e) {
                ...
                if (e = F(e), "month" === e || "year" === e) return t = this._days + a / 864e5, 
            ...
            function $a(e, t, n) {
                var a = Qt(e).abs(), r = Ti(a.as("s")), i = Ti(a.as("m")), s = Ti(a.as("h")), o = Ti(a.as("d")), u = Ti(a.as("M")), l = Ti(a.as("y")), d = r <= Si.ss && [ "s", r ] || r < Si.s && [ "ss", r ] || i <= 1 && [ "m" ] || i < Si.m && [ "mm", i ] || s <= 1 && [ "h" ] || s < Si.h && [ "hh", s ] || o <= 1 && [ "d" ] || o < Si.d && [ "dd", o ] || u <= 1 && [ "M" ] || u < Si.M && [ "MM", u ] || l <= 1 && [ "y" ] || [ "yy", l ];
                return d[2] = t, d[3] = +e > 0, d[4] = n, Ya.apply(null, d);
            }
            function ka(e) {
            ...
            function Da(e) {
                ...
                var t = this.localeData(), n = $a(this, !e, t);
            ...
            function Ta() {
                if (!this.isValid()) return this.localeData().invalidDate();
                var e, t, n, a = xi(this._milliseconds) / 1e3, r = xi(this._days), i = xi(this._months);
                e = L(a / 60), t = L(e / 60), a %= 60, e %= 60, n = L(i / 12), i %= 12;
                var s = n, o = i, u = r, l = t, d = e, c = a ? a.toFixed(3).replace(/\.?0+$/, "") : "", m = this.asSeconds();
                if (!m) return "P0D";
                var _ = m < 0 ? "-" : "", h = ba(this._months) !== ba(m) ? "-" : "", f = ba(this._days) !== ba(m) ? "-" : "", p = ba(this._milliseconds) !== ba(m) ? "-" : "";
                return _ + "P" + (s ? h + s + "Y" : "") + (o ? h + o + "M" : "") + (u ? f + u + "D" : "") + (l || d || c ? "T" : "") + (l ? p + l + "H" : "") + (d ? p + d + "M" : "") + (c ? p + c + "S" : "");
            }
            var Sa, xa;
            ...
            var Ha = t.momentProperties = [], ja = !1, Oa = {};
            t.suppressDeprecationWarnings = !1, t.deprecationHandler = null;
            var Ea;
            Ea = Object.keys ? Object.keys : function(e) {
                var t, n = [];
            ...
            var Ca = {
            ...
            }, Pa = "Invalid date", Fa = "%d", Wa = /\d{1,2}/, Na = {
                future: "in %s",
                past: "%s ago",
                s: "a few seconds",
                ss: "%d seconds",
                ...
                y: "a year",
                yy: "%d years"
            }, Ra = {}, Ia = {}, Ua = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, za = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Va = {}, qa = {}, Ja = /\d/, Ga = /\d\d/, Ba = /\d{3}/, Ka = /\d{4}/, Za = /[+-]?\d{6}/, Qa = /\d\d?/, Xa = /\d\d\d\d?/, er = /\d\d\d\d\d\d?/, tr = /\d{1,3}/, nr = /\d{1,4}/, ar = /[+-]?\d{1,6}/, rr = /\d+/, ir = /[+-]?\d+/, sr = /Z|[+-]\d\d:?\d\d/gi, or = /Z|[+-]\d\d(?::?\d\d)?/gi, ur = /[+-]?\d+(\.\d{1,3})?/, lr = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, dr = {}, cr = {}, mr = 0, _r = 1, hr = 2, fr = 3, pr = 4, gr = 5, Mr = 6, yr = 7, vr = 8;
            U("Y", 0, 0, function() {
                var e = this.year();
                return e <= 9999 ? "" + e : "+" + e;
            }), U(0, [ "YY", 2 ], 0, function() {
            ...
            P("year", "y"), N("year", 1), G("Y", ir), G("YY", Qa, Ga), G("YYYY", nr, Ka), G("YYYYY", ar, Za), 
            G("YYYYYY", ar, Za), Q([ "YYYYY", "YYYYYY" ], mr), Q("YYYY", function(e, n) {
            ...
            }), P("month", "M"), N("month", 8), G("M", Qa), G("MM", Qa, Ga), G("MMM", function(e, t) {
            ...
            var $r = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/, kr = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), wr = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), Dr = lr, br = lr;
            U("w", [ "ww", 2 ], "wo", "week"), U("W", [ "WW", 2 ], "Wo", "isoWeek"), P("week", "w"), 
            P("isoWeek", "W"), N("week", 5), N("isoWeek", 5), G("w", Qa), G("ww", Qa, Ga), G("W", Qa), 
            G("WW", Qa, Ga), X([ "w", "ww", "W", "WW" ], function(e, t, n, a) {
                t[a.substr(0, 1)] = Y(e);
            });
            var Tr = {
                dow: 0,
            ...
            }), U("e", 0, 0, "weekday"), U("E", 0, 0, "isoWeekday"), P("day", "d"), P("weekday", "e"), 
            P("isoWeekday", "E"), N("day", 11), N("weekday", 11), N("isoWeekday", 11), G("d", Qa), 
            G("e", Qa), G("E", Qa), G("dd", function(e, t) {
            ...
            var Sr = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), xr = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), Hr = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), jr = lr, Or = lr, Er = lr;
            U("H", [ "HH", 2 ], 0, "hour"), U("h", [ "hh", 2 ], 0, qe), U("k", [ "kk", 2 ], 0, Je), 
            U("hmm", 0, 0, function() {
            ...
            }), Ge("a", !0), Ge("A", !1), P("hour", "h"), N("hour", 13), G("a", Be), G("A", Be), 
            G("H", Qa), G("h", Qa), G("k", Qa), G("HH", Qa, Ga), G("hh", Qa, Ga), G("kk", Qa, Ga), 
            G("hmm", Xa), G("hmmss", er), G("Hmm", Xa), G("Hmmss", er), Q([ "H", "HH" ], fr), 
            Q([ "k", "kk" ], function(e, t, n) {
                ...
                var a = e.length - 2;
                t[fr] = Y(e.substr(0, a)), t[pr] = Y(e.substr(a)), f(n).bigHour = !0;
            }), Q("hmmss", function(e, t, n) {
                var a = e.length - 4, r = e.length - 2;
                t[fr] = Y(e.substr(0, a)), t[pr] = Y(e.substr(a, 2)), t[gr] = Y(e.substr(r)), f(n).bigHour = !0;
            }), Q("Hmm", function(e, t, n) {
                var a = e.length - 2;
                t[fr] = Y(e.substr(0, a)), t[pr] = Y(e.substr(a));
            }), Q("Hmmss", function(e, t, n) {
                var a = e.length - 4, r = e.length - 2;
                t[fr] = Y(e.substr(0, a)), t[pr] = Y(e.substr(a, 2)), t[gr] = Y(e.substr(r));
            });
            var Cr, Ar = /[ap]\.?m?\.?/i, Pr = re("Hours", !0), Fr = {
                calendar: Ca,
                longDateFormat: Aa,
                invalidDate: Pa,
                ordinal: Fa,
            ...
            var Br = w("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
            ...
            Pt("Z", ":"), Pt("ZZ", ""), G("Z", or), G("ZZ", or), Q([ "Z", "ZZ" ], function(e, t, n) {
                n._useUTC = !0, n._tzm = Ft(or, e);
            });
            var Xr = /([\+\-]|\d\d)/gi;
            t.updateOffset = function() {};
            var ei = /^(\-|\+)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/, ti = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/;
            Qt.fn = Et.prototype, Qt.invalid = Ot;
            ...
            Fn("GGGGG", "isoWeekYear"), P("weekYear", "gg"), P("isoWeekYear", "GG"), N("weekYear", 1), 
            N("isoWeekYear", 1), G("G", ir), G("g", ir), G("GG", Qa, Ga), G("gg", Qa, Ga), G("GGGG", nr, Ka), 
            G("gggg", nr, Ka), G("GGGGG", ar, Za), G("ggggg", ar, Za), X([ "gggg", "ggggg", "GGGG", "GGGGG" ], function(e, t, n, a) {
                t[a.substr(0, 2)] = Y(e);
            }), X([ "gg", "GG" ], function(e, n, a, r) {
                n[r] = t.parseTwoDigitYear(e);
            }), U("Q", 0, "Qo", "quarter"), P("quarter", "Q"), N("quarter", 7), G("Q", Ja), 
            Q("Q", function(e, t) {
                t[_r] = 3 * (Y(e) - 1);
            }), U("D", [ "DD", 2 ], "Do", "date"), P("date", "D"), N("date", 9), G("D", Qa), 
            G("DD", Qa, Ga), G("Do", function(e, t) {
                return e ? t._dayOfMonthOrdinalParse || t._ordinalParse : t._dayOfMonthOrdinalParseLenient;
            }), Q([ "D", "DD" ], hr), Q("Do", function(e, t) {
                t[hr] = Y(e.match(Qa)[0]);
            });
            var ii = re("Date", !0);
            U("DDD", [ "DDDD", 3 ], "DDDo", "dayOfYear"), P("dayOfYear", "DDD"), N("dayOfYear", 4), 
            G("DDD", tr), G("DDDD", Ba), Q([ "DDD", "DDDD" ], function(e, t, n) {
                n._dayOfYear = Y(e);
            }), U("m", [ "mm", 2 ], 0, "minute"), P("minute", "m"), N("minute", 14), G("m", Qa), 
            G("mm", Qa, Ga), Q([ "m", "mm" ], pr);
            var si = re("Minutes", !1);
            U("s", [ "ss", 2 ], 0, "second"), P("second", "s"), N("second", 15), G("s", Qa), 
            G("ss", Qa, Ga), Q([ "s", "ss" ], gr);
            var oi = re("Seconds", !1);
            U("S", 0, 0, function() {
            ...
            }), P("millisecond", "ms"), N("millisecond", 16), G("S", tr, Ja), G("SS", tr, Ga), 
            G("SSS", tr, Ba);
            var ui;
            for (ui = "SSSS"; ui.length <= 9; ui += "S") G(ui, rr);
            for (ui = "S"; ui.length <= 9; ui += "S") Q(ui, Jn);
            var li = re("Milliseconds", !1);
            U("z", 0, 0, "zoneAbbr"), U("zz", 0, 0, "zoneName");
            var di = y.prototype;
            di.add = ni, di.calendar = sn, di.clone = on, di.diff = hn, di.endOf = bn, di.format = yn, 
            di.from = vn, di.fromNow = Ln, di.to = Yn, di.toNow = $n, di.get = oe, di.invalidAt = An, 
            di.isAfter = un, di.isBefore = ln, di.isBetween = dn, di.isSame = cn, di.isSameOrAfter = mn, 
            di.isSameOrBefore = _n, di.isValid = En, di.lang = ri, di.locale = kn, di.localeData = wn, 
            di.max = Kr, di.min = Br, di.parsingFlags = Cn, di.set = ue, di.startOf = Dn, di.subtract = ai, 
            di.toArray = Hn, di.toObject = jn, di.toDate = xn, di.toISOString = gn, di.inspect = Mn, 
            di.toJSON = On, di.toString = pn, di.unix = Sn, di.valueOf = Tn, di.creationData = Pn, 
            di.year = Yr, di.isLeapYear = ae, di.weekYear = Wn, di.isoWeekYear = Nn, di.quarter = di.quarters = Vn, 
            di.month = pe, di.daysInMonth = ge, di.week = di.weeks = xe, di.isoWeek = di.isoWeeks = He, 
            di.weeksInYear = In, di.isoWeeksInYear = Rn, di.date = ii, di.day = di.days = We, 
            di.weekday = Ne, di.isoWeekday = Re, di.dayOfYear = qn, di.hour = di.hours = Pr, 
            di.minute = di.minutes = si, di.second = di.seconds = oi, di.millisecond = di.milliseconds = li, 
            di.utcOffset = Rt, di.utc = Ut, di.local = zt, di.parseZone = Vt, di.hasAlignedHourOffset = qt, 
            di.isDST = Jt, di.isLocal = Bt, di.isUtcOffset = Kt, di.isUtc = Zt, di.isUTC = Zt, 
            di.zoneAbbr = Gn, di.zoneName = Bn, di.dates = w("dates accessor is deprecated. Use date instead.", ii), 
            di.months = w("months accessor is deprecated. Use month instead", pe), di.years = w("years accessor is deprecated. Use year instead", Yr), 
            di.zone = w("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", It), 
            di.isDSTShifted = w("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", Gt);
            var ci = x.prototype;
            ci.calendar = H, ci.longDateFormat = j, ci.invalidDate = O, ci.ordinal = E, ci.preparse = Qn, 
            ci.postformat = Qn, ci.relativeTime = C, ci.pastFuture = A, ci.set = T, ci.months = ce, 
            ci.monthsShort = me, ci.monthsParse = he, ci.monthsRegex = ye, ci.monthsShortRegex = Me, 
            ci.week = be, ci.firstDayOfYear = Se, ci.firstDayOfWeek = Te, ci.weekdays = Ee, 
            ci.weekdaysMin = Ae, ci.weekdaysShort = Ce, ci.weekdaysParse = Fe, ci.weekdaysRegex = Ie, 
            ci.weekdaysShortRegex = Ue, ci.weekdaysMinRegex = ze, ci.isPM = Ke, ci.meridiem = Ze, 
            tt("en", {
            ...
            var mi = Math.abs, _i = ga("ms"), hi = ga("s"), fi = ga("m"), pi = ga("h"), gi = ga("d"), Mi = ga("w"), yi = ga("M"), vi = ga("y"), Li = va("milliseconds"), Yi = va("seconds"), $i = va("minutes"), ki = va("hours"), wi = va("days"), Di = va("months"), bi = va("years"), Ti = Math.round, Si = {
                ss: 44,
                s: 45,
                m: 45,
                h: 22,
                d: 26,
                M: 11
            }, xi = Math.abs, Hi = Et.prototype;
            return Hi.isValid = jt, Hi.abs = oa, Hi.add = la, Hi.subtract = da, Hi.as = fa, 
            Hi.asMilliseconds = _i, Hi.asSeconds = hi, Hi.asMinutes = fi, Hi.asHours = pi, Hi.asDays = gi, 
            Hi.asWeeks = Mi, Hi.asMonths = yi, Hi.asYears = vi, Hi.valueOf = pa, Hi._bubble = ma, 
            Hi.clone = Ma, Hi.get = ya, Hi.milliseconds = Li, Hi.seconds = Yi, Hi.minutes = $i, 
            Hi.hours = ki, Hi.days = wi, Hi.weeks = La, Hi.months = Di, Hi.years = bi, Hi.humanize = Da, 
            Hi.toISOString = Ta, Hi.toString = Ta, Hi.toJSON = Ta, Hi.locale = kn, Hi.localeData = wn, 
            Hi.toIsoString = w("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Ta), 
            Hi.lang = ri, U("X", 0, 0, "unix"), U("x", 0, 0, "valueOf"), G("x", ir), G("X", ur), 
            Q("X", function(e, t, n) {
                n._d = new Date(1e3 * parseFloat(e, 10));
            }), Q("x", function(e, t, n) {
                n._d = new Date(Y(e));
            }), t.version = "2.22.0", a(bt), t.fn = di, t.min = St, t.max = xt, t.now = Zr, 
            t.utc = _, t.unix = Kn, t.months = na, t.isDate = l, t.locale = tt, t.invalid = g, 
            t.duration = Qt, t.isMoment = v, t.weekdays = ra, t.parseZone = Zn, t.localeData = rt, 
            t.isDuration = Ct, t.monthsShort = aa, t.weekdaysMin = sa, t.defineLocale = nt, 
            t.updateLocale = at, t.locales = it, t.weekdaysShort = ia, t.normalizeUnits = F, 
            t.relativeTimeRounding = ka, t.relativeTimeThreshold = wa, t.calendarFormat = rn, 
            t.prototype = di, t.HTML5_FMT = {
    ...
    }, a.resolve = r, e.exports = a, a.id = 5;
}, function(e, t, n) {
    !function(e, t) {
        t(n(3));
    }(this, function(e) {
    ...
    !function(e, t, n) {
        ...
        function r(e) {
            ...
            return !(e.nodeType !== va || !t) || (v(e) || _a(e) || 0 === t || "number" == typeof t && t > 0 && t - 1 in e);
        }
        function i(e, t, n) {
            var a, s;
            if (e) if ($(e)) for (a in e) "prototype" == a || "length" == a || "name" == a || e.hasOwnProperty && !e.hasOwnProperty(a) || t.call(n, e[a], a, e); else if (_a(e) || r(e)) {
        ...
        function Y(e) {
            return "[object Date]" === ua.call(e);
        }
        function $(e) {
            return "function" == typeof e;
        }
        function k(e) {
            return "[object RegExp]" === ua.call(e);
        }
        function w(e) {
            return e && e.window === e;
        }
        ...
        function b(e) {
            return "[object File]" === ua.call(e);
        }
        function T(e) {
            return "[object FormData]" === ua.call(e);
        }
        function S(e) {
            return "[object Blob]" === ua.call(e);
        }
        function x(e) {
        ...
        function A(e, t, n, a) {
            if (w(e) || D(e)) throw la("cpws", "Can't copy! Making copies of Window or Scope instances is not supported.");
            if (t) {
                if (e === t) throw la("cpi", "Can't copy! Source and destination are identical.");
                if (n = n || [], a = a || [], y(e)) {
                    var r = n.indexOf(e);
                    if (r !== -1) return a[r];
                    n.push(e), a.push(t);
                ...
                if (_a(e)) {
                    ...
                    var u = t.$$hashKey;
                    _a(t) ? t.length = 0 : i(t, function(e, n) {
                        delete t[n];
                    });
                    for (var l in e) e.hasOwnProperty(l) && (s = A(e[l], null, n, a), y(e[l]) && (n.push(e[l]), 
                    a.push(s)), t[l] = s);
                    d(t, u);
                }
            } else if (t = e, e) if (_a(e)) t = A(e, [], n, a); else if (Y(e)) t = new Date(e.getTime()); else if (k(e)) t = new RegExp(e.source, e.toString().match(/[^\/]*$/)[0]), 
        ...
        function F(e, t) {
            ...
            if (s == o && "object" == s) {
                if (!_a(e)) {
                    if (Y(e)) return !!Y(t) && F(e.getTime(), t.getTime());
                    if (k(e)) return !!k(t) && e.toString() == t.toString();
                    if (D(e) || D(t) || w(e) || w(t) || _a(t) || Y(t) || k(t)) return !1;
                    i = {};
                    for (r in e) if ("$" !== r.charAt(0) && !$(e[r])) {
                        if (!F(e[r], t[r])) return !1;
                        i[r] = !0;
                    }
                    for (r in t) if (!i.hasOwnProperty(r) && "$" !== r.charAt(0) && t[r] !== n && !$(t[r])) return !1;
                    return !0;
                }
                if (!_a(t)) return !1;
        ...
        function U(e, t) {
            return "undefined" == typeof e ? n : (L(t) || (t = t ? 2 : null), JSON.stringify(e, I, t));
        }
        function z(e) {
        ...
        function V(e) {
            ...
            try {
                return e[0].nodeType === Ya ? Kn(t) : t.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function(e, t) {
                    return "<" + Kn(t);
                });
            } catch (e) {
                return Kn(t);
        ...
        function J(e) {
            ...
            return i((e || "").split("&"), function(e) {
                if (e && (t = e.replace(/\+/g, "%20").split("="), n = q(t[0]), M(n))) {
                    var r = !M(t[1]) || q(t[1]);
                    Zn.call(a, n) ? _a(a[n]) ? a[n].push(r) : a[n] = [ a[n], r ] : a[n] = r;
                }
            }), a;
        }
        function G(e) {
        ...
        function Z(e, t) {
            var n, a, r = ga.length;
            for (e = na(e), a = 0; a < r; ++a) if (n = ga[a] + t, v(n = e.attr(n))) return n;
            return null;
        }
        function Q(e, t) {
            var n, a, r = {};
        ...
        function X(n, a, r) {
            ...
            var o = function() {
                if (n = na(n), n.injector()) {
                    ...
                    throw la("btstrpd", "App Already Bootstrapped with this Element '{0}'", e.replace(/</, "&lt;").replace(/>/, "&gt;"));
                }
            ...
            e && !l.test(e.name) ? o() : (e.name = e.name.replace(l, ""), da.resumeBootstrap = function(e) {
                return i(e, function(e) {
                    a.push(e);
                }), o();
            }, void ($(da.resumeDeferredBootstrap) && da.resumeDeferredBootstrap()));
        }
        function ee() {
            e.name = "NG_ENABLE_DEBUG_INFO!" + e.name, e.location.reload();
        }
        function te(e) {
            var t = da.element(e).injector();
            if (!t) throw la("test", "no injector found for element argument to getTestability");
            return t.get("$$testability");
        }
        function ne(e, t) {
            return t = t || "_", e.replace(Ma, function(e, n) {
                return (n ? t : "") + e.toLowerCase();
            });
        }
        function ae() {
            var t;
            ya || (aa = e.jQuery, aa && aa.fn.on ? (na = aa, c(aa.fn, {
                scope: Na.scope,
                ...
                t(e);
            }) : na = ve, da.element = na, ya = !0);
        }
        function re(e, t, n) {
            if (!e) throw la("areq", "Argument '{0}' is {1}", t || "?", n || "required");
            return e;
        }
        function ie(e, t, n) {
            return n && _a(e) && (e = e[e.length - 1]), re($(e), t, "not a function, got " + (e && "object" == typeof e ? e.constructor.name || "Object" : typeof e)), 
            e;
        }
        function se(e, t) {
            if ("hasOwnProperty" === e) throw la("badname", "hasOwnProperty is not a valid {0} name", t);
        }
        function oe(e, t, n) {
            if (!t) return e;
        ...
        function me(e) {
            return "function" == typeof e ? e.toString().replace(/ \{[\s\S]*$/, "") : "undefined" == typeof e ? "undefined" : "string" != typeof e ? ce(e) : e;
        }
        function _e(t) {
            c(t, {
                bootstrap: X,
            ...
            try {
                ...
                ra("ngLocale", []).provider("$locale", pt);
            }
            ra("ng", [ "ngLocale" ], [ "$provide", function(e) {
                e.provider({
                    ...
                    ngInclude: ci
                }).directive(Or).directive(oi), e.provider({
                    $anchorScroll: Ve,
                    $animate: Ka,
                    $browser: Ge,
                    $cacheFactory: Be,
        ...
        function fe(e) {
            return e.replace(Ha, function(e, t, n, a) {
        ...
        function Me(e, t) {
            ...
            if (pe(e)) u.push(t.createTextNode(e)); else {
                for (n = n || o.appendChild(t.createElement("div")), a = (Pa.exec(e) || [ "", "" ])[1].toLowerCase(), 
                r = Wa[a] || Wa._default, n.innerHTML = r[1] + e.replace(Fa, "<$1></$2>") + r[2], 
                s = r[0]; s--; ) n = n.lastChild;
                u = W(u, n.childNodes), n = o.firstChild, n.textContent = "";
            }
        ...
        function ye(e, n) {
            n = n || t;
            var a;
            return (a = Ca.exec(e)) ? [ n.createElement(a[1]) ] : (a = Me(e, n)) ? a.childNodes : [];
        }
        function ve(e) {
            if (e instanceof ve) return e;
            var t;
            if (v(e) && (e = ha(e), t = !0), !(this instanceof ve)) {
                if (t && "<" != e.charAt(0)) throw Ea("nosel", "Looking up elements via selectors is not supported by jqLite! See: http://docs.angularjs.org/api/angular.element");
                return new ve(e);
            }
        ...
        function $e(e, t, n, a) {
            if (M(a)) throw Ea("offargs", "jqLite#off() does not support the `selector` argument");
            var r = we(e), s = r && r.events, o = r && r.handle;
            if (o) if (t) i(t.split(" "), function(t) {
                if (M(n)) {
                    var a = s[t];
                    if (C(a || [], n), a && a.length > 0) return;
                }
                xa(e, t, o), delete s[t];
            }); else for (t in s) "$destroy" !== t && xa(e, t, o), delete s[t];
        }
        function ke(e, t) {
            var a = e.ng339, r = a && ba[a];
            if (r) {
                if (t) return void delete r.data[t];
                r.handle && (r.events.$destroy && r.handle({}, "$destroy"), $e(e)), delete ba[a], 
                e.ng339 = n;
            }
        }
        function we(e, t) {
            var a = e.ng339, r = a && ba[a];
            return t && !r && (e.ng339 = a = he(), r = ba[a] = {
                events: {},
                data: {},
                handle: n
            }), r;
        ...
        function De(e, t, n) {
            if (ge(e)) {
                var a = M(n), r = !a && t && !y(t), i = !t, s = we(e, !r), o = s && s.data;
                if (a) o[t] = n; else {
                    if (i) return o;
                    if (r) return o && o[t];
                    c(o, t);
        ...
        function Te(e, t) {
            t && e.setAttribute && i(t.split(" "), function(t) {
                e.setAttribute("class", ha((" " + (e.getAttribute("class") || "") + " ").replace(/[\n\t]/g, " ").replace(" " + ha(t) + " ", " ")));
            });
        }
        function Se(e, t) {
            if (t && e.setAttribute) {
                ...
                i(t.split(" "), function(e) {
                    e = ha(e), n.indexOf(" " + e + " ") === -1 && (n += e + " ");
                }), e.setAttribute("class", ha(n));
            }
        }
        function xe(e, t) {
        ...
        function Ie(e) {
            var t = e.toString().replace(Ja, ""), n = t.match(za);
        ...
        function Ue(e, t, n) {
            ...
            if ("function" == typeof e) {
                if (!(a = e.$inject)) {
                    if (a = [], e.length) {
                        if (t) throw v(n) && n || (n = e.name || Ie(e)), Ga("strictdi", "{0} is not using explicit annotation and cannot be invoked in strict mode", n);
                        r = e.toString().replace(Ja, ""), s = r.match(za), i(s[1].split(Va), function(e) {
            ...
            } else _a(e) ? (o = e.length - 1, ie(e[o], "fn"), a = e.slice(0, o)) : ie(e, "fn", !0);
            return a;
        }
        function ze(e, t) {
            function a(e) {
            ...
            function r(e, t) {
                if (se(e, "service"), ($(t) || _a(t)) && (t = D.instantiate(t)), !t.$get) throw Ga("pget", "Provider '{0}' must define $get factory method.", e);
                return w[e + L] = t;
            }
            function s(e, t) {
                return function() {
                    var n = T.invoke(t, this);
                    if (g(n)) throw Ga("undef", "Provider '{0}' must return a value from $get factory method.", e);
                    return n;
                };
            }
            function o(e, t, n) {
            ...
            function c(e, t) {
                se(e, "constant"), w[e] = t, b[e] = t;
            }
            function m(e, t) {
                var n = D.get(e + L), a = n.$get;
                n.$get = function() {
                    var e = T.invoke(a, n);
            ...
            function _(e) {
                ...
                return i(e, function(e) {
                    ...
                    if (!k.get(e)) {
                        k.put(e, !0);
                        try {
                            v(e) ? (t = ra(e), n = n.concat(_(t.requires)).concat(t._runBlocks), a(t._invokeQueue), 
                            a(t._configBlocks)) : $(e) ? n.push(D.invoke(e)) : _a(e) ? n.push(D.invoke(e)) : ie(e, "module");
                        } catch (t) {
                            throw _a(e) && (e = e[e.length - 1]), t.message && t.stack && t.stack.indexOf(t.message) == -1 && (t = t.message + "\n" + t.stack), 
            ...
            function f(e, n) {
                function a(t, a) {
                    if (e.hasOwnProperty(t)) {
                        if (e[t] === M) throw Ga("cdep", "Circular dependency found: {0}", t + " <- " + Y.join(" <- "));
                        return e[t];
                    }
                    try {
                        return Y.unshift(t), e[t] = M, e[t] = n(t, a);
                    } catch (n) {
                ...
                function r(e, n, r, i) {
                    ...
                    var s, o, u, l = [], d = ze.$$annotate(e, t, i);
                    for (o = 0, s = d.length; o < s; o++) {
                        if (u = d[o], "string" != typeof u) throw Ga("itkn", "Incorrect injection token! Expected service name as string, got {0}", u);
                        l.push(r && r.hasOwnProperty(u) ? r[u] : a(u, i));
                    }
                    return _a(e) && (e = e[s]), e.apply(n, l);
                }
                function i(e, t, n) {
                    var a = Object.create((_a(e) ? e[e.length - 1] : e).prototype || null), i = r(e, a, t, n);
                    return y(i) || $(i) ? i : a;
                }
                return {
                    invoke: r,
                    ...
                    has: function(t) {
                        return w.hasOwnProperty(t + L) || e.hasOwnProperty(t);
                    }
                };
            }
            t = t === !0;
            var M = {}, L = "Provider", Y = [], k = new Re([], !0), w = {
                $provide: {
                    provider: a(r),
                    factory: a(o),
                    service: a(l),
            ...
            }, D = w.$injector = f(w, function(e, t) {
                throw da.isString(t) && Y.push(t), Ga("unpr", "Unknown provider: {0}", Y.join(" <- "));
            }), b = {}, T = b.$injector = f(b, function(e, t) {
                var a = D.get(e + L, t);
        ...
        function Je(e, t, a, r) {
            ...
            function c() {
                T = d(), T = g(T) ? null : T, F(T, C) && (T = C), C = T;
            }
            function m() {
                x === f.url() && S === T || (x = f.url(), S = T, i(O, function(e) {
                    e(f.url(), T);
                }));
            }
            function _(e) {
            ...
            var f = this, p = t[0], M = e.location, y = e.history, L = e.setTimeout, Y = e.clearTimeout, $ = {};
            f.isMock = !1;
            var k = 0, w = [];
            ...
            f.addPollFn = function(e) {
                return g(D) && u(100, L), b.push(e), e;
            };
            var T, S, x = M.href, H = t.find("base"), j = null;
            c(), S = T, f.url = function(t, n, a) {
                if (g(a) && (a = null), M !== e.location && (M = e.location), y !== e.history && (y = e.history), 
                t) {
                    var i = S === a;
                    if (x === t && (!r.history || i)) return f;
                    var s = x && Lt(x) === Lt(t);
                    return x = t, S = a, !r.history || s && i ? (s && !j || (j = t), n ? M.replace(t) : s ? M.hash = o(t) : M.href = t) : (y[n ? "replaceState" : "pushState"](a, "", t), 
                    c(), S = T), f;
                }
                return j || M.href.replace(/%27/g, "'");
            }, f.state = function() {
                return T;
            };
            var O = [], E = !1, C = null;
            f.onUrlChange = function(t) {
                return E || (r.history && na(e).on("popstate", l), na(e).on("hashchange", l), E = !0), 
                O.push(t), t;
            }, f.$$checkUrlChange = m, f.baseHref = function() {
                var e = H.attr("href");
                return e ? e.replace(/^(https?\:)?\/\/[^\/]*/, "") : "";
            };
            var A = {}, P = "", W = f.baseHref();
            f.cookies = function(e, t) {
                var r, i, s, o, u;
                if (!e) {
                    if (p.cookie !== P) for (P = p.cookie, i = P.split("; "), A = {}, o = 0; o < i.length; o++) s = i[o], 
                    u = s.indexOf("="), u > 0 && (e = _(s.substring(0, u)), A[e] === n && (A[e] = _(s.substring(u + 1))));
                    return A;
                }
                t === n ? p.cookie = encodeURIComponent(e) + "=;path=" + W + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : v(t) && (r = (p.cookie = encodeURIComponent(e) + "=" + encodeURIComponent(t) + ";path=" + W).length + 1, 
                r > 4096 && a.warn("Cookie '" + e + "' possibly not set or overflowed because it was too large (" + r + " > 4096 bytes)!"));
            }, f.defer = function(e, t) {
                var n;
                return k++, n = L(function() {
                    delete $[n], s(e);
                }, t || 0), $[n] = !0, n;
            }, f.defer.cancel = function(e) {
                return !!$[e] && (delete $[e], Y(e), s(h), !0);
            };
        }
        function Ge() {
            this.$get = [ "$window", "$log", "$sniffer", "$document", function(e, t, n, a) {
                return new Je(e, a, t, n);
            } ];
        }
        function Be() {
            this.$get = function() {
                function e(e, n) {
                    function r(e) {
                        e != m && (_ ? _ == e && (_ = e.n) : _ = e, i(e.n, e.p), i(e, m), m = e, m.n = null);
                    }
                    function i(e, t) {
                        e != t && (e && (e.p = t), t && (t.n = e));
                    }
                    ...
                    var s = 0, o = c({}, n, {
                        id: e
                    }), u = {}, l = n && n.capacity || Number.MAX_VALUE, d = {}, m = null, _ = null;
                    return t[e] = {
                        put: function(e, t) {
                            ...
                            if (!g(t)) return e in u || s++, u[e] = t, s > l && this.remove(_.key), t;
                        },
                        get: function(e) {
                            if (l < Number.MAX_VALUE) {
                                var t = d[e];
                        ...
                        remove: function(e) {
                            if (l < Number.MAX_VALUE) {
                                var t = d[e];
                                if (!t) return;
                                t == m && (m = t.p), t == _ && (_ = t.n), i(t.n, t.p), delete d[e];
                            }
                            delete u[e], s--;
                        },
                        removeAll: function() {
                        ...
                        destroy: function() {
                            u = null, o = null, d = null, delete t[e];
                        },
                        info: function() {
                            return c({}, o, {
                                size: s
        ...
        function Ze(e, a) {
            ...
            var s = {}, o = "Directive", l = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/, d = /(([\w\-]+)(?:\:([^;]+))?;?)/, m = O("ngSrc,ngSrcset,src,srcset"), g = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, L = /^(on[a-z]+|formaction)$/;
            this.directive = function t(n, a) {
                return se(n, "directive"), v(n) ? (re(a, "directiveFactory"), s.hasOwnProperty(n) || (s[n] = [], 
                e.factory(n + o, [ "$injector", "$exceptionHandler", function(e, t) {
                    ...
                    return i(s[n], function(i, s) {
                        try {
                            ...
                            $(o) ? o = {
                                compile: p(o)
                            } : !o.compile && o.link && (o.compile = p(o.link)), o.priority = o.priority || 0, 
                ...
                return M(e) ? (a.aHrefSanitizationWhitelist(e), this) : a.aHrefSanitizationWhitelist();
            }, this.imgSrcSanitizationWhitelist = function(e) {
                return M(e) ? (a.imgSrcSanitizationWhitelist(e), this) : a.imgSrcSanitizationWhitelist();
            };
            var Y = !0;
            this.debugInfoEnabled = function(e) {
                return M(e) ? (Y = e, this) : Y;
            }, this.$get = [ "$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(e, a, r, u, p, M, k, w, b, T, S) {
                function x(e, t) {
                    try {
                        e.addClass(t);
                    } catch (e) {}
                ...
                function H(e, t, n, a, r) {
                    e instanceof na || (e = na(e)), i(e, function(t, n) {
                        t.nodeType == Ya && t.nodeValue.match(/\S+/) && (e[n] = na(t).wrap("<span></span>").parent()[0]);
                    });
                    var s = O(e, t, e, n, a, r);
                    H.$$addScopeClass(e);
                    var o = null;
                    return function(t, n, a) {
                        ...
                        r && r.$$boundTransclude && (r = r.$$boundTransclude), o || (o = j(u));
                        var l;
                        if (l = "html" !== o ? na(Q(o, na("<div>").append(e).html())) : n ? Na.clone.call(e) : e, 
                        i) for (var d in i) l.data("$" + d + "Controller", i[d].instance);
                        return H.$$addScopeInfo(l, t), n && n(l, t), s && s(t, l, l, r), l;
                    };
                }
                function j(e) {
                    var t = e && e[0];
                ...
                function O(e, t, a, r, i, s) {
                    function o(e, a, r, i) {
                        var s, o, u, l, d, c, m, _, p;
                        if (h) {
                            var g = a.length;
                            for (p = new Array(g), d = 0; d < f.length; d += 3) m = f[d], p[m] = a[m];
                        } else p = a;
                        for (d = 0, c = f.length; d < c; ) u = p[f[d++]], s = f[d++], o = f[d++], s ? (s.scope ? (l = e.$new(), 
                        H.$$addScopeInfo(na(u), l)) : l = e, _ = s.transcludeOnThisElement ? A(e, s.transclude, i, s.elementTranscludeOnThisElement) : !s.templateOnThisElement && i ? i : !i && t ? A(e, t) : null, 
                        s(o, l, u, r, _)) : o && o(e, u.childNodes, n, i);
                    }
                    for (var u, l, d, c, m, _, h, f = [], p = 0; p < e.length; p++) u = new se(), l = P(e[p], [], u, 0 === p ? r : n, i), 
                    d = l.length ? I(l, e[p], u, t, a, null, [], [], s) : null, d && d.scope && H.$$addScopeClass(u.$$element), 
                    m = d && d.terminal || !(c = e[p].childNodes) || !c.length ? null : O(c, d ? (d.transcludeOnThisElement || !d.templateOnThisElement) && d.transclude : t), 
                    (d || m) && (f.push(p, d, m), _ = !0, h = h || d), s = null;
                    return _ ? o : null;
                }
                function A(e, t, n, a) {
                ...
                function P(e, t, n, a, r) {
                    ...
                    switch (o) {
                      case va:
                        z(t, Qe(E(e)), "E", a, r);
                        for (var c, m, _, h, f, p, g = e.attributes, M = 0, L = g && g.length; M < L; M++) {
                            var Y = !1, $ = !1;
                            c = g[M], m = c.name, f = ha(c.value), h = Qe(m), (p = ce.test(h)) && (m = m.replace(Qa, "").substr(8).replace(/_(.)/g, function(e, t) {
                                return t.toUpperCase();
                            }));
                            var k = h.replace(/(Start|End)$/, "");
                            q(k) && h === k + "Start" && (Y = m, $ = m.substr(0, m.length - 5) + "end", m = m.substr(0, m.length - 6)), 
                            _ = Qe(m.toLowerCase()), u[_] = m, !p && n.hasOwnProperty(_) || (n[_] = f, Ae(e, _) && (n[_] = !0)), 
                            ee(e, t, f, _, p), z(t, _, "A", a, r, Y, $);
                        }
                        if (s = e.className, y(s) && (s = s.animVal), v(s) && "" !== s) for (;i = d.exec(s); ) _ = Qe(i[2]), 
                        z(t, _, "C", a, r) && (n[_] = ha(i[3])), s = s.substr(i.index + i[0].length);
                        break;
                      ...
                      case $a:
                        try {
                            i = l.exec(e.nodeValue), i && (_ = Qe(i[1]), z(t, _, "M", a, r) && (n[_] = ha(i[2])));
                        } catch (e) {}
                    }
                    return t.sort(B), t;
                }
                ...
                function R(e, t, n) {
                    return function(a, r, i, s, o) {
                        return r = W(r[0], t, n), e(a, r, i, s, o);
                    };
                }
                function I(e, s, o, u, l, d, c, m, _) {
                    function h(e, t, n, a) {
                        e && (n && (e = R(e, n, a)), e.require = w.require, e.directiveName = b, (E === w || w.$$isolateScope) && (e = ae(e, {
                            isolateScope: !0
                        })), c.push(e)), t && (n && (t = R(t, n, a)), t.require = w.require, t.directiveName = b, 
                        (E === w || w.$$isolateScope) && (t = ae(t, {
                            isolateScope: !0
                        })), m.push(t));
                    }
                    function f(e, t, n, a) {
                        ...
                        if (v(t)) {
                            ...
                            r = r || l[o]("$" + t + "Controller"), !r && !u) throw Za("ctreq", "Controller '{0}', required by directive '{1}', can't be found!", t, e);
                            return r || null;
                        }
                        return _a(t) && (r = [], i(t, function(t) {
                            r.push(f(e, t, n, a));
                        })), r;
                    }
                    function L(e, t, r, u, l) {
                        function d(e, t, a) {
                            var r;
                            return D(e) || (a = t, t = e, e = n), q && (r = L), a || (a = q ? $.parent() : $), 
                            l(e, t, r, a, S);
                        }
                        var _, h, g, y, v, L, Y, $, w;
                        if (s === r ? (w = o, $ = o.$$element) : ($ = na(r), w = new se($, o)), E && (v = t.$new(!0)), 
                        l && (Y = d, Y.$$boundTransclude = l), O && (k = {}, L = {}, i(O, function(e) {
                            var n, a = {
                                $scope: e === E || e.$$isolateScope ? v : t,
                                $element: $,
                                $attrs: w,
                                $transclude: Y
                            };
                            y = e.controller, "@" == y && (y = w[e.name]), n = M(y, a, !0, e.controllerAs), 
                            L[e.name] = n, q || $.data("$" + e.name + "Controller", n.instance), k[e.name] = n;
                        })), E) {
                            H.$$addScopeInfo($, v, !0, !(C && (C === E || C === E.$$originalDirective))), H.$$addScopeClass($, !0);
                            var b = k && k[E.name], T = v;
                            b && b.identifier && E.bindToController === !0 && (T = b.instance), i(v.$$isolateBindings = E.$$isolateBindings, function(e, n) {
                                var r, i, s, o, u = e.attrName, l = e.optional, d = e.mode;
                                switch (d) {
                                  case "@":
                                  ...
                                  case "=":
                                    if (l && !w[u]) return;
                                    i = p(w[u]), o = i.literal ? F : function(e, t) {
                                        return e === t || e !== e && t !== t;
                                    }, s = i.assign || function() {
                                        throw r = T[n] = i(t), Za("nonassign", "Expression '{0}' used with directive '{1}' is non-assignable!", w[u], E.name);
                                    }, r = T[n] = i(t);
                                    var c = function(e) {
                                    ...
                                    c.$stateful = !0;
                                    var m;
                                    m = e.collection ? t.$watchCollection(w[u], c) : t.$watch(p(w[u], c), null, i.literal), 
                                    v.$on("$destroy", m);
                                    break;

                                  case "&":
                                    i = p(w[u]), T[n] = function(e) {
                                        return i(t, e);
                                    };
                                }
                            });
                        ...
                        for (k && (i(k, function(e) {
                            e();
                        }), k = null), _ = 0, h = c.length; _ < h; _++) g = c[_], ie(g, g.isolateScope ? v : t, $, w, g.require && f(g.directiveName, g.require, $, L), Y);
                        var S = t;
                        for (E && (E.template || null === E.templateUrl) && (S = v), e && e(S, r.childNodes, n, l), 
                        _ = m.length - 1; _ >= 0; _--) g = m[_], ie(g, g.isolateScope ? v : t, $, w, g.require && f(g.directiveName, g.require, $, L), Y);
                    }
                    _ = _ || {};
                    for (var Y, k, w, b, T, S, x, j = -Number.MAX_VALUE, O = _.controllerDirectives, E = _.newIsolateScopeDirective, C = _.templateDirective, A = _.nonTlbTranscludeDirective, I = !1, z = !1, q = _.hasElementTranscludeDirective, B = o.$$element = na(s), Z = d, X = u, ee = 0, ne = e.length; ee < ne; ee++) {
                        w = e[ee];
                        var re = w.$$start, oe = w.$$end;
                        if (re && (B = W(s, re, oe)), T = n, j > w.priority) break;
                        if ((x = w.scope) && (w.templateUrl || (y(x) ? (K("new/isolated scope", E || Y, w, B), 
                        E = w) : K("new/isolated scope", E, w, B)), Y = Y || w), b = w.name, !w.templateUrl && w.controller && (x = w.controller, 
                        O = O || {}, K("'" + b + "' controller", O[b], w, B), O[b] = w), (x = w.transclude) && (I = !0, 
                        w.$$tlb || (K("transclusion", A, w, B), A = w), "element" == x ? (q = !0, j = w.priority, 
                        T = B, B = o.$$element = na(t.createComment(" " + b + ": " + o[b] + " ")), s = B[0], 
                        te(l, N(T), s), X = H(T, u, j, Z && Z.name, {
                            nonTlbTranscludeDirective: A
                        })) : (T = na(Le(s)).contents(), B.empty(), X = H(T, u))), w.template) if (z = !0, 
                        K("template", C, w, B), C = w, x = $(w.template) ? w.template(B, o) : w.template, 
                        x = de(x), w.replace) {
                            if (Z = w, T = pe(x) ? [] : et(Q(w.templateNamespace, ha(x))), s = T[0], 1 != T.length || s.nodeType !== va) throw Za("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", b, "");
                            te(l, B, s);
                            var ue = {
                                $attr: {}
                            }, le = P(s, [], ue), ce = e.splice(ee + 1, e.length - (ee + 1));
                            E && U(le), e = e.concat(le).concat(ce), J(o, ue), ne = e.length;
                        } else B.html(x);
                        if (w.templateUrl) z = !0, K("template", C, w, B), C = w, w.replace && (Z = w), 
                        L = G(e.splice(ee, e.length - ee), B, o, l, I && X, c, m, {
                            controllerDirectives: O,
                            newIsolateScopeDirective: E,
                            templateDirective: C,
                            nonTlbTranscludeDirective: A
                        }), ne = e.length; else if (w.compile) try {
                            S = w.compile(B, o, X), $(S) ? h(null, S, re, oe) : S && h(S.pre, S.post, re, oe);
                        } catch (e) {
                            r(e, V(B));
                        }
                        w.terminal && (L.terminal = !0, j = Math.max(j, w.priority));
                    }
                    return L.scope = Y && Y.scope === !0, L.transcludeOnThisElement = I, L.elementTranscludeOnThisElement = q, 
                    L.templateOnThisElement = z, L.transclude = X, _.hasElementTranscludeDirective = q, 
                    L;
                }
                function U(e) {
                ...
                function z(t, a, i, u, l, d, c) {
                    if (a === l) return null;
                    var m = null;
                    if (s.hasOwnProperty(a)) for (var h, f = e.get(a + o), p = 0, g = f.length; p < g; p++) try {
                        h = f[p], (u === n || u > h.priority) && h.restrict.indexOf(i) != -1 && (d && (h = _(h, {
                            $$start: d,
                            $$end: c
                        })), t.push(h), m = h);
                    } catch (e) {
                ...
                function G(e, t, n, a, r, s, o, l) {
                    var d, c, m = [], h = t[0], f = e.shift(), p = _(f, {
                        templateUrl: null,
                        transclude: null,
                        replace: null,
                        $$originalDirective: f
                    }), g = $(f.templateUrl) ? f.templateUrl(t, n) : f.templateUrl, M = f.templateNamespace;
                    return t.empty(), u(g).then(function(u) {
                        var _, v, L, Y;
                        if (u = de(u), f.replace) {
                            if (L = pe(u) ? [] : et(Q(M, ha(u))), _ = L[0], 1 != L.length || _.nodeType !== va) throw Za("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", f.name, g);
                            v = {
                                $attr: {}
                            }, te(a, t, _);
                            var $ = P(_, [], v);
                            y(f.scope) && U($), e = $.concat(e), J(n, v);
                        } else _ = h, t.html(u);
                        for (e.unshift(p), d = I(e, _, n, r, t, f, s, o, l), i(a, function(e, n) {
                            e == _ && (a[n] = t[0]);
                        }), c = O(t[0].childNodes, r); m.length; ) {
                            var k = m.shift(), w = m.shift(), D = m.shift(), b = m.shift(), T = t[0];
                            if (!k.$$destroyed) {
                                if (w !== h) {
                                    var S = w.className;
                                    l.hasElementTranscludeDirective && f.replace || (T = Le(_)), te(D, na(w), T), x(na(T), S);
                                }
                                Y = d.transcludeOnThisElement ? A(k, d.transclude, b) : b, d(c, k, T, a, Y);
                            }
                        }
                        m = null;
                    }), function(e, t, n, a, r) {
                        var i = r;
                        t.$$destroyed || (m ? m.push(t, n, a, i) : (d.transcludeOnThisElement && (i = A(t, d.transclude, r)), 
                        d(c, t, n, a, i)));
                    };
                }
                function B(e, t) {
                ...
                function K(e, t, n, a) {
                    if (t) throw Za("multidir", "Multiple directives [{0}, {1}] asking for {2} on: {3}", t.name, n.name, e, V(a));
                }
                function Z(e, t) {
                    var n = a(t, !0);
                    n && e.push({
                        ...
                        compile: function(e) {
                            ...
                            return a && H.$$addBindingClass(t), function(e, t) {
                                var r = t.parent();
                                a || H.$$addBindingClass(r), H.$$addBindingInfo(r, n.expressions), e.$watch(n, function(e) {
                                    t[0].nodeValue = e;
                                });
                            };
                        }
                ...
                function ee(e, t, n, r, i) {
                    ...
                    var o = a(n, !0, s, i);
                    if (o) {
                        if ("multiple" === r && "select" === E(e)) throw Za("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", V(e));
                        t.push({
                            priority: 100,
                            compile: function() {
                                return {
                                    pre: function(e, t, u) {
                                        ...
                                        if (L.test(r)) throw Za("nodomevents", "Interpolations for HTML DOM event attributes are disallowed.  Please use the ng- versions (such as ng-click instead of onclick) instead.");
                                        var d = u[r];
                                        d !== n && (o = d && a(d, !0, s, i), n = d), o && (u[r] = o(e), (l[r] || (l[r] = [])).$$inter = !0, 
                ...
                function te(e, n, a) {
                    ...
                    if (e) for (r = 0, i = e.length; r < i; r++) if (e[r] == s) {
                        e[r++] = a;
                        for (var l = r, d = l + o - 1, c = e.length; l < c; l++, d++) d < c ? e[l] = e[d] : delete e[l];
                    ...
                    for (var _ = 1, h = n.length; _ < h; _++) {
                        var f = n[_];
                        na(f).remove(), m.appendChild(f), delete n[_];
                    }
                    n[0] = a, n.length = 1;
                }
                function ae(e, t) {
                ...
                se.prototype = {
                    ...
                    $set: function(e, t, a, s) {
                        var o, u = this.$$element[0], l = Ae(u, e), d = Pe(u, e), c = e;
                        if (l ? (this.$$element.prop(e, t), s = l) : d && (this[d] = t, c = d), this[e] = t, 
                        s ? this.$attr[e] = s : (s = this.$attr[e], s || (this.$attr[e] = s = ne(e, "-"))), 
                        o = E(this.$$element), "a" === o && "href" === e || "img" === o && "src" === e) this[e] = t = S(t, "src" === e); else if ("img" === o && "srcset" === e) {
                            for (var m = "", _ = ha(t), h = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, f = /\s/.test(_) ? h : /(,)/, p = _.split(f), g = Math.floor(p.length / 2), M = 0; M < g; M++) {
                                var y = 2 * M;
                                m += S(ha(p[y]), !0), m += " " + ha(p[y + 1]);
                            }
                            var v = ha(p[2 * M]).split(/\s/);
                            m += S(ha(v[0]), !0), 2 === v.length && (m += " " + ha(v[1])), this[e] = t = m;
                        }
                ...
                var oe = a.startSymbol(), ue = a.endSymbol(), de = "{{" == oe || "}}" == ue ? f : function(e) {
                    return e.replace(/\{\{/g, oe).replace(/}}/g, ue);
                }, ce = /^ngAttr[A-Z]/;
                return H.$$addBindingInfo = Y ? function(e, t) {
                    var n = e.data("$binding") || [];
                    _a(t) ? n = n.concat(t) : n.push(t), e.data("$binding", n);
                } : h, H.$$addBindingClass = Y ? function(e) {
                    x(e, "ng-binding");
                } : h, H.$$addScopeInfo = Y ? function(e, t, n, a) {
                    var r = n ? a ? "$isolateScopeNoTemplate" : "$isolateScope" : "$scope";
                    e.data(r, t);
                } : h, H.$$addScopeClass = Y ? function(e, t) {
                    x(e, t ? "ng-isolate-scope" : "ng-scope");
                } : h, H;
            } ];
        }
        function Qe(e) {
            return fe(e.replace(Qa, ""));
        }
        function Xe(e, t) {
        ...
        function tt() {
            ...
            this.register = function(t, n) {
                se(t, "controller"), y(t) ? c(e, t) : e[t] = n;
                ...
                return function(a, u, l, d) {
                    var m, _, h, f;
                    if (l = l === !0, d && v(d) && (f = d), v(a)) {
                        if (_ = a.match(r), !_) throw Xa("ctrlfmt", "Badly formed controller string '{0}'. Must match `__name__ as __id__` or `__name__`.", a);
                        h = _[1], f = f || _[3], a = e.hasOwnProperty(h) ? e[h] : oe(u.$scope, h, !0) || (t ? oe(s, h, !0) : n), 
                        ie(a, h, !0);
                    }
                    if (l) {
                        var p = (_a(a) ? a[a.length - 1] : a).prototype;
                        return m = Object.create(p || null), f && o(u, f, m, h || a.name), c(function() {
                            return i.invoke(a, m, u, h), m;
                        }, {
                            instance: m,
                            identifier: f
                        });
                    }
                    return m = i.instantiate(a, u, h), f && o(u, f, m, h || a.name), m;
                };
            } ];
        }
        function nt() {
        ...
        function st(e) {
            var t, n, a, r = le();
            return e ? (i(e.split("\n"), function(e) {
                a = e.indexOf(":"), t = Kn(ha(e.substr(0, a))), n = ha(e.substr(a + 1)), t && (r[t] = r[t] ? r[t] + ", " + n : n);
            }), r) : r;
        }
        function ot(e) {
            var t = y(e) ? e : n;
        ...
        function ut(e, t, n, a) {
            return $(a) ? a(e, t, n) : (i(a, function(a) {
                e = a(e, t, n);
            }), e);
        }
        function lt(e) {
        ...
        function dt() {
            ...
            this.$get = [ "$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(s, u, l, d, m, _) {
                function h(t) {
                    function r(e) {
                        var t = c({}, e);
                    ...
                    function s(e) {
                        ...
                        return i(e, function(e, a) {
                            $(e) ? (t = e(), null != t && (n[a] = t)) : n[a] = e;
                        }), n;
                    }
                    function o(t) {
                        var n, a, r, i = e.headers, o = c({}, t.headers);
                        i = c({}, i.common, i[Kn(t.method)]);
                        e: for (n in i) {
                            a = Kn(n);
                    ...
                    if (!da.isObject(t)) throw a("$http")("badreq", "Http request configuration must be an object.  Received: {0}", t);
                    var u = c({
                        method: "get",
                        transformRequest: e.transformRequest,
                        transformResponse: e.transformResponse
                    }, t);
                    u.headers = o(t), u.method = Qn(u.method);
                    var l = function(t) {
                        var a = t.headers, s = ut(t.data, ot(a), n, t.transformRequest);
                        return g(s) && i(a, function(e, t) {
                    ...
                    for (i(D, function(e) {
                        ...
                        var h = d.shift(), f = d.shift();
                        _ = _.then(h, f);
                    }
                    return _.success = function(e) {
                        return ie(e, "fn"), _.then(function(t) {
                            e(t.data, t.status, t.headers, u);
                        }), _;
                    }, _.error = function(e) {
                        return ie(e, "fn"), _.then(null, function(t) {
                            e(t.data, t.status, t.headers, u);
                        }), _;
                    }, _;
                }
                ...
                function L(a, r) {
                    function i(e, n, a, r) {
                        ...
                        _ && (lt(e) ? _.put(Y, [ e, n, st(a), r ]) : _.remove(Y)), t ? d.$applyAsync(i) : (i(), 
                        d.$$phase || d.$apply());
                    }
                    function o(e, t, n, r) {
                        t = t >= -1 ? t : 0, (lt(t) ? p.resolve : p.reject)({
                            data: e,
                            status: t,
                            headers: ot(n),
                            config: a,
                    ...
                    function c() {
                        var e = h.pendingRequests.indexOf(a);
                        e !== -1 && h.pendingRequests.splice(e, 1);
                    }
                    var _, f, p = m.defer(), v = p.promise, L = a.headers, Y = k(a.url, a.params);
                    if (h.pendingRequests.push(a), v.then(c, c), !a.cache && !e.cache || a.cache === !1 || "GET" !== a.method && "JSONP" !== a.method || (_ = y(a.cache) ? a.cache : y(e.cache) ? e.cache : w), 
                    _ && (f = _.get(Y), M(f) ? H(f) ? f.then(l, l) : _a(f) ? o(f[1], f[0], P(f[2]), f[3]) : o(f, 200, {}, "OK") : _.put(Y, v)), 
                    g(f)) {
                        var $ = sn(a.url) ? u.cookies()[a.xsrfCookieName || e.xsrfCookieName] : n;
                        $ && (L[a.xsrfHeaderName || e.xsrfHeaderName] = $), s(a.method, Y, r, i, L, a.timeout, a.withCredentials, a.responseType);
                    }
                    return v;
                }
                function k(e, t) {
                    ...
                    return o(t, function(e, t) {
                        null === e || g(e) || (_a(e) || (e = [ e ]), i(e, function(e) {
                            y(e) && (e = Y(e) ? e.toISOString() : U(e)), n.push(K(t) + "=" + K(e));
                        }));
                    }), n.length > 0 && (e += (e.indexOf("?") == -1 ? "?" : "&") + n.join("&")), e;
                }
                var w = l("$http"), D = [];
                return i(r, function(e) {
                    D.unshift(v(e) ? _.get(e) : _.invoke(e));
                }), h.pendingRequests = [], f("get", "delete", "head", "jsonp"), p("post", "put", "patch"), 
                h.defaults = e, h;
            } ];
        }
        function ct() {
        ...
        function mt() {
            this.$get = [ "$browser", "$window", "$document", function(e, t, n) {
                return _t(e, ct, e.defer, t.angular.callbacks, n[0]);
            } ];
        }
        function _t(e, t, a, r, s) {
            function o(e, t, n) {
            ...
            return function(s, u, l, d, c, m, _, f) {
                function p() {
                    v && v(), L && L.abort();
                }
                function g(t, r, i, s, o) {
                    $ !== n && a.cancel($), v = L = null, t(r, i, s, o), e.$$completeOutstandingRequest(h);
                }
                if (e.$$incOutstandingRequestCount(), u = u || e.url(), "jsonp" == Kn(s)) {
                    var y = "_" + (r.counter++).toString(36);
                    r[y] = function(e) {
                        r[y].data = e, r[y].called = !0;
                    };
                    var v = o(u.replace("JSON_CALLBACK", "angular.callbacks." + y), y, function(e, t) {
                        g(d, e, r[y].data, "", t), r[y] = h;
                    });
                } else {
                    var L = t();
                    L.open(s, u, !0), i(c, function(e, t) {
                        M(e) && L.setRequestHeader(t, e);
                    }), L.onload = function() {
                        var e = L.statusText || "", t = "response" in L ? L.response : L.responseText, n = 1223 === L.status ? 204 : L.status;
                        0 === n && (n = t ? 200 : "file" == rn(u).protocol ? 404 : 0), g(d, n, t, L.getAllResponseHeaders(), e);
                    };
                    var Y = function() {
                        g(d, -1, null, null, "");
                    };
                    if (L.onerror = Y, L.onabort = Y, _ && (L.withCredentials = !0), f) try {
                        L.responseType = f;
                    } catch (e) {
                        if ("json" !== f) throw e;
                    }
                ...
                if (m > 0) var $ = a(p, m); else H(m) && m.then(p);
            };
        }
        function ht() {
            var e = "{{", t = "}}";
            this.startSymbol = function(t) {
                ...
                function s(i, s, m, _) {
                    ...
                    _ = !!_;
                    for (var p, y, v, L = 0, Y = [], k = [], w = i.length, D = [], b = []; L < w; ) {
                        if ((p = i.indexOf(e, L)) == -1 || (y = i.indexOf(t, p + o)) == -1) {
                            L !== w && D.push(h(i.substring(L)));
                            break;
                        }
                        L !== p && D.push(h(i.substring(L, p))), v = i.substring(p + o, y), Y.push(v), k.push(n(v, f)), 
                        L = y + u, b.push(D.length), D.push("");
                    }
                    ...
                    if (!s || Y.length) {
                        ...
                        return c(function(e) {
                            var t = 0, n = Y.length, r = new Array(n);
                            try {
                                for (;t < n; t++) r[t] = k[t](e);
                                return T(r);
                            } catch (e) {
                            ...
                            $$watchDelegate: function(e, t, n) {
                                ...
                                return e.$watchGroup(k, function(n, r) {
                                    var i = T(n);
                                    $(t) && t.call(this, i, n !== r ? a : i, e), a = i;
                                }, n);
                            }
                        });
                    }
                }
                var o = e.length, u = t.length, l = new RegExp(e.replace(/./g, i), "g"), d = new RegExp(t.replace(/./g, i), "g");
        ...
        function ft() {
            this.$get = [ "$rootScope", "$window", "$q", "$$q", function(e, t, n, a) {
                function r(r, s, o, u) {
                    var l = t.setInterval, d = t.clearInterval, c = 0, m = M(u) && !u, _ = (m ? a : n).defer(), h = _.promise;
                    return o = M(o) ? o : 0, h.then(null, null, r), h.$$intervalId = l(function() {
                        _.notify(c++), o > 0 && c >= o && (_.resolve(c), d(h.$$intervalId), delete i[h.$$intervalId]), 
                        m || e.$apply();
                    }, s), i[h.$$intervalId] = _, h;
                }
                var i = {};
        ...
        function yt(e, t) {
            ...
            t.$$search = J(a.search), t.$$hash = decodeURIComponent(a.hash), t.$$path && "/" != t.$$path.charAt(0) && (t.$$path = "/" + t.$$path);
        }
        function vt(e, t) {
        ...
        function wt(e, t, a) {
            this.$$html5 = !0, a = a || "", Mt(e, this), this.$$parse = function(e) {
                var n = vt(t, e);
                if (!v(n)) throw ur("ipthprfx", 'Invalid url "{0}", missing path prefix "{1}".', e, t);
                yt(n, this), this.$$path || (this.$$path = "/"), this.$$compose();
            }, this.$$compose = function() {
                var e = G(this.$$search), n = this.$$hash ? "#" + B(this.$$hash) : "";
                this.$$url = gt(this.$$path) + (e ? "?" + e : "") + n, this.$$absUrl = t + this.$$url.substr(1);
            }, this.$$parseLinkUrl = function(r, i) {
                if (i && "#" === i[0]) return this.hash(i.slice(1)), !0;
                var s, o, u;
                return (s = vt(e, r)) !== n ? (o = s, u = (s = vt(a, s)) !== n ? t + (vt("/", s) || s) : e + o) : (s = vt(t, r)) !== n ? u = t + s : t == r + "/" && (u = t), 
                u && this.$$parse(u), !!u;
            };
        }
        function Dt(e, t, n) {
            Mt(e, this), this.$$parse = function(a) {
                function r(e, t, n) {
                    var a, r = /^\/[A-Z]:(\/.*)/;
                    return 0 === t.indexOf(n) && (t = t.replace(n, "")), r.exec(t) ? e : (a = r.exec(e), 
                    a ? a[1] : e);
                }
                var i, s = vt(e, a) || vt(t, a);
                g(s) || "#" !== s.charAt(0) ? this.$$html5 ? i = s : (i = "", g(s) && (e = a, this.replace())) : (i = vt(n, s), 
                g(i) && (i = s)), yt(i, this), this.$$path = r(this.$$path, i, e), this.$$compose();
            }, this.$$compose = function() {
                var t = G(this.$$search), a = this.$$hash ? "#" + B(this.$$hash) : "";
                this.$$url = gt(this.$$path) + (t ? "?" + t : "") + a, this.$$absUrl = e + (this.$$url ? n + this.$$url : "");
        ...
        function bt(e, t, n) {
            this.$$html5 = !0, Dt.apply(this, arguments), this.$$parseLinkUrl = function(a, r) {
                ...
                var i, s;
                return e == Lt(a) ? i = a : (s = vt(t, a)) ? i = e + n + s : t === a + "/" && (i = t), 
                i && this.$$parse(i), !!i;
            }, this.$$compose = function() {
                var t = G(this.$$search), a = this.$$hash ? "#" + B(this.$$hash) : "";
                this.$$url = gt(this.$$path) + (t ? "?" + t : "") + a, this.$$absUrl = e + n + this.$$url;
            };
        }
        function Tt(e) {
            return function() {
        ...
        function xt() {
            ...
            this.hashPrefix = function(t) {
                ...
                var l, d, c, m = a.baseHref(), _ = a.url();
                if (t.enabled) {
                    if (!m && t.requireBase) throw ur("nobase", "$location in HTML5 mode requires a <base> tag to be present!");
                    c = kt(_) + (m || "/"), d = r.history ? wt : bt;
                } else c = Lt(_), d = Dt;
                var h = $t(c);
                l = new d(c, h, "#" + e), l.$$parseLinkUrl(_, _), l.$$state = a.state();
                var f = /^\s*(javascript|mailto):/i;
                i.on("click", function(e) {
                    if (t.rewriteLinks && !e.ctrlKey && !e.metaKey && !e.shiftKey && 2 != e.which && 2 != e.button) {
                        for (var r = na(e.target); "a" !== E(r[0]); ) if (r[0] === i[0] || !(r = r.parent())[0]) return;
                        var o = r.prop("href"), u = r.attr("href") || r.attr("xlink:href");
                        y(o) && "[object SVGAnimatedString]" === o.toString() && (o = rn(o.animVal).href), 
                        f.test(o) || !o || r.attr("target") || e.isDefaultPrevented() || l.$$parseLinkUrl(o, u) && (e.preventDefault(), 
                        l.absUrl() != a.url() && (n.$apply(), s.angular["ff-684208-preventDefault"] = !0));
                    }
                }), Yt(l.absUrl()) != Yt(_) && a.url(l.absUrl(), !0);
                var p = !0;
                return a.onUrlChange(function(e, t) {
                    return g(vt(h, e)) ? void (s.location.href = e) : (n.$evalAsync(function() {
                        var a, r = l.absUrl(), i = l.$$state;
                        l.$$parse(e), l.$$state = t, a = n.$broadcast("$locationChangeStart", e, r, t, i).defaultPrevented, 
                        l.absUrl() === e && (a ? (l.$$parse(r), l.$$state = i, o(r, !1, i)) : (p = !1, u(r, i)));
                    }), void (n.$$phase || n.$digest()));
                }), n.$watch(function() {
                    var e = Yt(a.url()), t = Yt(l.absUrl()), i = a.state(), s = l.$$replace, d = e !== t || l.$$html5 && r.history && i !== l.$$state;
                    (p || d) && (p = !1, n.$evalAsync(function() {
                        var t = l.absUrl(), a = n.$broadcast("$locationChangeStart", t, e, l.$$state, i).defaultPrevented;
                        l.absUrl() === t && (a ? (l.$$parse(e), l.$$state = i) : (d && o(t, s, i === l.$$state ? null : l.$$state), 
                        u(e, i)));
                    })), l.$$replace = !1;
                }), l;
            } ];
        ...
        function Ht() {
            ...
            this.debugEnabled = function(t) {
                ...
                function r(e) {
                    var t = n.console || {}, r = t[e] || t.log || h, s = !1;
                    try {
                        s = !!r.apply;
                    } catch (e) {}
                    return s ? function() {
        ...
        function jt(e, t) {
            if ("__defineGetter__" === e || "__defineSetter__" === e || "__lookupGetter__" === e || "__lookupSetter__" === e || "__proto__" === e) throw dr("isecfld", "Attempting to access a disallowed field in Angular expressions! Expression: {0}", t);
            return e;
        }
        function Ot(e, t) {
            if (e += "", !v(e)) throw dr("iseccst", "Cannot convert object to primitive value! Expression: {0}", t);
            return e;
        }
        function Et(e, t) {
            if (e) {
                if (e.constructor === e) throw dr("isecfn", "Referencing Function in Angular expressions is disallowed! Expression: {0}", t);
                if (e.window === e) throw dr("isecwindow", "Referencing the Window in Angular expressions is disallowed! Expression: {0}", t);
                if (e.children && (e.nodeName || e.prop && e.attr && e.find)) throw dr("isecdom", "Referencing DOM nodes in Angular expressions is disallowed! Expression: {0}", t);
                if (e === Object) throw dr("isecobj", "Referencing Object in Angular expressions is disallowed! Expression: {0}", t);
            }
            return e;
        }
        function Ct(e, t) {
            if (e) {
                if (e.constructor === e) throw dr("isecfn", "Referencing Function in Angular expressions is disallowed! Expression: {0}", t);
                if (e === cr || e === mr || e === _r) throw dr("isecff", "Referencing call, apply or bind in Angular expressions is disallowed! Expression: {0}", t);
            }
        }
        function At(e) {
            return e.constant;
        ...
        function Pt(e, t, n, a, r) {
            ...
            return i = jt(s.shift(), r), Et(e[i], r), e[i] = a, a;
        }
        function Ft(e) {
            return "constructor" == e;
        }
        function Wt(e, t, a, r, i, s, o) {
            jt(e, s), jt(t, s), jt(a, s), jt(r, s), jt(i, s);
            var u = function(e) {
                return Et(e, s);
            }, l = o || Ft(e) ? u : f, d = o || Ft(t) ? u : f, c = o || Ft(a) ? u : f, m = o || Ft(r) ? u : f, _ = o || Ft(i) ? u : f;
            return function(s, o) {
                var u = o && o.hasOwnProperty(e) ? o : s;
                return null == u ? u : (u = l(u[e]), t ? null == u ? n : (u = d(u[t]), a ? null == u ? n : (u = c(u[a]), 
                r ? null == u ? n : (u = m(u[r]), i ? null == u ? n : u = _(u[i]) : u) : u) : u) : u);
            };
        }
        function Nt(e, t) {
            return function(n, a) {
        ...
        function Rt(e, t, a) {
            var r = t.expensiveChecks, s = r ? vr : yr, o = s[e];
            if (o) return o;
            var u = e.split("."), l = u.length;
            if (t.csp) o = l < 6 ? Wt(u[0], u[1], u[2], u[3], u[4], a, r) : function(e, t) {
                var i, s = 0;
                do i = Wt(u[s++], u[s++], u[s++], u[s++], u[s++], a, r)(e, t), t = n, e = i; while (s < l);
                return i;
            }; else {
                var d = "";
                r && (d += "s = eso(s, fe);\nl = eso(l, fe);\n");
                ...
                i(u, function(e, t) {
                    ...
                    (r || Ft(e)) && (n = "eso(" + n + ", fe)", c = !0), d += "if(s == null) return undefined;\ns=" + n + ";\n";
                }), d += "return s;";
                var m = new Function("s", "l", "eso", "fe", d);
                m.toString = p(d), c && (m = Nt(m, a)), o = m;
            }
        ...
        function It(e) {
            return $(e.valueOf) ? e.valueOf() : Lr.call(e);
        }
        function Ut() {
            var e = le(), t = le();
            this.$get = [ "$filter", "$sniffer", function(n, a) {
                ...
                function u(e, t, n, a) {
                    ...
                    if (1 === i.length) {
                        ...
                        return i = i[0], e.$watch(function(e) {
                            var t = i(e);
                            return o(t, u) || (r = a(e), u = t && It(t)), r;
                        }, t, n);
                    }
                    for (var l = [], d = 0, c = i.length; d < c; d++) l[d] = o;
                    return e.$watch(function(e) {
                        for (var t = !1, n = 0, s = i.length; n < s; n++) {
                            var u = i[n](e);
                            (t || (t = !o(u, l[n]))) && (l[n] = u && It(u));
                        }
                        return t && (r = a(e)), r;
                    }, t, n);
                }
                function l(e, t, n, a) {
                    ...
                    return r = e.$watch(function(e) {
                        ...
                        i = e, $(t) && t.apply(this, arguments), M(e) && a.$$postDigest(function() {
                            M(i) && r();
                        });
                    }, n);
                }
                function d(e, t, n, a) {
                    ...
                    return s = e.$watch(function(e) {
                        ...
                        o = e, $(t) && t.call(this, e, n, a), r(e) && a.$$postDigest(function() {
                            r(o) && s();
                        });
                    }, n);
                }
                ...
                function m(e, t) {
                    if (!t) return e;
                    var n = e.$$watchDelegate, a = n !== d && n !== l, r = a ? function(n, a) {
                        var r = e(n, a);
                        return t(r, n, a);
                    } : function(n, a) {
                ...
                return function(a, i, s) {
                    ...
                    switch (typeof a) {
                      case "string":
                        ...
                        var M = s ? t : e;
                        if (o = M[g], !o) {
                            ":" === a.charAt(0) && ":" === a.charAt(1) && (p = !0, a = a.substring(2));
                            var y = s ? f : _, v = new gr(y), L = new Mr(v, n, y);
                            o = L.parse(a), o.constant ? o.$$watchDelegate = c : p ? (o = r(o), o.$$watchDelegate = o.literal ? d : l) : o.inputs && (o.$$watchDelegate = u), 
                            M[g] = o;
                        }
                        return m(o, i);
        ...
        function qt(e, t) {
            ...
            function u(e) {
                ...
                for (var s = 0, o = i.length; s < o; ++s) {
                    ...
                    try {
                        $(a) ? r.resolve(a(e.value)) : 1 === e.status ? r.resolve(e.value) : r.reject(e.value);
                    } catch (e) {
                        r.reject(e), t(e);
                    }
                }
            ...
            var m = a("$q", TypeError), _ = function() {
                return new d();
            };
            s.prototype = {
                then: function(e, t, n) {
                ...
                $$resolve: function(e) {
                    ...
                    try {
                        (y(e) || $(e)) && (n = e && e.then), $(n) ? (this.promise.$$state.status = -1, n.call(e, a[0], a[1], this.notify)) : (this.promise.$$state.value = e, 
            ...
            var h = function(e) {
                ...
                if (!$(t)) throw m("norslvr", "Expected resolverFn, got '{0}'", t);
                if (!(this instanceof e)) return new e(t);
                var r = new d();
                return t(n, a), r.promise;
            };
            return M.defer = _, M.reject = h, M.when = g, M.all = c, M;
        }
        function Jt() {
            this.$get = [ "$window", "$timeout", function(e, t) {
                ...
                function a(e) {
                    var t = d.length;
                    return l++, d.push(e), 0 === t && (u = o(n)), function() {
                        t >= 0 && (d[t] = null, t = null, 0 === --l && u && (u(), u = null, d.length = 0));
                    };
                }
        ...
        function Gt() {
            ...
            this.digestTtl = function(e) {
            ...
            }, this.$get = [ "$injector", "$exceptionHandler", "$parse", "$browser", function(a, u, d, c) {
                function m(e) {
                ...
                _.prototype = {
                    ...
                    $new: function(t, n) {
                        var a;
                        return n = n || this, t ? (a = new _(), a.$root = this.$root) : (this.$$ChildScope || (this.$$ChildScope = e(this)), 
                    ...
                    $watch: function(e, t, n) {
                        ...
                        return s = null, $(t) || (o.fn = h), i || (i = r.$$watchers = []), i.unshift(o), 
                        function() {
                            C(i, o), s = null;
                        };
                    },
                    ...
                    $watchCollection: function(e, t) {
                        function n(e) {
                            ...
                            if (!g(i)) {
                                if (y(i)) if (r(i)) {
                                    s !== _ && (s = _, p = s.length = 0, c++), t = i.length, p !== t && (c++, s.length = p = t);
                                    for (var l = 0; l < t; l++) u = s[l], o = i[l], a = u !== u && o !== o, a || u === o || (c++, 
                                    s[l] = o);
                                } else {
                                    s !== h && (s = h = {}, p = 0, c++), t = 0;
                                    for (n in i) i.hasOwnProperty(n) && (t++, o = i[n], u = s[n], n in s ? (a = u !== u && o !== o, 
                                    a || u === o || (c++, s[n] = o)) : (p++, s[n] = o, c++));
                                    if (p > t) {
                                        c++;
                                        for (n in s) i.hasOwnProperty(n) || (p--, delete s[n]);
                                    }
                                } else s !== i && (s = i, c++);
                                return c;
                            }
                        ...
                        function a() {
                            if (f ? (f = !1, t(i, i, u)) : t(i, o, u), l) if (y(i)) if (r(i)) {
                        ...
                        n.$stateful = !0;
                        var i, s, o, u = this, l = t.length > 1, c = 0, m = d(e, n), _ = [], h = {}, f = !0, p = 0;
                        return this.$watch(m, a);
                    },
                    $digest: function() {
                        var e, a, r, i, l, d, m, _, h, g, M = t, y = this, Y = [];
                        f("$digest"), c.$$checkUrlChange(), this === k && null !== o && (c.defer.cancel(o), 
                        L()), s = null;
                        do {
                            for (d = !1, _ = y; w.length; ) {
                                try {
                                    g = w.shift(), g.scope.$eval(g.expression, g.locals);
                                } catch (e) {
                                    u(e);
                                }
                                s = null;
                            ...
                            e: do {
                                if (i = _.$$watchers) for (l = i.length; l--; ) try {
                                    if (e = i[l]) if ((a = e.get(_)) === (r = e.last) || (e.eq ? F(a, r) : "number" == typeof a && "number" == typeof r && isNaN(a) && isNaN(r))) {
                                        if (e === s) {
                                            d = !1;
                                            break e;
                                        }
                                    } else d = !0, s = e, e.last = e.eq ? A(a, null) : a, e.fn(a, r === v ? a : r, _), 
                                    M < 5 && (h = 4 - M, Y[h] || (Y[h] = []), Y[h].push({
                                        msg: $(e.exp) ? "fn: " + (e.exp.name || e.exp.toString()) : e.exp,
                                        newVal: a,
                                        oldVal: r
                                    }));
                                } catch (e) {
                                ...
                                if (!(m = _.$$childHead || _ !== y && _.$$nextSibling)) for (;_ !== y && !(m = _.$$nextSibling); ) _ = _.$parent;
                            } while (_ = m);
                            if ((d || w.length) && !M--) throw p(), n("infdig", "{0} $digest() iterations reached. Aborting!\nWatchers fired in the last 5 iterations: {1}", t, Y);
                        } while (d || w.length);
                        for (p(); D.length; ) try {
                            D.shift()();
                        } catch (e) {
                    ...
                    $on: function(e, t) {
                        ...
                        return function() {
                            var a = n.indexOf(t);
                            a !== -1 && (n[a] = null, M(r, 1, e));
                        };
                    },
                    $emit: function(e, t) {
                        var n, a, r, i = [], s = this, o = !1, l = {
                            name: e,
                            targetScope: s,
                    ...
                    $broadcast: function(e, t) {
                        ...
                        for (var s, o, l, d = W([ i ], arguments, 1); a = r; ) {
                            for (i.currentScope = a, s = a.$$listeners[e] || [], o = 0, l = s.length; o < l; o++) if (s[o]) try {
                                s[o].apply(null, d);
                            } catch (e) {
                                u(e);
                            } else s.splice(o, 1), o--, l--;
                            if (!(r = a.$$listenerCount[e] && a.$$childHead || a !== n && a.$$nextSibling)) for (;a !== n && !(r = a.$$nextSibling); ) a = a.$parent;
                        }
                        return i.currentScope = null, i;
                    }
                };
                var k = new _(), w = k.$$asyncQueue = [], D = k.$$postDigestQueue = [], b = k.$$applyAsyncQueue = [];
                return k;
            } ];
        }
        function Bt() {
        ...
        function Qt() {
            ...
            this.resourceUrlWhitelist = function(t) {
                ...
                function o(e, t) {
                    ...
                    if (!a) throw Yr("icontext", "Attempted to trust a value in invalid context. Context: {0}; Value: {1}", e, t);
                ...
                function l(e, t) {
                    ...
                    if (e === $r.HTML) return d(t);
                    throw Yr("unsafe", "Attempting to use an unsafe value in a safe context.");
                }
                var d = function(e) {
                    throw Yr("unsafe", "Attempting to use an unsafe value in a safe context.");
                };
                a.has("$sanitize") && (d = a.get("$sanitize"));
                var c = s(), m = {};
                return m[$r.HTML] = s(c), m[$r.CSS] = s(c), m[$r.URL] = s(c), m[$r.JS] = s(c), m[$r.RESOURCE_URL] = s(m[$r.URL]), 
                {
                    trustAs: o,
                    getTrusted: l,
                    valueOf: u
        ...
        function Xt() {
            ...
            this.enabled = function(t) {
                ...
                if (e && ta < 8) throw Yr("iequirks", "Strict Contextual Escaping does not support Internet Explorer version < 11 in quirks mode.  You can fix this by adding the text <!doctype html> to the top of your HTML document.  See http://docs.angularjs.org/api/ng.$sce for more information.");
                var a = P($r);
                a.isEnabled = function() {
                    return e;
                }, a.trustAs = n.trustAs, a.getTrusted = n.getTrusted, a.valueOf = n.valueOf, e || (a.trustAs = a.getTrusted = function(e, t) {
                    return t;
                }, a.valueOf = f), a.parseAs = function(e, n) {
                    var r = t(n);
                ...
                return i($r, function(e, t) {
                    var n = Kn(t);
                    a[fe("parse_as_" + n)] = function(t) {
                        return r(e, t);
                    }, a[fe("get_trusted_" + n)] = function(t) {
                        return s(e, t);
                    }, a[fe("trust_as_" + n)] = function(t) {
                        return o(e, t);
                    };
                }), a;
            } ];
        ...
        function en() {
            this.$get = [ "$window", "$document", function(e, t) {
                var n, a, r = {}, i = m((/android (\d+)/.exec(Kn((e.navigator || {}).userAgent)) || [])[1]), s = /Boxee/i.test((e.navigator || {}).userAgent), o = t[0] || {}, u = /^(Moz|webkit|ms)(?=[A-Z])/, l = o.body && o.body.style, d = !1, c = !1;
                if (l) {
                    for (var _ in l) if (a = u.exec(_)) {
                        n = a[0], n = n.substr(0, 1).toUpperCase() + n.substr(1);
                        break;
                    }
                    n || (n = "WebkitOpacity" in l && "webkit"), d = !!("transition" in l || n + "Transition" in l), 
                    c = !!("animation" in l || n + "Animation" in l), !i || d && c || (d = v(o.body.style.webkitTransition), 
                    c = v(o.body.style.webkitAnimation));
                }
                return {
        ...
        function tn() {
            this.$get = [ "$templateCache", "$http", "$q", "$sce", function(e, t, n, a) {
                function r(i, s) {
                    ...
                    r.totalPendingRequests++, v(i) && e.get(i) || (i = a.getTrustedResourceUrl(i));
                    var u = t.defaults && t.defaults.transformResponse;
                    _a(u) ? u = u.filter(function(e) {
                        return e !== rt;
                    }) : u === rt && (u = null);
                    var l = {
                        cache: e,
            ...
            this.$get = [ "$rootScope", "$browser", "$location", function(e, t, n) {
                ...
                return a.findBindings = function(e, t, n) {
                    ...
                    return i(a, function(e) {
                        var a = da.element(e).data("$binding");
                        a && i(a, function(a) {
                            if (n) {
                                var i = new RegExp("(^|\\s)" + fa(t) + "(\\s|\\||$)");
                                i.test(a) && r.push(e);
        ...
        function an() {
            this.$get = [ "$rootScope", "$browser", "$q", "$$q", "$exceptionHandler", function(e, t, n, a, r) {
                function i(i, o, u) {
                    var l, d = M(u) && !u, c = (d ? a : n).defer(), m = c.promise;
        ...
        function un(e) {
            ...
            } ], t("currency", mn), t("date", wn), t("filter", ln), t("json", Dn), t("limitTo", bn), 
            t("lowercase", xr), t("number", _n), t("orderBy", Tn), t("uppercase", Hr);
        }
        function ln() {
        ...
        function dn(e, t, n) {
            var a, r = y(e) && "$" in e;
            return t === !0 ? t = F : $(t) || (t = function(e, t) {
        ...
        function cn(e, t, n, a, r) {
            ...
            if (_a(e)) return e.some(function(e) {
                return cn(e, t, n, a);
            });
            switch (i) {
              case "object":
        ...
        function mn(e) {
            ...
            return function(e, n, a) {
                return g(n) && (n = t.CURRENCY_SYM), g(a) && (a = t.PATTERNS[1].maxFrac), null == e ? e : hn(e, t.PATTERNS[1], t.GROUP_SEP, t.DECIMAL_SEP, a).replace(/\u00A4/g, n);
            };
        }
        function _n(e) {
            var t = e.NUMBER_FORMATS;
        ...
        function hn(e, t, n, a, r) {
            ...
            if (s.indexOf("e") !== -1) {
                var d = s.match(/([\d\.]+)e(-?)(\d+)/);
                d && "-" == d[2] && d[3] > r + 1 ? e = 0 : (o = s, l = !0);
            }
            if (l) r > 0 && e < 1 && (o = e.toFixed(r), e = parseFloat(o)); else {
                var c = (s.split(Dr)[1] || "").length;
                g(r) && (r = Math.min(Math.max(t.minFrac, c), t.maxFrac)), e = +(Math.round(+(e.toString() + "e" + r)).toString() + "e" + -r);
                var m = ("" + e).split(Dr), _ = m[0];
                m = m[1] || "";
                var h, f = 0, p = t.lgSize, M = t.gSize;
                if (_.length >= p + M) for (f = _.length - p, h = 0; h < f; h++) (f - h) % M === 0 && 0 !== h && (o += n), 
                o += _.charAt(h);
                for (h = f; h < _.length; h++) (_.length - h) % p === 0 && 0 !== h && (o += n), 
                o += _.charAt(h);
                for (;m.length < r; ) m += "0";
        ...
        function gn(e, t) {
            return function(n, a) {
                var r = n["get" + e](), i = Qn(t ? "SHORT" + e : e);
                return a[i][r];
            };
        }
        function Mn(e) {
        ...
        function Ln(e) {
            return function(t) {
                var n = yn(t.getFullYear()), a = vn(t), r = +a - +n, i = 1 + Math.round(r / 6048e5);
                return fn(i, e);
            };
        }
        function Yn(e, t) {
        ...
        function wn(e) {
            function t(e) {
                ...
                if (t = e.match(n)) {
                    ...
                    var u = m(t[4] || 0) - r, l = m(t[5] || 0) - i, d = m(t[6] || 0), c = Math.round(1e3 * parseFloat("0." + (t[7] || 0)));
                    return o.call(a, u, l, d, c), a;
                }
                return e;
            }
            ...
            return function(n, a, r) {
                var s, o, u = "", l = [];
                if (a = a || "mediumDate", a = e.DATETIME_FORMATS[a] || a, v(n) && (n = Sr.test(n) ? m(n) : t(n)), 
                L(n) && (n = new Date(n)), !Y(n)) return n;
                for (;a; ) o = Tr.exec(a), o ? (l = W(l, o, 1), a = l.pop()) : (l.push(a), a = null);
                return r && "UTC" === r && (n = new Date(n.getTime()), n.setMinutes(n.getMinutes() + n.getTimezoneOffset())), 
                i(l, function(t) {
                    s = br[t], u += s ? s(n, e.DATETIME_FORMATS) : t.replace(/(^'|'$)/g, "").replace(/''/g, "'");
                }), u;
            };
        }
        function Dn() {
        ...
        function bn() {
            return function(e, t) {
                return L(e) && (e = e.toString()), _a(e) || v(e) ? (t = Math.abs(Number(t)) === 1 / 0 ? Number(t) : m(t), 
        ...
        function Tn(e) {
            return function(t, n, a) {
                ...
                return r(t) ? (n = _a(n) ? n : [ n ], 0 === n.length && (n = [ "+" ]), n = n.map(function(t) {
                    var n = !1, a = t || f;
                    if (v(t)) {
        ...
        function Hn(e, t, a, r, s) {
            var o = this, u = [], l = o.$$parentForm = e.parent().controller("form") || Er;
            ...
            l.$addControl(o), o.$rollbackViewValue = function() {
                ...
                unset: function(e, t, n) {
                    var a = e[t];
                    a && (C(a, n), 0 === a.length && delete e[t]);
                },
                parentForm: l,
                $animate: r
            }), o.$setDirty = function() {
                r.removeClass(e, pi), r.addClass(e, gi), o.$dirty = !0, o.$pristine = !1, l.$setDirty();
            }, o.$setPristine = function() {
                r.setClass(e, pi, gi + " " + Cr), o.$dirty = !1, o.$pristine = !0, o.$submitted = !1, 
                i(u, function(e) {
                    e.$setPristine();
                });
        ...
        function En(e, t, n, a, r, i) {
            ...
            var u = function(e) {
                if (l && (i.defer.cancel(l), l = null), !o) {
                    ...
                    "password" === s || n.ngTrim && "false" === n.ngTrim || (r = ha(r)), (a.$viewValue !== r || "" === r && a.$$hasNativeValidators) && a.$setViewValue(r, u);
                }
            };
        ...
        function Cn(e, t) {
            ...
            if (v(e)) {
                ...
                var n = Vr.exec(e);
                if (n) {
                    var a = +n[1], r = +n[2], i = 0, s = 0, o = 0, u = 0, l = yn(a), d = 7 * (r - 1);
                    return t && (i = t.getHours(), s = t.getMinutes(), o = t.getSeconds(), u = t.getMilliseconds()), 
                    new Date(a, 0, l.getDate() + d, i, s, o, u);
                }
            }
            return NaN;
        }
        ...
        function Pn(e, t, a, r) {
            return function(i, s, o, u, l, d, c) {
                function m(e) {
                    return e && !(e.getTime && e.getTime() !== e.getTime());
                }
                function _(e) {
                    return M(e) ? Y(e) ? e : a(e) : n;
                }
                Fn(i, s, o, u), En(i, s, o, u, l, d);
                var h, f = u && u.$options && u.$options.timezone;
                if (u.$$parserName = e, u.$parsers.push(function(e) {
                    if (u.$isEmpty(e)) return null;
                    if (t.test(e)) {
                        var r = a(e, h);
                        return "UTC" === f && r.setMinutes(r.getMinutes() - r.getTimezoneOffset()), r;
                    }
                    return n;
                }), u.$formatters.push(function(e) {
                    if (e && !Y(e)) throw Li("datefmt", "Expected `{0}` to be a date", e);
                    if (m(e)) {
                        if (h = e, h && "UTC" === f) {
        ...
        function Wn(e, t, a, r, i, s) {
            if (Fn(e, t, a, r), En(e, t, a, r, i, s), r.$$parserName = "number", r.$parsers.push(function(e) {
                return r.$isEmpty(e) ? null : Ir.test(e) ? parseFloat(e) : n;
            }), r.$formatters.push(function(e) {
                if (!r.$isEmpty(e)) {
                    if (!L(e)) throw Li("numfmt", "Expected `{0}` to be a number", e);
                    e = e.toString();
                }
                return e;
            }), M(a.min) || a.ngMin) {
                ...
                r.$validators.min = function(e) {
                    ...
                    M(e) && !L(e) && (e = parseFloat(e, 10)), o = L(e) && !isNaN(e) ? e : n, r.$validate();
                });
            }
            if (M(a.max) || a.ngMax) {
                var u;
                r.$validators.max = function(e) {
                    ...
                    M(e) && !L(e) && (e = parseFloat(e, 10)), u = L(e) && !isNaN(e) ? e : n, r.$validate();
                });
            }
        }
        function Nn(e, t, n, a, r, i) {
            En(e, t, n, a, r, i), jn(a), a.$$parserName = "url", a.$validators.url = function(e, t) {
                var n = e || t;
                return a.$isEmpty(n) || Nr.test(n);
            };
        }
        function Rn(e, t, n, a, r, i) {
            En(e, t, n, a, r, i), jn(a), a.$$parserName = "email", a.$validators.email = function(e, t) {
                var n = e || t;
        ...
        function Un(e, t, n, a, r) {
            var i;
            if (M(a)) {
                if (i = e(a), !i.constant) throw Li("constexpr", "Expected constant expression for `{0}`, but saw `{1}`.", n, a);
                return i(t);
            }
            return r;
        }
        function zn(e, t, n, a, r, i, s, o) {
            var u = Un(o, e, "ngTrueValue", n.ngTrueValue, !0), l = Un(o, e, "ngFalseValue", n.ngFalseValue, !1), d = function(e) {
                a.$setViewValue(t[0].checked, e && e.type);
            };
            t.on("click", d), a.$render = function() {
            ...
            return e = "ngClass" + e, [ "$animate", function(n) {
                ...
                return {
                    ...
                    link: function(s, o, u) {
                        ...
                        function m(e, t) {
                            var r = a(t, e), i = a(e, t);
                            r = c(r, 1), i = c(i, -1), r && r.length && n.addClass(o, r), i && i.length && n.removeClass(o, i);
                        }
                        function _(e) {
                            if (t === !0 || s.$index % 2 === t) {
                                var n = r(e || []);
                        ...
                        var h;
                        s.$watch(u[e], _, !0), u.$observe("class", function(t) {
                            _(s.$eval(u[e]));
        ...
        function qn(e) {
            function t(e, t, u) {
                t === n ? a("$pending", e, u) : r("$pending", e, u), x(t) ? t ? (c(o.$error, e, u), 
                d(o.$$success, e, u)) : (d(o.$error, e, u), c(o.$$success, e, u)) : (c(o.$error, e, u), 
                c(o.$$success, e, u)), o.$pending ? (i(vi, !0), o.$valid = o.$invalid = n, s("", null)) : (i(vi, !1), 
                o.$valid = Jn(o.$error), o.$invalid = !o.$valid, s("", o.$valid));
                var l;
            ...
            function r(e, t, a) {
                o[e] && c(o[e], t, a), Jn(o[e]) && (o[e] = n);
            }
            function i(e, t) {
                t && !l[e] ? (_.addClass(u, e), l[e] = !0) : !t && l[e] && (_.removeClass(u, e), 
                l[e] = !1);
            }
            function s(e, t) {
                e = e ? "-" + ne(e, "-") : "", i(hi + e, t === !0), i(fi + e, t === !1);
            }
            var o = e.ctrl, u = e.$element, l = {}, d = e.set, c = e.unset, m = e.parentForm, _ = e.$animate;
            l[fi] = !(l[hi] = u.hasClass(hi)), o.$setValidity = t;
        }
        function Jn(e) {
            if (e) for (var t in e) return !1;
            return !0;
        }
        var Gn = /^\/(.+)\/([a-z]*)$/, Bn = "validity", Kn = function(e) {
            return v(e) ? e.toLowerCase() : e;
        }, Zn = Object.prototype.hasOwnProperty, Qn = function(e) {
        ...
        "i" !== "I".toLowerCase() && (Kn = Xn, Qn = ea);
        var ta, na, aa, ra, ia = [].slice, sa = [].splice, oa = [].push, ua = Object.prototype.toString, la = a("ng"), da = e.angular || (e.angular = {}), ca = 0;
        ta = t.documentMode, h.$inject = [], f.$inject = [];
        var ma, _a = Array.isArray, ha = function(e) {
            return v(e) ? e.trim() : e;
        }, fa = function(e) {
            return e.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g, "\\$1").replace(/\x08/g, "\\x08");
        }, pa = function() {
            if (M(pa.isActive_)) return pa.isActive_;
        ...
        }, ga = [ "ng-", "data-ng-", "ng:", "x-ng-" ], Ma = /[A-Z]/g, ya = !1, va = 1, La = 2, Ya = 3, $a = 8, ka = 9, wa = 11, Da = {
            full: "1.3.20",
            major: 1,
            minor: 3,
            dot: 20,
        ...
        ve.expando = "ng339";
        var ba = ve.cache = {}, Ta = 1, Sa = function(e, t, n) {
        ...
        var Ha = /([\:\-\_]+(.))/g, ja = /^moz([A-Z])/, Oa = {
            mouseleave: "mouseout",
            mouseenter: "mouseover"
        }, Ea = a("jqLite"), Ca = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Aa = /<|&#?\w+;/, Pa = /<([\w:]+)/, Fa = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Wa = {
        ...
        var Na = ve.prototype = {
            ready: function(n) {
                ...
                var r = !1;
                "complete" === t.readyState ? setTimeout(a) : (this.on("DOMContentLoaded", a), ve(e).on("load", a));
            },
            toString: function() {
                var e = [];
        ...
        i({
            ...
            inheritedData: je,
            scope: function(e) {
                return na.data(e, "$scope") || je(e.parentNode || e, [ "$isolateScope", "$scope" ]);
            },
            ...
            hasClass: be,
            css: function(e, t, n) {
                return t = fe(t), M(n) ? void (e.style[t] = n) : e.style[t];
            },
            attr: function(e, t, a) {
                var r = e.nodeType;
                if (r !== Ya && r !== La && r !== $a) {
                    var i = Kn(t);
                    if (Ra[i]) {
                        if (!M(a)) return e[t] || (e.attributes.getNamedItem(t) || h).specified ? i : n;
                        a ? (e[t] = !0, e.setAttribute(t, i)) : (e[t] = !1, e.removeAttribute(i));
                    } else if (M(a)) e.setAttribute(t, a); else if (e.getAttribute) {
            ...
            prop: function(e, t, n) {
                return M(n) ? void (e[t] = n) : e[t];
            },
            text: function() {
                function e(e, t) {
                    if (g(t)) {
                        var n = e.nodeType;
                        return n === va || n === Ya ? e.textContent : "";
                    }
                    e.textContent = t;
                }
                return e.$dv = "", e;
            ...
            html: function(e, t) {
                return g(t) ? e.innerHTML : (Ye(e, !0), void (e.innerHTML = t));
            },
            empty: Oe
        }, function(e, t) {
            ve.prototype[t] = function(t, a) {
                var r, i, s = this.length;
                if (e !== Oe && (2 == e.length && e !== be && e !== He ? t : a) === n) {
                    if (y(t)) {
            ...
            on: function e(t, n, a, r) {
                if (M(r)) throw Ea("onargs", "jqLite#on() does not support the `selector` or `eventData` parameters");
                if (ge(t)) {
                    ...
                    for (var u = n.indexOf(" ") >= 0 ? n.split(" ") : [ n ], l = u.length; l--; ) {
                        n = u[l];
                        var d = s[n];
                        d || (s[n] = [], "mouseenter" === n || "mouseleave" === n ? e(t, Oa[n], function(e) {
                            var t = this, a = e.relatedTarget;
                            a && (a === t || t.contains(a)) || o(e, n);
                        }) : "$destroy" !== n && Sa(t, n, o), d = s[n]), d.push(a);
                    }
                }
            },
            off: $e,
            ...
            toggleClass: function(e, t, n) {
                t && i(t.split(" "), function(t) {
                    var a = n;
                    g(a) && (a = !be(e, t)), (a ? Se : Te)(e, t);
                });
            },
            parent: function(e) {
                var t = e.parentNode;
                return t && t.nodeType !== wa ? t : null;
            },
            next: function(e) {
            ...
            triggerHandler: function(e, t, n) {
                var a, r, s, o = t.type || t, u = we(e), l = u && u.events, d = l && l[o];
                d && (a = {
                    preventDefault: function() {
                    ...
                    type: o,
                    target: e
                }, t.type && (a = c(a, t)), r = P(d), s = n ? [ a ].concat(n) : [ a ], i(r, function(t) {
                    a.isImmediatePropagationStopped() || t.apply(e, s);
                }));
            }
        }, function(e, t) {
            ve.prototype[t] = function(t, n, a) {
                for (var r, i = 0, s = this.length; i < s; i++) g(r) ? (r = e(this[i], t, n, a), 
                M(r) && (r = na(r))) : xe(r, e(this[i], t, n, a));
                return M(r) ? r : this;
        ...
        var za = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Va = /,/, qa = /^\s*(_?)(\S+?)\1\s*$/, Ja = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Ga = a("$injector");
        ze.$$annotate = Ue;
        var Ba = a("$animate"), Ka = [ "$provide", function(e) {
            this.$$selectors = {}, this.register = function(t, n) {
                var a = t + "-animation";
                if (t && "." != t.charAt(0)) throw Ba("notcsel", "Expecting class selector starting with '.' got '{0}'.", t);
                ...
                return {
                    ...
                    $$addClassImmediately: function(e, t, n) {
                        return e = na(e), t = v(t) ? t : _a(t) ? t.join(" ") : "", i(e, function(e) {
                            Se(e, t);
                        }), u(e, n), o();
                    },
                    ...
                    setClass: function(e, t, n, i) {
                        ...
                        e = na(e);
                        var d = e.data(u);
                        d ? i && d.options && (d.options = da.extend(d.options || {}, i)) : (d = {
                            classes: {},
                            options: i
                        }, l = !0);
                        var c = d.classes;
                        return t = _a(t) ? t : t.split(" "), n = _a(n) ? n : n.split(" "), s(c, t, !0), 
                        s(c, n, !1), l && (d.promise = a(function(t) {
                            var n = e.data(u);
                            if (e.removeData(u), n) {
                                var a = r(e, n.classes);
        ...
        var Qa = /^((?:x|data)[\:\-_])/i, Xa = a("$controller"), er = "application/json", tr = {
            ...
            search: function(e, t) {
                switch (arguments.length) {
                  ...
                  case 1:
                    if (v(e) || L(e)) e = e.toString(), this.$$search = J(e); else {
                        if (!y(e)) throw ur("isrcharg", "The first argument of the `$location#search()` call must be a string or an object.");
        ...
        i([ bt, Dt, wt ], function(e) {
            e.prototype = Object.create(lr), e.prototype.state = function(t) {
                if (!arguments.length) return this.$$state;
                if (e !== wt || !this.$$html5) throw ur("nostate", "History API state support is available only in HTML5 mode and only in browsers supporting HTML5 History API");
                return this.$$state = g(t) ? null : t, this;
            };
        });
        var dr = a("$parse"), cr = Function.prototype.call, mr = Function.prototype.apply, _r = Function.prototype.bind, hr = le();
        i({
            null: function() {
                return null;
            },
            ...
            e.constant = e.literal = e.sharedGetter = !0, hr[t] = e;
        }), hr.this = function(e) {
            return e;
        }, hr.this.sharedGetter = !0;
        var fr = c(le(), {
            "+": function(e, t, a, r) {
                return a = a(e, t), r = r(e, t), M(a) ? M(r) ? a + r : a : M(r) ? r : n;
            },
            "-": function(e, t, n, a) {
                return n = n(e, t), a = a(e, t), (M(n) ? n : 0) - (M(a) ? a : 0);
            },
            "*": function(e, t, n, a) {
                return n(e, t) * a(e, t);
            },
        ...
        gr.prototype = {
            ...
            lex: function(e) {
                for (this.text = e, this.index = 0, this.tokens = []; this.index < this.text.length; ) {
                    ...
                    if ('"' === t || "'" === t) this.readString(t); else if (this.isNumber(t) || "." === t && this.isNumber(this.peek())) this.readNumber(); else if (this.isIdent(t)) this.readIdent(); else if (this.is(t, "(){}[].,;:?")) this.tokens.push({
                        ...
                        var n = t + this.peek(), a = n + this.peek(2), r = fr[t], i = fr[n], s = fr[a];
                        if (r || i || s) {
                            var o = s ? a : i ? n : t;
                            this.tokens.push({
                                index: this.index,
            ...
            throwError: function(e, t, n) {
                n = n || this.index;
                var a = M(t) ? "s " + t + "-" + this.index + " [" + this.text.substring(t, n) + "]" : " " + n;
                throw dr("lexerr", "Lexer Error: {0} at column{1} in expression [{2}].", e, a, this.text);
            },
            readNumber: function() {
        ...
        Mr.ZERO = c(function() {
            ...
            primary: function() {
                var e;
                this.expect("(") ? (e = this.filterChain(), this.consume(")")) : this.expect("[") ? e = this.arrayDeclaration() : this.expect("{") ? e = this.object() : this.peek().identifier && this.peek().text in hr ? e = hr[this.consume().text] : this.peek().identifier ? e = this.identifier() : this.peek().constant ? e = this.constant() : this.throwError("not a primary expression", this.peek());
            ...
            throwError: function(e, t) {
                throw dr("syntax", "Syntax Error: Token '{0}' {1} at column {2} of the expression [{3}] starting at [{4}].", t.text, e, t.index + 1, this.text, this.text.substring(t.index));
            },
            peekToken: function() {
                if (0 === this.tokens.length) throw dr("ueoe", "Unexpected end of expression: {0}", this.text);
            ...
            objectIndex: function(e) {
                ...
                return this.consume("]"), c(function(r, i) {
                    var s, o = e(r, i), u = Ot(a(r, i), t);
                    return jt(u, t), o ? s = Et(o[u], t) : n;
                }, {
                    assign: function(n, r, i) {
                        var s = jt(Ot(a(n, i), t), t), o = Et(e(n, i), t);
            ...
            functionCall: function(e, t) {
                ...
                return function(s, o) {
                    var u = t ? t(s, o) : M(t) ? n : s, l = e(s, o, u) || h;
                    if (i) for (var d = a.length; d--; ) i[d] = Et(a[d](s, o), r);
                    Et(u, r), Ct(l, r);
                    var c = l.apply ? l.apply(u, i) : l(i[0], i[1], i[2], i[3], i[4]);
                    return i && (i.length = 0), Et(c, r);
                };
            },
            ...
            object: function() {
                ...
                return this.consume("}"), c(function(n, a) {
        ...
        var yr = le(), vr = le(), Lr = Object.prototype.valueOf, Yr = a("$sce"), $r = {
            HTML: "html",
            CSS: "css",
            URL: "url",
            RESOURCE_URL: "resourceUrl",
            JS: "js"
        }, Za = a("$compile"), kr = t.createElement("a"), wr = rn(e.location.href);
        un.$inject = [ "$provide" ], mn.$inject = [ "$locale" ], _n.$inject = [ "$locale" ];
        var Dr = ".", br = {
            yyyy: pn("FullYear", 4),
            ...
            compile: function(e, t) {
                if (!t.href && !t.xlinkHref && !t.name) return function(e, t) {
                    if ("a" === t[0].nodeName.toLowerCase()) {
                        var n = "[object SVGAnimatedString]" === ua.call(t.prop("href")) ? "xlink:href" : "href";
        ...
        i(Ra, function(e, t) {
            ...
            Or[t] = function() {
                return {
                    ...
                    link: function(n, a, r) {
                        var i = e, s = e;
                        "href" === e && "[object SVGAnimatedString]" === ua.call(a.prop("href")) && (s = "xlinkHref", 
        ...
        var Ar = function(e) {
                    ...
                    compile: function(a, r) {
                        ...
                        return {
                            pre: function(e, a, r, s) {
                                ...
                                var u = s.$$parentForm;
                                i && (Pt(e, null, s.$name, s, s.$name), r.$observe(i, function(t) {
                                    s.$name !== t && (Pt(e, null, s.$name, n, s.$name), u.$$renameControl(s, t), Pt(e, null, s.$name, s, s.$name));
                                })), a.on("$destroy", function() {
                                    u.$removeControl(s), i && Pt(e, null, r[i], n, s.$name), c(s, Er);
                                });
                            }
                        };
                    }
        ...
        }, Pr = Ar(), Fr = Ar(!0), Wr = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, Nr = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Rr = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Ir = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Ur = /^(\d{4})-(\d{2})-(\d{2})$/, zr = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Vr = /^(\d{4})-W(\d\d)$/, qr = /^(\d{4})-(\d\d)$/, Jr = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Gr = {
            text: On,
            date: Pn("date", Ur, An(Ur, [ "yyyy", "MM", "dd" ]), "yyyy-MM-dd"),
            "datetime-local": Pn("datetimelocal", zr, An(zr, [ "yyyy", "MM", "dd", "HH", "mm", "ss", "sss" ]), "yyyy-MM-ddTHH:mm:ss.sss"),
            time: Pn("time", Jr, An(Jr, [ "HH", "mm", "ss", "sss" ]), "HH:mm:ss.sss"),
            week: Pn("week", Vr, Cn, "yyyy-Www"),
            month: Pn("month", qr, An(qr, [ "yyyy", "MM" ]), "yyyy-MM"),
            number: Wn,
            url: Nn,
            email: Rn,
            radio: In,
            ...
            reset: h,
            file: h
        }, Br = [ "$browser", "$sniffer", "$filter", "$parse", function(e, t, n, a) {
            return {
                restrict: "E",
                require: [ "?ngModel" ],
                link: {
        ...
        }), ni = Vn("", !0), ai = Vn("Odd", 0), ri = Vn("Even", 1), ii = Sn({
            compile: function(e, t) {
                    ...
                    compile: function(r, i) {
                        ...
                        return function(t, n) {
                            n.on(e, function(n) {
                                ...
                                ui[e] && a.$$phase ? t.$evalAsync(r) : t.$apply(r);
                            });
                        };
                    }
                };
        ...
        var li = [ "$animate", function(e) {
        ...
        } ], di = [ "$templateRequest", "$anchorScroll", "$animate", function(e, t, n) {
            return {
                restrict: "ECA",
                priority: 400,
                terminal: !0,
                ...
                compile: function(a, r) {
                    ...
                    return function(a, r, u, l, d) {
                        var c, m, _, h = 0, f = function() {
                            m && (m.remove(), m = null), c && (c.$destroy(), c = null), _ && (n.leave(_).then(function() {
                                m = null;
                            }), m = _, _ = null);
                        };
                            ...
                            i ? (e(i, !0).then(function(e) {
                                if (m === h) {
                                    ...
                                    var o = d(t, function(e) {
                                        f(), n.enter(e, null, r).then(u);
                                    });
                                    c = t, _ = o, c.$emit("$includeContentLoaded", i), a.$eval(s);
                                }
                            }, function() {
                                m === h && (f(), a.$emit("$includeContentError", i));
                            }), a.$emit("$includeContentRequested", i)) : (f(), l.template = null);
                        });
                    };
                }
            };
        } ], ci = [ "$compile", function(e) {
            return {
                restrict: "ECA",
                priority: -400,
                require: "ngInclude",
                link: function(n, a, r, i) {
                    return /SVG/.test(a[0].toString()) ? (a.empty(), void e(Me(i.template, t).childNodes)(n, function(e) {
                        a.append(e);
                    }, {
            ...
            return {
                ...
                link: function(e, t, a, r) {
                    var s = t.attr(a.$attr.ngList) || ", ", o = "false" !== a.ngTrim, u = o ? ha(s) : s, l = function(e) {
                        if (!g(e)) {
                            var t = [];
                    ...
                    r.$parsers.push(l), r.$formatters.push(function(e) {
                        return _a(e) ? e.join(s) : n;
                    }), r.$isEmpty = function(e) {
                        return !e || !e.length;
                    };
                }
            };
        }, hi = "ng-valid", fi = "ng-invalid", pi = "ng-pristine", gi = "ng-dirty", Mi = "ng-untouched", yi = "ng-touched", vi = "ng-pending", Li = a("ngModel"), Yi = [ "$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(e, t, a, r, s, o, u, l, d, c) {
            this.$viewValue = Number.NaN, this.$modelValue = Number.NaN, this.$$rawModelValue = n, 
            this.$validators = {}, this.$asyncValidators = {}, this.$parsers = [], this.$formatters = [], 
            this.$viewChangeListeners = [], this.$untouched = !0, this.$touched = !1, this.$pristine = !0, 
            this.$dirty = !1, this.$valid = !0, this.$invalid = !1, this.$error = {}, this.$$success = {}, 
            this.$pending = n, this.$name = c(a.name || "", !1)(e);
            var m, _ = s(a.ngModel), f = _.assign, p = _, y = f, v = null, Y = this;
            this.$$setOptions = function(e) {
                ...
                } else if (!_.assign) throw Li("nonassign", "Expression '{0}' is non-assignable. Element: {1}", a.ngModel, V(r));
            }, this.$render = h, this.$isEmpty = function(e) {
                return g(e) || "" === e || null === e || e !== e;
            };
            var k = r.inheritedData("$formController") || Er, w = 0;
            qn({
                ctrl: this,
                $element: r,
                set: function(e, t) {
                ...
                Y.$dirty = !1, Y.$pristine = !0, o.removeClass(r, gi), o.addClass(r, pi);
            }, this.$setDirty = function() {
                Y.$dirty = !0, Y.$pristine = !1, o.removeClass(r, pi), o.addClass(r, gi), k.$setDirty();
            }, this.$setUntouched = function() {
                Y.$touched = !1, Y.$untouched = !0, o.setClass(r, Mi, yi);
            }, this.$setTouched = function() {
                Y.$touched = !0, Y.$untouched = !1, o.setClass(r, yi, Mi);
            }, this.$rollbackViewValue = function() {
                u.cancel(v), Y.$viewValue = Y.$$lastCommittedViewValue, Y.$render();
            }, this.$validate = function() {
                if (!L(Y.$modelValue) || !isNaN(Y.$modelValue)) {
                    var e = Y.$$lastCommittedViewValue, t = Y.$$rawModelValue, a = Y.$valid, r = Y.$modelValue, i = Y.$options && Y.$options.allowInvalid;
                    Y.$$runValidators(t, e, function(e) {
                        i || a === e || (Y.$modelValue = e ? t : n, Y.$modelValue !== r && Y.$$writeModelToScope());
                    });
                }
            }, this.$$runValidators = function(e, t, a) {
                function r() {
                    var e = Y.$$parserName || "parse";
                    return m !== n ? (m || (i(Y.$validators, function(e, t) {
                        u(t, null);
                ...
                function s() {
                    var n = !0;
                    return i(Y.$validators, function(a, r) {
                        var i = a(e, t);
                        n = n && i, u(r, i);
                    }), !!n || (i(Y.$asyncValidators, function(e, t) {
                        u(t, null);
                    }), !1);
                }
                function o() {
                    ...
                    i(Y.$asyncValidators, function(i, s) {
                        var o = i(e, t);
                        if (!H(o)) throw Li("$asyncValidators", "Expected asynchronous validator to return a promise but got '{0}' instead.", o);
                        u(s, n), a.push(o.then(function() {
                            u(s, !0);
                        }, function(e) {
                            r = !1, u(s, !1);
                        }));
                    }), a.length ? d.all(a).then(function() {
                        l(r);
                    }, h) : l(!0);
                }
                function u(e, t) {
                    c === w && Y.$setValidity(e, t);
                }
                function l(e) {
                    c === w && a(e);
                }
                ...
                var e = Y.$viewValue;
                u.cancel(v), (Y.$$lastCommittedViewValue !== e || "" === e && Y.$$hasNativeValidators) && (Y.$$lastCommittedViewValue = e, 
                Y.$pristine && this.$setDirty(), this.$$parseAndValidate());
            }, this.$$parseAndValidate = function() {
                function t() {
                    Y.$modelValue !== s && Y.$$writeModelToScope();
                }
                var a = Y.$$lastCommittedViewValue, r = a;
                if (m = !g(r) || n) for (var i = 0; i < Y.$parsers.length; i++) if (r = Y.$parsers[i](r), 
                g(r)) {
                    m = !1;
                    break;
                }
                L(Y.$modelValue) && isNaN(Y.$modelValue) && (Y.$modelValue = p(e));
                var s = Y.$modelValue, o = Y.$options && Y.$options.allowInvalid;
                Y.$$rawModelValue = r, o && (Y.$modelValue = r, t()), Y.$$runValidators(r, Y.$$lastCommittedViewValue, function(e) {
                    o || (Y.$modelValue = e ? r : n, t());
                });
            }, this.$$writeModelToScope = function() {
                y(e, Y.$modelValue), i(Y.$viewChangeListeners, function(e) {
                    try {
                        e();
                    } catch (e) {
                        t(e);
                ...
                var n, a = 0, r = Y.$options;
                r && M(r.debounce) && (n = r.debounce, L(n) ? a = n : L(n[t]) ? a = n[t] : L(n.default) && (a = n.default)), 
                u.cancel(v), a ? v = u(function() {
                    Y.$commitViewValue();
                }, a) : l.$$phase ? Y.$commitViewValue() : e.$apply(function() {
                    Y.$commitViewValue();
                });
            }, e.$watch(function() {
                var t = p(e);
                if (t !== Y.$modelValue && (Y.$modelValue === Y.$modelValue || t === t)) {
                    Y.$modelValue = Y.$$rawModelValue = t, m = n;
                    for (var a = Y.$formatters, r = a.length, i = t; r--; ) i = a[r](i);
                    Y.$viewValue !== i && (Y.$viewValue = Y.$$lastCommittedViewValue = i, Y.$render(), 
                    Y.$$runValidators(t, i, h));
                }
                return t;
            });
        } ], $i = [ "$rootScope", function(e) {
            return {
                restrict: "A",
                ...
                priority: 1,
                compile: function(t) {
                    return t.addClass(pi).addClass(Mi).addClass(hi), {
            ...
            return {
                ...
                controller: [ "$scope", "$attrs", function(e, t) {
                    ...
                    this.$options.updateOn = ha(this.$options.updateOn.replace(ki, function() {
            ...
            terminal: !0,
            priority: 1e3
        }), bi = [ "$locale", "$interpolate", function(e, t) {
            ...
            return {
                ...
                link: function(r, s, o) {
                    ...
                    var l, d = o.count, c = o.$attr.when && s.attr(o.$attr.when), m = o.offset || 0, _ = r.$eval(c) || {}, h = {}, f = t.startSymbol(), p = t.endSymbol(), g = f + d + "-" + m + p, M = da.noop;
                    i(o, function(e, t) {
                        var n = a.exec(t);
                        if (n) {
                            var r = (n[1] ? "-" : "") + Kn(n[2]);
                        ...
                        a || n in _ || (n = e.pluralCat(n - m)), n === l || a && isNaN(l) || (M(), M = r.$watch(h[n], u), 
                        l = n);
                    });
                }
            };
            ...
            return {
                ...
                compile: function(a, m) {
                    var _ = m.ngRepeat, h = t.createComment(" end ngRepeat: " + _ + " "), f = _.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);
                    if (!f) throw u("iexp", "Expected expression in form of '_item_ in _collection_[ track by _id_]' but got '{0}'.", _);
                    var p = f[1], g = f[2], M = f[3], y = f[4];
                    if (f = p.match(/^(?:(\s*[\$\w]+)|\(\s*([\$\w]+)\s*,\s*([\$\w]+)\s*\))$/), !f) throw u("iidexp", "'_item_' in '_item_ in _collection_' should be an identifier or '(_key_, _value_)' expression, but got '{0}'.", p);
                    var v = f[3] || f[1], L = f[2];
                    ...
                    return y ? Y = e(y) : (k = function(e, t) {
                        return Ne(t);
                    }, w = function(e) {
                        return e;
                    }), function(e, t, a, m, f) {
                        Y && ($ = function(t, n, a) {
                            return L && (D[L] = t), D[v] = n, D.$index = a, Y(e, D);
                        });
                        var p = le();
                        e.$watchCollection(g, function(a) {
                            var m, g, y, Y, D, b, T, S, x, H, j, O, E = t[0], C = le();
                            if (M && (e[M] = a), r(a)) x = a, S = $ || k; else {
                                S = $ || w, x = [];
                                for (var A in a) a.hasOwnProperty(A) && "$" != A.charAt(0) && x.push(A);
                                x.sort();
                            }
                            for (Y = x.length, j = new Array(Y), m = 0; m < Y; m++) if (D = a === x ? m : x[m], 
                            b = a[D], T = S(D, b, m), p[T]) H = p[T], delete p[T], C[T] = H, j[m] = H; else {
                                if (C[T]) throw i(j, function(e) {
                                    e && e.scope && (p[e.id] = e);
                                }), u("dupes", "Duplicates in a repeater are not allowed. Use 'track by' expression to specify unique keys. Repeater: {0}, Duplicate key: {1}, Duplicate value: {2}", _, T, b);
                                j[m] = {
                                    id: T,
                                    scope: n,
                                    clone: n
                            ...
                            for (var P in p) {
                                if (H = p[P], O = ue(H.clone), s.leave(O), O[0].parentNode) for (m = 0, g = O.length; m < g; m++) O[m][o] = !0;
                                H.scope.$destroy();
                            }
                            for (m = 0; m < Y; m++) if (D = a === x ? m : x[m], b = a[D], H = j[m], H.scope) {
                                y = E;
                                do y = y.nextSibling; while (y && y[o]);
                                d(H) != y && s.move(ue(H.clone), null, na(E)), E = c(H), l(H.scope, m, v, b, L, D, Y);
                            } else f(function(e, t) {
                                H.scope = t;
                                var n = h.cloneNode(!1);
                                e[e.length++] = n, s.enter(e, null, na(E)), E = n, H.clone = e, C[H.id] = H, l(H.scope, m, v, b, L, D, Y);
                            });
                            p = C;
                        });
                    };
            ...
            return {
                ...
                link: function(n, a, r, s) {
                    var o = r.ngSwitch || r.on, u = [], l = [], d = [], c = [], m = function(e, t) {
                        return function() {
                            e.splice(t, 1);
                        };
                    };
                    n.$watch(o, function(n) {
                        var a, r;
                        for (a = 0, r = d.length; a < r; ++a) e.cancel(d[a]);
                        for (d.length = 0, a = 0, r = c.length; a < r; ++a) {
                            var o = ue(l[a].clone);
                            c[a].$destroy();
                            var _ = d[a] = e.leave(o);
                            _.then(m(d, a));
                        }
                        l.length = 0, c.length = 0, (u = s.cases["!" + n] || s.cases["?"]) && i(u, function(n) {
            ...
            link: function(e, t, n, r, i) {
                if (!i) throw a("ngTransclude")("orphan", "Illegal use of ngTransclude directive in the template! No parent directive that requires a transclusion found. Element: {0}", V(t));
                i(function(e) {
                    t.empty(), t.append(e);
                });
            }
            ...
            return {
                ...
                link: function(o, u, l, d) {
                    function c(e, t, n, a) {
                        n.$render = function() {
                            var e = n.$viewValue;
                            a.hasOption(e) ? (k.parent() && k.remove(), t.val(e), "" === e && h.prop("selected", !0)) : null == e && h ? t.val("") : a.renderUnknownOption(e);
                    ...
                    function m(e, t, n) {
                        ...
                        n.$render = function() {
                            ...
                            F(a, n.$viewValue) || (a = P(n.$viewValue), n.$render());
                        }), t.on("change", function() {
                            e.$apply(function() {
                                var e = [];
                                i(t.find("option"), function(t) {
                    ...
                    function _(t, o, u) {
                        function l(e, n, a) {
                            return F[b] = a, x && (F[x] = n), e(t, F);
                        }
                        function d() {
                            t.$apply(function() {
                                var e, n = O(t) || [];
                                if (g) e = [], i(o.val(), function(t) {
                                    t = C ? A[t] : t, e.push(c(t, n[t]));
                                }); else {
                                    var a = C ? A[o.val()] : o.val();
                                    e = c(a, n[a]);
                                }
                                u.$setViewValue(e), k();
                            });
                        ...
                        function _(e) {
                            ...
                            if (g) if (C && _a(e)) {
                                t = new Re([]);
                                for (var n = 0; n < e.length; n++) t.put(l(C, null, e[n]), !0);
                            } else t = new Re(e); else C && (e = l(C, null, e));
                            return function(n, a) {
                                var r;
                                return r = C ? C : S ? S : j, g ? M(t.remove(l(r, n, a))) : e === l(r, n, a);
                            };
                        }
                        function h() {
                            L || (t.$$postDigest(k), L = !0);
                        }
                        function p(e, t, n) {
                            e[t] = e[t] || 0, e[t] += n ? 1 : -1;
                        }
                        function k() {
                            L = !1;
                            var e, n, a, r, d, c, m, h, y, k, w, b, T, S, j, E, W, N = {
                                "": []
                            }, R = [ "" ], I = u.$viewValue, U = O(t) || [], z = x ? s(U) : U, V = {}, q = _(I), J = !1;
                            for (A = {}, b = 0; k = z.length, b < k; b++) m = b, x && (m = z[b], "$" === m.charAt(0)) || (h = U[m], 
                            e = l(H, m, h) || "", (n = N[e]) || (n = N[e] = [], R.push(e)), T = q(m, h), J = J || T, 
                            E = l(D, m, h), E = M(E) ? E : "", W = C ? C(t, F) : x ? z[b] : b, C && (A[W] = m), 
                            n.push({
                                id: W,
                                label: E,
                                selected: T
                            }));
                            for (g || (v || null === I ? N[""].unshift({
                                id: "",
                                label: "",
                                selected: !J
                            }) : J || N[""].unshift({
                                ...
                                for (e = R[w], n = N[e], P.length <= w ? (r = {
                                    element: $.clone().attr("label", e),
                                    label: n.label
                                }, d = [ r ], P.push(d), o.append(r.element)) : (d = P[w], r = d[0], r.label != e && r.element.attr("label", r.label = e)), 
                                S = null, b = 0, k = n.length; b < k; b++) a = n[b], (c = d[b + 1]) ? (S = c.element, 
                                c.label !== a.label && (p(V, c.label, !1), p(V, a.label, !0), S.text(c.label = a.label), 
                                S.prop("label", c.label)), c.id !== a.id && S.val(c.id = a.id), S[0].selected !== a.selected && (S.prop("selected", c.selected = a.selected), 
                                ta && S.prop("selected", c.selected))) : ("" === a.id && v ? j = v : (j = Y.clone()).val(a.id).prop("selected", a.selected).attr("selected", a.selected).prop("label", a.label).text(a.label), 
                                d.push(c = {
                                    element: j,
                                    label: a.label,
                                    id: a.id,
                                    selected: a.selected
                                }), p(V, a.label, !0), S ? S.after(j) : r.element.append(j), S = j);
                                for (b++; d.length > b; ) a = d.pop(), p(V, a.label, !1), a.element.remove();
                            }
                            for (;P.length > w; ) {
                                for (n = P.pop(), b = 1; b < n.length; ++b) p(V, n[b].label, !1);
                                n[0].element.remove();
                            }
                            i(V, function(e, t) {
                                e > 0 ? f.addOption(t) : e < 0 && f.removeOption(t);
                            });
                        }
                        var w;
                        if (!(w = y.match(r))) throw Wi("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", y, V(o));
                        var D = a(w[2] || w[1]), b = w[4] || w[6], T = / as /.test(w[0]) && w[1], S = T ? a(T) : null, x = w[5], H = a(w[3] || ""), j = a(w[2] ? w[1] : b), O = a(w[7]), E = w[8], C = E ? a(w[8]) : null, A = {}, P = [ [ {
                            element: o,
                            label: ""
                        } ] ], F = {};
                        v && (e(v)(t), v.removeClass("ng-scope"), v.remove()), o.empty(), o.on("change", d), 
                        u.$render = k, t.$watchCollection(O, h), t.$watchCollection(m, h), g && t.$watchCollection(function() {
                            return u.$modelValue;
                        }, h);
                    }
                    if (d[1]) {
                        for (var h, f = d[0], p = d[1], g = l.multiple, y = l.ngOptions, v = !1, L = !1, Y = na(t.createElement("option")), $ = na(t.createElement("optgroup")), k = Y.clone(), w = 0, D = u.children(), b = D.length; w < b; w++) if ("" === D[w].value) {
                            h = v = D.eq(w);
                            break;
                        }
                        f.init(p, v, k), g && (p.$isEmpty = function(e) {
                            return !e || 0 === e.length;
                        }), y ? _(o, u, p) : g ? m(o, u, p) : c(o, u, p, f);
                    }
                }
            };
                ...
                link: function(e, t, r, i) {
                    if (i) {
                        ...
                        r.$observe("pattern", function(e) {
                            if (v(e) && e.length > 0 && (e = new RegExp("^" + e + "$")), e && !e.test) throw a("ngPattern")("noregexp", "Expected {0} to be a RegExp but was {1}. Element: {2}", o, e, V(t));
                            s = e || n, i.$validate();
                        }), i.$validators.pattern = function(e, t) {
                            return i.$isEmpty(t) || g(s) || s.test(t);
                        };
                    }
                }
            };
        ...
        _e(da), void na(t).ready(function() {
            Q(t, X);
        }));
    ...
    !function() {
        ...
        function a(n, a, i, s, o) {
            function u(e) {
                if (!$) return v = e, Y ? void o.cancel() : void (null === v ? (f(), y()) : v === !0 ? (f(), 
                M(), o.result(!0, L)) : v === !1 ? (M(), d(L), o.result(!1, L)) : console.warn("invalid dialog state", v));
            }
            function l() {
                o = null, s = null, f(), M();
            }
            function d(e) {
                f(), r.isArray(e) || (e = [ e ]), e.forEach(function(e) {
                    var a = null;
                    e.target && (a = t(n, e.target)), a && a[0] ? m(a, e) : c(e);
                });
            }
            function c(e) {
            ...
            function m(e, t) {
                ...
                var a = e.parent();
                a.addClass("has-error"), e.after(n), a.on("keypress change", _);
            }
            function _(e) {
                for (var t = e.target; t !== this; ) h(r.element(t)), t = t.parentNode;
            }
            function h(t) {
                var n = t.parent();
                e(n, ".dialog-error").remove(), n.removeClass("has-error"), n.off("keypress change", _);
            }
            function f() {
            ...
            function p(e) {
                return s.cancel && s.cancel(), Y = !0, e.stopPropagation(), e.preventDefault(), 
                !1;
            }
            function g(e) {
                var t = e.message || e;
            ...
            function y() {
                ...
                M(), t(n, a).prepend(w), r.forEach(e(n, ".form-control"), i), r.forEach(e(n, ".form-checkbox"), i), 
                r.forEach(e(n, ".btn"), i), t(n, ".btn-cancel").on("click", p);
            }
            var v = null, L = null, Y = !1, $ = !1, k = [], w = r.element("<div class='dialog-wait-ct pull-left'>");
            ...
            return w.append(D), this.detach = l, s ? (s.then(function(e) {
                ...
                s && o && null === v && (u(null), o.$digest());
            }, 0)) : void l();
        }
        var r = n(129);
        n(131), r.module("ui.cockpit", [ "ui.bootstrap" ]).directive("modalDialog", [ "$q", function(e) {
            return {
                restrict: "E",
                transclude: !0,
    ...
    angular.module("ui.bootstrap.collapse", []).directive("collapse", [ "$animate", function(e) {
            ...
            link: function(t, n, a, r) {
                ...
                n.find("input").css({
                    ...
                    a.disabled || t.$apply(function() {
                        l.$setViewValue(n.hasClass(u.activeClass) ? s() : i()), l.$render();
                    });
        ...
        function r(t, n, r) {
            g || (angular.extend(t, {
                ...
                direction: r,
                active: !1
            }), a.enabled() && !e.noTransition && !e.$currentTransition && t.$element && c.slides.length > 1 && (t.$element.data(f, t.direction), 
            c.currentSlide && c.currentSlide.$element && c.currentSlide.$element.data(f, t.direction), 
            e.$currentTransition = !0, _ ? a.on("addClass", t.$element, function(t, n) {
                "close" === n && (e.$currentTransition = null, a.off("addClass", t));
            }) : t.$element.one("$animate:close", function() {
                e.$currentTransition = null;
            })), c.currentSlide = t, p = n, s());
        }
        function i(e) {
        ...
        var l, d, c = this, m = c.slides = e.slides = [], _ = angular.version.minor >= 4, h = "uib-noTransition", f = "uib-slideDirection", p = -1;
        c.currentSlide = null;
        var g = !1;
        c.select = e.select = function(t, n) {
            var a = e.indexOfSlide(t);
            void 0 === n && (n = a > c.getCurrentIndex() ? "next" : "prev"), t && t !== c.currentSlide && !e.$currentTransition && r(t, a, n);
        }, e.$on("$destroy", function() {
            g = !0;
            ...
            var t = (c.getCurrentIndex() + 1) % m.length;
            return 0 === t && e.noWrap() ? void e.pause() : c.select(i(t), "next");
        }, e.prev = function() {
            var t = c.getCurrentIndex() - 1 < 0 ? m.length - 1 : c.getCurrentIndex() - 1;
            return e.noWrap() && t === m.length - 1 ? void e.pause() : c.select(i(t), "prev");
            ...
            t.$element = n, m.push(t), 1 === m.length || t.active ? (c.select(m[m.length - 1]), 
            ...
            var t = m.indexOf(e);
            m.splice(t, 1), m.length > 0 && e.active ? t >= m.length ? c.select(m[t - 1]) : c.select(m[t]) : p > t && p--, 
            0 === m.length && (c.currentSlide = null);
        ...
        return e.has("$animateCss") && (i = e.get("$animateCss")), {
            beforeAddClass: function(e, s, o) {
                if ("active" == s && e.parent() && !e.parent().data(a)) {
                    var u = !1, l = e.data(r), d = "next" == l ? "left" : "right", c = n.bind(this, e, d + " " + l, o);
                    return e.addClass(l), i ? i(e, {
                        addClass: d
                    }).start().done(c) : t.addClass(e, d).then(function() {
                        u || c(), o();
                    }), function() {
                        u = !0;
                    };
            ...
            beforeRemoveClass: function(e, s, o) {
                if ("active" === s && e.parent() && !e.parent().data(a)) {
                    var u = !1, l = e.data(r), d = "next" == l ? "left" : "right", c = n.bind(this, e, d, o);
                    return i ? i(e, {
                        addClass: d
                    }).start().done(c) : t.addClass(e, d).then(function() {
                        u || c(), o();
        ...
        this.parse = function(n, s, o) {
            ...
            var u = this.parsers[s], l = u.regex, d = u.map, c = n.match(l);
            if (c && c.length) {
                var m, _;
                ...
                for (var h = 1, f = c.length; h < f; h++) {
                    var p = d[h - 1];
                    p.apply && p.apply.call(m, c[h]);
                }
                return r(m.year, m.month, m.date) && (_ = new Date(m.year, m.month, m.date, m.hours, m.minutes, m.seconds, m.milliseconds || 0)), 
                _;
            }
        };
        ...
        return {
            ...
            positionElements: function(e, t, n, a) {
                var r, i, s, o, u = n.split("-"), l = u[0], d = u[1] || "center";
        ...
        this.modes = [ "day", "month", "year" ], angular.forEach([ "formatDay", "formatMonth", "formatYear", "formatDayHeader", "formatDayTitle", "formatMonthTitle", "showWeeks", "startingDay", "yearRange", "shortcutPropagation" ], function(n, r) {
            u[n] = angular.isDefined(t[n]) ? r < 6 ? a(t[n])(e.$parent) : e.$parent.$eval(t[n]) : s[n];
            ...
            t[a] ? e.$parent.$watch(n(t[a]), function(n) {
                u[a] = angular.isDefined(n) ? n : t[a], e[a] = u[a], ("minMode" == a && u.modes.indexOf(e.datepickerMode) < u.modes.indexOf(u[a]) || "maxMode" == a && u.modes.indexOf(e.datepickerMode) > u.modes.indexOf(u[a])) && (e.datepickerMode = u[a]);
            }) : (u[a] = s[a] || null, e[a] = u[a]);
        ...
        e.$on("datepicker.focus", d), e.keydown = function(t) {
        ...
        return {
            ...
            link: function(t, n, a, r) {
                ...
                r._refreshView = function() {
                    var n = r.activeDate.getFullYear(), a = r.activeDate.getMonth(), i = new Date(n, a, 1), u = r.startingDay - i.getDay(), l = u > 0 ? 7 - u : -u, d = new Date(i);
                    l > 0 && d.setDate(-l + 1);
                    for (var c = s(d, 42), m = 0; m < 42; m++) c[m] = angular.extend(r.createDateObject(c[m], r.formatDay), {
                        secondary: c[m].getMonth() !== a,
                        uid: t.uniqueId + "-" + m
                    });
                    t.labels = new Array(7);
                    for (var _ = 0; _ < 7; _++) t.labels[_] = {
                        abbr: e(c[_].date, r.formatDayHeader),
                        full: e(c[_].date, "EEEE")
                    };
                    if (t.title = e(r.activeDate, r.formatDayTitle), t.rows = r.split(c, 7), t.showWeeks) {
                        t.weekNumbers = [];
                        for (var h = (11 - r.startingDay) % 7, f = t.rows.length, p = 0; p < f; p++) t.weekNumbers.push(o(t.rows[p][h].date));
                    }
        ...
        showButtonBar: !0,
        onOpenFocus: !0
    }).directive("datepickerPopup", [ "$compile", "$parse", "$document", "$rootScope", "$position", "dateFilter", "dateParser", "datepickerPopupConfig", "$timeout", function(e, t, n, a, r, i, s, o, u) {
        return {
            restrict: "EA",
            require: "ngModel",
            scope: {
            ...
            link: function(l, d, c, m) {
                ...
                var p, g = angular.isDefined(c.closeOnDateSelection) ? l.$parent.$eval(c.closeOnDateSelection) : o.closeOnDateSelection, M = angular.isDefined(c.datepickerAppendToBody) ? l.$parent.$eval(c.datepickerAppendToBody) : o.appendToBody, y = angular.isDefined(c.onOpenFocus) ? l.$parent.$eval(c.onOpenFocus) : o.onOpenFocus, v = angular.isDefined(c.datepickerPopupTemplateUrl) ? c.datepickerPopupTemplateUrl : o.datepickerPopupTemplateUrl, L = angular.isDefined(c.datepickerTemplateUrl) ? c.datepickerTemplateUrl : o.datepickerTemplateUrl, Y = {};
                l.showButtonBar = angular.isDefined(c.showButtonBar) ? l.$parent.$eval(c.showButtonBar) : o.showButtonBar, 
                l.getText = function(e) {
                    return l[e + "Text"] || o[e + "Text"];
                }, l.isDisabled = function(e) {
                    return "today" === e && (e = new Date()), l.watchData.minDate && l.compare(e, Y.minDate) < 0 || l.watchData.maxDate && l.compare(e, Y.maxDate) > 0;
                }, l.compare = function(e, t) {
                    return new Date(e.getFullYear(), e.getMonth(), e.getDate()) - new Date(t.getFullYear(), t.getMonth(), t.getDate());
                };
                var $ = !1;
                if (o.html5Types[c.type] ? (p = o.html5Types[c.type], $ = !0) : (p = c.datepickerPopup || o.datepickerPopup, 
                c.$observe("datepickerPopup", function(e, t) {
                    var n = e || o.datepickerPopup;
                    if (n !== p && (p = n, m.$modelValue = null, !p)) throw new Error("datepickerPopup must have a date format specified.");
                })), !p) throw new Error("datepickerPopup must have a date format specified.");
                if ($ && c.datepickerPopup) throw new Error("HTML5 date input types do not support custom formats.");
                ...
                var w = angular.element(k.children()[0]);
                if (w.attr("template-url", L), $ && "month" === c.type && (w.attr("datepicker-mode", '"month"'), 
                w.attr("min-mode", "month")), c.datepickerOptions) {
                    var D = l.$parent.$eval(c.datepickerOptions);
                    D && D.initDate && (l.initDate = D.initDate, w.attr("init-date", "initDate"), delete D.initDate), 
                ...
                l.watchData = {}, angular.forEach([ "minMode", "maxMode", "minDate", "maxDate", "datepickerMode", "initDate", "shortcutPropagation" ], function(e) {
                    if (c[e]) {
                        ...
                        if (l.$parent.$watch(n, function(t) {
                            l.watchData[e] = t, "minDate" !== e && "maxDate" !== e || (Y[e] = new Date(t));
                        }), w.attr(_(e), "watchData." + e), "datepickerMode" === e) {
                            var a = n.assign;
                            l.$watch("watchData." + e, function(e, t) {
                                angular.isFunction(a) && e !== t && a(l.$parent, e);
                            });
                        }
                    }
                }), c.dateDisabled && w.attr("date-disabled", "dateDisabled({ date: date, mode: mode })"), 
                c.showWeeks && w.attr("show-weeks", c.showWeeks), c.customClass && w.attr("custom-class", "customClass({ date: date, mode: mode })"), 
                $ ? m.$formatters.push(function(e) {
                    return l.date = e, e;
                }) : (m.$$parserName = "date", m.$validators.date = f, m.$parsers.unshift(h), m.$formatters.push(function(e) {
                    return l.date = e, m.$isEmpty(e) ? e : i(e, p);
                })), l.dateSelection = function(e) {
                    angular.isDefined(e) && (l.date = e);
                    var t = l.date ? i(l.date, p) : null;
                    d.val(t), m.$setViewValue(t), g && (l.isOpen = !1, d[0].focus());
                }, m.$viewChangeListeners.push(function() {
                    l.date = s.parse(m.$viewValue, p, l.date);
                });
                var b = function(e) {
                    !l.isOpen || d[0].contains(e.target) || k[0].contains(e.target) || l.$apply(function() {
                        l.isOpen = !1;
                    });
                }, T = function(e) {
                    27 === e.which && l.isOpen ? (e.preventDefault(), e.stopPropagation(), l.$apply(function() {
                        l.isOpen = !1;
                    }), d[0].focus()) : 40 !== e.which || l.isOpen || (e.preventDefault(), e.stopPropagation(), 
                    l.$apply(function() {
                        l.isOpen = !0;
                    }));
                };
                d.bind("keydown", T), l.keydown = function(e) {
                    27 === e.which && (l.isOpen = !1, d[0].focus());
                }, l.$watch("isOpen", function(e) {
                    e ? (l.position = M ? r.offset(d) : r.position(d), l.position.top = l.position.top + d.prop("offsetHeight"), 
                    u(function() {
                        y && l.$broadcast("datepicker.focus"), n.bind("click", b);
                    }, 0, !1)) : n.unbind("click", b);
                }), l.select = function(e) {
                    if ("today" === e) {
                        var t = new Date();
                ...
                var S = e(k)(l);
                k.remove(), M ? n.find("body").append(S) : d.after(S), l.$on("$destroy", function() {
                    l.isOpen === !0 && (a.$$phase || l.$apply(function() {
                        l.isOpen = !1;
                    })), S.remove(), d.unbind("keydown", T), n.unbind("click", b);
                });
            }
        };
    ...
    } ]).controller("DropdownController", [ "$scope", "$attrs", "$parse", "dropdownConfig", "dropdownService", "$animate", "$position", "$document", "$compile", "$templateRequest", function(e, t, n, a, r, i, s, o, u, l) {
        var d, c, m = this, _ = e.$new(), h = a.openClass, f = angular.noop, p = t.onToggle ? n(t.onToggle) : angular.noop, g = !1, M = !1, y = o.find("body");
        this.init = function(a) {
            m.$element = a, t.isOpen && (c = n(t.isOpen), f = c.assign, e.$watch(c, function(e) {
                _.isOpen = !!e;
            })), g = angular.isDefined(t.dropdownAppendToBody), M = angular.isDefined(t.keyboardNav), 
            g && m.dropdownMenu && (y.append(m.dropdownMenu), y.addClass("dropdown"), a.on("$destroy", function() {
                m.dropdownMenu.remove();
            }));
        }, this.toggle = function(e) {
            return _.isOpen = arguments.length ? !!e : !_.isOpen;
        }, this.isOpen = function() {
            return _.isOpen;
        }, _.getToggleElement = function() {
            return m.toggleElement;
        }, _.getAutoClose = function() {
            return t.autoClose || "always";
        }, _.getElement = function() {
            return m.$element;
        }, _.isKeynavEnabled = function() {
            return M;
        }, _.focusDropdownEntry = function(e) {
        ...
        }, _.getDropdownElement = function() {
            return m.dropdownMenu;
        }, _.focusToggleElement = function() {
            m.toggleElement && m.toggleElement[0].focus();
        }, _.$watch("isOpen", function(t, n) {
            if (g && m.dropdownMenu) {
                var a = s.positionElements(m.$element, m.dropdownMenu, "bottom-left", !0), o = {
                    top: a.top + "px",
                    display: t ? "block" : "none"
                }, c = m.dropdownMenu.hasClass("dropdown-menu-right");
                c ? (o.left = "auto", o.right = window.innerWidth - (a.left + m.$element.prop("offsetWidth")) + "px") : (o.left = a.left + "px", 
                o.right = "auto"), m.dropdownMenu.css(o);
            }
            var M = g ? y : m.$element;
            if (i[t ? "addClass" : "removeClass"](M, h).then(function() {
                angular.isDefined(t) && t !== n && p(e, {
                    open: !!t
                });
            }), t) m.dropdownMenuTemplateUrl && l(m.dropdownMenuTemplateUrl).then(function(e) {
                d = _.$new(), u(e.trim())(d, function(e) {
                    var t = e;
                    m.dropdownMenu.replaceWith(t), m.dropdownMenu = t;
                });
            }), _.focusToggleElement(), r.open(_); else {
                if (m.dropdownMenuTemplateUrl) {
                    d && d.$destroy();
                    var v = angular.element('<ul class="dropdown-menu"></ul>');
                    m.dropdownMenu.replaceWith(v), m.dropdownMenu = v;
                }
                r.close(_), m.selectedOption = null;
            }
            angular.isFunction(f) && f(e, t);
        }), e.$on("$locationChangeSuccess", function() {
            "disabled" !== _.getAutoClose() && (_.isOpen = !1);
        });
        var v = e.$on("$destroy", function() {
            _.$destroy();
        });
        _.$on("$destroy", v);
    ...
    }).factory("$modalStack", [ "$animate", "$timeout", "$document", "$compile", "$rootScope", "$q", "$injector", "$$multiMap", "$$stackedMap", function(e, t, n, a, r, i, s, o, u) {
        function l() {
        ...
        function d(e, t) {
            ...
            y.remove(e), m(r.modalDomEl, r.modalScope, function() {
                var t = r.openedClass || M;
                v.remove(t, e), a.toggleClass(t, v.hasKey(t));
            }), c(), t && t.focus ? t.focus() : a.focus();
        }
        function c() {
            if (f && l() == -1) {
                var e = p;
        ...
        function m(t, n, a) {
            function r() {
                r.done || (r.done = !0, h ? h(t, {
                    event: "leave"
                }).start().then(function() {
                    t.remove();
                }) : e.leave(t), n.$destroy(), a && a());
            }
            var s, o = null, u = function() {
                return s || (s = i.defer(), o = s.promise), function() {
                    s.resolve();
                };
            };
            return n.$broadcast(L.NOW_CLOSING_EVENT, u), i.when(o).then(r);
        }
        function _(e, t, n) {
            return !e.value.modalScope.$broadcast("modal.closing", t, n).defaultPrevented;
        }
        var h = null;
        s.has("$animateCss") && (h = s.get("$animateCss"));
        var f, p, g, M = "modal-open", y = u.createNew(), v = o.createNew(), L = {
            NOW_CLOSING_EVENT: "modal.stack.now-closing"
        }, Y = 0, $ = "a[href], area[href], input:not([disabled]), button:not([disabled]),select:not([disabled]), textarea:not([disabled]), iframe, object, embed, *[tabindex], *[contenteditable=true]";
        return r.$watch(l, function(e) {
            p && (p.index = e);
            ...
            if (t && t.value.keyboard) switch (e.which) {
              case 27:
                e.preventDefault(), r.$apply(function() {
                    L.dismiss(t.key, "escape key press");
                });
                break;

              case 9:
                L.loadFocusElementList(t);
                var n = !1;
                e.shiftKey ? L.isFocusInFirstItem(e) && (n = L.focusLastFocusableElement()) : L.isFocusInLastItem(e) && (n = L.focusFirstFocusableElement()), 
                n && (e.preventDefault(), e.stopPropagation());
            }
        }), L.open = function(e, t) {
            var i = n[0].activeElement, s = t.openedClass || M;
            y.add(e, {
                deferred: t.deferred,
            ...
            var o = n.find("body").eq(0), u = l();
            if (u >= 0 && !f) {
                p = r.$new(!0), p.index = u;
                var d = angular.element('<div modal-backdrop="modal-backdrop"></div>');
                d.attr("backdrop-class", t.backdropClass), t.animation && d.attr("modal-animation", "true"), 
                f = a(d)(p), o.append(f);
            }
            ...
            L.clearFocusListCache();
        }, L.close = function(e, t) {
            var n = y.get(e);
            return n && _(n, t, !0) ? (n.value.modalScope.$$uibDestructionScheduled = !0, n.value.deferred.resolve(t), 
            d(e, n.value.modalOpener), !0) : !n;
        }, L.dismiss = function(e, t) {
            var n = y.get(e);
            return n && _(n, t, !1) ? (n.value.modalScope.$$uibDestructionScheduled = !0, n.value.deferred.reject(t), 
            d(e, n.value.modalOpener), !0) : !n;
        }, L.dismissAll = function(e) {
            for (var t = this.getTop(); t && this.dismiss(t.key, e); ) t = this.getTop();
        }, L.getTop = function() {
            return y.top();
        }, L.modalRendered = function(e) {
            var t = y.get(e);
            t && t.value.renderDeferred.resolve();
        }, L.focusFirstFocusableElement = function() {
            return g.length > 0 && (g[0].focus(), !0);
        }, L.focusLastFocusableElement = function() {
            return g.length > 0 && (g[g.length - 1].focus(), !0);
        }, L.isFocusInFirstItem = function(e) {
            return g.length > 0 && (e.target || e.srcElement) == g[0];
        }, L.isFocusInLastItem = function(e) {
            return g.length > 0 && (e.target || e.srcElement) == g[g.length - 1];
        }, L.clearFocusListCache = function() {
            g = [], Y = 0;
        }, L.loadFocusElementList = function(e) {
            if ((void 0 === g || !g.length0) && e) {
                var t = e.value.modalDomEl;
                t && t.length && (g = t[0].querySelectorAll($));
            }
        }, L;
        ...
        var e = {
            ...
            $get: [ "$injector", "$rootScope", "$q", "$templateRequest", "$controller", "$modalStack", function(t, n, a, r, i, s) {
                ...
                return l.getPromiseChain = function() {
                    ...
                    var r = a.defer(), l = a.defer(), c = a.defer(), m = {
                        result: r.promise,
                        opened: l.promise,
                        rendered: c.promise,
                        close: function(e) {
                    ...
                    var _, h = a.all([ o(t) ].concat(u(t.resolve)));
                    return _ = d = a.all([ d ]).then(function() {
                        return h;
                    }, function() {
                        return h;
                    }).then(function(e) {
                        ...
                        var o, u = {}, d = 1;
                        t.controller && (u.$scope = a, u.$modalInstance = m, angular.forEach(t.resolve, function(t, n) {
                            u[n] = e[d++];
                        }), o = i(t.controller, u), t.controllerAs && (t.bindToController && angular.extend(o, a), 
        ...
        return {
            ...
            link: function(n, a, r, i) {
                ...
                function o(e, t) {
                    var n = [], a = 1, r = t, i = angular.isDefined(d) && d < t;
                    i && (c ? (a = Math.max(e - Math.floor(d / 2), 1), r = a + d - 1, r > t && (r = t, 
                    a = r - d + 1)) : (a = (Math.ceil(e / d) - 1) * d + 1, r = Math.min(a + d - 1, t)));
                    for (var o = a; o <= r; o++) {
                        var u = s(o, o, o === e);
                        n.push(u);
                    }
                ...
                var u = i[0], l = i[1];
                if (l) {
                    var d = angular.isDefined(r.maxSize) ? n.$parent.$eval(r.maxSize) : t.maxSize, c = angular.isDefined(r.rotate) ? n.$parent.$eval(r.rotate) : t.rotate;
        ...
        this.options = function(e) {
            ...
            angular.extend(n, e);
        }, this.$get = [ "$window", "$compile", "$timeout", "$document", "$position", "$interpolate", "$rootScope", "$parse", function(r, i, s, o, u, l, d, c) {
            return function(r, m, _, h) {
                function f(e) {
                    var t = (e || h.trigger || _).split(" "), a = t.map(function(e) {
                        return n[e] || e;
                    });
                    return {
                        show: t,
                ...
                h = angular.extend({}, t, a, h);
                var p = e(r), g = l.startSymbol(), M = l.endSymbol(), y = "<div " + p + '-popup title="' + g + "title" + M + '" ' + (h.useContentExp ? 'content-exp="contentExp()" ' : 'content="' + g + "content" + M + '" ') + 'placement="' + g + "placement" + M + '" popup-class="' + g + "popupClass" + M + '" animation="animation" is-open="isOpen"origin-scope="origScope" ></div>';
                return {
                    restrict: "EA",
                    compile: function(e, t) {
                        var n = i(y);
                        return function(e, t, a, i) {
                            ...
                            function _() {
                                O && !e.$eval(a[m + "Enable"]) || (L(), E.popupDelay ? S || (S = s(g, E.popupDelay, !1)) : g());
                            }
                            function p() {
                                M(), d.$$phase || d.$digest();
                            }
                            function g() {
                                return S = null, T && (s.cancel(T), T = null), (h.useContentExp ? E.contentExp() : E.content) ? (y(), 
                                E.isOpen = !0, A && A.assign(E.origScope, E.isOpen), d.$$phase || E.$apply(), D.css({
                                    display: "block"
                                }), void P()) : angular.noop;
                            }
                            function M() {
                                E.isOpen = !1, A && A.assign(E.origScope, E.isOpen), s.cancel(S), S = null, s.cancel(x), 
                                x = null, E.animation ? T || (T = s(v, 500)) : v();
                            }
                            function y() {
                                D && v(), b = E.$new(), D = n(b, function(e) {
                                    H ? o.find("body").append(e) : t.after(e);
                                }), h.useContentExp && (b.$watch("contentExp()", function(e) {
                                    !e && E.isOpen && M();
                                }), b.$watch(function() {
                                    C || (C = !0, b.$$postDigest(function() {
                                        C = !1, E.isOpen && P();
                                    }));
                                }));
                            }
                            function v() {
                                T = null, D && (D.remove(), D = null), b && (b.$destroy(), b = null);
                            }
                            function L() {
                                Y(), $(), k();
                            }
                            function Y() {
                                E.popupClass = a[m + "Class"];
                            }
                            function $() {
                                var e = a[m + "Placement"];
                                E.placement = angular.isDefined(e) ? e : h.placement;
                            }
                            function k() {
                                var e = a[m + "PopupDelay"], t = parseInt(e, 10);
                                E.popupDelay = isNaN(t) ? h.popupDelay : t;
                            }
                            function w() {
                                var e = a[m + "Trigger"];
                                F(), j = f(e), "none" !== j.show && j.show.forEach(function(e, n) {
                                    e === j.hide[n] ? t[0].addEventListener(e, l) : e && (t[0].addEventListener(e, _), 
                                    t[0].addEventListener(j.hide[n], p));
                                });
                            }
                            var D, b, T, S, x, H = !!angular.isDefined(h.appendToBody) && h.appendToBody, j = f(void 0), O = angular.isDefined(a[m + "Enable"]), E = e.$new(!0), C = !1, A = !!angular.isDefined(a[m + "IsOpen"]) && c(a[m + "IsOpen"]), P = function() {
                                D && (x || (x = s(function() {
                                    D.css({
                                        top: 0,
                                        left: 0,
                                    ...
                                    var e = u.position(D), n = u.positionElements(t, D, E.placement, H);
                            ...
                            E.origScope = e, E.isOpen = !1, E.contentExp = function() {
                                return e.$eval(a[r]);
                            }, h.useContentExp || a.$observe(r, function(e) {
                                E.content = e, !e && E.isOpen ? M() : P();
                            }), a.$observe("disabled", function(e) {
                                S && e && (s.cancel(S), S = null), e && E.isOpen && M();
                            }), a.$observe(m + "Title", function(e) {
                                E.title = e, P();
                            }), a.$observe(m + "Placement", function() {
                                E.isOpen && ($(), P());
                            }), A && e.$watch(A, function(e) {
                                e !== E.isOpen && l();
                            });
                            var F = function() {
                                j.show.forEach(function(e) {
                                    t.unbind(e, _);
                                }), j.hide.forEach(function(e) {
                                    t.unbind(e, p);
                                });
                            };
                            w();
                            var W = e.$eval(a[m + "Animation"]);
                            E.animation = angular.isDefined(W) ? !!W : h.animation;
                            var N = e.$eval(a[m + "AppendToBody"]);
                            H = angular.isDefined(N) ? N : H, H && e.$on("$locationChangeSuccess", function() {
                                E.isOpen && M();
                            }), e.$on("$destroy", function() {
                                s.cancel(T), s.cancel(S), s.cancel(x), F(), v(), E = null;
                            });
                        };
                    }
                };
        ...
        return {
            link: function(r, i, s) {
                var o, u, l, d = r.$eval(s.tooltipTemplateTranscludeScope), c = 0, m = function() {
                ...
                r.$watch(t.parseAsResourceUrl(s.tooltipTemplateTransclude), function(t) {
                    ...
                    t ? (a(t, !0).then(function(a) {
                        if (s === c) {
                            var r = d.$new(), u = a, _ = n(u)(r, function(t) {
                                m(), e.enter(t, i);
                            });
                            o = r, l = _, o.$emit("$includeContentLoaded", t);
                        }
                    }, function() {
                        s === c && (m(), r.$emit("$includeContentError", t));
        ...
        function s() {
            ...
            if (n) return e.showMeridian && (12 === t && (t = 0), e.meridian === p[1] && (t += 12)), 
            t;
        }
        function o() {
        ...
        function l(e) {
            d(), f.$setViewValue(new Date(h)), c(e);
        }
        function d() {
            f.$setValidity("time", !0), e.invalidHours = !1, e.invalidMinutes = !1;
        }
        function c(t) {
            var n = h.getHours(), a = h.getMinutes();
            e.showMeridian && (n = 0 === n || 12 === n ? 12 : n % 12), e.hours = "h" === t ? n : u(n), 
            "m" !== t && (e.minutes = u(a)), e.meridian = h.getHours() < 12 ? p[0] : p[1];
        }
        function m(e, t) {
        ...
        var h = new Date(), f = {
            $setViewValue: angular.noop
        }, p = angular.isDefined(t.meridians) ? e.$parent.$eval(t.meridians) : i.meridians || r.DATETIME_FORMATS.AMPMS;
        ...
        e.$parent.$watch(n(t.max), function(e) {
            ...
            e.updateHours = function() {
                var e = s(), t = o();
                angular.isDefined(e) && angular.isDefined(t) ? (h.setHours(e), h < y || h > v ? a(!0) : l("h")) : a(!0);
                ...
                var e = o(), t = s();
                angular.isDefined(e) && angular.isDefined(t) ? (h.setMinutes(e), h < y || h > v ? a(void 0, !0) : l("m")) : a(void 0, !0);
            ...
            var t = f.$viewValue;
            isNaN(t) ? (f.$setValidity("time", !1), a.error('Timepicker directive: "ng-model" value must be a Date object, a number of milliseconds since 01.01.1970 or a string representing an RFC2822 or ISO 8601 date.')) : (t && (h = t), 
            h < y || h > v ? (f.$setValidity("time", !1), e.invalidHours = !0, e.invalidMinutes = !0) : d(), 
            c());
        }, e.showSpinners = angular.isDefined(t.showSpinners) ? e.$parent.$eval(t.showSpinners) : i.showSpinners, 
        e.incrementHours = function() {
            e.noIncrementHours() || _(60 * g);
        }, e.decrementHours = function() {
            e.noDecrementHours() || _(60 * -g);
        }, e.incrementMinutes = function() {
            e.noIncrementMinutes() || _(M);
        }, e.decrementMinutes = function() {
            e.noDecrementMinutes() || _(-M);
        }, e.toggleMeridian = function() {
            e.noToggleMeridian() || _(720 * (h.getHours() < 12 ? 1 : -1));
        };
    ...
    } ]).directive("typeahead", [ "$compile", "$parse", "$q", "$timeout", "$document", "$window", "$rootScope", "$position", "typeaheadParser", function(e, t, n, a, r, i, s, o, u) {
        var l = [ 9, 13, 27, 38, 40 ], d = 200;
        return {
            require: [ "ngModel", "^?ngModelOptions" ],
            link: function(c, m, _, h) {
                function f() {
                    A.moveInProgress || (A.moveInProgress = !0, A.$digest()), z && a.cancel(z), z = a(function() {
                        A.matches.length && p(), A.moveInProgress = !1, A.$digest();
                    }, d);
                }
                function p() {
                    A.position = S ? o.offset(m) : o.position(m), A.position.top += m.prop("offsetHeight");
                }
                var g = h[0], M = h[1], y = c.$eval(_.typeaheadMinLength);
                y || 0 === y || (y = 1);
                var v, L, Y = c.$eval(_.typeaheadWaitMs) || 0, $ = c.$eval(_.typeaheadEditable) !== !1, k = t(_.typeaheadLoading).assign || angular.noop, w = t(_.typeaheadOnSelect), D = !!angular.isDefined(_.typeaheadSelectOnBlur) && c.$eval(_.typeaheadSelectOnBlur), b = t(_.typeaheadNoResults).assign || angular.noop, T = _.typeaheadInputFormatter ? t(_.typeaheadInputFormatter) : void 0, S = !!_.typeaheadAppendToBody && c.$eval(_.typeaheadAppendToBody), x = c.$eval(_.typeaheadFocusFirst) !== !1, H = !!_.typeaheadSelectOnExact && c.$eval(_.typeaheadSelectOnExact), j = t(_.ngModel), O = t(_.ngModel + "($$$p)"), E = function(e, t) {
                    return angular.isFunction(j(c)) && M && M.$options && M.$options.getterSetter ? O(e, {
                        $$$p: t
                    }) : j.assign(e, t);
                }, C = u.parse(_.typeahead), A = c.$new(), P = c.$on("$destroy", function() {
                    A.$destroy();
                });
                A.$on("$destroy", P);
                var F = "typeahead-" + A.$id + "-" + Math.floor(1e4 * Math.random());
                m.attr({
                ...
                W.attr({
                    ...
                    query: "query",
                    position: "position"
                }), angular.isDefined(_.typeaheadTemplateUrl) && W.attr("template-url", _.typeaheadTemplateUrl), 
                angular.isDefined(_.typeaheadPopupTemplateUrl) && W.attr("popup-template-url", _.typeaheadPopupTemplateUrl);
                var N = function() {
                    A.matches = [], A.activeIdx = -1, m.attr("aria-expanded", !1);
                }, R = function(e) {
                    return F + "-option-" + e;
                };
                ...
                var I = function(e, t) {
                    return !!(A.matches.length > t && e) && e.toUpperCase() === A.matches[t].label.toUpperCase();
                }, U = function(e) {
                    var t = {
                        $viewValue: e
                    };
                    k(c, !0), b(c, !1), n.when(C.source(c, t)).then(function(n) {
                        var a = e === g.$viewValue;
                        if (a && v) if (n && n.length > 0) {
                            A.activeIdx = x ? 0 : -1, b(c, !1), A.matches.length = 0;
                            for (var r = 0; r < n.length; r++) t[C.itemName] = n[r], A.matches.push({
                                id: R(r),
                                label: C.viewMapper(A, t),
                                model: n[r]
                            });
                            A.query = e, p(), m.attr("aria-expanded", !0), H && 1 === A.matches.length && I(e, 0) && A.select(0);
                        } else N(), b(c, !0);
                        a && k(c, !1);
                    }, function() {
                        N(), k(c, !1), b(c, !0);
                ...
                S && (angular.element(i).bind("resize", f), r.find("body").bind("scroll", f));
                var z;
                A.moveInProgress = !1, N(), A.query = void 0;
                var V, q = function(e) {
                    V = a(function() {
                        U(e);
                    }, Y);
                ...
                g.$parsers.unshift(function(e) {
                    return v = !0, 0 === y || e && e.length >= y ? Y > 0 ? (J(), q(e)) : U(e) : (k(c, !1), 
                    J(), N()), $ ? e : e ? void g.$setValidity("editable", !1) : (g.$setValidity("editable", !0), 
                    null);
                }), g.$formatters.push(function(e) {
                    var t, n, a = {};
                    return $ || g.$setValidity("editable", !0), T ? (a.$model = e, T(c, a)) : (a[C.itemName] = e, 
                    t = C.viewMapper(c, a), a[C.itemName] = void 0, n = C.viewMapper(c, a), t !== n ? t : e);
                }), A.select = function(e) {
                    var t, n, r = {};
                    L = !0, r[C.itemName] = n = A.matches[e].model, t = C.modelMapper(c, r), E(c, t), 
                    g.$setValidity("editable", !0), g.$setValidity("parse", !0), w(c, {
                        $item: n,
                        $model: t,
                        $label: C.viewMapper(c, r)
                    }), N(), A.$eval(_.typeaheadFocusOnSelect) !== !1 && a(function() {
                        m[0].focus();
                    }, 0, !1);
                }, m.bind("keydown", function(e) {
                    if (0 !== A.matches.length && l.indexOf(e.which) !== -1) {
                        if (A.activeIdx === -1 && (9 === e.which || 13 === e.which)) return N(), void A.$digest();
                        e.preventDefault(), 40 === e.which ? (A.activeIdx = (A.activeIdx + 1) % A.matches.length, 
                        A.$digest()) : 38 === e.which ? (A.activeIdx = (A.activeIdx > 0 ? A.activeIdx : A.matches.length) - 1, 
                        A.$digest()) : 13 === e.which || 9 === e.which ? A.$apply(function() {
                            A.select(A.activeIdx);
                        }) : 27 === e.which && (e.stopPropagation(), N(), A.$digest());
                    }
                }), m.bind("blur", function() {
                    D && A.matches.length && A.activeIdx !== -1 && !L && (L = !0, A.$apply(function() {
                        A.select(A.activeIdx);
                    })), v = !1, L = !1;
                });
                var G = function(e) {
                    m[0] !== e.target && 3 !== e.which && 0 !== A.matches.length && (N(), s.$$phase || A.$digest());
                };
                r.bind("click", G), c.$on("$destroy", function() {
                    r.unbind("click", G), S && B.remove(), W.remove();
                });
                var B = e(W)(A);
                S ? r.find("body").append(B) : m.after(B);
            }
        };
    ...
    !function(e, t, n) {
        ...
        function a() {
            ...
            this.when = function(e, r) {
            ...
            }, this.$get = [ "$rootScope", "$location", "$routeParams", "$q", "$injector", "$templateRequest", "$sce", function(n, r, i, s, o, l, d) {
                function c(e, t) {
                    var n = t.keys, a = {};
                ...
                function m(e) {
                    var a = y.current;
                    p = h(), g = p && a && p.$$route === a.$$route && t.equals(p.pathParams, a.pathParams) && !p.reloadOnSearch && !M, 
                    g || !a && !p || n.$broadcast("$routeChangeStart", p, a).defaultPrevented && e && e.preventDefault();
                }
                function _() {
                    var e = y.current, a = p;
                    g ? (e.params = a.params, t.copy(e.params, i), n.$broadcast("$routeUpdate", e)) : (a || e) && (M = !1, 
                    y.current = a, a && a.redirectTo && (t.isString(a.redirectTo) ? r.path(f(a.redirectTo, a.params)).search(a.params).replace() : r.url(a.redirectTo(a.pathParams, r.path(), r.search())).replace()), 
                    s.when(a).then(function() {
                        if (a) {
                            ...
                            t.isDefined(n) && (a.loadedTemplateUrl = d.valueOf(n), e = l(n))), t.isDefined(e) && (r.$template = e), 
                            s.all(r);
                        }
                    }).then(function(r) {
                ...
                var p, g, M = !1, y = {
                    routes: a,
                    reload: function() {
                        M = !0, n.$evalAsync(function() {
                            m(), _();
                        });
                    },
                    updateParams: function(e) {
                        if (!this.current || !this.current.$$route) throw u("norout", "Tried updating route when with no current route");
                        e = t.extend({}, this.current.params, e), r.path(f(this.current.$$route.originalPath, e)), 
                        r.search(e);
                    }
                };
                return n.$on("$locationChangeStart", m), n.$on("$locationChangeSuccess", _), y;
            } ];
        }
        function r() {
            this.$get = function() {
        ...
        function i(e, n, a) {
            return {
                ...
                link: function(r, i, s, o, u) {
                    function l() {
                        _ && (a.cancel(_), _ = null), c && (c.$destroy(), c = null), m && (_ = a.leave(m), 
                        _.then(function() {
                            _ = null;
                        }), m = null);
                    }
                    function d() {
                        ...
                        if (t.isDefined(o)) {
                            var d = r.$new(), _ = e.current, p = u(d, function(e) {
                                a.enter(e, null, m || i).then(function() {
                                    !t.isDefined(h) || h && !r.$eval(h) || n();
                                }), l();
                            });
                            m = p, c = _.scope = d, c.$emit("$viewContentLoaded"), c.$eval(f);
                        } else l();
                    }
                    var c, m, _, h = s.autoscroll, f = s.onload || "";
    ...
    angular.module("gettext", []), angular.module("gettext").constant("gettext", function(e) {
        ...
        var o, u = "$$noContext", l = '<span id="test" title="test" class="tested">test</span>', d = angular.element("<span>" + l + "</span>").html() !== l, c = function(e) {
        ...
        return o = {
            ...
            setStrings: function(t, n) {
                ...
                for (var r in n) {
                    var i = n[r];
                    if (d && (r = angular.element("<span>" + r + "</span>").html()), angular.isString(i) || angular.isArray(i)) {
                        var o = {};
                        o[u] = i, i = o;
                    }
                    ...
                    for (var l in i) {
                        var c = i[l];
                        angular.isArray(c) ? this.strings[t][r][l] = c : (this.strings[t][r][l] = [], this.strings[t][r][l][a] = c);
                    }
                }
                s();
            },
            getStringFormFor: function(t, n, a, r) {
                if (!t) return null;
                var i = this.strings[t] || {}, s = i[n] || {}, o = s[r || u] || [];
                return o[e(t, a)];
            },
            getString: function(e, n, a) {
                var i = t(this.currentLanguage);
                return e = this.getStringFormFor(this.currentLanguage, e, 1, a) || this.getStringFormFor(i, e, 1, a) || c(e), 
                e = n ? r(e)(n) : e, m(e);
            },
            getPlural: function(e, n, a, i, s) {
                var o = t(this.currentLanguage);
                return n = this.getStringFormFor(this.currentLanguage, n, e, s) || this.getStringFormFor(o, n, e, s) || c(1 === e ? n : a), 
        ...
        var u = parseInt((/msie (\d+)/.exec(angular.lowercase(r.navigator.userAgent)) || [])[1], 10), l = "translateParams";
        return {
            restrict: "AE",
            terminal: !0,
            compile: function(r, s) {
                ...
                var l = i.trim(r.html()), d = s.translatePlural, c = s.translateContext;
                return u <= 8 && "<!--IE fix-->" === l.slice(-13) && (l = l.slice(0, -13)), {
                    post: function(r, s, u) {
                        function m(t) {
                            t = t || null;
                            var o;
                            d ? (r = h || (h = r.$new()), r.$count = _(r), o = e.getPlural(r.$count, l, d, t, c)) : o = e.getString(l, t, c);
                            var u = s.contents();
                            if (u || o) {
                                if (o === i.trim(u.html())) return void (f && a(u)(r));
                                var m = angular.element("<span>" + o + "</span>");
                                a(m.contents())(r);
                                var p = m.contents();
                                n.enter(p, s), n.leave(u);
                            }
                        }
                        var _ = t(u.translateN), h = null, f = !0, p = o(r, u, m);
                        m(p), f = !1, u.translateN && r.$watch(u.translateN, function() {
                            m(p);
    ...
    function a(e) {
        ...
        var t, n = e[1][0], a = e[1][0], r = e[2][2], i = e[3][0], s = e[4][0], o = e[4][1];
        if (n) if (i > 0) t = l("Receiving delta parts"); else if (r) t = l("Receiving metadata objects"); else {
            var d = s / o * 100;
            t = u.format(l("Receiving objects: $0%"), d.toFixed(2));
        } else t = l(a ? "Writing objects" : "Scanning metadata");
        return t;
    }
    function r(e) {
        for (var t = [ "adds", "removes", "up", "down" ], n = e[0], a = {}, r = 0; r < n.length; r++) {
            var i = t[n[r][1]];
            a[i] || (a[i] = []);
            var s = {
                name: n[r][0],
            ...
            1 === s.type ? (s.version = n[r][2].PreviousPackage.v[1], s.arch = n[r][2].PreviousPackage.v[2]) : (s.version = n[r][2].NewPackage.v[1], 
            s.arch = n[r][2].NewPackage.v[2]), a[i].push(s);
        }
        return a;
    }
    function i(e) {
        ...
        if (e.split("\n").forEach(function(e) {
            ...
            var n = e.name ? e.name : "", a = t.name ? t.name : "";
            return n.toLowerCase().localeCompare(a.toLowerCase());
        }), !(t.length < 1)) {
    ...
    function o() {
        ...
        function t() {
            j ? O = !0 : (L.dispatchEvent("changed"), j = window.setTimeout(function() {
                j = null, O && L.dispatchEvent("changed"), O = !1;
            }, 300));
        }
        function n() {
            return x || (L.connection_error = null, L.os_list = [], Y = null, $ = {}, k = null, 
            w = {}, D = {}, b = {}, T = null, S = null, H = u.defer(), H.promise.done(function() {
                Y && Y.valid ? g(Y.Deployments) : t();
            }), x = u.dbus(d, {
                superuser: !0,
                capabilities: [ "address" ]
            }), x.watch(c).fail(o), x.addEventListener("close", p), Y = x.proxy(m, _), Y.addEventListener("changed", M), 
            Y.wait(function() {
                x ? ($ = x.proxies(h, c), k = function(e, t) {
                    t.Name && (w[t.Name] = t.path);
                }, $.addEventListener("changed", t), $.addEventListener("added", k), $.wait(function() {
                    for (var e in $) {
                        var t = $[e];
                        w[t.Name] = e;
                    }
        ...
        function o(e) {
            x = null, L.connection_error = e, Y && (Y.removeEventListener("changed", M), Y = null), 
            $ && (k && $.removeEventListener("added", k), k = null, $ = {});
        }
        function p(e, t) {
            o(t), L.dispatchEvent("connectionLost", [ t ]);
        }
        function g(e) {
            var n, a = {}, r = [];
            if (e) for (n = 0; n < e.length; n++) {
                var i = e[n], s = i.osname.v;
                a[s] || r.push(s), a[s] = !0;
            }
            L.os_list = r, t();
        }
        ...
        function y(t) {
            var n, a = L.get_os_proxy(t);
            return !a && Y && (a = $[Y.Booted]), a && (n = e(a, "BootedDeployment.origin.v"), 
            n || (n = e(a, "DefaultDeployment.origin.v"))), n;
        }
        function v(e, t, n) {
            var a = L.get_default_origin(e);
            if (!t && a && (t = a.remote), !n && a && (n = a.branch), (!a || a.branch != n || a.remote != t) && t && n) return t + ":" + n;
        }
        var L = this;
        u.event_target(L), L.connection_error = null, L.os_list = [];
        var Y = null, $ = {}, k = null, w = {}, D = {}, b = {}, T = null, S = null, x = null, H = null, j = null, O = !1;
        Object.defineProperty(this, "running_method", {
            enumerable: !1,
            get: function() {
                if (T) return T;
                if (Y && Y.ActiveTransaction) {
                    var e = Y.ActiveTransaction[0], t = $[Y.ActiveTransaction[2]];
            ...
            return n(), H.promise.done(function() {
                L.connection_error ? e.reject(L.connection_error) : e.resolve(x);
            }), e.promise;
        }, L.known_versions_for = function(t, n, a) {
            var r, i, s, o = Y ? Y.Deployments : [], u = [], l = v(t, n, a), d = L.get_os_proxy(t);
            d && (s = e(d, "CachedUpdate.origin.v"), s && (b[s] = d.CachedUpdate)), i = l ? b[l] : b[s], 
            i && (r = e(i, "checksum.v"));
            for (var c = 0; c < o.length; c++) {
                var m = o[c], _ = e(m, "checksum.v");
                m.id && e(m, "osname.v") != t || (L.item_matches(m, "DefaultDeployment") ? (r && _ !== r && u.push(i), 
                u.push(m)) : e(m, "checksum.v") !== r && u.push(m));
            }
            return u;
        }, L.get_default_origin = function(e) {
            var t, n = y(e);
            return n && (t = n.split(":"), t.length > 1 && (n = {
                remote: t[0]
            }, t.shift(), n.branch = t.join(":"))), n;
        }, L.get_os_proxy = function(e) {
            var t = w[e], n = null;
            return t && (n = $[t]), n;
        }, L.signature_obj = function(e) {
            if (e.v) {
                var t = e.v[11];
        ...
        }, L.packages = function(t) {
            var n = e(t, "id.v"), a = e(t, "checksum.v"), o = n;
            if (!n && a && (o = a), !S) {
                var l = $[Y.Booted];
                if (!l) return;
            ...
            if (o && !D[o]) {
                var d, c, m = L.get_os_proxy(t.osname.v);
                m && (n === S ? (c = u.spawn([ "rpm", "-qa" ]), d = new s(c, i)) : n ? (c = m.call("GetDeploymentsRpmDiff", [ S, n ]), 
                d = new s(c, r)) : t.origin.v === y(m.Name) && (c = m.call("GetCachedUpdateRpmDiff", [ "" ]), 
                d = new s(c, r)), D[o] = d);
            }
            return D[o];
        }, L.item_matches = function(t, n, a) {
            var r = e(t, "osname.v"), i = null, s = null;
            return !!r && (i = L.get_os_proxy(r), s = e(i, n), a || (a = "checksum"), a += ".v", 
            e(t, a) === e(s, a));
        }, L.cache_update_for = function(t, n, a) {
            var i = u.defer(), o = v(t, n, a), d = L.get_os_proxy(t);
            if (d) {
                if (!o) return u.when(d.CachedUpdate);
                d.call("GetCachedRebaseRpmDiff", [ o, [] ]).done(function(t) {
                    var n;
                    t && 2 == t.length && e(t[1], "checksum.v") && (n = t[1], b[o] = n, D[n.checksum.v] = new s(u.when([ t[0] ]), r)), 
            ...
            return i.promise();
        }, L.check_for_updates = function(e, n, a) {
            var r, i = v(e, n, a);
            return r = i ? L.run_transaction("DownloadRebaseRpmDiff", [ i, [] ], e).then(function() {
                return T = "DownloadRebaseRpmDiff:" + e, L.cache_update_for(e, n, a).always(function() {
                    T = null, t();
                });
            }) : L.run_transaction("DownloadUpdateRpmDiff", null, e);
        }, L.reload = function() {
            var e = u.defer();
            return Y && Y.ReloadConfig ? Y.ReloadConfig().fail(function(e) {
                console.warn("Error reloading config:", e);
            }).always(function() {
                e.resolve();
            }) : e.resolve(), e.promise();
        }, L.run_transaction = function(e, n, r) {
            function i(e) {
                T = null, c && (m && m.remove(), c.removeEventListener("close", o), c.close()), 
                c = null, m = null, t();
            }
            function s(e) {
                _.reject(e), i();
            ...
            T = e + ":" + r;
            var d, c = null, m = null, _ = u.defer(), h = !1;
            if (Array.isArray(n)) for (d = 0; d < n.length; d++) {
                var p = n[d];
                if (null !== p && "object" == typeof p && "reboot" in p) {
                    h = n[d].reboot;
                    break;
                }
            }
            return L.connect().fail(s).done(function() {
                var t = L.get_os_proxy(r);
                return t ? void L.reload().done(function() {
                    t.call(e, n).fail(s).done(function(e) {
                        var t = {
                            superuser: !0,
                            address: e[0],
                            bus: "none"
                        };
                        h && u.hint("restart"), c = u.dbus(null, t), c.addEventListener("close", o), m = c.subscribe({
                            path: "/"
                        }, function(e, t, n, r) {
                            if ("DownloadProgress" == n) {
                                var o = a(r);
                                o && _.notify(o);
                            } else "Message" == n ? _.notify(r[0]) : "Finished" == n && (r ? r[0] ? (_.resolve(r[1]), 
                            i()) : s(r[1]) : (console.warn("Unexpected transaction response", r), s({
                                problem: "protocol-error"
                            })));
                        }), c.call("/", f, "Start");
                    });
                }) : s(u.format(l("OS $0 not found"), r));
            }), _.promise();
        };
    }
    var u = n(2), l = u.gettext, d = "org.projectatomic.rpmostree1", c = "/org/projectatomic/rpmostree1", m = "org.projectatomic.rpmostree1.Sysroot", _ = "/org/projectatomic/rpmostree1/Sysroot", h = "org.projectatomic.rpmostree1.OS", f = "org.projectatomic.rpmostree1.Transaction";
    e.exports = new o();
}, function(e, t, n) {
    "use strict";
    var a = n(2), r = n(129);
    n(130), n(136);
    var i = a.gettext, s = n(134);
    r.module("ostree.remotes", [ "ui.cockpit", "ostree.utils" ]).factory("remoteActions", [ "$q", "$timeout", "config", function(e, t, n) {
        function o() {
            return a.spawn([ "ostree", "remote", "list" ], {
                superuser: "try",
                err: "message"
            }).then(function(e) {
                var t = [];
                return r.forEach(e.trim().split(/\r\n|\r|\n/), function(e, n) {
                    e && t.push(e);
                }), t.sort();
            });
        }
        function u(e) {
            return s.reload().then(function() {
                return a.spawn([ "ostree", "remote", "refs", e ], {
                    superuser: "try",
                    err: "message"
                }).then(function(e) {
                    var t = [];
                    return r.forEach(e.trim().split(/\r\n|\r|\n/), function(e, n) {
                        var a = e.split(":");
                        a.length > 1 ? t.push(a.slice(1).join(":")) : e && t.push(e);
                    }), t.sort();
                });
            });
        }
        function l(e, t, n) {
            var r = [ "ostree", "remote", "add" ];
            return n ? r.push("--set=gpg-verify=true") : r.push("--set=gpg-verify=false"), r.push(e, t), 
            a.spawn(r, {
                superuser: "try",
                err: "message"
            });
        ...
        function d(e) {
            return a.spawn([ "ostree", "remote", "delete", e ], {
                superuser: "try",
                err: "message"
            });
        }
        function c(e, t) {
            var n = a.spawn([ "ostree", "remote", "gpg-import", "--stdin", e ], {
                superuser: "try",
                err: "message"
            });
            return n.input(t), n;
        ...
        function m(e) {
            return a.file("/etc/ostree/remotes.d/" + e + ".conf", {
                superuser: "try"
            });
        }
        function _(e) {
        ...
        function h(t) {
            var a = m(t), r = _(t), s = e.defer();
            return a.read().done(function(e, t) {
                var a = n.parseData(e);
                a[r] ? s.resolve(a[r]) : s.reject(i("No configuration data found"));
            }).fail(function(e) {
                s.reject(e);
            }).always(function() {
                a.close();
        ...
        function f(t, a) {
            function r(e) {
                return n.changeData(e, s, a);
            }
            var i = m(t), s = _(t), o = e.defer();
            return i.modify(r).done(function(e, t) {
                o.resolve();
            }).fail(function(e) {
                o.reject(e);
            }).always(function() {
        ...
        return {
            listRemotes: o,
            listBranches: u,
            loadRemoteSettings: h,
            updateRemoteSettings: f,
            addRemote: l,
            deleteRemote: d,
            importGPGKey: c
        };
        ...
        return {
            ...
            link: function(n, r, s) {
                ...
                t.loadRemoteSettings(n.remote).then(function(e) {
                    ...
                    n.failure(a.format(i("Couldn't load settings for '$0': $1"), n.remote, a.message(e)));
                }), n.cancel = function() {
                    n.$emit("formFinished");
                    ...
                    if (n.fields) {
                        n.$emit("formRunning");
                        var a = !!n.fields.gpgVerify, r = e.when([]);
                        return a && n.fields.gpgData && (r = e.when(t.importGPGKey(n.remote, n.fields.gpgData))), 
                        r.then(function() {
        ...
        return {
            ...
            link: function(n, a, r) {
                function s(t) {
                    var a, r = [], s = /^[a-z0-9_\.\-]+$/i, o = /\s/;
                    return n.fields.name = n.fields.name ? n.fields.name.trim() : null, n.fields.url = n.fields.url ? n.fields.url.trim() : null, 
                    n.fields.name && s.test(n.fields.name.toLowerCase()) || (a = new Error(i("Please provide a valid name")), 
                    a.target = "#remote-name", r.push(a), a = null), n.fields.url && !o.test(n.fields.url) || (a = new Error(i("Please provide a valid URL")), 
                    a.target = "#remote-url", r.push(a), a = null), r.length > 0 ? e.reject(r) : e.when({
                        name: n.fields.name,
                        url: n.fields.url,
                ...
                n.add = function(e) {
                    return n.$emit("formRunning"), s().then(function(e) {
    ...
    } ]).controller("ChangeRepositoryCtrl", [ "$q", "$scope", "$modalInstance", "dialogData", "remoteActions", function(e, t, n, o, u) {
        function l() {
            var e = t.remote;
            t.loading = !0, t.remote = null, u.listRemotes().done(function(n) {
                t.remotes = n, e && n && n.indexOf(e) > -1 && (t.remote = e);
            }).fail(function(e) {
                console.warn(e), t.remote = null, t.loading_error = a.format(i("Error loading remotes: $0"), a.message(e));
            }).always(function() {
                t.loading = !1, t.$applyAsync();
            });
        }
        r.extend(t, o), t.loading = !0, t.loading_error = null, t.adding = !1, t.editing = null, 
        t.running = !1, t.$on("formRunning", function(e) {
            ...
            return u.listBranches(e.remote).then(function(t) {
                ...
                e.branches.error = a.message(t), e.branch = null;
            }).then(function() {
                return s.cache_update_for(t.os, e.remote, e.branch).then(function() {
                    return e;
                }, function() {
                    return e;
                });
    ...
    "use strict";
    var a = n(129);
    a.module("ostree.utils", []).factory("config", [ function() {
        function e(e, t) {
            return e + " = " + t;
        }
        function t(t) {
            var n = [];
            return a.forEach(t, function(t, a) {
                (t || t === !1) && n.push(e(a, t));
            }), n.join("\n") + "\n\n";
        }
        function n(e) {
            var t, n = {}, a = e ? e.split(i.lines) : [], r = null;
            for (t = 0; t < a.length; t++) {
                var s, o = a[t];
                i.param.test(o) ? (s = o.match(i.param), r ? n[r][s[1]] = s[2] : n[s[1]] = s[2]) : i.section.test(o) && (s = o.match(i.section), 
                r = s[1].trim(), n[r] = {});
            }
            return n;
        }
        function r(n, a, r) {
            var s, o = n ? n.split(i.lines) : [], u = !1, l = r, d = "";
            for (s = 0; s < o.length; s++) {
                var c, m, _ = o[s];
                if (i.section.test(_)) {
                    if (u) break;
                    c = _.match(i.section), m = c[1].trim(), u = a == m;
                } else u && i.param.test(_) && (c = _.match(i.param), m = c[1], null === l[m] ? _ = null : void 0 !== l[m] && (_ = e(m, l[m])), 
                delete l[m]);
                null !== _ && (d += _ + "\n");
            }
            return u || (d += "\n[" + a + "]\n"), d += t(l), s < o.length && (d += o.slice(s).join("\n")), 
            d;
        }
        var i = {
            section: /^\s*\[\s*([^\]]*)\s*\]\s*$/,
