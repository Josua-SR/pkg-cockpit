!function(e) {
    ...
    (function(e) {
        !function(t, n) {
            ...
            var mi = Math.abs, _i = ga("ms"), hi = ga("s"), fi = ga("m"), pi = ga("h"), gi = ga("d"), Mi = ga("w"), yi = ga("M"), vi = ga("y"), Li = va("milliseconds"), $i = va("seconds"), Yi = va("minutes"), ki = va("hours"), wi = va("days"), Di = va("months"), bi = va("years"), Ti = Math.round, Si = {
                ss: 44,
                s: 45,
                m: 45,
                h: 22,
            ...
            Hi.clone = Ma, Hi.get = ya, Hi.milliseconds = Li, Hi.seconds = $i, Hi.minutes = Yi, 
    ...
    !function(e, t, n) {
            ...
            function f(e, n) {
                function a(t, a) {
                    if (e.hasOwnProperty(t)) {
                        if (e[t] === M) throw Ga("cdep", "Circular dependency found: {0}", t + " <- " + $.join(" <- "));
                        return e[t];
                    }
                    try {
                        return $.unshift(t), e[t] = M, e[t] = n(t, a);
                    } catch (n) {
        ...
        function Je(e, t, a, r) {
            ...
            var f = this, p = t[0], M = e.location, y = e.history, L = e.setTimeout, $ = e.clearTimeout, Y = {};
            f.isMock = !1;
            var k = 0, w = [];
            ...
            this.debugInfoEnabled = function(e) {
                ...
                function I(e, s, o, u, l, d, c, m, _) {
                    ...
                    for (var $, k, w, b, T, S, x, j = -Number.MAX_VALUE, O = _.controllerDirectives, E = _.newIsolateScopeDirective, C = _.templateDirective, A = _.nonTlbTranscludeDirective, I = !1, z = !1, q = _.hasElementTranscludeDirective, B = o.$$element = na(s), Z = d, X = u, ee = 0, ne = e.length; ee < ne; ee++) {
                        ...
                        if ((x = w.scope) && (w.templateUrl || (y(x) ? (K("new/isolated scope", E || $, w, B), 
                ...
                function G(e, t, n, a, r, s, o, l) {
                    var d, c, m = [], h = t[0], f = e.shift(), p = _(f, {
                        ...
                        replace: null,
                        $$originalDirective: f
                    }), g = Y(f.templateUrl) ? f.templateUrl(t, n) : f.templateUrl, M = f.templateNamespace;
                    return t.empty(), u(g).then(function(u) {
                        ...
                        if (u = de(u), f.replace) {
                            ...
                            var Y = P(_, [], v);
                            y(f.scope) && U(Y), e = Y.concat(e), J(n, v);
                        } else _ = h, t.html(u);
        ...
        function dt() {
            ...
            this.$get = [ "$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(s, u, l, d, m, _) {
                ...
                function L(a, r) {
                    ...
                    _ && (f = _.get($), M(f) ? H(f) ? f.then(l, l) : _a(f) ? o(f[1], f[0], P(f[2]), f[3]) : o(f, 200, {}, "OK") : _.put($, v)), 
                    g(f)) {
        ...
        function ht() {
            ...
            this.startSymbol = function(t) {
                ...
                function s(i, s, m, _) {
                    ...
                    _ = !!_;
                    for (var p, y, v, L = 0, $ = [], k = [], w = i.length, D = [], b = []; L < w; ) {
                        if ((p = i.indexOf(e, L)) == -1 || (y = i.indexOf(t, p + o)) == -1) {
                            L !== w && D.push(h(i.substring(L)));
                            break;
                        }
                        L !== p && D.push(h(i.substring(L, p))), v = i.substring(p + o, y), $.push(v), k.push(n(v, f)), 
            ...
            this.$get = [ "$filter", "$sniffer", function(n, a) {
                ...
                function l(e, t, n, a) {
                    ...
                    return r = e.$watch(function(e) {
                        ...
                        i = e, Y(t) && t.apply(this, arguments), M(e) && a.$$postDigest(function() {
                            M(i) && r();
                        });
                    }, n);
                }
        ...
        function qt(e, t) {
            ...
            s.prototype = {
                ...
                $$resolve: function(e) {
                    ...
                    try {
                        (y(e) || Y(e)) && (n = e && e.then), Y(n) ? (this.promise.$$state.status = -1, n.call(e, a[0], a[1], this.notify)) : (this.promise.$$state.value = e, 
        ...
        function Gt() {
            ...
            this.digestTtl = function(e) {
                ...
                _.prototype = {
                    ...
                    $digest: function() {
                        var e, a, r, i, l, d, m, _, h, g, M = t, y = this, $ = [];
        ...
        }, ga = [ "ng-", "data-ng-", "ng:", "x-ng-" ], Ma = /[A-Z]/g, ya = !1, va = 1, La = 2, $a = 3, Ya = 8, ka = 9, wa = 11, Da = {
            full: "1.3.20",
            major: 1,
            minor: 3,
            dot: 20,
        ...
        var yr = le(), vr = le(), Lr = Object.prototype.valueOf, $r = a("$sce"), Yr = {
            HTML: "html",
            CSS: "css",
            URL: "url",
        ...
        var li = [ "$animate", function(e) {
        ...
        }, hi = "ng-valid", fi = "ng-invalid", pi = "ng-pristine", gi = "ng-dirty", Mi = "ng-untouched", yi = "ng-touched", vi = "ng-pending", Li = a("ngModel"), $i = [ "$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(e, t, a, r, s, o, u, l, d, c) {
            ...
            var m, _ = s(a.ngModel), f = _.assign, p = _, y = f, v = null, $ = this;
            ...
            qn({
                ...
                $.$touched = !1, $.$untouched = !0, o.setClass(r, Mi, yi);
            }, this.$setTouched = function() {
                $.$touched = !0, $.$untouched = !1, o.setClass(r, yi, Mi);
                ...
                compile: function(a, m) {
                    ...
                    return y ? $ = e(y) : (k = function(e, t) {
                        ...
                        e.$watchCollection(g, function(a) {
                            var m, g, y, $, D, b, T, S, x, H, j, O, E = t[0], C = le();
                            if (M && (e[M] = a), r(a)) x = a, S = Y || k; else {
                                S = Y || w, x = [];
                            ...
                            for (m = 0; m < $; m++) if (D = a === x ? m : x[m], b = a[D], H = j[m], H.scope) {
                                ...
                                d(H) != y && s.move(ue(H.clone), null, na(E)), E = c(H), l(H.scope, m, v, b, L, D, $);
                            } else f(function(e, t) {
                                H.scope = t;
                                var n = h.cloneNode(!1);
            ...
            return {
                ...
                link: function(o, u, l, d) {
                    ...
                    if (d[1]) {
                        for (var h, f = d[0], p = d[1], g = l.multiple, y = l.ngOptions, v = !1, L = !1, $ = na(t.createElement("option")), Y = na(t.createElement("optgroup")), k = $.clone(), w = 0, D = u.children(), b = D.length; w < b; w++) if ("" === D[w].value) {
                            h = v = D.eq(w);
                            break;
                        }
    ...
    !function() {
        ...
        function a(n, a, i, s, o) {
            function u(e) {
                if (!Y) return v = e, $ ? void o.cancel() : void (null === v ? (f(), y()) : v === !0 ? (f(), 
    ...
    angular.module("ui.bootstrap.collapse", []).directive("collapse", [ "$animate", function(e) {
        ...
        return {
            ...
            link: function(l, d, c, m) {
                ...
                var p, g = angular.isDefined(c.closeOnDateSelection) ? l.$parent.$eval(c.closeOnDateSelection) : o.closeOnDateSelection, M = angular.isDefined(c.datepickerAppendToBody) ? l.$parent.$eval(c.datepickerAppendToBody) : o.appendToBody, y = angular.isDefined(c.onOpenFocus) ? l.$parent.$eval(c.onOpenFocus) : o.onOpenFocus, v = angular.isDefined(c.datepickerPopupTemplateUrl) ? c.datepickerPopupTemplateUrl : o.datepickerPopupTemplateUrl, L = angular.isDefined(c.datepickerTemplateUrl) ? c.datepickerTemplateUrl : o.datepickerTemplateUrl, $ = {};
        ...
        return {
            ...
            link: function(c, m, _, h) {
                ...
                g.$parsers.unshift(function(e) {
                    return v = !0, 0 === y || e && e.length >= y ? $ > 0 ? (J(), q(e)) : U(e) : (k(c, !1), 
    ...
    angular.module("gettext", []), angular.module("gettext").constant("gettext", function(e) {
        ...
        function s(e) {
            return i.lcFirst(e.replace(d, ""));
        }
        function o(e, t, n) {
            var a = Object.keys(t).filter(function(e) {
                return i.startsWith(e, d) && e !== d;
            });
        ...
        var u = angular.$$lowercase || angular.lowercase, l = parseInt((/msie (\d+)/.exec(u(r.navigator.userAgent)) || [])[1], 10), d = "translateParams";
        return {
            restrict: "AE",
            terminal: !0,
            compile: function(r, s) {
                ...
                var u = i.trim(r.html()), d = s.translatePlural, c = s.translateContext;
                return l <= 8 && "<!--IE fix-->" === u.slice(-13) && (u = u.slice(0, -13)), {
                    post: function(r, s, l) {
                        function m(t) {
                            t = t || null;
                            var o;
                            d ? (r = h || (h = r.$new()), r.$count = _(r), o = e.getPlural(r.$count, u, d, t, c)) : o = e.getString(u, t, c);
                            var l = s.contents();
                            if (l || o) {
                                if (o === i.trim(l.html())) return void (f && a(l)(r));
                                var m = angular.element("<span>" + o + "</span>");
                                a(m.contents())(r);
                                var p = m.contents();
                                n.enter(p, s), n.leave(l);
                            }
                        }
                        var _ = t(l.translateN), h = null, f = !0, p = o(r, l, m);
                        m(p), f = !1, l.translateN && r.$watch(l.translateN, function() {
                            m(p);
    ...
    function o() {
        ...
        function n() {
            ...
            }), x.watch(c).fail(o), x.addEventListener("close", p), $ = x.proxy(m, _), $.addEventListener("changed", M), 
            $.wait(function() {
        ...
        function o(e) {
            x = null, L.connection_error = e, $ && ($.removeEventListener("changed", M), $ = null), 
