!function(e) {
    ...
    function s() {
        var e = M.defer();
        return x.call("/org/freedesktop/PackageKit", "org.freedesktop.PackageKit", "CreateTransaction", [], {
            timeout: 5e3
        }).done(function(t) {
            var n = x.proxy("org.freedesktop.PackageKit.Transaction", t[0]);
            n.wait(function() {
                return e.resolve(n);
            });
        }).fail(function(t) {
    ...
    function u(e) {
        ...
        if (!t) return null;
        var s, i;
        return "uptodate" == e.state || "available" == e.state ? (i = f.createElement("button", {
            className: "btn btn-default",
            onClick: function() {
                return e.onRefresh();
            }
        }, y("Check for updates")), null !== e.timeSinceRefresh && (s = f.createElement("span", {
            style: {
                paddingRight: "3ex"
            }
        }, M.format(y("Last checked: $0 ago"), p.duration(1e3 * e.timeSinceRefresh).humanize())))) : "applying" == e.state && (i = f.createElement("button", {
            className: "btn btn-default",
            onClick: function() {
                return e.onCancel();
            },
            disabled: !e.allowCancel
        }, y("Cancel"))), f.createElement("div", {
            className: "content-header-extra"
        }, f.createElement("table", {
            width: "100%"
        }, f.createElement("tr", null, f.createElement("td", {
            id: "state"
        }, t), f.createElement("td", {
    ...
    function _(e) {
        ...
        }))), t.security && (a = f.createElement("p", null, f.createElement("span", {
            className: "fa fa-bug security-label"
        }, " "), f.createElement("span", {
            className: "security-label-text"
        }, y("Security Update") + (t.cve_urls.length ? ": " : "")), d(t.cve_urls.map(function(e) {
            return f.createElement("a", {
                href: e,
                rel: "noopener",
                referrerpolicy: "no-referrer",
        ...
        })))), f.createElement("tbody", null, f.createElement("tr", {
            className: "listing-ct-item" + (t.security ? " security" : "")
        }, f.createElement("th", null, d(e.pkgNames.map(function(e) {
            return f.createElement(L, {
                tip: E[e]
            }, f.createElement("span", null, e));
        }))), f.createElement("td", {
            className: "narrow"
        }, t.version), f.createElement("td", {
            className: "narrow"
    ...
    function l(e) {
        ...
        }, f.createElement("thead", null, f.createElement("tr", null, f.createElement("th", null, y("Name")), f.createElement("th", null, y("Version")), f.createElement("th", null, y("Bugs")), f.createElement("th", null, y("Details")))), t.map(function(t) {
    ...
    function m(e) {
        ...
        }, f.createElement("h1", null, y("Restart Recommended")), f.createElement("p", null, y("Updated packages may require a restart to take effect.")), f.createElement("div", {
        ...
        }, y("Ignore")), " ", f.createElement("button", {
    ...
    }, M = n(6), f = n(7), p = n(8), L = n(96).Tooltip;
    n(99);
    var y = M.gettext, Y = {
        loading: y("Loading available updates, please wait..."),
        locked: y("Some other program is currently using the package manager, please wait..."),
        refreshing: y("Refreshing package information"),
        uptodate: y("No updates pending"),
        applying: y("Applying updates"),
        updateSuccess: null,
        updateError: y("Applying updates failed"),
        loadError: y("Loading available updates failed")
    }, k = 1, v = 2, g = 3, D = 13, T = 22, w = 8, b = 1, S = 10, H = 30, j = {
        8: y("Downloading"),
        9: y("Installing"),
        10: y("Updating"),
        11: y("Setting up"),
        14: y("Verifying")
    }, x = M.dbus("org.freedesktop.PackageKit", {
        superuser: "try",
        track: !0
    }), E = {}, P = function(e) {
        function t() {
            a(this, t), h(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), 
            this.state = {
                percentage: 0,
                timeRemaining: null,
                curStatus: null,
        ...
        return r(t, e), c(t, [ {
            ...
            value: function() {
                ...
                t.addEventListener("Package", function(n, a, r) {
                    ...
                    e.setState({
                        curPackage: s[0] + " " + s[1],
                        curStatus: a,
                        percentage: t.Percentage <= 100 ? t.Percentage : 0,
            ...
            value: function() {
                var e;
                return e = this.state.curPackage ? f.createElement("span", null, f.createElement("strong", null, j[this.state.curStatus || S] || j[S]), " ", this.state.curPackage) : y("Initializing..."), 
                f.createElement("div", {
                ...
                }, null !== this.state.timeRemaining ? f.createElement("span", null, p.duration(1e3 * this.state.timeRemaining).humanize()) : null)));
            }
        } ]), t;
    }(f.Component), W = function(e) {
        function t() {
            a(this, t), h(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), 
            this.state = {
                state: "loading",
        ...
        return r(t, e), c(t, [ {
            ...
            value: function() {
                var e = this;
                x.call("/org/freedesktop/PackageKit", "org.freedesktop.PackageKit", "GetTransactionList", [], {
                    timeout: 5e3
                }).done(function(t) {
                    var n = t[0], a = n.map(function(e) {
                        return x.call(e, "org.freedesktop.DBus.Properties", "Get", [ "org.freedesktop.PackageKit.Transaction", "Role" ], {
                            timeout: 5e3
                        });
                    });
                    M.all(a).done(function(t) {
                        for (var a = 0; a < t.length; ++a) if (t[a].v == T) {
                            var r = x.proxy("org.freedesktop.PackageKit.Transaction", n[a]);
                ...
                }), x.addEventListener("close", function(t, n) {
                    console.log("close:", t, n);
                    var a;
                    a = y("not-found" == n.problem ? "PackageKit is not installed" : "PackageKit crashed"), 
            ...
            value: function(e) {
                var t = this;
                s().done(function(n) {
                    n.addEventListener("UpdateDetail", function(e, n, a, r, s, d, u, _, l, m) {
                        var c = t.state.updates[n];
                        c.vendor_urls = s, c.bug_urls = o(d), c.description = t.formatDescription(l || m), 
                        c.cve_urls = o(u && u.length > 0 ? u : i(c.description)), c.cve_urls && c.cve_urls.length > 0 && (c.security = !0), 
                        t.setState({
            ...
            value: function() {
                ...
                s().done(function(a) {
                    ...
                    return e.handleLoadError("not-found" == t.problem ? y("PackageKit is not installed") : t);
                });
            }
        }, {
            ...
            value: function() {
                var e = this;
                x.call("/org/freedesktop/PackageKit", "org.freedesktop.PackageKit", "GetTimeSinceAction", [ D ], {
                    timeout: 5e3
                }).done(function(t) {
                    e.setState({
                        timeSinceRefresh: t
            ...
            value: function(e) {
                ...
                this.setState({
                    ...
                    t.setState({
                        ...
                        haveSecurity: !1,
                        loadPercent: null
                    }), t.loadUpdates()) : (n != v && t.state.errorMessages.push(M.format(y("PackageKit reported error code $0"), n)), 
                    t.setState({
                        state: "updateError"
                    }));
                }), e.addEventListener("changed", function(e, n) {
                    "AllowCancel" in n && t.setState({
            ...
            value: function() {
                ...
                switch (this.state.state) {
                  ...
                  case "refreshing":
                  case "locked":
                    return this.state.loadPercent ? f.createElement("div", {
                        className: "progress-main-view"
                    }, f.createElement("div", {
                        className: "progress"
                    }, f.createElement("div", {
                  ...
                  case "available":
                    return f.createElement("div", null, f.createElement("table", {
                        width: "100%"
                    }, f.createElement("tr", null, f.createElement("td", null, f.createElement("h2", null, y("Available Updates"))), f.createElement("td", {
                        className: "text-right"
                    }, this.state.haveSecurity ? f.createElement("button", {
                        className: "btn btn-default",
                        onClick: function() {
                            return e.applyUpdates(!0);
                        }
                    }, y("Install security updates")) : null, "   ", f.createElement("button", {
                        className: "btn btn-primary",
                        onClick: function() {
                            return e.applyUpdates(!1);
                        }
                    }, y("Install all updates"))))), this.state.cockpitUpdate ? f.createElement("div", {
                        className: "alert alert-warning"
                    }, f.createElement("span", {
                        className: "pficon pficon-warning-triangle-o"
                    }), f.createElement("span", null, f.createElement("strong", null, y("Cockpit itself will be updated.")), " ", y("When you get disconnected, the updates will continue in the background. You can reconnect and resume watching the update progress."))) : null, f.createElement(l, {
                  ...
                  case "updateError":
                    return this.state.errorMessages.map(function(e) {
                        return f.createElement("pre", null, e);
                    });
                  ...
                  case "restart":
                    ...
                    })), f.createElement("h1", null, y("Restarting")), f.createElement("p", null, y("Your server will close the connection soon. You can reconnect after it has restarted.")));
                  ...
                  case "uptodate":
                    ...
                    })), f.createElement("p", null, y("System is up to date")));
            ...
            value: function() {
                var e = this;
                return f.createElement("div", null, f.createElement(u, {
                    ...
                    onCancel: function() {
                        return e.state.applyTransaction.Cancel();
                    }
                }), f.createElement("div", {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        document.title = M.gettext(document.title), f.render(f.createElement(W, null), document.getElementById("app"));
    });
}, function(e, t) {
    e.exports = cockpit;
}, function(e, t, n) {
    ...
    !function(t, n) {
        ...
        function t(e, t, n) {
            ...
            return a ? a === ze ? r = d(e, t, n) : a === Ue ? r = y(e, t, n) : a === Ne ? r = M(e, t, n) : a === Je && (r = document.createComment("react-text: " + (e.uid || re()))) : r = document.createTextNode(e), 
            r;
        }
        function n(e, t, n, r) {
            var s = e.vtype;
            if (s === Ue) return Y(e, t, n, r);
            if (s === Ne) return f(e, t, n, r);
            if (s !== ze) return n;
        ...
        function r(e) {
            if (e) {
                ...
                e.shouldIgnore || (t.vtype ? t.vtype === ze ? c(t, e.newVnode, n, e.parentContext) : t.vtype === Ne ? n = f(t, e.newVnode, n, e.parentContext) : t.vtype === Ue && (n = Y(t, e.newVnode, n, e.parentContext)) : n.replaceData(0, n.length, e.newVnode));
        ...
        function d(e, t, n) {
            ...
            return de(s, r, i), null != e.ref && (te(Ke, e), te(Ke, s)), s;
        }
        function u(e, n, a) {
        ...
        function m(e, t, n, a, r) {
            ...
            if (0 !== d) if (0 !== u) {
                for (var l = Array(u), c = null, h = null, M = 0; M < d; M++) for (var f = i[M], p = 0; p < u; p++) if (!l[p]) {
                    var L = o[p];
                    if (f === L) {
                        var y = !0;
                        r && (f.vtype !== Ue && f.vtype !== Ne || f.type.contextTypes && (y = !1)), l[p] = {
                            shouldIgnore: y,
                            vnode: f,
                            newVnode: L,
                            node: s[M],
            ...
            } else for (var M = 0; M < d; M++) te(e.removes, {
                vnode: i[M],
                node: s[M]
            }); else if (u > 0) for (var M = 0; M < u; M++) te(e.creates, {
                vnode: o[M],
                parentNode: a,
                parentContext: r,
                index: M
        ...
        function y(e, n, a) {
            ...
            te($e, d), null != e.ref && (te(Ke, e), te(Ke, d)), m;
        }
        function Y(e, t, n, a) {
        ...
        function $(e) {
            ...
            for (var s in t) if (t.hasOwnProperty(s)) {
                ...
                ut[s] = {
                    ...
                    mustUseProperty: K(i, _t),
                    hasBooleanValue: K(i, lt),
                    hasNumericValue: K(i, mt),
                    hasPositiveNumericValue: K(i, ct),
                    hasOverloadedBooleanValue: K(i, ht)
                };
            }
        }
        function K(e, t) {
        ...
        function q(e, t, n) {
            ...
            if (a) if (null == n || a.hasBooleanValue && !n || a.hasNumericValue && isNaN(n) || a.hasPositiveNumericValue && n < 1 || a.hasOverloadedBooleanValue && n === !1) B(e, t); else if (a.mustUseProperty) {
        ...
        function ie(e, t, n, a) {
            vt.test(t) ? C(e, t) : "style" === t ? R(e.style, n) : t === Fe ? e.innerHTML = "" : a ? e.removeAttribute(t) : B(e, t);
        }
        ...
        function Le(e, t) {
            ...
            var u = fe.apply(void 0, [ n, s ].concat(o));
        ...
        var Fe = "dangerouslySetInnerHTML", Oe = "http://www.w3.org/2000/svg", Ce = "liteid", ze = 2, Ne = 3, Ue = 4, Je = 5, Re = 1, Ge = 9, Ie = 11, Ve = null, $e = [], Ke = [], qe = {
            updaters: [],
            isPending: !1,
            add: function(e) {
                te(this.updaters, e);
        ...
        var rt = /^-?\d+(\.\d+)?$/, st = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", it = st + "\\-.0-9\\uB7\\u0300-\\u036F\\u203F-\\u2040", ot = new RegExp("^[" + st + "][" + it + "]*$"), dt = RegExp.prototype.test.bind(new RegExp("^(data|aria)-[" + it + "]*$")), ut = {}, _t = 1, lt = 4, mt = 8, ct = 24, ht = 32, Mt = {
            props: {
                accept: 0,
                acceptCharset: 0,
                accessKey: 0,
            ...
            domProps: {}
        }, ft = "http://www.w3.org/1999/xlink", pt = "http://www.w3.org/XML/1998/namespace", Lt = {
        ...
        !function(t, n) {
            ...
            function Se(e) {
                ...
                return e._locale = e._locale || w(e._l), null === t || void 0 === n && "" === t ? c({
                    nullInput: !0
                }) : ("string" == typeof t && (e._i = t = e._locale.preparse(t)), f(t) ? new M(ee(t)) : (r(n) ? Te(e) : n ? ge(e) : s(t) ? e._d = t : He(e), 
                e));
            }
            function He(e) {
                var n = e._i;
            ...
            U("YYYYYY", ea, Bn), G([ "YYYYY", "YYYYYY" ], da), G("YYYY", function(e, n) {
            ...
            U("DDDD", Kn), G([ "DDD", "DDDD" ], function(e, t, n) {
                n._dayOfYear = L(e);
            }), t.ISO_8601 = function() {};
            ...
            U("GGGGG", ea, Bn), U("ggggg", ea, Bn), I([ "gggg", "ggggg", "GGGG", "GGGGG" ], function(e, t, n, a) {
                t[a.substr(0, 2)] = L(e);
            ...
            for (Na = "S"; Na.length <= 9; Na += "S") G(Na, Bt);
            ...
            Ja.from = Mt, Ja.fromNow = ft, Ja.to = pt, Ja.toNow = Lt, Ja.get = P, Ja.invalidAt = jt, 
            ...
            Ja.isoWeek = Ja.isoWeeks = fe, Ja.weeksInYear = Ft, Ja.isoWeeksInYear = At, Ja.date = Ea, 
            ...
            Ba._calendar = Ga, Ba.calendar = tn, Ba._longDateFormat = Ia, Ba.longDateFormat = nn, 
            ...
            Ba.pastFuture = dn, Ba.set = un, Ba.months = K, Ba._months = Ma, Ba.monthsShort = q, 
            Ba._monthsShort = fa, Ba.monthsParse = B, Ba.week = me, Ba._week = ga, Ba.firstDayOfYear = he, 
            Ba.firstDayOfWeek = ce, Ba.weekdays = zt, Ba._weekdays = Pa, Ba.weekdaysMin = Ut, 
            Ba._weekdaysMin = Aa, Ba.weekdaysShort = Nt, Ba._weekdaysShort = Wa, Ba.weekdaysParse = Jt, 
            Ba.isPM = Kt, Ba._meridiemParse = Fa, Ba.meridiem = qt, D("en", {
            ...
            fr.asMonths = rr, fr.asYears = sr, fr.valueOf = wn, fr._bubble = vn, fr.get = Sn, 
