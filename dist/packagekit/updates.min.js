!function(e) {
    ...
    function s() {
        var e = h.defer();
        return j.call("/org/freedesktop/PackageKit", "org.freedesktop.PackageKit", "CreateTransaction", [], {
            timeout: 5e3
        }).done(function(t) {
            var n = j.proxy("org.freedesktop.PackageKit.Transaction", t[0]);
            n.wait(function() {
                return e.resolve(n);
            });
        }).fail(function(t) {
    ...
    function u(e) {
        ...
        }, L("Check for updates")), null !== e.timeSinceRefresh && (s = M.createElement("span", {
            style: {
                paddingRight: "3ex"
            }
        }, h.format(L("Last checked: $0 ago"), f.duration(1e3 * e.timeSinceRefresh).humanize())))) : "applying" == e.state && (i = M.createElement("button", {
            className: "btn btn-default",
            onClick: function() {
                return e.onCancel();
            },
            disabled: !e.allowCancel
        }, L("Cancel"))), M.createElement("div", {
    ...
    var L = h.gettext, y = {
        ...
        refreshing: L("Refreshing package information"),
    ...
    }, Y = 1, k = 2, v = 3, g = 13, D = 22, T = 8, w = 1, b = 10, S = 30, H = {
        8: L("Downloading"),
        9: L("Installing"),
        10: L("Updating"),
        11: L("Setting up"),
        14: L("Verifying")
    }, j = h.dbus("org.freedesktop.PackageKit", {
        superuser: "try",
        track: !0
    }), x = {}, P = function(e) {
        function t() {
        ...
        return r(t, e), m(t, [ {
            ...
            value: function() {
                var e;
                e = this.state.curPackage ? M.createElement("span", null, M.createElement("strong", null, H[this.state.curStatus || b] || H[b]), " ", this.state.curPackage) : L("Initializing...");
                var t;
        ...
        return r(t, e), m(t, [ {
            ...
            value: function() {
                var e = this;
                j.call("/org/freedesktop/PackageKit", "org.freedesktop.PackageKit", "GetTransactionList", [], {
                    timeout: 5e3
                }).done(function(t) {
                    var n = t[0], a = n.map(function(e) {
                        return j.call(e, "org.freedesktop.DBus.Properties", "Get", [ "org.freedesktop.PackageKit.Transaction", "Role" ], {
                            timeout: 5e3
                        });
                    });
                    h.all(a).done(function(t) {
                        for (var a = 0; a < t.length; ++a) if (t[a].v == D) {
                            var r = j.proxy("org.freedesktop.PackageKit.Transaction", n[a]);
                ...
                }), j.addEventListener("close", function(t, n) {
            ...
            value: function() {
                var e = this;
                j.call("/org/freedesktop/PackageKit", "org.freedesktop.PackageKit", "GetTimeSinceAction", [ g ], {
                    timeout: 5e3
                }).done(function(t) {
                    e.setState({
                        timeSinceRefresh: t
                ...
                switch (this.state.state) {
                  ...
                  case "available":
                    return M.createElement("div", null, M.createElement("table", {
                        width: "100%"
                    }, M.createElement("tr", null, M.createElement("td", null, M.createElement("h2", null, L("Available Updates"))), M.createElement("td", {
                        className: "text-right"
            ...
            value: function() {
                var e = this;
                return M.createElement("div", null, M.createElement(u, {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        document.title = h.gettext(document.title), M.render(M.createElement(E, null), document.getElementById("app"));
    });
}, function(e, t) {
    e.exports = cockpit;
}, function(e, t, n) {
    ...
    !function(t, n) {
        ...
        function f(e, t, n, a) {
            ...
            return o.cache = o.cache || {}, o.cache[t.uid] = i, o !== n && P(o.cache, n.cache, o), 
            o;
        }
        function p(e, t) {
        ...
        function ie(e, t, n, a) {
            vt.test(t) ? C(e, t) : "style" === t ? G(e.style, n) : t === Fe ? e.innerHTML = "" : a ? e.removeAttribute(t) : B(e, t);
        }
        function oe(e, t, n, a, r) {
            if ("value" !== t && "checked" !== t || (a = e[t]), n !== a) return void 0 === n ? void ie(e, t, a, r) : void ("style" === t ? R(e.style, a, n) : se(e, t, n, r));
        }
        function de(e, t, n) {
        ...
        function _e(e) {
            return !(!e || e.nodeType !== Ge && e.nodeType !== Re && e.nodeType !== Ie);
        }
        function le(e, n, a, r) {
        ...
        var Fe = "dangerouslySetInnerHTML", Oe = "http://www.w3.org/2000/svg", Ce = "liteid", ze = 2, Ne = 3, Ue = 4, Je = 5, Ge = 1, Re = 9, Ie = 11, Ve = null, $e = [], Ke = [], qe = {
            updaters: [],
            isPending: !1,
            add: function(e) {
                te(this.updaters, e);
        ...
        W.prototype = {
            ...
            forceUpdate: function(e) {
                ...
                if (n.isMounted) {
                    ...
                    c !== _ && (c.cache = c.cache || {}, P(c.cache, _.cache, c)), n.vnode = m, n.node = c, 
        ...
        Pt.prototype = W.prototype, We.prototype = Object.create(W.prototype), We.prototype.constructor = We, 
        ...
        return Et.__SECRET_DOM_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Tt, Et;
    });
}, function(e, t, n) {
    (function(e) {
        //! moment.js
        ...
        !function(t, n) {
            ...
            function C(e, t) {
                return e.isValid() ? (t = z(t, e.localeData()), Rn[t] = Rn[t] || O(t), Rn[t](e)) : e.localeData().invalidDate();
            }
            function z(e, t) {
                function n(e) {
            ...
            var Fn, On, Cn = t.momentProperties = [], zn = !1, Nn = {}, Un = {}, Jn = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, Gn = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Rn = {}, In = {}, Vn = /\d/, $n = /\d\d/, Kn = /\d{3}/, qn = /\d{4}/, Bn = /[+-]?\d{6}/, Zn = /\d\d?/, Xn = /\d{1,3}/, Qn = /\d{1,4}/, ea = /[+-]?\d{1,6}/, ta = /\d+/, na = /[+-]?\d+/, aa = /Z|[+-]\d\d:?\d\d/gi, ra = /[+-]?\d+(\.\d{1,3})?/, sa = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, ia = {}, oa = {}, da = 0, ua = 1, _a = 2, la = 3, ma = 4, ca = 5, ha = 6;
            ...
            }), b("month", "M"), U("M", Zn), U("MM", Zn, $n), U("MMM", sa), U("MMMM", sa), R([ "M", "MM" ], function(e, t) {
                t[ua] = L(e) - 1;
            ...
            U("YYYYYY", ea, Bn), R([ "YYYYY", "YYYYYY" ], da), R("YYYY", function(e, n) {
            ...
            U("DDDD", Kn), R([ "DDD", "DDDD" ], function(e, t, n) {
                n._dayOfYear = L(e);
            }), t.ISO_8601 = function() {};
            ...
            Oe("Z", ":"), Oe("ZZ", ""), U("Z", aa), U("ZZ", aa), R([ "Z", "ZZ" ], function(e, t, n) {
            ...
            }), A("Q", 0, 0, "quarter"), b("quarter", "Q"), U("Q", Vn), R("Q", function(e, t) {
                t[ua] = 3 * (L(e) - 1);
            }), A("D", [ "DD", 2 ], "Do", "date"), b("date", "D"), U("D", Zn), U("DD", Zn, $n), 
            U("Do", function(e, t) {
                return e ? t._ordinalParse : t._ordinalParseLenient;
            }), R([ "D", "DD" ], _a), R("Do", function(e, t) {
            ...
            U("h", Zn), U("HH", Zn, $n), U("hh", Zn, $n), R([ "H", "HH" ], la), R([ "a", "A" ], function(e, t, n) {
            ...
            for (Na = "S"; Na.length <= 9; Na += "S") R(Na, Bt);
            ...
            Ja.valueOf = gt, Ja.year = va, Ja.isLeapYear = _e, Ja.weekYear = Et, Ja.isoWeekYear = Wt, 
            ...
            Ja.day = Ja.days = Gt, Ja.weekday = Rt, Ja.isoWeekday = It, Ja.dayOfYear = Le, Ja.hour = Ja.hours = Oa, 
            Ja.minute = Ja.minutes = Ca, Ja.second = Ja.seconds = za, Ja.millisecond = Ja.milliseconds = Ua, 
            Ja.utcOffset = Ue, Ja.utc = Ge, Ja.local = Re, Ja.parseZone = Ie, Ja.hasAlignedHourOffset = Ve, 
            ...
            Ba._calendar = Ra, Ba.calendar = tn, Ba._longDateFormat = Ia, Ba.longDateFormat = nn, 
            ...
            Ba.firstDayOfWeek = ce, Ba.weekdays = zt, Ba._weekdays = Ea, Ba.weekdaysMin = Ut, 
            ...
            R("X", function(e, t, n) {
                ...
                n._d = new Date(L(e));
            }), t.version = "2.10.6", a(xe), t.fn = Ga, t.min = Ee, t.max = We, t.utc = u, t.unix = Qt, 
