!function(e) {
            ...
            function s(n, s) {
                function u() {
                    ...
                    i += "?timeout=" + h, p = new a("POST", i, JSON.stringify(t)).then(function(t) {
                        ...
                        var a = n.data, r = n.status;
                        a && a.code && (r = a.code), "Namespace" != t.kind || 409 !== r && 403 !== r ? (e("create failed:", i, a || n), 
    ...
    !function() {
        ...
        var i = n(32), s = n(42);
        n(40), i.module("kubeClient.cockpit", [ "kubeClient" ]).factory("CockpitKubeWatch", [ "$q", "KUBE_SCHEMA", "cockpitKubeDiscover", function(n, a, r) {
            return function(a, o) {
                function l(e) {
                    e ? (h = L, L = {}) : h = null, u(!0);
                }
            ...
            function i(e, t) {
                ...
                return e && e.server && (n = document.createElement("a"), n.href = e.server, n.hostname && (o.address = n.hostname), 
                n.port && (o.port = parseInt(n.port, 10)), "https:" == n.protocol && (n.port && "0" !== n.port || (o.port = n.href == e.server ? 6443 : 443), 
                o.tls = {}, o.tls.authority = a(e, "certificate-authority"), o.tls.validate = !e["insecure-skip-tls-verify"])), 
                t && (i = t.token, s = t["auth-provider"] || {}, s.config && (s.config["access-token"] ? i = s.config["access-token"] : s.config.token && (i = s.config.token)), 
                i && (o.headers.Authorization = "Bearer " + i), t.username && (o.headers.Authorization = "Basic " + r(t.username, t.password || "")), 
                o.tls && (o.tls.certificate = a(t, "client-certificate"), o.tls.key = a(t, "client-key"))), 
                o;
            }
            function s(t, n) {
                var a, r;
            ...
            function o() {
                ...
                return n([ "kubectl", "config", "view", "--minify", "--output=json" ]).then(function(t) {
                    var a, r, i;
                    try {
                        i = JSON.parse(t).users[0], i && i.user && (r = i.user["auth-provider"]);
                    } catch (e) {
                        console.warn("received invalid kubectl config", e);
                    }
                    return a = r ? n([ "kubectl", "version" ]).then(function() {
                        return n(e);
                    }, function() {
                        return n(e);
                    }) : n(e);
    ...
    !function() {
        var e = n(32), t = n(61);
        n(40), e.module("kubernetes.date", [ "kubeClient" ]).factory("momentLib", [ function() {
            return t;
    ...
    }, a.resolve = r, e.exports = a, a.id = 63;
}, function(e, t, n) {
    ...
    !function() {
        var e = n(32);
        n(35), n(40), n(41), n(192), n(199), n(200), n(201), e.module("kubernetes.app", [ "ui.bootstrap", "kubeClient", "kubeClient.cockpit", "kubernetes.connection" ]).controller("MainCtrl", [ "$scope", "$location", "$rootScope", "$timeout", "$modal", "kubeLoader", "kubeSelect", "KubeDiscoverSettings", "filterService", "connectionActions", function(t, n, a, r, i, s, o, l, u, c) {
            function d() {
    ...
    !function() {
        var e = n(32);
        n(44), n(41), n(149), n(193), n(194), n(181), n(184), n(195), n(196), n(197), n(198), 
    ...
    !function() {
        var e = n(32);
        n(40), e.module("registry.policy", [ "kubeClient" ]).factory("projectPolicy", [ "$q", "$rootScope", "kubeLoader", "kubeMethods", function(t, n, a, r) {
            function i(t, n) {
    ...
    !function() {
        ...
        var a = n(32);
        n(33), n(44), n(40), n(60), n(234), n(214), n(235), n(187), n(190), n(173), n(236), 
        n(237), n(237), n(238), a.module("registry.images", [ "ngRoute", "ui.cockpit", "kubeClient", "kubernetes.date", "registry.tags", "registryUI.images" ]).config([ "$routeProvider", function(e) {
        ...
        !function() {
            angular.module("registryUI.date", []).provider("MomentLib", [ function() {
                ...
                return "function" == typeof e && (e.createFromInputFallback = function(e) {
                    e._d = new Date(e._i);
                }), t.$stateful = !0, "function" == typeof e ? t : n;
            } ]);
        }();
    }, function(e, t) {
        !function() {
    ...
    !function() {
        var e = n(32);
        n(33), n(34), n(35), n(191), n(60), n(233), n(215), n(214), n(40), n(41), n(174);
        var t = 15, a = 8;
