!function(e) {
    ...
    !function(e, t, n) {
        ...
        function r(e) {
            ...
            var t = e.length;
            return !(e.nodeType !== va || !t) || (b(e) || ca(e) || 0 === t || "number" == typeof t && t > 0 && t - 1 in e);
        }
        function i(e, t, n) {
            var a, s;
            if (e) if (k(e)) for (a in e) "prototype" == a || "length" == a || "name" == a || e.hasOwnProperty && !e.hasOwnProperty(a) || t.call(n, e[a], a, e); else if (ca(e) || r(e)) {
        ...
        function P(e, t, n, a) {
            ...
            } else if (t = e, e) if (ca(e)) t = P(e, [], n, a); else if ($(e)) t = new Date(e.getTime()); else if (w(e)) t = new RegExp(e.source, e.toString().match(/[^\/]*$/)[0]), 
        ...
        function z(e) {
            ...
            var t = Qn("<div>").append(e).html();
            try {
                return e[0].nodeType === _a ? Gn(t) : t.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function(e, t) {
                    return "<" + Gn(t);
                });
            } catch (e) {
                return Gn(t);
        ...
        function G(e) {
            ...
            return i((e || "").split("&"), function(e) {
                if (e && (t = e.replace(/\+/g, "%20").split("="), n = q(t[0]), _(n))) {
                    var r = !_(t[1]) || q(t[1]);
                    Bn.call(a, n) ? ca(a[n]) ? a[n].push(r) : a[n] = [ a[n], r ] : a[n] = r;
                }
            }), a;
        }
        function B(e) {
        ...
        function Z(e, t) {
            var n, a, r = fa.length;
            for (e = Qn(e), a = 0; a < r; ++a) if (n = fa[a] + t, b(n = e.attr(n))) return n;
            return null;
        }
        function X(e, t) {
            var n, a, r = {};
        ...
        function Q(n, a, r) {
            ...
            e && !u.test(e.name) ? o() : (e.name = e.name.replace(u, ""), oa.resumeBootstrap = function(e) {
        ...
        function ae() {
            var t;
            ga || (ea = e.jQuery, ea && ea.fn.on ? (Qn = ea, d(ea.fn, {
                scope: Pa.scope,
                ...
                var n;
                if (ua) ua = !1; else for (var a, r = 0; null != (a = e[r]); r++) n = ea._data(a, "events"), 
                n && n.$destroy && ea(a).triggerHandler("$destroy");
                t(e);
            }) : Qn = be, oa.element = Qn, ga = !0);
        }
        function re(e, t, n) {
        ...
        function ie(e, t, n) {
            return n && ca(e) && (e = e[e.length - 1]), re(k(e), t, "not a function, got " + (e && "object" == typeof e ? e.constructor.name || "Object" : typeof e)), 
            e;
        }
        function se(e, t) {
        ...
        function pe(t) {
            ...
            ta("ng", [ "ngLocale" ], [ "$provide", function(e) {
                e.provider({
                    ...
                    ngInclude: oi
                }).directive(xr).directive(ai), e.provider({
                    $anchorScroll: ze,
                    $animate: qa,
                    $browser: Be,
                    $cacheFactory: Je,
        ...
        function _e(e, t) {
            ...
            if (ge(e)) l.push(t.createTextNode(e)); else {
                for (n = n || o.appendChild(t.createElement("div")), a = (Ea.exec(e) || [ "", "" ])[1].toLowerCase(), 
                r = Ha[a] || Ha._default, n.innerHTML = r[1] + e.replace(Aa, "<$1></$2>") + r[2], 
                s = r[0]; s--; ) n = n.lastChild;
                l = R(l, n.childNodes), n = o.firstChild, n.textContent = "";
            }
        ...
        function ye(e, n) {
            n = n || t;
            var a;
            return (a = ja.exec(e)) ? [ n.createElement(a[1]) ] : (a = _e(e, n)) ? a.childNodes : [];
        }
        function be(e) {
            if (e instanceof be) return e;
            var t;
            if (b(e) && (e = da(e), t = !0), !(this instanceof be)) {
                if (t && "<" != e.charAt(0)) throw Sa("nosel", "Looking up elements via selectors is not supported by jqLite! See: http://docs.angularjs.org/api/angular.element");
                return new be(e);
            }
            t ? Se(this, ye(e)) : Se(this, e);
        }
        function Me(e) {
        ...
        function ke(e, t, n, a) {
            if (_(a)) throw Sa("offargs", "jqLite#off() does not support the `selector` argument");
        ...
        function we(e, t) {
            var a = e.ng339, r = a && ka[a];
            if (r) {
                if (t) return void delete r.data[t];
                r.handle && (r.events.$destroy && r.handle({}, "$destroy"), ke(e)), delete ka[a], 
                e.ng339 = n;
            }
        }
        function Le(e, t) {
            var a = e.ng339, r = a && ka[a];
            return t && !r && (e.ng339 = a = fe(), r = ka[a] = {
                events: {},
                data: {},
                handle: n
            }), r;
        ...
        function Ce(e, t, a) {
            e.nodeType == ba && (e = e.documentElement);
            for (var r = ca(t) ? t : [ t ]; e; ) {
                for (var i = 0, s = r.length; i < s; i++) if ((a = Qn.data(e, r[i])) !== n) return a;
        ...
        function He(t, n) {
            n = n || e, "complete" === n.document.readyState ? n.setTimeout(t) : Qn(n).on("load", t);
        }
        function Pe(e, t) {
        ...
        function Oe(e, t) {
            var n = e.nodeName;
            return ("INPUT" === n || "TEXTAREA" === n) && Ra[t];
        }
        function Ie(e, t) {
            var n = function(n, a) {
        ...
        function We(e, t, n) {
            ...
            if ("function" == typeof e) {
                if (!(a = e.$inject)) {
                    if (a = [], e.length) {
                        if (t) throw b(n) && n || (n = e.name || Ne(e)), Va("strictdi", "{0} is not using explicit annotation and cannot be invoked in strict mode", n);
                        r = e.toString().replace(Wa, ""), s = r.match(Ua), i(s[1].split(Fa), function(e) {
                            e.replace(Na, function(e, t, n) {
                                a.push(n);
                            });
                        });
                    }
        ...
        function Ve(e, t) {
            ...
            function r(e, t) {
                if (se(e, "service"), (k(t) || ca(t)) && (t = D.instantiate(t)), !t.$get) throw Va("pget", "Provider '{0}' must define $get factory method.", e);
                return L[e + M] = t;
            }
            function s(e, t) {
                return function() {
                    var n = T.invoke(t, this);
                    if (v(n)) throw Va("undef", "Provider '{0}' must return a value from $get factory method.", e);
                    return n;
                };
            }
            function o(e, t, n) {
            ...
            function p(e) {
                ...
                return i(e, function(e) {
                    ...
                    if (!w.get(e)) {
                        w.put(e, !0);
                        try {
                            b(e) ? (t = ta(e), n = n.concat(p(t.requires)).concat(t._runBlocks), a(t._invokeQueue), 
                            a(t._configBlocks)) : k(e) ? n.push(D.invoke(e)) : ca(e) ? n.push(D.invoke(e)) : ie(e, "module");
                        } catch (t) {
                            throw ca(e) && (e = e[e.length - 1]), t.message && t.stack && t.stack.indexOf(t.message) == -1 && (t = t.message + "\n" + t.stack), 
                            Va("modulerr", "Failed to instantiate module {0} due to:\n{1}", e, t.stack || t.message || t);
                        }
                    }
                }), n;
            }
            function h(e, n) {
                function a(t, a) {
                    if (e.hasOwnProperty(t)) {
                        if (e[t] === _) throw Va("cdep", "Circular dependency found: {0}", t + " <- " + $.join(" <- "));
                        return e[t];
                    }
                    try {
                ...
                function r(e, n, r, i) {
                    ...
                    for (o = 0, s = c.length; o < s; o++) {
                        if (l = c[o], "string" != typeof l) throw Va("itkn", "Incorrect injection token! Expected service name as string, got {0}", l);
                        u.push(r && r.hasOwnProperty(l) ? r[l] : a(l, i));
                    }
                    return ca(e) && (e = e[s]), e.apply(n, u);
                }
                function i(e, t, n) {
            ...
            var _ = {}, M = "Provider", $ = [], w = new Fe([], !0), L = {
                ...
                throw oa.isString(t) && $.push(t), Va("unpr", "Unknown provider: {0}", $.join(" <- "));
        ...
        function Ge(e, t, a, r) {
            ...
            function c() {
                Y = e.history.state, Y = v(Y) ? null : Y, I(Y, A) && (Y = A), A = Y;
            }
            function d() {
                x === p.url() && T === Y || (x = p.url(), T = Y, i(C, function(e) {
                    e(p.url(), Y);
                }));
            }
            function m(e) {
            ...
            var p = this, h = t[0], g = e.location, _ = e.history, y = e.setTimeout, M = e.clearTimeout, $ = {};
            p.isMock = !1;
            var k = 0, w = [];
            p.$$completeOutstandingRequest = s, p.$$incOutstandingRequestCount = function() {
                k++;
            ...
            p.addPollFn = function(e) {
                return v(L) && l(100, y), D.push(e), e;
            };
            var Y, T, x = g.href, S = t.find("base"), j = null;
            c(), T = Y, p.url = function(t, n, a) {
                if (v(a) && (a = null), g !== e.location && (g = e.location), _ !== e.history && (_ = e.history), 
                t) {
                    var i = T === a;
                    if (x === t && (!r.history || i)) return p;
                    var s = x && Mt(x) === Mt(t);
                    return x = t, T = a, !r.history || s && i ? (s || (j = t), n ? g.replace(t) : s ? g.hash = o(t) : g.href = t) : (_[n ? "replaceState" : "pushState"](a, "", t), 
                    c(), T = Y), p;
                }
            ...
            p.onUrlChange = function(t) {
                return E || (r.history && Qn(e).on("popstate", u), Qn(e).on("hashchange", u), E = !0), 
                C.push(t), t;
            }, p.$$checkUrlChange = d, p.baseHref = function() {
                var e = S.attr("href");
                return e ? e.replace(/^(https?\:)?\/\/[^\/]*/, "") : "";
            };
            var H = {}, P = "", O = p.baseHref();
            p.cookies = function(e, t) {
                var r, i, s, o, l;
                if (!e) {
                    if (h.cookie !== P) for (P = h.cookie, i = P.split("; "), H = {}, o = 0; o < i.length; o++) s = i[o], 
                    l = s.indexOf("="), l > 0 && (e = m(s.substring(0, l)), H[e] === n && (H[e] = m(s.substring(l + 1))));
                    return H;
                }
                t === n ? h.cookie = encodeURIComponent(e) + "=;path=" + O + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : b(t) && (r = (h.cookie = encodeURIComponent(e) + "=" + encodeURIComponent(t) + ";path=" + O).length + 1, 
        ...
        function Ze(e, a) {
            function r(e, t) {
                ...
                return i(e, function(e, r) {
                    var i = e.match(n);
                    if (!i) throw Ga("iscp", "Invalid isolate scope definition for directive '{0}'. Definition: {... {1}: '{2}' ...}", t, r, e);
                    a[r] = {
                        mode: i[1][0],
                        collection: "*" === i[2],
                        optional: "?" === i[3],
            ...
            this.debugInfoEnabled = function(e) {
                return _(e) ? ($ = e, this) : $;
            }, this.$get = [ "$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(e, a, r, l, g, _, w, L, Y, T, x) {
                function S(e, t) {
                    try {
                        e.addClass(t);
                    } catch (e) {}
                ...
                function j(e, t, n, a, r) {
                    e instanceof Qn || (e = Qn(e)), i(e, function(t, n) {
                        t.nodeType == _a && t.nodeValue.match(/\S+/) && (e[n] = Qn(t).wrap("<span></span>").parent()[0]);
                    });
                    var s = E(e, t, e, n, a, r);
                    j.$$addScopeClass(e);
                    var o = null;
                    return function(t, n, a) {
                        ...
                        var u;
                        if (u = "html" !== o ? Qn(X(o, Qn("<div>").append(e).html())) : n ? Pa.clone.call(e) : e, 
                ...
                function E(e, t, a, r, i, s) {
                    function o(e, a, r, i) {
                        ...
                        j.$$addScopeInfo(Qn(l), u)) : u = e, p = s.transcludeOnThisElement ? P(e, s.transclude, i, s.elementTranscludeOnThisElement) : !s.templateOnThisElement && i ? i : !i && t ? P(e, t) : null, 
                    ...
                    switch (o) {
                      case va:
                        ...
                        for (var d, m, p, f, h, g, v = e.attributes, _ = 0, M = v && v.length; _ < M; _++) {
                            var $ = !1, k = !1;
                            d = v[_], m = d.name, h = da(d.value), f = Xe(m), (g = de.test(f)) && (m = m.replace(Ba, "").substr(8).replace(/_(.)/g, function(e, t) {
                        ...
                        V(t, p, "C", a, r) && (n[p] = da(i[3])), s = s.substr(i.index + i[0].length);
                        break;
                      ...
                      case ya:
                        try {
                            i = u.exec(e.nodeValue), i && (p = Xe(i[1]), V(t, p, "M", a, r) && (n[p] = da(i[2])));
                        } catch (e) {}
                    }
                    return t.sort(J), t;
                }
                function R(e, t, n) {
                    ...
                    if (t && e.hasAttribute && e.hasAttribute(t)) {
                        do {
                            if (!e) throw Ga("uterdir", "Unterminated attribute, found '{0}' but no matching '{1}' found.", t, n);
                ...
                function F(e, t, n) {
                    return function(a, r, i, s, o) {
                        return r = R(r[0], t, n), e(a, r, i, s, o);
                    };
                }
                function N(e, s, o, l, u, c, d, m, p) {
                    function f(e, t, n, a) {
                        e && (n && (e = F(e, n, a)), e.require = L.require, e.directiveName = Y, (A === L || L.$$isolateScope) && (e = ae(e, {
                            isolateScope: !0
                        })), d.push(e)), t && (n && (t = F(t, n, a)), t.require = L.require, t.directiveName = Y, 
                    ...
                    function h(e, t, n, a) {
                        ...
                        if (b(t)) {
                            ...
                            r = r || u[o]("$" + t + "Controller"), !r && !l) throw Ga("ctreq", "Controller '{0}', required by directive '{1}', can't be found!", t, e);
                            return r || null;
                        }
                    ...
                    function M(e, t, r, l, u) {
                        ...
                        var p, f, v, y, b, M, $, k, L;
                        if (s === r ? (L = o, k = o.$$element) : (k = Qn(r), L = new se(k, o)), A && (b = t.$new(!0)), 
                                ...
                                switch (c) {
                                  ...
                                  case "=":
                                    ...
                                    i = g(L[l]), o = i.literal ? I : function(e, t) {
                                        ...
                                        throw r = T[n] = i(t), Ga("nonassign", "Expression '{0}' used with directive '{1}' is non-assignable!", L[l], A.name);
                                    }, r = T[n] = i(t);
                                    var d = function(e) {
                        ...
                        var x = t;
                        for (A && (A.template || null === A.templateUrl) && (x = b), e && e(x, r.childNodes, n, u), 
                        p = m.length - 1; p >= 0; p--) v = m[p], ie(v, v.isolateScope ? b : t, k, L, v.require && h(v.directiveName, v.require, k, M), $);
                    }
                    p = p || {};
                    for (var $, w, L, Y, T, x, S, C = -Number.MAX_VALUE, E = p.controllerDirectives, A = p.newIsolateScopeDirective, H = p.templateDirective, P = p.nonTlbTranscludeDirective, N = !1, V = !1, q = p.hasElementTranscludeDirective, J = o.$$element = Qn(s), Z = c, Q = l, ee = 0, ne = e.length; ee < ne; ee++) {
                        L = e[ee];
                        var re = L.$$start, oe = L.$$end;
                        if (re && (J = R(s, re, oe)), T = n, C > L.priority) break;
                        if ((S = L.scope) && (L.templateUrl || (y(S) ? (K("new/isolated scope", A || $, L, J), 
                        A = L) : K("new/isolated scope", A, L, J)), $ = $ || L), Y = L.name, !L.templateUrl && L.controller && (S = L.controller, 
                        E = E || {}, K("'" + Y + "' controller", E[Y], L, J), E[Y] = L), (S = L.transclude) && (N = !0, 
                        L.$$tlb || (K("transclusion", P, L, J), P = L), "element" == S ? (q = !0, C = L.priority, 
                        T = J, J = o.$$element = Qn(t.createComment(" " + Y + ": " + o[Y] + " ")), s = J[0], 
                        te(u, U(T), s), Q = j(T, l, C, Z && Z.name, {
                            nonTlbTranscludeDirective: P
                        })) : (T = Qn(Me(s)).contents(), J.empty(), Q = j(T, l))), L.template) if (V = !0, 
                        K("template", H, L, J), H = L, S = k(L.template) ? L.template(J, o) : L.template, 
                        S = ce(S), L.replace) {
                            if (Z = L, T = ge(S) ? [] : et(X(L.templateNamespace, da(S))), s = T[0], 1 != T.length || s.nodeType !== va) throw Ga("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", Y, "");
                            te(u, J, s);
                            var le = {
                                $attr: {}
                        ...
                        M = B(e.splice(ee, e.length - ee), J, o, u, N && Q, d, m, {
                            ...
                            x = L.compile(J, o, Q), k(x) ? f(null, x, re, oe) : x && f(x.pre, x.post, re, oe);
                        } catch (e) {
                            r(e, z(J));
                        }
                ...
                function G(e, t) {
                    ...
                    i(e, function(a, r) {
                        ...
                        "class" == i ? (S(r, t), e.class = (e.class ? e.class + " " : "") + t) : "style" == i ? (r.attr("style", r.attr("style") + ";" + t), 
                ...
                function B(e, t, n, a, r, s, o, u) {
                    ...
                    return t.empty(), l(Y.getTrustedResourceUrl(v)).then(function(l) {
                        var p, b, M, $;
                        if (l = ce(l), h.replace) {
                            if (M = ge(l) ? [] : et(X(_, da(l))), p = M[0], 1 != M.length || p.nodeType !== va) throw Ga("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", h.name, v);
                            b = {
                                $attr: {}
                            }, te(a, t, p);
                            var k = O(p, [], b);
                        ...
                        for (e.unshift(g), c = N(e, p, n, r, t, h, s, o, u), i(a, function(e, n) {
                            ...
                            if (!w.$$destroyed) {
                                if (L !== f) {
                                    var x = L.className;
                                    u.hasElementTranscludeDirective && h.replace || (T = Me(p)), te(D, Qn(L), T), S(Qn(T), x);
                                }
                ...
                function K(e, t, n, a) {
                    if (t) throw Ga("multidir", "Multiple directives [{0}, {1}] asking for {2} on: {3}", t.name, n.name, e, z(a));
                }
                function Z(e, t) {
                    var n = a(t, !0);
                    n && e.push({
                ...
                function ee(e, t, n, r, i) {
                    ...
                    var o = a(n, !0, s, i);
                    if (o) {
                        if ("multiple" === r && "select" === A(e)) throw Ga("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", z(e));
                        t.push({
                            priority: 100,
                            compile: function() {
                                return {
                                    pre: function(e, t, l) {
                                        ...
                                        if (M.test(r)) throw Ga("nodomevents", "Interpolations for HTML DOM event attributes are disallowed.  Please use the ng- versions (such as ng-click instead of onclick) instead.");
                                        var c = l[r];
                ...
                function te(e, n, a) {
                    ...
                    m.appendChild(s), Qn(a).data(Qn(s).data()), ea ? (ua = !0, ea.cleanData([ s ])) : delete Qn.cache[s[Qn.expando]];
                    for (var p = 1, f = n.length; p < f; p++) {
                        var h = n[p];
                        Qn(h).remove(), m.appendChild(h), delete n[p];
                    }
                    n[0] = a, n.length = 1;
                }
                function ae(e, t) {
                ...
                se.prototype = {
                    ...
                    $set: function(e, t, a, s) {
                        ...
                        o = A(this.$$element), "a" === o && "href" === e || "img" === o && "src" === e) this[e] = t = x(t, "src" === e); else if ("img" === o && "srcset" === e) {
                            for (var m = "", p = da(t), f = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, h = /\s/.test(p) ? f : /(,)/, g = p.split(h), v = Math.floor(g.length / 2), _ = 0; _ < v; _++) {
                                var y = 2 * _;
                                m += x(da(g[y]), !0), m += " " + da(g[y + 1]);
                            }
                            var b = da(g[2 * _]).split(/\s/);
                            m += x(da(b[0]), !0), 2 === b.length && (m += " " + da(b[1])), this[e] = t = m;
                        }
                ...
                return j.$$addBindingInfo = $ ? function(e, t) {
                    ...
                    S(e, t ? "ng-isolate-scope" : "ng-scope");
                } : f, j;
            } ];
        }
        function Xe(e) {
            return he(e.replace(Ba, ""));
        }
        function Qe(e, t) {
            ...
            this.register = function(t, n) {
                ...
                return function(a, l, u, c) {
                    ...
                    if (u = u === !0, c && b(c) && (h = c), b(a)) {
                        if (p = a.match(r), !p) throw Ja("ctrlfmt", "Badly formed controller string '{0}'. Must match `__name__ as __id__` or `__name__`.", a);
        ...
        function it(e) {
            var t = e.match(Xa);
            return t && Qa[t[0]].test(e);
        }
        function st(e) {
            var t, n, a, r = ue();
            return e ? (i(e.split("\n"), function(e) {
                a = e.indexOf(":"), t = Gn(da(e.substr(0, a))), n = da(e.substr(a + 1)), t && (r[t] = r[t] ? r[t] + ", " + n : n);
            }), r) : r;
        }
        function ot(e) {
            var t = y(e) ? e : n;
            ...
            this.$get = [ "$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(s, l, u, c, m, p) {
                function f(t) {
                    ...
                    function o(t) {
                        ...
                        i = d({}, i.common, i[Gn(t.method)]);
                        e: for (n in i) {
                            a = Gn(n);
                            for (r in o) if (Gn(r) === a) continue e;
                            o[n] = i[n];
                        }
                        return s(o);
                    }
                ...
                function M(a, r) {
                    ...
                    function o(e, t, n, r) {
                        t = Math.max(t, 0), (ut(t) ? g.resolve : g.reject)({
                            data: e,
                            status: t,
                            headers: ot(n),
                            config: a,
                    ...
                    p && (h = p.get($), _(h) ? j(h) ? h.then(u, u) : ca(h) ? o(h[1], h[0], O(h[2]), h[3]) : o(h, 200, {}, "OK") : p.put($, b)), 
                    v(h)) {
                        var k = rn(a.url) ? l.cookies()[a.xsrfCookieName || e.xsrfCookieName] : n;
        ...
        function pt(e, t, a, r, s) {
            function o(e, t, n) {
                ...
                }, La(a, "load", i), La(a, "error", i), s.body.appendChild(a), i;
            }
            return function(s, l, u, c, d, m, p, h) {
                ...
                if (e.$$incOutstandingRequestCount(), l = l || e.url(), "jsonp" == Gn(s)) {
                    ...
                    M.open(s, l, !0), i(d, function(e, t) {
                        ...
                        0 === n && (n = t ? 200 : "file" == an(l).protocol ? 404 : 0), v(c, n, t, M.getAllResponseHeaders(), e);
                    };
                    var $ = function() {
                        v(c, -1, null, null, "");
                    };
        ...
        function Lt(e, t) {
            this.$$html5 = !0, t = t || "";
            var a = kt(e);
            _t(e, this), this.$$parse = function(e) {
                var t = bt(a, e);
                if (!b(t)) throw rr("ipthprfx", 'Invalid url "{0}", missing path prefix "{1}".', e, a);
                yt(t, this), this.$$path || (this.$$path = "/"), this.$$compose();
            }, this.$$compose = function() {
                var e = B(this.$$search), t = this.$$hash ? "#" + J(this.$$hash) : "";
                this.$$url = vt(this.$$path) + (e ? "?" + e : "") + t, this.$$absUrl = a + this.$$url.substr(1);
            }, this.$$parseLinkUrl = function(r, i) {
                if (i && "#" === i[0]) return this.hash(i.slice(1)), !0;
                var s, o, l;
                return (s = bt(e, r)) !== n ? (o = s, l = (s = bt(t, s)) !== n ? a + (bt("/", s) || s) : e + o) : (s = bt(a, r)) !== n ? l = a + s : a == r + "/" && (l = a), 
                l && this.$$parse(l), !!l;
            };
        }
        function Dt(e, t) {
            ...
            _t(e, this), this.$$parse = function(a) {
                ...
                var i, s = bt(e, a) || bt(n, a);
                "#" === s.charAt(0) ? (i = bt(t, s), v(i) && (i = s)) : i = this.$$html5 ? s : "", 
                yt(i, this), this.$$path = r(this.$$path, i, e), this.$$compose();
            }, this.$$compose = function() {
                var n = B(this.$$search), a = this.$$hash ? "#" + J(this.$$hash) : "";
        ...
        function Yt(e, t) {
            ...
            this.$$parseLinkUrl = function(a, r) {
                ...
                var i, s;
                return e == Mt(a) ? i = a : (s = bt(n, a)) ? i = e + t + s : n === a + "/" && (i = n), 
                i && this.$$parse(i), !!i;
            }, this.$$compose = function() {
                var n = B(this.$$search), a = this.$$hash ? "#" + J(this.$$hash) : "";
        ...
        function St() {
            ...
            this.hashPrefix = function(t) {
                ...
                return S(e) ? (t.enabled = e, this) : y(e) ? (S(e.enabled) && (t.enabled = e.enabled), 
                S(e.requireBase) && (t.requireBase = e.requireBase), S(e.rewriteLinks) && (t.rewriteLinks = e.rewriteLinks), 
                this) : t;
                ...
                u = new c(d, "#" + e), u.$$parseLinkUrl(p, p), u.$$state = a.state();
                var f = /^\s*(javascript|mailto):/i;
                i.on("click", function(e) {
                    if (t.rewriteLinks && !e.ctrlKey && !e.metaKey && !e.shiftKey && 2 != e.which && 2 != e.button) {
                        for (var r = Qn(e.target); "a" !== A(r[0]); ) if (r[0] === i[0] || !(r = r.parent())[0]) return;
                        var o = r.prop("href"), l = r.attr("href") || r.attr("xlink:href");
                        y(o) && "[object SVGAnimatedString]" === o.toString() && (o = an(o.animVal).href), 
                        f.test(o) || !o || r.attr("target") || e.isDefaultPrevented() || u.$$parseLinkUrl(o, l) && (e.preventDefault(), 
                ...
                return a.onUrlChange(function(e, t) {
                    n.$evalAsync(function() {
                        ...
                        u.absUrl() === e && (a ? (u.$$parse(r), u.$$state = i, o(r, !1, i)) : (h = !1, l(r, i)));
                    }), n.$$phase || n.$digest();
                }), n.$watch(function() {
        ...
        function At(e, t) {
            if (e) {
                if (e.constructor === e) throw sr("isecfn", "Referencing Function in Angular expressions is disallowed! Expression: {0}", t);
                if (e === or || e === lr || e === ur) throw sr("isecff", "Referencing call, apply or bind in Angular expressions is disallowed! Expression: {0}", t);
            }
        }
        function Ht(e) {
            return e.constant;
        ...
        function Pt(e, t, n, a, r) {
            ...
            return i = Ct(s.shift(), r), Et(e[i], r), e[i] = a, a;
        }
        function Ot(e) {
        ...
        function It(e, t, a, r, i, s, o) {
            ...
            var l = function(e) {
                return Et(e, s);
            }, u = o || Ot(e) ? l : h, c = o || Ot(t) ? l : h, d = o || Ot(a) ? l : h, m = o || Ot(r) ? l : h, p = o || Ot(i) ? l : h;
            return function(s, o) {
        ...
        function Ut(e, t, a) {
            ...
            if (t.csp) o = u < 6 ? It(l[0], l[1], l[2], l[3], l[4], a, r) : function(e, t) {
                var i, s = 0;
                do i = It(l[s++], l[s++], l[s++], l[s++], l[s++], a, r)(e, t), t = n, e = i; while (s < u);
                return i;
            }; else {
                var c = "";
                r && (c += "s = eso(s, fe);\nl = eso(l, fe);\n");
        ...
        function Ft(e) {
            return k(e.valueOf) ? e.valueOf() : vr.call(e);
        }
        function Nt() {
            var e = ue(), t = ue();
                    ...
                    switch (typeof a) {
                      case "string":
                        ...
                        if (o = _[v], !o) {
                            ...
                            var y = s ? h : p, b = new pr(y), M = new fr(b, n, y);
        ...
        function Gt() {
            ...
            this.digestTtl = function(t) {
            ...
            }, this.$get = [ "$injector", "$exceptionHandler", "$parse", "$browser", function(a, o, l, c) {
                function d() {
                ...
                d.prototype = {
                    ...
                    $watch: function(e, t, a) {
                        ...
                        return n = null, k(t) || (o.fn = f), s || (s = i.$$watchers = []), s.unshift(o), 
                        function() {
                            H(s, o), n = null;
                        };
                    },
                    ...
                    $watchCollection: function(e, t) {
                        ...
                        function a() {
                            if (h ? (h = !1, t(i, i, u)) : t(i, o, u), c) if (y(i)) if (r(i)) {
                                o = new Array(i.length);
                                for (var e = 0; e < i.length; e++) o[e] = i[e];
                            } else {
                                o = {};
                                for (var n in i) Bn.call(i, n) && (o[n] = i[n]);
                            } else o = i;
                        }
                        n.$stateful = !0;
                        var i, s, o, u = this, c = t.length > 1, d = 0, m = l(e, n), p = [], f = {}, h = !0, g = 0;
                        return this.$watch(m, a);
                    },
                    $digest: function() {
                        var a, r, i, l, u, d, f, h, v, y, b = e, L = this, D = [];
                        ...
                        do {
                            ...
                            e: do {
                                if (l = h.$$watchers) for (u = l.length; u--; ) try {
                                    if (a = l[u]) if ((r = a.get(h)) === (i = a.last) || (a.eq ? I(r, i) : "number" == typeof r && "number" == typeof i && isNaN(r) && isNaN(i))) {
                                        if (a === n) {
                                            d = !1;
                                            break e;
                                        }
                                    } else d = !0, n = a, a.last = a.eq ? P(r, null) : r, a.fn(r, i === g ? r : i, h), 
                                    b < 5 && (v = 4 - b, D[v] || (D[v] = []), D[v].push({
                                ...
                                if (!(f = h.$$childHead || h !== L && h.$$nextSibling)) for (;h !== L && !(f = h.$$nextSibling); ) h = h.$parent;
                            } while (h = f);
                            if ((d || $.length) && !b--) throw p(), t("infdig", "{0} $digest() iterations reached. Aborting!\nWatchers fired in the last 5 iterations: {1}", e, D);
                        } while (d || $.length);
                        for (p(); w.length; ) try {
                            w.shift()();
                        } catch (e) {
                    ...
                    $broadcast: function(e, t) {
                        ...
                        for (var s, l, u, c = R([ i ], arguments, 1); a = r; ) {
                            for (i.currentScope = a, s = a.$$listeners[e] || [], l = 0, u = s.length; l < u; l++) if (s[l]) try {
                                s[l].apply(null, c);
                            } catch (e) {
                                o(e);
                            } else s.splice(l, 1), l--, u--;
        ...
        function Jt(e) {
            if ("self" === e) return e;
            if (b(e)) {
                if (e.indexOf("***") > -1) throw _r("iwcard", "Illegal sequence *** in string matcher.  String: {0}", e);
        ...
        function Zt() {
            ...
            this.resourceUrlWhitelist = function(t) {
                ...
                function o(e, t) {
                    ...
                    if (!a) throw _r("icontext", "Attempted to trust a value in invalid context. Context: {0}; Value: {1}", e, t);
                    if (null === t || t === n || "" === t) return t;
                    if ("string" != typeof t) throw _r("itype", "Attempted to trust a non-string value in a content requiring a string: Context: {0}", e);
                    return new a(t);
                }
                function l(e) {
                ...
                function u(e, t) {
                    ...
                    if (e === yr.RESOURCE_URL) {
                        if (i(t)) return t;
                        throw _r("insecurl", "Blocked loading resource from url not allowed by $sceDelegate policy.  URL: {0}", t.toString());
                    }
                ...
                var d = s(), m = {};
                return m[yr.HTML] = s(d), m[yr.CSS] = s(d), m[yr.URL] = s(d), m[yr.JS] = s(d), m[yr.RESOURCE_URL] = s(m[yr.URL]), 
                {
                    trustAs: o,
                    getTrusted: u,
                    valueOf: l
        ...
        function Xt() {
            ...
            this.enabled = function(t) {
                ...
                if (e && Xn < 8) throw _r("iequirks", "Strict Contextual Escaping does not support Internet Explorer version < 11 in quirks mode.  You can fix this by adding the text <!doctype html> to the top of your HTML document.  See http://docs.angularjs.org/api/ng.$sce for more information.");
                var a = O(yr);
        ...
        function Qt() {
            this.$get = [ "$window", "$document", function(e, t) {
                var n, a, r = {}, i = m((/android (\d+)/.exec(Gn((e.navigator || {}).userAgent)) || [])[1]), s = /Boxee/i.test((e.navigator || {}).userAgent), o = t[0] || {}, l = /^(Moz|webkit|ms)(?=[A-Z])/, u = o.body && o.body.style, c = !1, d = !1;
                if (u) {
        ...
        function en() {
            this.$get = [ "$templateCache", "$http", "$q", function(e, t, n) {
                function a(r, i) {
                    function s(e) {
                        if (!i) throw Ga("tpload", "Failed to load template: {0}", r);
                        return n.reject(e);
                    }
        ...
        function an(e) {
            var t = e;
            return Xn && (br.setAttribute("href", t), t = br.href), br.setAttribute("href", t), 
            {
                href: br.href,
        ...
        function on(e) {
            ...
            } ], t("currency", dn), t("date", $n), t("filter", ln), t("json", kn), t("limitTo", wn), 
            t("lowercase", Dr), t("number", mn), t("orderBy", Ln), t("uppercase", Yr);
        }
        function ln() {
        ...
        function un(e, t, n) {
            ...
            return t === !0 ? t = I : k(t) || (t = function(e, t) {
                return !y(e) && !y(t) && (e = Gn("" + e), t = Gn("" + t), e.indexOf(t) !== -1);
            }), a = function(a) {
        ...
        function dn(e) {
            ...
            return function(e, n, a) {
                return v(n) && (n = t.CURRENCY_SYM), v(a) && (a = t.PATTERNS[1].maxFrac), null == e ? e : pn(e, t.PATTERNS[1], t.GROUP_SEP, t.DECIMAL_SEP, a).replace(/\u00A4/g, n);
            };
        }
        function mn(e) {
            var t = e.NUMBER_FORMATS;
        ...
        function hn(e, t, n, a) {
            return n = n || 0, function(r) {
                var i = r["get" + e]();
                return (n > 0 || i > -n) && (i += n), 0 === i && n == -12 && (i = 12), fn(i, t, a);
            };
        }
        function gn(e, t) {
            return function(n, a) {
        ...
        function bn(e) {
            return function(t) {
                var n = _n(t.getFullYear()), a = yn(t), r = +a - +n, i = 1 + Math.round(r / 6048e5);
                return fn(i, e);
            };
        }
        function Mn(e, t) {
        ...
        function $n(e) {
            ...
            return function(n, a, r) {
                var s, o, l = "", u = [];
                if (a = a || "mediumDate", a = e.DATETIME_FORMATS[a] || a, b(n) && (n = Lr.test(n) ? m(n) : t(n)), 
                M(n) && (n = new Date(n)), !$(n)) return n;
                for (;a; ) o = wr.exec(a), o ? (u = R(u, o, 1), a = u.pop()) : (u.push(a), a = null);
                return r && "UTC" === r && (n = new Date(n.getTime()), n.setMinutes(n.getMinutes() + n.getTimezoneOffset())), 
                i(u, function(t) {
                    s = kr[t], l += s ? s(n, e.DATETIME_FORMATS) : t.replace(/(^'|'$)/g, "").replace(/''/g, "'");
                }), l;
            };
        }
        function kn() {
        ...
        function wn() {
            return function(e, t) {
                return M(e) && (e = e.toString()), ca(e) || b(e) ? (t = Math.abs(Number(t)) === 1 / 0 ? Number(t) : m(t), 
        ...
        function Tn(e, t, a, r, s) {
            var o = this, l = [], u = o.$$parentForm = e.parent().controller("form") || Sr;
            ...
            u.$addControl(o), o.$rollbackViewValue = function() {
                ...
                r.removeClass(e, mi), r.addClass(e, pi), o.$dirty = !0, o.$pristine = !1, u.$setDirty();
            }, o.$setPristine = function() {
                r.setClass(e, mi, pi + " " + jr), o.$dirty = !1, o.$pristine = !0, o.$submitted = !1, 
                i(l, function(e) {
                    e.$setPristine();
                });
        ...
        function jn(e, t, n, a, r, i) {
            ...
            var l = function(e) {
                if (u && (i.defer.cancel(u), u = null), !o) {
                    ...
                    "password" === s || n.ngTrim && "false" === n.ngTrim || (r = da(r)), (a.$viewValue !== r || "" === r && a.$$hasNativeValidators) && a.$setViewValue(r, l);
                }
            };
        ...
        function Cn(e, t) {
            ...
            if (b(e)) {
                ...
                var n = Fr.exec(e);
                if (n) {
                    var a = +n[1], r = +n[2], i = 0, s = 0, o = 0, l = 0, u = _n(a), c = 7 * (r - 1);
        ...
        function Pn(e, t, a, r, i, s) {
            if (Hn(e, t, a, r), jn(e, t, a, r, i, s), r.$$parserName = "number", r.$parsers.push(function(e) {
                return r.$isEmpty(e) ? null : Ir.test(e) ? parseFloat(e) : n;
            }), r.$formatters.push(function(e) {
                if (!r.$isEmpty(e)) {
                    if (!M(e)) throw vi("numfmt", "Expected `{0}` to be a number", e);
                    e = e.toString();
                }
                return e;
            }), _(a.min) || a.ngMin) {
        ...
        function On(e, t, n, a, r, i) {
            jn(e, t, n, a, r, i), xn(a), a.$$parserName = "url", a.$validators.url = function(e, t) {
                var n = e || t;
                return a.$isEmpty(n) || Pr.test(n);
            };
        }
        function In(e, t, n, a, r, i) {
            jn(e, t, n, a, r, i), xn(a), a.$$parserName = "email", a.$validators.email = function(e, t) {
                var n = e || t;
        ...
        function Fn(e, t, n, a, r, i, s, o) {
            var l = Un(o, e, "ngTrueValue", n.ngTrueValue, !0), u = Un(o, e, "ngFalseValue", n.ngFalseValue, !1), c = function(e) {
        ...
        function Wn(e) {
            function t(e, t, l) {
                t === n ? a("$pending", e, l) : r("$pending", e, l), S(t) ? t ? (d(o.$error, e, l), 
                c(o.$$success, e, l)) : (c(o.$error, e, l), d(o.$$success, e, l)) : (d(o.$error, e, l), 
                d(o.$$success, e, l)), o.$pending ? (i(gi, !0), o.$valid = o.$invalid = n, s("", null)) : (i(gi, !1), 
                o.$valid = Vn(o.$error), o.$invalid = !o.$valid, s("", o.$valid));
                var u;
            ...
            u[di] = !(u[ci] = l.hasClass(ci)), o.$setValidity = t;
        }
        function Vn(e) {
            if (e) for (var t in e) return !1;
            return !0;
        }
        var zn = /^\/(.+)\/([a-z]*)$/, qn = "validity", Gn = function(e) {
            return b(e) ? e.toLowerCase() : e;
        }, Bn = Object.prototype.hasOwnProperty, Jn = function(e) {
        ...
        "i" !== "I".toLowerCase() && (Gn = Kn, Jn = Zn);
        var Xn, Qn, ea, ta, na = [].slice, aa = [].splice, ra = [].push, ia = Object.prototype.toString, sa = a("ng"), oa = e.angular || (e.angular = {}), la = 0;
        Xn = t.documentMode, f.$inject = [], h.$inject = [];
        var ua, ca = Array.isArray, da = function(e) {
            return b(e) ? e.trim() : e;
        }, ma = function(e) {
            return e.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g, "\\$1").replace(/\x08/g, "\\x08");
        }, pa = function() {
            if (_(pa.isActive_)) return pa.isActive_;
            ...
            return pa.isActive_ = e;
        }, fa = [ "ng-", "data-ng-", "ng:", "x-ng-" ], ha = /[A-Z]/g, ga = !1, va = 1, _a = 3, ya = 8, ba = 9, Ma = 11, $a = {
            full: "1.3.14",
            major: 1,
            minor: 3,
            dot: 14,
        ...
        be.expando = "ng339";
        var ka = be.cache = {}, wa = 1, La = function(e, t, n) {
        ...
        var Ya = /([\:\-\_]+(.))/g, Ta = /^moz([A-Z])/, xa = {
            mouseleave: "mouseout",
            mouseenter: "mouseover"
        }, Sa = a("jqLite"), ja = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Ca = /<|&#?\w+;/, Ea = /<([\w:]+)/, Aa = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ha = {
        ...
        var Pa = be.prototype = {
            ...
            eq: function(e) {
                return Qn(e >= 0 ? this[e] : this[this.length + e]);
            },
            length: 0,
            push: ra,
            sort: [].sort,
        ...
        i({
            ...
            inheritedData: Ce,
            scope: function(e) {
                return Qn.data(e, "$scope") || Ce(e.parentNode || e, [ "$isolateScope", "$scope" ]);
            },
            ...
            attr: function(e, t, a) {
                var r = Gn(t);
                if (Oa[r]) {
                    if (!_(a)) return e[t] || (e.attributes.getNamedItem(t) || f).specified ? r : n;
            ...
            text: function() {
                function e(e, t) {
                    if (v(t)) {
                        var n = e.nodeType;
                        return n === va || n === _a ? e.textContent : "";
                    }
                    e.textContent = t;
                }
                return e.$dv = "", e;
            ...
            on: function e(t, n, a, r) {
                if (_(r)) throw Sa("onargs", "jqLite#on() does not support the `selector` or `eventData` parameters");
                if (ve(t)) {
                    ...
                    for (var l = n.indexOf(" ") >= 0 ? n.split(" ") : [ n ], u = l.length; u--; ) {
                        n = l[u];
                        var c = s[n];
                        c || (s[n] = [], "mouseenter" === n || "mouseleave" === n ? e(t, xa[n], function(e) {
            ...
            be.prototype[t] = function(t, n, a) {
                ...
                _(r) && (r = Qn(r))) : Se(r, e(this[i], t, n, a));
                return _(r) ? r : this;
        ...
        var Ua = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Fa = /,/, Na = /^\s*(_?)(\S+?)\1\s*$/, Wa = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Va = a("$injector");
        Ve.$$annotate = We;
        var za = a("$animate"), qa = [ "$provide", function(e) {
            this.$$selectors = {}, this.register = function(t, n) {
                var a = t + "-animation";
                if (t && "." != t.charAt(0)) throw za("notcsel", "Expecting class selector starting with '.' got '{0}'.", t);
                ...
                return {
                    ...
                    $$addClassImmediately: function(e, t, n) {
                        return e = Qn(e), t = b(t) ? t : ca(t) ? t.join(" ") : "", i(e, function(e) {
                            xe(e, t);
                        }), l(e, n), o();
                    },
        ...
        var Ba = /^((?:x|data)[\:\-_])/i, Ja = a("$controller"), Ka = "application/json", Za = {
        ...
        var sr = a("$parse"), or = Function.prototype.call, lr = Function.prototype.apply, ur = Function.prototype.bind, cr = ue();
        i({
            null: function() {
                return null;
            },
        ...
        fr.ZERO = d(function() {
            ...
            filter: function(e) {
                ...
                return d(function(i, s) {
                    ...
                    constant: !r.$stateful && i.every(Ht),
                    inputs: !r.$stateful && i
                });
            },
            expression: function() {
            ...
            unary: function() {
                var e;
                return this.expect("+") ? this.primary() : (e = this.expect("-")) ? this.binaryFn(fr.ZERO, e.text, this.unary()) : (e = this.expect("!")) ? this.unaryFn(e.text, this.unary()) : this.primary();
            },
            ...
            objectIndex: function(e) {
                ...
                return this.consume("]"), d(function(r, i) {
                    var s, o = e(r, i), l = a(r, i);
                    return Ct(l, t), o ? s = Et(o[l], t) : n;
                }, {
                    assign: function(n, r, i) {
                        var s = Ct(a(n, i), t), o = Et(e(n, i), t);
            ...
            functionCall: function(e, t) {
                ...
                return function(s, o) {
                    ...
                    if (i) for (var c = a.length; c--; ) i[c] = Et(a[c](s, o), r);
                    Et(l, r), At(u, r);
                    var d = u.apply ? u.apply(l, i) : u(i[0], i[1], i[2], i[3], i[4]);
                    return i && (i.length = 0), Et(d, r);
                };
            },
        ...
        var hr = ue(), gr = ue(), vr = Object.prototype.valueOf, _r = a("$sce"), yr = {
            HTML: "html",
            CSS: "css",
            URL: "url",
            RESOURCE_URL: "resourceUrl",
            JS: "js"
        }, Ga = a("$compile"), br = t.createElement("a"), Mr = an(e.location.href);
        ...
        var $r = ".", kr = {
            ...
            ww: bn(2),
            w: bn(1)
        }, wr = /((?:[^yMdHhmsaZEw']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|w+))(.*)/, Lr = /^\-?\d+$/;
        $n.$inject = [ "$locale" ];
        var Dr = g(Gn), Yr = g(Jn);
        Ln.$inject = [ "$parse" ];
        var Tr = g({
                ...
                return {
                    ...
                    link: function(n, a, r) {
                        ...
                        r.$attr[s] = "xlink:href", i = null), r.$observe(t, function(t) {
                            return t ? (r.$set(s, t), void (Xn && i && a.prop(i, r[s]))) : void ("href" === e && r.$set(s, null));
                        });
                    }
                };
            };
        ...
        var Cr = function(e) {
                    ...
                    compile: function(e) {
                        return e.addClass(mi).addClass(ci), {
                            pre: function(e, a, r, i) {
                                ...
                                var o = i.$$parentForm, l = i.$name;
                                l && (Pt(e, null, l, i, l), r.$observe(r.name ? "name" : "ngForm", function(t) {
                                    l !== t && (Pt(e, null, l, n, l), l = t, Pt(e, null, l, i, l), o.$$renameControl(i, l));
                                })), a.on("$destroy", function() {
                                    o.$removeControl(i), l && Pt(e, null, l, n, l), d(i, Sr);
                                });
                            }
                        };
                    }
        ...
        }, Er = Cr(), Ar = Cr(!0), Hr = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, Pr = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Or = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Ir = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Rr = /^(\d{4})-(\d{2})-(\d{2})$/, Ur = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Fr = /^(\d{4})-W(\d\d)$/, Nr = /^(\d{4})-(\d\d)$/, Wr = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Vr = {
            text: Sn,
            date: An("date", Rr, En(Rr, [ "yyyy", "MM", "dd" ]), "yyyy-MM-dd"),
            "datetime-local": An("datetimelocal", Ur, En(Ur, [ "yyyy", "MM", "dd", "HH", "mm", "ss", "sss" ]), "yyyy-MM-ddTHH:mm:ss.sss"),
            time: An("time", Wr, En(Wr, [ "HH", "mm", "ss", "sss" ]), "HH:mm:ss.sss"),
            week: An("week", Fr, Cn, "yyyy-Www"),
            month: An("month", Nr, En(Nr, [ "yyyy", "MM" ]), "yyyy-MM"),
            number: Pn,
            url: On,
            email: In,
            radio: Rn,
            ...
            reset: f,
            file: f
        }, zr = [ "$browser", "$sniffer", "$filter", "$parse", function(e, t, n, a) {
            return {
                restrict: "E",
                require: [ "?ngModel" ],
                link: {
                    pre: function(r, i, s, o) {
                        o[0] && (Vr[Gn(s.type)] || Vr.text)(r, i, s, o[0], t, e, n, a);
                    }
                }
            };
        } ], qr = /^(true|false|\d+)$/, Gr = function() {
            return {
                restrict: "A",
                priority: 100,
                compile: function(e, t) {
                    return qr.test(t.ngValue) ? function(e, t, n) {
        ...
        }), Xr = Nn("", !0), Qr = Nn("Odd", 0), ei = Nn("Even", 1), ti = Dn({
            compile: function(e, t) {
        ...
        var ii = [ "$animate", function(e) {
            ...
            return {
                ...
                controller: oa.noop,
                compile: function(r, i) {
                    var s = i.ngInclude || i.src, o = i.onload || "", l = i.autoscroll;
                    return function(r, i, u, c, d) {
                        var m, p, f, h = 0, g = function() {
                            p && (p.remove(), p = null), m && (m.$destroy(), m = null), f && (n.leave(f).then(function() {
                                p = null;
                            }), p = f, f = null);
                        };
                        r.$watch(a.parseAsResourceUrl(s), function(a) {
                            ...
                            a ? (e(a, !0).then(function(e) {
                                if (u === h) {
                                    ...
                                    m = t, f = l, m.$emit("$includeContentLoaded", a), r.$eval(o);
                                }
                            }, function() {
                                u === h && (g(), r.$emit("$includeContentError", a));
            ...
            return {
                ...
                link: function(e, t, a, r) {
                    var s = t.attr(a.$attr.ngList) || ", ", o = "false" !== a.ngTrim, l = o ? da(s) : s, u = function(e) {
                        if (!v(e)) {
                            var t = [];
        ...
        }, ci = "ng-valid", di = "ng-invalid", mi = "ng-pristine", pi = "ng-dirty", fi = "ng-untouched", hi = "ng-touched", gi = "ng-pending", vi = new a("ngModel"), _i = [ "$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(e, t, a, r, s, o, l, u, c, d) {
            ...
            this.$$setOptions = function(e) {
                ...
                } else if (!p.assign) throw vi("nonassign", "Expression '{0}' is non-assignable. Element: {1}", a.ngModel, z(r));
            }, this.$render = f, this.$isEmpty = function(e) {
                return v(e) || "" === e || null === e || e !== e;
            };
            var w = r.inheritedData("$formController") || Sr, L = 0;
            Wn({
                ctrl: this,
                $element: r,
                set: function(e, t) {
                ...
                $.$dirty = !1, $.$pristine = !0, o.removeClass(r, pi), o.addClass(r, mi);
            }, this.$setDirty = function() {
                $.$dirty = !0, $.$pristine = !1, o.removeClass(r, mi), o.addClass(r, pi), w.$setDirty();
            }, this.$setUntouched = function() {
                $.$touched = !1, $.$untouched = !0, o.setClass(r, fi, hi);
            }, this.$setTouched = function() {
                $.$touched = !0, $.$untouched = !1, o.setClass(r, hi, fi);
                ...
                function o() {
                    ...
                    i($.$asyncValidators, function(i, s) {
                        var o = i(e, t);
                        if (!j(o)) throw vi("$asyncValidators", "Expected asynchronous validator to return a promise but got '{0}' instead.", o);
            ...
            return {
                ...
                priority: 1,
                compile: function(t) {
                    return t.addClass(mi).addClass(fi).addClass(ci), {
            ...
            return {
                ...
                controller: [ "$scope", "$attrs", function(e, t) {
                    ...
                    this.$options.updateOn = da(this.$options.updateOn.replace(bi, function() {
            ...
            terminal: !0,
            priority: 1e3
        }), ki = [ "$locale", "$interpolate", function(e, t) {
            ...
            return {
                ...
                link: function(r, s, o) {
                    ...
                    var u, c = o.count, d = o.$attr.when && s.attr(o.$attr.when), m = o.offset || 0, p = r.$eval(d) || {}, f = {}, h = t.startSymbol(), g = t.endSymbol(), v = h + c + "-" + m + g, _ = oa.noop;
                    i(o, function(e, t) {
                        var n = a.exec(t);
                        if (n) {
                            var r = (n[1] ? "-" : "") + Gn(n[2]);
                ...
                compile: function(a, m) {
                    ...
                    return y ? $ = e(y) : (w = function(e, t) {
                        ...
                        e.$watchCollection(v, function(a) {
                            var m, v, y, $, D, Y, T, x, S, j, C, E, A = t[0], H = ue();
                            if (_ && (e[_] = a), r(a)) S = a, x = k || w; else {
                                x = k || L, S = [];
                                for (var P in a) a.hasOwnProperty(P) && "$" != P.charAt(0) && S.push(P);
                                S.sort();
                            }
                            for ($ = S.length, C = new Array($), m = 0; m < $; m++) if (D = a === S ? m : S[m], 
                            Y = a[D], T = x(D, Y, m), g[T]) j = g[T], delete g[T], H[T] = j, C[m] = j; else {
                            ...
                            for (m = 0; m < $; m++) if (D = a === S ? m : S[m], Y = a[D], j = C[m], j.scope) {
                                y = A;
                                do y = y.nextSibling; while (y && y[o]);
                                c(j) != y && s.move(le(j.clone), null, Qn(A)), A = d(j), u(j.scope, m, b, Y, M, D, $);
                            } else h(function(e, t) {
                                j.scope = t;
                                var n = f.cloneNode(!1);
                                e[e.length++] = n, s.enter(e, null, Qn(A)), A = n, j.clone = e, H[j.id] = j, u(j.scope, m, b, Y, M, D, $);
                            });
                            g = H;
                        });
                    };
            ...
            return {
                ...
                link: function(o, l, u, c) {
                    function d(e, t, n, a) {
                        n.$render = function() {
                            var e = n.$viewValue;
                            a.hasOption(e) ? (L.parent() && L.remove(), t.val(e), "" === e && f.prop("selected", !0)) : v(e) && f ? t.val("") : a.renderUnknownOption(e);
                    ...
                    function p(t, o, l) {
                        ...
                        function p(e) {
                            ...
                            } else t = new Fe(e); else H && (e = u(H, null, e));
                            return function(n, a) {
                                var r;
                                return r = H ? H : x ? x : C, y ? _(t.remove(u(r, n, a))) : e === u(r, n, a);
                            };
                        }
                        function f() {
                            $ || (t.$$postDigest(v), $ = !0);
                        ...
                        function v() {
                            $ = !1;
                            var e, n, a, r, c, d, m, f, v, b, L, Y, T, x, C, A, R, U = {
                                "": []
                            }, F = [ "" ], N = l.$viewValue, W = E(t) || [], V = S ? s(W) : W, z = {}, q = p(N), G = !1;
                            for (P = {}, Y = 0; b = V.length, Y < b; Y++) m = Y, S && (m = V[Y], "$" === m.charAt(0)) || (f = W[m], 
                            e = u(j, m, f) || "", (n = U[e]) || (n = U[e] = [], F.push(e)), T = q(m, f), G = G || T, 
                            A = u(D, m, f), A = _(A) ? A : "", R = H ? H(t, I) : S ? V[Y] : Y, H && (P[R] = m), 
                            n.push({
                                id: R,
                                label: A,
                                selected: T
                            }));
                            for (y || (M || null === N ? U[""].unshift({
                                id: "",
                                label: "",
                                selected: !G
                            }) : G || U[""].unshift({
                                ...
                                label: "",
                                selected: !0
                            })), L = 0, v = F.length; L < v; L++) {
                                for (e = F[L], n = U[e], O.length <= L ? (r = {
                                    element: w.clone().attr("label", e),
                                    label: n.label
                                }, c = [ r ], O.push(c), o.append(r.element)) : (c = O[L], r = c[0], r.label != e && r.element.attr("label", r.label = e)), 
                                x = null, Y = 0, b = n.length; Y < b; Y++) a = n[Y], (d = c[Y + 1]) ? (x = d.element, 
                                d.label !== a.label && (g(z, d.label, !1), g(z, a.label, !0), x.text(d.label = a.label), 
                                x.prop("label", d.label)), d.id !== a.id && x.val(d.id = a.id), x[0].selected !== a.selected && (x.prop("selected", d.selected = a.selected), 
                                Xn && x.prop("selected", d.selected))) : ("" === a.id && M ? C = M : (C = k.clone()).val(a.id).prop("selected", a.selected).attr("selected", a.selected).prop("label", a.label).text(a.label), 
                                c.push(d = {
                                    element: C,
                                    label: a.label,
                                    id: a.id,
                                    selected: a.selected
                                }), g(z, a.label, !0), x ? x.after(C) : r.element.append(C), x = C);
                        ...
                        var L;
                        if (!(L = b.match(r))) throw Hi("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", b, z(o));
                        var D = a(L[2] || L[1]), Y = L[4] || L[6], T = / as /.test(L[0]) && L[1], x = T ? a(T) : null, S = L[5], j = a(L[3] || ""), C = a(L[2] ? L[1] : Y), E = a(L[7]), A = L[8], H = A ? a(L[8]) : null, P = {}, O = [ [ {
                            element: o,
                            label: ""
                        } ] ], I = {};
                        M && (e(M)(t), M.removeClass("ng-scope"), M.remove()), o.empty(), o.on("change", c), 
                        l.$render = v, t.$watchCollection(E, f), t.$watchCollection(m, f), y && t.$watchCollection(function() {
                            return l.$modelValue;
                        }, f);
                    }
                    if (c[1]) {
                        for (var f, h = c[0], g = c[1], y = u.multiple, b = u.ngOptions, M = !1, $ = !1, k = Qn(t.createElement("option")), w = Qn(t.createElement("optgroup")), L = k.clone(), D = 0, Y = l.children(), T = Y.length; D < T; D++) if ("" === Y[D].value) {
                            f = M = Y.eq(D);
                            break;
                        }
                        h.init(g, M, L), y && (g.$isEmpty = function(e) {
                            return !e || 0 === e.length;
                        }), b ? p(o, l, g) : y ? m(o, l, g) : d(o, l, g, h);
                    }
                }
            };
                ...
                link: function(e, t, r, i) {
                    if (i) {
                        ...
                        r.$observe("pattern", function(e) {
                            ...
                            return i.$isEmpty(e) || v(s) || s.test(e);
                        };
                    }
                }
            };
        ...
        pe(oa), void Qn(t).ready(function() {
            X(t, Q);
        }));
                ...
                function p() {
                    ...
                    s.when(a).then(function() {
                        if (a) {
                            ...
                            n = c.getTrustedResourceUrl(n), t.isDefined(n) && (a.loadedTemplateUrl = n, e = u(n))), 
    ...
    angular.module("ui.bootstrap.collapse", []).directive("collapse", [ "$animate", function(e) {
        ...
        return {
            ...
            link: function(e, t, n, a) {
                ...
                var o = a[0], l = a[1];
                l.$render = function() {
                    t.toggleClass(o.activeClass, angular.equals(l.$modelValue, r()));
                }, t.bind(o.toggleEvent, function() {
                    e.$apply(function() {
                        l.$setViewValue(t.hasClass(o.activeClass) ? i() : r()), l.$render();
                    });
                });
            }
        };
        ...
        var o, l, u = this, c = u.slides = e.slides = [], d = -1;
        u.currentSlide = null;
        var m = !1;
        u.select = e.select = function(t, a) {
            function i() {
                m || (angular.extend(t, {
                    direction: a,
                    active: !0
                ...
                })), u.currentSlide = t, d = s, r());
            }
            var s = u.indexOfSlide(t);
            void 0 === a && (a = s > u.getCurrentIndex() ? "next" : "prev"), t && t !== u.currentSlide && i();
        }, e.$on("$destroy", function() {
            m = !0;
        }), u.getCurrentIndex = function() {
            return u.currentSlide && angular.isDefined(u.currentSlide.index) ? +u.currentSlide.index : d;
        }, u.indexOfSlide = function(e) {
            return angular.isDefined(e.index) ? +e.index : c.indexOf(e);
        }, e.next = function() {
            var t = (u.getCurrentIndex() + 1) % c.length;
            if (!e.$currentTransition) return u.select(a(t), "next");
        }, e.prev = function() {
            var t = u.getCurrentIndex() - 1 < 0 ? c.length - 1 : u.getCurrentIndex() - 1;
            if (!e.$currentTransition) return u.select(a(t), "prev");
            ...
            t.$element = n, c.push(t), 1 === c.length || t.active ? (u.select(c[c.length - 1]), 
            ...
            var t = c.indexOf(e);
            c.splice(t, 1), c.length > 0 && e.active ? t >= c.length ? u.select(c[t - 1]) : u.select(c[t]) : d > t && d--;
        };
        ...
        this.parse = function(t, i, s) {
            ...
            var o = this.parsers[i], l = o.regex, u = o.map, c = t.match(l);
            if (c && c.length) {
                var d, m;
                d = s ? {
                    year: s.getFullYear(),
        ...
        this.modes = [ "day", "month", "year" ], angular.forEach([ "formatDay", "formatMonth", "formatYear", "formatDayHeader", "formatDayTitle", "formatMonthTitle", "minMode", "maxMode", "showWeeks", "startingDay", "yearRange", "shortcutPropagation" ], function(n, r) {
            l[n] = angular.isDefined(t[n]) ? r < 8 ? a(t[n])(e.$parent) : e.$parent.$eval(t[n]) : o[n];
        }), angular.forEach([ "minDate", "maxDate" ], function(a) {
            t[a] ? e.$parent.$watch(n(t[a]), function(e) {
                l[a] = e ? new Date(e) : null, l.refreshView();
            }) : l[a] = o[a] ? new Date(o[a]) : null;
        }), e.datepickerMode = e.datepickerMode || o.datepickerMode, e.maxMode = l.maxMode, 
        ...
        return {
            ...
            link: function(o, l, u, c) {
                ...
                function m(e) {
                    angular.isNumber(e) && (e = new Date(e));
                    {
                        ...
                        if (angular.isString(e)) {
                            var t = i.parse(e, f, o.date) || new Date(e);
                ...
                var f, h = angular.isDefined(u.closeOnDateSelection) ? o.$parent.$eval(u.closeOnDateSelection) : s.closeOnDateSelection, g = angular.isDefined(u.datepickerAppendToBody) ? o.$parent.$eval(u.datepickerAppendToBody) : s.appendToBody;
                o.showButtonBar = angular.isDefined(u.showButtonBar) ? o.$parent.$eval(u.showButtonBar) : s.showButtonBar, 
                o.getText = function(e) {
                    return o[e + "Text"] || s[e + "Text"];
                };
                var v = !1;
                if (s.html5Types[u.type] ? (f = s.html5Types[u.type], v = !0) : (f = u.datepickerPopup || s.datepickerPopup, 
                u.$observe("datepickerPopup", function(e, t) {
                    var n = e || s.datepickerPopup;
                    if (n !== f && (f = n, c.$modelValue = null, !f)) throw new Error("datepickerPopup must have a date format specified.");
                })), !f) throw new Error("datepickerPopup must have a date format specified.");
                if (v && u.datepickerPopup) throw new Error("HTML5 date input types do not support custom formats.");
                var _ = angular.element("<div datepicker-popup-wrap><div datepicker></div></div>");
                _.attr({
                    "ng-model": "date",
                    "ng-change": "dateSelection()"
                });
                var y = angular.element(_.children()[0]);
                if (v && "month" == u.type && (y.attr("datepicker-mode", '"month"'), y.attr("min-mode", "month")), 
                u.datepickerOptions) {
                    var b = o.$parent.$eval(u.datepickerOptions);
                    b.initDate && (o.initDate = b.initDate, y.attr("init-date", "initDate"), delete b.initDate), 
                ...
                }), u.dateDisabled && y.attr("date-disabled", "dateDisabled({ date: date, mode: mode })"), 
                u.showWeeks && y.attr("show-weeks", u.showWeeks), u.customClass && y.attr("custom-class", "customClass({ date: date, mode: mode })"), 
                v ? c.$formatters.push(function(e) {
                    return o.date = e, e;
                }) : (c.$$parserName = "date", c.$validators.date = p, c.$parsers.unshift(m), c.$formatters.push(function(e) {
                    return o.date = e, c.$isEmpty(e) ? e : r(e, f);
                })), o.dateSelection = function(e) {
                    angular.isDefined(e) && (o.date = e);
                    var t = o.date ? r(o.date, f) : "";
                    l.val(t), c.$setViewValue(t), h && (o.isOpen = !1, l[0].focus());
                }, c.$viewChangeListeners.push(function() {
                    o.date = i.parse(c.$viewValue, f, o.date) || new Date(c.$viewValue);
                });
                var M = function(e) {
                    o.isOpen && e.target !== l[0] && o.$apply(function() {
                        o.isOpen = !1;
                    });
                }, $ = function(e, t) {
                    o.keydown(e);
                };
                l.bind("keydown", $), o.keydown = function(e) {
                    27 === e.which ? (e.preventDefault(), o.isOpen && e.stopPropagation(), o.close()) : 40 !== e.which || o.isOpen || (o.isOpen = !0);
                }, o.$watch("isOpen", function(e) {
                    e ? (o.$broadcast("datepicker.focus"), o.position = g ? a.offset(l) : a.position(l), 
                    o.position.top = o.position.top + l.prop("offsetHeight"), n.bind("click", M)) : n.unbind("click", M);
                }), o.select = function(e) {
                    if ("today" === e) {
                        var t = new Date();
                    ...
                    o.isOpen = !1, l[0].focus();
                };
                var k = e(_)(o);
                _.remove(), g ? n.find("body").append(k) : l.after(k), o.$on("$destroy", function() {
                    k.remove(), l.unbind("keydown", $), n.unbind("click", M);
                });
            }
        };
        ...
        var l, u = this, c = e.$new(), d = a.openClass, m = angular.noop, p = t.onToggle ? n(t.onToggle) : angular.noop, f = !1;
        this.init = function(a) {
            u.$element = a, t.isOpen && (l = n(t.isOpen), m = l.assign, e.$watch(l, function(e) {
                c.isOpen = !!e;
            })), f = angular.isDefined(t.dropdownAppendToBody), f && u.dropdownMenu && (o.find("body").append(u.dropdownMenu), 
            a.on("$destroy", function() {
                u.dropdownMenu.remove();
            }));
            ...
            i[t ? "addClass" : "removeClass"](u.$element, d), t ? (c.focusToggleElement(), r.open(c)) : r.close(c), 
            m(e, t), angular.isDefined(t) && t !== n && p(e, {
                open: !!t
            });
        ...
        function o(e) {
            ...
            f.remove(e), u(a.modalDomEl, a.modalScope, function() {
                t.toggleClass(p, f.length() > 0), l();
            });
        }
        function l() {
            if (d && s() == -1) {
        ...
        var d, m, p = "modal-open", f = i.createNew(), h = {};
        return r.$watch(s, function(e) {
            ...
            var h = a(c)(t.scope);
            f.top().value.modalDomEl = h, f.top().value.modalOpener = i, o.append(h), o.addClass(p);
        ...
        var e = {
            ...
            $get: [ "$injector", "$rootScope", "$q", "$templateRequest", "$controller", "$modalStack", function(t, n, a, r, i, s) {
                ...
                return u.open = function(t) {
                    var r = a.defer(), u = a.defer(), c = a.defer(), d = {
                        result: r.promise,
                        opened: u.promise,
                        rendered: c.promise,
                        close: function(e) {
                    ...
                    var m = a.all([ o(t) ].concat(l(t.resolve)));
                    return m.then(function(e) {
                        var a = (t.scope || n).$new();
                        a.$close = d.close, a.$dismiss = d.dismiss;
                        var o, l = {}, u = 1;
                        t.controller && (l.$scope = a, l.$modalInstance = d, angular.forEach(t.resolve, function(t, n) {
                            l[n] = e[u++];
                        }), o = i(t.controller, l), t.controllerAs && (a[t.controllerAs] = o)), s.open(d, {
                            scope: a,
                            deferred: r,
                            renderDeferred: c,
                            content: e[0],
        ...
        this.options = function(e) {
            ...
            angular.extend(n, e);
        }, this.$get = [ "$window", "$compile", "$timeout", "$document", "$position", "$interpolate", function(r, i, s, o, l, u) {
            return function(r, c, d, m) {
                ...
                var f = e(r), h = u.startSymbol(), g = u.endSymbol(), v = "<div " + f + '-popup title="' + h + "title" + g + '" ' + (m.useContentExp ? 'content-exp="contentExp()" ' : 'content="' + h + "content" + g + '" ') + 'placement="' + h + "placement" + g + '" popup-class="' + h + "popupClass" + g + '" animation="animation" is-open="isOpen"origin-scope="origScope" ></div>';
                return {
                    restrict: "EA",
                    compile: function(e, t) {
                        var n = i(v);
                        return function(e, t, a, i) {
                            ...
                            function d() {
                                S && !e.$eval(a[c + "Enable"]) || (y(), j.popupDelay ? Y || (Y = s(h, j.popupDelay, !1), 
                                Y.then(function(e) {
                                    e();
                                })) : h()());
                            }
                            ...
                            function h() {
                                return Y = null, D && (s.cancel(D), D = null), (m.useContentExp ? j.contentExp() : j.content) ? (v(), 
                                w.css({
                                    top: 0,
                                    left: 0,
                                    display: "block"
                                }), j.$digest(), C(), j.isOpen = !0, j.$apply(), C) : angular.noop;
                            }
                            function g() {
                                j.isOpen = !1, s.cancel(Y), Y = null, j.animation ? D || (D = s(_, 500)) : _();
                            }
                            function v() {
                                w && _(), L = j.$new(), w = n(L, function(e) {
                            ...
                            function b() {
                                j.popupClass = a[c + "Class"];
                            }
                            function M() {
                                var e = a[c + "Placement"];
                                j.placement = angular.isDefined(e) ? e : m.placement;
                            }
                            function $() {
                            ...
                            function k() {
                                var e = a[c + "Trigger"];
                                E(), x = p(e), x.show === x.hide ? t.bind(x.show, u) : (t.bind(x.show, d), t.bind(x.hide, f));
                            }
                            var w, L, D, Y, T = !!angular.isDefined(m.appendToBody) && m.appendToBody, x = p(void 0), S = angular.isDefined(a[c + "Enable"]), j = e.$new(!0), C = function() {
                                if (w) {
                                    var e = l.positionElements(t, w, j.placement, T);
                            ...
                            var E = function() {
                                t.unbind(x.show, d), t.unbind(x.hide, f);
                            };
                            k();
                            var A = e.$eval(a[c + "Animation"]);
                            j.animation = angular.isDefined(A) ? !!A : m.animation;
                            var H = e.$eval(a[c + "AppendToBody"]);
                            T = angular.isDefined(H) ? H : T, T && e.$on("$locationChangeSuccess", function() {
                                j.isOpen && g();
                            }), e.$on("$destroy", function() {
                                s.cancel(D), s.cancel(Y), E(), _(), j = null;
                            });
                        };
                    }
                };
        ...
        function u(e) {
            c(), f.$setViewValue(new Date(p)), d(e);
        }
        function c() {
        ...
        function d(t) {
            ...
            "m" !== t && (e.minutes = l(a)), e.meridian = p.getHours() < 12 ? h[0] : h[1];
        }
        function m(e) {
            var t = new Date(p.getTime() + 6e4 * e);
            p.setHours(t.getHours(), t.getMinutes()), u();
        }
        var p = new Date(), f = {
            $setViewValue: angular.noop
        }, h = angular.isDefined(t.meridians) ? e.$parent.$eval(t.meridians) : i.meridians || r.DATETIME_FORMATS.AMPMS;
        this.init = function(n, a) {
            f = n, f.$render = this.render, f.$formatters.unshift(function(e) {
        ...
        t.minuteStep && e.$parent.$watch(n(t.minuteStep), function(e) {
            ...
            var a = function(t, n) {
                f.$setViewValue(null), f.$setValidity("time", !1), angular.isDefined(t) && (e.invalidHours = t), 
                angular.isDefined(n) && (e.invalidMinutes = n);
            };
            e.updateHours = function() {
                var e = s();
                angular.isDefined(e) ? (p.setHours(e), u("h")) : a(!0);
                ...
                var e = o();
                angular.isDefined(e) ? (p.setMinutes(e), u("m")) : a(void 0, !0);
            ...
            var e = f.$viewValue;
            isNaN(e) ? (f.$setValidity("time", !1), a.error('Timepicker directive: "ng-model" value must be a Date object, a number of milliseconds since 01.01.1970 or a string representing an RFC2822 or ISO 8601 date.')) : (e && (p = e), 
            c(), d());
        ...
        return {
            ...
            link: function(l, u, c, d) {
                var m, p = l.$eval(c.typeaheadMinLength) || 1, f = l.$eval(c.typeaheadWaitMs) || 0, h = l.$eval(c.typeaheadEditable) !== !1, g = t(c.typeaheadLoading).assign || angular.noop, v = t(c.typeaheadOnSelect), _ = c.typeaheadInputFormatter ? t(c.typeaheadInputFormatter) : void 0, y = !!c.typeaheadAppendToBody && l.$eval(c.typeaheadAppendToBody), b = l.$eval(c.typeaheadFocusFirst) !== !1, M = t(c.ngModel).assign, $ = s.parse(c.typeahead), k = l.$new();
                ...
                var D = function() {
                    k.matches = [], k.activeIdx = -1, u.attr("aria-expanded", !1);
                }, Y = function(e) {
                    return w + "-option-" + e;
                };
                k.$watch("activeIdx", function(e) {
                    e < 0 ? u.removeAttr("aria-activedescendant") : u.attr("aria-activedescendant", Y(e));
                });
                var T = function(e) {
                    var t = {
                        $viewValue: e
                    };
                    g(l, !0), n.when($.source(l, t)).then(function(n) {
                        var a = e === d.$viewValue;
                        if (a && m) if (n && n.length > 0) {
                            k.activeIdx = b ? 0 : -1, k.matches.length = 0;
                            for (var r = 0; r < n.length; r++) t[$.itemName] = n[r], k.matches.push({
                                id: Y(r),
                                label: $.viewMapper(k, t),
                                model: n[r]
                            });
                            k.query = e, k.position = y ? i.offset(u) : i.position(u), k.position.top = k.position.top + u.prop("offsetHeight"), 
                ...
                d.$parsers.unshift(function(e) {
                    return m = !0, e && e.length >= p ? f > 0 ? (j(), S(e)) : T(e) : (g(l, !1), j(), 
                    D()), h ? e : e ? void d.$setValidity("editable", !1) : (d.$setValidity("editable", !0), 
                    e);
                }), d.$formatters.push(function(e) {
                    var t, n, a = {};
                    return h || d.$setValidity("editable", !0), _ ? (a.$model = e, _(l, a)) : (a[$.itemName] = e, 
                    t = $.viewMapper(l, a), a[$.itemName] = void 0, n = $.viewMapper(l, a), t !== n ? t : e);
                }), k.select = function(e) {
                    var t, n, r = {};
                    r[$.itemName] = n = k.matches[e].model, t = $.modelMapper(l, r), M(l, t), d.$setValidity("editable", !0), 
                    d.$setValidity("parse", !0), v(l, {
                        $item: n,
                        $model: t,
                        $label: $.viewMapper(l, r)
                    }), D(), a(function() {
                        u[0].focus();
                    }, 0, !1);
                ...
                var C = function(e) {
                    u[0] !== e.target && (D(), k.$digest());
                };
                r.bind("click", C), l.$on("$destroy", function() {
                    r.unbind("click", C), y && E.remove(), L.remove();
                });
                var E = e(L)(k);
                y ? r.find("body").append(E) : u.after(E);
            }
        };
    ...
    !function() {
        ...
        l.module("kubeClient", []).value("KUBE_SCHEMA", m).value("KUBE_NAME_RE", p).factory("kubeLoader", [ "$q", "$timeout", "KubeWatch", "KubeRequest", "KUBE_SCHEMA", function(e, t, n, a, r) {
            ...
            function d(e) {
                ...
                if (L = null, t) {
                    var n, a, r, i, s, l, u = {}, d = {};
                    for (n = 0, a = t.length; n < a; n++) i = t[n].object, i && (r = o([ i ]), "DELETED" == t[n].type ? (delete w[r], 
                    d[r] = i) : t[n].checkResourceVersion ? (s = c(i), l = c(w[r]), (!s || !l || s >= l) && (u[r] = i, 
                    w[r] = i)) : (u[r] = i, w[r] = i));
                    e(u, d);
                }
            }
    ...
    (function(e) {
        ...
        !function(t, n) {
            ...
            function h(e) {
                f(this, e), this._d = new Date(null != e._d ? e._d.getTime() : NaN), Rn === !1 && (Rn = !0, 
                t.updateOffset(this), Rn = !1);
            }
            function g(e) {
            ...
            function L(e, t) {
                return null !== t ? (t.abbr = e, Un[e] = Un[e] || new b(), Un[e].set(t), w(e), Un[e]) : (delete Un[e], 
                null);
            }
            function D(e) {
                var t;
            ...
            function I(e, t) {
                return e.isValid() ? (t = R(t, e.localeData()), Vn[t] = Vn[t] || O(t), Vn[t](e)) : e.localeData().invalidDate();
            }
            function R(e, t) {
                function n(e) {
            ...
            function ke(e) {
                ...
                for (r = R(e._f, e._locale).match(Nn) || [], n = 0; n < r.length; n++) i = r[n], 
            ...
            function Te(e) {
                ...
                return e._locale = e._locale || D(e._l), null === t || void 0 === n && "" === t ? p({
                    nullInput: !0
                }) : ("string" == typeof t && (e._i = t = e._locale.preparse(t)), g(t) ? new h(ee(t)) : (r(n) ? Le(e) : n ? ke(e) : i(t) ? e._d = t : xe(e), 
                e));
            }
            function xe(e) {
                var n = e._i;
            ...
            function He(e) {
                var t = x(e), n = t.year || 0, a = t.quarter || 0, r = t.month || 0, i = t.week || 0, s = t.day || 0, o = t.hour || 0, l = t.minute || 0, u = t.second || 0, c = t.millisecond || 0;
            ...
            function tt(e, t) {
                var n;
                return t = Re(t, e), e.isBefore(t) ? n = et(e, t) : (n = et(t, e), n.milliseconds = -n.milliseconds, 
                n.months = -n.months), n;
            }
            function nt(e, t) {
                return function(n, a) {
            ...
            function rt(e, t) {
                var n = e || je(), a = Re(n, this).startOf("day"), r = this.diff(a, "days", !0), i = r < -6 ? "sameElse" : r < -1 ? "lastWeek" : r < 0 ? "lastDay" : r < 1 ? "sameDay" : r < 2 ? "nextDay" : r < 7 ? "nextWeek" : "sameElse";
            ...
            function ct(e, t, n) {
                var a, r, i = Re(e, this), s = 6e4 * (i.utcOffset() - this.utcOffset());
            ...
            var Pn, On, In = t.momentProperties = [], Rn = !1, Un = {}, Fn = {}, Nn = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, Wn = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Vn = {}, zn = {}, qn = /\d/, Gn = /\d\d/, Bn = /\d{3}/, Jn = /\d{4}/, Kn = /[+-]?\d{6}/, Zn = /\d\d?/, Xn = /\d{1,3}/, Qn = /\d{1,4}/, ea = /[+-]?\d{1,6}/, ta = /\d+/, na = /[+-]?\d+/, aa = /Z|[+-]\d\d:?\d\d/gi, ra = /[+-]?\d+(\.\d{1,3})?/, ia = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, sa = {}, oa = {}, la = 0, ua = 1, ca = 2, da = 3, ma = 4, pa = 5, fa = 6;
            ...
            }), Y("month", "M"), F("M", Zn), F("MM", Zn, Gn), F("MMM", ia), F("MMMM", ia), V([ "M", "MM" ], function(e, t) {
                t[ua] = _(e) - 1;
            ...
            Y("year", "y"), F("Y", na), F("YY", Zn, Gn), F("YYYY", Qn, Jn), F("YYYYY", ea, Kn), 
            F("YYYYYY", ea, Kn), V([ "YYYYY", "YYYYYY" ], la), V("YYYY", function(e, n) {
            ...
            Y("isoWeek", "W"), F("w", Zn), F("ww", Zn, Gn), F("W", Zn), F("WW", Zn, Gn), z([ "w", "ww", "W", "WW" ], function(e, t, n, a) {
                t[a.substr(0, 1)] = _(e);
            });
            var ka = {
                dow: 0,
            ...
            H("DDD", [ "DDDD", 3 ], "DDDo", "dayOfYear"), Y("dayOfYear", "DDD"), F("DDD", Xn), 
            F("DDDD", Bn), V([ "DDD", "DDDD" ], function(e, t, n) {
                n._dayOfYear = _(e);
            }), t.ISO_8601 = function() {};
            ...
            Oe("Z", ":"), Oe("ZZ", ""), F("Z", aa), F("ZZ", aa), V([ "Z", "ZZ" ], function(e, t, n) {
            ...
            Xe.fn = He.prototype;
            var xa = nt(1, "add"), Sa = nt(-1, "subtract");
            ...
            jt("GGGGG", "isoWeekYear"), Y("weekYear", "gg"), Y("isoWeekYear", "GG"), F("G", na), 
            F("g", na), F("GG", Zn, Gn), F("gg", Zn, Gn), F("GGGG", Qn, Jn), F("gggg", Qn, Jn), 
            F("GGGGG", ea, Kn), F("ggggg", ea, Kn), z([ "gggg", "ggggg", "GGGG", "GGGGG" ], function(e, t, n, a) {
                t[a.substr(0, 2)] = _(e);
            }), z([ "gg", "GG" ], function(e, n, a, r) {
                n[r] = t.parseTwoDigitYear(e);
            }), H("Q", 0, 0, "quarter"), Y("quarter", "Q"), F("Q", qn), V("Q", function(e, t) {
                t[ua] = 3 * (_(e) - 1);
            }), H("D", [ "DD", 2 ], "Do", "date"), Y("date", "D"), F("D", Zn), F("DD", Zn, Gn), 
            F("Do", function(e, t) {
            ...
            Y("isoWeekday", "E"), F("d", Zn), F("e", Zn), F("E", Zn), F("dd", ia), F("ddd", ia), 
            F("dddd", ia), z([ "dd", "ddd", "dddd" ], function(e, t, n) {
            ...
            }), qt("a", !0), qt("A", !1), Y("hour", "h"), F("a", Gt), F("A", Gt), F("H", Zn), 
            F("h", Zn), F("HH", Zn, Gn), F("hh", Zn, Gn), V([ "H", "HH" ], da), V([ "a", "A" ], function(e, t, n) {
                n._isPm = n._locale.isPM(e), n._meridiem = e;
            }), V([ "h", "hh" ], function(e, t, n) {
                t[da] = _(e), d(n).bigHour = !0;
            });
            var Pa = /[ap]\.?m?\.?/i, Oa = S("Hours", !0);
            H("m", [ "mm", 2 ], 0, "minute"), Y("minute", "m"), F("m", Zn), F("mm", Zn, Gn), 
            V([ "m", "mm" ], ma);
            var Ia = S("Minutes", !1);
            H("s", [ "ss", 2 ], 0, "second"), Y("second", "s"), F("s", Zn), F("ss", Zn, Gn), 
            V([ "s", "ss" ], pa);
            var Ra = S("Seconds", !1);
            H("S", 0, 0, function() {
            ...
            }), Y("millisecond", "ms"), F("S", Xn, qn), F("SS", Xn, Gn), F("SSS", Xn, Bn);
            var Ua;
            for (Ua = "SSSS"; Ua.length <= 9; Ua += "S") F(Ua, ta);
            for (Ua = "S"; Ua.length <= 9; Ua += "S") V(Ua, Kt);
            var Fa = S("Milliseconds", !1);
            H("z", 0, 0, "zoneAbbr"), H("zz", 0, 0, "zoneName");
            var Na = h.prototype;
            Na.add = xa, Na.calendar = rt, Na.clone = it, Na.diff = ct, Na.endOf = $t, Na.format = ft, 
            Na.from = ht, Na.fromNow = gt, Na.to = vt, Na.toNow = _t, Na.get = E, Na.invalidAt = St, 
            Na.isAfter = st, Na.isBefore = ot, Na.isBetween = lt, Na.isSame = ut, Na.isValid = Tt, 
            Na.lang = ja, Na.locale = yt, Na.localeData = bt, Na.max = La, Na.min = wa, Na.parsingFlags = xt, 
            Na.set = E, Na.startOf = Mt, Na.subtract = Sa, Na.toArray = Dt, Na.toObject = Yt, 
            ...
            Na.minute = Na.minutes = Ia, Na.second = Na.seconds = Ra, Na.millisecond = Na.milliseconds = Fa, 
            Na.utcOffset = Fe, Na.utc = We, Na.local = Ve, Na.parseZone = ze, Na.hasAlignedHourOffset = qe, 
            ...
            Ka._monthsShort = ga, Ka.monthsParse = K, Ka.week = me, Ka._week = ka, Ka.firstDayOfYear = fe, 
            Ka.firstDayOfWeek = pe, Ka.weekdays = Rt, Ka._weekdays = Ea, Ka.weekdaysMin = Ft, 
            Ka._weekdaysMin = Ha, Ka.weekdaysShort = Ut, Ka._weekdaysShort = Aa, Ka.weekdaysParse = Nt, 
            Ka.isPM = Bt, Ka._meridiemParse = Pa, Ka.meridiem = Jt, w("en", {
            ...
            var Za = Math.abs, Xa = Yn("ms"), Qa = Yn("s"), er = Yn("m"), tr = Yn("h"), nr = Yn("d"), ar = Yn("w"), rr = Yn("M"), ir = Yn("y"), sr = xn("milliseconds"), or = xn("seconds"), lr = xn("minutes"), ur = xn("hours"), cr = xn("days"), dr = xn("months"), mr = xn("years"), pr = Math.round, fr = {
                s: 45,
                m: 45,
                h: 22,
                d: 26,
            ...
            gr.weeks = Sn, gr.months = dr, gr.years = mr, gr.humanize = An, gr.toISOString = Hn, 
            ...
            gr.lang = ja, H("X", 0, 0, "unix"), H("x", 0, 0, "valueOf"), F("x", na), F("X", ra), 
            V("X", function(e, t, n) {
    ...
    !function() {
        var e = n(32);
        n(35), n(39), n(40), n(193), n(200), n(201), n(202), e.module("kubernetes.app", [ "ui.bootstrap", "kubeClient", "kubeClient.cockpit", "kubernetes.connection" ]).controller("MainCtrl", [ "$scope", "$location", "$rootScope", "$timeout", "$modal", "kubeLoader", "kubeSelect", "KubeDiscoverSettings", "filterService", "connectionActions", function(t, n, a, r, i, s, o, l, u, c) {
            function d() {
            ...
            function o() {
                var e;
                u && (e = i().kind("Namespace")), e && 0 !== e.length || (e = i().kind("Project"));
                var t, n, a = [];
            ...
            var u = !0, c = s().then(function(e) {
                var n = [];
                return "openshift" === e.flavor && n.push(r.load("projects")), e.isAdmin && n.push(r.watch("namespaces", a)), 
                t.all(n);
            });
    ...
    !function() {
        var e = n(32);
        n(43), n(40), n(150), n(194), n(195), n(182), n(185), n(196), n(197), n(198), n(199), 
    ...
    !function() {
        ...
        n(226), n(227), n(228), n(229), n(230), n(231), n(232), n(233), t.module("registry.projects", [ "ngRoute", "ui.cockpit", "kubeClient", "kubernetes.listing", "registry.policy" ]).config([ "$routeProvider", function(e) {
            ...
            function M(e) {
                ...
                return n[x] ? "anonymous" : n[S] ? "shared" : "private";
            }
            function $(t, a) {
                var r = {
                    kind: "User",
            ...
            var L = "get", D = "imagestreams/layers", Y = "registry-viewer", T = "Group", x = "system:unauthenticated", S = "system:authenticated", j = "registry-admin";
            return {
    ...
    !function() {
        ...
        n(45), n(237), n(238), n(239), n(239), n(240), t.module("registry.images", [ "ngRoute", "ui.cockpit", "kubeClient", "kubernetes.date", "kubernetes.listing", "registry.tags", "registryUI.images" ]).config([ "$routeProvider", function(e) {
            ...
            function p() {
                o().then(function(e) {
                    m.subjectAccessReview(_, e.currentUser, "update", "imagestreamimages").then(function(e) {
            ...
            h = g.substr(v + 1)), l.watchImages(n), s.listen(function() {
            ...
            var d = a.stream || {}, m = d.metadata || {}, p = d.spec || {}, f = o.getString.bind(o), h = "none";
            ...
            }, e.placeholder = f("eg: my-image-stream"), a.stream || (e.labels.populate.none = f("Create empty image stream")), 
    ...
    !function(e) {
        ...
        !function() {
            ...
            } ]).directive("registryImagestreamListing", [ "imagestreamTags", "$location", function(e, t) {
                return {
                    restrict: "E",
                    scope: {
                        imagestream: "=",
                    ...
                    link: function(n, a, r) {
                        ...
                        n.imagestreamTags = e, n.imagestreamPath = n.imagestreamFunc(), n.imagestreamActivate = function(e, a, r) {
                            var i;
                            n.imagestreamExpanded(e, a) ? n.imagestreamToggle(e, a, r) : (i = n.$emit("activate", e, a, r), 
                            !i.defaultPrevented && n.imagestreamPath && t.path(n.imagestreamPath(e, a))), r.preventDefault();
                        };
                        var s = {};
                        n.imagestreamExpanded = function(e, t) {
                            return i(e, t) in s;
                        }, n.imagestreamToggle = function(e, t, n) {
                            var a = i(e, t);
                            a in s ? delete s[a] : s[a] = !0, n.stopPropagation();
                        };
                    }
                };
            } ]);
        ...
        n(4), n(2), n(3), n(5), n(0), n(1), n(6), n(7), n(9), n(8), n(10), n(11), n(12), 
        n(13), e.exports = n(14);
    } ]);
}, function(e, t) {
    var n, a = window.angular;
    ...
    !function() {
        var e = n(32);
        n(33), n(34), n(35), n(192), n(61), n(234), n(216), n(215), n(39), n(40), n(175);
        var t = 15, a = 8;
        e.module("registry", [ "ngRoute", "ui.bootstrap", "ui.bootstrap.popover", "gettext", "kubernetes.app", "kubernetes.date", "registry.images", "registry.projects", "registry.policy", "kubeClient", "kubeClient.cockpit" ]).config([ "$routeProvider", "KubeWatchProvider", "KubeRequestProvider", "KubeDiscoverSettingsProvider", "$provide", function(e, t, n, a, r) {
            e.when("/", {
            ...
            a.KubeDiscoverSettingsFactory = "cockpitKubeDiscoverSettings", r.decorator("$exceptionHandler", [ "$delegate", "$log", function(e, t) {
                return function(t, n) {
