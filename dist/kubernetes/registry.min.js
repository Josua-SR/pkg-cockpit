!function(e) {
    ...
    !function(e, t, n) {
        ...
        function i(e, t, n) {
            var a, s;
            if (e) if (k(e)) for (a in e) "prototype" == a || "length" == a || "name" == a || e.hasOwnProperty && !e.hasOwnProperty(a) || t.call(n, e[a], a, e); else if (pa(e) || r(e)) {
        ...
        function P(e, t, n, a) {
            ...
            } else if (t = e, e) if (pa(e)) t = P(e, [], n, a); else if ($(e)) t = new Date(e.getTime()); else if (w(e)) t = new RegExp(e.source, e.toString().match(/[^\/]*$/)[0]), 
        ...
        function I(e, t) {
            ...
            if (s == o && "object" == s) {
                if (!pa(e)) {
                    ...
                    if (D(e) || D(t) || L(e) || L(t) || pa(t) || $(t) || w(t)) return !1;
                    i = {};
        ...
        function z(e) {
            ...
            try {
                return e[0].nodeType === $a ? Jn(t) : t.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function(e, t) {
                    return "<" + Jn(t);
                });
            } catch (e) {
                return Jn(t);
        ...
        function ie(e, t, n) {
            return n && pa(e) && (e = e[e.length - 1]), re(k(e), t, "not a function, got " + (e && "object" == typeof e ? e.constructor.name || "Object" : typeof e)), 
            e;
        }
        function se(e, t) {
        ...
        function Ve(e, t) {
            ...
            function r(e, t) {
                if (se(e, "service"), (k(t) || pa(t)) && (t = D.instantiate(t)), !t.$get) throw Ba("pget", "Provider '{0}' must define $get factory method.", e);
                return L[e + M] = t;
            }
            function s(e, t) {
                return function() {
                ...
                return i(e, function(e) {
                    ...
                    if (!w.get(e)) {
                        ...
                        try {
                            ...
                            a(t._configBlocks)) : k(e) ? n.push(D.invoke(e)) : pa(e) ? n.push(D.invoke(e)) : ie(e, "module");
                        } catch (t) {
        ...
        function Ge(e, t, a, r) {
            ...
            var h = this, g = t[0], _ = e.location, y = e.history, M = e.setTimeout, $ = e.clearTimeout, k = {};
            h.isMock = !1;
            var w = 0, L = [];
        ...
        function Ze(e, a) {
            ...
            this.debugInfoEnabled = function(e) {
                return _(e) ? ($ = e, this) : $;
            }, this.$get = [ "$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(e, a, r, l, g, _, w, L, Y, T, S) {
                function x(e, t) {
                    try {
                        e.addClass(t);
                    } catch (e) {}
                    ...
                    switch (o) {
                      case ba:
                        ...
                        for (var d, m, p, f, h, g, v = e.attributes, _ = 0, M = v && v.length; _ < M; _++) {
                            ...
                            q(w) && f === w + "Start" && ($ = m, k = m.substr(0, m.length - 5) + "end", m = m.substr(0, m.length - 6)), 
                            p = Xe(m.toLowerCase()), l[p] = m, !g && n.hasOwnProperty(p) || (n[p] = h, Pe(e, p) && (n[p] = !0)), 
                            ee(e, t, h, p, g), V(t, p, "A", a, r, $, k);
                        }
                ...
                function N(e, s, o, l, u, c, d, m, p) {
                    ...
                    function M(e, t, r, l, u) {
                        function c(e, t, a) {
                            var r;
                            return D(e) || (a = t, t = e, e = n), q && (r = M), a || (a = q ? k.parent() : k), 
                            u(e, t, r, a, S);
                        }
                        var p, f, v, y, b, M, $, k, L;
                        if (s === r ? (L = o, k = o.$$element) : (k = na(r), L = new se(k, o)), A && (b = t.$new(!0)), 
                        u && ($ = c, $.$$boundTransclude = u), E && (w = {}, M = {}, i(E, function(e) {
                            var n, a = {
                            ...
                            M[e.name] = n, q || k.data("$" + e.name + "Controller", n.instance), w[e.name] = n;
                        })), A) {
                            j.$$addScopeInfo(k, b, !0, !(H && (H === A || H === A.$$originalDirective))), j.$$addScopeClass(k, !0);
                            var Y = w && w[A.name], T = b;
                        ...
                        for (w && (i(w, function(e) {
                            e();
                        }), w = null), p = 0, f = d.length; p < f; p++) v = d[p], ie(v, v.isolateScope ? b : t, k, L, v.require && h(v.directiveName, v.require, k, M), $);
                        var S = t;
                        for (A && (A.template || null === A.templateUrl) && (S = b), e && e(S, r.childNodes, n, u), 
                        p = m.length - 1; p >= 0; p--) v = m[p], ie(v, v.isolateScope ? b : t, k, L, v.require && h(v.directiveName, v.require, k, M), $);
                    }
                    p = p || {};
                    for (var $, w, L, Y, T, S, x, C = -Number.MAX_VALUE, E = p.controllerDirectives, A = p.newIsolateScopeDirective, H = p.templateDirective, P = p.nonTlbTranscludeDirective, N = !1, V = !1, q = p.hasElementTranscludeDirective, K = o.$$element = na(s), Z = c, Q = l, ee = 0, ne = e.length; ee < ne; ee++) {
                        L = e[ee];
                        var re = L.$$start, oe = L.$$end;
                        if (re && (K = U(s, re, oe)), T = n, C > L.priority) break;
                        if ((x = L.scope) && (L.templateUrl || (y(x) ? (J("new/isolated scope", A || $, L, K), 
                        A = L) : J("new/isolated scope", A, L, K)), $ = $ || L), Y = L.name, !L.templateUrl && L.controller && (x = L.controller, 
                        E = E || {}, J("'" + Y + "' controller", E[Y], L, K), E[Y] = L), (x = L.transclude) && (N = !0, 
                        L.$$tlb || (J("transclusion", P, L, K), P = L), "element" == x ? (q = !0, C = L.priority, 
                        T = K, K = o.$$element = na(t.createComment(" " + Y + ": " + o[Y] + " ")), s = K[0], 
                        te(u, F(T), s), Q = j(T, l, C, Z && Z.name, {
                            nonTlbTranscludeDirective: P
                        })) : (T = na(Me(s)).contents(), K.empty(), Q = j(T, l))), L.template) if (V = !0, 
                        J("template", H, L, K), H = L, x = k(L.template) ? L.template(K, o) : L.template, 
                        x = ce(x), L.replace) {
                        ...
                        if (L.templateUrl) V = !0, J("template", H, L, K), H = L, L.replace && (Z = L), 
                        M = B(e.splice(ee, e.length - ee), K, o, u, N && Q, d, m, {
                            controllerDirectives: E,
                            newIsolateScopeDirective: A,
                            templateDirective: H,
                            nonTlbTranscludeDirective: P
                        }), ne = e.length; else if (L.compile) try {
                            S = L.compile(K, o, Q), k(S) ? f(null, S, re, oe) : S && f(S.pre, S.post, re, oe);
                        } catch (e) {
                            r(e, z(K));
                        }
                ...
                function B(e, t, n, a, r, s, o, u) {
                    var c, d, m = [], f = t[0], h = e.shift(), g = p(h, {
                        ...
                        replace: null,
                        $$originalDirective: h
                    }), v = k(h.templateUrl) ? h.templateUrl(t, n) : h.templateUrl, _ = h.templateNamespace;
                    return t.empty(), l(v).then(function(l) {
                        ...
                        if (l = ce(l), h.replace) {
                            ...
                            var k = O(p, [], b);
                            y(h.scope) && W(k), e = k.concat(e), G(n, b);
                        } else p = f, t.html(l);
                        for (e.unshift(g), c = N(e, p, n, r, t, h, s, o, u), i(a, function(e, n) {
                            ...
                            if (!w.$$destroyed) {
                                ...
                                $ = c.transcludeOnThisElement ? P(w, c.transclude, Y) : Y, c(d, w, T, a, $);
                            }
                        }
                        m = null;
                    }), function(e, t, n, a, r) {
        ...
        function st(e) {
            var t, n, a, r = ue();
            return e ? (i(e.split("\n"), function(e) {
                a = e.indexOf(":"), t = Jn(fa(e.substr(0, a))), n = fa(e.substr(a + 1)), t && (r[t] = r[t] ? r[t] + ", " + n : n);
            }), r) : r;
        }
        function ot(e) {
            var t = y(e) ? e : n;
            ...
            this.$get = [ "$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(s, l, u, c, m, p) {
                function f(t) {
                    ...
                    function o(t) {
                        ...
                        i = d({}, i.common, i[Jn(t.method)]);
                        e: for (n in i) {
                            a = Jn(n);
                            for (r in o) if (Jn(r) === a) continue e;
                            o[n] = i[n];
                        }
                        return s(o);
                    }
                ...
                function M(a, r) {
                    ...
                    var p, h, g = m.defer(), b = g.promise, M = a.headers, $ = w(a.url, a.params);
                ...
                function w(e, t) {
                    ...
                    return o(t, function(e, t) {
                        null === e || v(e) || (pa(e) || (e = [ e ]), i(e, function(e) {
                            y(e) && (e = $(e) ? e.toISOString() : W(e)), n.push(J(t) + "=" + J(e));
                        }));
        ...
        function pt(e, t, a, r, s) {
            ...
            return function(s, l, u, c, d, m, p, h) {
                ...
                function v(t, r, i, s, o) {
                    k !== n && a.cancel(k), b = M = null, t(r, i, s, o), e.$$completeOutstandingRequest(f);
                }
                if (e.$$incOutstandingRequestCount(), l = l || e.url(), "jsonp" == Jn(s)) {
                ...
                if (m > 0) var k = a(g, m); else j(m) && m.then(g);
            };
        }
        function ft() {
            var e = "{{", t = "}}";
            this.startSymbol = function(t) {
                ...
                function s(i, s, m, p) {
                    ...
                    p = !!p;
                    for (var g, y, b, M = 0, $ = [], w = [], L = i.length, D = [], Y = []; M < L; ) {
                        if ((g = i.indexOf(e, M)) == -1 || (y = i.indexOf(t, g + o)) == -1) {
                            M !== L && D.push(f(i.substring(M)));
                            break;
                        }
                        M !== g && D.push(f(i.substring(M, g))), b = i.substring(g + o, y), $.push(b), w.push(n(b, h)), 
        ...
        function Lt(e, t, a) {
            this.$$html5 = !0, a = a || "", _t(e, this), this.$$parse = function(e) {
                ...
                var e = B(this.$$search), n = this.$$hash ? "#" + K(this.$$hash) : "";
        ...
        function Dt(e, t, n) {
            _t(e, this), this.$$parse = function(a) {
                ...
                var t = B(this.$$search), a = this.$$hash ? "#" + K(this.$$hash) : "";
            ...
            this.$get = [ "$filter", "$sniffer", function(n, a) {
                ...
                function u(e, t, n, a) {
                    ...
                    return r = e.$watch(function(e) {
                        ...
                        i = e, k(t) && t.apply(this, arguments), _(e) && a.$$postDigest(function() {
                            _(i) && r();
                        });
                    }, n);
                }
        ...
        function qt(e, t) {
            ...
            s.prototype = {
                ...
                $$resolve: function(e) {
                    ...
                    try {
                        (y(e) || k(e)) && (n = e && e.then), k(n) ? (this.promise.$$state.status = -1, n.call(e, a[0], a[1], this.notify)) : (this.promise.$$state.value = e, 
            ...
            this.digestTtl = function(e) {
                ...
                p.prototype = {
                    ...
                    $watch: function(e, t, n) {
                        ...
                        return s = null, k(t) || (o.fn = f), i || (i = r.$$watchers = []), i.unshift(o), 
                        function() {
                            H(i, o), s = null;
                        };
                    },
                ...
                var w = new p(), L = w.$$asyncQueue = [], D = w.$$postDigestQueue = [], Y = w.$$applyAsyncQueue = [];
                return w;
            } ];
        }
        function Kt() {
        ...
        function en() {
            this.$get = [ "$window", "$document", function(e, t) {
                var n, a, r = {}, i = m((/android (\d+)/.exec(Jn((e.navigator || {}).userAgent)) || [])[1]), s = /Boxee/i.test((e.navigator || {}).userAgent), o = t[0] || {}, l = /^(Moz|webkit|ms)(?=[A-Z])/, u = o.body && o.body.style, c = !1, d = !1;
                if (u) {
        ...
        function cn(e, t, n) {
            ...
            return t === !0 ? t = I : k(t) || (t = function(e, t) {
                return !v(e) && (null === e || null === t ? e === t : !y(e) && !y(t) && (e = Jn("" + e), 
                t = Jn("" + t), e.indexOf(t) !== -1));
            }), a = function(a) {
        ...
        var Bn = /^\/(.+)\/([a-z]*)$/, Kn = "validity", Jn = function(e) {
        ...
        }, va = [ "ng-", "data-ng-", "ng:", "x-ng-" ], _a = /[A-Z]/g, ya = !1, ba = 1, Ma = 2, $a = 3, ka = 8, wa = 9, La = 11, Da = {
            full: "1.3.20",
            major: 1,
            minor: 3,
            dot: 20,
        ...
        Ve.$$annotate = We;
        var Ka = a("$animate"), Ja = [ "$provide", function(e) {
            this.$$selectors = {}, this.register = function(t, n) {
                var a = t + "-animation";
                if (t && "." != t.charAt(0)) throw Ka("notcsel", "Expecting class selector starting with '.' got '{0}'.", t);
        ...
        var yr = ue(), br = ue(), Mr = Object.prototype.valueOf, $r = a("$sce"), kr = {
            HTML: "html",
            CSS: "css",
            URL: "url",
            RESOURCE_URL: "resourceUrl",
            JS: "js"
        }, Za = a("$compile"), wr = t.createElement("a"), Lr = rn(e.location.href);
        ...
        var Pr = function(e) {
            ...
            reset: f,
            file: f
        }, Kr = [ "$browser", "$sniffer", "$filter", "$parse", function(e, t, n, a) {
            return {
                restrict: "E",
                require: [ "?ngModel" ],
                link: {
                    pre: function(r, i, s, o) {
                        o[0] && (Br[Jn(s.type)] || Br.text)(r, i, s, o[0], t, e, n, a);
                    }
                }
            };
        } ], Jr = /^(true|false|\d+)$/, Zr = function() {
            return {
                restrict: "A",
                priority: 100,
                compile: function(e, t) {
        ...
        var ui = [ "$animate", function(e) {
            ...
            qn({
                ...
                $.$dirty = !0, $.$pristine = !1, o.removeClass(r, gi), o.addClass(r, vi), w.$setDirty();
            ...
            return {
                ...
                controller: [ "$scope", "$attrs", function(e, t) {
                    ...
                    this.$options.updateOn = fa(this.$options.updateOn.replace(wi, function() {
            ...
            return {
                ...
                link: function(o, l, u, c) {
                    function d(e, t, n, a) {
                        n.$render = function() {
                            var e = n.$viewValue;
                            a.hasOption(e) ? (w.parent() && w.remove(), t.val(e), "" === e && f.prop("selected", !0)) : null == e && f ? t.val("") : a.renderUnknownOption(e);
                    ...
                    function p(t, o, l) {
                        ...
                        function w() {
                            M = !1;
                            var e, n, a, r, c, d, m, f, y, w, L, Y, T, S, C, A, U, F = {
                                "": []
                            }, R = [ "" ], N = l.$viewValue, W = E(t) || [], V = x ? s(W) : W, z = {}, q = p(N), G = !1;
                            for (P = {}, Y = 0; w = V.length, Y < w; Y++) m = Y, x && (m = V[Y], "$" === m.charAt(0)) || (f = W[m], 
                        ...
                        l.$render = w, t.$watchCollection(E, f), t.$watchCollection(m, f), v && t.$watchCollection(function() {
                            return l.$modelValue;
                        }, f);
                    }
                    if (c[1]) {
                        for (var f, h = c[0], g = c[1], v = u.multiple, y = u.ngOptions, b = !1, M = !1, $ = na(t.createElement("option")), k = na(t.createElement("optgroup")), w = $.clone(), L = 0, D = l.children(), Y = D.length; L < Y; L++) if ("" === D[L].value) {
                            f = b = D.eq(L);
                            break;
                        }
                        h.init(g, b, w), v && (g.$isEmpty = function(e) {
                            return !e || 0 === e.length;
    ...
    angular.module("ui.bootstrap.collapse", []).directive("collapse", [ "$animate", function(e) {
        ...
        return {
            ...
            link: function(u, c, d, m) {
                ...
                var S = e(w)(u);
                w.remove(), _ ? n.find("body").append(S) : c.after(S), u.$on("$destroy", function() {
        ...
        return r.$watch(u, function(e) {
            ...
            if ((void 0 === v || !v.length0) && e) {
                ...
                t && t.length && (v = t[0].querySelectorAll(k));
            }
        }, M;
        ...
        return {
            ...
            link: function(d, m, p, f) {
                ...
                var N = function(e, t) {
                    ...
                    w(d, !0), Y(d, !1), n.when(H.source(d, t)).then(function(n) {
                        var a = e === v.$viewValue;
                ...
                v.$parsers.unshift(function(e) {
                    return b = !0, 0 === y || e && e.length >= y ? $ > 0 ? (G(), q(e)) : W(e) : (w(d, !1), 
                    G(), F()), k ? e : e ? void v.$setValidity("editable", !1) : (v.$setValidity("editable", !0), 
                    null);
                }), v.$formatters.push(function(e) {
                    var t, n, a = {};
                    return k || v.$setValidity("editable", !0), T ? (a.$model = e, T(d, a)) : (a[H.itemName] = e, 
                ...
                r.bind("click", B), d.$on("$destroy", function() {
                    r.unbind("click", B), S && K.remove(), U.remove();
                });
                var K = e(U)(P);
                S ? r.find("body").append(K) : m.after(K);
            }
        };
    ...
    !function() {
        ...
        var l = n(32), u = "/api/v1", c = "/oapi/v1", d = {
            ...
            api: c,
            global: !0
        } ]), p = /^[a-z0-9]([-a-z0-9_.]*[a-z0-9])?$/, f = /^[a-zA-Z0-9_.]([-a-zA-Z0-9 ,=@._]*[a-zA-Z0-9._])?$/, h = "120s", g = Math.random().toString(36).slice(2), v = 1;
    ...
    !function() {
        ...
        n(40), i.module("kubeClient.cockpit", [ "kubeClient" ]).factory("CockpitKubeWatch", [ "$q", "KUBE_SCHEMA", "cockpitKubeDiscover", function(n, a, r) {
            return function(a, o) {
                ...
                e("creating watch:", a);
                var f, h, g, v, _ = !1, y = null, b = null, M = null, $ = n.defer(), k = $.promise, w = !1, L = {};
    ...
    !function() {
        ...
        function a(n, a, i, s, o) {
            function l(e) {
                if (!k) return b = e, $ ? void o.cancel() : void (null === b ? (h(), y()) : b === !0 ? (h(), 
            ...
            var b = null, M = null, $ = !1, k = !1, w = [], L = r.element("<div class='dialog-wait-ct pull-left'>");
    ...
    (function(e) {
        ...
        !function(t, n) {
            ...
            function L(e, t) {
                return null !== t ? (t.abbr = e, Fn[e] = Fn[e] || new b(), Fn[e].set(t), w(e), Fn[e]) : (delete Fn[e], 
                null);
            }
            function D(e) {
                var t;
            ...
            function $n() {
                ...
                l.minutes = t % 60, n = v(t / 60), l.hours = n % 24, s += v(n / 24), r = v(kn(s)), 
                o += r, s -= Mn(wn(r)), a = v(o / 12), o %= 12, l.days = s, l.months = o, l.years = a, 
                this;
            }
            function kn(e) {
            ...
            var Pn, On, In = t.momentProperties = [], Un = !1, Fn = {}, Rn = {}, Nn = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, Wn = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Vn = {}, zn = {}, qn = /\d/, Gn = /\d\d/, Bn = /\d{3}/, Kn = /\d{4}/, Jn = /[+-]?\d{6}/, Zn = /\d\d?/, Xn = /\d{1,3}/, Qn = /\d{1,4}/, ea = /[+-]?\d{1,6}/, ta = /\d+/, na = /[+-]?\d+/, aa = /Z|[+-]\d\d:?\d\d/gi, ra = /[+-]?\d+(\.\d{1,3})?/, ia = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, sa = {}, oa = {}, la = 0, ua = 1, ca = 2, da = 3, ma = 4, pa = 5, fa = 6;
            ...
            Y("year", "y"), R("Y", na), R("YY", Zn, Gn), R("YYYY", Qn, Kn), R("YYYYY", ea, Jn), 
            R("YYYYYY", ea, Jn), V([ "YYYYY", "YYYYYY" ], la), V("YYYY", function(e, n) {
            ...
            R("g", na), R("GG", Zn, Gn), R("gg", Zn, Gn), R("GGGG", Qn, Kn), R("gggg", Qn, Kn), 
            R("GGGGG", ea, Jn), R("ggggg", ea, Jn), z([ "gggg", "ggggg", "GGGG", "GGGGG" ], function(e, t, n, a) {
                t[a.substr(0, 2)] = _(e);
            ...
            for (Fa = "S"; Fa.length <= 9; Fa += "S") V(Fa, Jt);
            ...
            Na.lang = ja, Na.locale = yt, Na.localeData = bt, Na.max = La, Na.min = wa, Na.parsingFlags = St, 
            Na.set = E, Na.startOf = Mt, Na.subtract = xa, Na.toArray = Dt, Na.toObject = Yt, 
            Na.toDate = Lt, Na.toISOString = pt, Na.toJSON = pt, Na.toString = mt, Na.unix = wt, 
            Na.valueOf = kt, Na.year = $a, Na.isLeapYear = ce, Na.weekYear = Et, Na.isoWeekYear = At, 
            ...
            Na.isDST = Ge, Na.isDSTShifted = Be, Na.isLocal = Ke, Na.isUtcOffset = Je, Na.isUtc = Ze, 
            ...
            }, qa = "Invalid date", Ga = "%d", Ba = /\d{1,2}/, Ka = {
                future: "in %s",
                past: "%s ago",
                s: "a few seconds",
                m: "a minute",
            ...
            Ja._calendar = Va, Ja.calendar = tn, Ja._longDateFormat = za, Ja.longDateFormat = nn, 
            Ja._invalidDate = qa, Ja.invalidDate = an, Ja._ordinal = Ga, Ja.ordinal = rn, Ja._ordinalParse = Ba, 
            Ja.preparse = sn, Ja.postformat = sn, Ja._relativeTime = Ka, Ja.relativeTime = on, 
            Ja.pastFuture = ln, Ja.set = un, Ja.months = B, Ja._months = ha, Ja.monthsShort = K, 
            Ja._monthsShort = ga, Ja.monthsParse = J, Ja.week = me, Ja._week = ka, Ja.firstDayOfYear = fe, 
            Ja.firstDayOfWeek = pe, Ja.weekdays = Ut, Ja._weekdays = Ea, Ja.weekdaysMin = Rt, 
            Ja._weekdaysMin = Ha, Ja.weekdaysShort = Ft, Ja._weekdaysShort = Aa, Ja.weekdaysParse = Nt, 
            Ja.isPM = Bt, Ja._meridiemParse = Pa, Ja.meridiem = Kt, w("en", {
            ...
            t.months = mn, t.isDate = i, t.locale = w, t.invalid = p, t.duration = Xe, t.isMoment = g, 
    ...
    !function() {
        var e = n(32);
        n(40), e.module("registry.policy", [ "kubeClient" ]).factory("projectPolicy", [ "$q", "$rootScope", "kubeLoader", "kubeMethods", "kubeSelect", "KubeWatch", "KubeRequest", "KUBE_SCHEMA", function(t, n, a, r, i, s, o, l) {
            function u(e) {
                return l.RoleBinding.api = e ? j : C, l.rolebindings.api = e ? j : C, T = e, v(null), 
                f(null), e ? "rolebindings" : "policybindings";
            }
            function c() {
                return S || (S = new o("GET", "/oapi/v1").then(function(e) {
                    var t, n = e.data || {}, a = n.resources || [];
                    for (t = 0; t < a.length; t++) if ("PolicyBinding" == a[t].kind) return u();
                    return u(x);
                }, function(e) {
            ...
            function m(t) {
                e.forEach(t, function(e) {
                    ...
                    if (!(t in a.objects || "Group" == e.kind && 0 === e.name.indexOf("system:"))) {
                        var n = {
                            kind: e.kind,
                            apiVersion: "v1",
                            metadata: {
            ...
            function p(e, t, a, r) {
                var i = t + ":" + a;
                e in E || (E[e] = {}), E[e][i] = r, r && e in A && delete A[e][i], n.$applyAsync();
            }
            function f(t) {
                t ? (A[t] = e.extend({}, E[t]), delete E[t]) : (A = E, E = {}), n.$applyAsync();
            }
            function h(e, t, n) {
                var i = t + ":" + n, s = !0, o = null, l = E[e];
                if (l && i in l && (o = l[i], s = !1), o || (l = A[e], l && i in l && (o = l[i])), 
                !s) return o;
                var u = {
                    kind: "LocalResourceAccessReview",
                    apiVersion: "v1",
                ...
                p(e, t, n, null);
                var c = a.resolve("localresourceaccessreviews", null, e);
                return r.post(c, u).then(function(a) {
                    p(e, t, n, a);
                }, function(a) {
            ...
            function g(e, n, i, s) {
                ...
                if (o in H) l.resolve(H[o]); else {
                    ...
                    r.post(a.resolve("subjectaccessreviews"), u).then(function(e) {
                        H[o] = e.allowed, l.resolve(e.allowed);
                    }, function(e) {
            ...
            function v(e) {
                if (e) for (var t in H) 0 === t.lastIndexOf(e + ":", 0) && delete H[t]; else H = {};
                n.$applyAsync();
            }
            function _(e, t, n) {
            ...
            function y(e, t, n) {
                ...
                return k(L(i, "subjects"), n), k(D(i, n.kind), n.name), r.create(i, e);
            }
            function b(e, n, a) {
                a.apiGroup = T;
                var r = Y(e);
                return _(r, n, function(e) {
                    w(L(e, "subjects"), a), w(D(e, a.kind), a.name);
                }).then(function() {
                    f(r);
                }, function(e) {
            ...
            function M(n, a, r) {
                var s = [ "registry-admin", "registry-editor", "registry-viewer" ], o = t.when(), l = [], u = i().kind("PolicyBinding").namespace(n).name(":default").one();
                return r.apiGroup = T, u && (l = u.roleBindings), e.forEach(a, function(e) {
                    $(s, e.roleRef.name) !== -1 && (o = o.then(function() {
                        return b(n, e.roleRef.name, r);
                    }));
                }), o;
            }
            function $(t, n) {
            ...
            function D(e, t) {
                return "Group" == t || "SystemGroup" == t ? L(e, "groupNames") : L(e, "userNames");
            }
            function Y(e) {
                return "object" == typeof e ? e.metadata.name : e;
            }
            var T, S, x = "rbac.authorization.k8s.io", j = "/apis/rbac.authorization.k8s.io/v1beta1", C = l.RoleBinding.api;
            a.listen(function(e, t) {
                var n, a = {};
                if (!e && !t) return v(null), f(null), void (S = null);
                for (n in t) "PolicyBinding" == t[n].kind && (d(t[n].roleBindings, !0), a[t[n].metadata.namespace] = !0);
                for (n in e) "PolicyBinding" == e[n].kind ? (d(e[n].roleBindings, !1), a[e[n].metadata.namespace] = !0) : "RoleBinding" == e[n].kind && (m(e[n].subjects || []), 
            ...
            return {
                ...
                addToRole: function(e, n, a) {
                    ...
                    var r = Y(e);
                    return _(r, n, function(e) {
                        k(L(e, "subjects"), a), k(D(e, a.kind), a.name);
                    }).then(function() {
                        f(r);
                    }, function(e) {
                        return 404 === e.code ? y(r, n, a) : t.reject(e);
                    });
                },
                removeFromRole: b,
                removeMemberFromProject: M,
    ...
    !function() {
        ...
        n(225), n(226), n(227), n(228), n(229), n(230), n(231), n(232), t.module("registry.projects", [ "ngRoute", "ui.cockpit", "kubeClient", "kubernetes.listing", "registry.policy" ]).config([ "$routeProvider", function(e) {
        ...
        } ]).controller("ProjectsCtrl", [ "$scope", "$routeParams", "$location", "kubeSelect", "kubeLoader", "projectData", "projectActions", "ListingState", "roleActions", "projectPolicy", function(e, n, a, r, i, s, o, l, u, c) {
            i.watch("users", e), i.watch("groups", e), c.watch(e);
            var d = n.namespace || "";
            e.projName = d, d ? (e.listing = new l(e), e.project = function() {
                return r().kind("Project").name(d).one();
        ...
        } ]).controller("UserCtrl", [ "$scope", "$routeParams", "$location", "kubeSelect", "kubeLoader", "projectData", "projectActions", "roleActions", "ListingState", "projectPolicy", function(e, n, a, r, i, s, o, l, u, c) {
            i.watch("users", e), i.watch("groups", e), c.watch(e);
            var d = n.user || "";
            e.userName = d, d ? (e.user = function() {
                return r().kind("User").name(d).one();
        ...
        } ]).controller("GroupCtrl", [ "$scope", "$routeParams", "$location", "kubeSelect", "kubeLoader", "projectData", "projectActions", "roleActions", "ListingState", "projectPolicy", function(e, n, a, r, i, s, o, l, u, c) {
            i.watch("users", e), i.watch("groups", e), c.watch(e);
            var d = n.group || "";
            e.groupName = d, d ? (e.group = function() {
                return r().kind("Group").name(d).one();
            }, e.listing = new u(e), e.$on("activate", function(e, t) {
                e.preventDefault(), a.path(t);
            })) : (e.listing = new u(e), a.path("/projects")), e.projects = function() {
                return r().kind("Project");
            ...
            function o(e) {
                var t, n;
                for (t = w.length - 1; t >= 0; t--) if (w[t].ocRole === e) {
                    n = w[t].displayRole;
                    break;
                }
                return n;
            ...
            function f(n) {
                var a = e.when(), r = s.getGroupsWithMember(p(), n.metadata.name);
                t.forEach(r, function(e) {
                    a = a.then(function() {
                        return u.removeUserFromGroup(n, e);
                    });
                });
                var l = s.getProjectsWithMember(m(), n.metadata.name);
                return t.forEach(l, function(e) {
                    var t = s.subjectRoleBindings(n.metadata.name, e.metadata.name), r = {
                        kind: n.kind,
                        name: n.metadata.name
                    };
                    a = a.then(function() {
                        return o.removeMemberFromProject(e.metadata.name, t, r);
                    });
                }), a = a.then(function() {
                    return i.delete(n);
                });
            ...
            n.performModify = function() {
                ...
                var e = n.fields.memberObj, t = n.fields.parentObj.metadata.name, a = s.subjectRoleBindings(e.metadata.name, t), r = {
                    kind: e.kind,
                    name: e.metadata.name
                };
                return o.removeMemberFromProject(t, a, r);
            };
            ...
            function m(n) {
                var a = e.when(), s = i.getProjectsWithMember(d(), n.metadata.name);
                return t.forEach(s, function(e) {
    ...
    !function() {
        ...
        e.module("registry", [ "ngRoute", "ui.bootstrap", "ui.bootstrap.popover", "gettext", "kubernetes.app", "kubernetes.date", "registry.images", "registry.projects", "registry.policy", "registryUI.date", "kubeClient", "kubeClient.cockpit" ]).config([ "$routeProvider", "KubeWatchProvider", "KubeRequestProvider", "KubeDiscoverSettingsProvider", "MomentLibProvider", "$provide", function(e, t, n, a, r, i) {
            ...
            n.load("projects"), c.watch(e), s.watchImages(e), r.register("buildRecentStreams", function() {
                var e, n = [];
