!function(t) {
	 ...
	 */
        !function(t, e, n) {
            ...
            function U(t, e, n, r) {
                if (E(t) || k(t)) throw ar("cpws", "Can't copy! Making copies of Window or Scope instances is not supported.");
                if (e) {
                ...
                } else if (e = t, t) if (cr(t)) e = U(t, [], n, r); else if (x(t)) e = new Date(t.getTime()); else if (C(t)) e = new RegExp(t.source, t.toString().match(/[^\/]*$/)[0]), 
            ...
            function P(t, e) {
                ...
                if (a == s && "object" == a) {
                    if (!cr(t)) {
                        ...
                        if (k(t) || k(e) || E(t) || E(e) || cr(e)) return !1;
                        o = {};
            ...
            function vt(t, e) {
                ...
                if (mt(t)) u.push(e.createTextNode(t)); else {
                    ...
                    i = Ir[r] || Ir._default, n.innerHTML = i[1] + t.replace(Dr, "<$1></$2>") + i[2], 
            ...
            function Gt(t, e, r, i) {
                ...
                function c() {
                    T = t.history.state, T = g(T) ? null : T, P(T, D) && (T = D), D = T;
                }
                function f() {
                ...
                var I = {}, U = "", R = d.baseHref();
                d.cookies = function(t, e) {
                    var i, o, a, s, u;
                    if (!t) {
                        if ($.cookie !== U) for (U = $.cookie, o = U.split("; "), I = {}, s = 0; s < o.length; s++) a = o[s], 
                        u = a.indexOf("="), u > 0 && (t = h(a.substring(0, u)), I[t] === n && (I[t] = h(a.substring(u + 1))));
                        return I;
                    }
                ...
                this.debugInfoEnabled = function(t) {
                    ...
                    function q(t, e, n, r, i) {
                        ...
                        return function(e, n, r) {
                            ...
                            var l;
                            if (l = "html" !== s ? Xn(K(s, Xn("<div>").append(t).html())) : n ? Ur.clone.call(t) : t, 
                    ...
                    function j(t, e, r, i, o, a) {
                        function s(t, r, i, o) {
                            ...
                            q.$$addScopeInfo(Xn(u), l)) : l = t, d = a.transcludeOnThisElement ? U(t, a.transclude, o, a.elementTranscludeOnThisElement) : !a.templateOnThisElement && o ? o : !o && e ? U(t, e) : null, 
                        ...
                        switch (s) {
                          case gr:
                            ...
                            for (var f, h, d, p, $, m, g = t.attributes, v = 0, w = g && g.length; v < w; v++) {
                                var x = !1, S = !1;
                                f = g[v], h = f.name, $ = fr(f.value), p = Kt(h), (m = ft.test(p)) && (h = h.replace(Wr, "").substr(8).replace(/_(.)/g, function(t, e) {
                          ...
                          case yr:
                            try {
                                o = l.exec(t.nodeValue), o && (d = Kt(o[1]), B(e, d, "M", r, i) && (n[d] = fr(o[2])));
                            } catch (t) {}
                        }
                        return e.sort(J), e;
                    }
                    ...
                    function H(t, a, s, u, l, c, f, h, d) {
                        ...
                        function $(t, e, n, r) {
                            ...
                            if (b(e)) {
                                ...
                                i = i || l[s]("$" + e + "Controller"), !i && !u) throw Gr("ctreq", "Controller '{0}', required by directive '{1}', can't be found!", e, t);
                                return i || null;
                            }
                        ...
                        function w(t, e, i, u, l) {
                            ...
                            if (a === i ? (E = s, S = s.$$element) : (S = Xn(i), E = new at(S, s)), D && (b = e.$new(!0)), 
                                    ...
                                    switch (c) {
                                      ...
                                      case "=":
                                        ...
                                        o = m(E[u]), s = o.literal ? P : function(t, e) {
                                            ...
                                            throw i = A[n] = o(e), Gr("nonassign", "Expression '{0}' used with directive '{1}' is non-assignable!", E[u], D.name);
                                        }, i = A[n] = o(e);
                                        var f = function(t) {
                        ...
                        d = d || {};
                        for (var x, C, E, T, A, M, O, N = -Number.MAX_VALUE, j = d.controllerDirectives, D = d.newIsolateScopeDirective, I = d.templateDirective, U = d.nonTlbTranscludeDirective, H = !1, B = !1, z = d.hasElementTranscludeDirective, J = s.$$element = Xn(a), Z = c, X = u, tt = 0, nt = t.length; tt < nt; tt++) {
                            E = t[tt];
                            ...
                            A = J, J = s.$$element = Xn(e.createComment(" " + T + ": " + s[T] + " ")), a = J[0], 
                            et(l, F(A), a), X = q(A, u, N, Z && Z.name, {
                                nonTlbTranscludeDirective: U
                            })) : (A = Xn(wt(a)).contents(), J.empty(), X = q(A, u))), E.template) if (B = !0, 
                            Y("template", I, E, J), I = E, O = S(E.template) ? E.template(J, s) : E.template, 
                            O = ct(O), E.replace) {
                                if (Z = E, A = mt(O) ? [] : te(K(E.templateNamespace, fr(O))), a = A[0], 1 != A.length || a.nodeType !== gr) throw Gr("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", T, "");
                                et(l, J, a);
                                var ut = {
                                    $attr: {}
                    ...
                    function W(t, e, n, r, i, a, s, l) {
                        ...
                        return e.empty(), u(T.getTrustedResourceUrl(g)).then(function(u) {
                            var d, b, w, x;
                            if (u = ct(u), $.replace) {
                                if (w = mt(u) ? [] : te(K(v, fr(u))), d = w[0], 1 != w.length || d.nodeType !== gr) throw Gr("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", $.name, g);
                                b = {
                                    $attr: {}
                                }, et(r, e, d);
                                var S = R(d, [], b);
                            ...
                            for (t.unshift(m), c = H(t, d, n, i, e, $, a, s, l), o(r, function(t, n) {
                                ...
                                if (!C.$$destroyed) {
                                    if (E !== p) {
                                        var M = E.className;
                                        l.hasElementTranscludeDirective && $.replace || (A = wt(d)), et(k, Xn(E), A), O(Xn(A), M);
                                    }
                    ...
                    function Y(t, e, n, r) {
                        if (e) throw Gr("multidir", "Multiple directives [{0}, {1}] asking for {2} on: {3}", e.name, n.name, t, Q(r));
                    }
                    function Z(t, e) {
                        var n = r(e, !0);
                        n && t.push({
                    ...
                    function tt(t, e, n, i, o) {
                        ...
                        var s = r(n, !0, a, o);
                        if (s) {
                            if ("multiple" === i && "select" === D(t)) throw Gr("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", Q(t));
                            e.push({
                                priority: 100,
                                compile: function() {
                                    return {
                                        pre: function(t, e, u) {
                                            ...
                                            if (w.test(i)) throw Gr("nodomevents", "Interpolations for HTML DOM event attributes are disallowed.  Please use the ng- versions (such as ng-click instead of onclick) instead.");
                                            var c = u[i];
                ...
                this.$get = [ "$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(a, u, l, c, h, d) {
                    function p(e) {
                        ...
                        function s(e) {
                            ...
                            t: for (n in o) {
                                r = Gn(n);
                                for (i in s) if (Gn(i) === r) continue t;
                                s[n] = o[n];
                            }
                            return a(s);
                        }
                        ...
                        u.headers = s(e), u.method = Jn(u.method);
                        var l = function(e) {
            ...
            function Ee(t, e) {
                ...
                ve(t, this), this.$$parse = function(t) {
                    ...
                    var t = W(this.$$search), e = this.$$hash ? "#" + J(this.$$hash) : "";
            ...
            function ke(t, e) {
                ...
                ve(t, this), this.$$parse = function(r) {
                    ...
                    var n = W(this.$$search), r = this.$$hash ? "#" + J(this.$$hash) : "";
                ...
                this.hashPrefix = function(e) {
                    ...
                    o.on("click", function(t) {
                        if (e.rewriteLinks && !t.ctrlKey && !t.metaKey && !t.shiftKey && 2 != t.which && 2 != t.button) {
                            for (var i = Xn(t.target); "a" !== D(i[0]); ) if (i[0] === o[0] || !(i = i.parent())[0]) return;
            ...
            function Ge() {
                ...
                this.digestTtl = function(e) {
                    ...
                    f.prototype = {
                        ...
                        $digest: function() {
                            var r, i, o, u, l, f, p, $, g, y, b = t, E = this, k = [];
                            ...
                            do {
                                ...
                                t: do {
                                    if (u = $.$$watchers) for (l = u.length; l--; ) try {
                                        ...
                                        } else f = !0, n = r, r.last = r.eq ? U(i, null) : i, r.fn(i, o === m ? i : o, $), 
                                    ...
                                    if (!(p = $.$$childHead || $ !== E && $.$$nextSibling)) for (;$ !== E && !(p = $.$$nextSibling); ) $ = $.$parent;
                                } while ($ = p);
                    ...
                    var w = new f(), x = w.$$asyncQueue = [], C = w.$$postDigestQueue = [], E = w.$$applyAsyncQueue = [];
                    return w;
                } ];
            }
            function We() {
            ...
            function Ke() {
                ...
                this.enabled = function(e) {
                    ...
                    if (t && Kn < 8) throw vi("iequirks", "Strict Contextual Escaping does not support Internet Explorer version < 11 in quirks mode.  You can fix this by adding the text <!doctype html> to the top of your HTML document.  See http://docs.angularjs.org/api/ng.$sce for more information.");
                    var r = R(yi);
            ...
            function Xe() {
                this.$get = [ "$window", "$document", function(t, e) {
                    var n, r, i = {}, o = h((/android (\d+)/.exec(Gn((t.navigator || {}).userAgent)) || [])[1]), a = /Boxee/i.test((t.navigator || {}).userAgent), s = e[0] || {}, u = /^(Moz|webkit|ms)(?=[A-Z])/, l = s.body && s.body.style, c = !1, f = !1;
                    if (l) {
            ...
            function rn(t) {
                var e = t;
                return Kn && (bi.setAttribute("href", e), e = bi.href), bi.setAttribute("href", e), 
                {
                    href: bi.href,
            ...
            function sn(t) {
                ...
                } ], e("currency", fn), e("date", xn), e("filter", un), e("json", Sn), e("limitTo", Cn), 
                e("lowercase", ki), e("number", hn), e("orderBy", En), e("uppercase", Ti);
            }
            function un() {
            ...
            function xn(t) {
                ...
                return function(n, r, i) {
                    var a, s, u = "", l = [];
                    if (r = r || "mediumDate", r = t.DATETIME_FORMATS[r] || r, b(n) && (n = Ei.test(n) ? h(n) : e(n)), 
            ...
            function Un(t, e, r, i, o, a) {
                if (In(t, e, r, i), qn(t, e, r, i, o, a), i.$$parserName = "number", i.$parsers.push(function(t) {
            ...
            var Qn = /^\/(.+)\/([a-z]*)$/, zn = "validity", Gn = function(t) {
                return b(t) ? t.toLowerCase() : t;
            }, Wn = Object.prototype.hasOwnProperty, Jn = function(t) {
            ...
            "i" !== "I".toLowerCase() && (Gn = Yn, Jn = Zn);
            var Kn, Xn, tr, er, nr = [].slice, rr = [].splice, ir = [].push, or = Object.prototype.toString, ar = r("ng"), sr = t.angular || (t.angular = {}), ur = 0;
            Kn = e.documentMode, p.$inject = [], $.$inject = [];
            ...
            bt.expando = "ng339";
            var Sr = bt.cache = {}, Cr = 1, Er = function(t, e, n) {
            ...
            }, Or = r("jqLite"), qr = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Nr = /<|&#?\w+;/, jr = /<([\w:]+)/, Dr = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ir = {
            ...
            Ir.optgroup = Ir.option, Ir.tbody = Ir.tfoot = Ir.colgroup = Ir.caption = Ir.thead, 
            Ir.th = Ir.td;
            var Ur = bt.prototype = {
                ready: function(n) {
                    function r() {
                ...
                on: function t(e, n, r, i) {
                    ...
                    if (gt(e)) {
                        ...
                        for (var u = n.indexOf(" ") >= 0 ? n.split(" ") : [ n ], l = u.length; l--; ) {
                            ...
                            }) : "$destroy" !== n && Er(e, n, s), c = a[n]), c.push(r);
                        }
                    }
                },
                off: St,
            ...
            var Wr = /^((?:x|data)[\:\-_])/i, Jr = r("$controller"), Yr = "application/json", Zr = {
            ...
            o([ Te, ke, Ee ], function(t) {
                t.prototype = Object.create(oi), t.prototype.state = function(e) {
                    ...
                    if (t !== Ee || !this.$$html5) throw ii("nostate", "History API state support is available only in HTML5 mode and only in browsers supporting HTML5 History API");
            ...
            var $i = lt(), mi = lt(), gi = Object.prototype.valueOf, vi = r("$sce"), yi = {
                ...
                JS: "js"
            }, Gr = r("$compile"), bi = e.createElement("a"), wi = rn(t.location.href);
                    ...
                    return {
                        ...
                        link: function(n, r, i) {
                            ...
                            i.$attr[a] = "xlink:href", o = null), i.$observe(e, function(e) {
                                return e ? (i.$set(a, e), void (Kn && o && r.prop(o, i[a]))) : void ("href" === t && i.$set(a, null));
                            });
                        }
                    };
                };
                        ...
                        compile: function(t) {
                            return t.addClass(ho).addClass(co), {
                                pre: function(t, r, i, o) {
                                    ...
                                    u && (Ue(t, null, u, o, u), i.$observe(i.name ? "name" : "ngForm", function(e) {
                                        u !== e && (Ue(t, null, u, n, u), u = e, Ue(t, null, u, o, u), s.$$renameControl(o, u));
                                    })), r.on("$destroy", function() {
                                        s.$removeControl(o), u && Ue(t, null, u, n, u), f(o, Oi);
                                    });
                                }
                            };
                        }
            ...
            }, ji = Ni(), Di = Ni(!0), Ii = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, Ui = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Ri = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Pi = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Vi = /^(\d{4})-(\d{2})-(\d{2})$/, Fi = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Li = /^(\d{4})-W(\d\d)$/, Hi = /^(\d{4})-(\d\d)$/, _i = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Bi = {
                text: On,
                date: Dn("date", Vi, jn(Vi, [ "yyyy", "MM", "dd" ]), "yyyy-MM-dd"),
                "datetime-local": Dn("datetimelocal", Fi, jn(Fi, [ "yyyy", "MM", "dd", "HH", "mm", "ss", "sss" ]), "yyyy-MM-ddTHH:mm:ss.sss"),
                time: Dn("time", _i, jn(_i, [ "HH", "mm", "ss", "sss" ]), "HH:mm:ss.sss"),
                week: Dn("week", Li, Nn, "yyyy-Www"),
                month: Dn("month", Hi, jn(Hi, [ "yyyy", "MM" ]), "yyyy-MM"),
                number: Un,
                url: Rn,
                email: Pn,
                radio: Vn,
            ...
            } ], Yi = [ "$sce", "$parse", "$compile", function(t, e, n) {
                return {
                    restrict: "A",
            ...
            }), Ki = Hn("", !0), Xi = Hn("Odd", 0), to = Hn("Even", 1), eo = kn({
                compile: function(t, e) {
            ...
            var oo = [ "$animate", function(t) {
                ...
                var C = i.inheritedData("$formController") || Oi, E = 0;
                _n({
                    ctrl: this,
                    $element: i,
                    set: function(t, e) {
                    ...
                    x.$dirty = !0, x.$pristine = !1, s.removeClass(i, ho), s.addClass(i, po), C.$setDirty();
                        ...
                        return y ? x = t(y) : (C = function(t, e) {
                            ...
                            t.$watchCollection(g, function(r) {
                                ...
                                for (h = 0; h < x; h++) if (k = r === O ? h : O[h], T = r[k], q = N[h], q.scope) {
                                    ...
                                    c(q) != y && a.move(ut(q.clone), null, Xn(D)), D = f(q), l(q.scope, h, b, T, w, k, x);
                                } else $(function(t, e) {
                                    q.scope = e;
                                    var n = p.cloneNode(!1);
                                    t[t.length++] = n, a.enter(t, null, Xn(D)), D = n, q.clone = t, I[q.id] = q, l(q.scope, h, b, T, w, k, x);
                                });
                                m = I;
                            });
                        };
                ...
                return {
                    ...
                    link: function(s, u, l, c) {
                        function f(t, e, n, r) {
                            n.$render = function() {
                                var t = n.$viewValue;
                                r.hasOption(t) ? (E.parent() && E.remove(), e.val(t), "" === t && p.prop("selected", !0)) : g(t) && p ? e.val("") : r.renderUnknownOption(t);
                        ...
                        function d(e, s, u) {
                            ...
                            function d(t) {
                                ...
                                return function(n, r) {
                                    var i;
                                    return i = I ? I : M ? M : N, y ? v(e.remove(l(i, n, r))) : t === l(i, n, r);
                                };
                            }
                            function p() {
                            ...
                            function g() {
                                x = !1;
                                var t, n, r, i, c, f, h, p, g, b, E, T, A, M, N, D, V, F = {
                                    "": []
                                }, L = [ "" ], H = u.$viewValue, _ = j(e) || [], B = O ? a(_) : _, Q = {}, z = d(H), G = !1;
                                for (U = {}, T = 0; b = B.length, T < b; T++) h = T, O && (h = B[T], "$" === h.charAt(0)) || (p = _[h], 
                                ...
                                for (y || (w || null === H ? F[""].unshift({
                                    ...
                                    Kn && M.prop("selected", f.selected))) : ("" === r.id && w ? N = w : (N = S.clone()).val(r.id).prop("selected", r.selected).attr("selected", r.selected).prop("label", r.label).text(r.label), 
                                    c.push(f = {
                                        element: N,
                                        label: r.label,
                                        id: r.id,
                            ...
                            var E;
                            if (!(E = b.match(i))) throw Uo("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", b, Q(s));
                        ...
                        if (c[1]) {
                            for (var p, $ = c[0], m = c[1], y = l.multiple, b = l.ngOptions, w = !1, x = !1, S = Xn(e.createElement("option")), C = Xn(e.createElement("optgroup")), E = S.clone(), k = 0, T = u.children(), A = T.length; k < A; k++) if ("" === T[k].value) {
                                p = w = T.eq(k);
                                break;
                            }
                            $.init(m, w, E), y && (m.$isEmpty = function(t) {
                                return !t || 0 === t.length;
