!function(e) {
    ...
    !function(e, t, n) {
        ...
        function A(e, t, n, a) {
            ...
            } else if (t = e, e) if (pa(e)) t = A(e, [], n, a); else if ($(e)) t = new Date(e.getTime()); else if (k(e)) t = new RegExp(e.source, e.toString().match(/[^\/]*$/)[0]), 
        ...
        function pe(t) {
            ...
            ra("ng", [ "ngLocale" ], [ "$provide", function(e) {
                e.provider({
                    ...
                    ngInclude: di
                }).directive(jr).directive(oi), e.provider({
                    $anchorScroll: We,
                    $animate: Ka,
                    $browser: Ge,
                    $cacheFactory: Je,
        ...
        function he(e) {
            return e.replace(Ea, function(e, t, n, a) {
        ...
        function ve(e, t) {
            ...
            if (ge(e)) l.push(t.createTextNode(e)); else {
                ...
                r = qa[a] || qa._default, n.innerHTML = r[1] + e.replace(Fa, "<$1></$2>") + r[2], 
        ...
        function we(e, t, n, a) {
            if (v(a)) throw Ha("offargs", "jqLite#off() does not support the `selector` argument");
        ...
        function Oe(e, t) {
            var n = e.nodeName;
            return ("INPUT" === n || "TEXTAREA" === n) && Ia[t];
        }
        function Fe(e, t) {
            var n = function(n, a) {
        ...
        function Re(e) {
            var t = e.toString().replace(Ba, ""), n = t.match(Ua);
            ...
            if ("function" == typeof e) {
                if (!(a = e.$inject)) {
                    if (a = [], e.length) {
                        ...
                        r = e.toString().replace(Ba, ""), s = r.match(Ua), i(s[1].split(Wa), function(e) {
        ...
        function Ue(e, t) {
            ...
            function r(e, t) {
                if (se(e, "service"), (w(t) || pa(t)) && (t = D.instantiate(t)), !t.$get) throw Ga("pget", "Provider '{0}' must define $get factory method.", e);
                return L[e + M] = t;
            }
            function s(e, t) {
                return function() {
        ...
        function Be(e, t, a, r) {
            ...
            var T, S, x = v.href, E = t.find("base"), C = null;
            d(), S = T, h.url = function(t, n, a) {
                ...
                t) {
                    ...
                    var s = x && Mt(x) === Mt(t);
                    return x = t, S = a, !r.history || s && i ? (s && !C || (C = t), n ? v.replace(t) : s ? v.hash = o(t) : v.href = t) : (y[n ? "replaceState" : "pushState"](a, "", t), 
                    d(), S = T), h;
                }
            ...
            h.onUrlChange = function(t) {
                return H || (r.history && na(e).on("popstate", u), na(e).on("hashchange", u), H = !0), 
                j.push(t), t;
            }, h.$$checkUrlChange = m, h.baseHref = function() {
                var e = E.attr("href");
                return e ? e.replace(/^(https?\:)?\/\/[^\/]*/, "") : "";
            };
            var A = {}, O = "", q = h.baseHref();
            h.cookies = function(e, t) {
                var r, i, s, o, l;
                if (!e) {
                    if (g.cookie !== O) for (O = g.cookie, i = O.split("; "), A = {}, o = 0; o < i.length; o++) s = i[o], 
                    l = s.indexOf("="), l > 0 && (e = p(s.substring(0, l)), A[e] === n && (A[e] = p(s.substring(l + 1))));
                    return A;
                }
                t === n ? g.cookie = encodeURIComponent(e) + "=;path=" + q + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : b(t) && (r = (g.cookie = encodeURIComponent(e) + "=" + encodeURIComponent(t) + ";path=" + q).length + 1, 
            ...
            this.debugInfoEnabled = function(e) {
                ...
                function E(e, t, n, a, r) {
                    ...
                    return function(t, n, a) {
                        ...
                        var u;
                        if (u = "html" !== o ? na(Z(o, na("<div>").append(e).html())) : n ? Va.clone.call(e) : e, 
                ...
                function j(e, t, a, r, i, s) {
                    function o(e, a, r, i) {
                        ...
                        E.$$addScopeInfo(na(l), u)) : u = e, p = s.transcludeOnThisElement ? A(e, s.transclude, i, s.elementTranscludeOnThisElement) : !s.templateOnThisElement && i ? i : !i && t ? A(e, t) : null, 
                ...
                function O(e, t, n, a, r) {
                    ...
                    switch (o) {
                      case ba:
                        ...
                        U(t, p, "C", a, r) && (n[p] = fa(i[3])), s = s.substr(i.index + i[0].length);
                        break;
                      ...
                      case wa:
                        try {
                            i = u.exec(e.nodeValue), i && (p = Ze(i[1]), U(t, p, "M", a, r) && (n[p] = fa(i[2])));
                        } catch (e) {}
                    }
                    return t.sort(J), t;
                }
                ...
                function R(e, s, o, l, u, c, d, m, p) {
                    ...
                    function M(e, t, r, l, u) {
                        ...
                        var p, f, _, y, b, M, $, w, L;
                        if (s === r ? (L = o, w = o.$$element) : (w = na(r), L = new se(w, o)), H && (b = t.$new(!0)), 
                                ...
                                switch (c) {
                                  ...
                                  case "=":
                                    ...
                                    i = g(L[l]), o = i.literal ? F : function(e, t) {
                                        ...
                                        throw r = T[n] = i(t), Qa("nonassign", "Expression '{0}' used with directive '{1}' is non-assignable!", L[l], H.name);
                                    }, r = T[n] = i(t);
                                    var d = function(e) {
                    ...
                    p = p || {};
                    for (var $, k, L, Y, T, S, x, C = -Number.MAX_VALUE, j = p.controllerDirectives, H = p.newIsolateScopeDirective, P = p.templateDirective, A = p.nonTlbTranscludeDirective, R = !1, U = !1, z = p.hasElementTranscludeDirective, J = o.$$element = na(s), Q = c, X = l, ee = 0, ne = e.length; ee < ne; ee++) {
                        L = e[ee];
                        ...
                        })) : (T = na(Me(s)).contents(), J.empty(), X = E(T, l))), L.template) if (U = !0, 
                        K("template", P, L, J), P = L, x = w(L.template) ? L.template(J, o) : L.template, 
                        x = ce(x), L.replace) {
                            if (Q = L, T = ge(x) ? [] : et(Z(L.templateNamespace, fa(x))), s = T[0], 1 != T.length || s.nodeType !== ba) throw Qa("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", Y, "");
                            te(u, J, s);
                            var le = {
                                $attr: {}
                ...
                function ee(e, t, n, r, i) {
                    ...
                    var o = a(n, !0, s, i);
                    if (o) {
                        if ("multiple" === r && "select" === H(e)) throw Qa("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", W(e));
                        t.push({
                            priority: 100,
                            compile: function() {
                                return {
        ...
        function ct() {
            ...
            this.$get = [ "$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(s, l, u, c, m, p) {
                ...
                function M(a, r) {
                    ...
                    p && (h = p.get($), v(h) ? E(h) ? h.then(u, u) : pa(h) ? o(h[1], h[0], O(h[2]), h[3]) : o(h, 200, {}, "OK") : p.put($, b)), 
                    _(h)) {
        ...
        function Dt(e, t, n) {
            vt(e, this), this.$$parse = function(a) {
                ...
                _(s) || "#" !== s.charAt(0) ? this.$$html5 ? i = s : (i = "", _(s) && (e = a, this.replace())) : (i = bt(n, s), 
                _(i) && (i = s)), yt(i, this), this.$$path = r(this.$$path, i, e), this.$$compose();
            }, this.$$compose = function() {
            ...
            this.hashPrefix = function(t) {
                ...
                i.on("click", function(e) {
                    if (t.rewriteLinks && !e.ctrlKey && !e.metaKey && !e.shiftKey && 2 != e.which && 2 != e.button) {
                        for (var r = na(e.target); "a" !== H(r[0]); ) if (r[0] === i[0] || !(r = r.parent())[0]) return;
                ...
                return a.onUrlChange(function(e, t) {
                    return _(bt(f, e)) ? void (s.location.href = e) : (n.$evalAsync(function() {
        ...
        function Ot(e, t, n, a, r) {
            ...
            return i = Ct(s.shift(), r), Ht(e[i], r), e[i] = a, a;
        }
        function Ft(e) {
            return "constructor" == e;
        }
        function qt(e, t, a, r, i, s, o) {
            Ct(e, s), Ct(t, s), Ct(a, s), Ct(r, s), Ct(i, s);
            var l = function(e) {
                return Ht(e, s);
            }, u = o || Ft(e) ? l : h, c = o || Ft(t) ? l : h, d = o || Ft(a) ? l : h, m = o || Ft(r) ? l : h, p = o || Ft(i) ? l : h;
            return function(s, o) {
        ...
        function Nt(e, t, a) {
            ...
            if (t.csp) o = u < 6 ? qt(l[0], l[1], l[2], l[3], l[4], a, r) : function(e, t) {
                var i, s = 0;
                do i = qt(l[s++], l[s++], l[s++], l[s++], l[s++], a, r)(e, t), t = n, e = i; while (s < u);
                return i;
            }; else {
                var c = "";
                r && (c += "s = eso(s, fe);\nl = eso(l, fe);\n");
                    ...
                    switch (typeof a) {
                      case "string":
                        ...
                        if (o = v[_], !o) {
                            ...
                            var y = s ? h : p, b = new _r(y), M = new vr(b, n, y);
            ...
            this.digestTtl = function(e) {
                ...
                p.prototype = {
                        ...
                        do {
                            ...
                            e: do {
                                if (i = p.$$watchers) for (u = i.length; u--; ) try {
                                    ...
                                    } else c = !0, s = e, e.last = e.eq ? A(a, null) : a, e.fn(a, r === b ? a : r, p), 
                    ...
                    $broadcast: function(e, t) {
                        ...
                        for (var s, o, u, c = q([ i ], arguments, 1); a = r; ) {
        ...
        function ln(e) {
            ...
            t("lowercase", xr), t("number", pn), t("orderBy", Tn), t("uppercase", Er);
        }
        function un() {
        ...
        function Ln(e) {
            ...
            return function(n, a, r) {
                ...
                for (;a; ) o = Tr.exec(a), o ? (u = q(u, o, 1), a = u.pop()) : (u.push(a), a = null);
        ...
        function En(e, t, a, r, s) {
            var o = this, l = [], u = o.$$parentForm = e.parent().controller("form") || Hr;
            ...
            u.$addControl(o), o.$rollbackViewValue = function() {
                ...
                r.setClass(e, gi, _i + " " + Pr), o.$dirty = !1, o.$pristine = !0, o.$submitted = !1, 
                i(l, function(e) {
                    e.$setPristine();
                });
                ...
                r.addClass(e, Pr), o.$submitted = !0, u.$setSubmitted();
            };
        }
        function Cn(e) {
        ...
        function qn(e, t, a, r, i, s) {
            if (Fn(e, t, a, r), Hn(e, t, a, r, i, s), r.$$parserName = "number", r.$parsers.push(function(e) {
        ...
        function Vn(e, t, n, a, r, i) {
            Hn(e, t, n, a, r, i), Cn(a), a.$$parserName = "url", a.$validators.url = function(e, t) {
                var n = e || t;
                return a.$isEmpty(n) || Vr.test(n);
            };
        }
        function Nn(e, t, n, a, r, i) {
            Hn(e, t, n, a, r, i), Cn(a), a.$$parserName = "email", a.$validators.email = function(e, t) {
                var n = e || t;
        ...
        function Un(e, t, n, a, r, i, s, o) {
            var l = In(o, e, "ngTrueValue", n.ngTrueValue, !0), u = In(o, e, "ngFalseValue", n.ngFalseValue, !1), c = function(e) {
        ...
        var Ea = /([\:\-\_]+(.))/g, Ca = /^moz([A-Z])/, ja = {
            mouseleave: "mouseout",
            mouseenter: "mouseover"
        }, Ha = a("jqLite"), Pa = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Aa = /<|&#?\w+;/, Oa = /<([\w:]+)/, Fa = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, qa = {
        ...
        qa.optgroup = qa.option, qa.tbody = qa.tfoot = qa.colgroup = qa.caption = qa.thead, 
        qa.th = qa.td;
        var Va = be.prototype = {
            ready: function(n) {
                function a() {
            ...
            on: function e(t, n, a, r) {
                ...
                if (_e(t)) {
                    ...
                    for (var l = n.indexOf(" ") >= 0 ? n.split(" ") : [ n ], u = l.length; u--; ) {
                        n = l[u];
                        var c = s[n];
                        c || (s[n] = [], "mouseenter" === n || "mouseleave" === n ? e(t, ja[n], function(e) {
        ...
        var Ua = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Wa = /,/, za = /^\s*(_?)(\S+?)\1\s*$/, Ba = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Ga = a("$injector");
        Ue.$$annotate = Ie;
        ...
        vr.ZERO = d(function() {
            ...
            objectIndex: function(e) {
                ...
                return this.consume("]"), d(function(r, i) {
                    var s, o = e(r, i), l = jt(a(r, i), t);
                    return Ct(l, t), o ? s = Ht(o[l], t) : n;
                }, {
                    assign: function(n, r, i) {
                        var s = Ct(jt(a(n, i), t), t), o = Ht(e(n, i), t);
                        ...
                        return {
                            pre: function(e, a, r, s) {
                                ...
                                i && (Ot(e, null, s.$name, s, s.$name), r.$observe(i, function(t) {
                                    ...
                                    l.$removeControl(s), i && Ot(e, null, r[i], n, s.$name), d(s, Hr);
                                });
                            }
                        };
                    }
        ...
        }, Or = Ar(), Fr = Ar(!0), qr = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, Vr = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Nr = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Rr = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Ir = /^(\d{4})-(\d{2})-(\d{2})$/, Ur = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Wr = /^(\d{4})-W(\d\d)$/, zr = /^(\d{4})-(\d\d)$/, Br = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Gr = {
            text: jn,
            date: On("date", Ir, An(Ir, [ "yyyy", "MM", "dd" ]), "yyyy-MM-dd"),
            "datetime-local": On("datetimelocal", Ur, An(Ur, [ "yyyy", "MM", "dd", "HH", "mm", "ss", "sss" ]), "yyyy-MM-ddTHH:mm:ss.sss"),
            time: On("time", Br, An(Br, [ "HH", "mm", "ss", "sss" ]), "HH:mm:ss.sss"),
            week: On("week", Wr, Pn, "yyyy-Www"),
            month: On("month", zr, An(zr, [ "yyyy", "MM" ]), "yyyy-MM"),
            number: qn,
            url: Vn,
            email: Nn,
            radio: Rn,
        ...
        var ui = [ "$animate", function(e) {
        ...
        }, fi = "ng-valid", hi = "ng-invalid", gi = "ng-pristine", _i = "ng-dirty", vi = "ng-untouched", yi = "ng-touched", bi = "ng-pending", Mi = a("ngModel"), $i = [ "$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(e, t, a, r, s, o, l, u, c, d) {
            ...
            var k = r.inheritedData("$formController") || Hr, L = 0;
            zn({
                ctrl: this,
                $element: r,
                set: function(e, t) {
                ...
                $.$dirty = !0, $.$pristine = !1, o.removeClass(r, gi), o.addClass(r, _i), k.$setDirty();
            }, this.$setUntouched = function() {
                $.$touched = !1, $.$untouched = !0, o.setClass(r, vi, yi);
            }, this.$setTouched = function() {
                $.$touched = !0, $.$untouched = !1, o.setClass(r, yi, vi);
                ...
                function o() {
                    ...
                    i($.$asyncValidators, function(i, s) {
                        var o = i(e, t);
                        if (!E(o)) throw Mi("$asyncValidators", "Expected asynchronous validator to return a promise but got '{0}' instead.", o);
            ...
            return {
                ...
                link: function(r, s, o) {
                    ...
                    var u, c = o.count, d = o.$attr.when && s.attr(o.$attr.when), m = o.offset || 0, p = r.$eval(d) || {}, f = {}, h = t.startSymbol(), g = t.endSymbol(), _ = h + c + "-" + m + g, v = ca.noop;
                    i(o, function(e, t) {
                        var n = a.exec(t);
                        if (n) {
                            var r = (n[1] ? "-" : "") + Kn(n[2]);
                    ...
                    return y ? $ = e(y) : (k = function(e, t) {
                        ...
                        e.$watchCollection(_, function(a) {
                            ...
                            for (m = 0; m < $; m++) if (D = a === x ? m : x[m], Y = a[D], E = C[m], E.scope) {
                                ...
                                c(E) != y && s.move(le(E.clone), null, na(H)), H = d(E), u(E.scope, m, b, Y, M, D, $);
                            } else h(function(e, t) {
                                E.scope = t;
                                var n = f.cloneNode(!1);
                                e[e.length++] = n, s.enter(e, null, na(H)), H = n, E.clone = e, P[E.id] = E, u(E.scope, m, b, Y, M, D, $);
                            });
                            g = P;
                        });
                    };
        ...
        } ], Si = "ng-hide", xi = "ng-hide-animate", Ei = [ "$animate", function(e) {
            return {
                restrict: "A",
                multiElement: !0,
                link: function(t, n, a) {
                ...
                link: function(o, l, u, c) {
                    ...
                    function p(t, o, l) {
                        ...
                        function p(e) {
                            ...
                            return function(n, a) {
                                var r;
                                return r = P ? P : S ? S : C, _ ? v(t.remove(u(r, n, a))) : e === u(r, n, a);
                            };
                        }
                        function f() {
                        ...
                        function k() {
                            M = !1;
                            var e, n, a, r, c, d, m, f, y, k, L, Y, T, S, C, H, q, V = {
                                "": []
                            }, N = [ "" ], R = l.$viewValue, I = j(t) || [], U = x ? s(I) : I, W = {}, z = p(R), B = !1;
                            for (A = {}, Y = 0; k = U.length, Y < k; Y++) m = Y, x && (m = U[Y], "$" === m.charAt(0)) || (f = I[m], 
                        ...
                        var L;
                        if (!(L = y.match(r))) throw qi("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", y, W(o));
                        ...
                        l.$render = k, t.$watchCollection(j, f), t.$watchCollection(m, f), _ && t.$watchCollection(function() {
                            return l.$modelValue;
                        }, f);
                    }
                    if (c[1]) {
        ...
        l.module("kubeClient", []).value("KUBE_SCHEMA", m).value("KUBE_NAME_RE", p).factory("kubeLoader", [ "$q", "$timeout", "KubeWatch", "KubeRequest", "KUBE_SCHEMA", function(e, t, n, a, r) {
            ...
            function d(e) {
                ...
                if (L = null, t) {
                    ...
                    "DELETED" == t[n].type ? (delete k[r], d[r] = i) : t[n].checkResourceVersion ? (s = c(i), 
