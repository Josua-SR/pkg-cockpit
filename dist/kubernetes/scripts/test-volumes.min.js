!function(e) {
    ...
    !function(e, t, n) {
        ...
        function U(e, t) {
            return "undefined" == typeof e ? n : (M(t) || (t = t ? 2 : null), JSON.stringify(e, R, t));
        }
        function I(e) {
        ...
        function Q(e, t) {
            var n, a, r = _a.length;
            for (e = na(e), a = 0; a < r; ++a) if (n = _a[a] + t, b(n = e.attr(n))) return n;
            return null;
        }
        function Z(e, t) {
            var n, a, r = {};
        ...
        function Ue(e, t, n) {
            ...
            if ("function" == typeof e) {
                if (!(a = e.$inject)) {
                    if (a = [], e.length) {
                        if (t) throw b(n) && n || (n = e.name || Re(e)), Ga("strictdi", "{0} is not using explicit annotation and cannot be invoked in strict mode", n);
        ...
        function Be(e, t, a, r) {
            ...
            var h = this, g = t[0], v = e.location, y = e.history, M = e.setTimeout, $ = e.clearTimeout, w = {};
            h.isMock = !1;
            var k = 0, L = [];
            ...
            h.cookies = function(e, t) {
                ...
                t === n ? g.cookie = encodeURIComponent(e) + "=;path=" + N + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : b(t) && (r = (g.cookie = encodeURIComponent(e) + "=" + encodeURIComponent(t) + ";path=" + N).length + 1, 
        ...
        function Qe(e, a) {
            ...
            var o = {}, s = "Directive", u = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/, c = /(([\w\-]+)(?:\:([^;]+))?;?)/, m = H("ngSrc,ngSrcset,src,srcset"), _ = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, M = /^(on[a-z]+|formaction)$/;
            this.directive = function t(n, a) {
                return oe(n, "directive"), b(n) ? (re(a, "directiveFactory"), o.hasOwnProperty(n) || (o[n] = [], 
            ...
            this.debugInfoEnabled = function(e) {
                ...
                function A(e, t, n, a, r) {
                    ...
                    switch (s) {
                      case ba:
                        I(t, Ze(j(e)), "E", a, r);
                        for (var d, m, p, f, h, g, _ = e.attributes, v = 0, M = _ && _.length; v < M; v++) {
                            var $ = !1, w = !1;
                        ...
                        if (o = e.className, y(o) && (o = o.animVal), b(o) && "" !== o) for (;i = c.exec(o); ) p = Ze(i[2]), 
                ...
                function R(e, o, s, l, u, c, d, m, p) {
                    ...
                    function M(e, t, r, l, u) {
                        function c(e, t, a) {
                            var r;
                            return D(e) || (a = t, t = e, e = n), z && (r = M), a || (a = z ? w.parent() : w), 
                            u(e, t, r, a, S);
                        }
                        var p, f, _, y, b, M, $, w, L;
                        if (o === r ? (L = s, w = s.$$element) : (w = na(r), L = new oe(w, s)), j && (b = t.$new(!0)), 
                        u && ($ = c, $.$$boundTransclude = u), H && (k = {}, M = {}, i(H, function(e) {
                            var n, a = {
                                $scope: e === j || e.$$isolateScope ? b : t,
                                $element: w,
                                $attrs: L,
                                $transclude: $
                            };
                            y = e.controller, "@" == y && (y = L[e.name]), n = v(y, a, !0, e.controllerAs), 
                            M[e.name] = n, z || w.data("$" + e.name + "Controller", n.instance), k[e.name] = n;
                        })), j) {
                            C.$$addScopeInfo(w, b, !0, !(P && (P === j || P === j.$$originalDirective))), C.$$addScopeClass(w, !0);
                            var Y = k && k[j.name], T = b;
                            Y && Y.identifier && j.bindToController === !0 && (T = Y.instance), i(b.$$isolateBindings = j.$$isolateBindings, function(e, n) {
                        ...
                        for (k && (i(k, function(e) {
                            e();
                        }), k = null), p = 0, f = d.length; p < f; p++) _ = d[p], ie(_, _.isolateScope ? b : t, w, L, _.require && h(_.directiveName, _.require, w, M), $);
                        var S = t;
                        for (j && (j.template || null === j.templateUrl) && (S = b), e && e(S, r.childNodes, n, u), 
                        p = m.length - 1; p >= 0; p--) _ = m[p], ie(_, _.isolateScope ? b : t, w, L, _.require && h(_.directiveName, _.require, w, M), $);
                    }
                    p = p || {};
                    for (var $, k, L, Y, T, S, x, E = -Number.MAX_VALUE, H = p.controllerDirectives, j = p.newIsolateScopeDirective, P = p.templateDirective, O = p.nonTlbTranscludeDirective, R = !1, I = !1, z = p.hasElementTranscludeDirective, J = s.$$element = na(o), Q = c, X = l, ee = 0, ne = e.length; ee < ne; ee++) {
                        ...
                        })) : (T = na(Me(o)).contents(), J.empty(), X = C(T, l))), L.template) if (I = !0, 
                        K("template", P, L, J), P = L, x = w(L.template) ? L.template(J, s) : L.template, 
                        x = ce(x), L.replace) {
                            if (Q = L, T = ge(x) ? [] : et(Z(L.templateNamespace, fa(x))), o = T[0], 1 != T.length || o.nodeType !== ba) throw Qa("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", Y, "");
                            te(u, J, o);
                            var le = {
                                $attr: {}
                        ...
                        M = G(e.splice(ee, e.length - ee), J, s, u, R && X, d, m, {
                    ...
                    return M.scope = $ && $.scope === !0, M.transcludeOnThisElement = R, M.elementTranscludeOnThisElement = z, 
                    M.templateOnThisElement = I, M.transclude = X, p.hasElementTranscludeDirective = z, 
                    M;
                }
                function U(e) {
                ...
                function G(e, t, n, a, r, o, s, u) {
                    ...
                    return t.empty(), l(_).then(function(l) {
                        var p, b, M, $;
                        if (l = ce(l), h.replace) {
                            if (M = ge(l) ? [] : et(Z(v, fa(l))), p = M[0], 1 != M.length || p.nodeType !== ba) throw Qa("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", h.name, _);
                            b = {
                                $attr: {}
                            }, te(a, t, p);
                            var w = A(p, [], b);
                            y(h.scope) && U(w), e = w.concat(e), B(n, b);
                        } else p = f, t.html(l);
        ...
        function ct() {
            ...
            this.$get = [ "$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(o, l, u, c, m, p) {
                ...
                function M(a, r) {
                    ...
                    p && (h = p.get($), v(h) ? C(h) ? h.then(u, u) : pa(h) ? s(h[1], h[0], A(h[2]), h[3]) : s(h, 200, {}, "OK") : p.put($, b)), 
                    _(h)) {
                        var w = on(a.url) ? l.cookies()[a.xsrfCookieName || e.xsrfCookieName] : n;
                        w && (M[a.xsrfHeaderName || e.xsrfHeaderName] = w), o(a.method, $, r, i, M, a.timeout, a.withCredentials, a.responseType);
                    }
                    return b;
                }
                function k(e, t) {
        ...
        function pt(e, t, a, r, o) {
            ...
            return function(o, l, u, c, d, m, p, h) {
                ...
                function _(t, r, i, o, s) {
                    w !== n && a.cancel(w), b = M = null, t(r, i, o, s), e.$$completeOutstandingRequest(f);
                }
                if (e.$$incOutstandingRequestCount(), l = l || e.url(), "jsonp" == Kn(o)) {
                    ...
                    var b = s(l.replace("JSON_CALLBACK", "angular.callbacks." + y), y, function(e, t) {
                        _(c, e, r[y].data, "", t), r[y] = f;
                    });
                } else {
                    var M = t();
                    M.open(o, l, !0), i(d, function(e, t) {
            ...
            this.startSymbol = function(t) {
                ...
                function o(i, o, m, p) {
                    ...
                    for (var g, y, b, M = 0, $ = [], k = [], L = i.length, D = [], Y = []; M < L; ) {
                        if ((g = i.indexOf(e, M)) == -1 || (y = i.indexOf(t, g + s)) == -1) {
                            M !== L && D.push(f(i.substring(M)));
                            break;
                        }
                        M !== g && D.push(f(i.substring(M, g))), b = i.substring(g + s, y), $.push(b), k.push(n(b, h)), 
        ...
        function Lt(e, t, a) {
            this.$$html5 = !0, a = a || "", vt(e, this), this.$$parse = function(e) {
                ...
                var o, s, l;
                return (o = bt(e, r)) !== n ? (s = o, l = (o = bt(a, o)) !== n ? t + (bt("/", o) || o) : e + s) : (o = bt(t, r)) !== n ? l = t + o : t == r + "/" && (l = t), 
                l && this.$$parse(l), !!l;
            };
        }
        function Dt(e, t, n) {
            vt(e, this), this.$$parse = function(a) {
                ...
                var i, o = bt(e, a) || bt(t, a);
                _(o) || "#" !== o.charAt(0) ? this.$$html5 ? i = o : (i = "", _(o) && (e = a, this.replace())) : (i = bt(n, o), 
        ...
        function Yt(e, t, n) {
            this.$$html5 = !0, Dt.apply(this, arguments), this.$$parseLinkUrl = function(a, r) {
                ...
                var i, o;
                return e == Mt(a) ? i = a : (o = bt(t, a)) ? i = e + n + o : t === a + "/" && (i = t), 
                i && this.$$parse(i), !!i;
            }, this.$$compose = function() {
                var t = G(this.$$search), a = this.$$hash ? "#" + J(this.$$hash) : "";
        ...
        function xt() {
            ...
            this.hashPrefix = function(t) {
                ...
                return a.onUrlChange(function(e, t) {
                    return _(bt(f, e)) ? void (o.location.href = e) : (n.$evalAsync(function() {
        ...
        function Vt(e, t, a) {
            var r = t.expensiveChecks, o = r ? br : yr, s = o[e];
            if (s) return s;
                    ...
                    switch (typeof a) {
                      case "string":
                        ...
                        if (s = v[_], !s) {
                            ...
                            var y = o ? h : p, b = new _r(y), M = new vr(b, n, y);
                            s = M.parse(a), s.constant ? s.$$watchDelegate = d : g ? (s = r(s), s.$$watchDelegate = s.literal ? c : u) : s.inputs && (s.$$watchDelegate = l), 
                            v[_] = s;
                        }
                        return m(s, i);
                        ...
                        do {
                            ...
                            e: do {
                                if (i = p.$$watchers) for (u = i.length; u--; ) try {
                                    ...
                                    } else c = !0, o = e, e.last = e.eq ? O(a, null) : a, e.fn(a, r === b ? a : r, p), 
        ...
        function en() {
            this.$get = [ "$window", "$document", function(e, t) {
                ...
                if (u) {
                    ...
                    d = !!("animation" in u || n + "Animation" in u), !i || c && d || (c = b(s.body.style.webkitTransition), 
                    d = b(s.body.style.webkitAnimation));
                }
                return {
        ...
        function Nn(e, t, a, r, i, o) {
            if (Fn(e, t, a, r), jn(e, t, a, r, i, o), r.$$parserName = "number", r.$parsers.push(function(e) {
                ...
                r.$validators.min = function(e) {
                    ...
                    v(e) && !M(e) && (e = parseFloat(e, 10)), s = M(e) && !isNaN(e) ? e : n, r.$validate();
                });
            }
            if (v(a.max) || a.ngMax) {
                var l;
        ...
        function zn(e) {
            function t(e, t, l) {
                ...
                d(s.$$success, e, l)), s.$pending ? (i(bi, !0), s.$valid = s.$invalid = n, o("", null)) : (i(bi, !1), 
        ...
        }, _a = [ "ng-", "data-ng-", "ng:", "x-ng-" ], va = /[A-Z]/g, ya = !1, ba = 1, Ma = 2, $a = 3, wa = 8, ka = 9, La = 11, Da = {
            full: "1.3.20",
            major: 1,
            minor: 3,
            dot: 20,
        ...
        var Za = /^((?:x|data)[\:\-_])/i, Xa = a("$controller"), er = "application/json", tr = {
            ...
            search: function(e, t) {
                switch (arguments.length) {
                  ...
                  case 1:
                    if (b(e) || M(e)) e = e.toString(), this.$$search = B(e); else {
        ...
        var ui = [ "$animate", function(e) {
        ...
        }, fi = "ng-valid", hi = "ng-invalid", gi = "ng-pristine", _i = "ng-dirty", vi = "ng-untouched", yi = "ng-touched", bi = "ng-pending", Mi = a("ngModel"), $i = [ "$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(e, t, a, r, o, s, l, u, c, d) {
            ...
            var m, p = o(a.ngModel), h = p.assign, g = p, y = h, b = null, $ = this;
            this.$$setOptions = function(e) {
                ...
                } else if (!p.assign) throw Mi("nonassign", "Expression '{0}' is non-assignable. Element: {1}", a.ngModel, W(r));
            ...
            zn({
                ...
                function s() {
                    ...
                    i($.$asyncValidators, function(i, o) {
                        var s = i(e, t);
                        if (!C(s)) throw Mi("$asyncValidators", "Expected asynchronous validator to return a promise but got '{0}' instead.", s);
                    ...
                    return y ? $ = e(y) : (k = function(e, t) {
                        ...
                        e.$watchCollection(_, function(a) {
                            ...
                            for (m = 0; m < $; m++) if (D = a === x ? m : x[m], Y = a[D], C = E[m], C.scope) {
                                ...
                                c(C) != y && o.move(le(C.clone), null, na(j)), j = d(C), u(C.scope, m, b, Y, M, D, $);
                            } else h(function(e, t) {
                                C.scope = t;
                                var n = f.cloneNode(!1);
                                e[e.length++] = n, o.enter(e, null, na(j)), j = n, C.clone = e, P[C.id] = C, u(C.scope, m, b, Y, M, D, $);
                            });
                            g = P;
                        });
                    };
            ...
            return {
                ...
                link: function(s, l, u, c) {
                    ...
                    function p(t, s, l) {
                        ...
                        function k() {
                            ...
                            for (_ || (b || null === R ? q[""].unshift({
                                ...
                                ta && S.prop("selected", d.selected))) : ("" === a.id && b ? E = b : (E = $.clone()).val(a.id).prop("selected", a.selected).attr("selected", a.selected).prop("label", a.label).text(a.label), 
                                c.push(d = {
                                    element: E,
                                    label: a.label,
                                    id: a.id,
                    ...
                    if (c[1]) {
                        for (var f, h = c[0], g = c[1], _ = u.multiple, y = u.ngOptions, b = !1, M = !1, $ = na(t.createElement("option")), w = na(t.createElement("optgroup")), k = $.clone(), L = 0, D = l.children(), Y = D.length; L < Y; L++) if ("" === D[L].value) {
                            f = b = D.eq(L);
                            break;
                        }
                        h.init(g, b, k), _ && (g.$isEmpty = function(e) {
                            return !e || 0 === e.length;
                ...
                link: function(e, t, r, i) {
                    if (i) {
                        ...
                        r.$observe("pattern", function(e) {
                            if (b(e) && e.length > 0 && (e = new RegExp("^" + e + "$")), e && !e.test) throw a("ngPattern")("noregexp", "Expected {0} to be a RegExp but was {1}. Element: {2}", s, e, W(t));
                            o = e || n, i.$validate();
    ...
    angular.module("ui.bootstrap.collapse", []).directive("collapse", [ "$animate", function(e) {
        ...
        return {
            ...
            link: function(u, c, d, m) {
                ...
                var g, _ = angular.isDefined(d.closeOnDateSelection) ? u.$parent.$eval(d.closeOnDateSelection) : s.closeOnDateSelection, v = angular.isDefined(d.datepickerAppendToBody) ? u.$parent.$eval(d.datepickerAppendToBody) : s.appendToBody, y = angular.isDefined(d.onOpenFocus) ? u.$parent.$eval(d.onOpenFocus) : s.onOpenFocus, b = angular.isDefined(d.datepickerPopupTemplateUrl) ? d.datepickerPopupTemplateUrl : s.datepickerPopupTemplateUrl, M = angular.isDefined(d.datepickerTemplateUrl) ? d.datepickerTemplateUrl : s.datepickerTemplateUrl, $ = {};
        ...
        function m(t, n, a) {
            ...
            return n.$broadcast(M.NOW_CLOSING_EVENT, l), i.when(s).then(r);
        }
        function p(e, t, n) {
        ...
        var h, g, _, v = "modal-open", y = l.createNew(), b = s.createNew(), M = {
                ...
                return {
                    ...
                    compile: function(e, t) {
                        ...
                        return function(e, t, a, i) {
                            ...
                            function p() {
                                H && !e.$eval(a[m + "Enable"]) || (M(), j.popupDelay ? S || (S = o(_, j.popupDelay, !1)) : _());
                            }
                            function g() {
                                v(), c.$$phase || c.$digest();
                            }
                            ...
                            function v() {
                                ...
                                x = null, j.animation ? T || (T = o(b, 500)) : b();
                            }
                            function y() {
                                D && b(), Y = j.$new(), D = n(Y, function(e) {
                            ...
                            C = angular.isDefined(q) ? q : C, C && e.$on("$locationChangeSuccess", function() {
                                ...
                                o.cancel(T), o.cancel(S), o.cancel(x), F(), b(), j = null;
                            });
                        };
                    }
                };
        ...
        return {
            ...
            link: function(d, m, p, f) {
                ...
                _.$parsers.unshift(function(e) {
                    return b = !0, 0 === y || e && e.length >= y ? $ > 0 ? (B(), z(e)) : U(e) : (k(d, !1), 
                    ...
                    var t, n, r = {};
                    M = !0, r[P.itemName] = n = O.matches[e].model, t = P.modelMapper(d, r), j(d, t), 
    ...
    !function() {
        ...
        var l = n(32), u = "/api/v1", c = "/oapi/v1", d = {
            ...
            api: c,
            global: !0
        } ]), p = /^[a-z0-9]([-a-z0-9_.]*[a-z0-9])?$/, f = /^[a-zA-Z0-9_.]([-a-zA-Z0-9 ,=@._]*[a-zA-Z0-9._])?$/, h = "120s", g = Math.random().toString(36).slice(2), _ = 1;
    ...
    !function() {
        ...
        n(40), i.module("kubeClient.cockpit", [ "kubeClient" ]).factory("CockpitKubeWatch", [ "$q", "KUBE_SCHEMA", "cockpitKubeDiscover", function(n, a, r) {
            return function(a, s) {
                ...
                e("creating watch:", a);
                var f, h, g, _, v = !1, y = null, b = null, M = null, $ = n.defer(), w = $.promise, k = !1, L = {};
    ...
    !function() {
        ...
        function a(n, a, i, o, s) {
            function l(e) {
                if (!w) return b = e, $ ? void s.cancel() : void (null === b ? (h(), y()) : b === !0 ? (h(), 
                v(), s.result(!0, M)) : b === !1 ? (v(), c(M), s.result(!1, M)) : console.warn("invalid dialog state", b));
            }
            function u() {
                s = null, o = null, h(), v();
            }
    ...
    (function(e) {
        ...
        !function(t, n) {
            ...
            function L(e, t) {
                return null !== t ? (t.abbr = e, qn[e] = qn[e] || new b(), qn[e].set(t), k(e), qn[e]) : (delete qn[e], 
                null);
            }
            function D(e) {
                var t;
            ...
            var va = /^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/, ya = [ [ "YYYYYY-MM-DD", /[+-]\d{6}-\d{2}-\d{2}/ ], [ "YYYY-MM-DD", /\d{4}-\d{2}-\d{2}/ ], [ "GGGG-[W]WW-E", /\d{4}-W\d{2}-\d/ ], [ "GGGG-[W]WW", /\d{4}-W\d{2}/ ], [ "YYYY-DDD", /\d{4}-\d{3}/ ] ], ba = [ [ "HH:mm:ss.SSSS", /(T| )\d\d:\d\d:\d\d\.\d+/ ], [ "HH:mm:ss", /(T| )\d\d:\d\d:\d\d/ ], [ "HH:mm", /(T| )\d\d:\d\d/ ], [ "HH", /(T| )\d\d/ ] ], Ma = /^\/?Date\((\-?\d+)/i;
            ...
            Ra.lang = Ca, Ra.locale = yt, Ra.localeData = bt, Ra.max = La, Ra.min = ka, Ra.parsingFlags = St, 
            Ra.set = H, Ra.startOf = Mt, Ra.subtract = xa, Ra.toArray = Dt, Ra.toObject = Yt, 
            ...
            gr.abs = _n, gr.add = yn, gr.subtract = bn, gr.as = Ln, gr.asMilliseconds = Za, 
            ...
            gr.toString = Pn, gr.toJSON = Pn, gr.locale = yt, gr.localeData = bt, gr.toIsoString = ne("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Pn), 
	 ...
	 */
        !function(e) {
            ...
            function _(e) {
                ...
                z.depth--, !e || z.blocking || z.queue.length || 0 !== z.depth || b();
            }
            function v() {
            ...
            if (S) {
                ...
                QUnit.config.urlConfig.push({
                    ...
                    QUnit.begin(function(e) {
                        ...
                        }), M(), k(), L(e.modules), a = l("qunit-tests"), a && C.hidepassed && i(a, "hidepass");
                    ...
                    QUnit.diff = function() {
                        ...
                        return e.prototype.DiffMain = function(e, t, n) {
                            ...
                            var i, o, s, l, u, c, d, m, p, f, h, g, _, v, y, b, M, $, w, k, L, D, Y;
                            ...
                            v = 0, L = 0; L < s && !(new Date().getTime() > r); L++) {
                                for (D = -L + h; D <= L - g; D += 2) {
                                    for (b = l + D, M = D === -L || D !== L && c[b - 1] < c[b + 1] ? c[b + 1] : c[b - 1] + 1, 
                                    w = M - D; M < i && w < o && e.charAt(M) === t.charAt(w); ) M++, w++;
                                    if (c[b] = M, M > i) g += 2; else if (w > o) h += 2; else if (f && (y = l + p - D, 
                                    y >= 0 && y < u && d[y] !== -1 && ($ = i - d[y], M >= $))) return this.diffBisectSplit(e, t, M, w, r);
                                }
                                for (Y = -L + _; Y <= L - v; Y += 2) {
                                    for (y = l + Y, $ = Y === -L || Y !== L && d[y - 1] < d[y + 1] ? d[y + 1] : d[y - 1] + 1, 
                                    k = $ - Y; $ < i && k < o && e.charAt(i - $ - 1) === t.charAt(o - k - 1); ) $++, 
                                    k++;
                                    if (d[y] = $, $ > i) v += 2; else if (k > o) _ += 2; else if (!f && (b = l + p - Y, 
                                    b >= 0 && b < u && c[b] !== -1 && (M = c[b], w = l + M - b, $ = i - $, M >= $))) return this.diffBisectSplit(e, t, M, w, r);
                                }
                            }
                            return [ [ n, e ], [ a, t ] ];
    ...
    !function(i, o) {
        ...
        function p(p, _, v) {
            ...
            L.explain = S, L.note = function(e) {
                ...
                var t = "";
                L.count += 1, i(e) && (t += "not "), t += "ok " + L.count, L.puts(m(t, b(e)));
            }, L.testDone = function() {
                a(k.config) && (L.expectedCount += k.config.current.expected);
            }, L.done = function() {
                ("undefined" == typeof L.config.noPlan || L.config.noPlan) && M(a(k.config) ? L.expectedCount : L.count);
