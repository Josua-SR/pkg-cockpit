!function(e) {
        ...
        function Ze(e, a) {
            ...
            this.debugInfoEnabled = function(e) {
                    ...
                    switch (o) {
                      case _a:
                        ...
                        for (var d, m, f, p, h, g, _ = e.attributes, v = 0, M = _ && _.length; v < M; v++) {
                            var $ = !1, L = !1;
                            d = _[v], m = d.name, h = da(d.value), p = Qe(m), (g = de.test(p)) && (m = m.replace(Ja, "").substr(8).replace(/_(.)/g, function(e, t) {
                ...
                function V(e, s, o, u, l, c, d, m, f) {
                    ...
                    f = f || {};
                    for (var $, k, w, Y, T, S, x, E = -Number.MAX_VALUE, H = f.controllerDirectives, j = f.newIsolateScopeDirective, A = f.templateDirective, O = f.nonTlbTranscludeDirective, V = !1, q = !1, z = f.hasElementTranscludeDirective, G = o.$$element = Xn(s), Z = c, X = u, ee = 0, ne = e.length; ee < ne; ee++) {
                        w = e[ee];
                        var re = w.$$start, oe = w.$$end;
                        if (re && (G = F(s, re, oe)), T = n, E > w.priority) break;
                        if ((x = w.scope) && (w.templateUrl || (b(x) ? (K("new/isolated scope", j || $, w, G), 
                        j = w) : K("new/isolated scope", j, w, G)), $ = $ || w), Y = w.name, !w.templateUrl && w.controller && (x = w.controller, 
                        H = H || {}, K("'" + Y + "' controller", H[Y], w, G), H[Y] = w), (x = w.transclude) && (V = !0, 
                        w.$$tlb || (K("transclusion", O, w, G), O = w), "element" == x ? (z = !0, E = w.priority, 
                        T = G, G = o.$$element = Xn(t.createComment(" " + Y + ": " + o[Y] + " ")), s = G[0], 
                        te(l, N(T), s), X = C(T, u, E, Z && Z.name, {
                            nonTlbTranscludeDirective: O
                        })) : (T = Xn(Me(s)).contents(), G.empty(), X = C(T, u))), w.template) if (q = !0, 
                        K("template", A, w, G), A = w, x = L(w.template) ? w.template(G, o) : w.template, 
                        x = ce(x), w.replace) {
                        ...
                        if (w.templateUrl) q = !0, K("template", A, w, G), A = w, w.replace && (Z = w), 
                        M = J(e.splice(ee, e.length - ee), G, o, l, V && X, d, m, {
                            controllerDirectives: H,
                            newIsolateScopeDirective: j,
                            templateDirective: A,
                            nonTlbTranscludeDirective: O
                        }), ne = e.length; else if (w.compile) try {
                            S = w.compile(G, o, X), L(S) ? p(null, S, re, oe) : S && p(S.pre, S.post, re, oe);
                        } catch (e) {
                            r(e, R(G));
                        }
        ...
        function ct() {
            ...
            this.$get = [ "$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(s, u, l, c, m, f) {
                function p(t) {
                    ...
                    u.headers = o(t), u.method = Gn(u.method);
                    var l = function(t) {
                    ...
                    $watchCollection: function(e, t) {
                        ...
                        function a() {
                            if (h ? (h = !1, t(i, i, l)) : t(i, o, l), c) if (b(i)) if (r(i)) {
                                ...
                                o = {};
                                for (var n in i) Jn.call(i, n) && (o[n] = i[n]);
                            } else o = i;
                        }
                        n.$stateful = !0;
    ...
    !function() {
        ...
        var u = n(31), l = "/api/v1", c = "/oapi/v1", d = {
            ...
            api: c,
            global: !0
        } ]), f = /^[a-z0-9]([-a-z0-9]*[a-z0-9])?$/, p = "120s", h = Math.random().toString(36).slice(2), g = 1;
        u.module("kubeClient", []).value("KUBE_SCHEMA", m).value("KUBE_NAME_RE", f).factory("kubeLoader", [ "$q", "$timeout", "KubeWatch", "KubeRequest", "KUBE_SCHEMA", function(e, t, n, a, r) {
            function i(e, t, a) {
                ...
                return !i.global && t && (s += "/namespaces/" + t), s += "/" + i.type, s in $ || (r = new n(s, l), 
                r.what = e, r.global = i.global, r.namespace = t, r.cancelWatch = r.cancel, r.cancel = function() {
                    var e = $[s];
                    e && (e.references -= 1, e.references <= 0 && (e.cancelWatch(), delete $[s]));
                }, $[s] = r), $[s].references += a, $[s];
            }
            function s(t, n) {
                var a = M.namespace;
            ...
            function d(e) {
                ...
                if (k = null, t) {
                    var n, a, r, i, s, u, l = {}, d = {};
                    for (n = 0, a = t.length; n < a; n++) i = t[n].object, i && (r = o([ i ]), "DELETED" == t[n].type ? (delete L[r], 
                    d[r] = i) : t[n].checkResourceVersion ? (s = c(i), u = c(L[r]), (!s || !u || s >= u) && (l[r] = i, 
                    L[r] = i)) : (l[r] = i, L[r] = i));
                    e(l, d);
                }
            }
            function f() {
                var e, t, n;
                for (e = 0, t = y.length; e < t; e++) n = y[e], n && n.apply(D, arguments);
            }
            function p() {
                w = null, d(f);
            }
            function h() {
                var e;
                window.clearTimeout(w), w = null, k = null;
                var t = $;
                $ = {}, u.forEach(t, function(e) {
                    e.cancelWatch();
                });
                for (e in L) delete L[e];
                for (e in M) delete M[e];
                M.namespace = null, f();
            }
            function g(e, t, n) {
                l(e.map(function(e) {
            ...
            function v(e) {
                ...
                var r, i;
                for (i in L) r = L[i].metadata, !t || !r.namespace || r.namespace in t || (a[i] = L[i], 
                delete L[i], delete n[i]);
                var o, l, c = [];
                for (o in $) l = $[o], (!t && l.namespace || t && !l.global && !(l.namespace in t)) && (l.cancelWatch(), 
                delete $[o], c.push(l));
            ...
            var y = [], M = {
                ...
                listen: function(e, n) {
                    ...
                    var a = t(function() {
                        ...
                        cancel: function() {
                            var n, r;
                            for (t.cancel(a), a = null, n = 0, r = y.length; n < r; n++) y[n] === e && (y[n] = null);
                        }
                    };
                    return b(r, n), r;
                },
            ...
            function s(n, s) {
                ...
                return n.forEach(function(e) {
                    var t = e.metadata || {};
                    "Namespace" != e.kind && "Project" != e.kind || t.name !== s || (h = !0);
                    var n = m[e.kind] || m[""];
                    n.global || (g = !0);
                }), n = n.slice(), s && g && !h && n.unshift({
                    apiVersion: "v1",
                    kind: "Namespace",
                    metadata: {
                        name: s
            ...
            function d(e, n, r, i) {
                var s = o([ n ]), u = new a(e, s, JSON.stringify(r), i);
            ...
            function _(e, n) {
                ...
                n || (n = {});
                var s = e.metadata;
                return s && (a = null, void 0 !== s.name && (s.name ? f.test(s.name) || (a = new Error("The name contains invalid characters")) : a = new Error("The name cannot be empty")), 
    ...
    !function() {
        function e(e, t) {
            ...
            for (i = 0; i < u; i++) if (n = e[i].querySelectorAll(t)) for (a = 0, s = n.length; a < s; a++) o.push(n[i]);
            return r.element(o);
        }
        function t(e, t) {
        ...
        function a(n, a, i) {
            function s(e) {
                if (!M) return v = e, y ? void i.$dismiss() : void (null === v ? (f(), _()) : v === !0 ? (f(), 
                i.$close(b)) : v === !1 ? (g(), u(b)) : console.warn("invalid dialog state", v));
            }
            function o() {
                i = null, a = null, f(), g();
            }
            ...
            function p(e) {
                return a.cancel && a.cancel(), y = !0, e.stopPropagation(), e.preventDefault(), 
                !1;
            }
            function h(e) {
                var t = e.message || e;
            ...
            function g() {
                ...
                L.remove(), t(n, ".btn-cancel").off("click", p);
            }
            function _() {
                function i(e) {
                    var t = r.element(e);
                ...
                g(), t(n, ".modal-footer").prepend(L), r.forEach(e(n, ".form-control"), i), r.forEach(e(n, ".btn"), i), 
                t(n, ".btn-cancel").on("click", p);
            }
            var v = null, b = null, y = !1, M = !1, $ = [], L = r.element("<div class='dialog-wait-ct pull-left'>");
            L.append(r.element("<div class='spinner spinner-sm'>"));
            var k = r.element("<span>");
            return L.append(k), this.detach = o, a ? (a.then(function(e) {
                b = e, a && s(!0);
            }, function(e) {
                b = e, a && s(!1);
            }, function(e) {
            ...
            return {
                ...
                link: function(n, r, i) {
                    ...
                    n.complete = function(t) {
                        s(), t && t.then || (t = e(t)), u = new a(r, t, n);
                    }, n.failure = function() {
    ...
    (function(e) {
        ...
        !function(t, n) {
            ...
            Y("year", "y"), U("Y", na), U("YY", Zn, Bn), U("YYYY", Xn, Gn), U("YYYYY", ea, Kn), 
            ...
            U("DDDD", Jn), q([ "DDD", "DDDD" ], function(e, t, n) {
                n._dayOfYear = v(e);
            }), t.ISO_8601 = function() {};
            ...
            U("g", na), U("GG", Zn, Bn), U("gg", Zn, Bn), U("GGGG", Xn, Gn), U("gggg", Xn, Gn), 
            ...
            }), Y("millisecond", "ms"), U("S", Qn, zn), U("SS", Qn, Bn), U("SSS", Qn, Jn);
            var Na;
            ...
            Va.isDST = Be, Va.isDSTShifted = Je, Va.isLocal = Ge, Va.isUtcOffset = Ke, Va.isUtc = Ze, 
            ...
            Ka.preparse = sn, Ka.postformat = sn, Ka._relativeTime = Ga, Ka.relativeTime = on, 
            ...
            Ka.isPM = Jt, Ka._meridiemParse = Oa, Ka.meridiem = Gt, k("en", {
    ...
    !function() {
        ...
        var t = n(31);
        n(32), n(42), n(38), n(60), n(43), n(235), n(236), n(187), n(190), n(173), n(44), 
        n(237), n(238), n(239), n(239), n(240), t.module("registry.images", [ "ngRoute", "ui.cockpit", "kubeClient", "kubernetes.date", "kubernetes.listing", "registry.tags", "registryUI.images" ]).config([ "$routeProvider", function(e) {
                        ...
                        if (!(t in a.objects)) {
                            ...
                            if (a.handle(r), l) {
                                ...
                                a.load("ImageStreamImage", s, n.namespace).then(function(e) {
                                    ...
                                    console.warn("couldn't load image: " + e.statusText), r.metadata.resourceVersion = "invalid";
                                });
                            }
                        }
                    });
            ...
            var l = !1;
            return n.register("taggedBy", function(e) {
                var t, a, r = {};
        ...
        } ]).controller("ImageStreamModifyCtrl", [ "$scope", "$modalInstance", "dialogData", "imageTagData", "kubeMethods", "filterService", function(e, n, a, r, i, s) {
            function o() {
                var e = {
                    spec: {
                ...
                return "none" != p.populate && (e.spec.dockerImageRepository = p.pull.trim()), "tags" == p.populate && r.buildSpec(p.tags, e.spec, p.insecure), 
                i.patch(c, e);
            }
            function u() {
                var e = {
                    ...
                    metadata: {
                        name: p.name.trim(),
                        namespace: p.project.trim()
                    }
                };
                return "none" != p.populate && (e.spec = {
                    dockerImageRepository: p.pull.trim()
                }), "tags" == p.populate && (e.spec = r.buildSpec(p.tags, e.spec, p.insecure)), 
                i.check(e, {
                    "metadata.name": "#imagestream-modify-name",
                    "metadata.namespace": "#imagestream-modify-project"
                }).then(function() {
                    return i.create(e, p.project);
                });
            }
            function l(e) {
                var t;
            ...
            var c = a.stream || {}, d = c.metadata || {}, m = c.spec || {}, f = "none";
            m.dockerImageRepository && (f = "pull"), m.tags && (f = "tags");
            var p = {
                name: d.name || "",
                project: d.namespace || s.namespace() || "",
                populate: f,
            ...
            }, a.stream || (e.labels.populate.none = "Create empty image stream"), e.performCreate = u, 
            e.performModify = o, e.hasInsecureTag = l, e.projects = s.namespaces, t.extend(e, a);
