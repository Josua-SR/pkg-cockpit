!function(e) {
    ...
    !function(e, t, n) {
        ...
        function Be(e, t, a, i) {
            ...
            f.onUrlChange = function(t) {
                return H || (i.history && Xn(e).on("popstate", u), Xn(e).on("hashchange", u), H = !0), 
                E.push(t), t;
            ...
            this.debugInfoEnabled = function(e) {
                ...
                function V(e, s, o, l, u, c, d, m, f) {
                    ...
                    function M(e, t, i, l, u) {
                        ...
                        u && ($ = c, $.$$boundTransclude = u), H && (w = {}, M = {}, r(H, function(e) {
                            var n, a = {
                                ...
                                switch (c) {
                                  ...
                                  case "=":
                                    ...
                                    r = g(L[l]), o = r.literal ? I : function(e, t) {
                                        ...
                                        throw i = T[n] = r(t), Ba("nonassign", "Expression '{0}' used with directive '{1}' is non-assignable!", L[l], j.name);
                                    }, i = T[n] = r(t);
                                    var d = function(e) {
                        ...
                        var S = t;
                        for (j && (j.template || null === j.templateUrl) && (S = y), e && e(S, i.childNodes, n, u), 
                        f = m.length - 1; f >= 0; f--) _ = m[f], re(_, _.isolateScope ? y : t, k, L, _.require && h(_.directiveName, _.require, k, M), $);
                    }
                    f = f || {};
                    for (var $, w, L, Y, T, S, x, E = -Number.MAX_VALUE, H = f.controllerDirectives, j = f.newIsolateScopeDirective, A = f.templateDirective, O = f.nonTlbTranscludeDirective, V = !1, q = !1, z = f.hasElementTranscludeDirective, J = o.$$element = Xn(s), Q = c, X = l, ee = 0, ne = e.length; ee < ne; ee++) {
                        L = e[ee];
                        ...
                        x = ce(x), L.replace) {
                            ...
                            j && W(ue), e = e.concat(ue).concat(de), B(o, le), ne = e.length;
                        } else J.html(x);
        ...
        }, Hi = Ei(), ji = Ei(!0), Ai = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, Oi = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Pi = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Ii = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Fi = /^(\d{4})-(\d{2})-(\d{2})$/, Ui = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Ni = /^(\d{4})-W(\d\d)$/, Vi = /^(\d{4})-(\d\d)$/, Wi = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, qi = {
            text: xn,
                ...
                compile: function(a, m) {
                    ...
                    return b ? $ = e(b) : (w = function(e, t) {
                        ...
                        e.$watchCollection(_, function(a) {
                            var m, _, b, $, D, Y, T, S, x, C, E, H, j = t[0], A = ue();
                            ...
                            for (var P in g) {
                                if (C = g[P], H = le(C.clone), s.leave(H), H[0].parentNode) for (m = 0, _ = H.length; m < _; m++) H[m][o] = !0;
                                C.scope.$destroy();
                            }
                            for (m = 0; m < $; m++) if (D = a === x ? m : x[m], Y = a[D], C = E[m], C.scope) {
                                b = j;
                                do b = b.nextSibling; while (b && b[o]);
                                c(C) != b && s.move(le(C.clone), null, Xn(j)), j = d(C), u(C.scope, m, y, Y, M, D, $);
                            } else h(function(e, t) {
                                C.scope = t;
                                var n = p.cloneNode(!1);
                                e[e.length++] = n, s.enter(e, null, Xn(j)), j = n, C.clone = e, A[C.id] = C, u(C.scope, m, y, Y, M, D, $);
                            });
                            g = A;
                        });
                    };
            ...
            return {
                ...
                link: function(o, l, u, c) {
                    ...
                    function f(t, o, l) {
                        ...
                        function _() {
                            $ = !1;
                            var e, n, a, i, c, d, m, p, _, y, L, Y, T, S, E, j, F, U = {
                                "": []
                            ...
                            j = u(D, m, p), j = v(j) ? j : "", F = A ? A(t, I) : x ? q[Y] : Y, A && (O[F] = m), 
                            n.push({
                                id: F,
                                label: j,
                                selected: T
                        ...
                        var D = a(L[2] || L[1]), Y = L[4] || L[6], T = / as /.test(L[0]) && L[1], S = T ? a(T) : null, x = L[5], C = a(L[3] || ""), E = a(L[2] ? L[1] : Y), H = a(L[7]), j = L[8], A = j ? a(L[8]) : null, O = {}, P = [ [ {
                            element: o,
                            label: ""
                        } ] ], I = {};
                        M && (e(M)(t), M.removeClass("ng-scope"), M.remove()), o.empty(), o.on("change", c), 
                        l.$render = _, t.$watchCollection(H, p), t.$watchCollection(m, p), b && t.$watchCollection(function() {
                            return l.$modelValue;
                        }, p);
                    }
                    if (c[1]) {
    ...
    angular.module("ui.bootstrap.collapse", []).directive("collapse", [ "$animate", function(e) {
                ...
                return {
                    ...
                    compile: function(e, t) {
                        ...
                        return function(e, t, a, r) {
                            ...
                            function k() {
                                var e = a[c + "Trigger"];
                                H(), S = f(e), S.show === S.hide ? t.bind(S.show, u) : (t.bind(S.show, d), t.bind(S.hide, p));
                            }
        ...
        return {
            ...
            link: function(l, u, c, d) {
                ...
                var H = e(L)(k);
                b ? i.find("body").append(H) : u.after(H);
            }
        };
    ...
    (function(e) {
        ...
        !function(t, n) {
            ...
            gi.weeks = xn, gi.months = di, gi.years = mi, gi.humanize = jn, gi.toISOString = An, 
            ...
            q("X", function(e, t, n) {
                ...
                n._d = new Date(v(e));
            }), t.version = "2.10.6", a(Ce), t.fn = Wa, t.min = He, t.max = je, t.utc = u, t.unix = Xt, 
        ...
        !function(e) {
            ...
            function v() {
                z.blocking = !0, z.testTimeout && U.setTimeout && (I(z.timeout), z.timeout = P(function() {
                    ...
                    z.current.semaphore = 0, j.pushFailure("Test timed out", m(2)), b();
                }, z.testTimeout));
            }
            function b() {
            ...
            function u() {
                ...
                for (e = 0; e < o.length; e++) if (a = C.urlConfig[e], "string" == typeof a && (a = {
                    ...
                    l += "<option value='" + i + "'" + (C[a.id] === a.value[n] ? (s = !0) && " selected='selected'" : "") + ">" + i + "</option>"; else for (n in a.value) j.call(a.value, n) && (l += "<option value='" + t(n) + "'" + (C[a.id] === n ? (s = !0) && " selected='selected'" : "") + ">" + t(a.value[n]) + "</option>");
