!function(e) {
    ...
    "use strict";
    var o = n(34), r = o, i = n(16);
    o.test("toFixedPrecision", function() {
        r.equal("1.0", i.toFixedPrecision("1", 1)), r.equal("1.0", i.toFixedPrecision("1.0", 1)), 
        r.equal("1.0", i.toFixedPrecision("1.01", 1)), r.equal("1.1", i.toFixedPrecision("1.1", 1)), 
        r.equal("1.1", i.toFixedPrecision("1.123", 1)), r.equal("1", i.toFixedPrecision("1", 0)), 
        r.equal("1", i.toFixedPrecision("1.0", 0)), r.equal("1", i.toFixedPrecision("1.01", 0)), 
        r.equal("1", i.toFixedPrecision("1.1", 0)), r.equal("1", i.toFixedPrecision("1.123", 0)), 
        r.equal("1.00", i.toFixedPrecision("1", 2)), r.equal("1.00", i.toFixedPrecision("1.0", 2)), 
        r.equal("1.01", i.toFixedPrecision("1.01", 2)), r.equal("1.10", i.toFixedPrecision("1.1", 2)), 
        r.equal("1.12", i.toFixedPrecision("1.123", 2)), r.equal("12.0", i.toFixedPrecision("12", 1)), 
        r.equal("12.0", i.toFixedPrecision("12.0", 1)), r.equal("12.0", i.toFixedPrecision("12.01", 1)), 
        r.equal("12.0", i.toFixedPrecision("12.010", 1)), r.equal("12.1", i.toFixedPrecision("12.123", 1)), 
        r.equal("12.00", i.toFixedPrecision("12", 2)), r.equal("12.00", i.toFixedPrecision("12.0", 2)), 
        r.equal("12.01", i.toFixedPrecision("12.01", 2)), r.equal("12.01", i.toFixedPrecision("12.010", 2)), 
        r.equal("12.12", i.toFixedPrecision("12.123", 2));
    }), o.start();
}, , , , , , , , , , , , , , , function(e, t) {
    "use strict";
    ...
    function r(e, t) {
        ...
        switch (t) {
          ...
          default:
            console.error("toGigaBytes(): unknown unit: " + t), n = e / 1;
        }
        if (n < 1) n = n.toFixed(2); else {
            var o = n.toFixed(1);
            n = n - o === 0 ? n.toFixed(0) : o;
        }
        return n;
    }
    function i(e, t) {
        ...
        switch (t) {
          ...
          default:
            console.error("toKiloBytes(): unknown unit: " + t), n = e / 1;
        }
        return n;
    }
    function s(e) {
    ...
    function a(e) {
        h.default.isDev && console.log(e);
    }
    function l(e, t) {
        return e in g ? t in g[e] ? g[e][t] : (a("rephraseUI(key='" + e + "', original='" + t + "'): unknown original value"), 
        t) : (a("rephraseUI(key='" + e + "', original='" + t + "'): unknown key"), t);
    }
    function c(e, t) {
        t = t || 0;
        var n = Math.pow(10, t), o = Math.abs(Math.round(e * n)), r = (e < 0 ? "-" : "") + String(Math.floor(o / n));
        if (t > 0) {
            var i = String(o % n), s = new Array(Math.max(t - i.length, 0) + 1).join("0");
            r += "." + s + i;
        }
        return r;
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.toGigaBytes = r, t.toKiloBytes = i, t.isEmpty = s, t.arrayEquals = u, t.logDebug = a, 
    t.rephraseUI = l, t.toFixedPrecision = c;
    var d = n(17), f = o(d), p = n(15), h = o(p), m = f.default.gettext, g = {
        autostart: {
            disable: m("disabled"),
            enable: m("enabled")
        },
    ...
    "use strict";
    !function() {
        window.QUnit = n(35), window.qunitTap = n(37), n(38), n(40), e.exports = window.QUnit;
    }();
}, function(e, t, n) {
    (function(t) {
        /*!
	 ...
	 */
        !function(t) {
            function n() {
                k.autorun = !0, k.previousModule && y("moduleDone", T, {
                ...
                var e, n, o = b("qunit-banner"), r = b("qunit-tests"), i = +new M() - k.started, s = k.stats.all - k.stats.bad, u = [ "Tests completed in ", i, " milliseconds.<br/>", "<span class='passed'>", s, "</span> assertions of <span class='total'>", k.stats.all, "</span> passed, <span class='failed'>", k.stats.bad, "</span> failed." ].join("");
                if (o && (o.className = k.stats.bad ? "qunit-fail" : "qunit-pass"), r && (b("qunit-testresult").innerHTML = u), 
                k.altertitle && O.document && document.title && (document.title = [ k.stats.bad ? "✖" : "✔", document.title.replace(/^[\u2714\u2716] /i, "") ].join(" ")), 
                k.reorder && O.sessionStorage && 0 === k.stats.bad) for (e = 0; e < sessionStorage.length; e++) n = sessionStorage.key(e++), 
                0 === n.indexOf("qunit-test-") && sessionStorage.removeItem(n);
                k.scrolltop && t.scrollTo && t.scrollTo(0, 0), y("done", T, {
                    failed: k.stats.bad,
                    passed: s,
                    total: k.stats.all,
                    runtime: i
            ...
            function r(e, t) {
                ...
                if (e.stack) {
                    if (n = e.stack.split("\n"), /^error$/i.test(n[0]) && n.shift(), j) {
                        for (o = [], r = t; r < n.length && n[r].indexOf(j) === -1; r++) o.push(n[r]);
            ...
            function a(e) {
                ...
                for (k.depth = k.depth ? k.depth + 1 : 1; k.queue.length && !k.blocking; ) {
                    if (!(!O.setTimeout || k.updateRate <= 0 || new M().getTime() - o < k.updateRate)) {
                        P(t, 13);
                        break;
                    }
                    k.queue.shift()();
            ...
            function l() {
                if (k.pollution = [], k.noglobals) for (var e in t) if (F.call(t, e)) {
            ...
            function c() {
                ...
                l(), e = d(k.pollution, n), e.length > 0 && T.pushFailure("Introduced global variable(s): " + e.join(", ")), 
                t = d(n, k.pollution), t.length > 0 && T.pushFailure("Deleted global variable(s): " + t.join(", "));
            }
            function d(e, t) {
                var n, o, r = e.slice();
            ...
            function f(e, n) {
                for (var o in n) F.call(n, o) && ("constructor" === o && e === t || (void 0 === n[o] ? delete e[o] : e[o] = n[o]));
                return e;
            }
            function p(e, t, n) {
            ...
            function b(e) {
                return O.document && document.getElementById && document.getElementById(e);
            }
            function w(e) {
                return function(t) {
                    k[e].push(t);
            ...
            function y(e, t, n) {
                var o, r;
                if (T.hasOwnProperty(e)) T[e].call(t, n); else for (r = k[e], o = 0; o < r.length; o++) r[o].call(t, n);
            }
            function x(e, t) {
            ...
            function q(e) {
                f(this, e), this.assertions = [], this.testNumber = ++q.count;
            }
            var T, E, k, N, S = 0, j = (i(0) || "").replace(/(:\d+)+\)?/, "").replace(/.+\//, ""), C = Object.prototype.toString, F = Object.prototype.hasOwnProperty, M = t.Date, P = t.setTimeout, L = t.clearTimeout, O = {
                ...
                var t, n, o = T.is("array", e) ? [] : {};
                for (t in e) F.call(e, t) && (n = e[t], o[t] = n === Object(n) ? D(n) : n);
                return o;
            };
            T = {
                module: function(e, t) {
                ...
                start: function(e) {
                    return void 0 === k.semaphore ? void T.begin(function() {
                        P(function() {
                            T.start(e);
                        });
                    }) : (k.semaphore -= e || 1, k.semaphore > 0 ? void 0 : k.semaphore < 0 ? (k.semaphore = 0, 
                    void T.pushFailure("Called start() while already started (QUnit.config.semaphore was 0 already)", null, i(2))) : void (O.setTimeout ? P(function() {
                        k.semaphore > 0 || (k.timeout && L(k.timeout), k.blocking = !1, a(!0));
                    }, 13) : (k.blocking = !1, a(!0))));
                },
                stop: function(e) {
                    k.semaphore += e || 1, k.blocking = !0, k.testTimeout && O.setTimeout && (L(k.timeout), 
                    k.timeout = P(function() {
                        T.ok(!1, "Test timed out"), k.semaphore = 1, T.start();
                    }, k.testTimeout));
                }
            }, function() {
                function e() {}
                ...
                if (T.urlParams = s, k.filter = s.filter, k.module = s.module, k.testNumber = [], 
                ...
                push: function(e, t, n, o) {
                    ...
                    r = o, e || (n = s(T.jsDump.parse(n)), t = s(T.jsDump.parse(t)), r += "<table><tr class='test-expected'><th>Expected: </th><td><pre>" + n + "</pre></td></tr>", 
                    t !== n && (r += "<tr class='test-actual'><th>Result: </th><td><pre>" + t + "</pre></td></tr>", 
                    r += "<tr class='test-diff'><th>Diff: </th><td><pre>" + T.diff(n, t) + "</pre></td></tr>"), 
                    u = i(), u && (a.source = u, r += "<tr class='test-source'><th>Source: </th><td><pre>" + s(u) + "</pre></td></tr>"), 
                    r += "</table>"), y("log", T, a), k.current.assertions.push({
                        result: !!e,
                        message: r
                    });
                },
                pushFailure: function(e, t, n) {
                    ...
                    o += "</table>", y("log", T, r), k.current.assertions.push({
                        result: !1,
                        message: o
                    });
                },
                url: function(e) {
                    e = f(f({}, T.urlParams), e);
                    var n, o = "?";
                    for (n in e) F.call(e, n) && (o += encodeURIComponent(n) + "=" + encodeURIComponent(e[n]) + "&");
            ...
            }), O.document && "complete" !== document.readyState || (k.autorun = !0), T.load = function() {
                y("begin", T, {});
                var e, n, o, r, i, u, a, l, c, d, m, g, v, w, x = 0, q = [], E = "", N = "", S = f({}, k);
                for (T.init(), f(k, S), k.blocking = !1, u = k.urlConfig.length, o = 0; o < u; o++) if (d = k.urlConfig[o], 
                "string" == typeof d && (d = {
                    id: d,
                    label: d
                }), k[d.id] = T.urlParams[d.id], d.value && "string" != typeof d.value) {
                    ...
                    m = !1, T.is("array", d.value)) for (r = 0; r < d.value.length; r++) N += "<option value='" + s(d.value[r]) + "'" + (k[d.id] === d.value[r] ? (m = !0) && " selected='selected'" : "") + ">" + s(d.value[r]) + "</option>"; else for (r in d.value) F.call(d.value, r) && (N += "<option value='" + s(r) + "'" + (k[d.id] === r ? (m = !0) && " selected='selected'" : "") + ">" + s(d.value[r]) + "</option>");
                ...
                for (o in k.modules) k.modules.hasOwnProperty(o) && q.push(o);
                for (x = q.length, q.sort(function(e, t) {
                ...
                o = 0; o < x; o++) E += "<option value='" + s(encodeURIComponent(q[o])) + "' " + (k.module === q[o] ? "selected='selected'" : "") + ">" + s(q[o]) + "</option>";
                ...
                n.type = "checkbox", n.id = "qunit-filter-pass", p(n, "click", function() {
                    ...
                    t.className = e.replace(/ hidepass /, " ")), O.sessionStorage && (n.checked ? sessionStorage.setItem("qunit-filter-passed-tests", "true") : sessionStorage.removeItem("qunit-filter-passed-tests"));
                }), (k.hidepassed || O.sessionStorage && sessionStorage.getItem("qunit-filter-passed-tests")) && (n.checked = !0, 
                ...
                g.innerHTML = N, h(g.getElementsByTagName("input"), "click", function(e) {
                    ...
                    n[o.name] = o.checked ? o.defaultValue || !0 : void 0, t.location = T.url(n);
                }), h(g.getElementsByTagName("select"), "change", function(e) {
                    var n = {}, o = e.target || e.srcElement;
                    n[o.name] = o.options[o.selectedIndex].value || void 0, t.location = T.url(n);
                ...
                k.autostart && T.start();
            }, O.document && p(t, "load", T.load), N = t.onerror, t.onerror = function(e, t, n) {
                var r = !1;
                if (N && (r = N(e, t, n)), r !== !0) {
                    if (T.config.current) {
                ...
                setup: function() {
                    if (this.module === k.previousModule && F.call(k, "previousModule") || (F.call(k, "previousModule") && y("moduleDone", T, {
                        name: k.previousModule,
                        failed: k.moduleStats.bad,
                        passed: k.moduleStats.all - k.moduleStats.bad,
                        total: k.moduleStats.all
                        ...
                        setup: function() {},
                        teardown: function() {}
                    }, this.moduleTestEnvironment), this.started = +new M(), y("testStart", T, {
                        name: this.testName,
                        module: this.module
                    }), T.current_testEnvironment = this.testEnvironment, k.pollution || l(), k.notrycatch) return void this.testEnvironment.setup.call(this.testEnvironment, T.assert);
                    try {
                        this.testEnvironment.setup.call(this.testEnvironment, T.assert);
                    } catch (e) {
                        T.pushFailure("Setup failed on " + this.testName + ": " + (e.message || e), r(e, 1));
                    }
                },
                run: function() {
                    k.current = this;
                    ...
                    this.callbackStarted = +new M(), k.notrycatch) return this.callback.call(this.testEnvironment, T.assert), 
                    ...
                    try {
                        ...
                        this.callbackRuntime = +new M() - this.callbackStarted, T.pushFailure("Died on test #" + (this.assertions.length + 1) + " " + this.stack + ": " + (e.message || e), r(e, 0)), 
                        l(), k.blocking && T.start();
                    }
                },
                teardown: function() {
                    if (k.current = this, k.notrycatch) return "undefined" == typeof this.callbackRuntime && (this.callbackRuntime = +new M() - this.callbackStarted), 
                ...
                finish: function() {
                    ...
                    k.moduleStats.all += this.assertions.length, d) {
                        ...
                        T.config.reorder && O.sessionStorage && (c ? sessionStorage.setItem("qunit-test-" + this.module + "-" + this.testName, c) : sessionStorage.removeItem("qunit-test-" + this.module + "-" + this.testName)), 
                ...
                queue: function() {
                    ...
                    u(function() {
                        n.init();
                    }), t = T.config.reorder && O.sessionStorage && +sessionStorage.getItem("qunit-test-" + this.module + "-" + this.testName), 
                    t ? e() : u(e, !0);
                }
            }, E = T.assert = {
                ok: function(e, t) {
                    ...
                    y("log", T, o), k.current.assertions.push({
                        result: e,
                        message: t
                    });
                },
                ...
                propEqual: function(e, t, n) {
                    e = D(e), t = D(t), T.push(T.equiv(e, t), e, t, n);
                },
                ...
                throws: function(e, t, n) {
                    ...
                    k.current.ignoreGlobalErrors = !1, o ? (t ? t instanceof Error ? i = o instanceof Error && o.name === t.name && o.message === t.message : "regexp" === T.objectType(t) ? i = t.test(U(o)) : "string" === T.objectType(t) ? i = t === U(o) : o instanceof t ? i = !0 : t.call({}, o) === !0 && (r = null, 
                    i = !0) : (i = !0, r = null), T.push(i, o, r, n)) : T.pushFailure(n, null, "No exception was thrown.");
                }
                ...
                function e(e, t, n) {
                    var o = T.objectType(e);
                    if (o) return "function" === T.objectType(t[o]) ? t[o].apply(t, n) : t[o];
                }
                ...
                var r = /^function (\w+)/, i = {
                    ...
                    parsers: {
                        ...
                        function: function(e) {
                            ...
                            return o && (t += " " + o), t += "( ", t = [ t, T.jsDump.parse(e, "functionArgs"), "){" ].join(""), 
                        ...
                        object: function(e, t) {
                            ...
                            T.jsDump.up(), o = [];
                            for (r in e) o.push(r);
                            for (o.sort(), s = 0; s < o.length; s++) r = o[s], i = e[r], u.push(T.jsDump.parse(r, "key") + ": " + T.jsDump.parse(i, void 0, t));
                            return T.jsDump.down(), n("{", u, "}");
                        },
                        node: function(e) {
                            var t, n, o, r = T.jsDump.HTML ? "&lt;" : "<", i = T.jsDump.HTML ? "&gt;" : ">", s = e.nodeName.toLowerCase(), u = r + s, a = e.attributes;
                            if (a) for (n = 0, t = a.length; n < t; n++) o = a[n].nodeValue, o && "inherit" !== o && (u += " " + a[n].nodeName + "=" + T.jsDump.parse(o, "attribute"));
                ...
                function e(e, t) {
                    var n, o = {}, r = {};
                    for (n = 0; n < t.length; n++) F.call(o, t[n]) || (o[t[n]] = {
                        rows: [],
                        o: null
                    }), o[t[n]].rows.push(n);
                    for (n = 0; n < e.length; n++) F.call(r, e[n]) || (r[e[n]] = {
                        rows: [],
                        n: null
                    }), r[e[n]].rows.push(n);
                    for (n in o) F.call(o, n) && 1 === o[n].rows.length && F.call(r, n) && 1 === r[n].rows.length && (t[o[n].rows[0]] = {
                        text: t[o[n].rows[0]],
                        row: r[n].rows[0]
                    }, e[r[n].rows[0]] = {
                        text: e[r[n].rows[0]],
    ...
    !function(i, s) {
        ...
        function p(p, v, b) {
            ...
            function q(e) {
                var o;
                t(C, e) !== -1 && (o = E.config[e], "undefined" != typeof o && n(o, F[e]));
            }
            function T(e) {
                var t;
            ...
            var E = p, k = {}, N = "undefined" != typeof E.jsDump && "function" == typeof E.jsDump.parse, S = N ? function(e) {
                ...
                t(b[e]));
            }, C = [ "moduleStart", "testStart", "log", "testDone", "done" ], F = {};
            return k.config = e({
                initialCount: 1,
            ...
            k.explain = S, k.note = function(e) {
                ...
                var e, t, n, o = g(E);
                for (t = 0; t < C.length; t += 1) e = C[t], n = o(E, k, e), F[e] = n;
            }(), k;
        }
