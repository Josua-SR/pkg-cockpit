!function(e) {
    ...
    16: function(e, t, n) {
        ...
        function a(e) {
            if (v.default.isDev) {
                ...
                console.log.apply(console, [ e ].concat(n));
            }
        }
        function l(e, t) {
            return e in y ? t in y[e] ? y[e][t] : (a("rephraseUI(key='" + e + "', original='" + t + "'): unknown original value"), 
        ...
        function d(e) {
            ...
            return s.id = "dynamically-generated-file", s.href = "data:" + o + "," + encodeURIComponent(t), 
            document.body.appendChild(s), !f() && "download" in s ? (a("fileDownload() is using A.HREF"), 
            s.setAttribute("download", r), s.click()) : !function() {
                a("fileDownload() is using IFRAME");
                var e = document.createElement("iframe");
                e.width = "1", e.height = "1", document.body.appendChild(e);
                var n = "\n[...............................GraphicsConsole]\n";
                e.src = "data:" + o + "," + encodeURIComponent(t + n), window.setTimeout(function() {
        ...
        t.rephraseUI = l, t.toFixedPrecision = c, t.fileDownload = d, t.vmId = p;
        var h = n(17), m = r(h), g = n(15), v = r(g), b = m.default.gettext, y = {
            autostart: {
                disable: b("disabled"),
                enable: b("enabled")
            },
    ...
    38: function(e, t, n) {
        "use strict";
        !function() {
            window.QUnit = n(39), window.qunitTap = n(42), n(43), n(44), e.exports = window.QUnit;
        }();
    },
    39: function(e, t, n) {
        var r;
