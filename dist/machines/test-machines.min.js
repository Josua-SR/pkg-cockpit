!function(e) {
    ...
    17: function(e, t, n) {
        ...
        function c(e, t) {
            return e in w ? t in w[e] ? w[e][t] : (a("rephraseUI(key='" + e + "', original='" + t + "'): unknown original value"), 
        ...
        function p(e) {
            var t = e.data, n = e.fileName, r = void 0 === n ? "myFile.dat" : n, i = e.mimeType, o = void 0 === i ? "application/octet-stream" : i;
            if (!t) return console.error("fileDownload(): no data to download"), !1;
            var s = document.createElement("a");
            if (s.id = "dynamically-generated-file", s.href = "data:" + o + "," + encodeURIComponent(t), 
            document.body.appendChild(s), !d() && "download" in s) a("fileDownload() is using A.HREF"), 
            s.setAttribute("download", r), s.click(); else {
                a("fileDownload() is using IFRAME");
                var u = document.createElement("iframe");
                u.width = "1", u.height = "1", document.body.appendChild(u);
                var l = "\n[...............................GraphicsConsole]\n";
                u.src = "data:" + o + "," + encodeURIComponent(t + l), window.setTimeout(function() {
                    return document.body.removeChild(u);
                }, 333);
            }
            return window.setTimeout(function() {
                a("removing temporary A.HREF for filedownload"), document.body.removeChild(s);
            }, 5e3), !0;
        }
        function h(e) {
            return "vm-" + e;
        ...
        t.logError = l, t.rephraseUI = c, t.toFixedPrecision = f, t.fileDownload = p, t.vmId = h;
        var m = n(18), g = r(m), v = n(16), b = r(v), y = g.default.gettext, w = {
            autostart: {
                disable: y("disabled"),
                enable: y("enabled")
            },
    ...
    53: function(e, t, n) {
        "use strict";
        !function() {
            window.QUnit = n(54), window.qunitTap = n(56), n(57), n(58), e.exports = window.QUnit;
        }();
    },
    54: function(e, t, n) {
        var r;
            ...
            !function(e) {
                ...
                function v(e) {
                    ...
                    for (z.depth = (z.depth || 0) + 1; z.queue.length && !z.blocking; ) {
                        if (!(!R.setTimeout || z.updateRate <= 0 || O() - n < z.updateRate)) {
                            D(t, 13);
                            break;
                        }
                ...
                }, D = e.setTimeout, L = e.clearTimeout, A = e.window, R = {
                ...
                function M(e, t, n) {
                    ...
                    u && (r = j.createElement("strong"), r.innerHTML = C(e, n), i = j.createElement("a"), 
