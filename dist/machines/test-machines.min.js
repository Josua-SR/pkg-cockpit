!function(e) {
    ...
    18: function(e, t, n) {
        ...
        function u(e, t) {
            return l(e, t, U[s(l(e, t, S.B).value)]);
        }
        function a(e, t, n) {
        ...
        function h(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = t && 46 === e.charCode || e.charCode >= 48 && e.charCode <= 57;
        ...
        function g(e, t) {
            return e in F ? t in F[e] ? F[e][t] : (d("rephraseUI(key='" + e + "', original='" + t + "'): unknown original value"), 
        ...
        function y(e) {
            ...
            document.body.appendChild(s), !b() && "download" in s) d("fileDownload() is using A.HREF"), 
            s.setAttribute("download", r), s.click(); else {
                ...
                var a = "\n[...............................GraphicsConsole]\n";
                u.src = "data:" + o + "," + encodeURIComponent(t + a), window.setTimeout(function() {
                    return document.body.removeChild(u);
                }, 333);
            }
            return window.setTimeout(function() {
                d("removing temporary A.HREF for filedownload"), document.body.removeChild(s);
            }, 5e3), !0;
        }
        function w(e) {
            return "vm-" + e;
        ...
        function q(e, t) {
            var n = k.default.defer(), r = !1, i = window.setTimeout(function() {
                r || (n.resolve(), r = !0);
            }, t);
            return e.then(function() {
                r || (n.resolve.apply(n, arguments), r = !0, window.clearTimeout(i));
            }), e.catch(function() {
                r || (n.reject.apply(n, arguments), r = !0, window.clearTimeout(i));
            }), n.promise;
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        t.fileDownload = y, t.vmId = w, t.mouseClick = x, t.timeoutedPromise = q;
        var E = n(19), k = r(E), T = n(17), M = r(T), C = k.default.gettext, S = t.units = {
            B: {
                name: "B",
                base1024Exponent: 0
            },
    ...
    70: function(e, t, n) {
        "use strict";
        !function() {
            window.QUnit = n(71), window.qunitTap = n(73), n(74), n(75), e.exports = window.QUnit;
        }();
    },
    71: function(e, t, n) {
        var r;
	 ...
	 */
            !function(e) {
                ...
                function m() {
                    var t, n;
                    for (t in V) Q[t] !== V[t] && (n = Q[t], Q[t] = V[t], Q[t](n), e.console && e.console.warn && e.console.warn("QUnit." + t + " was replaced with a new value.\nPlease, check out the documentation on how to apply logging callbacks.\nReference: https://api.qunitjs.com/category/callbacks/"));
                }
                function g() {
                    var e, t, n = [];
                    if (!z.started) {
                ...
                function k(e, t, n) {
                    var r, i = !t;
                    if ("array" !== Q.objectType(e)) t ? z.queue.splice(Y++, 0, e) : n ? (K || (K = T(n)), 
                    r = Math.floor(K() * (z.queue.length - Y + 1)), z.queue.splice(Y + r, 0, e)) : z.queue.push(e), 
                ...
                }, B = (d(0) || "").replace(/(:\d+)+\)?/, "").replace(/.+\//, ""), H = !1, $ = !1, _ = Object.prototype.toString, G = Object.prototype.hasOwnProperty, z = {
                    queue: [],
                    blocking: !0,
                    reorder: !0,
                    altertitle: !0,
