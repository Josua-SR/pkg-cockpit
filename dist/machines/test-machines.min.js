!function(e) {
    ...
    40: function(e, t, n) {
        ...
        function u(e, t) {
            return l(e, t, I[s(l(e, t, S.B).value)]);
        }
        function a(e, t, n) {
        ...
        function l(e, t, n) {
            ...
            r;
            var i = S["string" == typeof t ? t : t.name], s = S["string" == typeof n ? n : n.name];
        ...
        function h(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = t && "." === e.key || e.key >= "0" && e.key <= "9" || "Backspace" === e.key || "Delete" === e.key || "Tab" === e.key || "ArrowLeft" === e.key || "ArrowRight" === e.key || "ArrowUp" === e.key || "ArrowDown" === e.key || "a" === e.key && e.ctrlKey || "Home" === e.key || "End" === e.key;
        ...
        function E(e, t, n, r) {
            var i = k.default.defer(), o = !1, s = window.setTimeout(function() {
                o || (i.resolve(), o = !0, n());
            }, t);
            return e.then(function() {
                o || (o = !0, window.clearTimeout(s), i.resolve.apply(i, arguments)), "function" == typeof n && n.apply(r, arguments);
            }), e.catch(function() {
                o || (o = !0, window.clearTimeout(s), i.reject.apply(i, arguments)), "function" == typeof r && r.apply(r, arguments);
            }), i.promise;
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.units = t.LIBVIRT_SYSTEM_CONNECTION = t.LIBVIRT_SESSION_CONNECTION = void 0, 
        t.toReadableNumber = i, t.convertToBestUnit = u, t.convertToUnit = a, t.convertToUnitVerbose = l, 
        t.isEmpty = c, t.arrayEquals = f, t.logDebug = d, t.logError = p, t.digitFilter = h, 
        t.getTodayYearShifted = m, t.rephraseUI = g, t.toFixedPrecision = v, t.fileDownload = b, 
        t.vmId = y, t.storagePoolId = w, t.mouseClick = x, t.timeoutedPromise = E;
        var q = n(41), k = r(q), T = n(39), M = r(T), C = k.default.gettext, S = (t.LIBVIRT_SESSION_CONNECTION = "session", 
        t.LIBVIRT_SYSTEM_CONNECTION = "system", t.units = {
            B: {
                name: "B",
                base1024Exponent: 0
            },
    ...
    1123: function(e, t, n) {
        "use strict";
        !function() {
            window.QUnit = n(1124), window.qunitTap = n(1125), n(1126), n(1127), e.exports = window.QUnit;
        }();
    },
    1124: function(e, t, n) {
        var r;
	 ...
	 */
            !function(e) {
                ...
                function u(e) {
                    ...
                    for (t in e) $.call(e, t) && (n = e[t], r[t] = n === Object(n) ? u(n) : n);
                    return r;
                }
                function a(t, n, r) {
                    for (var i in n) $.call(n, i) && ("constructor" === i && t === e || (void 0 === n[i] ? delete t[i] : r && "undefined" != typeof t[i] || (t[i] = n[i])));
                    return t;
                }
                function l(e) {
                ...
                function h(e, t) {
                    var n, r, i;
                    for (i = G.callbacks[e], n = 0, r = i.length; n < r; n++) i[n](t);
                }
                function m() {
                    var t, n;
                    for (t in z) j[t] !== z[t] && (n = j[t], j[t] = z[t], j[t](n), e.console && e.console.warn && e.console.warn("QUnit." + t + " was replaced with a new value.\nPlease, check out the documentation on how to apply logging callbacks.\nReference: https://api.qunitjs.com/category/callbacks/"));
                }
                function g() {
                    var e, t, n = [];
                    if (!G.started) {
                        for (G.started = Q(), m(), "" === G.modules[0].name && 0 === G.modules[0].tests.length && G.modules.shift(), 
                ...
                function v(e) {
                    ...
                    for (G.depth = (G.depth || 0) + 1; G.queue.length && !G.blocking; ) {
                        if (!(!A.setTimeout || G.updateRate <= 0 || Q() - n < G.updateRate)) {
                            D(t, 13);
                            break;
                        }
                ...
                function b() {
                    G.blocking = !0, G.testTimeout && A.setTimeout && (L(G.timeout), G.timeout = D(function() {
                        if (!G.current) throw new Error("Test timed out");
                        G.current.semaphore = 0, j.pushFailure("Test timed out", d(2)), y();
                    }, G.testTimeout));
                }
                function y() {
                    _ = !0, A.setTimeout ? D(function() {
                        G.current && G.current.semaphore > 0 || (G.timeout && L(G.timeout), g());
                    }, 13) : g();
                }
                function w() {
                    var e, t;
                    G.autorun = !0, G.previousModule && h("moduleDone", {
                        ...
                        runtime: Q() - G.moduleStats.started
                    }), delete G.previousModule, e = Q() - G.started, t = G.stats.all - G.stats.bad, 
                    h("done", {
                        failed: G.stats.bad,
                        passed: t,
                        total: G.stats.all,
                ...
                function E(e) {
                    ...
                    this.testId = q(this.module.name, this.testName), this.module.tests.push({
                        name: this.testName,
                        testId: this.testId
                    }), e.skip ? (this.callback = function() {}, this.async = !1, this.expected = 0) : this.assert = new F(this);
                }
                function q(e, t) {
                ...
                function k(e, t, n) {
                    var r, i = !t;
                    if ("array" !== j.objectType(e)) t ? G.queue.splice(Y++, 0, e) : n ? (K || (K = T(n)), 
                    r = Math.floor(K() * (G.queue.length - Y + 1)), G.queue.splice(Y + r, 0, e)) : G.queue.push(e), 
                    G.autorun && !G.blocking && v(i); else for (;e.length; ) k(e.shift());
                }
                function T(e) {
                ...
                function M() {
                    if (G.pollution = [], G.noglobals) for (var t in e) if ($.call(e, t)) {
                ...
                function C() {
                    ...
                    M(), e = o(G.pollution, n), e.length > 0 && j.pushFailure("Introduced global variable(s): " + e.join(", ")), 
                    t = o(n, G.pollution), t.length > 0 && j.pushFailure("Deleted global variable(s): " + t.join(", "));
                }
                function S(e, t, n) {
                ...
                function I(e, t, n, r) {
                    if (!W) {
                        var i;
                        2 === arguments.length && (n = t, t = null), i = new E({
                            testName: e,
                            expected: t,
                            async: r,
                            callback: n
                ...
                function N(e, t, n, r) {
                    var i;
                    W || (j.config.queue.length = 0, W = !0, 2 === arguments.length && (n = t, t = null), 
                    i = new E({
                        testName: e,
                        expected: t,
                        async: r,
                ...
                var j = {}, O = e.Date, Q = O.now || function() {
                    return new O().getTime();
                }, D = e.setTimeout, L = e.clearTimeout, R = e.window, A = {
                ...
                }, B = (d(0) || "").replace(/(:\d+)+\)?/, "").replace(/.+\//, ""), H = !1, _ = !1, V = Object.prototype.toString, $ = Object.prototype.hasOwnProperty, G = {
                    queue: [],
                    blocking: !0,
                    reorder: !0,
                    altertitle: !0,
                        ...
                        R.onerror = function(t, n, r) {
                            ...
                            if (e && (i = e(t, n, r)), i !== !0) {
                                if (j.config.current) {
                                    ...
                                    j.pushFailure(t, n + ":" + r);
                                } else j.test("global failure", a(function() {
                                    j.pushFailure(t, n + ":" + r);
                                }, {
                                    validTest: !0
                                }));
                ...
                }(), j.isLocal = !(A.document && "file:" !== R.location.protocol), j.version = "1.23.1", 
                a(j, {
                    module: function(e, t, n) {
                        function r() {
                            var n = G.moduleStack.length ? G.moduleStack.slice(-1)[0] : null, r = null !== n ? [ n.name, e ].join(" > ") : e, i = {
                                name: r,
                                parentModule: n,
                                tests: [],
                                moduleId: q(r)
                            ...
                            a(o, t), i.testEnvironment = o, G.modules.push(i), i;
                        }
                        function i(e) {
                            G.currentModule = e;
                        }
                    ...
                    start: function(e) {
                        ...
                        if (G.current) {
                            ...
                            if (G.current.semaphore < 0) return G.current.semaphore = 0, void j.pushFailure("Called start() while already started (test's semaphore was 0 already)", d(2));
                        } else {
                ...
                E.count = 0, E.prototype = {
                    before: function() {
                        this.module === G.previousModule && $.call(G, "previousModule") || ($.call(G, "previousModule") && h("moduleDone", {
                            name: G.previousModule.name,
                            tests: G.previousModule.tests,
                            failed: G.moduleStats.bad,
                            passed: G.moduleStats.all - G.moduleStats.bad,
                    ...
                    run: function() {
                        ...
                        var t;
                        if (G.current = this, this.async && j.stop(), this.callbackStarted = Q(), G.notrycatch) return void e(this);
                        try {
                            e(this);
                        } catch (e) {
                            this.pushFailure("Died on test #" + (this.assertions.length + 1) + " " + this.stack + ": " + (e.message || e), f(e, 0)), 
                            M(), G.blocking && j.start();
                        }
                    },
                    after: function() {
                        C();
                    ...
                    hooks: function(e) {
                        function t(r, i) {
                            i.parentModule && t(r, i.parentModule), i.testEnvironment && "function" === j.objectType(i.testEnvironment[e]) && n.push(r.queueHook(i.testEnvironment[e], e));
                        }
                        var n = [];
                    ...
                    finish: function() {
                        ...
                        var e, t = 0;
                        for (this.runtime = Q() - this.started, G.stats.all += this.assertions.length, G.moduleStats.all += this.assertions.length, 
                    ...
                    queue: function() {
                        ...
                        var t, n = this;
                        if (this.valid()) return t = j.config.reorder && A.sessionStorage && +sessionStorage.getItem("qunit-test-" + this.module.name + "-" + this.testName), 
                        k(e, t, G.seed);
                    },
                    ...
                    resolvePromise: function(e, t) {
                        ...
                        null != e && (n = e.then, "function" === j.objectType(n) && (j.stop(), n.call(e, function() {
                            ...
                            i.pushFailure(r, f(e, 0)), M(), j.start();
                        })));
                    },
                    valid: function() {
                        function e(t) {
                        ...
                        return !(!this.callback || !this.callback.validTest) || !(G.moduleId && G.moduleId.length > 0 && !t(this.module)) && (!(G.testId && G.testId.length > 0 && s(this.testId, G.testId) < 0) && (!(i && !e(this.module)) && (!n || (r ? this.regexFilter(!!r[1], r[2], r[3], o) : this.stringFilter(n, o)))));
                    },
                    ...
                    push: function(e, t, n, r, i) {
                        var o = this instanceof F ? this : j.config.current.assert;
                        return o.pushResult({
                            result: e,
                            actual: t,
                            expected: n,
                    ...
                    pushResult: function(e) {
                        var t = this, n = t instanceof F && t.test || j.config.current;
                        ...
                        t instanceof F || (t = n.assert), t.test.pushResult(e);
                    },
                    ok: function(e, t) {
                    ...
                    throws: function(e, t, n) {
                        var r, i, o = t, s = !1, u = this instanceof F && this.test || j.config.current;
                        ...
                        u.ignoreGlobalErrors = !1, r && (i = j.objectType(t), t ? "regexp" === i ? s = t.test(P(r)) : "string" === i ? s = t === P(r) : "function" === i && r instanceof t ? s = !0 : "object" === i ? s = r instanceof t.constructor && r.name === t.name && r.message === t.message : "function" === i && t.call({}, r) === !0 && (o = null, 
                    ...
                    F.prototype.raises = F.prototype.throws;
                }(), j.equiv = function() {
                    function e(e, t) {
                    ...
                    for (e = 0, t = n.length; e < t; e++) R[n[e]] = j[n[e]];
                }(), R.QUnit = j), "undefined" != typeof i && i && i.exports && (i.exports = j, 
                i.exports.QUnit = j), "undefined" != typeof t && t && (t.QUnit = j), r = function() {
                    return j;
                }.call(t, n, t, i), !(void 0 !== r && (i.exports = r)), j.config.autostart = !1;
            }(function() {
                return this;
            }()), function() {
                function e() {
                    var e, t, n, r, i = {}, o = I.search.slice(1).split("&"), s = o.length;
                ...
                function n(e, t, n) {
                    e.addEventListener ? e.addEventListener(t, n, !1) : e.attachEvent && e.attachEvent("on" + t, function() {
                        var t = window.event;
                        t.target || (t.target = t.srcElement || F), n.call(e, t);
                    });
                }
                function r(e, t, r) {
                ...
                function a(e) {
                    return F.getElementById && F.getElementById(e);
                }
                function l() {
                    var e, n, r, i, o, s = !1, u = N.urlConfig, a = "";
                    for (e = 0; e < u.length; e++) if (r = N.urlConfig[e], "string" == typeof r && (r = {
                        id: r,
                        label: r
                        ...
                        a += "<option value='" + i + "'" + (N[r.id] === r.value[n] ? (s = !0) && " selected='selected'" : "") + ">" + i + "</option>"; else for (n in r.value) j.call(r.value, n) && (a += "<option value='" + t(n) + "'" + (N[r.id] === n ? (s = !0) && " selected='selected'" : "") + ">" + t(r.value[n]) + "</option>");
                        N[r.id] && !s && (i = t(N[r.id]), a += "<option value='" + i + "' selected='selected' disabled='disabled'>" + i + "</option>"), 
                        a += "</select>";
                    } else a += "<input id='qunit-urlconfig-" + i + "' name='" + i + "' type='checkbox'" + (r.value ? " value='" + t(r.value) + "'" : "") + (N[r.id] ? " checked='checked'" : "") + " title='" + o + "' /><label for='qunit-urlconfig-" + i + "' title='" + o + "'>" + r.label + "</label>";
                    return a;
                }
                function c() {
                    var e, t, n, r = this, i = {};
                    ...
                    N[r.name] = t || !1, n = a("qunit-tests"), n && s(n, "hidepass", t || !1), window.history.replaceState(null, "", e)) : window.location = e;
                }
                function f(e) {
                    var t, n, r, i = "?", o = window.location;
                    e = QUnit.extend(QUnit.extend({}, QUnit.urlParams), e);
                    for (t in e) if (j.call(e, t) && void 0 !== e[t]) for (n = [].concat(e[t]), r = 0; r < n.length; r++) i += encodeURIComponent(t), 
                ...
                function h() {
                    var e = F.createElement("form"), t = F.createElement("label"), r = F.createElement("input"), i = F.createElement("button");
                    return o(e, "qunit-filter"), t.innerHTML = "Filter: ", r.type = "text", r.value = N.filter || "", 
                ...
                function m() {
                    ...
                    e = 0; e < D.length; e++) n += "<option value='" + t(encodeURIComponent(D[e])) + "' " + (QUnit.urlParams.module === D[e] ? "selected='selected'" : "") + ">" + t(D[e]) + "</option>";
                    return n += "</select>";
                }
                function g() {
                    var e = a("qunit-testrunner-toolbar"), t = F.createElement("span"), r = m();
                ...
                function b() {
                    ...
                    e && (e.innerHTML = "<a href='" + t(O) + "'>" + e.innerHTML + "</a> ");
                }
                function y() {
                ...
                function w() {
                    ...
                    t && t.parentNode.removeChild(t), e && (e.innerHTML = "", t = F.createElement("p"), 
                ...
                function E() {
                    ...
                    return !e || e.length <= 0 ? "" : "<div id='qunit-filteredTest'>Rerunning selected tests: " + t(e.join(", ")) + " <a id='qunit-clearFilter' href='" + t(O) + "'>Run all tests</a></div>";
                }
                function q() {
                    var e = a("qunit-userAgent");
                    e && (e.innerHTML = "", e.appendChild(F.createTextNode("QUnit " + QUnit.version + "; " + navigator.userAgent)));
                }
                function k() {
                    var e = a("qunit");
                    e && (e.innerHTML = "<h1 id='qunit-header'>" + t(F.title) + "</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar'></div>" + E() + "<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"), 
                    b(), y(), w(), q(), v();
                }
                function T(e) {
                    var t, n, r, i, o, s;
                ...
                function M(e, t, n) {
                    ...
                    u && (r = F.createElement("strong"), r.innerHTML = C(e, n), i = F.createElement("a"), 
                    i.innerHTML = "Rerun", i.href = f({
                        testId: t
                    }), o = F.createElement("li"), o.appendChild(r), o.appendChild(i), o.id = "qunit-test-output-" + t, 
                    s = F.createElement("ol"), s.className = "qunit-assert-list", o.appendChild(s), 
                    u.appendChild(o));
                }
                function C(e, n) {
                    var r = "";
                ...
                if (I) {
                    ...
                    QUnit.config.urlConfig.push({
                        ...
                        var N = QUnit.config, F = window.document, P = !1, j = Object.prototype.hasOwnProperty, O = f({
                            filter: void 0,
                            module: void 0,
                            moduleId: void 0,
                            testId: void 0
                        ...
                        QUnit.begin(function(e) {
                            var t, n, r;
                            for (t = 0; t < e.modules.length; t++) n = e.modules[t], n.name && D.push(n.name);
                            D.sort(function(e, t) {
                                return e.localeCompare(t);
                            }), x(), k(), T(e.modules), r = a("qunit-tests"), r && N.hidepassed && o(r, "hidepass");
                            ...
                            N.altertitle && F.title && (F.title = [ e.failed ? "✖" : "✔", F.title.replace(/^[\u2714\u2716] /i, "") ].join(" ")), 
                            ...
                            t = a("qunit-testresult"), t && (r = QUnit.config.reorder && Q.sessionStorage && +sessionStorage.getItem("qunit-test-" + e.module + "-" + e.name), 
                            ...
                            i += "<span class='runtime'>@ " + e.runtime + " ms</span>", !e.result && j.call(e, "expected") ? (o = e.negative ? "NOT " + QUnit.dump.parse(e.expected) : QUnit.dump.parse(e.expected), 
                            ...
                            n = c.getElementsByTagName("ol")[0], r = F.createElement("li"), r.className = e.result ? "pass" : "fail", 
                            ...
                            0 === c ? o(u, "qunit-collapsed") : c && N.collapse && !P ? P = !0 : o(u, "qunit-collapsed"), 
                            ...
                            d = F.createElement("em"), d.className = "qunit-skipped-label", d.innerHTML = "skipped", 
                            i.insertBefore(d, t)) : (n(t, "click", function() {
                                s(u, "qunit-collapsed");
                            }), i.className = c ? "fail" : "pass", r = F.createElement("span"), r.className = "runtime", 
                            r.innerHTML = e.runtime + " ms", i.insertBefore(r, u)), e.source && (p = F.createElement("p"), 
                        ...
                        L && "complete" === F.readyState ? QUnit.load() : n(window, "load", QUnit.load), 
                        QUnit.diff = function() {
                            function e() {}
                            var n = -1, r = 1, i = 0;
                            return e.prototype.DiffMain = function(e, t, n) {
                                ...
                                var o, s, u, a, l, c, f, d, p, h, m, g, v, b, y, w, x, E, q, k, T, M, C;
                                ...
                                b = 0, T = 0; T < u && !(new Date().getTime() > i); T++) {
                                    for (M = -T + m; M <= T - g; M += 2) {
                                        ...
                                        q = x - M; x < o && q < s && e.charAt(x) === t.charAt(q); ) x++, q++;
                                        if (c[w] = x, x > o) g += 2; else if (q > s) m += 2; else if (h && (y = a + p - M, 
                                        y >= 0 && y < l && f[y] !== -1 && (E = o - f[y], x >= E))) return this.diffBisectSplit(e, t, x, q, i);
                                    }
                                    for (C = -T + v; C <= T - b; C += 2) {
                                        for (y = a + C, E = C === -T || C !== T && f[y - 1] < f[y + 1] ? f[y + 1] : f[y - 1] + 1, 
                                        k = E - C; E < o && k < s && e.charAt(o - E - 1) === t.charAt(s - k - 1); ) E++, 
                                        k++;
                                        if (f[y] = E, E > o) b += 2; else if (k > s) v += 2; else if (!h && (w = a + p - C, 
                                        w >= 0 && w < l && c[w] !== -1 && (x = c[w], q = a + x - w, E = o - E, x >= E))) return this.diffBisectSplit(e, t, x, q, i);
                                    }
                                }
                                return [ [ n, e ], [ r, t ] ];
        ...
        !function(o, s) {
            ...
            function p(p, v, b) {
                ...
                function w(e) {
                    ...
                    var t = [];
                    return e.message && t.push(e.message), y("showExpectationOnFailure") && !s(e) && (c(t, "expected", e.expected, I), 
                    c(t, "got", e.actual, I)), f(y("showTestNameOnFailure"), t, "test", e.name, l), 
                ...
                var k = p, T = {}, M = function(e, t) {
                    ...
                    t(b[e]));
                }, C = [ "moduleStart", "testStart", "log", "testDone", "done" ], S = {}, I = function() {
                ...
                T.explain = I, T.note = function(e) {
                    ...
                    "undefined" != typeof k.config && q(0 === arguments.length ? C : m.apply(arguments));
                }, function() {
                    var e, t, n, r = g(k);
