!function(e) {
	 ...
	 */
        !function(e) {
            ...
            function b() {
                z.blocking = !0, z.testTimeout && A.setTimeout && (L(z.timeout), z.timeout = D(function() {
                    if (!z.current) throw new Error("Test timed out");
                    z.current.semaphore = 0, Q.pushFailure("Test timed out", d(2)), y();
                }, z.testTimeout));
            }
            function y() {
                $ = !0, A.setTimeout ? D(function() {
                    z.current && z.current.semaphore > 0 || (z.timeout && L(z.timeout), g());
                }, 13) : g();
            }
            function w() {
                var e, t;
            ...
            if (U) {
                ...
                QUnit.config.urlConfig.push({
                    ...
                    L && "complete" === j.readyState ? QUnit.load() : n(window, "load", QUnit.load), 
                    QUnit.diff = function() {
                        function e() {}
                        var n = -1, r = 1, i = 0;
