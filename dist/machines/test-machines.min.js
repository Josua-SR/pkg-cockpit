!function(e) {
    ...
    10: function(e, t, n) {
        ...
        var E = n(11), k = r(E), T = n(9), M = r(T), C = k.default.gettext, S = t.units = {
            B: {
                name: "B",
                base1024Exponent: 0
            },
    ...
    62: function(e, t, n) {
        "use strict";
        !function() {
            window.QUnit = n(63), window.qunitTap = n(65), n(66), n(67), e.exports = window.QUnit;
        }();
    },
    63: function(e, t, n) {
        var r;
	 ...
	 */
            !function(e) {
                ...
                function g() {
                    var e, t, n = [];
                    if (!z.started) {
                        for (z.started = D(), m(), "" === z.modules[0].name && 0 === z.modules[0].tests.length && z.modules.shift(), 
                ...
                function v(e) {
                    ...
                    for (z.depth = (z.depth || 0) + 1; z.queue.length && !z.blocking; ) {
                        if (!(!R.setTimeout || z.updateRate <= 0 || D() - n < z.updateRate)) {
                            O(t, 13);
                            break;
                        }
                ...
                function b() {
                    z.blocking = !0, z.testTimeout && R.setTimeout && (L(z.timeout), z.timeout = O(function() {
                ...
                function w() {
                    ...
                    z.autorun = !0, z.previousModule && h("moduleDone", {
                        ...
                        runtime: D() - z.moduleStats.started
                    }), delete z.previousModule, e = D() - z.started, t = z.stats.all - z.stats.bad, 
                    h("done", {
                        failed: z.stats.bad,
                        passed: t,
                        total: z.stats.all,
                ...
                q.count = 0, q.prototype = {
                    ...
                    run: function() {
                        ...
                        var t;
                        if (z.current = this, this.async && Q.stop(), this.callbackStarted = D(), z.notrycatch) return void e(this);
                        try {
                            e(this);
                        } catch (e) {
                    ...
                    finish: function() {
                        ...
                        var e, t = 0;
                        for (this.runtime = D() - this.started, z.stats.all += this.assertions.length, z.moduleStats.all += this.assertions.length, 
