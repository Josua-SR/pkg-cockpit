!function(e) {
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.toGigaBytes = i, t.toKiloBytes = o, t.isEmpty = s, t.arrayEquals = u, t.logDebug = a, 
    t.rephraseUI = l, t.toFixedPrecision = c;
    var f = n(17), d = r(f), p = n(15), h = r(p), m = d.default.gettext, g = {
        autostart: {
            disable: m("disabled"),
            enable: m("enabled")
        },
    ...
    "use strict";
    !function() {
        window.QUnit = n(36), window.qunitTap = n(39), n(40), n(41), e.exports = window.QUnit;
    }();
}, function(e, t, n) {
    var r;
    (function(e, i) {
	 ...
	 */
        !function(e) {
            ...
            function m() {
                var t, n;
                for (t in K) Q[t] !== K[t] && (n = Q[t], Q[t] = K[t], Q[t](n), e.console && e.console.warn && e.console.warn("QUnit." + t + " was replaced with a new value.\nPlease, check out the documentation on how to apply logging callbacks.\nReference: https://api.qunitjs.com/category/callbacks/"));
            }
            function g() {
                var e, t, n = [];
                if (!z.started) {
                    for (z.started = O(), m(), "" === z.modules[0].name && 0 === z.modules[0].tests.length && z.modules.shift(), 
            ...
            function v(e) {
                ...
                for (z.depth = (z.depth || 0) + 1; z.queue.length && !z.blocking; ) {
                    if (!(!A.setTimeout || z.updateRate <= 0 || O() - n < z.updateRate)) {
                        L(t, 13);
                        break;
                    }
                    z.current && (z.current.usedAsync = !1), z.queue.shift()();
                }
                z.depth--, !e || z.blocking || z.queue.length || 0 !== z.depth || w();
            }
            function b() {
                z.blocking = !0, z.testTimeout && A.setTimeout && (D(z.timeout), z.timeout = L(function() {
                    if (!z.current) throw new Error("Test timed out");
                    z.current.semaphore = 0, Q.pushFailure("Test timed out", d(2)), y();
                }, z.testTimeout));
            }
            function y() {
                $ = !0, A.setTimeout ? L(function() {
                    z.current && z.current.semaphore > 0 || (z.timeout && D(z.timeout), g());
                }, 13) : g();
            }
            function w() {
                var e, t;
            ...
            function q(e) {
                ...
                this.testId = E(this.module.name, this.testName), this.module.tests.push({
                    name: this.testName,
                    testId: this.testId
                }), e.skip ? (this.callback = function() {}, this.async = !1, this.expected = 0) : this.assert = new j(this);
            }
            function E(e, t) {
            ...
            function k(e, t, n) {
                var r, i = !t;
                if ("array" !== Q.objectType(e)) t ? z.queue.splice(J++, 0, e) : n ? (V || (V = T(n)), 
                r = Math.floor(V() * (z.queue.length - J + 1)), z.queue.splice(J + r, 0, e)) : z.queue.push(e), 
                z.autorun && !z.blocking && v(i); else for (;e.length; ) k(e.shift());
            }
            function T(e) {
            ...
            function M() {
                if (z.pollution = [], z.noglobals) for (var t in e) if (G.call(e, t)) {
            ...
            function S() {
                ...
                M(), e = o(z.pollution, n), e.length > 0 && Q.pushFailure("Introduced global variable(s): " + e.join(", ")), 
                t = o(n, z.pollution), t.length > 0 && Q.pushFailure("Deleted global variable(s): " + t.join(", "));
            }
            function C(e, t, n) {
            ...
            function I(e, t, n, r) {
                var i;
                W || (Q.config.queue.length = 0, W = !0, 2 === arguments.length && (n = t, t = null), 
                i = new q({
                    testName: e,
                    expected: t,
                    async: r,
            ...
            var Q = {}, N = e.Date, O = N.now || function() {
                return new N().getTime();
            }, L = e.setTimeout, D = e.clearTimeout, R = e.window, A = {
            ...
            }, H = (d(0) || "").replace(/(:\d+)+\)?/, "").replace(/.+\//, ""), B = !1, $ = !1, _ = Object.prototype.toString, G = Object.prototype.hasOwnProperty, z = {
                queue: [],
                blocking: !0,
                reorder: !0,
                altertitle: !0,
            ...
            }(), Q.isLocal = !(A.document && "file:" !== R.location.protocol), Q.version = "1.23.1", 
            a(Q, {
                module: function(e, t, n) {
                    function r() {
                        ...
                        a(o, t), i.testEnvironment = o, z.modules.push(i), i;
                    }
                    function i(e) {
                        z.currentModule = e;
                    }
                    var o, s, u = z.currentModule;
                    ...
                    }, "function" === l(n) && (z.moduleStack.push(o), i(o), n.call(o.testEnvironment, s), 
                    z.moduleStack.pop(), o = o.parentModule || u), i(o);
                },
                asyncTest: C,
                test: U,
                skip: F,
                ...
                start: function(e) {
                    ...
                    if (z.current) {
                        ...
                        if (z.current.semaphore < 0) return z.current.semaphore = 0, void Q.pushFailure("Called start() while already started (test's semaphore was 0 already)", d(2));
                    } else {
                        if (B = !0, $) throw new Error("Called start() outside of a test context while already started");
            ...
            q.count = 0, q.prototype = {
                before: function() {
                    this.module === z.previousModule && G.call(z, "previousModule") || (G.call(z, "previousModule") && h("moduleDone", {
                        name: z.previousModule.name,
                        tests: z.previousModule.tests,
                        failed: z.moduleStats.bad,
                        passed: z.moduleStats.all - z.moduleStats.bad,
                ...
                run: function() {
                    ...
                    var t;
                    if (z.current = this, this.async && Q.stop(), this.callbackStarted = O(), z.notrycatch) return void e(this);
                    try {
                        e(this);
                    } catch (e) {
                        this.pushFailure("Died on test #" + (this.assertions.length + 1) + " " + this.stack + ": " + (e.message || e), f(e, 0)), 
                        M(), z.blocking && Q.start();
                    }
                },
                after: function() {
                    S();
                ...
                queue: function() {
                    ...
                    var t, n = this;
                    if (this.valid()) return t = Q.config.reorder && A.sessionStorage && +sessionStorage.getItem("qunit-test-" + this.module.name + "-" + this.testName), 
                    k(e, t, z.seed);
                },
                ...
                valid: function() {
                    ...
                    return !(!this.callback || !this.callback.validTest) || !(z.moduleId && z.moduleId.length > 0 && !t(this.module)) && (!(z.testId && z.testId.length > 0 && s(this.testId, z.testId) < 0) && (!(i && !e(this.module)) && (!n || (r ? this.regexFilter(!!r[1], r[2], r[3], o) : this.stringFilter(n, o)))));
                },
                ...
                push: function(e, t, n, r, i) {
                    var o = this instanceof j ? this : Q.config.current.assert;
                    return o.pushResult({
                        result: e,
                        actual: t,
                        expected: n,
                ...
                pushResult: function(e) {
                    var t = this, n = t instanceof j && t.test || Q.config.current;
                    ...
                    t instanceof j || (t = n.assert), t.test.pushResult(e);
                },
                ok: function(e, t) {
                ...
                throws: function(e, t, n) {
                    var r, i, o = t, s = !1, u = this instanceof j && this.test || Q.config.current;
                    ...
                    u.ignoreGlobalErrors = !1, r && (i = Q.objectType(t), t ? "regexp" === i ? s = t.test(P(r)) : "string" === i ? s = t === P(r) : "function" === i && r instanceof t ? s = !0 : "object" === i ? s = r instanceof t.constructor && r.name === t.name && r.message === t.message : "function" === i && t.call({}, r) === !0 && (o = null, 
                ...
                for (e = 0, t = n.length; e < t; e++) R[n[e]] = Q[n[e]];
            }(), R.QUnit = Q), "undefined" != typeof i && i && i.exports && (i.exports = Q, 
            ...
            function n(e, t, n) {
                e.addEventListener ? e.addEventListener(t, n, !1) : e.attachEvent && e.attachEvent("on" + t, function() {
                    var t = window.event;
                    t.target || (t.target = t.srcElement || j), n.call(e, t);
                });
            }
            function r(e, t, r) {
            ...
            function h() {
                var e = j.createElement("form"), t = j.createElement("label"), r = j.createElement("input"), i = j.createElement("button");
            ...
            function m() {
                ...
                e = 0; e < L.length; e++) n += "<option value='" + t(encodeURIComponent(L[e])) + "' " + (QUnit.urlParams.module === L[e] ? "selected='selected'" : "") + ">" + t(L[e]) + "</option>";
                return n += "</select>";
            }
            function g() {
                var e = a("qunit-testrunner-toolbar"), t = j.createElement("span"), r = m();
            ...
            function w() {
                ...
                t && t.parentNode.removeChild(t), e && (e.innerHTML = "", t = j.createElement("p"), 
            ...
            function E() {
                ...
                e && (e.innerHTML = "", e.appendChild(j.createTextNode("QUnit " + QUnit.version + "; " + navigator.userAgent)));
            }
            function k() {
                var e = a("qunit");
                e && (e.innerHTML = "<h1 id='qunit-header'>" + t(j.title) + "</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar'></div>" + q() + "<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"), 
                b(), y(), w(), E(), v();
            }
            function T(e) {
                var t, n, r, i, o, s;
            ...
            function M(e, t, n) {
                ...
                u && (r = j.createElement("strong"), r.innerHTML = S(e, n), i = j.createElement("a"), 
                i.innerHTML = "Rerun", i.href = f({
                    testId: t
                }), o = j.createElement("li"), o.appendChild(r), o.appendChild(i), o.id = "qunit-test-output-" + t, 
            ...
            if (U) {
                ...
                QUnit.config.urlConfig.push({
                    ...
                    var I = QUnit.config, j = window.document, P = !1, Q = Object.prototype.hasOwnProperty, N = f({
                        filter: void 0,
                        module: void 0,
                        moduleId: void 0,
                        testId: void 0
                    ...
                    QUnit.begin(function(e) {
                        var t, n, r;
                        for (t = 0; t < e.modules.length; t++) n = e.modules[t], n.name && L.push(n.name);
                        L.sort(function(e, t) {
                        ...
                        I.altertitle && j.title && (j.title = [ e.failed ? "✖" : "✔", j.title.replace(/^[\u2714\u2716] /i, "") ].join(" ")), 
                        I.reorder && O.sessionStorage && 0 === e.failed) for (t = 0; t < sessionStorage.length; t++) n = sessionStorage.key(t++), 
                        ...
                        t = a("qunit-testresult"), t && (r = QUnit.config.reorder && O.sessionStorage && +sessionStorage.getItem("qunit-test-" + e.module + "-" + e.name), 
                        ...
                        n = c.getElementsByTagName("ol")[0], r = j.createElement("li"), r.className = e.result ? "pass" : "fail", 
                        ...
                        l = e.passed, c = e.failed, I.reorder && O.sessionStorage && (c ? sessionStorage.setItem("qunit-test-" + e.module + "-" + e.name, c) : sessionStorage.removeItem("qunit-test-" + e.module + "-" + e.name)), 
                        0 === c ? o(u, "qunit-collapsed") : c && I.collapse && !P ? P = !0 : o(u, "qunit-collapsed"), 
                        ...
                        r.innerHTML = e.runtime + " ms", i.insertBefore(r, u)), e.source && (p = j.createElement("p"), 
                    ...
                    D && "complete" === j.readyState ? QUnit.load() : n(window, "load", QUnit.load), 
                    QUnit.diff = function() {
                        function e() {}
                        var n = -1, r = 1, i = 0;
                        return e.prototype.DiffMain = function(e, t, n) {
                            ...
                            var o, s, u, a, l, c, f, d, p, h, m, g, v, b, y, w, x, q, E, k, T, M, S;
                            ...
                            b = 0, T = 0; T < u && !(new Date().getTime() > i); T++) {
                                ...
                                for (S = -T + v; S <= T - b; S += 2) {
                                    for (y = a + S, q = S === -T || S !== T && f[y - 1] < f[y + 1] ? f[y + 1] : f[y - 1] + 1, 
                                    k = q - S; q < o && k < s && e.charAt(o - q - 1) === t.charAt(s - k - 1); ) q++, 
                                    k++;
                                    if (f[y] = q, q > o) b += 2; else if (k > s) v += 2; else if (!h && (w = a + p - S, 
    ...
    !function(o, s) {
        ...
        function p(p, v, b) {
            ...
            function q(e) {
                var r;
                t(S, e) !== -1 && (r = k.config[e], "undefined" != typeof r && n(r, C[e]));
            }
            function E(e) {
                var t;
            ...
            var k = p, T = {}, M = function(e, t) {
                ...
                t(b[e]));
            }, S = [ "moduleStart", "testStart", "log", "testDone", "done" ], C = {}, U = function() {
            ...
            T.explain = U, T.note = function(e) {
                ...
                "undefined" != typeof k.config && E(0 === arguments.length ? S : m.apply(arguments));
            }, function() {
                var e, t, n, r = g(k);
                for (t = 0; t < S.length; t += 1) e = S[t], n = r(k, T, e), C[e] = n;
            }(), T;
        }
