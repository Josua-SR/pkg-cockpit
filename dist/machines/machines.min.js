!function(t) {
    ...
    var o = n(10), s = i(o), c = n(11), u = i(c), l = n(19), d = i(l), h = n(21), f = n(16), p = n(64), g = i(p), m = n(23);
}, function(t, e, n) {
    "use strict";
    ...
    function l(t, e) {
        switch (t = t ? t : [], e.type) {
          case "UPDATE_OS_INFO_LIST":
            return e.osInfoList instanceof Array ? [].concat(a(e.osInfoList)) : t;
    ...
    function d(t, e) {
        switch (t = t ? t : {
          ...
          case "VM_CREATE_IN_PROGRESS":
            return t.vmsCreated = Object.assign({}, t.vmsCreated, r({}, e.vm.name, e.vm)), t;

          case "VM_CREATE_COMPLETED":
            return delete t.vmsCreated[e.vm.name], t;

          case "VM_INSTALL_IN_PROGRESS":
            return t.vmsInstallInitiated = Object.assign({}, t.vmsInstallInitiated, r({}, e.vm.name, e.vm)), 
            t;

          case "VM_INSTALL_COMPLETED":
            return delete t.vmsInstallInitiated[e.vm.name], t;

          case "ADD_NOTIFICATION":
            var n = "string" == typeof e.notification ? {
                message: e.notification
            } : e.notification, i = t.notifications;
            return n.id = i.length > 0 ? i[i.length - 1].id + 1 : 1, n.type || (n.type = "info"), 
            t.notifications = [].concat(a(i), [ n ]), t;
    ...
    var r = n(10), a = i(r), o = n(20), s = i(o), c = function(t) {
        var e = t.store, n = e.getState(), i = n.vms, r = n.config, o = n.osInfoList, c = n.ui, u = e.dispatch;
    ...
    var s = function() {
    ...
    }(), c = n(17), u = i(c), l = n(10), d = i(l), h = n(21), f = n(16), p = n(24), g = i(p), m = n(28), v = n(31), y = i(v), x = n(39), _ = i(x), b = n(40), w = i(b), S = n(50), T = n(53), A = i(T), E = n(55), C = n(60), P = i(C), k = n(63), M = i(k), L = u.default.gettext, O = function(t) {
        var e = t.vm, n = t.config, i = t.dispatch, r = t.onStart, a = t.onInstall, o = t.onReboot, s = t.onForceReboot, c = t.onShutdown, u = t.onForceoff, l = t.onSendNMI, h = t.installInProgress, p = (0, 
        f.vmId)(e.name), g = e.state, m = e.metadata.hasInstallPhase, v = null;
        n.provider.canReset(g) && (v = (0, A.default)({
            buttons: [ {
                title: L("Restart"),
                action: o,
                id: p + "-reboot"
            }, {
                title: L("Force Restart"),
                action: s,
                id: p + "-forceReboot"
            } ]
        }));
        var y = null;
        if (n.provider.canShutdown(g)) {
            var x = [ {
                title: L("Shut Down"),
                action: c,
                id: p + "-off"
            }, {
                title: L("Force Shut Down"),
                action: u,
                id: p + "-forceOff"
            } ];
            n.provider.canSendNMI && n.provider.canSendNMI(g) && x.push({
                title: L("Send Non-Maskable Interrupt"),
                action: l,
                id: p + "-sendNMI"
            }), y = (0, A.default)({
                buttons: x
        ...
        var _ = null;
        n.provider.canRun(g, m) && (_ = d.default.createElement("button", {
            className: "btn btn-default btn-danger",
            onClick: (0, f.mouseClick)(r),
            id: p + "-run"
        }, L("Run")));
        var b = null;
        n.provider.canInstall(g, m, h) && (b = d.default.createElement("button", {
            className: "btn btn-default btn-danger",
            onClick: (0, f.mouseClick)(a),
            id: p + "-install"
        }, L("Install")));
        var w = null;
        if (n.provider.VmActions) {
            var T = n.provider.VmActions;
            w = d.default.createElement(T, {
                vm: e,
        ...
        var E = null;
        return void 0 !== g && n.provider.canDelete && n.provider.canDelete(g, e.id, n.providerState) && (E = d.default.createElement("button", {
            className: "btn btn-danger",
            id: p + "-delete",
            onClick: (0, f.mouseClick)(function() {
                return (0, S.deleteDialog)(e, i);
            })
        }, L("Delete"))), d.default.createElement("div", null, v, y, _, b, w, E);
    };
    O.propTypes = {
        vm: l.PropTypes.object.isRequired,
        config: l.PropTypes.string.isRequired,
        dispatch: l.PropTypes.func.isRequired,
        onStart: l.PropTypes.func.isRequired,
        onReboot: l.PropTypes.func.isRequired,
        onForceReboot: l.PropTypes.func.isRequired,
        onShutdown: l.PropTypes.func.isRequired,
        onForceoff: l.PropTypes.func.isRequired,
        onSendNMI: l.PropTypes.func.isRequired
    };
    var N = function(t) {
        ...
        return d.default.createElement("span", {
            ...
            "data-toggle": "tooltip",
            "data-placement": "left"
        }, r, " ", d.default.createElement("i", {
            onClick: (0, f.mouseClick)(e),
            className: n
        }));
    };
    N.propTypes = {
        ...
        state: l.PropTypes.string.isRequired
    };
    var I = e.StateIcon = function(t) {
        var e = t.state, n = t.config, i = t.valueId, r = t.extra;
        if (void 0 === e) return d.default.createElement("div", null);
        var a = {
            running: {
                className: "pficon pficon-ok icon-1x-vms",
                title: L("The VM is running.")
            },
            idle: {
                className: "pficon pficon-running icon-1x-vms",
                title: L("The VM is idle.")
            },
            paused: {
                className: "pficon pficon-pause icon-1x-vms",
                title: L("The VM is paused.")
            },
            shutdown: {
                className: "glyphicon glyphicon-wrench icon-1x-vms",
                title: L("The VM is going down.")
            },
            "shut off": {
                className: "fa fa-arrow-circle-o-down icon-1x-vms",
                title: L("The VM is down.")
            },
            crashed: {
                className: "pficon pficon-error-circle-o icon-1x-vms",
                title: L("The VM crashed.")
            },
            dying: {
                className: "pficon pficon-warning-triangle-o icon-1x-vms",
                title: L("The VM is in process of dying (shut down or crash is not completed).")
            },
            pmsuspended: {
                className: "pficon pficon-ok icon-1x-vms",
                title: L("The VM is suspended by guest power management.")
            }
        };
        return n.provider.vmStateMap && (a = Object.assign(a, n.provider.vmStateMap)), a[e] ? d.default.createElement("span", {
            title: a[e].title,
            "data-toggle": "tooltip",
            "data-placement": "left"
        }, r, d.default.createElement("span", {
            id: i
        }, (0, f.rephraseUI)("vmStates", e))) : d.default.createElement("small", null, e);
    };
    I.propTypes = {
        state: l.PropTypes.string.isRequired,
        config: l.PropTypes.string.isRequired,
        valueId: l.PropTypes.string,
        extra: l.PropTypes.any
    };
    var R = function(t) {
        function e() {
        ...
        return o(e, t), s(e, [ {
            ...
            value: function() {
                ...
                s = isNaN(s) ? 0 : s, s = (0, f.toFixedPrecision)(s, 1), (0, f.logDebug)("VmUsageTab.render(): rssMem: " + i + " KiB, memTotal: " + r + " KiB, available: " + a + " KiB, totalCpus: " + o + ", cpuUsage: " + s);
                var c = {
                    columns: [ [ L("Used"), (0, f.toReadableNumber)((0, f.convertToUnit)(i, f.units.KiB, f.units.GiB)) ], [ L("Available"), (0, 
                    f.toReadableNumber)((0, f.convertToUnit)(a, f.units.KiB, f.units.GiB)) ] ],
                    groups: [ [ "used", "available" ] ],
                    order: null
                }, l = {
                    columns: [ [ L("Used"), s ], [ L("Available"), 100 - s ] ],
                    groups: [ [ "used", "available" ] ],
                    order: null
                }, h = {
                    width: e,
                ...
                return d.default.createElement("table", null, d.default.createElement("tr", null, d.default.createElement("td", null, d.default.createElement(g.default, {
                    data: c,
                    size: h,
                    width: "8",
                    tooltipText: " ",
                    primaryTitle: (0, f.toReadableNumber)((0, f.convertToUnit)(i, f.units.KiB, f.units.GiB)),
                    secondaryTitle: "GiB",
                    caption: "used from " + u.default.format_bytes(1024 * r) + " memory"
                })), d.default.createElement("td", null, d.default.createElement(g.default, {
                    data: l,
                    size: h,
                    width: "8",
                    tooltipText: " ",
    ...
    var V = function(t) {
        var e = t.vm, n = t.config, i = t.hostDevices, r = t.onStart, a = t.onInstall, o = t.onShutdown, s = t.onForceoff, c = t.onReboot, u = t.onForceReboot, l = t.onUsageStartPolling, h = t.onUsageStopPolling, p = t.onSendNMI, g = t.uiState, v = t.dispatch, x = e.lastMessage && d.default.createElement("span", {
            className: "pficon-warning-triangle-o machines-status-alert"
        }), b = d.default.createElement(I, {
            state: e.state,
            config: n,
            valueId: (0, f.vmId)(e.name) + "-state",
            extra: x
        }), S = d.default.createElement("div", {
            id: (0, f.vmId)(e.name) + "-usage"
        }, L("Usage")), T = d.default.createElement("div", {
            id: (0, f.vmId)(e.name) + "-disks"
        }, L("Disks")), A = d.default.createElement("div", {
            id: (0, f.vmId)(e.name) + "-networks"
        }, L("Networks")), E = d.default.createElement("div", {
            id: (0, f.vmId)(e.name) + "-consoles"
        }, L("Consoles")), C = [ {
            name: L("Overview"),
            renderer: P.default,
            data: {
        ...
        n.provider.vmTabRenderers && (C = C.concat(n.provider.vmTabRenderers.map(function(t) {
            var i = t.name;
            return t.idPostfix && (i = d.default.createElement("div", {
                id: (0, f.vmId)(e.name) + "-" + t.idPostfix
            }, t.name)), {
                name: i,
        ...
        var k = g && g.createInProgress, M = null;
        g && g.createInProgress && g.createInProgress.openConsoleTab && (M = C.map(function(t) {
            return t.name;
        }).indexOf(E));
        var N = d.default.createElement("span", {
            id: (0, f.vmId)(e.name) + "-row"
        }, e.name);
        return d.default.createElement(m.ListingRow, {
            rowId: "" + (0, f.vmId)(e.name),
            columns: [ {
                name: N,
                header: !0
            }, (0, f.rephraseUI)("connections", e.connectionName), b ],
            initiallyExpanded: k,
            initiallyActiveTab: M,
            tabRenderers: C,
            listingActions: O({
                vm: e,
                config: n,
                ...
                onForceoff: s,
                onSendNMI: p,
                installInProgress: !!g.installInProgress
            })
        });
    };
    V.propTypes = {
        vm: l.PropTypes.object.isRequired,
        config: l.PropTypes.object.isRequired,
        hostDevices: l.PropTypes.object.isRequired,
        onStart: l.PropTypes.func.isRequired,
        onShutdown: l.PropTypes.func.isRequired,
        onForceoff: l.PropTypes.func.isRequired,
        onReboot: l.PropTypes.func.isRequired,
        ...
        onUsageStartPolling: l.PropTypes.func.isRequired,
        onUsageStopPolling: l.PropTypes.func.isRequired,
        onSendNMI: d.default.PropTypes.func.isRequired,
        dispatch: l.PropTypes.func.isRequired,
        initallyExpanded: l.PropTypes.bool
    };
    var D = function(t) {
        function e(t) {
            r(this, e);
        ...
        return o(e, t), s(e, [ {
            ...
            key: "render",
            value: function() {
                var t = this, e = this.props, n = e.vms, i = e.config, r = e.osInfoList, a = e.ui, o = e.dispatch, s = e.actions, c = function(t, e) {
                    return t.name.localeCompare(e.name);
                }, u = [ d.default.createElement("a", {
                    className: "card-pf-link-with-icon pull-right",
                    id: "create-new-vm",
                    onClick: (0, f.mouseClick)(function() {
                        return (0, E.createVmDialog)(o, r);
                    })
                }, d.default.createElement("span", {
                    className: "pficon pficon-add-circle-o"
                }), L("Create New VM")) ];
                return s && (u = u.concat(s)), d.default.createElement("div", {
                    className: "container-fluid"
                }, d.default.createElement(M.default, {
                    id: "notification-area",
                    notifications: a.notifications,
                    onDismiss: function(t) {
                        return o((0, h.clearNotification)(t));
                    }
                }), d.default.createElement(m.Listing, {
                    title: L("Virtual Machines"),
                    columnTitles: [ L("Name"), L("Connection"), L("State") ],
                    actions: u,
                    emptyCaption: L("No VM is running or defined on this host")
                }, n.sort(c).map(function(e) {
                    return d.default.createElement(V, {
                        vm: e,
                        config: i,
                        hostDevices: t.deviceProxies,
                        onStart: function() {
                            return o((0, h.startVm)(e));
                        },
                        onInstall: function() {
                            return o((0, h.installVm)(e));
                        },
                        onReboot: function() {
                            return o((0, h.rebootVm)(e));
                        },
                        onForceReboot: function() {
                            return o((0, h.forceRebootVm)(e));
                        },
                        onShutdown: function() {
                            return o((0, h.shutdownVm)(e));
                        },
                        onForceoff: function() {
                            return o((0, h.forceVmOff)(e));
                        },
                        onUsageStartPolling: function() {
                            return o((0, h.usageStartPolling)(e));
                        },
                        onUsageStopPolling: function() {
                            return o((0, h.usageStopPolling)(e));
                        },
                        onSendNMI: function() {
                            return o((0, h.sendNMI)(e));
                        },
                        dispatch: o,
                        uiState: {
                            createInProgress: a.vmsCreated[e.name],
                            installInProgress: a.vmsInstallInitiated[e.name]
                        },
                        key: "" + (0, f.vmId)(e.name)
                    });
                })));
    ...
    D.propTypes = {
        vms: l.PropTypes.array.isRequired,
        config: l.PropTypes.object.isRequired,
        osInfoList: l.PropTypes.array.isRequired,
        ui: l.PropTypes.object.isRequired,
        dispatch: l.PropTypes.func.isRequired
    }, e.default = D;
}, function(t, e, n) {
    "use strict";
    ...
    function r(t) {
        return (0, H.virt)("GET_ALL_VMS", {
            connectionName: t
        });
    }
    function a(t, e) {
        return (0, H.virt)("GET_VM", {
            lookupId: e,
            connectionName: t
        });
    }
    function o() {
        return (0, H.virt)("GET_OS_INFO_LIST");
    }
    function s(t) {
        return (0, H.virt)("SHUTDOWN_VM", {
            name: t.name,
            id: t.id,
    ...
    function l(t) {
        return (0, H.virt)("FORCEREBOOT_VM", {
            name: t.name,
            id: t.id,
            connectionName: t.connectionName
        });
    ...
    function f(t) {
        return (0, H.virt)("INSTALL_VM", t);
    }
    function p(t) {
        return (0, H.virt)("CREATE_VM", t);
    }
    function g(t, e) {
        return (0, H.virt)("CONSOLE_VM", {
            name: t.name,
            id: t.id,
            connectionName: t.connectionName,
            consoleDetail: e
    ...
    function m(t) {
        return (0, H.virt)("USAGE_START_POLLING", {
            name: t.name,
            id: t.id,
            connectionName: t.connectionName
        });
    ...
    function v(t) {
        return (0, H.virt)("USAGE_STOP_POLLING", {
            name: t.name,
            id: t.id,
            connectionName: t.connectionName
        });
    ...
    function x(t, e, n) {
        return (0, H.virt)("CHANGE_NETWORK_STATE", {
            name: t.name,
            networkMac: e,
            state: n,
            connectionName: t.connectionName
    ...
    function _(t, e) {
        return function(n, i) {
            e = e || (0, U.getRefreshInterval)(i()), e > 0 && !F.default.hidden ? ((0, B.logDebug)("Scheduling " + e + " ms delayed action"), 
            window.setTimeout(function() {
                (0, B.logDebug)("Executing delayed action"), n(t);
            }, e)) : window.setTimeout(function() {
                return n(_(t, e));
            }, z.default.DefaultRefreshInterval);
        };
    }
    function b(t) {
        return {
    ...
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.getAllVms = r, e.getVm = a, e.getOsInfoList = o, e.shutdownVm = s, e.forceVmOff = c, 
    e.rebootVm = u, e.forceRebootVm = l, e.startVm = d, e.deleteVm = h, e.installVm = f, 
    e.createVm = p, e.vmDesktopConsole = g, e.usageStartPolling = m, e.usageStopPolling = v, 
    e.sendNMI = y, e.changeNetworkState = x, e.delayPolling = _, e.setProvider = b, 
    e.setRefreshInterval = w, e.updateOrAddVm = S, e.updateVm = T, e.updateOsInfoList = A, 
    e.vmCreateInProgress = E, e.vmCreateCompleted = C, e.vmInstallInProgress = P, e.vmInstallCompleted = k, 
    e.addErrorNotification = M, e.addNotification = L, e.clearNotification = O, e.clearNotifications = N, 
    e.vmActionFailed = I, e.deleteVmMessage = R, e.undefineVm = V, e.deleteUnlistedVMs = D;
    var G = n(17), F = i(G), U = n(22), j = n(15), z = i(j), B = n(16), H = n(23);
}, function(t, e) {
    "use strict";
    function n(t) {
    ...
    }(), c = n(25), u = i(c), l = n(10), d = i(l), h = n(26), f = i(h), p = n(16), g = 0, m = function(t) {
        function e(t) {
            r(this, e);
            var n = a(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t));
    ...
    !function(e, n) {
        ...
        function r(t) {
            var e = this;
            e.d3 = window.d3 ? window.d3 : n(27), e.api = t, e.config = e.getDefaultConfig(), 
    ...
    }(), c = n(10), u = i(c), l = n(17), d = i(l), h = n(16), f = n(32), p = i(f), g = n(37), m = i(g);
    u.default;
    ...
    var r = n(10), a = i(r), o = n(17), s = i(o), c = n(28), u = n(33), l = n(16);
    a.default;
    ...
    }(), c = n(17), u = i(c), l = n(10), d = i(l), h = n(16), f = n(34);
    n(36);
    ...
    var r = n(10), a = i(r), o = n(17), s = i(o), c = n(38), u = i(c);
    a.default;
    ...
    var r = n(10), a = i(r), o = n(17), s = i(o), c = n(21), u = n(16), l = n(28), d = s.default.gettext, h = function(t) {
    ...
    }(), c = n(10), u = i(c), l = n(17), d = i(l), h = n(41), f = i(h), p = n(43), g = i(p), m = n(48), v = i(m), y = n(49), x = i(y), _ = n(16), b = n(21), w = d.default.gettext, S = function() {
    ...
    }(), c = n(10), u = i(c), l = n(17), d = i(l), h = n(44), f = d.default.gettext, p = function(t) {
        function e(t) {
            r(this, e);
            var n = a(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t));
            return n.state = {
    ...
    var a = n(17), o = i(a), s = n(10), c = i(s), u = n(51), l = n(21);
    n(52);
    ...
    }(), l = n(17), d = i(l), h = n(10), f = i(h), p = n(51), g = i(p), m = n(41), v = i(m), y = n(56), x = i(y), _ = n(21), b = n(16), w = n(58);
    n(59);
    ...
    var a = n(17), o = i(a), s = n(10), c = i(s), u = n(61), l = i(u), d = n(62), h = i(d), f = n(16), p = o.default.gettext;
    c.default;
    var g = function(t) {
    ...
    var r = n(10), a = i(r), o = n(16), s = n(21), c = n(33);
    a.default;
    var u = function(t) {
    ...
    function l(t, e) {
        var n = $.default.Virsh.connections[e];
        return (0, H.spawnScript)({
            script: "virsh " + n.params.join(" ") + " -r list --all | awk '$1 == \"-\" || $1+0 > 0 { print $2 }'"
        }).then(function(n) {
            var i = n.trim().split(/\r?\n/);
            return i.forEach(function(t, e) {
                i[e] = t.trim();
            }), (0, X.logDebug)("GET_ALL_VMS: vmNames: " + JSON.stringify(i)), t((0, z.deleteUnlistedVMs)(e, i)), 
            N.default.all(i.map(function(n) {
                return t((0, z.getVm)(e, n));
            }));
        });
    }
    function d(t) {
        var e = t.connectionName, n = t.method, i = t.failHandler, r = t.args;
        return (0, H.spawnProcess)({
            cmd: "virsh",
            args: $.default.Virsh.connections[e].params.concat(r),
            failHandler: i
        }).fail(function(t, e, r) {
            var a = n + "() exception: '" + t + "', data: '" + e + "', output: '" + r + "'";
            return i ? void (0, X.logDebug)(a) : void console.warn(a);
        });
    }
    function h(t) {
    ...
    function f(t, e, n) {
        var i = R.default.parseXML(n);
        if (!i) return void console.warn("Can't parse dumpxml, input: \"" + n + '"');
        var r = i.getElementsByTagName("domain")[0], a = r.getElementsByTagName("os")[0], o = r.getElementsByTagName("currentMemory")[0], s = r.getElementsByTagName("vcpu")[0], c = r.getElementsByTagName("cpu")[0], u = s.attributes.getNamedItem("current"), l = r.getElementsByTagName("devices")[0], d = a.getElementsByTagName("type")[0], h = p(r, "metadata"), f = r.getElementsByTagName("name")[0].childNodes[0].nodeValue, v = r.getElementsByTagName("uuid")[0].childNodes[0].nodeValue, b = d.nodeValue, S = d.getAttribute("machine"), T = o.getAttribute("unit"), A = (0, 
        X.convertToUnit)(o.childNodes[0].nodeValue, T, X.units.KiB), E = u && u.value ? u.value : s.childNodes[0].nodeValue, C = g(l), P = y(a, l), k = x(c), M = _(l), L = m(l), O = "true" === w(h, "has_install_phase"), N = w(h, "install_source"), I = w(h, "os_variant"), V = {
            hasInstallPhase: O,
            installSource: N,
            osVariant: I
        };
    ...
    function g(t) {
        ...
        if (n) for (var i = 0; i < n.length; i++) {
            var r = n[i], a = r.getElementsByTagName("target")[0], o = p(r, "driver"), s = p(r, "source"), c = p(r, "serial"), u = p(r, "alias"), l = p(r, "readonly"), d = p(r, "shareable"), h = p(r, "boot"), f = s ? p(s, "host") : void 0, g = {
            ...
            g.target ? (e[g.target] = g, (0, X.logDebug)("parseDumpxmlForDisks(): disk device found: " + JSON.stringify(g))) : console.warn("parseDumpxmlForDisks(): mandatory properties are missing in dumpxml, found: " + JSON.stringify(g));
        }
        return e;
    }
    function m(t) {
        ...
        if (n) for (var i = 0; i < n.length; i++) {
            var r = n[i], a = r.getElementsByTagName("target")[0], o = p(r, "mac"), s = p(r, "model"), c = p(r, "alias"), u = p(r, "source"), l = p(r, "driver"), d = p(r, "virtualport"), h = p(r, "address"), f = p(r, "link"), g = p(r, "mtu"), m = h ? p(h, "local") : null, v = {
                type: r.getAttribute("type"),
    ...
    function v(t) {
        var e = t.tagName, n = W("other");
        switch (e) {
          case "disk":
            n = (0, X.rephraseUI)("bootableDisk", t.getAttribute("device"));
            break;

          case "interface":
            n = (0, X.rephraseUI)("bootableDisk", "interface");
            break;
    ...
    function y(t, e) {
        ...
        if (i.length > 0) {
            for (var r = 0; r < i.length; r++) {
                ...
                o && n.devices.push({
                    order: r,
                    type: (0, X.rephraseUI)("bootableDisk", o)
                });
            }
            return n;
        }
    ...
    function x(t) {
        if (t) {
            ...
            return (0, X.rephraseUI)("cpuMode", e) + (n ? " (" + n + ")" : "");
        }
    }
    function _(t) {
        ...
        if (n) for (var i = 0; i < n.length; i++) {
            ...
            X.logDebug)("parseDumpxmlForConsoles(): graphics device found: " + JSON.stringify(a))) : console.warn("parseDumpxmlForConsoles(): mandatory properties are missing in dumpxml, found: " + JSON.stringify(a));
        }
    ...
    function b(t, e, n, i) {
        ...
        return t(tt.isRunning(s) ? (0, z.updateVm)({
            connectionName: e,
            name: n,
            state: s,
            persistent: u,
    ...
    function w(t, e) {
        if (!t) return null;
        var n = t.getElementsByTagNameNS(K, e);
    ...
    function P(t, e) {
        (0, X.logDebug)("doUsagePolling(" + t + ", " + e + ")");
        var n = function(t) {
        ...
        return function(i, r) {
            return (0, B.usagePollingEnabled)(r(), t, e) ? (i((0, z.delayPolling)(P(t, e), null, t, e)), 
            h({
                connectionName: e,
                method: "dommemstat",
                name: t,
                ...
                n && A(i, e, t, n);
            })) : void (0, X.logDebug)("doUsagePolling(" + t + ", " + e + "): usage polling disabled, stopping loop");
        };
    }
    function k(t, e, n) {
        var i = /event '([a-z-]+)' .* domain ([^:]+)(?:: (.*))?$/, r = i.exec(n);
        if (!r) return void console.warn("Unable to parse event, ignoring:", n);
        var a = r.slice(1), o = L(a, 3), s = o[0], c = o[1], u = o[2];
        switch ((0, X.logDebug)("handleEvent(" + e + "): domain " + c + ": got event " + s + "; details: " + u), 
        s) {
          case "lifecycle":
            var l = u.split(" ")[0];
            switch (l) {
              case "Undefined":
                t((0, z.undefineVm)(e, c));
                break;
              ...
              default:
                (0, X.logDebug)("Unhandled lifecycle event type " + l + " in event: " + n);
            }
            break;
          ...
          default:
            (0, X.logDebug)("handleEvent " + e + " " + c + ": ignoring event " + n);
        }
    }
    function M(t, e) {
        var n = "";
        N.default.spawn([ "virsh" ].concat($.default.Virsh.connections[e].params).concat([ "-r", "event", "--all", "--loop" ]), {
            err: "message",
            pty: !0
        }).stream(function(i) {
            n += i;
            for (var r = n.split("\n"); r.length > 1; ) k(t, e, r.shift().trim());
            n = r[0];
        }).fail(function(n) {
            console.log("virsh event failed:", n), t((0, z.deleteUnlistedVMs)(e, [])), t((0, 
            z.delayPolling)((0, z.getAllVms)(e)));
        });
    }
    Object.defineProperty(e, "__esModule", {
        value: !0
    ...
    var O = n(17), N = i(O), I = n(25), R = i(I), V = n(65), D = i(V), G = n(66), F = i(G), U = n(67), j = i(U), z = n(21), B = n(22), H = n(68), X = n(16), Y = n(69), q = n(15), $ = i(q), W = N.default.gettext, K = "https://github.com/cockpit-project/cockpit/tree/master/pkg/machines", Q = 1e4, Z = 4e3, J = 3e3, tt = {};
    tt = {
        name: "Libvirt",
        init: function(t) {
            return !0;
        ...
        canInstall: function(t, e, n) {
            return "running" != t && e && !n;
        },
        ...
        serialConsoleCommand: function(t) {
            var e = t.vm;
            return !!e.displays.pty && [ "virsh" ].concat(r($.default.Virsh.connections[e.connectionName].params), [ "console", e.name ]);
        },
        GET_VM: function(t) {
            var e = t.lookupId, n = t.connectionName;
            return (0, X.logDebug)(this.name + ".GET_VM()"), function(t) {
                if (!(0, X.isEmpty)(e)) return h({
                    connectionName: n,
                    method: "dumpxml",
                    name: e
                }).then(function(i) {
        ...
        GET_ALL_VMS: function(t) {
            ...
            return (0, X.logDebug)(this.name + ".GET_ALL_VMS(connectionName='" + e + "'):"), 
            e ? function(t) {
                M(t, e), l(t, e), t((0, z.getOsInfoList)());
            } : function(t) {
                return N.default.user().done(function(e) {
                    var n = Object.getOwnPropertyNames($.default.Virsh.connections).filter(function(t) {
                        return u(t, e);
                    }).map(function(e) {
                        return t((0, z.getAllVms)(e));
                    });
                    return N.default.all(n);
                });
            };
        },
        GET_OS_INFO_LIST: function() {
            return (0, X.logDebug)(this.name + ".GET_OS_INFO_LIST():"), function(t) {
                return N.default.script(j.default, null, {
                    err: "message",
        ...
        SHUTDOWN_VM: function(t) {
            var e = t.name, n = t.connectionName;
            return (0, X.logDebug)(this.name + ".SHUTDOWN_VM(" + e + "):"), function(t) {
                return d({
                    connectionName: n,
                    method: "SHUTDOWN_VM",
                    failHandler: s({
                        ...
                        name: e,
                        connectionName: n,
                        message: W("VM SHUT DOWN action failed")
                    }),
                    args: [ "shutdown", e ]
                });
            };
        ...
        FORCEOFF_VM: function(t) {
            var e = t.name, n = t.connectionName;
            return (0, X.logDebug)(this.name + ".FORCEOFF_VM(" + e + "):"), function(t) {
                return d({
                    connectionName: n,
                    method: "FORCEOFF_VM",
                    failHandler: s({
                        ...
                        name: e,
                        connectionName: n,
                        message: W("VM FORCE OFF action failed")
                    }),
                    args: [ "destroy", e ]
                });
            };
        ...
        REBOOT_VM: function(t) {
            var e = t.name, n = t.connectionName;
            return (0, X.logDebug)(this.name + ".REBOOT_VM(" + e + "):"), function(t) {
                return d({
                    connectionName: n,
                    method: "REBOOT_VM",
                    failHandler: s({
                        ...
                        name: e,
                        connectionName: n,
                        message: W("VM REBOOT action failed")
                    }),
                    args: [ "reboot", e ]
                });
            };
        ...
        FORCEREBOOT_VM: function(t) {
            var e = t.name, n = t.connectionName;
            return (0, X.logDebug)(this.name + ".FORCEREBOOT_VM(" + e + "):"), function(t) {
                return d({
                    connectionName: n,
                    ...
                    failHandler: s({
                        ...
                        name: e,
                        connectionName: n,
                        message: W("VM FORCE REBOOT action failed")
                    }),
                    args: [ "reset", e ]
                });
            };
        ...
        START_VM: function(t) {
            var e = t.name, n = t.connectionName;
            return (0, X.logDebug)(this.name + ".START_VM(" + e + "):"), function(t) {
                return d({
                    connectionName: n,
                    method: "START_VM",
                    failHandler: s({
                        ...
                        name: e,
                        connectionName: n,
                        message: W("VM START action failed")
                    }),
                    args: [ "start", e ]
                });
            };
        ...
        CREATE_VM: function(t) {
            ...
            return (0, X.logDebug)(this.name + ".CREATE_VM(" + e + "):"), function(t) {
                return t((0, z.vmCreateInProgress)({
                    name: e,
                    openConsoleTab: !0
                })), o && t((0, z.vmInstallInProgress)({
                    name: e
                })), window.setTimeout(function() {
                    t((0, z.vmCreateCompleted)({
                        name: e
                    }));
                }, Q), o && window.setTimeout(function() {
                    t((0, z.vmInstallCompleted)({
                        name: e
                    }));
                }, Z), N.default.script(D.default, [ e, n, i, r, a, o ], {
                    err: "message",
                    environ: [ "LC_ALL=C" ]
                });
            };
        ...
        INSTALL_VM: function(t) {
            ...
            return (0, X.logDebug)(this.name + ".INSTALL_VM(" + e + "):"), function(t) {
                return t((0, z.vmInstallInProgress)({
                    name: e
                })), window.setTimeout(function() {
                    t((0, z.vmInstallCompleted)({
                        name: e
                    }));
                }, Z), N.default.script(F.default, [ e, r.installSource, r.osVariant, (0, X.convertToUnit)(i, X.units.KiB, X.units.MiB), n, (0, 
                Y.prepareDisksParam)(a), (0, Y.prepareDisplaysParam)(o) ], {
                    err: "message",
                    environ: [ "LC_ALL=C" ]
                }).fail(c({
                    dispatch: t,
                    name: e,
                    connectionName: s,
                    message: W("INSTALL VM action failed")
                }, J));
            };
        },
        DELETE_VM: function(t) {
            ...
            return (0, X.logDebug)(this.name + ".DELETE_VM(" + i + ", " + JSON.stringify(a) + "):"), 
            function(t) {
        ...
        CHANGE_NETWORK_STATE: function(t) {
            ...
            return (0, X.logDebug)(this.name + ".CHANGE_NETWORK_STATE(" + e + "." + n + " " + i + "):"), 
            function(t) {
                d({
                    connectionName: r,
                    ...
                    failHandler: s({
                        ...
                        name: e,
                        connectionName: r,
                        message: W("CHANGE NETWORK STATE action failed")
                    }),
        ...
        USAGE_START_POLLING: function(t) {
            var e = t.name, n = t.connectionName;
            return (0, X.logDebug)(this.name + ".USAGE_START_POLLING(" + e + "):"), function(t) {
                t((0, z.updateVm)({
                    connectionName: n,
                    name: e,
                    usagePolling: !0
        ...
        USAGE_STOP_POLLING: function(t) {
            var e = t.name, n = t.connectionName;
            return (0, X.logDebug)(this.name + ".USAGE_STOP_POLLING(" + e + "):"), function(t) {
                return t((0, z.updateVm)({
                    connectionName: n,
                    name: e,
                    usagePolling: !1
                }));
        ...
        CONSOLE_VM: function(t) {
            ...
            return (0, X.logDebug)(this.name + ".CONSOLE_VM(name='" + e + "'), detail = ", n), 
            function(t) {
                (0, X.fileDownload)({
                    data: C(n),
                    fileName: "console.vv",
        ...
        SENDNMI_VM: function(t) {
            var e = t.name, n = t.connectionName;
            return (0, X.logDebug)(this.name + ".SENDNMI_VM(" + e + "):"), function(t) {
                return d({
                    connectionName: n,
                    method: "SENDNMI_VM",
                    failHandler: s({
                        ...
                        name: e,
                        connectionName: n,
                        message: W("VM SEND Non-Maskable Interrrupt action failed")
                    }),
                    args: [ "inject-nmi", e ]
                });
            };
