!function(t) {
    ...
    function u(t, e) {
        ...
        switch (t = t ? t : [], (0, v.logDebug)("reducer vms: action=" + JSON.stringify(e)), 
        e.type) {
          case "UPDATE_ADD_VM":
    ...
    function f(t, e) {
        if (t.actualTimeInMs) {
            ...
            (0, v.logDebug)("timeSampleUsageData(): can't compute diff - missing previous record"), 
            t.cpuUsage = 0;
        }
    }
    Object.defineProperty(e, "__esModule", {
    ...
    var r = n(10), a = i(r), o = n(20), s = i(o), c = n(69), u = i(c), l = function(t) {
        var e = t.store, n = e.getState(), i = n.vms, r = n.config, o = n.systemInfo, c = n.ui, l = e.dispatch;
    ...
    var c = function() {
    ...
    }(), u = n(17), l = i(u), d = n(10), h = i(d), f = n(21), p = n(16), g = n(24), m = n(27), v = n(35), y = i(v), x = n(38), _ = i(x), b = n(68), w = i(b), S = l.default.gettext, T = function(t) {
        function e(t) {
            a(this, e);
        ...
        return s(e, t), c(e, [ {
            ...
            key: "render",
            value: function() {
                var t = this, e = this.props, n = e.vms, i = e.config, a = e.systemInfo, o = e.ui, s = e.dispatch, c = e.actions, u = [].concat(r(n), r(this.asDummVms(n, o.vms))), l = function(t, e) {
                    return t.name.localeCompare(e.name);
                }, d = [ h.default.createElement("a", {
                    className: "card-pf-link-with-icon pull-right",
                    id: "create-new-vm",
                    onClick: (0, p.mouseClick)(function() {
                        return (0, m.createVmDialog)(s, a.osInfoList);
                    })
                }, h.default.createElement("span", {
                    className: "pficon pficon-add-circle-o"
                }), S("Create New VM")) ];
                return c && (d = d.concat(c)), h.default.createElement("div", {
                    className: "container-fluid"
                }, h.default.createElement(y.default, {
                    id: "notification-area",
                    notifications: o.notifications,
                    onDismiss: function(t) {
                        return s((0, f.clearNotification)(t));
                    }
                }), h.default.createElement(g.Listing, {
                    title: S("Virtual Machines"),
                    columnTitles: [ S("Name"), S("Connection"), S("State") ],
                    actions: d,
                    emptyCaption: S("No VM is running or defined on this host")
                }, u.sort(l).map(function(e) {
                    return e.isUi ? h.default.createElement(w.default, {
                        vm: e
                        ...
                        onStart: function() {
                            return s((0, f.startVm)(e));
                        },
                        onInstall: function() {
                            return s((0, f.installVm)(e));
                        },
                        onReboot: function() {
                            return s((0, f.rebootVm)(e));
                        },
                        onForceReboot: function() {
                            return s((0, f.forceRebootVm)(e));
                        },
                        onShutdown: function() {
                            return s((0, f.shutdownVm)(e));
                        },
                        onForceoff: function() {
                            return s((0, f.forceVmOff)(e));
                        },
                        onUsageStartPolling: function() {
                            return s((0, f.usageStartPolling)(e));
                        },
                        onUsageStopPolling: function() {
                            return s((0, f.usageStopPolling)(e));
                        },
                        onSendNMI: function() {
                            return s((0, f.sendNMI)(e));
                        },
                        dispatch: s,
                        key: "" + (0, p.vmId)(e.name)
                    });
    ...
    T.propTypes = {
        ...
        systemInfo: d.PropTypes.object.isRequired,
    ...
    function c(t) {
        if ((0, b.isEmpty)(t.vmName)) return A("Name should not be empty");
        if (t.vmName = t.vmName.trim(), (0, b.isEmpty)(t.vmName)) return A("Name should not consist of empty characters only");
        if (t.error) return t.error;
        if (t.source = t.source ? t.source.trim() : null, !(0, b.isEmpty)(t.source)) {
            switch (t.sourceType) {
              case C:
                if (!t.source.startsWith("/")) return A("Invalid filename");
                break;

              case E:
              default:
                if (!t.source.startsWith("http") && !t.source.startsWith("ftp") && !t.source.startsWith("nfs")) return A("Source should start with http, ftp or nfs protocol");
            }
            "/" === t.source && (t.source = null);
        }
        return (0, b.isEmpty)(t.source) ? A("Installation Source should not be empty") : t.memorySize <= 0 ? A("Memory should be positive number") : t.storageSize < 0 ? A("Storage Size should not be negative number") : void 0;
    }
    Object.defineProperty(e, "__esModule", {
        value: !0
    ...
    }(), l = n(17), d = i(l), h = n(10), f = i(h), p = n(28), g = i(p), m = n(30), v = i(m), y = n(31), x = i(y), _ = n(21), b = n(16), w = n(33);
    n(34);
    var S = n(15), T = i(S), A = d.default.gettext, E = "url", C = "file", P = function(t) {
        ...
        return f.default.createElement("tr", null, f.default.createElement("td", {
            ...
            htmlFor: n
        }, e)), f.default.createElement("td", null, f.default.createElement("div", {
            ...
            type: "number",
            value: (0, b.toFixedPrecision)(i),
            onKeyPress: b.digitFilter,
            step: 1,
            min: 0,
            onChange: a
        })), f.default.createElement("span", {
            className: "thirty-five-spaced-cell padding-left"
        }, f.default.createElement(v.default.Select, {
            id: n + "-unit-select",
            initial: r,
            onChange: o
        }, f.default.createElement(v.default.SelectEntry, {
            data: b.units.MiB.name,
            key: b.units.MiB.name
        }, A("MiB")), f.default.createElement(v.default.SelectEntry, {
            data: b.units.GiB.name,
            key: b.units.GiB.name
        }, A("GiB")))))))));
    }, k = function(t) {
        function e(t) {
            a(this, e);
            ...
            return n.state = {
                ...
                os: t.vmParams.os,
                memorySize: (0, b.convertToUnit)(t.vmParams.memorySize, b.units.MiB, b.units.GiB),
                memorySizeUnit: b.units.GiB.name,
                storageSize: t.vmParams.storageSize,
                storageSizeUnit: b.units.GiB.name,
        ...
        return s(e, t), u(e, [ {
            ...
            value: function(t, e, n) {
                ...
                switch (t) {
                  ...
                  case "memorySize":
                    this.setState(r({}, t, e)), e = (0, b.convertToUnit)(e, this.state.memorySizeUnit, b.units.MiB);
                    break;

                  case "storageSize":
                    this.setState(r({}, t, e)), e = (0, b.convertToUnit)(e, this.state.storageSizeUnit, b.units.GiB);
                    break;

                  case "memorySizeUnit":
                    this.setState(r({}, t, e)), e = (0, b.convertToUnit)(this.state.memorySize, e, b.units.MiB), 
                    t = "memorySize";
                    break;

                  case "storageSizeUnit":
                    this.setState(r({}, t, e)), e = (0, b.convertToUnit)(this.state.storageSize, e, b.units.GiB), 
                    t = "storageSize";
                }
                a(t, e);
            }
            ...
            value: function() {
                var t = [];
                this.props.familyMap[w.DIVIDER_FAMILY] && (t.push(f.default.createElement(v.default.SelectEntry, {
                    data: w.NOT_SPECIFIED,
                    key: w.NOT_SPECIFIED
                }, A(w.NOT_SPECIFIED))), t.push(f.default.createElement(v.default.SelectDivider, null))), 
                this.props.familyList.forEach(function(e) {
                    var n = e.family, i = e.vendors;
                    n !== w.DIVIDER_FAMILY && (t.push(f.default.createElement(v.default.SelectHeader, null, n)), 
                    i.forEach(function(e) {
                        t.push(f.default.createElement(v.default.SelectEntry, {
                            data: e,
                            key: e
                        }, e));
                    }));
                ...
                var e = this.props.vendorMap[this.state.vendor].map(function(t) {
                    return f.default.createElement(v.default.SelectEntry, {
                        data: t.shortId,
                        key: t.shortId
                    }, (0, w.getOSStringRepresentation)(t));
                }), n = void 0, i = void 0;
                switch (this.state.sourceType) {
                  case C:
                    i = "source-file", n = f.default.createElement(x.default.FileAutoComplete, {
                        id: i,
                        placeholder: A("Path to ISO file on host's file system"),
                  ...
                  case E:
                  default:
                    i = "source-url", n = f.default.createElement("input", {
                        id: i,
                        className: "form-control",
                        type: "text",
                        minLength: 1,
                        placeholder: A("Remote URL"),
                ...
                return f.default.createElement("div", {
                ...
                }, f.default.createElement("tr", null, f.default.createElement("td", {
                    className: "top"
                }, f.default.createElement("label", {
                    className: "control-label",
                    htmlFor: "vm-name"
                }, A("Name"))), f.default.createElement("td", null, f.default.createElement("input", {
                    id: "vm-name",
                    className: "form-control",
                    type: "text",
                    minLength: 1,
                    ...
                    className: "control-label",
                    htmlFor: "source-type"
                }, A("Installation Source Type"))), f.default.createElement("td", null, f.default.createElement(v.default.Select, {
                    id: "source-type",
                    ...
                    data: C,
                    key: C
                }, A("Filesystem")), f.default.createElement(v.default.SelectEntry, {
                    data: E,
                    key: E
                }, A("URL"))))), f.default.createElement("tr", null, f.default.createElement("td", {
                    className: "top"
                }, f.default.createElement("label", {
                    className: "control-label",
                    htmlFor: i
                }, A("Installation Source"))), f.default.createElement("td", null, n)), f.default.createElement("tr", null, f.default.createElement("td", {
                    className: "top"
                }, f.default.createElement("label", {
                    className: "control-label",
                    htmlFor: "vendor-select"
                }, A("OS Vendor"))), f.default.createElement("td", null, f.default.createElement(v.default.Select, {
                    id: "vendor-select",
                    initial: this.state.vendor,
                    onChange: this.onChangedValue.bind(this, "vendor")
                }, t))), f.default.createElement("tr", null, f.default.createElement("td", {
                    className: "top"
                }, f.default.createElement("label", {
                    className: "control-label",
                    htmlFor: "vendor-select"
                }, A("Operating System"))), f.default.createElement("td", null, f.default.createElement(v.default.StatelessSelect, {
                    id: "system-select",
                    ...
                    className: "control-label",
                    htmlFor: "start-vm"
                }, A("Immediately Start VM"))), f.default.createElement("td", null, f.default.createElement("input", {
                    id: "start-vm",
    ...
    k.propTypes = {
        valuesChanged: h.PropTypes.func.isRequired,
        vmParams: h.PropTypes.object.isRequired,
        vendorMap: h.PropTypes.object.isRequired,
        familyMap: h.PropTypes.object.isRequired,
        familyList: h.PropTypes.array.isRequired
    };
    e.createVmDialog = function(t, e) {
        var n = {
            vmName: null,
            sourceType: C,
            source: null,
            vendor: w.NOT_SPECIFIED,
            os: w.OTHER_OS_SHORT_ID,
            memorySize: 1024,
            storageSize: 10,
            startVm: !1,
            error: null
            ...
            n[t] = e;
        }, r = (0, w.prepareVendors)(e), a = f.default.createElement(k, {
            vmParams: n,
            ...
            title: A("Create New Virtual Machine"),
            body: a
        }, s = {
            actions: [ {
                clicked: function() {
                    var e = c(n);
                    return e ? d.default.defer().reject(e).promise : (0, b.timeoutedPromise)(t((0, _.createVm)(n)), T.default.LeaveCreateVmDialogVisibleAfterSubmit, null, function(e) {
                        t((0, _.addErrorNotification)({
                            message: d.default.format(A("Creation of vm $0 failed"), n.vmName),
                            description: e
                        }));
                    });
                },
        ...
        g.default.show_modal_dialog(o, s);
    };
}, function(t, e, n) {
    "use strict";
    ...
    var o = r.createClass({
        ...
        action_click: function(t, e) {
            if (!e || 0 === e.button) {
                ...
                this.setState({
                    ...
                    action_canceled: !1
                }), this.state.action_in_progress_promise = t(this.update_progress.bind(this)).then(function() {
                    n.setState({
                        action_in_progress: !1,
                        error_message: null
        ...
        function n() {
            null !== l.props && void 0 !== l.props || (l.props = {}), l.props.footer = r.createElement(o, l.footerProps), 
            l.render();
        }
        ...
        return l.props = null, l.footerProps = null, l.render = function() {
            l.props.footer = r.createElement(o, l.footerProps), r.render(r.createElement(s, l.props), a);
            ...
            l.footerProps.dialog_done != u && (c = l.footerProps.dialog_done, l.footerProps.dialog_done = u), 
            n();
    ...
    var r = n(17), a = i(r), o = n(10), s = i(o), c = n(16), u = n(39), l = i(u), d = n(45), h = i(d), f = n(46), p = i(f), g = n(54), m = i(g), v = n(57), y = i(v), x = n(62), _ = i(x), b = n(63), w = i(b), S = n(24), T = a.default.gettext;
    s.default;
    var A = function(t) {
    ...
    A.propTypes = {
        ...
        initallyExpanded: o.PropTypes.bool
    }, e.default = A;
}, function(t, e, n) {
    "use strict";
    function i(t) {
    ...
    }(), c = n(10), u = i(c), l = n(17), d = i(l), h = n(16), f = n(40), p = i(f), g = n(43), m = i(g);
    u.default;
    var v = d.default.gettext, y = function(t) {
        function e() {
    ...
    var r = n(10), a = i(r), o = n(17), s = i(o), c = n(24), u = n(41), l = n(16);
    a.default;
    var d = s.default.gettext, h = function(t) {
    ...
    }(), c = n(17), u = i(c), l = n(10), d = i(l), h = n(16), f = n(36);
    n(42);
    ...
    var r = n(10), a = i(r), o = n(17), s = i(o), c = n(44), u = i(c);
    a.default;
    ...
    }(), c = n(10), u = i(c), l = n(17), d = i(l), h = n(30), f = i(h), p = n(47), g = i(p), m = n(52), v = i(m), y = n(53), x = i(y), _ = n(16), b = n(21), w = d.default.gettext, S = function() {
    ...
    }(), c = n(10), u = i(c), l = n(17), d = i(l), h = n(48), f = d.default.gettext, p = function(t) {
        function e(t) {
            r(this, e);
            var n = a(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t));
            return n.state = {
    ...
    var a = n(17), o = i(a), s = n(10), c = i(s), u = n(55), l = i(u), d = n(56), h = i(d), f = n(16), p = o.default.gettext;
    c.default;
    var g = function(t) {
    ...
    var r = n(17), a = i(r), o = n(10), s = i(o), c = a.default.gettext;
    s.default;
    var u = function(t) {
    ...
    var r = n(10), a = i(r), o = n(16), s = n(21), c = n(41);
    a.default;
    var u = function(t) {
    ...
    var r = n(17), a = i(r), o = n(10), s = i(o), c = n(16), u = n(58), l = n(60), d = i(l), h = a.default.gettext;
    s.default;
    var f = function(t) {
    ...
    var a = n(17), o = i(a), s = n(10), c = i(s), u = n(28), l = n(21);
    n(59);
    ...
    var r = n(17), a = i(r), o = n(10), s = i(o), c = n(16), u = a.default.gettext;
    s.default;
    var l = function(t) {
    ...
    }(), c = n(17), u = i(c), l = n(10), d = i(l), h = n(16), f = n(64), p = i(f), g = u.default.gettext, m = function(t) {
        function e() {
            return r(this, e), a(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments));
        }
        return o(e, t), s(e, [ {
    ...
    }(), c = n(65), u = i(c), l = n(10), d = i(l), h = n(66), f = i(h), p = n(16), g = 0, m = function(t) {
        function e(t) {
            r(this, e);
            var n = a(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t));
    ...
    !function(e, n) {
        ...
        function r(t) {
            var e = this;
            e.d3 = window.d3 ? window.d3 : n(67), e.api = t, e.config = e.getDefaultConfig(), 
    ...
    var r = n(10), a = i(r), o = n(16), s = n(62), c = i(s), u = n(24);
    a.default;
    var l = function(t) {
        var e = t.vm, n = null;
    ...
    var N = n(17), I = i(N), R = n(72), V = i(R), D = n(65), G = i(D), F = n(73), U = i(F), j = n(74), z = i(j), B = n(75), H = i(B), X = n(76), Y = i(X), q = n(11), $ = i(q), W = n(21), K = n(22), Q = n(77), Z = n(16), J = n(78), tt = n(79), et = n(15), nt = i(et), it = I.default.gettext, rt = "https://github.com/cockpit-project/cockpit/tree/master/pkg/machines", at = {};
    at = {
        name: "Libvirt",
        init: function(t) {
            return !0;
