!function(e) {
    ...
    0: function(e, t, n) {
        "use strict";
        var i = n(728), r = n(2), o = i, s = n(723), u = [ "# top comment", "", "foo bar", " indented value", "", "will disappear", "key value #comment" ].join("\n"), a = [ "# top comment", "", "foo moo", "indented value", "", "#key value #comment", "hooray value" ].join("\n");
    ...
    728: function(e, t, n) {
        "use strict";
        !function() {
            window.QUnit = n(729), window.qunitTap = n(731), n(732), n(733), e.exports = window.QUnit;
        }();
    },
    729: function(e, t, n) {
        var i;
