!function(e) {
    ...
    "use strict";
    var i = n(24), r = n(2), o = i, s = n(19), u = [ "# top comment", "", "foo bar", " indented value", "", "will disappear", "key value #comment" ].join("\n"), a = [ "# top comment", "", "foo moo", "indented value", "", "#key value #comment", "hooray value" ].join("\n");
    ...
    "use strict";
    !function() {
        window.QUnit = n(25), window.qunitTap = n(28), n(29), n(30), e.exports = window.QUnit;
    }();
}, function(e, t, n) {
    var i;
    (function(e, r) {
