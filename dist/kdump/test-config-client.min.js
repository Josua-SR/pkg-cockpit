!function(e) {
    ...
    0: function(e, t, n) {
        "use strict";
        var i = n(932), r = n(2), o = i, s = n(927), u = [ "# top comment", "", "foo bar", " indented value", "", "will disappear", "key value #comment" ].join("\n"), a = [ "# top comment", "", "foo moo", "indented value", "", "#key value #comment", "hooray value", "" ].join("\n");
    ...
    932: function(e, t, n) {
        "use strict";
        !function() {
            window.QUnit = n(933), window.qunitTap = n(934), n(935), n(936), e.exports = window.QUnit;
        }();
    },
    933: function(e, t, n) {
        var i;
