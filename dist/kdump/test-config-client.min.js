!function(e) {
    ...
    "use strict";
    var i = n(30), r = n(2), o = i, s = n(25), u = [ "# top comment", "", "foo bar", " indented value", "", "will disappear", "key value #comment" ].join("\n"), a = [ "# top comment", "", "foo moo", "indented value", "", "#key value #comment", "hooray value" ].join("\n");
    ...
    "use strict";
    !function() {
        window.QUnit = n(31), window.qunitTap = n(34), n(35), n(36), e.exports = window.QUnit;
    }();
}, function(e, t, n) {
    var i;
    (function(e, r) {
