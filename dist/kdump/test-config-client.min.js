!function(e) {
    ...
    "use strict";
    var i = n(21), r = n(2), o = i, s = n(16), u = [ "# top comment", "", "foo bar", " indented value", "", "will disappear", "key value #comment" ].join("\n"), a = [ "# top comment", "", "foo moo", "indented value", "", "#key value #comment", "hooray value" ].join("\n");
    ...
    "use strict";
    !function() {
        window.QUnit = n(22), window.qunitTap = n(25), n(26), n(27), e.exports = window.QUnit;
    }();
}, function(e, t, n) {
    var i;
    (function(e, r) {
