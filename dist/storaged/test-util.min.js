!function(e) {
        ...
        !function(i, s) {
            ...
            function a(t, r) {
                ...
                for (var a, f, d, p, h, m, g = s(r), v = new c(t), E = [], _ = [], T = [], M = !1, S = !1; !v.eos(); ) {
                    ...
                    if (!v.scan(g[0])) break;
                    if (M = !0, f = v.scan(x) || "name", v.scan(b), "=" === f ? (d = v.scanUntil(w), 
                    v.scan(w), v.scanUntil(g[1])) : "{" === f ? (d = v.scanUntil(new RegExp("\\s*" + o("}" + r[1]))), 
                    v.scan(k), v.scanUntil(g[1]), f = "&") : d = v.scanUntil(g[1]), !v.scan(g[1])) throw new Error("Unclosed tag at " + v.pos);
    ...
    49: function(e, t, n) {
        "use strict";
        !function() {
            window.QUnit = n(50), window.qunitTap = n(53), n(54), n(55), e.exports = window.QUnit;
        }();
    },
    50: function(e, t, n) {
        var r;
	 ...
	 */
            !function(e) {
                ...
                }, F = (d(0) || "").replace(/(:\d+)+\)?/, "").replace(/.+\//, ""), H = !1, B = !1, V = Object.prototype.toString, z = Object.prototype.hasOwnProperty, $ = {
                    queue: [],
                    blocking: !0,
                    reorder: !0,
                    altertitle: !0,
                ...
                u(j, {
                    ...
                    start: function(e) {
                        ...
                        if ($.current) {
                            ...
                            if (H = !0, B) throw new Error("Called start() outside of a test context while already started");
