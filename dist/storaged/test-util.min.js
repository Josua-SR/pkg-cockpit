!function(e) {
	 ...
	 */
        !function(i, s) {
            ...
            function a(t, r) {
                function i() {
                    if (M && !S) for (;T.length; ) delete _[T.pop()]; else T = [];
                    M = !1, S = !1;
                }
                r = r || e.tags, t = t || "", "string" == typeof r && (r = r.split(y));
                for (var a, f, d, p, h, m, g = s(r), v = new c(t), E = [], _ = [], T = [], M = !1, S = !1; !v.eos(); ) {
                    if (a = v.pos, d = v.scanUntil(g[0])) for (var q = 0, C = d.length; q < C; ++q) p = d.charAt(q), 
                    n(p) ? T.push(_.length) : S = !0, _.push([ "text", p, a, a + 1 ]), a += 1, "\n" === p && i();
                    if (!v.scan(g[0])) break;
                    if (M = !0, f = v.scan(x) || "name", v.scan(b), "=" === f ? (d = v.scanUntil(k), 
                    v.scan(k), v.scanUntil(g[1])) : "{" === f ? (d = v.scanUntil(new RegExp("\\s*" + o("}" + r[1]))), 
                    v.scan(w), v.scanUntil(g[1]), f = "&") : d = v.scanUntil(g[1]), !v.scan(g[1])) throw new Error("Unclosed tag at " + v.pos);
                    if (h = [ f, d, a, v.pos ], _.push(h), "#" === f || "^" === f) E.push(h); else if ("/" === f) {
                        if (m = E.pop(), !m) throw new Error('Unopened section "' + d + '" at ' + a);
                        if (m[1] !== d) throw new Error('Unclosed section "' + m[1] + '" at ' + a);
                    } else "name" === f || "{" === f || "&" === f ? S = !0 : "=" === f && (g = s(r = d.split(y)));
                }
                if (m = E.pop()) throw new Error('Unclosed section "' + m[1] + '" at ' + v.pos);
                return l(u(_));
            }
            function u(e) {
            ...
            var p = RegExp.prototype.test, h = /\S/, m = Object.prototype.toString, g = Array.isArray || function(e) {
            ...
            c.prototype.eos = function() {
                ...
                a[0]) {
                  case "#":
                    ...
                    if (g(u)) for (var p = 0, h = u.length; p < h; ++p) l += this.renderTokens(a[4], n.push(u[p]), o, i); else if ("object" == typeof u || "string" == typeof u) l += this.renderTokens(a[4], n.push(u), o, i); else if (r(u)) {
                  ...
                  case "^":
                    u = n.lookup(a[1]), (!u || g(u) && 0 === u.length) && (l += this.renderTokens(a[4], n, o, i));
                    break;
	 ...
	 */
            !function(e) {
                ...
                function _(e, t, n) {
                    var r, o = !t;
                    if ("array" !== L.objectType(e)) t ? $.queue.splice(K++, 0, e) : n ? (W || (W = T(n)), 
                ...
                function S() {
                    var e, t, n = $.pollution;
                    M(), e = i($.pollution, n), e.length > 0 && L.pushFailure("Introduced global variable(s): " + e.join(", ")), 
                    t = i(n, $.pollution), t.length > 0 && L.pushFailure("Deleted global variable(s): " + t.join(", "));
                }
                function q(e, t, n) {
                ...
                }(), L.isLocal = !(P.document && "file:" !== O.location.protocol), L.version = "1.23.1", 
                u(L, {
                    ...
                    start: function(e) {
                        ...
                        if ($.current) {
                            ...
                            if ($.current.semaphore < 0) return $.current.semaphore = 0, void L.pushFailure("Called start() while already started (test's semaphore was 0 already)", d(2));
                        } else {
                ...
                x.count = 0, x.prototype = {
                    ...
                    run: function() {
                        ...
                        var t;
                        if ($.current = this, this.async && L.stop(), this.callbackStarted = R(), $.notrycatch) return void e(this);
                        try {
                            e(this);
                        } catch (e) {
                    ...
                    push: function(e, t, n, r, o) {
                        var i = this instanceof D ? this : L.config.current.assert;
                        return i.pushResult({
                            result: e,
                            actual: t,
                            expected: n,
                    ...
                    pushResult: function(e) {
                        var t = this, n = t instanceof D && t.test || L.config.current;
                    ...
                    throws: function(e, t, n) {
                        var r, o, i = t, s = !1, a = this instanceof D && this.test || L.config.current;
                    ...
                    for (e = 0, t = n.length; e < t; e++) O[n[e]] = L[n[e]];
                }(), O.QUnit = L), "undefined" != typeof o && o && o.exports && (o.exports = L, 
                ...
                if (C) {
                    ...
                    QUnit.config.urlConfig.push({
                        ...
                        var N = QUnit.config, D = window.document, I = !1, L = Object.prototype.hasOwnProperty, j = f({
                            filter: void 0,
                            module: void 0,
                            moduleId: void 0,
                            testId: void 0
                        ...
                        QUnit.begin(function(e) {
                            ...
                            }), w(), _(), T(e.modules), r = u("qunit-tests"), r && N.hidepassed && i(r, "hidepass");
                        ...
                        QUnit.diff = function() {
                            ...
                            return e.prototype.DiffMain = function(e, t, n) {
                                ...
                                var i, s, a, u, l, c, f, d, p, h, m, g, v, b, y, k, w, x, E, _, T, M, S;
                                ...
                                b = 0, T = 0; T < a && !(new Date().getTime() > o); T++) {
                                    for (M = -T + m; M <= T - g; M += 2) {
                                        ...
                                        E = w - M; w < i && E < s && e.charAt(w) === t.charAt(E); ) w++, E++;
                                        if (c[k] = w, w > i) g += 2; else if (E > s) m += 2; else if (h && (y = u + p - M, 
