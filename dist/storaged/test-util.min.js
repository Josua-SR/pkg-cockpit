	 ...
	 */
        !function(i, s) {
            ...
            function a(t, r) {
                ...
                for (var a, f, d, m, y, w, k = s(r), x = new c(t), E = [], _ = [], T = [], M = !1, S = !1; !x.eos(); ) {
                    if (a = x.pos, d = x.scanUntil(k[0])) for (var q = 0, C = d.length; q < C; ++q) m = d.charAt(q), 
                    n(m) ? T.push(_.length) : S = !0, _.push([ "text", m, a, a + 1 ]), a += 1, "\n" === m && i();
                    if (!x.scan(k[0])) break;
                    if (M = !0, f = x.scan(b) || "name", x.scan(p), "=" === f ? (d = x.scanUntil(g), 
                    ...
                    } else "name" === f || "{" === f || "&" === f ? S = !0 : "=" === f && (k = s(r = d.split(h)));
                }
