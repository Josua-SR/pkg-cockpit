!function(e) {
    ...
    !function() {
        ...
        var a = n(3), s = n(7), r = n(9), i = n(10), o = a.gettext, d = a.gettext, u = {};
        ...
        !function(t, n) {
            ...
            function nt(e, t) {
                if (null !== t) {
                    ...
                    a = Cs[e]._config; else if (null != t.parentLocale) if (null != Cs[t.parentLocale]) a = Cs[t.parentLocale]._config; else {
                        if (n = et(t.parentLocale), null == n) return Ns[t.parentLocale] || (Ns[t.parentLocale] = []), 
                    ...
                    return Cs[e] = new j(H(a, t)), Ns[e] && Ns[e].forEach(function(e) {
                        nt(e.name, e.config);
                    }), tt(e), Cs[e];
                }
            ...
            Z("X", function(e, t, n) {
                ...
                n._d = new Date(g(e));
            }), t.version = "2.22.1", a(bt), t.fn = _r, t.min = Ht, t.max = jt, t.now = Ks, 
    ...
    "use strict";
    !function() {
        window.QUnit = n(211), window.qunitTap = n(213), n(214), n(215), e.exports = window.QUnit;
    }();
}, function(e, t, n) {
    var a;
    (function(e, s) {
