!function(e) {
    ...
    5: function(e, t, n) {
        ...
        !function() {
            ...
            var o = n(2), i = n(3), s = n(6), a = n(8), u = i.gettext, l = i.gettext, c = {};
    ...
    52: function(e, t, n) {
        "use strict";
        !function() {
            window.QUnit = n(53), window.qunitTap = n(55), n(56), n(58), e.exports = window.QUnit;
        }();
    },
    53: function(e, t, n) {
        (function(t) {
	 ...
	 */
            !function(t) {
                ...
                var T, E, _, S, N = 0, q = (i(0) || "").replace(/(:\d+)+\)?/, "").replace(/.+\//, ""), C = Object.prototype.toString, j = Object.prototype.hasOwnProperty, M = t.Date, L = t.setTimeout, U = t.clearTimeout, D = {
                    ...
                    for (t in e) j.call(e, t) && (n = e[t], r[t] = n === Object(n) ? O(n) : n);
                    return r;
                };
                T = {
                    module: function(e, t) {
                    ...
                    start: function(e) {
                        ...
                        void T.pushFailure("Called start() while already started (QUnit.config.semaphore was 0 already)", null, i(2))) : void (D.setTimeout ? L(function() {
                            _.semaphore > 0 || (_.timeout && U(_.timeout), _.blocking = !1, u(!0));
                        }, 13) : (_.blocking = !1, u(!0))));
                    },
                    stop: function(e) {
                        _.semaphore += e || 1, _.blocking = !0, _.testTimeout && D.setTimeout && (U(_.timeout), 
                        _.timeout = L(function() {
                    ...
                    propEqual: function(e, t, n) {
                        e = O(e), t = O(t), T.push(T.equiv(e, t), e, t, n);
                    },
                    ...
                    throws: function(e, t, n) {
                        ...
                        _.current.ignoreGlobalErrors = !1, r ? (t ? t instanceof Error ? i = r instanceof Error && r.name === t.name && r.message === t.message : "regexp" === T.objectType(t) ? i = t.test(A(r)) : "string" === T.objectType(t) ? i = t === A(r) : r instanceof t ? i = !0 : t.call({}, r) === !0 && (o = null, 
