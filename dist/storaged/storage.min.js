!function(e) {
    ...
    !function() {
        ...
        var t = n(2), i = n(3), r = n(4), o = n(9), a = n(10), s = n(22), l = n(5);
        n(42), n(44), n(46), n(48), n(50);
        var c = i.gettext;
        t(e);
    }();
}, function(e, t) {
    ...
    !function() {
        ...
        var r = n(2), o = n(3), a = n(6), s = n(8), l = o.gettext, c = o.gettext, u = {};
        ...
        u.get_multipathd_service = function() {
            ...
            if (i.hasAttribute("hidden")) {
                var r = i.getAttribute("hidden");
                n ? (i.removeAttribute("hidden"), window.clearTimeout(parseInt(r, 10))) : r || (r = window.setTimeout(function() {
                    e(t, !0);
                }, 2e3), i.setAttribute("hidden", String(r)));
            }
        }, e.exports = u;
    }();
}, function(e, t, n) {
    ...
    e.exports = r.extend({}, o, {
        render: function(e, t, n) {
            return i(o.render(e, t, n));
        },
        to_html: function(e, t, n, r) {
            return i(o.to_html(e, t, n, r));
        },
        clearCache: function() {
    ...
    !function() {
        function t(e) {
            ...
            return o.parse(c), i(e.storaged_jobs).on("added removed changed", function() {
                n("body");
    ...
    !function() {
        function t(e, t) {
            ...
            function m() {
                ...
                i("#iscsi-sessions").amend(o.render(I, {
                    Sessions: r,
            ...
            function v() {
                function t(t) {
                    ...
                    return !(i && "/" != i.Table || "/" != n.Drive || "/" != n.CryptoBackingDevice || "/" != n.MDRaid || r && "/" != r.LogicalVolume || n.HintIgnore || !(n.Size > 0));
                }
                function n(t) {
            ...
            function E() {
                i("#storage").show(), L.resize(), W.resize();
            }
            var D, z;
            i("#vgroups").toggle(e.features.lvm2), i("#iscsi-sessions").toggle(e.features.iscsi);
            var N = i("#mdraids-tmpl").html();
            o.parse(N), i(e).on("changed", n);
            var A = i("#vgroups-tmpl").html();
            o.parse(A), i(e).on("changed", f);
            var I = i("#iscsi-sessions-tmpl").html();
            o.parse(I), i(e).on("changed", m);
            var P = i("#drives-tmpl").html();
            o.parse(P);
            var R;
            i(e).on("changed", h), i(e.blockdev_io).on("changed", h);
            var O = i("#others-tmpl").html();
            o.parse(O), i(e).on("changed", v);
            var F = i("#mounts-tmpl").html();
            o.parse(F), i(e).on("changed", g), i(e.fsys_sizes).on("changed", g), i(e).on("changed", b);
            var U = {
            ...
            i.extend(j.yaxis, {
                ...
                hoverable: !0,
                autoHighlight: !1
            }), j.setup_hook = k("#storage-writing-unit");
            var W = a.plot(i("#storage-writing-graph"), 300);
            W.set_options(j), z = W.add_metrics_stacked_instances_series($, {}), W.start_walking(), 
            i(z).on("hover", y), i(window).on("resize", function() {
                L.resize(), W.resize();
            });
            var B = a.setup_plot_controls(i("#storage"), i("#storage-graph-toolbar"));
            return B.reset([ L, W ]), n(), f(), m(), h(), v(), g(), b(), i("#storage-log").append(s.logbox([ "_SYSTEMD_UNIT=storaged.service", "+", "_SYSTEMD_UNIT=udisks2.service", "+", "_SYSTEMD_UNIT=dm-event.service", "+", "_SYSTEMD_UNIT=smartd.service", "+", "_SYSTEMD_UNIT=multipathd.service" ], 10)), 
        ...
        var i = n(2), r = n(3), o = n(6), a = n(11), s = n(15), l = n(5), c = n(19), u = n(21), d = r.gettext, p = r.gettext;
        e.exports = {
            init: t
        };
    }();
    ...
    !function(e) {
        ...
        function n(n, r, o, a) {
            ...
            function F(e) {
                e.lines.show && U(e), e.bars.show && $(e), e.points.show && V(e);
            }
            function U(e) {
            ...
            function L(e, t, n, i, r, o, a, s, l, c, u) {
            ...
            function $(e) {
                function t(t, n, i, r, o, a) {
                    for (var s = t.points, l = t.pointsize, c = 0; c < s.length; c += l) null != s[c] && L(s[c], s[c + 1], s[c + 2], n, i, r, o, a, le, e.bars.horizontal, e.bars.lineWidth);
                }
            ...
            function te(t, n) {
                ...
                ce.lineWidth = t.bars.lineWidth, ce.strokeStyle = r, L(n[0], n[1], n[2] || 0, i, i + t.bars.barWidth, function() {
                    return o;
    ...
    !function() {
        ...
        var i = n(3), r = n(6), o = n(16), a = n(17), s = n(18), l = i.gettext, c = i.gettext, u = {};
    ...
    !function() {
        ...
        var r = n(2), o = n(3), a = o.gettext, s = o.permission({
            admin: !0
        });
    ...
    !function() {
        function t(e, t) {
            ...
            function v() {
                k = null, c.hide("#storage-detail");
            }
            function g(t, n) {
                null !== E && (window.clearInterval(E), E = null), b = t, k = n, h();
                var i = document.querySelector("#detail-content");
                s.unmountComponentAtNode(i), "block" == b ? s.render(s.createElement(l.Block, {
                    client: e,
                    name: k
                }), i) : "mdraid" == b ? s.render(s.createElement(l.MDRaid, {
                    client: e,
                    name: k
                }), i) : "vgroup" == b && s.render(s.createElement(l.VGroup, {
                    client: e,
                    name: k
                }), i), c.show_soon("#storage-detail", !!i.firstChild);
            }
        ...
        var i = n(2), r = n(3), o = n(6), a = n(15), s = n(23), l = n(24), c = n(5), u = n(19), d = n(21), p = r.gettext;
        e.exports = {
            init: t
        };
    }();
    ...
    !function(t, n) {
        ...
        function _(e, t, n) {
            e && null != t && n && (n.nodeName && !n.getDOMNode && (n.getDOMNode = x), $(t) ? t(n) : e[t] = n);
        }
        function w(e, t) {
            e && null != t && ($(t) ? t(null) : delete e[t]);
        }
        function S(e) {
        ...
        function F(e) {
            ...
            for (var o in t) if (t.hasOwnProperty(o)) {
                ...
                Ue[o] = {
                    ...
                    hasBooleanValue: U(a, Le),
                    hasNumericValue: U(a, $e),
        ...
        function V(e, t, n) {
            ...
            if (i) if (null == n || i.hasBooleanValue && !n || i.hasNumericValue && isNaN(n) || i.hasPositiveNumericValue && n < 1 || i.hasOverloadedBooleanValue && n === !1) L(e, t); else if (i.mustUseProperty) e[i.propertyName] = n; else {
        ...
        function J(e, t, n, i, r) {
            if ("value" !== e && "checked" !== e || (t = i[e]), n !== t) {
                if (void 0 === n) return void (Ke.test(e) ? D(i, e) : "style" === e ? I(i.style, t) : "dangerouslySetInnerHTML" === e ? i.innerHTML = "" : r ? i.removeAttribute(e) : L(i, e));
        ...
        function ve(e, t) {
            ...
            $(t.getDefaultProps) && q(e.defaultProps, t.getDefaultProps());
        }
        function ge(e, t) {
            for (var n in t) t.hasOwnProperty(n) && $(t[n]) && (e[n] = t[n].bind(e));
        }
        function be() {
        ...
        function ke(e) {
            ...
            if (!$(e.render)) throw new Error("createClass: spec.render is not function");
        ...
        S.prototype = {
            ...
            getState: function() {
                ...
                return t.length && (n = q({}, n), G(t, function(t) {
                    return Xe(t) ? void (n = q({}, t[0])) : ($(t) && (t = t.call(e, n, i)), void q(n, t));
                }), t.length = 0), n;
            },
            ...
            addCallback: function(e) {
                $(e) && this.pendingCallbacks.push(e);
            }
        }, T.prototype = {
            constructor: T,
        ...
        var Ie = /^-?\d+(\.\d+)?$/, Pe = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", Re = Pe + "\\-.0-9\\uB7\\u0300-\\u036F\\u203F-\\u2040", Oe = new RegExp("^[" + Pe + "][" + Re + "]*$"), Fe = RegExp.prototype.test.bind(new RegExp("^(data|aria)-[" + Re + "]*$")), Ue = {}, Ve = 1, Le = 4, $e = 8, je = 24, We = 32, Be = {
            props: {
                accept: 0,
                acceptCharset: 0,
                accessKey: 0,
    ...
    function i(e, t) {
        function n(n) {
            for (var i = e.vgroups_lvols[t.path], r = 0; r < i.length; r++) if (i[r].Name == n) return i[r];
            return null;
        }
        for (var i, r = 0; r < 1e3 && (i = "lvol" + r.toFixed(), n(i)); r++) ;
        return i;
    }
    function r(e, t, n) {
        function r(e, t) {
        ...
        function p() {
            ...
            var i, r;
            y ? (i = g.lvol_name(y), r = I("Deleting a logical volume will delete all data in it.")) : n && (i = g.block_name(f), 
            r = I("Deleting a partition will delete all data in it.")), i && v.open({
                Title: h.format(I("Please confirm deletion of $0"), i),
                Alerts: g.get_usage_alerts(e, t.path),
                Fields: [],
                Action: {
                    Danger: r,
                    Title: I("Delete"),
        ...
        var f = r(t.iface, ".Block") ? t : null, m = f && e.blocks_lvm2[f.path], k = f && e.blocks_pvol[f.path], y = r(t.iface, ".LogicalVolume") ? t : m && e.lvols[m.LogicalVolume], x = f && "filesystem" == f.IdUsage, w = f && "crypto" == f.IdUsage, P = [], R = null;
        y && ("pool" == y.Type ? (o(I("Pool"), M), R = b.createElement(_, {
            onClick: a
        }, I("Create Thin Volume"))) : o(I("Volume"), C)), n && o(I("Partition"), z), x ? o(I("Filesystem"), S) : w ? o(I("Encryption"), T) : f && "raid" == f.IdUsage && "LVM2_member" == f.IdType || k && e.vgroups[k.VolumeGroup] ? o(I("Physical Volume"), E) : f && "raid" == f.IdUsage || f && e.mdraids[f.MDRaidMember] ? o(I("RAID Member"), D) : f && "other" == f.IdUsage && "swap" == f.IdType ? o(I("Swap"), N) : f && o(I("Unrecognized Data"), A);
        var O = [];
        if (w && (e.blocks_cleartext[f.path] ? s(I("Lock"), l) : s(I("Unlock"), c)), y && (y.Active ? s(I("Deactivate"), d) : s(I("Activate"), u)), 
        n || y) {
            var F = null;
            e.is_old_udisks2 && w && e.blocks_cleartext[f.path] && (F = I("Can't delete while unlocked")), 
            s(I("Delete"), p, F);
        }
        return {
            renderers: P,
            actions: [ b.createElement("div", null, O) ],
            row_action: R
        };
    }
    function o(e, t) {
        var n, i = e.blocks_pvol[t.path];
        if ("filesystem" == t.IdUsage) n = h.format(P("storage-id-desc", "$0 File System"), t.IdType); else if ("raid" == t.IdUsage) if (i && e.vgroups[i.VolumeGroup]) {
            var r = e.vgroups[i.VolumeGroup];
            n = h.format(I("Physical volume of $0"), r.Name);
        } else if (e.mdraids[t.MDRaidMember]) {
            var o = e.mdraids[t.MDRaidMember];
            n = h.format(I("Member of RAID Device $0"), g.mdraid_name(o));
        } else n = I("LVM2_member" == t.IdType ? "Physical Volume" : "Member of RAID Device"); else n = "crypto" == t.IdUsage ? P("storage-id-desc", "Encrypted data") : "other" == t.IdUsage ? "swap" == t.IdType ? P("storage-id-desc", "Swap Space") : P("storage-id-desc", "Other Data") : P("storage-id-desc", "Unrecognized Data");
        return {
            size: g.fmt_size(t.Size),
            text: n
        };
    }
    function a(e, t, n, i, r, o, a) {
        var s = null;
        a && (s = b.createElement("span", {
            className: "spinner spinner-sm spinner-inline",
            style: {
                visibility: "hidden"
            },
            "data-job-object": a
        })), o.row_action && (s = s ? b.createElement("span", null, s, o.row_action) : o.row_action);
        ...
        e.push(b.createElement(k.ListingRow, {
            key: n,
            columns: l,
    ...
    function s(e, t, n, i, s) {
        var l, u, d;
        "crypto" == i.IdUsage && (d = e.blocks_cleartext[i.path]), u = r(e, i, s), l = o(e, i), 
        a(t, n, i.path, g.block_name(i), l, u, i.path), d && c(e, t, n + 1, d);
    }
    function l(e, t, n, i) {
        function o(n, r, o) {
            function a() {
                x.format_dialog(e, i.path, r, o, p && n <= d);
            }
            if (o >= 3145728) {
                var s = b.createElement(_, {
                    onClick: a
                }, I("Create Partition")), l = [ b.createElement("span", {
                    className: "content-level-" + n
                }, g.fmt_size(o) + " " + I("Free Space")), "", {
                    element: s,
                    tight: !0
                } ];
                t.push(b.createElement(k.ListingRow, {
                    columns: l
                }));
            }
        }
        function l(n, i, o, s) {
            ...
            a(t, n, i.path, g.block_name(i), l, u, i.path), c(n + 1, o, s);
        }
        function c(n, i, r) {
            var a, c, u, p, m, h, v = i, g = i + r;
            for (a = 0; a < f.length; a++) c = e.blocks[f[a].path], u = f[a].Offset, p = f[a].Size, 
            m = f[a].IsContainer, h = f[a].IsContained, null !== c && (n === d && h || (n != d + 1 || h) && (u < i || u + p > i + r || (o(n, v, u - v), 
            m ? l(n, c, u, p) : s(e, t, n, c, !0), v = u + p)));
            o(n, v, g - v);
        }
        var u = e.blocks_ptable[i.path], d = n, p = "dos" == u.Type, f = e.blocks_partitions[i.path];
        c(d, 0, i.Size);
    }
    function c(e, t, n, i) {
    ...
    function d(e, t) {
        ...
        return b.createElement(k.Listing, {
            title: I("Content"),
            actions: r
        }, u(e, t));
    }
    function p(e, t, n, i, o) {
        ...
        e.blocks_ptable[i.path] ? (u = {
            size: g.fmt_size(i.Size),
            text: o.Name
        }, c = r(clienta, i, !1), a(t, n, o.Name, g.block_name(i), u, c, i.path), l(e, t, n + 1, i)) : s(e, t, n, i, !1);
    }
    function f(e, t, n, i) {
        var o, s, l, c;
        "pool" == i.Type ? (l = Math.max(i.DataAllocatedRatio, i.MetadataAllocatedRatio), 
        s = {
            size: g.fmt_size(i.Size),
            text: I("Pool for Thin Volumes")
        }, o = r(e, i, !1), a(t, n, i.Name, i.Name, s, o, !1), e.lvols_pool_members[i.path].forEach(function(i) {
            f(e, t, n + 1, i);
        })) : (c = e.lvols_block[i.path], c ? p(e, t, n, c, i) : (s = {
            size: g.fmt_size(i.Size),
            text: I(i.Active ? "Unsupported volume" : "Inactive volume")
        }, o = r(e, i, !1), a(t, n, i.Name, i.Name, s, o, !1)));
    }
    function m(e, t) {
        var n = [];
    ...
    var h = n(3), v = n(19), g = n(5), b = n(23), k = n(25), y = n(30), x = n(34), _ = y.StorageButton, w = y.StorageLink, S = (x.FormatButton, 
    n(35).FilesystemTab), T = n(36).CryptoTab, C = n(37).BlockVolTab, M = n(37).PoolVolTab, E = n(38).PVolTab, D = n(38).MDRaidMemberTab, z = n(39).PartitionTab, N = n(40).SwapTab, A = n(41).UnrecognizedTab, I = h.gettext, P = h.gettext, R = b.createClass({
        displayName: "Block",
        ...
        render: function() {
            ...
            if (!n) return null;
            var r = 0 == n.FreeSize && I("No free space"), o = b.createElement("div", {
                className: "pull-right"
            }, b.createElement(w, {
                onClick: e,
                excuse: r
    ...
    "use strict";
    var i = n(3), r = n(21).permission, o = n(23), a = n(31).Tooltip, s = i.gettext, l = (i.gettext, 
    o.createClass({
    ...
    var r = n(3), o = n(5), a = n(19), s = n(23), l = n(30), c = r.gettext, u = (r.gettext, 
    s.createClass({
    ...
    "use strict";
    var i = n(3), r = n(19), o = n(5), a = n(23), s = n(30), l = n(34), c = s.StorageButton, u = s.StorageLink, d = l.FormatButton, p = i.gettext, f = (i.gettext, 
    a.createClass({
    ...
    var o = n(3), a = n(19), s = n(5), l = n(23), c = n(30), u = n(34), d = c.StorageButton, p = c.StorageLink, f = (u.FormatButton, 
    ...
    "use strict";
    var i = n(3), r = n(5), o = n(23), a = n(34), s = a.FormatButton, l = i.gettext, c = (i.gettext, 
    o.createClass({
        displayName: "PVolTab",
        render: function() {
    ...
    "use strict";
    var i = n(3), r = n(5), o = n(23), a = i.gettext, s = (i.gettext, o.createClass({
    ...
    "use strict";
    var i = n(3), r = n(5), o = n(23), a = n(30), s = n(34), l = a.StorageButton, c = (a.StorageLink, 
    ...
    "use strict";
    var i = n(3), r = (n(5), n(23)), o = n(34), a = o.FormatButton, s = i.gettext, l = (i.gettext, 
    r.createClass({
