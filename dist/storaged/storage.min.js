!function(e) {
        ...
        function c() {
            ...
            function t(e) {
                ...
                f.spawn([ "stat", "-f", "-c", "[ %S, %f, %b ]", t ], {
                    ...
                    var n = JSON.parse(e);
                    u.fsys_sizes[t] = [ n[1] * n[0], n[2] * n[0] ], d(u).triggerHandler("changed");
                }).fail(function() {
    ...
    !function(i, a) {
        ...
        function s(t, r) {
            ...
            r = r || e.tags, t = t || "", "string" == typeof r && (r = r.split(y));
            for (var s, d, f, p, m, h, v = a(r), g = new u(t), w = [], T = [], E = [], S = !1, C = !1; !g.eos(); ) {
                ...
                g.scan(_), g.scanUntil(v[1])) : "{" === d ? (f = g.scanUntil(new RegExp("\\s*" + o("}" + r[1]))), 
                ...
                } else "name" === d || "{" === d || "&" === d ? C = !0 : "=" === d && (v = a(r = f.split(y)));
            }
        ...
        u.prototype.eos = function() {
            ...
            s[0]) {
              case "#":
                ...
                if (v(l)) for (var p = 0, m = l.length; p < m; ++p) c += this.renderTokens(s[4], n.push(l[p]), o, i); else if ("object" == typeof l || "string" == typeof l) c += this.renderTokens(s[4], n.push(l), o, i); else if (r(l)) {
              ...
              case "^":
                l = n.lookup(s[1]), (!l || v(l) && 0 === l.length) && (c += this.renderTokens(s[4], n, o, i));
                break;
    ...
    !function() {
        function t(e, t) {
            ...
            function m() {
                ...
                r("#iscsi-sessions").amend(i.render(j, {
                    Sessions: o,
            ...
            function h() {
                ...
                r("#drives").amend(i.render(U, {
                    Drives: s,
                    HasDrives: s.length > 0
                })), u.update(), t.update("#drives");
                for (var c in s) s[c] && s[c].dev && (A.add_instance(s[c].dev), I.add_instance(s[c].dev));
            }
            function v() {
                function t(t) {
            ...
            function T(e) {
                return function(t) {
                    ...
                    n.yaxis.options.min = 0, r(e).text(a.bytes_per_sec_tick_unit(n.yaxis));
                };
            }
            function E(e, t) {
                V = t, h();
                ...
                c.open({
                    ...
                    Action: {
                        ...
                        failure_filter: function(t, n) {
                            return n.message.indexOf("authorization") == -1 ? n : void N(e, t);
                        }
                    }
                });
            }
            ...
            function P() {
                r("#storage").show(), q.resize(), X.resize();
            }
            var A, I;
            r("#vgroups").toggle(e.features.lvm2), r("#iscsi-sessions").toggle(e.features.iscsi);
            var R = r("#mdraids-tmpl").html();
            i.parse(R), r(e).on("changed", n);
            var F = r("#vgroups-tmpl").html();
            i.parse(F), r(e).on("changed", p);
            var j = r("#iscsi-sessions-tmpl").html();
            i.parse(j), r(e).on("changed", m);
            var U = r("#drives-tmpl").html();
            i.parse(U);
            var V;
            r(e).on("changed", h), r(e.blockdev_io).on("changed", h);
            var L = r("#others-tmpl").html();
            i.parse(L), r(e).on("changed", v);
            var B = r("#mounts-tmpl").html();
            i.parse(B), r(e).on("changed", g), r(e.fsys_sizes).on("changed", g);
            var $ = r("#nfs-mounts-tmpl").html();
            i.parse($);
            var W = r("#nfs-users-tmpl").html();
            i.parse(W), r("#storage").on("click", "#nfs-mounts .nfs-arm-button", function(e) {
            ...
            r.extend(G.yaxis, {
                ...
                hoverable: !0,
                autoHighlight: !1
            }), G.setup_hook = T("#storage-reading-unit");
            var q = a.plot(r("#storage-reading-graph"), 300);
            q.set_options(G), A = q.add_metrics_stacked_instances_series(H, {}), q.start_walking(), 
            r(A).on("hover", E);
            var Y = {
            ...
            r.extend(J.yaxis, {
                ...
                hoverable: !0,
                autoHighlight: !1
            }), J.setup_hook = T("#storage-writing-unit");
            var X = a.plot(r("#storage-writing-graph"), 300);
            X.set_options(J), I = X.add_metrics_stacked_instances_series(Y, {}), X.start_walking(), 
            r(I).on("hover", E), r(window).on("resize", function() {
                q.resize(), X.resize();
            });
            var K = a.setup_plot_controls(r("#storage"), r("#storage-graph-toolbar"));
            return K.reset([ q, X ]), n(), p(), m(), h(), v(), g(), b(), w(), r("#storage-log").append(s.logbox([ "_SYSTEMD_UNIT=storaged.service", "+", "_SYSTEMD_UNIT=udisks2.service", "+", "_SYSTEMD_UNIT=dm-event.service", "+", "_SYSTEMD_UNIT=smartd.service", "+", "_SYSTEMD_UNIT=multipathd.service" ], 10)), 
            r("#create-mdraid").on("click", function() {
                ...
                l.reset_arming_zone(r(this)), D(r(this).attr("data-iscsi-session-remove"));
            }), {
                show: P,
                hide: O
            };
