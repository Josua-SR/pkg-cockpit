!function(e) {
    ...
    !function() {
        function e() {
            function e() {
                ...
                r.location = ""), t("body").show();
            }
            function n() {
                var e = !p.state || "running" === p.state, n = o.broken_multipath_present === !0;
                t("#multipath-broken").toggle(n && !e);
            }
            var u, d, f;
            t("body").on("click", "[data-goto-block]", function() {
                r.location.go([ t(this).attr("data-goto-block") ]);
            }), t("body").on("click", "[data-goto-mdraid]", function() {
                r.location.go([ "mdraid", t(this).attr("data-goto-mdraid") ]);
            }), t("body").on("click", "[data-goto-vgroup]", function() {
                r.location.go([ "vg", t(this).attr("data-goto-vgroup") ]);
            }), l.init_arming_zones(t("body")), o.init(function() {
                r.translate(), o.features === !1 ? (t("#unsupported").show(), t("body").show()) : (u = i.init(o), 
                d = a.init(o, u), f = s.init(o, u), t(r).on("locationchanged", e), e());
            });
            var p = l.get_multipathd_service();
            t(p).on("changed", n), t(o).on("changed", n), n(), t("#activate-multipath").on("click", function() {
                r.spawn([ "mpathconf", "--enable", "--with_multipathd", "y" ], {
                    superuser: "try"
                }).fail(function(e) {
        ...
        var t = n(6), r = n(7), o = n(8), i = n(16), a = n(17), s = n(31), l = n(9);
    ...
    !function() {
        function t(e, t) {
            ...
            function r(e) {
                for (var t = !1, n = 0; n < e.length; n++) for (var r = e[n], o = 0; o < r.length; o++) for (var s = r[o], l = 0; l < s.length; l++) null !== s[l] && (t = !0, 
                a.data[i[o][l]][o] = s[l]);
        ...
        function i() {
            b.storaged_client.watch({
                path_namespace: _
            }), b.mdraids = o("MDRaid"), b.vgroups = o("VolumeGroup"), b.lvols = o("LogicalVolume"), 
            b.drives = o("Drive"), b.drives_ata = o("Drive.Ata"), b.blocks = o("Block"), b.blocks_ptable = o("PartitionTable"), 
            b.blocks_part = o("Partition"), b.blocks_lvm2 = o("Block.LVM2"), b.blocks_pvol = o("PhysicalVolume"), 
            b.blocks_fsys = o("Filesystem"), b.blocks_crypto = o("Encrypted"), b.blocks_swap = o("Swapspace"), 
            b.iscsi_sessions = o("ISCSI.Session"), b.jobs = o("Job");
        }
        function a(e) {
        ...
        function s() {
            ...
            for (r in b.drives) b.drives_multipath_blocks[r] = [];
            for (r in b.blocks) o = b.blocks[r], b.blocks_part[r] || void 0 === b.drives_multipath_blocks[o.Drive] || (a(o) ? b.drives_block[o.Drive] = o : b.drives_multipath_blocks[o.Drive].push(o));
            for (r in b.drives_multipath_blocks) b.drives_block[r] || 1 != b.drives_multipath_blocks[r].length ? (b.drives_multipath_blocks[r].sort(p.block_cmp), 
            b.drives_block[r] || (b.broken_multipath_present = !0)) : (b.drives_block[r] = b.drives_multipath_blocks[r][0], 
            b.drives_multipath_blocks[r] = []);
            b.mdraids_block = {};
            for (r in b.blocks) o = b.blocks[r], "/" != o.MDRaid && (b.mdraids_block[o.MDRaid] = o);
            b.mdraids_members = {};
            for (r in b.mdraids) b.mdraids_members[r] = [];
            for (r in b.blocks) o = b.blocks[r], void 0 !== b.mdraids_members[o.MDRaidMember] && b.mdraids_members[o.MDRaidMember].push(o);
            for (r in b.mdraids_members) b.mdraids_members[r].sort(p.block_cmp);
            b.slashdevs_block = {};
            for (r in b.blocks) for (o = b.blocks[r], e(o, o.Device), e(o, o.PreferredDevice), 
            d = 0; d < o.Symlinks.length; d++) e(o, o.Symlinks[d]);
            b.uuids_mdraid = {};
            for (r in b.mdraids) i = b.mdraids[r], b.uuids_mdraid[i.UUID] = i;
            b.vgnames_vgroup = {};
            for (r in b.vgroups) s = b.vgroups[r], b.vgnames_vgroup[s.Name] = s;
            b.vgroups_pvols = {};
            for (r in b.vgroups) b.vgroups_pvols[r] = [];
            for (r in b.blocks_pvol) l = b.blocks_pvol[r], void 0 !== b.vgroups_pvols[l.VolumeGroup] && b.vgroups_pvols[l.VolumeGroup].push(l);
            for (r in b.vgroups_pvols) b.vgroups_pvols[r].sort(t);
            b.vgroups_lvols = {};
            for (r in b.vgroups) b.vgroups_lvols[r] = [];
            for (r in b.lvols) c = b.lvols[r], void 0 !== b.vgroups_lvols[c.VolumeGroup] && b.vgroups_lvols[c.VolumeGroup].push(c);
            for (r in b.vgroups_lvols) b.vgroups_lvols[r].sort(function(e, t) {
                return e.Name.localeCompare(t.Name);
            });
            b.lvols_block = {};
            for (r in b.blocks_lvm2) b.lvols_block[b.blocks_lvm2[r].LogicalVolume] = b.blocks[r];
            b.lvols_pool_members = {};
            for (r in b.lvols) "pool" == b.lvols[r].Type && (b.lvols_pool_members[r] = []);
            for (r in b.lvols) c = b.lvols[r], void 0 !== b.lvols_pool_members[c.ThinPool] && b.lvols_pool_members[c.ThinPool].push(c);
            for (r in b.lvols_pool_members) b.lvols_pool_members[r].sort(function(e, t) {
                return e.Name.localeCompare(t.Name);
            });
            b.blocks_cleartext = {};
            for (r in b.blocks) o = b.blocks[r], "/" != o.CryptoBackingDevice && (b.blocks_cleartext[o.CryptoBackingDevice] = o);
            b.blocks_partitions = {};
            for (r in b.blocks_ptable) b.blocks_partitions[r] = [];
            for (r in b.blocks_part) u = b.blocks_part[r], void 0 !== b.blocks_partitions[u.Table] && b.blocks_partitions[u.Table].push(u);
            for (r in b.blocks_partitions) b.blocks_partitions[r].sort(function(e, t) {
                return e.Offset - t.Offset;
            });
            b.path_jobs = {};
            for (r in b.jobs) n(b.jobs[r]);
        }
        function l(e) {
            function t(e, n) {
                var r = e.pop();
            ...
            function o() {
                return b.manager.valid ? b.manager.EnableModules ? b.manager.EnableModules(!0).then(function() {
                    var e = f.defer();
                    return b.manager_lvm2 = r("Manager.LVM2", "Manager"), b.manager_iscsi = r("Manager.ISCSI.Initiator", "Manager"), 
        ...
        function c() {
            ...
            function s(t, n) {
                ...
                return e([ "stop-and-unmount", JSON.stringify(r), JSON.stringify(n) ]);
            }
            function l(t, n) {
                var r = t.map(function(e) {
                    return e.unit;
                });
                return e([ "stop-and-remove", JSON.stringify(r), JSON.stringify(n) ]);
            }
            function c(t) {
        ...
        function u() {
            ...
            var t = "org.storaged.Storaged", n = "/org/storaged/Storaged", r = "org.storaged.Storaged", o = f.dbus(t), i = o.proxy(r + ".Manager", n + "/Manager", {
                watch: !0
            });
        ...
        f.event_target(b);
        var y, _, k;
        b.time_offset = void 0, b.features = void 0, b.storaged_client = void 0, b.call = function(e, t, n, r, o) {
            return b.storaged_client.call(e, k + "." + t, n, r, o);
        }, b.fsys_sizes = t([ {
            name: "mount.used"
        }, {
            name: "mount.total"
    ...
    !function() {
        ...
        function r(e, t, n) {
            ...
            if (1 == e.nodeType) {
                ...
                for (o = e.firstChild, i = t.firstChild; ;) {
                    for (a = o, s = i; a && 1 != a.nodeType && 3 != a.nodeType; ) a = a.nextSibling;
                    for (;s && 1 != s.nodeType && 3 != s.nodeType; ) s = s.nextSibling;
                    if (!a && !s) break;
                    a ? s ? (o = a.nextSibling, i = s.nextSibling, r(a, s, (n || 0) + 1)) : (o = a.nextSibling, 
                    i = null, e.removeChild(a)) : (o = null, i = s.nextSibling, e.appendChild(t.removeChild(s)));
                }
            }
        }
        var o = n(6), i = n(7), a = n(10), s = n(12), l = i.gettext, c = i.gettext, u = {};
        u.compare_versions = function(e, t) {
            ...
            var r, o = n(e), i = n(t), a = Math.min(o.length, i.length);
            for (r = 0; r < a; r++) if (o[r] != i[r]) return o[r] - i[r];
            ...
            function n(e) {
                return s && o ? i.format(l("<span>Encrypted Logical Volume of $0</span>"), e) : r && o ? i.format(l("<span>Encrypted Partition of $0</span>"), e) : s ? i.format(l("<span>Logical Volume of $0</span>"), e) : r ? i.format(l("<span>Partition of $0</span>"), e) : o ? i.format(l("<span>Encrypted $0</span>"), e) : e;
            }
            for (var r, o, s; ;) if (e.blocks_part[t] && e.blocks_ptable[e.blocks_part[t].Table]) r = !0, 
            ...
            function n(t, o, i) {
                ...
                var s, l, c, u, d, f, p = o, m = o + i, h = [];
                for (s = 0; s < r.length; s++) l = e.blocks[r[s].path], c = r[s].Offset, u = r[s].Size, 
                d = r[s].IsContainer, f = r[s].IsContained, null !== l && (0 === t && f || (1 != t || f) && (c < o || c + u > o + i || (a(p, c - p), 
                d ? h.push({
                    type: "container",
                    block: l,
                    size: u,
            ...
            function t(t) {
                ...
                var o = e.blocks[t], i = e.blocks_ptable[t], a = e.blocks_part[t], s = e.blocks_pvol[t];
                return !(o.HintIgnore || !(o.Size > 0) || n() || r() || i || a && a.IsContainer);
            }
            function n(t) {
                var n = e.blocks[t], r = u.get_block_link_target(e, t), i = o("<div>").html(r.html).text();
                return {
                    type: "block",
                    block: n,
                    size: n.Size,
            ...
            function r(t) {
                var n, r, s, c, d = u.get_partitions(e, t);
                for (n in d) r = d[n], "free" == r.type && (s = u.get_block_link_target(e, t.path), 
        ...
        u.get_multipathd_service = function() {
            ...
            function r(n) {
                var o = e.blocks[n], i = e.blocks_fsys[n], a = o && e.mdraids[o.MDRaidMember], s = e.blocks_pvol[n], l = s && e.vgroups[s.VolumeGroup], c = u.flatten(t(e, n).map(r));
    ...
    e.exports = o.extend({}, i, {
        render: function(e, t, n) {
            return t || (t = {}), r(i.render(e, t, n));
        },
        to_html: function(e, t, n, o) {
            return t || (t = {}), r(i.to_html(e, t, n, o));
        },
        clearCache: function() {
    ...
    !function(n, a) {
        ...
        r = a, i = "function" == typeof r ? r.apply(t, o) : r, !(void 0 !== i && (e.exports = i)));
    }(this, function(e) {
        function t(e) {
        ...
        function l(t, n) {
            ...
            function i(e) {
                ...
                s = new RegExp(r(e[0]) + "\\s*"), l = new RegExp("\\s*" + r(e[1])), f = new RegExp("\\s*" + r("}" + e[1]));
            }
            if (!t) return [];
            var s, l, f, p = [], m = [], v = [], g = !1, b = !1;
            i(n || e.tags);
            for (var T, E, S, C, M, N, D = new d(t); !D.eos(); ) {
                if (T = D.pos, S = D.scanUntil(s)) for (var z = 0, O = S.length; z < O; ++z) C = S.charAt(z), 
                a(C) ? v.push(m.length) : b = !0, m.push([ "text", C, T, T + 1 ]), T += 1, "\n" === C && o();
                if (!D.scan(s)) break;
                if (g = !0, E = D.scan(w) || "name", D.scan(y), "=" === E ? (S = D.scanUntil(k), 
                D.scan(k), D.scanUntil(l)) : "{" === E ? (S = D.scanUntil(f), D.scan(x), D.scanUntil(l), 
                E = "&") : S = D.scanUntil(l), !D.scan(l)) throw new Error("Unclosed tag at " + D.pos);
                if (M = [ E, S, T, D.pos ], m.push(M), "#" === E || "^" === E) p.push(M); else if ("/" === E) {
                    if (N = p.pop(), !N) throw new Error('Unopened section "' + S + '" at ' + T);
                    if (N[1] !== S) throw new Error('Unclosed section "' + N[1] + '" at ' + T);
                } else "name" === E || "{" === E || "&" === E ? b = !0 : "=" === E && i(S);
            }
            if (N = p.pop()) throw new Error('Unclosed section "' + N[1] + '" at ' + D.pos);
            return u(c(m));
        }
        function c(e) {
        ...
        d.prototype.eos = function() {
            ...
            if (r.hasOwnProperty(e)) n = r[e]; else {
                for (var i, a, s = this, l = !1; s; ) {
                    if (e.indexOf(".") > 0) for (n = s.view, i = e.split("."), a = 0; null != n && a < i.length; ) a === i.length - 1 && (l = o(n, i[a])), 
                    n = n[i[a++]]; else n = s.view[e], l = o(s.view, e);
                    if (l) break;
                    s = s.parent;
                }
                r[e] = n;
            ...
            for (var o, i, a, s = "", l = 0, c = e.length; l < c; ++l) a = void 0, o = e[l], 
            i = o[0], "#" === i ? a = this.renderSection(o, t, n, r) : "^" === i ? a = this.renderInverted(o, t, n, r) : ">" === i ? a = this.renderPartial(o, t, n, r) : "&" === i ? a = this.unescapedValue(o, t) : "name" === i ? a = this.escapedValue(o, t) : "text" === i && (a = this.rawValue(o)), 
            void 0 !== a && (s += a);
            return s;
            ...
            if (l) {
                if (h(l)) for (var c = 0, u = l.length; c < u; ++c) s += this.renderTokens(e[4], n.push(l[c]), r, o); else if ("object" == typeof l || "string" == typeof l || "number" == typeof l) s += this.renderTokens(e[4], n.push(l), r, o); else if (t(l)) {
                    if ("string" != typeof o) throw new Error("Cannot use higher-order sections without the original template");
                    l = l.call(n.view, o.slice(e[3], e[5]), i), null != l && (s += l);
                } else s += this.renderTokens(e[4], n, r, o);
                return s;
            }
        }, p.prototype.renderInverted = function(e, t, n, r) {
            var o = t.lookup(e[1]);
            if (!o || h(o) && 0 === o.length) return this.renderTokens(e[4], t, n, r);
        ...
        }, e.escape = s, e.Scanner = d, e.Context = f, e.Writer = p;
    });
}, function(e, t, n) {
    "use strict";
    !function() {
    ...
    function o(e, t, n) {
        var r;
        return r = "string" == typeof e ? e : e.join("\n"), a.default.spawn(s.concat(t), n).input(r);
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.spawn = o;
    var i = n(7), a = r(i), s = [ "sh", "-ec", "exec $(which python3 2>/dev/null || which python) $@", "--", "-" ];
}, function(e, t) {
    ...
    !function() {
        function t(e) {
            function t(t) {
                function n(e) {
                    r(t).find('[data-job-object="' + e + '"]').css("visibility", "visible");
                }
                function o(t) {
                    n(t);
                    var r = a.get_parent(e, t);
                    r && o(r);
                }
                function i(e) {
                    if (e && e.length) for (var t = 0; t < e.length; t++) o(e[t]);
                }
                var s;
                r(t).find("[data-job-object]").css("visibility", "hidden");
            ...
            function n() {
                function t(t) {
                    ...
                    var r = t.Objects.map(function(t) {
                ...
                function i(e) {
                    var t = n(e), r = u - t.StartTime / 1e3;
                    return r >= 2e3 || t.ExpectedEndTime > 0 && t.ExpectedEndTime / 1e3 - u >= 2e3;
                }
                function l(e) {
                    var r = n(e), o = null;
                    if (r.ExpectedEndTime > 0) {
                        var i = r.ExpectedEndTime / 1e3 - u;
                        i > 0 && (o = a.format_delay(i));
                    }
                    return {
                        path: e,
                        dbus: r,
                        Description: t(r),
                        Progress: r.ProgressValid && (100 * r.Progress).toFixed() + "%",
                        RemainingTime: o,
                ...
                return Object.keys(e.jobs).filter(i).sort(r).map(l);
            }
            function l() {
                var e = n();
                return i.render(c, {
            ...
            var c = r("#jobs-tmpl").html();
            return i.parse(c), r(e.jobs).on("added removed changed", function() {
                t("body");
            }), {
                update: t,
                query: n,
        ...
        var r = n(6), o = n(7), i = n(10), a = n(9), s = o.gettext;
        e.exports = {
            init: t
        };
    }();
    ...
    !function() {
        function t(e, t) {
            ...
            function m() {
                ...
                r("#iscsi-sessions").amend(i.render(U, {
                    Sessions: o,
            ...
            function h() {
                ...
                function a(t) {
                    var n = e.drives[t], r = e.drives_block[t];
                    if (r || (r = e.drives_multipath_blocks[t][0]), r) {
                        var i, a = l.decode_filename(r.Device).replace(/^\/dev\//, ""), s = e.blockdev_io.data[a], c = l.drive_name(n), u = o(n), d = l.fmt_size(n.Size);
            ...
            function v() {
                function t(t) {
                    var n = e.blocks[t], r = e.blocks_part[t], o = e.blocks_lvm2[t];
                    return !(r && "/" != r.Table || "/" != n.Drive || "/" != n.CryptoBackingDevice || "/" != n.MDRaid || o && "/" != o.LogicalVolume || n.HintIgnore || !(n.Size > 0));
                }
                function n(t) {
                    var n = e.blocks[t], r = l.block_name(n);
                    return {
                        path: t,
                        dev: r.replace(/^\/dev\//, ""),
                        Name: r,
            ...
            function g() {
                function n(t) {
                    var n = e.blocks[t], r = e.blocks_fsys[t];
                    return r && "filesystem" == n.IdUsage && "mpath_member" != n.IdType && !n.HintIgnore;
                }
                function o(t, n) {
                    return e.blocks[t].IdLabel.localeCompare(e.blocks[n]).IdLabel;
                }
                function a(t) {
                    for (var n, r = e.blocks[t], o = e.blocks_fsys[t], i = o.MountPoints.map(l.decode_filename), a = 0; a < i.length && !n; a++) n = e.fsys_sizes.data[i[a]];
                    return {
                        LinkTarget: l.get_block_link_target(e, t),
                        Name: r.IdLabel || l.block_name(r),
                        DeviceSize: l.fmt_size(r.Size),
                ...
                r("#mounts").amend(i.render($, {
                    Mounts: s,
                    HasMounts: s.length > 0
                })), r("#mounts [data-width]").each(function() {
                    r(this).css("width", r(this).attr("data-width"));
                }), u.update(), t.update("#mounts");
            }
            function b() {
                function t(t, n) {
                    var r;
                    return t.mounted && (r = e.nfs.get_fsys_size(t)), {
                        Server: t.fields[0].split(":")[0],
                        RemoteDir: t.fields[0].split(":")[1],
                        UsageText: r ? l.format_fsys_usage(r[0], r[1]) : null,
                        UsagePercent: r ? r[0] / r[1] * 100 : null,
                        UsageCritical: r && r[0] > .95 * r[1],
                ...
                var n = e.nfs.entries.map(t), o = r("#nfs-mounts .nfs-arm-button").hasClass("active");
                r("#nfs-mounts").amend(i.render(W, {
                    armed: o,
                    Mounts: n,
                    HasMounts: n.length > 0
                })), r("#nfs-mounts [data-width]").each(function() {
                    r(this).css("width", r(this).attr("data-width"));
                });
            }
            function y() {
                r("#nfs-mounts .nfs-arm-button").removeClass("active"), b();
            }
            function _(e, t) {
                t.fail(function(t, n) {
                    r("#error-popup-title").text(e), r("#error-popup-message").text(t.toString()), r("#error-popup").modal("show");
                });
            }
            function k(t, n, o, i, a) {
                function s(e) {
                    0 === e.length ? (r("#error-popup-title").text(t), r("#error-popup-message").text(o.toString()), 
                    r("#error-popup").modal("show")) : c.open({
                        Title: t,
                        Teardown: {
                            HasUnits: !0,
            ...
            function x(t) {
                function n(e) {
                    ...
                    var t = o.defer();
                    return a = t, o.spawn([ "showmount", "-e", "--no-headers", i ], {
                        err: "message"
                    }).done(function(e) {
                        if (t == a) {
                            var n = [];
                ...
                function r(r) {
                    c.open({
                        ...
                        Action: {
                            Title: d(t ? "Apply" : "Add"),
                            action: function(n) {
                                var r = [ n.server + ":" + n.remote, n.dir, t ? t.fields[2] : "nfs", n.opts ];
            ...
            function w() {
                r("#jobs").amend(t.render()), u.update();
            }
            function T(e) {
                var t = e.getAxes();
            ...
            function E(e) {
                return function(t) {
                    var n = t.getAxes();
                    r(e).text(a.bytes_per_sec_tick_unit(n.yaxis));
                };
            }
            function S(e, t) {
                L = t, h();
            ...
            function M(t, n) {
                ...
                return (n.username || n.password) && (r.username = {
                    t: "s",
                    v: n.username
                }, r.password = {
                    t: "s",
                    v: n.password
                }), e.manager_iscsi.call("Login", [ t[0], t[1], t[2], t[3], t[4], r ]);
            }
            function N(e, t) {
            ...
            function z(t) {
                ...
                if (n) {
                    ...
                    n.Logout(o).fail(function(e) {
                        r("#error-popup-title").text(d("Error")), r("#error-popup-message").text(e.toString()), 
                        r("#error-popup").modal("show");
                    });
                }
            }
            function O() {
            ...
            function A() {
                r("#storage").show(), Y.resize(), K.resize();
            }
            var I, R;
            r("#vgroups").toggle(e.features.lvm2), r("#iscsi-sessions").toggle(e.features.iscsi);
            var F = r("#mdraids-tmpl").html();
            i.parse(F), r(e).on("changed", n);
            var j = r("#vgroups-tmpl").html();
            i.parse(j), r(e).on("changed", p);
            var U = r("#iscsi-sessions-tmpl").html();
            i.parse(U), r(e).on("changed", m);
            var V = r("#drives-tmpl").html();
            i.parse(V);
            var L;
            r(e).on("changed", h), r(e.blockdev_io).on("changed", h);
            var B = r("#others-tmpl").html();
            i.parse(B), r(e).on("changed", v);
            var $ = r("#mounts-tmpl").html();
            i.parse($), r(e).on("changed", g), r(e.fsys_sizes).on("changed", g);
            var W = r("#nfs-mounts-tmpl").html();
            i.parse(W);
            var H = r("#nfs-users-tmpl").html();
            i.parse(H), r("#storage").on("click", "#nfs-mounts .nfs-arm-button", function(e) {
                r(this).toggleClass("active"), b();
            }), r("#storage").on("click", '[data-action="mount-mount"]', function() {
                var t = r(this).attr("data-arg"), n = e.nfs.entries[t];
                return _("Could not mount the filesystem", e.nfs.mount_entry(n)), y(), !1;
            }), r("#storage").on("click", '[data-action="mount-unmount"]', function() {
                var t = r(this).attr("data-arg"), n = e.nfs.entries[t];
            ...
            }), r("#storage").on("click", '[data-action="mount-edit"]', function() {
                var t = r(this).attr("data-arg"), n = e.nfs.entries[t];
                return n && x(n), y(), !1;
            }), r("#storage").on("click", '[data-action="mount-add"]', function() {
                return x(null), !1;
            }), r("#storage").on("click", '[data-action="mount-remove"]', function() {
                var t = r(this).attr("data-arg"), n = e.nfs.entries[t];
            ...
            }), r(e.nfs).on("changed", b), r(e).on("changed", w);
            var G = {
            ...
            var Y = a.plot(r("#storage-reading-graph"), 300);
            ...
            var K = a.plot(r("#storage-writing-graph"), 300);
            K.set_options(X), R = K.add_metrics_stacked_instances_series(J, {}), K.start_walking(), 
            r(R).on("hover", S), r(window).on("resize", function() {
                Y.resize(), K.resize();
            });
            var Q = a.setup_plot_controls(r("#storage"), r("#storage-graph-toolbar"));
            return Q.reset([ Y, K ]), n(), p(), m(), h(), v(), g(), b(), w(), r("#storage-log").append(s.logbox([ "_SYSTEMD_UNIT=storaged.service", "+", "_SYSTEMD_UNIT=udisks2.service", "+", "_SYSTEMD_UNIT=dm-event.service", "+", "_SYSTEMD_UNIT=smartd.service", "+", "_SYSTEMD_UNIT=multipathd.service" ], 10)), 
            r("#create-mdraid").on("click", function() {
                c.open({
            ...
            }), r("#create-volume-group").on("click", function() {
                function t(t) {
                    for (var n in e.vgroups) if (e.vgroups[n].Name == t) return e.vgroups[n];
                    return null;
                }
                for (var n, r = 0; r < 1e3 && (n = "vgroup" + r.toFixed(), t(n)); r++) ;
                c.open({
            ...
            }), r("#storage").on("click", '[data-action="add-iscsi-portal"]', function() {
                C();
            }), r("#storage").on("click", '[data-action="edit-iscsi"]', function() {
                O();
            }), r("#storage").on("click", "[data-iscsi-session-remove]", function() {
                l.reset_arming_zone(r(this)), z(r(this).attr("data-iscsi-session-remove"));
            }), {
                show: A,
                hide: P
            };
        }
        var r = n(6), o = n(7), i = n(10), a = n(18), s = n(22), l = n(9), c = n(26), u = n(30), d = o.gettext, f = o.gettext;
        e.exports = {
            init: t
        };
    }();
    ...
    function r(e, t, n, r) {
        ...
        function l() {
            v && g.width() > 0 && g.height() > 0 ? (p ? d() : (i(), p = o.plot(b, n, h)), y && window.clearInterval(y)) : y || (y = window.setInterval(l, 500));
        }
        function c() {
            v = !1;
        }
        function u() {
            p && v && (p.setData(n), r.setup_hook && r.setup_hook(p), p.setupGrid(), p.draw(), 
            r.post_hook && r.post_hook(p));
        }
        function d() {
    ...
    a.plot = function(e, t, n) {
        function r() {
            if (0 !== e.height() && 0 !== e.width()) {
                null === M && (M = o.plot(e, C, T)), M.setData(C);
                var t = M.getAxes();
        ...
        function c(e, t) {
            ...
            var r = -Math.ceil((1e3 * e + n) / x), s = -Math.floor(n / x);
            if (w && w.interval == x) w.move(r, s); else {
                w && w.close(), w = i.grid(x, r, s), D++;
                for (var l = 0; l < S.length; l++) S[l].reset();
                D--, u(), o(w).on("notify", function(e, t, n) {
                    a();
                });
            }
        }
        ...
        function d() {
            ...
            T = {}, S = [], C = [], M = null, o(e).empty(), o(e).data("flot_data", null);
        }
        function f() {
        ...
        function h(e, t) {
            ...
            function p() {
                function n() {
                    v.archives && !E.archives && (E.archives = !0, o(E).triggerHandler("changed"));
                }
                v && v.close(), v = i.metrics(x, b);
                var r = w.add(v, []), a = e.factor || 1;
                t.data = w.add(function(e, t, n) {
                    for (var o = 0; o < n; o++) e[t + o] = [ (w.beg + t + o) * x, f(r[t + o]) * a ];
        ...
        function v(e, t) {
            ...
            function a() {
                function e() {
                    f.archives && !E.archives && (E.archives = !0, o(E).triggerHandler("changed"));
                }
                f && f.close(), f = i.metrics(x, m), o(f).on("changed", e), e(), D++;
            ...
            function s(n, r) {
                function i() {
                    s = w.add(f, [ "a", n ]), l.data = w.add(function(e, t, n) {
                        for (var r = 0; r < n; r++) {
                            var o = (s[t + r] || 0) * c, i = (w.beg + t + r) * x, a = 0;
                            p && (a = p.data[t + r][1] ? p.data[t + r][1] : p.data[t + r][2]), Math.abs(o) > d ? (e[t + r] = [ i, a + o, a ], 
                            e[t + r - 1] && null === e[t + r - 1][1] && (e[t + r - 1][1] = e[t + r - 1][2])) : (e[t + r] = [ i, null, a ], 
                            e[t + r - 1] && null !== e[t + r - 1][1] && (e[t + r - 1][1] = e[t + r - 1][2]));
                        }
                    }), u();
                }
                function a() {
            ...
            function c(e, t) {
                var n, r;
                if (!w) return !1;
                r = Math.round(e.x / x) - w.beg, r < 0 && (r = 0);
                for (n in h) {
                    var o = h[n].data;
                    if (o[r] && o[r][1] && o[r][2] <= e.y && e.y <= o[r][1]) return h[n].selector || n;
                }
                return !1;
            }
            function d(e) {
        ...
        function b(e, t, n) {
            for (var r = null, o = !1, i = 0; i < S.length; i++) if (o = S[i].hover_hit(t, n)) {
                r = S[i];
                break;
            }
            g(r, o);
        ...
        function _(e, t) {
            t && o(E).triggerHandler("zoomstart", []);
        }
        function k(e, t) {
            M.clearSelection(!0), o(E).triggerHandler("zoom", [ (t.xaxis.to - t.xaxis.from) / 1e3, t.xaxis.to / 1e3 ]);
        }
        var x, w, T = {}, E = {}, S = [], C = [], M = null, N = !1, D = 0, z = null, O = !1;
        return o(e).on("plothover", b), o(e).on("mouseleave", y), o(e).on("plotselecting", _), 
        o(e).on("plotselected", k), o(e).data("flot_data", C), c(t, n), o.extend(E, {
            archives: !1,
            start_walking: s,
            stop_walking: l,
            refresh: a,
    ...
    a.plot_simple_template = function() {
        ...
        for (var t = Math.pow(2, Math.ceil(Math.log(e.max / 5) / Math.LN2)), n = [], r = 0; r < e.max; r += t) n.push(r);
        return n;
    };
    ...
    a.format_date_tick = function(e, t) {
        ...
        var r, o, i = 0, a = 1, s = 2, l = 3, u = t.tickSize[1];
        o = "minute" == u || "hour" == u ? l : "day" == u ? s : "month" == u ? a : i;
        var d = new Date(), f = new Date(t.min);
        r = i, f.getFullYear() == d.getFullYear() && (r = a, f.getMonth() == d.getMonth() && (r = s, 
        f.getDate() == d.getDate() && (r = l))), r > o && (r = o), r == s && (r = a);
        var p = new Date(e), m = " ";
        return i >= r && i <= o && (m += p.getFullYear().toFixed() + " "), a >= r && a <= o && (m += c[p.getMonth()] + " "), 
        s >= r && s <= o && (m += p.getDate().toFixed() + " "), l >= r && l <= o && (m += n(p.getHours()) + ":" + n(p.getMinutes()) + " "), 
        ...
        function i(e, t) {
            return e.add(function(e, n, r) {
                for (var o = 0; o < r; o++) e[n + o] = [ o, t[n + o] || 0 ];
            });
        }
        function a(e, t, n) {
            return e.add(function(e, r, o) {
                var i, a, s, l;
                for (i = 0; i < o; i++) s = 0, n && (a = n[r + i], s = a ? a[1] : 0), l = t[r + i] || 0, 
                e[r + i] = [ i, l + s, s ];
            });
        }
        var s = null;
        return n.forEach(function(e, n) {
            o.x_rh_stack_graphs ? e.data = a(t, e.row, s) : e.data = i(t, e.row), s = e.data;
        }), r(e, t, n, o);
    }, e.exports = a;
}, function(e, t) {
    !function(e) {
        e.color = {}, e.color.make = function(t, n, r, o) {
            var i = {};
            return i.r = t || 0, i.g = n || 0, i.b = r || 0, i.a = null != o ? o : 1, i.add = function(e, t) {
            ...
            var r;
            do {
                if (r = t.css(n).toLowerCase(), "" != r && "transparent" != r) break;
                t = t.parent();
            } while (t.length && !e.nodeName(t.get(0), "body"));
            return "rgba(0, 0, 0, 0)" == r && (r = "transparent"), e.color.parse(r);
        }, e.color.parse = function(n) {
            var r, o = e.color.make;
            if (r = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(n)) return o(parseInt(r[1], 10), parseInt(r[2], 10), parseInt(r[3], 10));
            if (r = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]+(?:\.[0-9]+)?)\s*\)/.exec(n)) return o(parseInt(r[1], 10), parseInt(r[2], 10), parseInt(r[3], 10), parseFloat(r[4]));
            if (r = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(n)) return o(2.55 * parseFloat(r[1]), 2.55 * parseFloat(r[2]), 2.55 * parseFloat(r[3]));
            if (r = /rgba\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\s*\)/.exec(n)) return o(2.55 * parseFloat(r[1]), 2.55 * parseFloat(r[2]), 2.55 * parseFloat(r[3]), parseFloat(r[4]));
            if (r = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(n)) return o(parseInt(r[1], 16), parseInt(r[2], 16), parseInt(r[3], 16));
            if (r = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(n)) return o(parseInt(r[1] + r[1], 16), parseInt(r[2] + r[2], 16), parseInt(r[3] + r[3], 16));
            var i = e.trim(n).toLowerCase();
            return "transparent" == i ? o(255, 255, 255, 0) : (r = t[i] || [ 0, 0, 0 ], o(r[0], r[1], r[2]));
        };
        var t = {
            aqua: [ 0, 255, 255 ],
            azure: [ 240, 255, 255 ],
        ...
        function t(t, n) {
            ...
            if (null == r && (r = document.createElement("canvas"), r.className = t, e(r).css({
                direction: "ltr",
                position: "absolute",
                left: 0,
                top: 0
            ...
            this.element = r;
            var o = this.context = r.getContext("2d"), i = window.devicePixelRatio || 1, a = o.webkitBackingStorePixelRatio || o.mozBackingStorePixelRatio || o.msBackingStorePixelRatio || o.oBackingStorePixelRatio || o.backingStorePixelRatio || 1;
        ...
        function n(n, o, i, a) {
            ...
            function c(t) {
                ...
                var r, o, i, a = n.css("font-size"), l = a ? +a.replace("px", "") : 13, c = {
                ...
                for (i = oe.xaxes.length || 1, r = 0; r < i; ++r) o = oe.xaxes[r], o && !o.tickColor && (o.tickColor = o.color), 
                o = e.extend(!0, {}, oe.xaxis, o), oe.xaxes[r] = o, o.font && (o.font = e.extend({}, c, o.font), 
                o.font.color || (o.font.color = o.color), o.font.lineHeight || (o.font.lineHeight = Math.round(1.15 * o.font.size)));
                for (i = oe.yaxes.length || 1, r = 0; r < i; ++r) o = oe.yaxes[r], o && !o.tickColor && (o.tickColor = o.color), 
                o = e.extend(!0, {}, oe.yaxis, o), oe.yaxes[r] = o, o.font && (o.font = e.extend({}, c, o.font), 
                o.font.color || (o.font.color = o.color), o.font.lineHeight || (o.font.lineHeight = Math.round(1.15 * o.font.size)));
                ...
                null != oe.highlightColor && (oe.series.highlightColor = oe.highlightColor), r = 0; r < oe.xaxes.length; ++r) v(ue, r + 1).options = oe.xaxes[r];
                for (r = 0; r < oe.yaxes.length; ++r) v(de, r + 1).options = oe.yaxes[r];
            ...
            function d(t) {
                for (var n = [], r = 0; r < t.length; ++r) {
                    ...
                    null != t[r].data ? (o.data = t[r].data, delete t[r].data, e.extend(!0, o, t[r]), 
                    t[r].data = o.data) : o.data = t[r], n.push(o);
                }
                return n;
            }
            function f(e, t) {
            ...
            function m(e) {
                var t, n, r = {};
                for (t = 0; t < ue.length; ++t) n = ue[t], n && n.used && (r["x" + n.n] = n.c2p(e.left));
                for (t = 0; t < de.length; ++t) n = de[t], n && n.used && (r["y" + n.n] = n.c2p(e.top));
                return void 0 !== r.x1 && (r.x = r.x1), void 0 !== r.y1 && (r.y = r.y1), r;
            }
            function h(e) {
                var t, n, r, o = {};
                for (t = 0; t < ue.length; ++t) if (n = ue[t], n && n.used && (r = "x" + n.n, null == e[r] && 1 == n.n && (r = "x"), 
                null != e[r])) {
                    o.left = n.p2c(e[r]);
                    break;
                }
                for (t = 0; t < de.length; ++t) if (n = de[t], n && n.used && (r = "y" + n.n, null == e[r] && 1 == n.n && (r = "y"), 
                null != e[r])) {
                    o.top = n.p2c(e[r]);
                    break;
                }
            ...
            function g() {
                var t, n = re.length, r = -1;
                for (t = 0; t < re.length; ++t) {
                    var o = re[t].color;
                    null != o && (n--, "number" == typeof o && o > r && (r = o));
                }
                n <= r && (n = r + 1);
                var i, a = [], s = oe.colors, l = s.length, c = 0;
                for (t = 0; t < n; t++) i = e.color.parse(s[t % l] || "#666"), t % l == 0 && t && (c = c >= 0 ? c < .5 ? -c - .2 : 0 : -c), 
                a[t] = i.scale("rgb", 1 + c);
                var u, d = 0;
                for (t = 0; t < re.length; ++t) {
                    if (u = re[t], null == u.color ? (u.color = a[d].toString(), ++d) : "number" == typeof u.color && (u.color = a[u.color].toString()), 
                    null == u.lines.show) {
                        var p, m = !0;
            ...
            function b() {
                ...
                var n, r, o, i, a, l, c, u, d, f, m, h, v = Number.POSITIVE_INFINITY, g = Number.NEGATIVE_INFINITY, b = Number.MAX_VALUE;
                for (e.each(p(), function(e, t) {
                    t.datamin = v, t.datamax = g, t.used = !1;
                }), n = 0; n < re.length; ++n) a = re[n], a.datapoints = {
                    points: []
                }, s(he.processRawData, [ a, a.data, a.datapoints ]);
                for (n = 0; n < re.length; ++n) {
                    if (a = re[n], m = a.data, h = a.datapoints.format, !h) {
                        if (h = [], h.push({
                            x: !0,
                            number: !0,
                            required: !0
                    ...
                    if (null == a.datapoints.pointsize) {
                        ...
                        for (a.xaxis.used = a.yaxis.used = !0, r = o = 0; r < m.length; ++r, o += c) {
                            f = m[r];
                            var k = null == f;
                            if (!k) for (i = 0; i < c; ++i) u = f[i], d = h[i], d && (d.number && null != u && (u = +u, 
                            isNaN(u) ? u = null : u == 1 / 0 ? u = b : u == -(1 / 0) && (u = -b)), null == u && (d.required && (k = !0), 
                            null != d.defaultValue && (u = d.defaultValue))), l[o + i] = u;
                            if (k) for (i = 0; i < c; ++i) u = l[o + i], null != u && (d = h[i], d.autoscale !== !1 && (d.x && t(a.xaxis, u, u), 
                            d.y && t(a.yaxis, u, u))), l[o + i] = null; else if (_ && o > 0 && null != l[o - c] && l[o - c] != l[o] && l[o - c + 1] != l[o + 1]) {
                                for (i = 0; i < c; ++i) l[o + c + i] = l[o + i];
                                l[o + 1] = l[o - c + 1], o += c;
                            }
                        }
                    }
                }
                for (n = 0; n < re.length; ++n) a = re[n], s(he.processDatapoints, [ a, a.datapoints ]);
                for (n = 0; n < re.length; ++n) {
                    a = re[n], l = a.datapoints.points, c = a.datapoints.pointsize, h = a.datapoints.format;
                    var x = v, w = v, T = g, E = g;
                    for (r = 0; r < l.length; r += c) if (null != l[r]) for (i = 0; i < c; ++i) u = l[r + i], 
            ...
            function y() {
                ...
                var r = n.data("plot");
                r && (r.shutdown(), ae.clear()), n.data("plot", ve);
            }
            function _() {
            ...
            function x(e) {
                ...
                var n, r, o = e.options.transform || t, i = e.options.inverseTransform;
                "x" == e.direction ? (n = e.scale = pe / Math.abs(o(e.max) - o(e.min)), r = Math.min(o(e.max), o(e.min))) : (n = e.scale = me / Math.abs(o(e.max) - o(e.min)), 
                n = -n, r = Math.max(o(e.max), o(e.min))), o == t ? e.p2c = function(e) {
                    return (e - r) * n;
                } : e.p2c = function(e) {
                    return (o(e) - r) * n;
                }, i ? e.c2p = function(e) {
            ...
            function w(e) {
                for (var t = e.options, n = e.ticks || [], r = t.labelWidth || 0, o = t.labelHeight || 0, i = r || ("x" == e.direction ? Math.floor(ie.width / (n.length || 1)) : null), a = e.direction + "Axis " + e.direction + e.n + "Axis", s = "flot-" + e.direction + "-axis flot-" + e.direction + e.n + "-axis " + a, l = t.font || "flot-tick-label tickLabel", c = 0; c < n.length; ++c) {
                    var u = n[c];
                    if (u.label) {
                        var d = ie.getTextInfo(s, u.label, l, null, i);
                        r = Math.max(r, d.width), o = Math.max(o, d.height);
                    }
                }
                e.labelWidth = t.labelWidth || r, e.labelHeight = t.labelHeight || o;
            }
            function T(t) {
                var n = t.labelWidth, r = t.labelHeight, o = t.options.position, i = "x" === t.direction, a = t.options.tickLength, s = oe.grid.axisMargin, l = oe.grid.labelMargin, c = !0, u = !0, d = !0, f = !1;
                e.each(i ? ue : de, function(e, n) {
                    n && (n.show || n.reserveSpace) && (n === t ? f = !0 : n.options.position === o && (f ? u = !1 : c = !1), 
                    f || (d = !1));
                }), u && (s = 0), null == a && (a = d ? "full" : 5), isNaN(+a) || (l += +a), i ? (r += l, 
                "bottom" == o ? (fe.bottom += r + s, t.box = {
                    top: ie.height - fe.bottom,
                    height: r
                }) : (t.box = {
                    top: fe.top + s,
                    height: r
                }, fe.top += r + s)) : (n += l, "left" == o ? (t.box = {
                    left: fe.left + s,
                    width: n
            ...
            function S() {
                ...
                if (null == n) for (n = 0, t = 0; t < re.length; ++t) n = Math.max(n, 2 * (re[t].points.radius + re[t].points.lineWidth / 2));
                var r = {
                    left: n,
                    right: n,
                    top: n,
                ...
                e.each(p(), function(e, t) {
                    t.reserveSpace && t.ticks && t.ticks.length && ("x" === t.direction ? (r.left = Math.max(r.left, t.labelWidth / 2), 
                    r.right = Math.max(r.right, t.labelWidth / 2)) : (r.bottom = Math.max(r.bottom, t.labelHeight / 2), 
                    r.top = Math.max(r.top, t.labelHeight / 2)));
                }), fe.left = Math.ceil(Math.max(r.left, fe.left)), fe.right = Math.ceil(Math.max(r.right, fe.right)), 
                fe.top = Math.ceil(Math.max(r.top, fe.top)), fe.bottom = Math.ceil(Math.max(r.bottom, fe.bottom));
            }
            function C() {
                var t, n = p(), r = oe.grid.show;
                for (var o in fe) {
                    var i = oe.grid.margin || 0;
                    fe[o] = "number" == typeof i ? i : i[o] || 0;
                }
                s(he.processOffset, [ fe ]);
                for (var o in fe) "object" == typeof oe.grid.borderWidth ? fe[o] += r ? oe.grid.borderWidth[o] : 0 : fe[o] += r ? oe.grid.borderWidth : 0;
            ...
            function M(e) {
                var t = e.options, n = +(null != t.min ? t.min : e.datamin), r = +(null != t.max ? t.max : e.datamax), o = r - n;
                if (0 == o) {
                    var i = 0 == r ? 1 : .01;
                    ...
                    null == t.max && (r += o * a, r > 0 && null != e.datamax && e.datamax <= 0 && (r = 0)));
                }
                e.min = n, e.max = r;
            }
            function N(t) {
                var n, o = t.options;
                n = "number" == typeof o.ticks && o.ticks > 0 ? o.ticks : .3 * Math.sqrt("x" == t.direction ? ie.width : ie.height);
                var i = (t.max - t.min) / n, a = -Math.floor(Math.log(i) / Math.LN10), s = o.tickDecimals;
                null != s && a > s && (a = s);
                ...
                t.delta = i, t.tickDecimals = Math.max(0, null != s ? s : a), t.tickSize = o.tickSize || l, 
                ...
                if (t.tickGenerator || (t.tickGenerator = function(e) {
                    var t, n = [], o = r(e.min, e.tickSize), i = 0, a = Number.NaN;
                    do t = a, a = o + i * e.tickSize, n.push(a), ++i; while (a < e.max && a != t);
                    return n;
                }, t.tickFormatter = function(e, t) {
                    var n = t.tickDecimals ? Math.pow(10, t.tickDecimals) : 1, r = "" + Math.round(e * n) / n;
                    if (null != t.tickDecimals) {
                        var o = r.indexOf("."), i = o == -1 ? 0 : r.length - o - 1;
                    ...
                    if (d && d.used && d != t) {
                        ...
                        t.tickGenerator = function(e) {
                            ...
                            t = e.min + t * (e.max - e.min), r.push(t);
                            return r;
            ...
            function D(t) {
                ...
                null == n || "number" == typeof n && n > 0 ? r = t.tickGenerator(t) : n && (r = e.isFunction(n) ? n(t) : n);
                var o, i;
                for (t.ticks = [], o = 0; o < r.length; ++o) {
                    var a = null, s = r[o];
            ...
            function O() {
                ...
                for (var t = 0; t < re.length; ++t) s(he.drawSeries, [ le, re[t] ]), F(re[t]);
                s(he.draw, [ le ]), e.show && e.aboveData && I(), ie.render(), J();
            }
            function P(e, t) {
                for (var n, r, o, i, a = p(), s = 0; s < a.length; ++s) if (n = a[s], n.direction == t && (i = t + n.n + "axis", 
                e[i] || 1 != n.n || (i = t + "axis"), e[i])) {
                    r = e[i].from, o = e[i].to;
                    break;
                }
                if (e[i] || (n = "x" == t ? ue[0] : de[0], r = e[t + "1"], o = e[t + "2"]), null != r && null != o && r > o) {
                    var l = r;
                    r = o, o = l;
                }
                return {
            ...
            function A() {
                le.save(), le.translate(fe.left, fe.top), le.fillStyle = ne(oe.grid.backgroundColor, me, 0, "rgba(255, 255, 255, 0)"), 
                le.fillRect(0, 0, pe, me), le.restore();
            }
            function I() {
                var t, n, r, o;
                le.save(), le.translate(fe.left, fe.top);
                var i = oe.grid.markings;
                ...
                n.ymin = n.yaxis.min, n.ymax = n.yaxis.max, i = i(n)), t = 0; t < i.length; ++t) {
                    ...
                    null == l.from && (l.from = l.axis.min), null == l.to && (l.to = l.axis.max), !(s.to < s.axis.min || s.from > s.axis.max || l.to < l.axis.min || l.from > l.axis.max)) {
                        ...
                        l.from = Math.floor(l.axis.p2c(l.from)), l.to = Math.floor(l.axis.p2c(l.to)), c || u) {
                            var d = a.lineWidth || oe.grid.markingsLineWidth, f = d % 2 ? .5 : 0;
                ...
                for (var m = 0; m < n.length; ++m) {
                    ...
                    if (y.show && 0 != y.ticks.length) {
                        ...
                        le.beginPath(), t = 0; t < y.ticks.length; ++t) {
                            var x = y.ticks[t].v;
                            g = b = 0, isNaN(x) || x < y.min || x > y.max || "full" == k && ("object" == typeof r && r[y.position] > 0 || r > 0) && (x == y.min || x == y.max) || ("x" == y.direction ? (h = y.p2c(x), 
                ...
                r && (o = oe.grid.borderColor, "object" == typeof r || "object" == typeof o ? ("object" != typeof r && (r = {
                    top: r,
                    right: r,
                    bottom: r,
                    left: r
                    ...
                    bottom: o,
                    left: o
                }), r.top > 0 && (le.strokeStyle = o.top, le.lineWidth = r.top, le.beginPath(), 
                le.moveTo(0 - r.left, 0 - r.top / 2), le.lineTo(pe, 0 - r.top / 2), le.stroke()), 
                r.right > 0 && (le.strokeStyle = o.right, le.lineWidth = r.right, le.beginPath(), 
                le.moveTo(pe + r.right / 2, 0 - r.top), le.lineTo(pe + r.right / 2, me), le.stroke()), 
                r.bottom > 0 && (le.strokeStyle = o.bottom, le.lineWidth = r.bottom, le.beginPath(), 
                le.moveTo(pe + r.right, me + r.bottom / 2), le.lineTo(0, me + r.bottom / 2), le.stroke()), 
                r.left > 0 && (le.strokeStyle = o.left, le.lineWidth = r.left, le.beginPath(), le.moveTo(0 - r.left / 2, me + r.bottom), 
                le.lineTo(0 - r.left / 2, 0), le.stroke())) : (le.lineWidth = r, le.strokeStyle = oe.grid.borderColor, 
                le.strokeRect(-r / 2, -r / 2, pe + r, me + r))), le.restore();
            }
            function R() {
                e.each(p(), function(e, t) {
                    var n, r, o, i, a, s = t.box, l = t.direction + "Axis " + t.direction + t.n + "Axis", c = "flot-" + t.direction + "-axis flot-" + t.direction + t.n + "-axis " + l, u = t.options.font || "flot-tick-label tickLabel";
                    if (ie.removeText(c), t.show && 0 != t.ticks.length) for (var d = 0; d < t.ticks.length; ++d) n = t.ticks[d], 
                    !n.label || n.v < t.min || n.v > t.max || ("x" == t.direction ? (i = "center", r = fe.left + t.p2c(n.v), 
                    "bottom" == t.position ? o = s.top + s.padding : (o = s.top + s.height - s.padding, 
                    a = "bottom")) : (a = "middle", o = fe.top + t.p2c(n.v), "left" == t.position ? (r = s.left + s.width - s.padding, 
                    i = "right") : r = s.left + s.padding), ie.addText(c, r, o, n.label, u, null, null, i, a));
                });
            }
            function F(e) {
            ...
            function j(e) {
                function t(e, t, n, r, o) {
                    ...
                    for (var c = a; c < i.length; c += a) {
                        ...
                        if (null != u && null != f) {
                            ...
                            if (u <= f && u < r.min) {
                                if (f < r.min) continue;
                                d = (r.min - u) / (f - u) * (p - d) + d, u = r.min;
                            } else if (f <= u && f < r.min) {
                                if (u < r.min) continue;
                                p = (r.min - u) / (f - u) * (p - d) + d, f = r.min;
                            }
                            if (u >= f && u > r.max) {
                                if (f > r.max) continue;
                                d = (r.max - u) / (f - u) * (p - d) + d, u = r.max;
                            } else if (f >= u && f > r.max) {
                                if (u > r.max) continue;
                                p = (r.max - u) / (f - u) * (p - d) + d, f = r.max;
                            }
                            u == s && d == l || le.moveTo(r.p2c(u) + t, o.p2c(d) + n), s = f, l = p, le.lineTo(r.p2c(f) + t, o.p2c(p) + n);
                        }
                    }
                    le.stroke();
                }
                function n(e, t, n) {
                    for (var r = e.points, o = e.pointsize, i = Math.min(Math.max(0, n.min), n.max), a = 0, s = !1, l = 1, c = 0, u = 0; ;) {
                        if (o > 0 && a > r.length + o) break;
                        a += o;
                        var d = r[a - o], f = r[a - o + l], p = r[a], m = r[a + l];
                        if (s) {
                ...
                var r = e.lines.lineWidth, o = e.shadowSize;
                if (r > 0 && o > 0) {
                    le.lineWidth = o, le.strokeStyle = "rgba(0,0,0,0.1)";
                    var i = Math.PI / 18;
                    t(e.datapoints, Math.sin(i) * (r / 2 + o / 2), Math.cos(i) * (r / 2 + o / 2), e.xaxis, e.yaxis), 
                    le.lineWidth = o / 2, t(e.datapoints, Math.sin(i) * (r / 2 + o / 4), Math.cos(i) * (r / 2 + o / 4), e.xaxis, e.yaxis);
                }
                le.lineWidth = r, le.strokeStyle = e.color;
                var a = B(e.lines, e.color, 0, me);
                a && (le.fillStyle = a, n(e.datapoints, e.xaxis, e.yaxis)), r > 0 && t(e.datapoints, 0, 0, e.xaxis, e.yaxis), 
                le.restore();
            }
            function U(e) {
                function t(e, t, n, r, o, i, a, s) {
                    for (var l = e.points, c = e.pointsize, u = 0; u < l.length; u += c) {
                        ...
                        d = i.p2c(d), f = a.p2c(f) + r, "circle" == s ? le.arc(d, f, t, 0, o ? Math.PI : 2 * Math.PI, !1) : s(le, d, f, t, o), 
                        le.closePath(), n && (le.fillStyle = n, le.fill()), le.stroke());
                    }
                }
                le.save(), le.translate(fe.left, fe.top);
                var n = e.points.lineWidth, r = e.shadowSize, o = e.points.radius, i = e.points.symbol;
                if (0 == n && (n = 1e-4), n > 0 && r > 0) {
                    var a = r / 2;
                    le.lineWidth = a, le.strokeStyle = "rgba(0,0,0,0.1)", t(e.datapoints, o, null, a + a / 2, !0, e.xaxis, e.yaxis, i), 
                    le.strokeStyle = "rgba(0,0,0,0.2)", t(e.datapoints, o, null, a / 2, !0, e.xaxis, e.yaxis, i);
                }
                le.lineWidth = n, le.strokeStyle = e.color, t(e.datapoints, o, B(e.points, e.color), 0, !1, e.xaxis, e.yaxis, i), 
                le.restore();
            }
            function V(e, t, n, r, o, i, a, s, l, c, u) {
                var d, f, p, m, h, v, g, b, y;
                c ? (b = v = g = !0, h = !1, d = n, f = e, m = t + r, p = t + o, f < d && (y = f, 
                f = d, d = y, h = !0, v = !1)) : (h = v = g = !0, b = !1, d = e + r, f = e + o, 
            ...
            function L(e) {
                function t(t, n, r, o, i, a) {
                    for (var s = t.points, l = t.pointsize, c = 0; c < s.length; c += l) null != s[c] && V(s[c], s[c + 1], s[c + 2], n, r, o, i, a, le, e.bars.horizontal, e.bars.lineWidth);
                }
                ...
                t(e.datapoints, n, n + e.bars.barWidth, r, e.xaxis, e.yaxis), le.restore();
            }
            function B(t, n, r, o) {
                var i = t.fill;
                if (!i) return null;
                if (t.fillColor) return ne(t.fillColor, r, o, n);
            ...
            function $() {
                ...
                oe.legend.show) {
                    for (var t, r, o = [], i = [], a = !1, s = oe.legend.labelFormatter, l = 0; l < re.length; ++l) t = re[l], 
                    t.label && (r = s ? s(t.label, t) : t.label, r && i.push({
                        label: r,
                        color: t.color
                    }));
                    if (oe.legend.sorted) if (e.isFunction(oe.legend.sorted)) i.sort(oe.legend.sorted); else if ("reverse" == oe.legend.sorted) i.reverse(); else {
            ...
            function W(e, t, n) {
                var r, o, i, a = oe.grid.mouseActiveRadius, s = a * a + 1, l = null;
                for (r = re.length - 1; r >= 0; --r) if (n(re[r])) {
                    var c = re[r], u = c.xaxis, d = c.yaxis, f = c.datapoints.points, p = u.c2p(e), m = d.c2p(t), h = a / u.scale, v = a / d.scale;
                    if (i = c.datapoints.pointsize, u.options.inverseTransform && (h = Number.MAX_VALUE), 
                    d.options.inverseTransform && (v = Number.MAX_VALUE), c.lines.show || c.points.show) for (o = 0; o < f.length; o += i) {
                        var g = f[o], b = f[o + 1];
                    ...
                    if (c.bars.show && !l) {
                        ...
                        for (w = x + c.bars.barWidth, o = 0; o < f.length; o += i) {
                            var g = f[o], b = f[o + 1], T = f[o + 2];
                            null != g && (re[r].bars.horizontal ? p <= Math.max(T, g) && p >= Math.min(T, g) && m >= b + x && m <= b + w : p >= g + x && p <= g + w && m >= Math.min(T, b) && m <= Math.max(T, b)) && (l = [ r, o / i ]);
                        }
                    }
                }
                return l ? (r = l[0], o = l[1], i = re[r].datapoints.pointsize, {
                    datapoint: re[r].datapoints.points.slice(o * i, (o + 1) * i),
                    dataIndex: o,
                    series: re[r],
                    seriesIndex: r
                }) : null;
            ...
            function Y(e, t, r) {
                var o = se.offset(), i = t.pageX - o.left - fe.left, a = t.pageY - o.top - fe.top, s = m({
                    left: i,
                    top: a
                });
                s.pageX = t.pageX, s.pageY = t.pageY;
                var l = W(i, a, r);
                if (l && (l.pageX = parseInt(l.series.xaxis.p2c(l.datapoint[0]) + o.left + fe.left, 10), 
                l.pageY = parseInt(l.series.yaxis.p2c(l.datapoint[1]) + o.top + fe.top, 10)), oe.grid.autoHighlight) {
            ...
            function K(e, t, n) {
                if ("number" == typeof e && (e = re[e]), "number" == typeof t) {
            ...
            function ee(t, n) {
                var r = n[0], o = n[1], i = t.xaxis, a = t.yaxis, s = "string" == typeof t.highlightColor ? t.highlightColor : e.color.parse(t.color).scale("a", .5).toString();
                if (!(r < i.min || r > i.max || o < a.min || o > a.max)) {
                    var l = t.points.radius + t.points.lineWidth / 2;
                    ce.lineWidth = l, ce.strokeStyle = s;
                    var c = 1.5 * l;
                    r = i.p2c(r), o = a.p2c(o), ce.beginPath(), "circle" == t.points.symbol ? ce.arc(r, o, c, 0, 2 * Math.PI, !1) : t.points.symbol(ce, r, o, c, !1), 
                    ce.closePath(), ce.stroke();
                }
            }
            function te(t, n) {
                var r, o = "string" == typeof t.highlightColor ? t.highlightColor : e.color.parse(t.color).scale("a", .5).toString(), i = o;
                switch (t.bars.align) {
                  case "left":
                    r = 0;
                    break;
                ...
                ce.lineWidth = t.bars.lineWidth, ce.strokeStyle = o, V(n[0], n[1], n[2] || 0, r, r + t.bars.barWidth, function() {
                    return i;
                }, t.xaxis, t.yaxis, ce, t.bars.horizontal, t.bars.lineWidth);
            }
            function ne(t, n, r, o) {
                if ("string" == typeof t) return t;
                for (var i = le.createLinearGradient(0, r, 0, n), a = 0, s = t.colors.length; a < s; ++a) {
                    var l = t.colors[a];
                    if ("string" != typeof l) {
            ...
            ve.setData = u, ve.setupGrid = C, ve.draw = O, ve.getPlaceholder = function() {
                ...
                k(), n.removeData("plot").empty(), re = [], oe = null, ie = null, ae = null, se = null, 
                le = null, ce = null, ue = [], de = [], he = null, ge = [], ve = null;
            }, ve.resize = function() {
                var e = n.width(), t = n.height();
                ie.resize(e, t), ae.resize(e, t);
            }, ve.hooks = he, l(ve), c(i), y(), u(o), C(), O(), _();
            var ge = [], be = null;
        }
        function r(e, t) {
        ...
        e.fn.detach || (e.fn.detach = function() {
        ...
        }, t.prototype.getTextInfo = function(t, n, r, o, i) {
            var a, s, l, c;
            if (n = "" + n, a = "object" == typeof r ? r.style + " " + r.variant + " " + r.weight + " " + r.size + "px/" + r.lineHeight + "px " + r.family : r, 
            ...
            c = l[n], null == c) {
                ...
                "object" == typeof r ? u.css({
                    font: a,
                    color: r.color
                }) : "string" == typeof r && u.addClass(r), c = l[n] = {
            ...
            return c;
        }, t.prototype.addText = function(e, t, n, r, o, i, a, s, l) {
            var c = this.getTextInfo(e, r, o, i, a), u = c.positions;
        ...
        }, t.prototype.removeText = function(e, t, n, r, i, a) {
            if (null == r) {
            ...
            } else for (var d, f = this.getTextInfo(e, r, i, a).positions, p = 0; d = f[p]; p++) d.x == t && d.y == n && (d.active = !1);
        }, e.plot = function(t, r, o) {
            var i = new n(e(t), r, o, e.plot.plugins);
            return i;
    ...
    !function(e) {
        function t(t) {
            ...
            function i() {
                ...
                var n = {}, r = m.first, o = m.second;
                return e.each(t.getAxes(), function(e, t) {
                    if (t.used) {
                        var i = t.c2p(r[t.direction]), a = t.c2p(o[t.direction]);
                        n[e] = {
                            from: Math.min(i, a),
                            to: Math.max(i, a)
                        };
            ...
            function l(e, n) {
                var r = t.getOptions(), o = t.getPlaceholder().offset(), i = t.getPlotOffset();
                e.x = s(0, n.pageX - o.left - i.left, t.width()), e.y = s(0, n.pageY - o.top - i.top, t.height()), 
                "y" == r.selection.mode && (e.x = e == m.first ? 0 : t.width()), "x" == r.selection.mode && (e.y = e == m.first ? 0 : t.height());
            }
            function c(e) {
            ...
            function d(e, n) {
                var r, o, i, a, s = t.getAxes();
                for (var l in s) if (r = s[l], r.direction == n && (a = n + r.n + "axis", e[a] || 1 != r.n || (a = n + "axis"), 
                e[a])) {
                    o = e[a].from, i = e[a].to;
                    break;
                }
                if (e[a] || (r = "x" == n ? t.getXAxes()[0] : t.getYAxes()[0], o = e[n + "1"], i = e[n + "2"]), 
                null != o && null != i && o > i) {
                    var c = o;
                    o = i, i = c;
                }
            ...
            function f(e, n) {
                var r, o = t.getOptions();
                "y" == o.selection.mode ? (m.first.x = 0, m.second.x = t.width()) : (r = d(e, "x"), 
                m.first.x = r.axis.p2c(r.from), m.second.x = r.axis.p2c(r.to)), "x" == o.selection.mode ? (m.first.y = 0, 
                m.second.y = t.height()) : (r = d(e, "y"), m.first.y = r.axis.p2c(r.from), m.second.y = r.axis.p2c(r.to)), 
            ...
            t.clearSelection = u, t.setSelection = f, t.getSelection = i, t.hooks.bindEvents.push(function(e, t) {
                var o = e.getOptions();
                null != o.selection.mode && (t.mousemove(n), t.mousedown(r));
            }), t.hooks.drawOverlay.push(function(t, n) {
                if (m.show && p()) {
                    var r = t.getPlotOffset(), o = t.getOptions();
                    n.save(), n.translate(r.left, r.top);
                    var i = e.color.parse(o.selection.color);
                    n.strokeStyle = i.scale("a", .8).toString(), n.lineWidth = 1, n.lineJoin = o.selection.shape, 
                ...
                o.unbind("mousemove", n), o.unbind("mousedown", r), v && e(document).unbind("mouseup", v);
            });
        }
        e.plot.plugins.push({
            init: t,
    ...
    !function(e) {
        ...
        function r(e) {
            ...
            for (var r = [ "Date", "Day", "FullYear", "Hours", "Milliseconds", "Minutes", "Month", "Seconds" ], o = 0; o < r.length; o++) t(n, "get" + r[o], e, "getUTC" + r[o]), 
            t(n, "set" + r[o], e, "setUTC" + r[o]);
            return n;
        }
        function o(e, t) {
        ...
        function i(r) {
            r.hooks.processOptions.push(function(r, i) {
                e.each(r.getAxes(), function(e, r) {
                    var i = r.options;
                    "time" == i.mode && (r.tickGenerator = function(e) {
                        var n = [], r = o(e.min, i), a = 0, l = i.tickSize && "quarter" === i.tickSize[1] || i.minTickSize && "quarter" === i.minTickSize[1] ? u : c;
                        ...
                        p = e.tickSize[1];
                        var g = v * s[p];
                        "second" == p ? r.setSeconds(t(r.getSeconds(), v)) : "minute" == p ? r.setMinutes(t(r.getMinutes(), v)) : "hour" == p ? r.setHours(t(r.getHours(), v)) : "month" == p ? r.setMonth(t(r.getMonth(), v)) : "quarter" == p ? r.setMonth(3 * t(r.getMonth() / 3, v)) : "year" == p && r.setFullYear(t(r.getFullYear(), v)), 
                        r.setMilliseconds(0), g >= s.minute && r.setSeconds(0), g >= s.hour && r.setMinutes(0), 
                        g >= s.day && r.setHours(0), g >= 4 * s.day && r.setDate(1), g >= 2 * s.month && r.setMonth(t(r.getMonth(), 3)), 
                        g >= 2 * s.quarter && r.setMonth(t(r.getMonth(), 6)), g >= s.year && r.setMonth(0);
                        var b, y = 0, _ = Number.NaN;
                        do if (b = _, _ = r.getTime(), n.push(_), "month" == p || "quarter" == p) if (v < 1) {
                            r.setDate(1);
                            var k = r.getTime();
                            r.setMonth(r.getMonth() + ("quarter" == p ? 3 : 1));
                            var x = r.getTime();
                            r.setTime(_ + y * s.hour + (x - k) * v), y = r.getHours(), r.setHours(0);
                        } else r.setMonth(r.getMonth() + v * ("quarter" == p ? 3 : 1)); else "year" == p ? r.setFullYear(r.getFullYear() + v) : r.setTime(_ + g); while (_ < e.max && _ != b);
                        return n;
                        ...
                        var p = n(r, a, i.monthNames, i.dayNames);
                        return p;
                    });
                });
            });
    ...
    !function() {
        function t(e) {
            function t(e, t, n, r, i, s) {
                ...
                return r > 1 && (l.count = r), "abrt-notification" === e ? (l.problem = !0, l.service = s.PROBLEM_BINARY) : t < 4 && (l.warning = !0), 
                o.render(a, l);
            }
            function n() {
                return d;
        ...
        var r = n(7), o = n(10), i = n(23), a = n(24), s = n(25), l = r.gettext, c = r.gettext, u = {};
        u.journalctl = function() {
            ...
            var s, l = new r.defer(), c = "", u = [], d = [], f = null, p = r.spawn(a, {
                host: i.host,
                batch: 8192,
                latency: 300,
                superuser: "try"
            ...
            return void 0 === e || null === e ? l("[no data]") : "string" == typeof e ? e : void 0 !== e.length ? r.format(l("[$0 bytes of binary data]"), e.length) : l("[binary data]");
        };
    ...
    !function() {
        ...
        function r(e) {
            ...
            function n(e) {
                ...
                o(this).find(".fa").removeClass("fa-angle-down").addClass("fa-angle-right")), _();
            }
            function r(e) {
            ...
            function d(e) {
                var t = e.Value || e.Max, n = S.find('[data-field="' + e.SizeSlider + '"]'), r = n.find(".size-text"), a = n.find(".size-unit"), s = o("<div class='slider'>").append(o("<div class='slider-bar'>").append(o("<div class='slider-thumb'>")));
                o(s).slider(), n.data("max", e.Max), n.data("round", e.Round), n.find(".slider").replaceWith(s), 
                o(s).on("change", f), n.find(".size-text").on("change", p), n.find(".size-unit").on("change", m), 
                s.prop("value", t / e.Max), n.val(t), r.val(i.format_number(t / +a.val()));
            }
            function f(e, t) {
                var n = o(this).parents(".size-slider"), r = n.find(".size-text"), a = n.find(".size-unit"), s = n.data("max"), l = n.data("round");
                t *= s, l && (t = Math.round(t / l) * l), t < 0 && (t = 0), t > s && (t = s), r.val(i.format_number(t / +a.val())), 
                n.val(t), o(n).trigger("change");
            }
            function p(e) {
                var t = o(this), n = t.parents(".size-slider"), r = n.find(".size-unit"), a = +r.val(), s = n.find(".slider"), l = n.data("max"), c = +t.val() * a, u = i.format_number(l / a), d = +u * a;
                c == d && (c = l), s.prop("value", c / l), n.val(c), o(n).trigger("change");
            }
            function m(e) {
                var t = o(this), n = t.parents(".size-slider"), r = n.find(".size-text");
                r.val(i.format_number(+n.val() / +t.val()));
            }
            function h(e, t) {
                var n = S.find('[data-field="' + e.SizeSlider + '"]'), r = n.find(".size-text"), o = n.find(".size-unit"), a = n.find(".slider");
                "number" == typeof t && (t = {
                    Value: t
                ...
                r.val(i.format_number(t.Value / +o.val())), n.val(t.Value));
            }
            function v(e, t) {
                if ("function" == typeof t) return void o.when(t(y())).then(function(t) {
                    t !== !1 && v(e, t);
                });
                var n = S.find('[data-field="' + e + '"]'), r = n.find("ul");
                r.empty().append(t.map(function(e) {
            ...
            function y() {
                ...
                return e.Fields.forEach(function(e) {
                    var n = b(e), r = S.find('[data-field="' + n + '"]');
                    if (e.TextInput) t[n] = r.val(); else if (e.PassInput) t[n] = r.val(); else if (e.SelectOne) t[n] = r.val(); else if (e.SizeInput) t[n] = 1024 * parseInt(r.val(), 10) * 1024; else if (e.SizeSlider) t[n] = parseInt(r.val(), 10); else if (e.CheckBox) t[n] = r.prop("checked"); else if (e.SelectMany) t[n] = [], 
                    r.find("input").each(function(r, o) {
                        o.checked && t[n].push(e.Options[r].value);
                    }); else if (e.SelectRow) r.find("tbody tr").each(function(r, i) {
                        o(i).hasClass("highlight-ct") && (t[n] = e.Rows[r].value);
                    }); else if (e.ComboBox) t[n] = r.find("input[type=text]").val(); else if (e.Arrow) t[n] = !r.hasClass("collapsed"); else if (e.CheckBoxText) {
                        var i = r.find("input[type=checkbox]"), a = r.find("input[type=text]");
            ...
            function x(e, t, n) {
                var r = null;
                return e.SizeSlider && (isNaN(t) && (r = c("Size must be a number")), 0 === t && (r = c("Size cannot be zero")), 
                t < 0 && (r = c("Size cannot be negative")), !e.AllowInfinite && t > e.Max && (r = c("Size is too large"))), 
                e.validate && (r = e.validate(t, n)), r;
            }
            function w() {
                var t = y(), n = [];
                return e.Fields.forEach(function(e) {
                    var r = b(e);
                    if (N[r]) t[r] = void 0; else {
                        var o = x(e, t[r], t);
                        if (o) {
                            var i = new Error(o);
                            i.target = '[data-field="' + r + '"]', n.push(i);
                        }
                    }
            ...
            l && l.modal("hide");
            var S = o(a.render(s, e));
            o("body").append(S), l = S, S.on("hidden.bs.modal", function() {
                S.remove();
            }), S.find(".dialog-arrow").on("click", n), S.find(".dialog-select-row-table tbody").on("click", r), 
    ...
    !function() {
        ...
        function r(e, t) {
            ...
            var i;
            t.message && (i = g("<div class='dialog-error help-block'>").text(t.message)), o.addClass("has-error").append(i), 
        ...
        function i(e, n) {
            ...
            n.forEach(function(t) {
                var n;
                t && (n = e.find(t.target), n && n.length ? r(n, t) : o(e, t), i = !0);
        ...
        function l(e, t, n) {
            function r() {
                ...
                r && r.promise === t && (s(e), n = t.state(), f || "resolved" == n && r.handle ? e.modal("hide") : "rejected" == n && r.handle && i(e, [ arguments[0] ]));
            }
            function o(n) {
                var r = e.data("dialog-wait");
                r && r.promise === t && ("string" != typeof n && (n = ""), c.text(n));
            }
        ...
        function c(t) {
            ...
            return t = t.find(".btn-onoff-ct").andSelf().filter(".btn-onoff-ct"), t.each(function(t, r) {
                var o, i, a, s = g(r).attr("data-toggle", "buttons").addClass("btn-group"), l = s.onoff("value"), c = s.find(".btn"), u = s.find("input").first().attr("name") || e();
                for (o = c.length; o < 2; o++) i = g('<input type="radio" autocomplete="off">'), 
                a = document.createTextNode(n(0 === o ? "On" : "Off")), s.append(g('<label class="btn">').append(i, a)), 
                c = null;
        ...
        g.fn.dialog = function(e) {
            ...
            return o.each(function() {
                ...
                n && (o.placement = n), g(this).tooltip(o), g(this).hasClass("disabled") === r && (g(this).toggleClass("disabled", !r).attr("data-original-title", null), 
                r ? g(this).attr("title", g(this).data(e)) : g(this).attr("title", t), g(this).tooltip("fixTitle"));
            }), o;
        };
    }();
    ...
    !function() {
        function t(e, t, n) {
            ...
            o(t).each(function() {
                ...
                o(this).tooltip({
                    html: !0
                }), o(this).hasClass("disabled") === r && (o(this).toggleClass("disabled", !r).attr("data-original-title", null), 
                r ? o(this).attr("title", o(this).data(e)) : o(this).attr("title", n), o(this).tooltip("fixTitle"));
            });
        }
        function r() {
            t(s, ".storage-privileged", i.format(a("The user <b>$0</b> is not permitted to manage storage"), s.user ? s.user.name : ""));
        }
        var o = n(6), i = n(7), a = i.gettext, s = i.permission({
            admin: !0
        });
        o(s).on("changed", r), e.exports = {
            permission: s,
            update: r
        };
    }();
    ...
    function s(e, t) {
        ...
        function r() {
            o.style.display = "none", f.default.unmountComponentAtNode(o);
        }
        var o = document.getElementById("storage-detail");
        return {
            show: n,
            hide: r
        };
    ...
    t.init = s;
    var c = n(7), u = r(c), d = n(32), f = r(d), p = n(9), m = r(p), h = n(33), v = n(50), g = n(51), b = n(52), y = n(53), _ = u.default.gettext, k = (t.StdDetailsLayout = function(e) {
        function t() {
        ...
        return a(t, e), l(t, [ {
            ...
            value: function() {
                ...
                var t = this.props.client, n = this.props.jobs, r = null, o = this.props.name;
                if ("block" == this.props.type) {
                    var i = t.slashdevs_block[this.props.name], a = i && t.drives[i.Drive];
                    a ? (o = m.default.drive_name(a), r = f.default.createElement(v.DriveDetails, {
                        client: t,
                        jobs: n,
                        drive: a
                    })) : i && (o = m.default.block_name(i), r = f.default.createElement(h.BlockDetails, {
                        client: t,
                        jobs: n,
                        block: i
                    }));
                    ...
                    s && (o = s.Name, r = f.default.createElement(g.VGroupDetails, {
                        client: t,
                        jobs: n,
                        vgroup: s
                    }));
                    ...
                    l && (o = m.default.mdraid_name(l), r = f.default.createElement(b.MDRaidDetails, {
                        client: t,
                        jobs: n,
                        mdraid: l
                    }));
                }
                return r || (r = f.default.createElement("div", {
                    className: "col-md-12"
    ...
    !function(t, n) {
        ...
        function t(e, t, n) {
            ...
            return r ? r === Be ? o = l(e, t, n) : r === We ? o = y(e, t, n) : r === $e ? o = h(e, t, n) : r === He && (o = document.createComment("react-text: " + (e.uid || se()))) : o = document.createTextNode(e), 
            o;
        }
        function n(e, t, n, o) {
            var i = e.vtype;
            if (i === We) return _(e, t, n, o);
            if (i === $e) return v(e, t, n, o);
            if (i !== Be) return n;
            var a = e.props[Ue] && e.props[Ue].__html;
            return null != a ? (p(e, t, n, o), c(t, n, o)) : (r(e, t, n, o), p(e, t, n, o)), 
            n;
        }
        function r(e, t, n, r) {
            var s = {
            ...
            f(s, e, t, n, r), ie(s.removes, i), ie(s.updates, o), ie(s.creates, a);
        }
        function o(e) {
            if (e) {
        ...
        function l(e, t, n) {
            var r = e.type, o = e.props, i = null;
            "svg" === r || n === Ve ? (i = document.createElementNS(Ve, r), n = Ve) : i = document.createElement(r), 
            c(e, i, t);
            var a = r.indexOf("-") >= 0 || null != o.is;
            return de(i, o, a), null != e.ref && (oe(Ke, e), oe(Ke, i)), i;
        }
        function c(e, n, r) {
            for (var o = n.vchildren = u(e), i = n.namespaceURI, a = 0, s = o.length; a < s; a++) n.appendChild(t(o[a], r, i));
        }
        function u(e) {
        ...
        function f(e, t, n, r, o) {
            if (r.vchildren) {
                var i = r.childNodes, a = r.vchildren, s = r.vchildren = u(n), l = a.length, c = s.length;
                if (0 !== l) if (0 !== c) {
                ...
                } else for (var h = 0; h < l; h++) oe(e.removes, {
                    vnode: a[h],
                    node: i[h]
        ...
        function p(e, t, n) {
            ...
            return fe(n, e.props, t.props, r), e.ref !== t.ref && (z(e.refs, e.ref, n), D(t.refs, t.ref, n)), 
            n;
        }
        function m(e, t) {
            var n = (e.props, t.vchildren), r = t.childNodes;
            if (n) for (var o = 0, i = n.length; o < i; o++) s(n[o], r[o]);
            z(e.refs, e.ref, t), t.eventStore = t.vchildren = null;
        }
        function h(e, n, r) {
            var o = b(e, n), i = t(o, n, r);
            return i.cache = i.cache || {}, i.cache[e.uid] = o, i;
        }
        function v(e, t, n, r) {
            var o = e.uid, i = n.cache[o];
            delete n.cache[o];
            var a = b(t, r), s = M(i, a, n, r);
            return s.cache = s.cache || {}, s.cache[t.uid] = a, s !== n && O(s.cache, n.cache, s), 
            s;
        }
        function g(e, t) {
            var n = e.uid, r = t.cache[n];
            delete t.cache[n], s(r, t);
        }
        function b(t, n) {
            var r = t.type, o = t.props, i = x(n, r.contextTypes), a = r(o, i);
            if (a && a.render && (a = a.render()), null === a || a === !1) a = e(He); else if (!a || !a.vtype) throw new Error("@" + r.name + "#render:You may have returned undefined, an array or some other invalid object");
            return a;
        }
        function y(e, n, r) {
            var o = e.type, i = e.props, a = e.uid, s = x(n, o.contextTypes), l = new o(i, s), c = l.$updater, u = l.$cache;
            ...
            var d = w(l), f = t(d, T(l, n), r);
            return f.cache = f.cache || {}, f.cache[a] = l, u.vnode = d, u.node = f, u.isMounted = !0, 
            oe(Xe, l), null != e.ref && (oe(Ke, e), oe(Ke, l)), f;
        }
        function _(e, t, n, r) {
            var o = e.uid, i = n.cache[o], a = i.$updater, s = i.$cache, l = t.type, c = t.props, u = x(r, l.contextTypes);
            if (delete n.cache[o], n.cache[t.uid] = i, s.parentContext = r, i.componentWillReceiveProps) {
                var d = !a.isPending;
        ...
        function k(e, t) {
            var n = e.uid, r = t.cache[n], o = r.$cache;
            delete t.cache[n], z(e.refs, e.ref, r), r.setState = r.forceUpdate = te, r.componentWillUnmount && r.componentWillUnmount(), 
            s(o.vnode, t), delete r.setState, o.isMounted = !1, o.node = o.parentContext = o.vnode = r.refs = r.context = null;
        }
        function x(e, t) {
            var n = {};
            if (!t || !e) return n;
        ...
        function w(t, n) {
            Je = t.refs;
            var r = t.render();
            if (null === r || r === !1) r = e(He); else if (!r || !r.vtype) throw new Error("@" + t.constructor.name + "#render:You may have returned undefined, an array or some other invalid object");
            return Je = null, r;
        }
        function T(e, t) {
        ...
        function M(e, r, o, i) {
            var a = o;
            return null == r ? (s(e, o), o.parentNode.removeChild(o)) : e.type !== r.type || e.key !== r.key ? (s(e, o), 
            a = t(r, i, o.namespaceURI), o.parentNode.replaceChild(a, o)) : (e !== r || i) && (a = n(e, r, o, i)), 
            a;
        }
        function N() {
            return this;
        ...
        function j(e, t, n) {
            ...
            if (r[t] = n, 1 === et[t]) return void (e[t] = L);
            if (ot[t] || (document.addEventListener(t.substr(2), V, !1), ot[t] = !0), tt && t === rt) return void e.addEventListener("click", nt, !1);
            e.nodeName;
        ...
        function L(e) {
            var t = e.currentTarget || e.target, n = "on" + e.type, r = B(e);
            r.currentTarget = t, Qe.isPending = !0;
            var o = t.eventStore, i = o && o[n];
        ...
        function le(e, t, n, r) {
            Et.test(t) ? j(e, t, n) : "style" === t ? W(e.style, n) : t === Ue ? n && null != n.__html && (e.innerHTML = n.__html) : r ? null == n ? e.removeAttribute(t) : e.setAttribute(t, "" + n) : K(e, t, n);
        }
        function ce(e, t, n, r) {
            Et.test(t) ? U(e, t) : "style" === t ? H(e.style, n) : t === Ue ? e.innerHTML = "" : r ? e.removeAttribute(t) : Q(e, t);
        }
        function ue(e, t, n, r, o) {
            if ("value" !== t && "checked" !== t || (r = e[t]), n !== r) return void 0 === n ? void ce(e, t, r, o) : void ("style" === t ? G(e.style, r, n) : le(e, t, n, o));
        }
        function de(e, t, n) {
            var r = "SELECT" === e.nodeName;
            for (var o in t) "children" !== o && (!r || "value" !== o && "defaultValue" !== o ? le(e, o, t[o], n) : Z(e, t.multiple, t[o]));
        }
        function fe(e, t, n, r) {
            var o = "SELECT" === e.nodeName;
            for (var i in t) "children" !== i && (n.hasOwnProperty(i) ? !o || "value" !== i && "defaultValue" !== i ? ue(e, i, n[i], t[i], r) : Z(e, n.multiple, n[i]) : ce(e, i, t[i], r));
            for (var i in n) "children" === i || t.hasOwnProperty(i) || (!o || "value" !== i && "defaultValue" !== i ? le(e, i, n[i], r) : Z(e, n.multiple, n[i]));
        }
        function pe(e) {
        ...
        function me(e, n, r, o) {
            ...
            if (a) return void (a === !0 ? St[i] = a = {
                ...
                callback: r,
                parentContext: o
            } : (a.vnode = e, a.parentContext = o, a.callback = a.callback ? re(a.callback, r) : r));
            St[i] = !0;
            var s = null, l = null;
            if (s = Ct[i]) l = M(s, e, n.firstChild, o); else {
            ...
            u || (Qe.isPending = !1, Qe.batchUpdate()), r && r.call(d), d;
        }
        function he(e, t, n) {
            return me(e, t, n);
        }
        ...
        function ye(t, n, r) {
            ...
            var u = arguments.length, d = r;
            if (u > 3) {
                d = Array(u - 2);
                for (var f = 2; f < u; f++) d[f - 2] = arguments[f];
            }
            return void 0 !== d && (s.children = d), e(o, t, s, i, a);
        }
        function _e(e) {
            return null != e && !!e.vtype;
        }
        function ke(e, t) {
            for (var n = e.type, r = e.key, o = e.ref, i = ae(ae({
                key: r,
                ref: o
        ...
        function Te(e, t, n) {
            ...
            if (wt(e)) ie(e, function(e) {
                var o = typeof e;
                "undefined" !== o && "boolean" !== o || (e = null), t.call(n, e, r++);
            }); else {
                var o = typeof e;
                "undefined" !== o && "boolean" !== o || (e = null), t.call(n, e, r);
            }
        ...
        function Ee(e, t, n) {
            ...
            Te(e, function(e, i) {
                ...
                var s = a.key = Me(e, i);
                o.hasOwnProperty(s) ? o[s] += 1 : o[s] = 0, a.index = o[s], oe(r, a);
            });
            var i = [];
            return r.forEach(function(e) {
                var t = e.child, n = e.key, r = e.index, a = e.isEqual;
                if (null != t && "boolean" != typeof t) {
                    if (!_e(t) || null == n) return void oe(i, t);
                    0 !== o[n] && (n += ":" + r), a || (n = Ne(t.key || "") + "/" + n), t = ke(t, {
                        key: n
                    }), oe(i, t);
                }
            }), i;
        ...
        function ze(e, t) {
            for (var n in t) if (t.hasOwnProperty(n)) {
                ...
                if ("getInitialState" !== n) {
                    var o = e[n];
                    ee(o) && ee(r) ? e[n] = re(o, r) : e[n] = r;
                } else oe(e.$getInitialStates, r);
            }
        }
        function Oe(e, t) {
        ...
        function Ie(e) {
            function t(n, r) {
                I.call(this, n, r), this.constructor = t, e.autobind !== !1 && Pe(this, t.prototype), 
            ...
            return o.$getInitialStates = [], De(r, function(e) {
                ze(o, e), Oe(t, e);
            }), o.getInitialState = Ae, e.mixins = n, t;
        }
        function Re(e, t) {
            if (e === t) return !0;
        ...
        A.prototype = {
            ...
            updateComponent: function() {
                ...
                R(e, n, this.getState(), r, this.clearCallbacks));
            },
            addState: function(e) {
            ...
            getState: function() {
                ...
                return t.length && (n = ae({}, n), t.forEach(function(t) {
                    var o = wt(t);
                    o && (t = t[0]), ee(t) && (t = t.call(e, n, r)), o ? n = ae({}, t) : ae(n, t);
                }), t.length = 0), n;
            },
        ...
        I.prototype = {
            ...
            forceUpdate: function(e) {
                ...
                if (n.isMounted) {
                    ...
                    var a = n.props || r, s = n.state || o, l = n.context || i, c = n.parentContext, u = n.node, d = n.vnode;
                    ...
                    C(), this.componentDidUpdate && this.componentDidUpdate(r, o, i), e && e.call(this), 
        ...
        var et = {
            ...
            onvolumechange: 1,
            onwaiting: 1
        }, tt = "ontouchstart" in document, nt = function() {}, rt = "onclick", ot = {}, it = {
    ...
    }(), l = n(7), c = r(l), u = n(32), d = r(u), f = n(9), p = r(f), m = n(31), h = n(34), v = r(h), g = c.default.gettext;
    ...
    function r(e, t) {
        function n(n) {
            for (var r = e.vgroups_lvols[t.path], o = 0; o < r.length; o++) if (r[o].Name == n) return r[o];
            return null;
        }
        for (var r, o = 0; o < 1e3 && (r = "lvol" + o.toFixed(), n(r)); o++) ;
        return r;
    }
    function o(e, t, n) {
        function o(e, t) {
        ...
        function f() {
            ...
            var r, o;
            if (_ ? (r = g.lvol_name(_), o = P("Deleting a logical volume will delete all data in it.")) : n && (r = g.block_name(p), 
            o = P("Deleting a partition will delete all data in it.")), r) {
                var i = g.get_active_usage(e, t.path);
                if (i.Blocking) return void v.open({
                    Title: h.format(P("$0 is in active use"), r),
                    Blocking: i.Blocking,
                    Fields: []
                });
                v.open({
                    Title: h.format(P("Please confirm deletion of $0"), r),
                    Teardown: i.Teardown,
                    Fields: [],
                    Action: {
                        Danger: o,
        ...
        var p = o(t.iface, ".Block") ? t : null, m = p && e.blocks_lvm2[p.path], y = p && e.blocks_pvol[p.path], _ = o(t.iface, ".LogicalVolume") ? t : m && e.lvols[m.LogicalVolume], k = p && "filesystem" == p.IdUsage, w = p && "crypto" == p.IdUsage, A = [], I = null;
    ...
    function i(e, t) {
        var n, r = e.blocks_pvol[t.path];
        if ("filesystem" == t.IdUsage) n = h.format(A("storage-id-desc", "$0 File System"), t.IdType); else if ("raid" == t.IdUsage) if (r && e.vgroups[r.VolumeGroup]) {
            var o = e.vgroups[r.VolumeGroup];
            n = h.format(P("Physical volume of $0"), o.Name);
    ...
    function s(e, t, n, r, s) {
        var l, u, d;
        "crypto" == r.IdUsage && (d = e.blocks_cleartext[r.path]), u = o(e, r, s), l = i(e, r), 
        a(e, t, n, r.path, g.block_name(r), l, u, r.path), d && c(e, t, n + 1, d);
    }
    function l(e, t, n, r) {
        function i(n, o, i) {
            function a() {
                k.format_dialog(e, r.path, o, i, f && n <= d);
            }
        ...
        function l(n, r) {
            ...
            a(e, t, n, r.block.path, g.block_name(r.block), i, s, r.block.path), c(n + 1, r.partitions);
        }
        function c(n, r) {
            var o, a;
            for (o = 0; o < r.length; o++) a = r[o], "free" == a.type ? i(n, a.start, a.size) : "container" == a.type ? l(n, a) : s(e, t, n, a.block, !0);
        }
        var u = e.blocks_ptable[r.path], d = n, f = "dos" == u.Type;
        c(n, g.get_partitions(e, r));
    }
    function c(e, t, n, r) {
        e.blocks_ptable[r.path] ? l(e, t, n, r) : s(e, t, n, r, null);
    }
    function u(e, t) {
        var n = [];
        return c(e, n, 0, t), n;
            ...
            return n.Blocking ? void v.open({
                ...
                Action: {
                    ...
                    action: function(r) {
                        ...
                        return "no" != r.erase && (o.erase = {
                            t: "s",
                            v: r.erase
                        }), g.teardown_active_usage(e, n).then(function() {
                            return t.Format(r.type, o);
                        });
                    }
                }
            });
    ...
    function f(e, t, n, r, i) {
        ...
        e.blocks_ptable[r.path] ? (u = {
            size: r.Size,
            text: i.Name
        }, c = o(e, r, !1), a(e, t, n, i.Name, g.block_name(r), u, c, r.path), l(e, t, n + 1, r)) : s(e, t, n, r, !1);
    }
    function p(e, t, n, r) {
        var i, s, l;
        "pool" == r.Type ? (s = {
        ...
        }, i = o(e, r, !1), a(e, t, n, r.Name, r.Name, s, i, !1), e.lvols_pool_members[r.path].forEach(function(r) {
            p(e, t, n + 1, r);
        })) : (l = e.lvols_block[r.path], l ? f(e, t, n, l, r) : (s = {
            size: r.Size,
            text: P(r.Active ? "Unsupported volume" : "Inactive volume")
        }, i = o(e, r, !1), a(e, t, n, r.Name, r.Name, s, i, !1)));
    }
    function m(e, t) {
        var n = [];
    ...
    var h = n(7), v = n(26), g = n(9), b = n(32), y = n(35), _ = n(37), k = n(42), x = _.StorageButton, w = _.StorageLink, T = n(43).FilesystemTab, E = n(44).CryptoTab, S = n(45).BlockVolTab, C = n(45).PoolVolTab, M = n(46).PVolTab, N = n(46).MDRaidMemberTab, D = n(47).PartitionTab, z = n(48).SwapTab, O = n(49).UnrecognizedTab, P = h.gettext, A = h.gettext, I = b.createClass({
        ...
        render: function() {
            ...
            var t = this, n = this.props.vgroup, o = 0 == n.FreeSize && P("No free space"), i = b.createElement("div", {
                className: "pull-right"
            }, b.createElement(w, {
                onClick: e,
                excuse: o
    ...
    var i = o.createClass({
        ...
        render: function() {
            ...
            if (this.state.expanded) {
                ...
                p = this.props.tabRenderers[d].data, (d === this.state.activeTab || d in this.state.loadedTabs) && (m = o.createElement(f, r({
        ...
        render: function() {
            ...
            var i;
            return (this.props.title || this.props.actions && this.props.actions.length > 0) && (i = o.createElement("caption", {
                className: "cockpit-caption"
            }, this.props.title, this.props.actions)), o.createElement("table", {
                className: e.join(" ")
            }, i, o.createElement("thead", {
                className: t
    ...
    var s = function() {
        ...
        render: function() {
            ...
            var t = this, n = t.props.client, r = t.props.block;
            if (r) {
                for (var o, i, a, s = r.path; ;) if (n.blocks_part[s] && n.blocks_ptable[n.blocks_part[s].Table]) o = !0, 
                ...
                r = n.blocks[s], n.blocks_lvm2[s] && n.lvols[n.blocks_lvm2[s].LogicalVolume] && (a = !0);
                var l, u;
                if (n.mdraids[r.MDRaid]) l = c.format(h("RAID Device $0"), d.mdraid_name(n.mdraids[r.MDRaid])), 
                u = function() {
                    c.location.go([ "mdraid", n.mdraids[r.MDRaid].UUID ]);
                ...
                } else l = n.drives[r.Drive] ? d.drive_name(n.drives[r.Drive]) : d.block_name(r), 
                u = function() {
                    c.location.go([ d.block_name(r).replace(/^\/dev\//, "") ]);
                };
                var m = p.createElement("a", {
                    onClick: u
                }, l);
                return a && i ? p.createElement("span", null, e(h("Encrypted Logical Volume of $0"), m)) : o && i ? p.createElement("span", null, e(h("Encrypted Partition of $0"), m)) : a ? p.createElement("span", null, e(h("Logical Volume of $0"), m)) : o ? p.createElement("span", null, e(h("Partition of $0"), m)) : i ? p.createElement("span", null, e(h("Encrypted $0"), m)) : m;
            }
        }
    }), _ = function(e) {
        function t() {
        ...
        return i(t, e), s(t, [ {
            ...
            value: function() {
                ...
                return p.createElement(v, {
                    excuse: this.props.excuse,
                    content: function(n) {
                        var r = "btn btn-default";
                        return n && (r += " disabled"), p.createElement("div", {
                            className: "btn-group"
                        }, p.createElement("button", {
                            className: r,
                            onClick: a(t.action)
                        }, t.title), p.createElement("button", {
                            className: r + " dropdown-toggle",
            ...
            function e(e) {
                ...
                if (e && n) {
                    ...
                    e.style.height = e.offsetHeight + "px"), e.offsetLeft === -1e4) {
                        for (var r = n.offsetLeft + .5 * n.offsetWidth - .5 * e.offsetWidth, o = n.offsetTop - e.offsetHeight, i = e.getElementsByClassName("tooltip-arrow")[0], a = e.offsetWidth / 2, s = r, l = o, c = n.offsetWidth, u = e.offsetParent; u; ) s += u.offsetLeft, 
                        l += u.offsetTop, c = u.offsetWidth, u = u.offsetParent;
                        var d = 0;
                        s < 0 ? d = -s + 5 : s + e.offsetWidth > c && (d = -(s + e.offsetWidth - c) - 5), 
                        r += d, a -= d, l < 0 && (o = n.offsetTop + n.offsetHeight, t.setState({
                            pos: "bottom"
                        })), e.style.left = r + "px", e.style.top = o + "px", i.style.left = a + "px";
                    }
    ...
    function a(e, t, n, a) {
        ...
        var s = r("defaults" == n ? "" : n), l = !i(s, "noauto"), c = i(s, "ro"), u = o(s);
        return [ {
            SelectOne: "mounting",
            Title: v("Mounting"),
            Options: [ {
    ...
    function s(e) {
        var t = [];
        return e.mount_auto || t.push("noauto"), e.mount_ro && t.push("ro"), e.mount_extra_options !== !1 && (t = t.concat(r(e.mount_extra_options))), 
        o(t);
    }
    function l(e, t) {
        var n = r(e), a = !i(n, "noauto"), s = i(n, "readonly"), l = o(n);
        return [ {
    ...
    function c(e) {
        ...
        e.crypto_extra_options !== !1 && (t = t.concat(r(e.crypto_extra_options))), o(t);
    }
    function u(e, t, n, r, o) {
        ...
        function g(t, n, r, o, i, a, s, l) {
            return e.is_old_udisks2 ? t.CreatePartition(n, r, o, i, a).then(function(t) {
                return e.call(t, "Block", "Format", [ s, l ]).then(function() {
                    return t;
                });
            }) : t.CreatePartitionAndFormat(n, r, o, i, a, s, l);
        }
        function b(t, n) {
            ...
            Action: {
                ...
                action: function(t) {
                    ...
                    return a.length > 0 && (o["config-items"] = {
                        t: "a(sa{sv})",
                        v: a
                    }), f.teardown_active_usage(e, T).then(r);
                }
            }
        });
    }
    ...
    "use strict";
    var r = n(7), o = n(26), i = n(9), a = n(6), s = n(32), l = n(37), c = n(42), u = l.StorageButton, d = l.StorageLink, f = c.FormatButton, p = r.gettext, m = s.createClass({
        ...
        render: function() {
            ...
            function t(e, t, n) {
                ...
                } ]), !k && r ? v.AddConfigurationItem(r, {}) : k && !r ? v.RemoveConfigurationItem(k, {}) : k && r && (t != x || n != w) ? v.UpdateConfigurationItem(k, r, {}) : void 0;
            }
            function n() {
                o.open({
            ...
            if (b) {
                ...
                m = _ ? r.format(p("$0 of $1"), i.fmt_size(_[0]), i.fmt_size(_[1])) : p("Unknown");
            } else m = "-";
            var k, x, w;
    ...
    var r = n(7), o = n(26), i = n(9), a = n(6), s = n(32), l = n(37), c = n(42), u = l.StorageButton, d = l.StorageLink, f = c.FormatButton, p = r.gettext, m = s.createClass({
        ...
        render: function() {
            function e(e) {
                function t() {
                    return r[1]["track-parents"] = {
                        t: "b",
                        v: !0
                    }, n ? h.UpdateConfigurationItem(n, r, {}) : h.AddConfigurationItem(r, {});
                }
                var n, r;
                h.GetSecretConfiguration({}).done(function(o) {
                    n = i.array_find(o, function(e) {
                        return "crypttab" == e[0];
                    }), r = [ "crypttab", n ? a.extend({}, n[1]) : {} ], r[1]["passphrase-contents"] || (r[1]["passphrase-contents"] = {
                        t: "ay",
                        v: i.encode_filename("")
                    }), e(r[1], t);
                });
            ...
            var r, l, m = this, h = m.props.block;
            return r = i.array_find(h.Configuration, function(e) {
                return "crypttab" == e[0];
            }), r && (l = i.decode_filename(r[1].options.v).split(",").filter(function(e) {
                return 0 !== e.indexOf("x-parent");
    ...
    function o(e, t) {
        var n = e.lvols_block[t.path], r = e.vgroups[t.VolumeGroup], o = e.lvols[t.ThinPool];
        a.open({
            ...
            Fields: [ {
                ...
                Title: p("Size"),
                Value: t.Size,
                Max: o ? 3 * o.Size : t.Size + r.FreeSize,
                AllowInfinite: !!o,
                Round: r.ExtentSize
            }, {
                CheckBox: "fsys",
            ...
            Action: {
                ...
                action: function(e) {
                    ...
                    if (!o && e.size < t.Size) return r(p("This logical volume cannot be made smaller."));
                    var i = {};
                    return o && (i.resize_fsys = {
                        t: "b",
                        v: o
                    }), t.Resize(e.size, i);
                }
    ...
    "use strict";
    var r = n(7), o = n(9), i = n(32), a = n(42), s = a.FormatButton, l = r.gettext, c = i.createClass({
        displayName: "PVolTab",
        render: function() {
            ...
            }, t.Name) : "-")), i.createElement("tr", null, i.createElement("td", null, l("Free")), i.createElement("td", null, e ? o.fmt_size(e.FreeSize) : "-"))));
        }
    }), u = i.createClass({
    ...
    "use strict";
    var r = n(7), o = n(9), i = n(32), a = r.gettext, s = i.createClass({
        ...
        render: function() {
            ...
            return i.createElement("div", null, i.createElement("table", {
                className: "info-table-ct"
            }, i.createElement("tr", null, i.createElement("td", null, a("Name")), i.createElement("td", null, e.Name || "-")), i.createElement("tr", null, i.createElement("td", null, a("Size")), i.createElement("td", null, o.fmt_size(e.Size))), i.createElement("tr", null, i.createElement("td", null, a("UUID")), i.createElement("td", null, e.UUID)), i.createElement("tr", null, i.createElement("td", null, a("Type")), i.createElement("td", null, e.Type))));
        }
    });
    e.exports = {
        PartitionTab: s
    ...
    "use strict";
    var r = n(7), o = n(9), i = n(6), a = n(32), s = n(37), l = n(42), c = s.StorageButton, u = l.FormatButton, d = r.gettext, f = a.createClass({
        displayName: "SwapTab",
        onSamplesChanged: function() {
            this.setState({});
        },
        ...
        render: function() {
            ...
            var n, r = this, i = r.props.client.blocks_swap[r.props.block.path], s = i && i.Active;
            if (s) {
                var l = r.props.client.swap_sizes.data[o.decode_filename(r.props.block.Device)];
    ...
    "use strict";
    var r = n(7), o = n(32), i = n(42), a = i.FormatButton, s = r.gettext, l = o.createClass({
    ...
    t.DriveDetails = function(e) {
        ...
        return a(t, e), s(t, [ {
            ...
            value: function() {
                ...
                var t = this.props.client, n = this.props.drive, r = t.drives_ata[n.path], o = n && t.drives_block[n.path], i = n && t.drives_multipath_blocks[n.path], a = null;
                r && (a = d.default.createElement("tr", null, d.default.createElement("td", null, g("storage", "Assessment")), d.default.createElement("td", null, r.SmartFailing ? d.default.createElement("span", {
                    className: "cockpit-disk-failing"
                }, g("DISK IS FAILING")) : d.default.createElement("span", null, g("Disk is OK")), r.SmartTemperature > 0 ? d.default.createElement("span", null, "(", p.default.format_temperature(r.SmartTemperature), ")") : null)));
    ...
    }(), l = n(7), c = r(l), u = n(32), d = r(u), f = n(9), p = r(f), m = n(31), h = n(34), v = r(h), g = n(37), b = n(26), y = r(b), _ = c.default.gettext, k = function(e) {
        function t() {
            return o(this, t), i(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments));
        }
        return a(t, e), s(t, [ {
            ...
            value: function() {
                ...
                function n(e) {
                    ...
                    var r = null, s = null;
                    return 1 === a.length ? s = _("The last physical volume of a volume group cannot be removed.") : e.FreeSize < e.Size ? e.Size <= i.FreeSize ? r = n : s = c.default.format(_("There is not enough free space elsewhere to remove this physical volume. At least $0 more free space is needed."), p.default.fmt_size(e.Size - i.FreeSize)) : r = t, 
                ...
                var r = this, o = r.props.client, i = r.props.vgroup, a = o.vgroups_pvols[i.path] || [];
    ...
    t.VGroupDetails = function(e) {
        ...
        return a(t, e), s(t, [ {
            ...
            value: function() {
                function e() {
                    ...
                    y.default.open({
                        ...
                        Action: {
                            Title: _("Rename"),
                            action: function(t) {
                                return r.Rename(t.name, {}).done(function() {
                                    e.go([ "vg", t.name ]);
                                });
                            }
                        }
                ...
                function t() {
                    var e = c.default.location, t = p.default.get_active_usage(n, r.path);
                    return t.Blocking ? void y.default.open({
                        Title: c.default.format(_("$0 is in active use"), r.Name),
                        Blocking: t.Blocking,
                        Fields: []
                    }) : void y.default.open({
                        Title: c.default.format(_("Please confirm deletion of $0"), r.Name),
                        Teardown: t.Teardown,
                        Fields: [],
                        Action: {
                ...
                var n = this.props.client, r = this.props.vgroup;
                this.ensurePolling(r.NeedsPolling);
                var o = [ {
                    title: _("Rename"),
                    action: e
                }, {
                    ...
                    className: "panel-heading"
                }, c.default.format(_("Volume Group $0"), r.Name), d.default.createElement("span", {
                    className: "pull-right"
                    ...
                    className: "info-table-ct"
                }, d.default.createElement("tr", null, d.default.createElement("td", null, _("storage", "UUID")), d.default.createElement("td", null, r.UUID)), d.default.createElement("tr", null, d.default.createElement("td", null, _("storage", "Capacity")), d.default.createElement("td", null, p.default.fmt_size_long(r.Size)))))), a = d.default.createElement(k, {
                    client: this.props.client,
                    vgroup: r
    ...
    var s = function() {
        ...
        return a(t, e), s(t, [ {
            ...
            value: function() {
                function e(e) {
                    var t = e.block;
                    return o.blocks_part[t.path] && (t = o.blocks[o.blocks_part[t.path].Table]), t && t.MDRaid != i.path;
                }
                function t() {
                    y.default.open({
                        Title: _("Add Disks"),
                ...
                function n(e) {
                    function t(e) {
                        return {
                            faulty: _("FAILED"),
                            in_sync: _("In Sync"),
                            spare: _(r[1] < 0 ? "Spare" : "Recovering"),
                    ...
                    var r = p.default.array_find(i.ActiveDevices, function(t) {
                        return t[0] == e.path;
                    }), m = r && r[1] >= 0 && r[1].toString(), h = r && r[2].map(t).join(", "), v = r && r[2].indexOf("in_sync") >= 0, b = r && r[2].indexOf("spare") >= 0 && r[1] >= 0, y = !1;
                ...
                var r = this, o = r.props.client, i = r.props.mdraid, a = o.mdraids_members[i.path] || [], s = "raid0" != i.Level, l = 0, u = 0;
    ...
    }(), l = n(7), c = r(l), u = n(32), d = r(u), f = n(37), p = c.default.gettext;
    t.Jobs = function(e) {
        function t() {
            return o(this, t), i(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments));
        }
