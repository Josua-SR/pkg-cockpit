!function(e) {
    ...
    !function(o, a) {
        ...
        function s(t, i) {
            function o() {
                if (C && !E) for (;T.length; ) delete S[T.pop()]; else T = [];
                C = !1, E = !1;
            }
            i = i || e.tags, t = t || "", "string" == typeof i && (i = i.split(m));
            for (var s, d, p, h, k, y, x = a(i), _ = new u(t), w = [], S = [], T = [], C = !1, E = !1; !_.eos(); ) {
                if (s = _.pos, p = _.scanUntil(x[0])) for (var M = 0, D = p.length; M < D; ++M) h = p.charAt(M), 
                n(h) ? T.push(S.length) : E = !0, S.push([ "text", h, s, s + 1 ]), s += 1, "\n" === h && o();
                if (!_.scan(x[0])) break;
                ...
                } else "name" === d || "{" === d || "&" === d ? E = !0 : "=" === d && (x = a(i = p.split(m)));
            }
    ...
    a.plot = function(e, t, n) {
        function i() {
            if (0 !== e.height() && 0 !== e.width()) {
                null === M && (M = r.plot(e, E, S)), M.setData(E);
                var t = M.getAxes();
                t.xaxis.options.min = w.beg * _, t.xaxis.options.max = (w.end - 2) * _, S.setup_hook && S.setup_hook(M), 
        ...
        function d() {
            ...
            S = {}, C = [], E = [], M = null, r(e).empty(), r(e).data("flot_data", null);
        }
        function p() {
        ...
        function v(e, t) {
            ...
            function s(n, i) {
                ...
                if (!h[n]) {
                    ...
                    v = l, h[n] = l, l.reset = o, l.remove = a, o(), E.push(l);
                }
            }
            function l() {
        ...
        function x(e, t) {
            M.clearSelection(!0), r(T).triggerHandler("zoom", [ (t.xaxis.to - t.xaxis.from) / 1e3, t.xaxis.to / 1e3 ]);
        }
        var _, w, S = {}, T = {}, C = [], E = [], M = null, D = !1, z = 0, N = null, A = !1;
        return r(e).on("plothover", b), r(e).on("mouseleave", k), r(e).on("plotselecting", y), 
        r(e).on("plotselected", x), r(e).data("flot_data", E), c(t, n), r.extend(T, {
            archives: !1,
            start_walking: s,
            stop_walking: l,
            refresh: a,
    ...
    !function(e) {
        ...
        function n(n, r, o, a) {
            ...
            }, ve.hooks = he, l(ve), c(o), k(), u(r), E(), A(), y();
            var ge = [], be = null;
        }
        function i(e, t) {
    ...
    !function() {
        function t(e, t) {
            function n() {
                ...
                if (t) {
                    ...
                    r && (a = {
                        ...
                        Temperature: r.SmartTemperature > 0 && u.format_temperature(r.SmartTemperature)
                    });
                    var s = null;
                    if (i) {
            ...
            function m() {
                function t(e) {
                    return {
                        ...
                        raid6: f("RAID 6"),
                        raid10: f("RAID 10")
                    }[e] || r.format(f("RAID ($0)"), e);
                }
                var n = e.uuids_mdraid[y];
                if (n) {
                    var i = e.mdraids_block[n.path], a = t(n.Level);
                    n.NumDevices > 0 && (a += ", " + r.format(f("$0 Disks"), n.NumDevices)), n.ChunkSize > 0 && (a += ", " + r.format(f("$0 Chunk Size"), u.fmt_size(n.ChunkSize)));
                    var s = null;
                    n.BitmapLocation && (s = {
                        Value: "none" != u.decode_filename(n.BitmapLocation)
                    });
                    var l = null;
                    n.Degraded > 0 && (l = r.format(r.ngettext("$0 disk is missing", "$0 disks are missing", n.Degraded), n.Degraded));
                    var c = n.Running;
            ...
            function b(t, n) {
                ...
                var r = document.getElementById("detail-content"), o = document.getElementById("detail-sidebar");
                s.unmountComponentAtNode(r), s.unmountComponentAtNode(o), "block" == k ? (i("#detail-body").attr("class", "col-md-12"), 
                s.render(s.createElement(l.Block, {
                    client: e,
                    name: y
                }), r)) : "mdraid" == k ? (i("#detail-body").attr("class", "col-md-8 col-lg-9 col-md-pull-4 col-lg-pull-3"), 
                s.render(s.createElement(l.MDRaid, {
                    client: e,
                    name: y
                }), r), s.render(s.createElement(c.MDRaid, {
                    client: e,
                    name: y
                }), o)) : "vgroup" == k && (i("#detail-body").attr("class", "col-md-8 col-lg-9 col-md-pull-4 col-lg-pull-3"), 
                s.render(s.createElement(l.VGroup, {
                    client: e,
                    name: y
                }), r), s.render(s.createElement(c.VGroup, {
                    client: e,
                    name: y
                }), o)), u.show_soon("#storage-detail", !!r.firstChild);
            }
            var k, y, x = u.get_multipathd_service(), _ = {
                ...
                mdraid_delete: function(t) {
                    ...
                    if (o) {
                        ...
                        d.open({
                            Title: r.format(f("Please confirm deletion of $0"), u.mdraid_name(o)),
                            Alerts: a && u.get_usage_alerts(e, a.path),
                            Fields: [],
                            Action: {
                                Title: f("Delete"),
                ...
                vgroup_delete: function(t) {
                    var n = r.location, i = e.vgroups[t];
                    i && d.open({
                        Title: r.format(f("Please confirm deletion of $0"), i.Name),
                        Alerts: u.get_usage_alerts(e, t),
                        Fields: [],
                        Action: {
            ...
            o.parse(w);
            var S = i("#block-detail-tmpl").html();
            o.parse(S);
            var T = i("#mdraid-detail-tmpl").html();
            o.parse(T);
        ...
        var i = n(6), r = n(7), o = n(10), a = n(19), s = n(27), l = n(28), c = n(43), u = n(9), d = n(23), p = n(25), f = r.gettext;
        e.exports = {
            init: t
        };
    }();
    ...
    !function(t, n) {
        ...
        function l(e, t, n, i) {
            ...
            var x = y.length;
            if (null == p && k) {
                for (var S = null, T = Array(x), C = 0; C < k; C++) for (var E = m[C], M = 0; M < x; M++) if (!T[M]) {
                    var D = y[M];
                    if (E === D) {
                        T[M] = {
                            vnode: E,
                ...
                e: for (var C = 0; C < k; C++) {
                    var E = m[C];
                    if (null !== E) {
                        for (var z = E.type, N = E.key, A = E.refs, I = v[C], M = 0; M < x; M++) if (!T[M]) {
                            var D = y[M];
                ...
                for (var C = 0; C < x; C++) {
                    var D = y[C], R = T[C];
                    if (R) {
                        var E = R.vnode, O = R.node;
                        if (D !== E) {
                            var F = D.vtype;
                            F ? F === _e ? O = l(E, D, O, i) : F === Se ? O = h(E, D, O, i) : F === we && (O = d(E, D, O, i)) : O.nodeValue = D;
                        }
                        var U = v[C];
        ...
        function c(e, t) {
            ...
            for (var l in n) n.hasOwnProperty(l) && Ke.test(l) && (l = E(l), De[l] === !0 && (t[l] = null));
        }
        function u(e, t, n) {
        ...
        function M(e, t, n) {
            if (t = E(t), 1 === De[t]) return void (e[t] = n);
            var i = e.eventStore || (e.eventStore = {});
            i[t] = n, ze[t] || (document.addEventListener(t.substr(2), z), ze[t] = !0);
            var r = e.nodeName;
            "onchange" !== t || "INPUT" !== r && "TEXTAREA" !== r || M(e, "oninput", n);
        }
        function D(e, t) {
            if (t = E(t), 1 === De[t]) return void (e[t] = null);
        ...
        function X(e, t, n) {
            for (var i in t) if (t.hasOwnProperty(i) && "children" !== i) {
                var r = t[i];
                Ke.test(i) ? M(e, i, r) : "style" === i ? A(e.style, r) : "dangerouslySetInnerHTML" === i ? r && null != r.__html && (e.innerHTML = r.__html) : n ? null == r ? e.removeAttribute(i) : e.setAttribute(i, "" + r) : V(e, i, r);
            }
        }
        function J(e, t, n, i, r) {
            if ("value" !== e && "checked" !== e || (t = i[e]), n !== t) {
                ...
                if (Ke.test(e)) M(i, e, n); else if ("style" === e) P(i.style, t, n); else if ("dangerouslySetInnerHTML" === e) {
        ...
        function Q(e, t, n, i) {
            ...
            Ze[o] = e;
            var u = Me.isPending;
            Me.isPending = !0, k(), a = Qe[o], delete Qe[o];
            var d = null;
            return Xe(a) ? d = Q(a[0], t, a[1], a[2]) : e.vtype === _e ? d = l : e.vtype === Se && (d = l.cache[e.id]), 
            u || (Me.isPending = !1, Me.batchUpdate()), n && n.call(d), d;
        }
        function Z(e, t, n) {
            return Q(e, t, n);
        }
        ...
        var ye = "http://www.w3.org/2000/svg", xe = "liteid", _e = 2, we = 3, Se = 4, Te = 5, Ce = null, Ee = [], Me = {
            updaters: [],
            isPending: !1,
            add: function(e) {
        ...
        S.prototype = {
            emitUpdate: function(e, t) {
                this.nextProps = e, this.nextContext = t, e || !Me.isPending ? this.updateComponent() : Me.add(this);
            },
    ...
    var h = n(7), v = n(23), g = n(9), b = n(6), k = n(27), y = n(29), x = n(32), _ = n(35), w = x.StorageButton, S = x.StorageLink, T = n(36).FilesystemTab, C = n(37).CryptoTab, E = n(38).BlockVolTab, M = n(38).PoolVolTab, D = n(39).PVolTab, z = n(39).MDRaidMemberTab, N = n(40).PartitionTab, A = n(41).SwapTab, I = n(42).UnrecognizedTab, P = h.gettext, R = h.gettext, O = k.createClass({
        displayName: "Block",
    ...
    "use strict";
    var i = n(7), r = n(25).permission, o = n(9), a = n(6), s = n(27), l = n(33).Tooltip, c = i.gettext, u = s.createClass({
        ...
        componentDidMount: function() {
            a(r).on("changed", this.onPermissionChanged);
        },
        componentWillUnmount: function() {
            a(r).off("changed", this.onPermissionChanged);
        },
        onClick: function(e) {
            if (e && 0 === e.button) {
        ...
        render: function() {
            ...
            if (!this.state.allowed) {
                var t = {
                    __html: i.format(c("The user <b>$0</b> is not permitted to manage storage"), r.user ? r.user.name : "")
                };
        ...
        render: function() {
            ...
            if (r) {
                for (var a, l, u, d = r.path; ;) if (n.blocks_part[d] && n.blocks_ptable[n.blocks_part[d].Table]) a = !0, 
                ...
                var p, f;
                if (n.mdraids[r.MDRaid]) p = i.format(c("RAID Device $0"), o.mdraid_name(n.mdraids[r.MDRaid])), 
                f = function() {
                    i.location.go([ "mdraid", n.mdraids[r.MDRaid].UUID ]);
                ...
                } else p = n.drives[r.Drive] ? o.drive_name(n.drives[r.Drive]) : o.block_name(r), 
                f = function() {
                    i.location.go([ o.block_name(r).replace(/^\/dev\//, "") ]);
                };
    ...
    "use strict";
    var i = n(7), r = n(23), o = n(9), a = n(6), s = n(27), l = n(32), c = l.StorageButton, u = l.StorageBlockNavLink, d = i.gettext, p = s.createClass({
        displayName: "MDRaid",
        getInitialState: function() {
            return {
                mdraid: null,
            ...
            function t() {
                r.open({
                    ...
                    Fields: [ {
                        SelectMany: "disks",
                        Title: d("Disks"),
                        Options: o.get_available_spaces(l).filter(e).map(o.available_space_to_option),
                        EmptyWarning: d("No disks are available."),
                        validate: function(e) {
                            if (0 === e.length) return d("At least one disk is needed.");
                        }
                    ...
                    Action: {
                        Title: d("Add"),
                        action: function(e) {
                            return o.prepare_available_spaces(l, e.disks).then(function() {
            ...
            function n(e) {
                function t(e) {
                    return {
                        faulty: d("FAILED"),
                        in_sync: d("In Sync"),
                        spare: d(r[1] < 0 ? "Spare" : "Recovering"),
                ...
                var r = o.array_find(p.ActiveDevices, function(t) {
                    return t[0] == e.path;
                }), a = r && r[1] >= 0 && r[1].toString(), b = r && r[2].map(t).join(", "), k = r && r[2].indexOf("in_sync") >= 0, y = r && r[2].indexOf("spare") >= 0 && r[1] >= 0, x = !1;
        ...
        render: function() {
            ...
            function n(e) {
                ...
                var r = null, a = null;
                return 1 === f.length ? a = d("The last physical volume of a volume group cannot be removed.") : e.FreeSize < e.Size ? e.Size <= p.FreeSize ? r = n : a = i.format(d("There is not enough free space elsewhere to remove this physical volume. At least $0 more free space is needed."), o.fmt_size(e.Size - p.FreeSize)) : r = t, 
                s.createElement("tr", null, s.createElement("td", {
                    className: "storage-icon"
                }, s.createElement("div", null, s.createElement("img", {
                    src: "images/storage-disk.png"
                ...
                }), s.createElement("br", null), s.createElement("span", null, i.format(d("$0, $1 free"), o.fmt_size(e.Size), o.fmt_size(e.FreeSize)))), s.createElement("td", {
                    className: "storage-action"
                }, s.createElement(c, {
                    onClick: r,
                    excuse: a
