!function(e) {
    ...
    !function() {
        function t(e, t) {
            ...
            function m() {
                ...
                i("#iscsi-sessions").amend(r.render(I, {
                    Sessions: o,
    ...
    function i(e, t, n, i) {
        ...
        function l() {
            v && g.width() > 0 && g.height() > 0 ? (f ? d() : (r(), f = o.plot(b, n, h)), k && window.clearInterval(k)) : k || (k = window.setInterval(l, 500));
        }
        function c() {
            v = !1;
        }
    ...
    !function() {
        ...
        function i(e) {
            ...
            function n(e) {
                ...
                o(this).find(".fa").removeClass("fa-angle-down").addClass("fa-angle-right")), b();
            }
            function i(e) {
            ...
            function d(e) {
                var t = e.Value || e.Max, n = w.find('[data-field="' + e.SizeSlider + '"]'), i = n.find(".size-text"), a = n.find(".size-unit"), s = o("<div class='slider'>").append(o("<div class='slider-bar'>").append(o("<div class='slider-thumb'>")));
                o(s).slider(), n.data("max", e.Max), n.data("round", e.Round), n.find(".slider").replaceWith(s), 
                o(s).on("change", p), n.find(".size-text").on("change", f), n.find(".size-unit").on("change", m), 
                s.prop("value", t / e.Max), n.val(t), i.val(r.format_number(t / +a.val()));
            }
            function p(e, t) {
                var n = o(this).parents(".size-slider"), i = n.find(".size-text"), a = n.find(".size-unit"), s = n.data("max"), l = n.data("round");
                t *= s, l && (t = Math.round(t / l) * l), t < 0 && (t = 0), t > s && (t = s), i.val(r.format_number(t / +a.val())), 
            ...
            function h(e, t) {
                var n = w.find('[data-field="' + e.SizeSlider + '"]'), i = n.find(".size-text"), o = n.find(".size-unit"), a = n.find(".slider");
                "number" == typeof t && (t = {
                    Value: t
                ...
                i.val(r.format_number(t.Value / +o.val())), n.val(t.Value));
            }
            function v(e) {
            ...
            function g() {
                ...
                return e.Fields.forEach(function(e) {
                    var n = v(e), i = w.find('[data-field="' + n + '"]');
            ...
            function b() {
                ...
                e.Fields.forEach(function(e) {
                    if (e.visible) {
                        var n = v(e);
                        T[n] = !e.visible(t), w.find('[data-field="' + n + '"]').parents("tr").toggle(!T[n]);
                    }
                });
            }
            function k(t) {
                e.Fields.forEach(function(e) {
                    e.TextInput && e.update ? w.find('[data-field="' + e.TextInput + '"]').val(e.update(g(), t)) : e.CheckBox && e.update ? w.find('[data-field="' + e.CheckBox + '"]').prop("checked", e.update(g(), t)) : e.SizeSlider && e.update && h(e, e.update(g(), t));
                });
            }
            function y(e, t, n) {
                var i = null;
            ...
            function x() {
                ...
                }), w.dialog("failure", n), 0 === n.length ? t : null;
            }
            function _(e) {
                return e.field ? {
                    message: e.message,
            ...
            }), e.HasBody = !t(e.Fields) || !t(e.Alerts) || !t(e.Blocking), l && l.modal("hide");
            var w = o(a.render(s, e));
            o("body").append(w), l = w, w.on("hidden.bs.modal", function() {
                w.remove();
            }), w.find(".dialog-arrow").on("click", n), w.find(".dialog-select-row-table tbody").on("click", i), 
            w.find(".dialog-select-row-table tbody tr:first-child").addClass("highlight-ct"), 
            w.on("click", ".dropdown li[value]", function(e) {
                return u(o(this));
            }), w.find(".dropdown").each(function(e, t) {
                var n;
            ...
            var T = {};
            w.on("change input", function(e) {
                b();
                var t = o(e.target).attr("data-field");
                t && k(t);
            }), w.find('button[data-action="apply"]').on("click", function() {
                var t = x();
                if (null !== t) {
                    var n = e.Action.action(t);
                    n ? (w.dialog("wait", n), n.done(function(e) {
                        w.modal("hide");
                    }).fail(function(n) {
                        e.Action.failure_filter && (n = e.Action.failure_filter(t, n)), n && (n = n.length ? n.map(_) : _(n), 
                        w.dialog("failure", n));
                    })) : w.modal("hide");
                }
            }), b(), w.modal("show");
    ...
    !function() {
        function t(e, t) {
            ...
            function g() {
                y = null, u.hide("#storage-detail"), s.unmountComponentAtNode(document.getElementById("detail-content")), 
                s.unmountComponentAtNode(document.getElementById("detail-sidebar"));
            }
            function b(t, n) {
                ...
                "block" == k ? (i("#detail-body").attr("class", "col-md-12"), s.render(s.createElement(l.Block, {
                    client: e,
                    name: y
    ...
    !function(t, n) {
        ...
        function t(e, t, n) {
            ...
            return i ? i === $e ? o = l(e, t, n) : i === We ? o = k(e, t, n) : i === je ? o = h(e, t, n) : i === He && (o = document.createComment("react-text: " + (e.uid || se()))) : o = document.createTextNode(e), 
            o;
        }
        function n(e, t, n, o) {
            var r = e.vtype;
            if (r === We) return y(e, t, n, o);
            if (r === je) return v(e, t, n, o);
            if (r !== $e) return n;
            var a = e.props[Ve] && e.props[Ve].__html;
        ...
        function i(e, t, n, i) {
            ...
            p(s, e, t, n, i), re(s.removes, r), re(s.updates, o), re(s.creates, a);
        }
        function o(e) {
            if (e) {
                var t = e.vnode, n = e.node;
                e.shouldIgnore || (t.vtype ? t.vtype === $e ? f(t, e.newVnode, n, e.parentContext) : t.vtype === je ? n = v(t, e.newVnode, n, e.parentContext) : t.vtype === We && (n = y(t, e.newVnode, n, e.parentContext)) : n.replaceData(0, n.length, e.newVnode));
        ...
        function s(e, t) {
            var n = e.vtype;
            n === $e ? m(e, t) : n === We ? x(e, t) : n === je && g(e, t);
        }
        function l(e, t, n) {
            var i = e.type, o = e.props, r = null;
            "svg" === i || n === Le ? (r = document.createElementNS(Le, i), n = Le) : r = document.createElement(i), 
            c(e, r, t);
            var a = i.indexOf("-") >= 0 || null != o.is;
            return de(r, o, a), null != e.ref && (oe(Ke, e), oe(Ke, r)), r;
        }
        function c(e, n, i) {
        ...
        function p(e, t, n, i, o) {
            if (i.vchildren) {
                ...
                if (0 !== l) if (0 !== c) {
                    ...
                    for (var h = 0; h < c; h++) {
                        var _ = d[h];
                        _ ? _.vnode.vtype === $e && p(e, _.vnode, _.newVnode, _.node, _.parentContext) : (m || (m = []), 
                        oe(m, {
                            vnode: s[h],
                            parentNode: i,
                            parentContext: o,
                    ...
                    f && oe(e.removes, f), m && oe(e.creates, m), oe(e.updates, d);
        ...
        function f(e, t, n) {
            ...
            return pe(n, e.props, t.props, i), e.ref !== t.ref && (N(e.refs, e.ref, n), z(t.refs, t.ref, n)), 
            n;
        }
        function m(e, t) {
        ...
        function b(t, n) {
            ...
            if (a && a.render && (a = a.render()), null === a || a === !1) a = e(He); else if (!a || !a.vtype) throw new Error("@" + i.name + "#render:You may have returned undefined, an array or some other invalid object");
            return a;
        }
        function k(e, n, i) {
            ...
            oe(Je, l), null != e.ref && (oe(Ke, e), oe(Ke, l)), p;
        }
        function y(e, t, n, i) {
        ...
        function x(e, t) {
            ...
            delete t.cache[n], N(e.refs, e.ref, i), i.setState = i.forceUpdate = te, i.componentWillUnmount && i.componentWillUnmount(), 
        ...
        function w(t, n) {
            Xe = t.refs;
            var i = t.render();
            if (null === i || i === !1) i = e(He); else if (!i || !i.vtype) throw new Error("@" + t.constructor.name + "#render:You may have returned undefined, an array or some other invalid object");
            return Xe = null, i;
        }
        function T(e, t) {
        ...
        function z(e, t, n) {
            null != t && n && (n.nodeName && !n.getDOMNode && (n.getDOMNode = D), ee(t) ? t(n) : e && (e[t] = n));
        }
        function N(e, t, n) {
        ...
        function I(e) {
            ...
            if (t) for (var i = 0; i < t.length; i++) {
                var o = t[i];
                if ((o.vtype === We || o.vtype === je) && o.type.contextTypes) return !1;
            }
            if (n) for (var i = 0; i < n.length; i++) if (!I(n[i])) return !1;
            return !0;
        }
        function P(e) {
        ...
        function U(e, t, n) {
            ...
            if (i[t] = n, 1 === et[t]) return void (e[t] = B);
            if (ot[t] || (document.addEventListener(t.substr(2), L, !1), ot[t] = !0), tt && t === it) return void e.addEventListener("click", nt, !1);
            e.nodeName;
            "onchange" === t && j(e) && U(e, "oninput", n);
        }
        function V(e, t) {
            t = F(t);
        ...
        function B(e) {
            var t = e.currentTarget || e.target, n = "on" + e.type, i = $(e);
        ...
        function G(e, t, n) {
            if (t !== n) {
                ...
                for (var i in t) n.hasOwnProperty(i) ? n[i] !== t[i] && Y(e, i, n[i]) : e[i] = "";
                for (var i in n) t.hasOwnProperty(i) || Y(e, i, n[i]);
            }
        }
        function q(e, t) {
        ...
        function X(e) {
            ...
            for (var r in t) if (t.hasOwnProperty(r)) {
                ...
                pt[r] = {
                    ...
                    hasBooleanValue: J(a, mt),
                    hasNumericValue: J(a, ht),
        ...
        function K(e, t, n) {
            var i = pt.hasOwnProperty(t) && pt[t];
        ...
        function le(e, t, n, i) {
            St.test(t) ? U(e, t, n) : "style" === t ? W(e.style, n) : t === Ve ? n && null != n.__html && (e.innerHTML = n.__html) : i ? null == n ? e.removeAttribute(t) : e.setAttribute(t, "" + n) : K(e, t, n);
        }
        function ce(e, t, n, i) {
            St.test(t) ? V(e, t) : "style" === t ? H(e.style, n) : t === Ve ? e.innerHTML = "" : i ? e.removeAttribute(t) : Q(e, t);
        }
        function ue(e, t, n, i, o) {
            if ("value" !== t && "checked" !== t || (i = e[t]), n !== i) return void 0 === n ? void ce(e, t, i, o) : void ("style" === t ? G(e.style, i, n) : le(e, t, n, o));
        }
        function de(e, t, n) {
        ...
        function me(e, n, i, o) {
            ...
            var r = n[Be] || (n[Be] = se()), a = Ct[r];
            if (a) return void (a === !0 ? Ct[r] = a = {
                vnode: e,
                callback: i,
                parentContext: o
            ...
            Ct[r] = !0;
            var s = null, l = null;
            if (s = Et[r]) l = M(s, e, n.firstChild, o); else {
            ...
            Et[r] = e;
            var u = Qe.isPending;
            Qe.isPending = !0, E(), a = Ct[r], delete Ct[r];
            var d = null;
            return "object" == typeof a ? d = me(a.vnode, n, a.callback, a.parentContext) : e.vtype === $e ? d = l : e.vtype === We && (d = l.cache[e.uid]), 
        ...
        function ke(t, n, i) {
            ...
            if ("string" == typeof t) o = $e; else {
                ...
                o = t.prototype && t.prototype.isReactComponent ? We : je;
            }
            var r = null, a = null, s = {};
        ...
        function xe(e, t) {
            ...
            var c = ke.apply(void 0, [ n, r ].concat(s));
        ...
        function Se(e, t, n) {
            ...
            return i.forEach(function(e) {
                ...
                if (null != t && "boolean" != typeof t) {
                    if (!ye(t) || null == n) return void oe(r, t);
                    0 !== o[n] && (n += ":" + i), a || (n = De(t.key || "") + "/" + n), t = xe(t, {
                        key: n
                    }), oe(r, t);
                }
            }), r;
        ...
        function ze(e, t) {
            e.forEach(function(e) {
                e && (wt(e.mixins) && ze(e.mixins, t), t(e));
            });
        }
        function Ne(e, t) {
        ...
        function Re(e) {
            function t(n, i) {
                R.call(this, n, i), this.constructor = t, e.autobind !== !1 && Ie(this, t.prototype), 
            ...
            return o.$getInitialStates = [], ze(i, function(e) {
                Ne(o, e), Ae(t, e);
            }), o.getInitialState = Pe, e.mixins = n, t;
        }
        function Oe(e, t) {
            if (e === t) return !0;
        ...
        var Ve = "dangerouslySetInnerHTML", Le = "http://www.w3.org/2000/svg", Be = "liteid", $e = 2, je = 3, We = 4, He = 5, Ge = 1, qe = 9, Ye = 11, Xe = null, Je = [], Ke = [], Qe = {
            updaters: [],
            isPending: !1,
            add: function(e) {
                oe(this.updaters, e);
        ...
        P.prototype = {
            ...
            updateComponent: function() {
                ...
                O(e, n, this.getState(), i, this.clearCallbacks));
            },
            addState: function(e) {
        ...
        var st = /^-?\d+(\.\d+)?$/, lt = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", ct = lt + "\\-.0-9\\uB7\\u0300-\\u036F\\u203F-\\u2040", ut = new RegExp("^[" + lt + "][" + ct + "]*$"), dt = RegExp.prototype.test.bind(new RegExp("^(data|aria)-[" + ct + "]*$")), pt = {}, ft = 1, mt = 4, ht = 8, vt = 24, gt = 32, bt = {
            props: {
                accept: 0,
                acceptCharset: 0,
                accessKey: 0,
            ...
            domProps: {}
        }, kt = "http://www.w3.org/1999/xlink", yt = "http://www.w3.org/XML/1998/namespace", xt = {
        ...
        var wt = Array.isArray, Tt = 0, St = /^on/i;
        Object.freeze || (Object.freeze = ne);
        var Ct = {}, Et = {}, Mt = Object.freeze({
            render: he,
            unstable_renderSubtreeIntoContainer: ve,
            unmountComponentAtNode: ge,
            findDOMNode: be
        }), Dt = "a|abbr|address|area|article|aside|audio|b|base|bdi|bdo|big|blockquote|body|br|button|canvas|caption|cite|code|col|colgroup|data|datalist|dd|del|details|dfn|dialog|div|dl|dt|em|embed|fieldset|figcaption|figure|footer|form|h1|h2|h3|h4|h5|h6|head|header|hgroup|hr|html|i|iframe|img|input|ins|kbd|keygen|label|legend|li|link|main|map|mark|menu|menuitem|meta|meter|nav|noscript|object|ol|optgroup|option|output|p|param|picture|pre|progress|q|rp|rt|ruby|s|samp|script|section|select|small|source|span|strong|style|sub|summary|sup|table|tbody|td|textarea|tfoot|th|thead|time|title|tr|track|u|ul|var|video|wbr|circle|clipPath|defs|ellipse|g|image|line|linearGradient|mask|path|pattern|polygon|polyline|radialGradient|rect|stop|svg|text|tspan", zt = {};
        ...
        Rt.prototype = R.prototype, Fe.prototype = Object.create(R.prototype), Fe.prototype.constructor = Fe, 
        Fe.prototype.isPureReactComponent = !0, Fe.prototype.shouldComponentUpdate = Ue;
        var Ot = ae({
            version: "0.15.1",
            cloneElement: xe,
            isValidElement: ye,
        ...
        return Ot.__SECRET_DOM_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Mt, Ot;
    });
}, function(e, t, n) {
    "use strict";
    function i(e, t) {
    ...
    function o(e, t, n) {
        ...
        function p() {
            ...
            var i, o;
            if (y ? (i = g.lvol_name(y), o = P("Deleting a logical volume will delete all data in it.")) : n && (i = g.block_name(f), 
            o = P("Deleting a partition will delete all data in it.")), i) {
        ...
        y && ("pool" == y.Type ? (r(P("Pool"), M), R = k.createElement(w, {
            onClick: a
        }, P("Create Thin Volume"))) : r(P("Volume"), E)), n && r(P("Partition"), N), x ? r(P("Filesystem"), S) : _ ? r(P("Encryption"), C) : f && "raid" == f.IdUsage && "LVM2_member" == f.IdType || b && e.vgroups[b.VolumeGroup] ? r(P("Physical Volume"), D) : f && "raid" == f.IdUsage || f && e.mdraids[f.MDRaidMember] ? r(P("RAID Member"), z) : f && "other" == f.IdUsage && "swap" == f.IdType ? r(P("Swap"), A) : f && r(P("Unrecognized Data"), I);
        var O = [];
    ...
    function r(e, t) {
        ...
        if ("filesystem" == t.IdUsage) n = h.format(R("storage-id-desc", "$0 File System"), t.IdType); else if ("raid" == t.IdUsage) if (i && e.vgroups[i.VolumeGroup]) {
            ...
            n = h.format(P("Member of RAID Device $0"), g.mdraid_name(r));
    ...
    function l(e, t, n, i) {
        function r(n, o, r) {
            ...
            }, g.format_size_and_text(r, P("Free Space"))), "", {
                element: s,
                tight: !0
            } ];
    ...
    var h = n(7), v = n(23), g = n(9), b = n(6), k = n(27), y = n(29), x = n(32), _ = n(35), w = x.StorageButton, T = x.StorageLink, S = n(36).FilesystemTab, C = n(37).CryptoTab, E = n(38).BlockVolTab, M = n(38).PoolVolTab, D = n(39).PVolTab, z = n(39).MDRaidMemberTab, N = n(40).PartitionTab, A = n(41).SwapTab, I = n(42).UnrecognizedTab, P = h.gettext, R = h.gettext, O = k.createClass({
        ...
        render: function() {
            ...
            if (!n) return null;
            var o = 0 == n.FreeSize && P("No free space"), r = k.createElement("div", {
                className: "pull-right"
            }, k.createElement(T, {
                onClick: e,
                excuse: o
            ...
            function e(e) {
                ...
                m.GetSecretConfiguration({}).done(function(o) {
                    n = r.array_find(o, function(e) {
                        return "crypttab" == e[0];
                    }), i = [ "crypttab", n ? a.extend({}, n[1]) : {} ], i[1]["passphrase-contents"] || (i[1]["passphrase-contents"] = {
                        t: "ay",
                        v: r.encode_filename("")
                    }), e(i[1], t);
                });
