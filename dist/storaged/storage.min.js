!function(e) {
    ...
    !function() {
        ...
        var t = n(6), i = n(7), r = n(8), o = n(13), a = n(14), s = n(26), l = n(9);
        n(43), n(44), n(45), n(46), n(47);
        var c = i.gettext;
        t(e);
    }();
}, function(e, t) {
    ...
    !function() {
        ...
        var r = n(6), o = n(7), a = n(10), s = n(12), l = o.gettext, c = o.gettext, u = {};
        u.compare_versions = function(e, t) {
        ...
        }, u.hostnamed = o.dbus("org.freedesktop.hostname1").proxy(), u.array_find = function(e, t) {
            ...
            if (!e.Name) return "";
            var t = e.Name.split(":");
            return 2 != t.length ? e.Name : void 0 === u.hostnamed.StaticHostname || t[0] == u.hostnamed.StaticHostname ? t[1] : o.format(l("$name (from $host)"), {
                name: t[1],
                host: t[0]
            });
            ...
            function n(t, r, o) {
                ...
                var s, l, c, u, d, p, f = r, m = r + o, h = [];
                for (s = 0; s < i.length; s++) l = e.blocks[i[s].path], c = i[s].Offset, u = i[s].Size, 
                d = i[s].IsContainer, p = i[s].IsContained, null !== l && (0 === t && p || (1 != t || p) && (c < r || c + u > r + o || (a(f, c - f), 
                d ? h.push({
                    type: "container",
                    block: l,
                    size: u,
            ...
            function i(t) {
                ...
                c = r("<div>").html(s.html).text(), a.push({
                    ...
                    start: i.start,
                    size: i.size,
                    desc: o.format(l("unpartitioned space on $0"), c)
                }));
            }
        ...
        function r(e) {
            ...
            e.indexOf(".") == -1 && (e += ".service"), i(function() {
                a.LoadUnit(e).done(function(e) {
                    x = o.proxy("org.freedesktop.systemd1.Unit", e), x.addEventListener("changed", n), 
                    t(x, n), _ = o.proxy("org.freedesktop.systemd1.Service", e), _.addEventListener("changed", r), 
                    t(_, r);
                }).fail(function(e) {
            ...
            return a.addEventListener("JobRemoved", function(e, t, n, i, r) {
                S[n] && ("done" == r ? S[n].resolve() : S[n].reject(r), delete S[n]);
            }), y;
        }
        var o, a, s = n(7);
        e.exports = {
    ...
    !function() {
        ...
        var i = n(6), r = n(7), o = n(10), a = n(9), s = r.gettext;
        e.exports = {
            init: t
        };
    }();
    ...
    !function() {
        function t(e, t) {
            ...
            var A = i("#mdraids-tmpl").html();
            o.parse(A), i(e).on("changed", n);
            var N = i("#vgroups-tmpl").html();
            o.parse(N), i(e).on("changed", f);
            ...
            i.extend(W.yaxis, {
                ...
                hoverable: !0,
                autoHighlight: !1
            }), W.setup_hook = k("#storage-writing-unit");
            var j = a.plot(i("#storage-writing-graph"), 300);
            j.set_options(W), z = j.add_metrics_stacked_instances_series($, {}), j.start_walking(), 
            i(z).on("hover", y), i(window).on("resize", function() {
                L.resize(), j.resize();
            });
            var B = a.setup_plot_controls(i("#storage"), i("#storage-graph-toolbar"));
            return B.reset([ L, j ]), n(), f(), m(), h(), v(), g(), b(), i("#storage-log").append(s.logbox([ "_SYSTEMD_UNIT=storaged.service", "+", "_SYSTEMD_UNIT=udisks2.service", "+", "_SYSTEMD_UNIT=dm-event.service", "+", "_SYSTEMD_UNIT=smartd.service", "+", "_SYSTEMD_UNIT=multipathd.service" ], 10)), 
        ...
        var i = n(6), r = n(7), o = n(10), a = n(15), s = n(19), l = n(9), c = n(23), u = n(25), d = r.gettext, p = r.gettext;
        e.exports = {
            init: t
        };
    }();
    ...
    a.plot = function(e, t, n) {
        ...
        function g(e, t) {
            A != e ? (A && A.hover(!1), A = e, N = t, A && A.hover(N)) : N != t && (N = t, A && A.hover(N));
        }
        function b(e, t, n) {
        ...
        var _, w, S = {}, T = {}, C = [], M = [], E = null, D = !1, z = 0, A = null, N = !1;
    ...
    !function(e) {
        ...
        function n(n, r, o, a) {
            ...
            function V(e) {
                ...
                le.lineWidth = n, le.strokeStyle = e.color, t(e.datapoints, r, W(e.points, e.color), 0, !1, e.xaxis, e.yaxis, o), 
                le.restore();
            }
            ...
            ve.setData = u, ve.setupGrid = M, ve.draw = N, ve.getPlaceholder = function() {
                return n;
            ...
            }, ve.hooks = he, l(ve), c(o), k(), u(r), M(), N(), y();
            var ge = [], be = null;
        }
        function i(e, t) {
    ...
    !function() {
        ...
        var i = n(7), r = n(10), o = n(20), a = n(21), s = n(22), l = i.gettext, c = i.gettext, u = {};
    ...
    !function() {
        ...
        var r = n(6), o = n(7), a = o.gettext, s = o.permission({
            admin: !0
        });
    ...
    !function() {
        function t(e, t) {
            function n(t) {
                return function(n) {
                    var i = n.block;
                    return e.blocks_part[i.path] && (i = e.blocks[e.blocks_part[i.path].Table]), i && i.MDRaid != t.path;
                };
            }
            function f(t) {
                return function(n) {
                    var i = n.block;
                    e.blocks_part[i.path] && (i = e.blocks[e.blocks_part[i.path].Table]);
                    var r = i && e.blocks_lvm2[i.path] && e.lvols[e.blocks_lvm2[i.path].LogicalVolume];
                    return !r || r.VolumeGroup != t.path;
                };
            }
            function m() {
                var t = e.slashdevs_block[x];
                if (t) {
                    var n = {
                        dbus: t,
                        Name: c.block_name(t),
                        Size: c.fmt_size_long(t.Size)
                    }, i = e.drives[t.Drive], r = e.drives_ata[t.Drive], a = null;
                    r && (a = {
                        Failing: e.drives_ata.SmartFailing,
                        Temperature: r.SmartTemperature > 0 && c.format_temperature(r.SmartTemperature)
                    });
                    var s = null;
                    if (i) {
                        var l = e.drives_block[i.path], u = e.drives_multipath_blocks[i.path], d = null;
                        u.length > 0 && (d = {
                            Devices: u.map(c.block_name)
                        }), s = {
                            dbus: i,
                            Size: i.Size > 0 && c.fmt_size_long(i.Size),
                            Assessment: a,
                            Device: l && c.block_name(l),
                            Multipath: d,
                            MultipathActive: "running" == _.state
                        };
                    }
                    return {
                        breadcrumb: i && c.drive_name(i),
                        header: o.render(T, {
                            Block: n,
                            Drive: s
                        }),
            ...
            function h() {
                ...
                function n(t) {
                    ...
                    var o = c.array_find(i.ActiveDevices, function(e) {
                        return e[0] == t.path;
                    }), a = o && o[2].indexOf("in_sync") >= 0, s = o && o[2].indexOf("spare") >= 0 && o[1] >= 0, l = !1;
                    return d ? a && g > 0 || s ? l = p("This disk cannot be removed while the device is recovering.") : a && v < 1 ? l = p("A spare disk needs to be added first before this disk can be removed.") : h.length <= 1 && (l = p("The last disk of a RAID device cannot be removed.")) : l = p("The RAID device must be running in order to remove disks."), 
                    {
                        path: t.path,
                ...
                if (i) {
                    ...
                    var h = e.mdraids_members[i.path], v = 0, g = 0;
                    i.ActiveDevices.forEach(function(e) {
                        e[2].indexOf("spare") >= 0 && (e[1] < 0 ? v += 1 : g += 1);
                    });
                    var b, k = [ {
                        title: p("Start"),
                        action: "mdraid_start"
                    ...
                    b = d ? k[1] : k[0];
                    var y = !1;
                    return d || (y = p("The MDRAID device must be running in order to add spare disks.")), 
                    {
                        breadcrumb: c.mdraid_name(i),
                        header: o.render(C, {
                            MDRaid: f,
                            MDRaidButton: o.render(S, {
                                arg: i.path,
                                def: b,
                                actions: k
                            }),
            ...
            function v() {
                ...
                var n = e.vgnames_vgroup[x];
                if (n) {
                    var i = e.vgroups_pvols[n.path];
                    n.NeedsPolling && null === z ? z = window.setInterval(function() {
                        n.Poll();
                    }, 2e3) : n.NeedsPolling || null === z || (window.clearInterval(z), z = null);
                    var a = {
                        dbus: n,
            ...
            function g() {
                var e;
                "block" == y ? e = m() : "mdraid" == y ? e = h() : "vgroup" == y && (e = v()), e ? (i("#storage-detail .breadcrumb .active").text(e.breadcrumb || x), 
                i("button.tooltip-ct").tooltip("destroy"), i("#detail-header").amend(e.header), 
                i("#detail-sidebar").amend(e.sidebar), i("button.tooltip-ct").tooltip(), e.sidebar ? i("#detail-body").attr("class", "col-md-8 col-lg-9 col-md-pull-4 col-lg-pull-3") : i("#detail-body").attr("class", "col-md-12")) : (i("#storage-detail .breadcrumb .active").text(x), 
                i("#detail-header").text(p("Not found")), i("#detail-sidebar").empty()), t.update("#storage-detail"), 
                i("#detail-jobs").amend(t.render()), d.update();
            }
            function b() {
                x = null, c.hide("#storage-detail");
            }
            function k(t, n) {
                null !== z && (window.clearInterval(z), z = null), y = t, x = n, g();
                var i = document.querySelector("#detail-content");
                s.unmountComponentAtNode(i), "block" == y ? s.render(s.createElement(l.Block, {
                    client: e,
                    name: x
                }), i) : "mdraid" == y ? s.render(s.createElement(l.MDRaid, {
                    client: e,
                    name: x
                }), i) : "vgroup" == y && s.render(s.createElement(l.VGroup, {
                    client: e,
                    name: x
                }), i), c.show_soon("#storage-detail", !!i.firstChild);
            }
            var y, x, _ = c.get_multipathd_service(), w = {
                ...
                mdraid_add_disk: function(t) {
                    ...
                    u.open({
                        ...
                        Fields: [ {
                            SelectMany: "disks",
                            Title: p("Disks"),
                            Options: c.get_available_spaces(e).filter(n(i)).map(c.available_space_to_option),
                            EmptyWarning: p("No disks are available."),
                            validate: function(e) {
                        ...
                        Action: {
                            Title: p("Add"),
                            action: function(t) {
                                return c.prepare_available_spaces(e, t.disks).then(function() {
                ...
                vgroup_add_disk: function(t) {
                    ...
                    n && u.open({
                        ...
                        Fields: [ {
                            SelectMany: "disks",
                            Title: p("Disks"),
                            Options: c.get_available_spaces(e).filter(f(n)).map(c.available_space_to_option),
                            EmptyWarning: p("No disks are available."),
                            validate: function(e) {
                                if (0 === e.length) return p("At least one disk is needed.");
                            }
            ...
            i("#storage-detail").on("click", "[data-action]", function() {
                ...
                var n = w[e].apply(this, t);
                n && n.fail(function(e) {
                    i("#error-popup-title").text(p("Error")), i("#error-popup-message").text(e.toString()), 
                    i("#error-popup").modal("show");
                });
            });
            var S = i("#action-btn-tmpl").html();
            o.parse(S);
            var T = i("#block-detail-tmpl").html();
            o.parse(T);
            var C = i("#mdraid-detail-tmpl").html();
            o.parse(C);
            var M = i("#mdraid-members-tmpl").html();
            o.parse(M);
            var E = i("#vgroup-detail-tmpl").html();
            o.parse(E);
            var D = i("#vgroup-pvs-tmpl").html();
            o.parse(D);
            var z;
            return i(_).on("changed", g), i(e).on("changed", g), i("#storage-detail-log").append(a.logbox([ "_SYSTEMD_UNIT=storaged.service", "+", "_SYSTEMD_UNIT=udisks2.service", "+", "_SYSTEMD_UNIT=dm-event.service", "+", "_SYSTEMD_UNIT=smartd.service", "+", "_SYSTEMD_UNIT=multipathd.service" ], 10)), 
        ...
        var i = n(6), r = n(7), o = n(10), a = n(19), s = n(27), l = n(28), c = n(9), u = n(23), d = n(25), p = r.gettext;
        e.exports = {
            init: t
        };
    }();
    ...
    !function(t, n) {
        ...
        function l(e, t, n, i) {
            ...
            if (null == p && k) {
                ...
                e: for (var C = 0; C < k; C++) {
                    var M = m[C];
                    if (null !== M) {
                        for (var z = M.type, A = M.key, N = M.refs, I = v[C], E = 0; E < x; E++) if (!T[E]) {
                            var D = y[E];
                            if (D.type === z && D.key === A && D.refs === N) {
                                T[E] = {
                                    vnode: M,
                                    node: I
                                };
        ...
        function v(e, t) {
            ...
            delete t.cache[n], w(e.refs, e.ref), i.setState = i.forceUpdate = W, i.componentWillUnmount && i.componentWillUnmount(), 
        ...
        function z(e) {
            ...
            for (Ee.isPending = !0; t; ) {
                ...
                if (s) {
                    if (r || (r = A(e)), r.currentTarget = t, s.call(t, r), r.$cancalBubble) break;
                    t = t.parentNode;
                } else t = t.parentNode;
            }
        ...
        function O(e, t, n) {
            return !Ae[t] && Ie.test(n) ? void (e[t] = n + "px") : ("float" === t && (t = "cssFloat"), 
        ...
        function F(e) {
            ...
            for (var o in t) if (t.hasOwnProperty(o)) {
                ...
                Ue[o] = {
                    ...
                    hasPositiveNumericValue: U(a, We),
                    hasOverloadedBooleanValue: U(a, je)
                };
            }
        }
        function U(e, t) {
        ...
        function X(e, t, n) {
            for (var i in t) if (t.hasOwnProperty(i) && "children" !== i) {
                var r = t[i];
                Ke.test(i) ? E(e, i, r) : "style" === i ? N(e.style, r) : "dangerouslySetInnerHTML" === i ? r && null != r.__html && (e.innerHTML = r.__html) : n ? null == r ? e.removeAttribute(i) : e.setAttribute(i, "" + r) : V(e, i, r);
            }
        }
        ...
        var Ie = /^-?\d+(\.\d+)?$/, Pe = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", Re = Pe + "\\-.0-9\\uB7\\u0300-\\u036F\\u203F-\\u2040", Oe = new RegExp("^[" + Pe + "][" + Re + "]*$"), Fe = RegExp.prototype.test.bind(new RegExp("^(data|aria)-[" + Re + "]*$")), Ue = {}, Ve = 1, Le = 4, $e = 8, We = 24, je = 32, Be = {
            props: {
                accept: 0,
                acceptCharset: 0,
                accessKey: 0,
    ...
    function r(e, t, n) {
        ...
        function p() {
            ...
            var i, r;
            y ? (i = g.lvol_name(y), r = P("Deleting a logical volume will delete all data in it.")) : n && (i = g.block_name(f), 
            r = P("Deleting a partition will delete all data in it.")), i && v.open({
                Title: h.format(P("Please confirm deletion of $0"), i),
        ...
        var f = r(t.iface, ".Block") ? t : null, m = f && e.blocks_lvm2[f.path], b = f && e.blocks_pvol[f.path], y = r(t.iface, ".LogicalVolume") ? t : m && e.lvols[m.LogicalVolume], x = f && "filesystem" == f.IdUsage, _ = f && "crypto" == f.IdUsage, S = [], R = null;
        y && ("pool" == y.Type ? (o(P("Pool"), E), R = k.createElement(w, {
            onClick: a
        }, P("Create Thin Volume"))) : o(P("Volume"), M)), n && o(P("Partition"), A), x ? o(P("Filesystem"), T) : _ ? o(P("Encryption"), C) : f && "raid" == f.IdUsage && "LVM2_member" == f.IdType || b && e.vgroups[b.VolumeGroup] ? o(P("Physical Volume"), D) : f && "raid" == f.IdUsage || f && e.mdraids[f.MDRaidMember] ? o(P("RAID Member"), z) : f && "other" == f.IdUsage && "swap" == f.IdType ? o(P("Swap"), N) : f && o(P("Unrecognized Data"), I);
        var O = [];
        if (_ && (e.blocks_cleartext[f.path] ? s(P("Lock"), l) : s(P("Unlock"), c)), y && (y.Active ? s(P("Deactivate"), d) : s(P("Activate"), u)), 
        n || y) {
            var F = null;
            e.is_old_udisks2 && _ && e.blocks_cleartext[f.path] && (F = P("Can't delete while unlocked")), 
            s(P("Delete"), p, F);
        }
        return {
            renderers: S,
    ...
    function o(e, t) {
        ...
        if ("filesystem" == t.IdUsage) n = h.format(R("storage-id-desc", "$0 File System"), t.IdType); else if ("raid" == t.IdUsage) if (i && e.vgroups[i.VolumeGroup]) {
            ...
            n = h.format(P("Member of RAID Device $0"), g.mdraid_name(o));
        } else n = P("LVM2_member" == t.IdType ? "Physical Volume" : "Member of RAID Device"); else n = "crypto" == t.IdUsage ? R("storage-id-desc", "Encrypted data") : "other" == t.IdUsage ? "swap" == t.IdType ? R("storage-id-desc", "Swap Space") : R("storage-id-desc", "Other Data") : R("storage-id-desc", "Unrecognized Data");
        return {
            size: t.Size,
            text: n
        };
    ...
    function a(e, t, n, i, r, o, a) {
        ...
        a && (s = k.createElement("span", {
            ...
            "data-job-object": a
        })), o.row_action && (s = s ? k.createElement("span", null, s, o.row_action) : o.row_action);
    ...
    function l(e, t, n, i) {
        function o(n, r, o) {
            function a() {
                _.format_dialog(e, i.path, r, o, p && n <= d);
            }
            var s = k.createElement(w, {
                onClick: a
            }, P("Create Partition")), l = [ k.createElement("span", {
                className: "content-level-" + n
            }, g.format_size_and_text(o, P("Free Space"))), "", {
                element: s,
                tight: !0
            } ];
        ...
        function l(n, i) {
            ...
            a(t, n, i.block.path, g.block_name(i.block), o, s, i.block.path), c(n + 1, i.partitions);
        }
        function c(n, i) {
            var r, a;
            for (r = 0; r < i.length; r++) a = i[r], "free" == a.type ? o(n, a.start, a.size) : "container" == a.type ? l(n, a) : s(e, t, n, a.block, !0);
        }
    ...
    function p(e, t, n, i, o) {
        ...
        e.blocks_ptable[i.path] ? (u = {
            size: i.Size,
            text: o.Name
        }, c = r(e, i, !1), a(t, n, o.Name, g.block_name(i), u, c, i.path), l(e, t, n + 1, i)) : s(e, t, n, i, !1);
    }
    function f(e, t, n, i) {
        var o, s, l;
        "pool" == i.Type ? (s = {
            ...
            size: i.Size,
            text: P(i.Active ? "Unsupported volume" : "Inactive volume")
    ...
    var h = n(7), v = n(23), g = n(9), b = n(6), k = n(27), y = n(29), x = n(32), _ = n(35), w = x.StorageButton, S = x.StorageLink, T = n(36).FilesystemTab, C = n(37).CryptoTab, M = n(38).BlockVolTab, E = n(38).PoolVolTab, D = n(39).PVolTab, z = n(39).MDRaidMemberTab, A = n(40).PartitionTab, N = n(41).SwapTab, I = n(42).UnrecognizedTab, P = h.gettext, R = h.gettext, O = k.createClass({
        displayName: "Block",
        ...
        render: function() {
            ...
            if (!n) return null;
            var r = 0 == n.FreeSize && P("No free space"), o = k.createElement("div", {
                className: "pull-right"
            }, k.createElement(S, {
                onClick: e,
                excuse: r
    ...
    var o = r.createClass({
        ...
        render: function() {
            var e, t = this, n = !!this.props.navigateToItem && !this.state.expanded, o = this.props.columns.map(function(e) {
            ...
            if (this.state.expanded) {
                ...
                f = this.props.tabRenderers[d].data, (d === this.state.activeTab || d in this.state.loadedTabs) && (m = r.createElement(p, i({
                    key: this.props.tabRenderers[d].name,
                    hidden: d !== this.state.activeTab
                }, f)), d === this.state.activeTab ? v.push(r.createElement("div", {
    ...
    "use strict";
    var i = n(7), r = n(25).permission, o = n(6), a = n(27), s = n(33).Tooltip, l = i.gettext, c = a.createClass({
        ...
        componentDidMount: function() {
            o(r).on("changed", this.onPermissionChanged);
        },
        componentWillUnmount: function() {
            o(r).off("changed", this.onPermissionChanged);
        },
        onClick: function(e) {
            if (e && 0 === e.button) {
                var t = this.props.onClick();
                t && t.fail(function(e) {
                    o("#error-popup-title").text(l("Error")), o("#error-popup-message").text(e.toString()), 
        ...
        render: function() {
            ...
            if (!this.state.allowed) {
                var t = {
                    __html: i.format(l("The user <b>$0</b> is not permitted to manage storage"), r.user ? r.user.name : "")
                };
            ...
            var n;
            return n = this.props.link ? a.createElement("a", {
                onClick: this.onClick,
                className: e ? " disabled" : ""
            }, this.props.children) : a.createElement("button", {
                onClick: this.onClick,
                className: "btn btn-default" + (e ? " disabled" : "")
            }, this.props.children), a.createElement(s, {
                tip: e
            }, n);
        }
    }), u = a.createClass({
    ...
    var r = n(7), o = n(9), a = n(23), s = n(27), l = n(32), c = r.gettext, u = s.createClass({
    ...
    "use strict";
    var i = n(7), r = n(23), o = n(9), a = n(6), s = n(27), l = n(32), c = n(35), u = l.StorageButton, d = l.StorageLink, p = c.FormatButton, f = i.gettext, m = s.createClass({
        ...
        render: function() {
            ...
            if (g) {
                ...
                c = k ? i.format(f("$0 of $1"), o.fmt_size(k[0]), o.fmt_size(k[1])) : f("Unknown");
            } else c = "-";
            var y, x, _;
    ...
    var i = n(7), r = n(23), o = n(9), a = n(6), s = n(27), l = n(32), c = n(35), u = l.StorageButton, d = l.StorageLink, p = c.FormatButton, f = i.gettext, m = s.createClass({
        ...
        render: function() {
            ...
            return i = o.array_find(m.Configuration, function(e) {
                return "crypttab" == e[0];
            }), i && (l = o.decode_filename(i[1].options.v).split(",").filter(function(e) {
                return 0 !== e.indexOf("x-parent");
    ...
    var o = n(7), a = n(23), s = n(9), l = n(6), c = n(27), u = n(32), d = u.StorageButton, p = u.StorageLink, f = o.gettext, m = c.createClass({
        ...
        render: function() {
            ...
            var o = this, l = o.props.lvol, u = o.props.client.vgroups[l.VolumeGroup];
    ...
    "use strict";
    var i = n(7), r = n(9), o = n(27), a = n(35), s = a.FormatButton, l = i.gettext, c = o.createClass({
        displayName: "PVolTab",
        render: function() {
    ...
    "use strict";
    var i = n(7), r = n(9), o = n(27), a = i.gettext, s = o.createClass({
    ...
    "use strict";
    var i = n(7), r = n(9), o = n(6), a = n(27), s = n(32), l = n(35), c = s.StorageButton, u = l.FormatButton, d = i.gettext, p = a.createClass({
        displayName: "SwapTab",
        onSamplesChanged: function() {
            this.setState({});
        },
        componentDidMount: function() {
            o(this.props.client.swap_sizes).on("changed", this.onSamplesChanged);
        },
        componentWillUnmount: function() {
            o(this.props.client.swap_sizes).off("changed", this.onSamplesChanged);
        },
        render: function() {
            function e() {
                if (o) return o.Start({});
            ...
            var n, i = this, o = i.props.client.blocks_swap[i.props.block.path], s = o && o.Active;
            if (s) {
                var l = i.props.client.swap_sizes.data[r.decode_filename(i.props.block.Device)];
    ...
    "use strict";
    var i = n(7), r = n(27), o = n(35), a = o.FormatButton, s = i.gettext, l = r.createClass({
