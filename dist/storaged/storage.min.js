!function(e) {
    ...
    !function() {
        ...
        u.get_multipathd_service = function() {
            ...
            function i(n) {
                var r = e.blocks[n], o = e.blocks_fsys[n], a = r && e.mdraids[r.MDRaidMember], s = e.blocks_pvol[n], l = s && e.vgroups[s.VolumeGroup], c = u.flatten(t(e, n).map(i));
                return o && o.MountPoints.length > 0 && c.push({
                    usage: "mounted",
                    block: r,
                    fsys: o
                }), a && c.push({
            ...
            return r.forEach(function(e) {
                var t, n;
                "mounted" == e.usage ? o.Teardown.Mounts.push({
                ...
                }), n && n[1] < 0 ? o.Teardown.MDRaidMembers.push(t) : o.Blocking.MDRaidMembers.push(t)) : "pvol" == e.usage && (t = {
                    Name: u.block_name(e.block),
                    VGroup: e.vgroup.Name
                }, e.pvol.FreeSize == e.pvol.Size ? o.Teardown.PhysicalVolumes.push(t) : o.Blocking.PhysicalVolumes.push(t));
            }), o.Teardown.HasMounts = o.Teardown.Mounts.length > 0, o.Teardown.HasMDRaidMembers = o.Teardown.MDRaidMembers.length > 0, 
            o.Teardown.HasPhysicalVolumes = o.Teardown.PhysicalVolumes.length > 0, o.Blocking.HasMounts = o.Blocking.Mounts.length > 0, 
            o.Blocking.HasMDRaidMembers = o.Blocking.MDRaidMembers.length > 0, o.Blocking.HasPhysicalVolumes = o.Blocking.PhysicalVolumes.length > 0, 
            o.Blocking.HasMounts || o.Blocking.HasMDRaidMembers || o.Blocking.HasPhysicalVolumes || (o.Blocking = null), 
            o;
            ...
            return o.all([ n(t.raw.filter(function(e) {
    ...
    !function(o, a) {
        ...
        function s(t, i) {
            ...
            for (var s, d, p, h, k, y, x = a(i), _ = new u(t), w = [], T = [], S = [], C = !1, E = !1; !_.eos(); ) {
                if (s = _.pos, p = _.scanUntil(x[0])) for (var M = 0, D = p.length; M < D; ++M) h = p.charAt(M), 
                n(h) ? S.push(T.length) : E = !0, T.push([ "text", h, s, s + 1 ]), s += 1, "\n" === h && o();
                if (!_.scan(x[0])) break;
                ...
                if (k = [ d, p, s, _.pos ], T.push(k), "#" === d || "^" === d) w.push(k); else if ("/" === d) {
    ...
    !function() {
        function t(e, t) {
            ...
            W.set_options($), z = W.add_metrics_stacked_instances_series(B, {}), W.start_walking(), 
            i(z).on("hover", y), i(window).on("resize", function() {
                L.resize(), W.resize();
            });
            var j = a.setup_plot_controls(i("#storage"), i("#storage-graph-toolbar"));
            return j.reset([ L, W ]), n(), f(), m(), h(), v(), g(), b(), i("#storage-log").append(s.logbox([ "_SYSTEMD_UNIT=storaged.service", "+", "_SYSTEMD_UNIT=udisks2.service", "+", "_SYSTEMD_UNIT=dm-event.service", "+", "_SYSTEMD_UNIT=smartd.service", "+", "_SYSTEMD_UNIT=multipathd.service" ], 10)), 
    ...
    a.plot = function(e, t, n) {
        function i() {
            if (0 !== e.height() && 0 !== e.width()) {
                null === M && (M = r.plot(e, E, T)), M.setData(E);
                var t = M.getAxes();
        ...
        function d() {
            ...
            T = {}, C = [], E = [], M = null, r(e).empty(), r(e).data("flot_data", null);
        }
        function p() {
        ...
        function h(e, t) {
            ...
            function f() {
                function n() {
                    v.archives && !S.archives && (S.archives = !0, r(S).triggerHandler("changed"));
                }
        ...
        function v(e, t) {
            ...
            function a() {
                function e() {
                    p.archives && !S.archives && (S.archives = !0, r(S).triggerHandler("changed"));
                }
        ...
        function y(e, t) {
            t && r(S).triggerHandler("zoomstart", []);
        }
        function x(e, t) {
            M.clearSelection(!0), r(S).triggerHandler("zoom", [ (t.xaxis.to - t.xaxis.from) / 1e3, t.xaxis.to / 1e3 ]);
        }
        var _, w, T = {}, S = {}, C = [], E = [], M = null, D = !1, z = 0, N = null, A = !1;
        return r(e).on("plothover", b), r(e).on("mouseleave", k), r(e).on("plotselecting", y), 
        r(e).on("plotselected", x), r(e).data("flot_data", E), c(t, n), r.extend(S, {
            archives: !1,
            start_walking: s,
            stop_walking: l,
            refresh: a,
                ...
                for (i = ie.length - 1; i >= 0; --i) if (n(ie[i])) {
                    ...
                    if (c.bars.show && !l) {
                        ...
                        for (w = _ + c.bars.barWidth, r = 0; r < p.length; r += o) {
                            var g = p[r], b = p[r + 1], T = p[r + 2];
                            null != g && (ie[i].bars.horizontal ? f <= Math.max(T, g) && f >= Math.min(T, g) && m >= b + _ && m <= b + w : f >= g + _ && f <= g + w && m >= Math.min(T, b) && m <= Math.max(T, b)) && (l = [ i, r / o ]);
                        }
                    }
                }
        ...
        function t(e, t) {
            ...
            var k, y, x = u.get_multipathd_service(), _ = {
                ...
                mdraid_delete: function(t) {
                    ...
                    if (o) {
                        ...
                        return a.Blocking ? void d.open({
                            Title: r.format(f("$0 is in active use"), u.mdraid_name(o)),
                            Blocking: a.Blocking,
                            Fields: []
                        }) : void d.open({
                ...
                vgroup_delete: function(t) {
                    var n = r.location, i = e.vgroups[t];
                    if (i) {
                        var o = u.get_active_usage(e, t);
                        return o.Blocking ? void d.open({
                            Title: r.format(f("$0 is in active use"), i.Name),
                            Blocking: o.Blocking,
                            Fields: []
                        }) : void d.open({
                            ...
                            Action: {
                                ...
                                Title: f("Delete"),
                                action: function() {
                                    return u.teardown_active_usage(e, o).then(function() {
                                        return i.Delete(!0, {
                                            "tear-down": {
                                                t: "b",
                                                v: !0
    ...
    !function(t, n) {
        ...
        function r(e, t, n) {
            ...
            return i ? i === _e ? r = a(e, t, n) : i === Te ? r = m(e, t, n) : i === we ? r = u(e, t, n) : i === Se && (r = document.createComment(e.comment)) : r = document.createTextNode(e), 
            r;
        }
        function o(e, t) {
            var n = e.vtype;
            n === _e ? c(e, t) : n === Te ? v(e, t) : n === we && p(e, t);
        }
        function a(e, t, n) {
        ...
        function l(e, t, n, i) {
            ...
            var x = y.length;
            if (null == p && k) {
                for (var T = null, S = Array(x), C = 0; C < k; C++) for (var E = m[C], M = 0; M < x; M++) if (!S[M]) {
                    var D = y[M];
                    if (E === D) {
                        S[M] = {
                            vnode: E,
                ...
                e: for (var C = 0; C < k; C++) {
                    var E = m[C];
                    if (null !== E) {
                        for (var z = E.type, N = E.key, A = E.refs, I = v[C], M = 0; M < x; M++) if (!S[M]) {
                            var D = y[M];
                        ...
                        T || (T = []), T[T.length] = I, o(E, I);
                    }
                }
                if (T) for (var C = 0, P = T.length; C < P; C++) n.removeChild(T[C]);
                for (var C = 0; C < x; C++) {
                    var D = y[C], R = S[C];
                    if (R) {
                        ...
                        if (D !== E) {
                            var F = D.vtype;
                            F ? F === _e ? O = l(E, D, O, i) : F === Te ? O = h(E, D, O, i) : F === we && (O = d(E, D, O, i)) : O.nodeValue = D;
                        }
                        var U = v[C];
        ...
        function v(e, t) {
            ...
            delete t.cache[n], w(e.refs, e.ref), i.setState = i.forceUpdate = $, i.componentWillUnmount && i.componentWillUnmount(), 
        ...
        function y(e, t, n, i) {
            ...
            a = r(t, i, n.namespaceURI), n.parentNode.replaceChild(a, n); else if (e !== t) {
                var s = e.vtype;
                s === _e ? a = l(e, t, n, i) : s === Te ? a = h(e, t, n, i) : s === we && (a = d(e, t, n, i));
            }
            return a;
        }
        function x() {
        ...
        function _(e, t, n) {
            e && null != t && n && (n.nodeName && !n.getDOMNode && (n.getDOMNode = x), B(t) ? t(n) : e[t] = n);
        }
        function w(e, t) {
            e && null != t && (B(t) ? t(null) : delete e[t]);
        }
        function T(e) {
        ...
        function F(e) {
            ...
            for (var o in t) if (t.hasOwnProperty(o)) {
                ...
                Ue[o] = {
                    ...
                    hasNumericValue: U(a, Be),
                    hasPositiveNumericValue: U(a, $e),
        ...
        function Q(e, t, n, i) {
            ...
            if (a) return void (a === !0 ? Qe[o] = a = [ e, n, i ] : (a[0] = e, a[2] = i, n && (a[1] = a[1] ? j(a[1], n) : n)));
            Qe[o] = !0;
            var s = null, l = null;
            ...
            var d = null;
            return Xe(a) ? d = Q(a[0], t, a[1], a[2]) : e.vtype === _e ? d = l : e.vtype === Te && (d = l.cache[e.id]), 
        ...
        function he(e, t) {
            for (var n in t) if (t.hasOwnProperty(n)) {
                ...
                if ("getInitialState" !== n) {
                    var r = e[n];
                    B(r) && B(i) ? e[n] = j(r, i) : e[n] = i;
                } else e.$getInitialStates.push(i);
            }
        }
        function ve(e, t) {
            q(e.propTypes, t.propTypes), q(e.contextTypes, t.contextTypes), q(e, t.statics), 
            B(t.getDefaultProps) && q(e.defaultProps, t.getDefaultProps());
        }
        function ge(e, t) {
            for (var n in t) t.hasOwnProperty(n) && B(t[n]) && (e[n] = t[n].bind(e));
        }
        function be() {
        ...
        function ke(e) {
            function t(n, i) {
                S.call(this, n, i), this.constructor = t, e.autobind !== !1 && ge(this, t.prototype), 
                this.state = this.getInitialState() || this.state;
            }
            if (!B(e.render)) throw new Error("createClass: spec.render is not function");
        ...
        var ye = "http://www.w3.org/2000/svg", xe = "liteid", _e = 2, we = 3, Te = 4, Se = 5, Ce = null, Ee = [], Me = {
            updaters: [],
            isPending: !1,
            add: function(e) {
        ...
        T.prototype = {
            ...
            getState: function() {
                ...
                return t.length && (n = q({}, n), G(t, function(t) {
                    return Xe(t) ? void (n = q({}, t[0])) : (B(t) && (t = t.call(e, n, i)), void q(n, t));
                }), t.length = 0), n;
            },
            ...
            addCallback: function(e) {
                B(e) && this.pendingCallbacks.push(e);
            }
        }, S.prototype = {
            constructor: S,
        ...
        var Ie = /^-?\d+(\.\d+)?$/, Pe = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", Re = Pe + "\\-.0-9\\uB7\\u0300-\\u036F\\u203F-\\u2040", Oe = new RegExp("^[" + Pe + "][" + Re + "]*$"), Fe = RegExp.prototype.test.bind(new RegExp("^(data|aria)-[" + Re + "]*$")), Ue = {}, Ve = 1, Le = 4, Be = 8, $e = 24, We = 32, je = {
            props: {
                accept: 0,
                acceptCharset: 0,
                accessKey: 0,
    ...
    function r(e, t, n) {
        ...
        function p() {
            ...
            var i, r;
            if (y ? (i = g.lvol_name(y), r = P("Deleting a logical volume will delete all data in it.")) : n && (i = g.block_name(f), 
            r = P("Deleting a partition will delete all data in it.")), i) {
                var o = g.get_active_usage(e, t.path);
                if (o.Blocking) return void v.open({
                    Title: h.format(P("$0 is in active use"), i),
                    Blocking: o.Blocking,
                    Fields: []
                });
                v.open({
                    ...
                    Action: {
                        ...
                        Title: P("Delete"),
                        action: function() {
                            return g.teardown_active_usage(e, o).then(function() {
                                return y ? y.Delete({
                                    "tear-down": {
                                        t: "b",
                                        v: !0
        ...
        var f = r(t.iface, ".Block") ? t : null, m = f && e.blocks_lvm2[f.path], b = f && e.blocks_pvol[f.path], y = r(t.iface, ".LogicalVolume") ? t : m && e.lvols[m.LogicalVolume], x = f && "filesystem" == f.IdUsage, _ = f && "crypto" == f.IdUsage, T = [], R = null;
        y && ("pool" == y.Type ? (o(P("Pool"), M), R = k.createElement(w, {
            onClick: a
        }, P("Create Thin Volume"))) : o(P("Volume"), E)), n && o(P("Partition"), N), x ? o(P("Filesystem"), S) : _ ? o(P("Encryption"), C) : f && "raid" == f.IdUsage && "LVM2_member" == f.IdType || b && e.vgroups[b.VolumeGroup] ? o(P("Physical Volume"), D) : f && "raid" == f.IdUsage || f && e.mdraids[f.MDRaidMember] ? o(P("RAID Member"), z) : f && "other" == f.IdUsage && "swap" == f.IdType ? o(P("Swap"), A) : f && o(P("Unrecognized Data"), I);
        var O = [];
            ...
            return n.Blocking ? void v.open({
                ...
                Action: {
                    ...
                    action: function(i) {
                        ...
                        return "no" != i.erase && (r.erase = {
                            t: "s",
                            v: i.erase
                        }), g.teardown_active_usage(e, n).then(function() {
                            return t.Format(i.type, r);
                        });
                    }
                }
            });
    ...
    var h = n(7), v = n(23), g = n(9), b = n(6), k = n(27), y = n(29), x = n(32), _ = n(35), w = x.StorageButton, T = x.StorageLink, S = n(36).FilesystemTab, C = n(37).CryptoTab, E = n(38).BlockVolTab, M = n(38).PoolVolTab, D = n(39).PVolTab, z = n(39).MDRaidMemberTab, N = n(40).PartitionTab, A = n(41).SwapTab, I = n(42).UnrecognizedTab, P = h.gettext, R = h.gettext, O = k.createClass({
        displayName: "Block",
    ...
    function i(e, t, n, i, s) {
        ...
        var y = o.get_active_usage(e, b ? null : t);
        return y.Blocking ? void a.open({
            Title: r.format(c("$0 is in active use"), o.block_name(v)),
            Blocking: y.Blocking,
            Fields: []
        }) : void a.open({
            Title: h,
            ...
            Action: {
                ...
                action: function(t) {
                    function i() {
                        return b ? "dos-extended" == t.type ? g.CreatePartition(n, t.size, "0x05", "", {}) : "empty" == t.type ? g.CreatePartition(n, t.size, "", "", {}) : f(g, n, t.size, "", "", {}, t.type, r) : v.Format(t.type, r);
                    }
                    ...
                    if ("custom" == t.mounting && a.push([ "fstab", {
                        dir: {
                            t: "ay",
                            v: o.encode_filename(t.mount_point)
                        },
                        type: {
                            t: "ay",
                        ...
                        opts: {
                            t: "ay",
                            v: o.encode_filename(t.mount_options || "defaults")
                        },
                        freq: {
                            t: "i",
                            v: 0
                        ...
                        var s = {
                            options: {
                                t: "ay",
                                v: o.encode_filename(t.crypto_options)
                            },
                            "track-parents": {
                                t: "b",
                                v: !0
                        ...
                        t.store_passphrase ? s["passphrase-contents"] = {
                            t: "ay",
                            v: o.encode_filename(t.passphrase)
                    ...
                    return a.length > 0 && (r["config-items"] = {
                        t: "a(sa{sv})",
                        v: a
                    }), o.teardown_active_usage(e, y).then(i);
                }
            }
        });
    }
