...
(function() {
    ...
    var R = P.indexOf("/cockpit.js");
    if (R === -1) R = P.indexOf("/cockpit.min.js");
    if (R !== -1) R = P.substring(0, R).lastIndexOf("/");
    if (R !== -1) {
        D = P.substring(R + 1, P.indexOf(".", R + 1));
        window.cockpit = T();
    }
