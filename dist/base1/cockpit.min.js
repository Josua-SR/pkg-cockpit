...
(function() {
    ...
    function M() {
        ...
        function S(n) {
            ...
            if (n.command == "init") {
                ...
                e.close(n);
            } else if (n.command == "ping") {
                n["command"] = "pong";
                e.send_control(n);
            } else if (n.command == "pong") {} else if (n.command == "hint") {
                if (m) m(n);
            } else if (t !== undefined) {
                r = u[t];
                if (r) r.apply(null, [ n ]);
    ...
    function T() {
        ...
        e.format_number = function He(n) {
            var t = e.language === undefined ? undefined : e.language.replace("_", "-");
        ...
        e.ngettext = function ln(e, n, t, r) {
                ...
                function g(e, n) {
                    ...
                    if (n.problem) {
                        ...
                        if (p && (p.status < 200 || p.status > 299)) {
                            var s;
                            var f = _e(p.headers, "Content-Type");
                            if (f && !c.binary) {
