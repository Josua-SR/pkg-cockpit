            ...
            dispatchEvent: {
                ...
                value: function e(n) {
                    ...
                    if (typeof n === "string") {
                        ...
                        if (arguments.length == 2) n.initCustomEvent(t, false, false, arguments[1]); else if (arguments.length > 2) n.initCustomEvent(t, false, false, r); else n.initCustomEvent(t, false, false, null);
                        r.unshift(n);
                    } else {
                        t = n.type;
                        r = arguments;
                    }
                    if (te(i["on" + t])) i["on" + t].apply(i, r);
                    se(o[t], i, r);
                }
            }
        });
 ...
 */    function g(r) {
 ...
 /* ready to fail */
        ...
        /* The channel/control arguments is used by filters, and auto-populated if necessary */        o.send_data = function e(n, t, r) {
            if (!a) {
                console.log("transport closed, dropped message: ", n);
                return false;
            }
            var i;
