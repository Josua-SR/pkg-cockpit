...
(function() {
    ...
    function E(e) {
        ...
        for (var i = 0, o = 0; o < n; o++) {
            ...
            i |= e[o] << (16 >>> t & 24);
            if (t === 2 || n - o === 1) {
                r += String.fromCharCode(_(i >>> 18 & 63), _(i >>> 12 & 63), _(i >>> 6 & 63), _(i & 63));
                i = 0;
            }
        }
    ...
    function x(e, n) {
        ...
        var i = (t * 3 + 1 >> 2) - r;
        var o = new (n || Array)(i);
        for (var a, s, l = 0, f = 0, u = 0; u < t; u++) {
            s = u & 3;
            l |= S(e.charCodeAt(u)) << 18 - 6 * s;
            if (s === 3 || t - u === 1) {
                for (a = 0; a < 3 && f < i; a++, f++) o[f] = l >>> (16 >>> a & 24) & 255;
                l = 0;
            }
        }
        return o;
    ...
    function M() {
        ...
        if (!i) {
            ...
            if (f) {
                if ("WebSocket" in window) {
                    i = new window.WebSocket(f, "cockpit1");
                } else if ("MozWebSocket" in window) {
                    i = new window.MozWebSocket(f);
                } else {
        ...
        e.send_control = function T(n) {
            ...
            return e.send_message(JSON.stringify(n), "", n);
        };
        e.register = function D(e, n, t) {
            u[e] = n;
            b[e] = t;
        };
        e.unregister = function P(e) {
            delete u[e];
            delete b[e];
        };
    }
    ...
    function U(n) {
        ...
        t.send = function w(e) {
            if (o) console.warn("sending message on closed channel"); else if (l) console.warn("sending message after done"); else if (!r) c.push([ false, e ]); else g(e);
        };
        t.control = function b(e) {
            e = e || {};
            if (!e.command) e.command = "options";
            if (e.command === "done") l = true;
            e.channel = f;
        ...
        t.toString = function E() {
            ...
            return "[Channel " + (t.valid ? f : "<invalid>") + " -> " + e + "]";
        };
    }
    function J(e) {
        var n = [];
    ...
    function T() {
        e.channel = function Ie(e) {
            return new U(e);
        };
        e.event_target = function Ae(e) {
            O(e, {});
            return e;
        };
        e.extend = l;
        ...
        function v(e) {
            ...
            n.decode = function r(n, i) {
                ...
                var a = 0, s = 0, l = n.length;
                var f, u, c, d;
                var v = "";
                while (s < l) {
                    f = n.charCodeAt(s);
                    u = f == 255 ? 0 : f > 251 && f < 254 ? 6 : f > 247 && f < 252 ? 5 : f > 239 && f < 248 ? 4 : f > 223 && f < 240 ? 3 : f > 191 && f < 224 ? 2 : f < 128 ? 1 : 0;
                    d = s + u <= l;
                    if (!d && o) {
                        t = n.substring(s);
                        break;
        ...
        e.utf8_encoder = function Be(e) {
            return new n(e);
        };
        e.utf8_decoder = function Me(e) {
            return new v((!!e));
        };
        e.base64_encode = E;
        e.base64_decode = x;
        e.kill = function Ne(n, t) {
            var r = {};
            if (n) r.host = n;
            if (t) r.group = t;
            e.transport.control("kill", r);
        };
        e.hint = function Ue(n, t) {
            if (!u) return;
            if (!t) t = h;
        ...
        e.format_number = function He(n) {
            if (!n && n !== 0) return ""; else if (n % 1 === 0) return n.toString(); else if (n > 0 && n <= .001) return .001.toLocaleString(e.language); else if (n < 0 && n >= -.001) return (-.001).toLocaleString(e.language); else if (n > 999 || n < -999) return n.toFixed(0); else return n.toLocaleString(e.language, {
        ...
        e.format_bytes = function Ke(e, n, t) {
            if (n === undefined) n = 1024;
            return z(e, W, n, t);
        };
        e.get_byte_units = function ze(e, n) {
        ...
        e.format_bytes_per_sec = function We(e, n, t) {
            if (n === undefined) n = 1024;
            return z(e, V, n, t);
        };
        var Z = {
        ...
        e.format_bits_per_sec = function Ve(e, n, t) {
        ...
        function Q(n, t, r) {
            ...
            function p(e) {
                ...
                } else if (f && !e.oldValue && e.newValue !== a.getItem(o)) {
                    v();
                }
                var n = null;
        ...
        function X(e, n, t) {
            ...
            r.load = function p(e, n, t) {
                ...
                for (d = r > 0 ? r - 1 : r; d < p; d++) {
                    ...
                    if (a < s) {
                        if (a > h) m.push([ h, a ]);
                        v(a, o.items.slice(a - l, s - l), o.mapping);
                        h = s;
                    } else if (d >= r) {
                        break;
                    }
                    ...
                    if (b < y) {
                        ...
                        for (r = 0; r < w; r++) {
                            ...
                            for (a = 0; a < s; a++) {
                                ...
                                c = t;
                                o = f.length;
                                for (i = 0; l !== undefined && i < o; i++) {
                                    if (!l) {
                                        l = undefined;
                                    } else if (c !== undefined && c !== null) {
                                        c = c[f[i]];
                                        if (c) l = l[c[""]]; else l = l[f[i]];
                                    } else {
                                        l = l[f[i]];
                                    }
                                }
            ...
            r.close = function() {
                ...
                for (n in d) {
                    e = d[n];
                    if (e && e.grid) e.grid.remove_sink(r);
                }
            };
        }
        e.series = function Fe(e, n, t) {
            return new X(e, n, t);
        };
        var ee = 1;
        function ne(e, n, t) {
            ...
            r.add = function g() {
                ...
                if (o(arguments[0])) {
                    ...
                    d = [ arguments[0], e ];
                    if (arguments[1] === true) l.unshift(d); else l.push(d);
            ...
            r.close = function E() {
                h();
                while (f.length) f.pop().links.remove();
            };
            r.move(n, t);
        }
        e.grid = function Ye(e, n, t) {
            return new ne(e, n, t);
        };
        function te(n, t) {
            this.problem = n;
        ...
        function ae() {
            ...
            function l(e, t, i) {
                ...
                var a, l, f, u = [];
                function c(e) {
                    u.push(encodeURIComponent(l) + "=" + encodeURIComponent(e));
                }
                if (t) {
                    for (l in t) {
                        f = t[l];
            ...
            function u() {
                ...
                if (arguments.length == 1 && arguments[0] instanceof ae) {
                    ...
                    var t = arguments[1] || {};
                    e = l(f(arguments[0], t), t);
                } else {
                    e = l.apply(n, arguments);
                }
                return e;
            }
            function c() {
        ...
        e.spawn = function(n, t) {
            ...
            s.addEventListener("close", function(e, n) {
                var t = f.squash();
                le("process closed:", JSON.stringify(n));
                if (t) le("process output:", t);
                if (n.message !== undefined) le("process error:", n.message);
        ...
        function ce() {
            ...
            e.update = function i(n, r, o) {
                ...
                if (!e.data[n][r]) e.data[n][r] = o; else o = l(e.data[n][r], o);
                t(n, r, o);
            };
        ...
        function de(n, t, r, i, o) {
            ...
            function c() {
                ...
                Object.keys(o.properties || {}).forEach(function(t) {
                    ...
                    var l = o.properties[t];
                    if (l.flags && l.flags.indexOf("w") !== -1) {
                        s.set = function(o) {
                            n.call(i, "org.freedesktop.DBus.Properties", "Set", [ r, t, e.variant(l.type, o) ]).fail(function(e) {
        ...
        function pe(n, t) {
            ...
            function w(e, n) {
                ...
                if (t.reply) {
                    if (a) {
                        l = {};
                        if (t.type) l.type = t.type;
                        if (t.flags) l.flags = t.flags;
                        a.resolve(t.reply[0] || [], l);
                        delete d[t.id];
                    }
                    return;
                } else if (t.error) {
                ...
                A(function() {
                    ...
                    if (t.signal) {
                        ...
                        fe("received unexpected dbus json message:", n);
                    }
                });
            }
            function b(e) {
            ...
            function E(e, n) {
                fe("dbus close:", n);
                f.removeEventListener("ready", _);
                f.removeEventListener("message", w);
                f.removeEventListener("close", E);
                f = null;
                k(n);
            }
            f.addEventListener("ready", _);
            f.addEventListener("message", w);
            f.addEventListener("close", E);
            var S = 1;
            ...
            r.publish = function(n, t, r, i) {
                ...
                S++;
                var s = d[a] = e.defer();
                var f = JSON.stringify(l({}, i, {
                    publish: o,
                    id: a
                }));
                if (m(f)) d[a] = s; else s.reject(new ue(p));
                var u = n + "\n" + t;
        ...
        e.variant = function tn(e, n) {
            return {
                v: n,
                t: e
            };
        };
        e.byte_array = function rn(e) {
            return window.btoa(e);
        };
        e.file = function on(n, t) {
            t = t || {};
            var r = t.binary;
            var i = {
                path: n,
        ...
        e.translate = function sn() {
            var n;
            if (arguments.length === 0) n = [ document ]; else if (arguments.length === 1 && arguments[0].length) n = arguments[0]; else n = arguments;
            var t, r, i, o, a, s, l, f, u, c;
            for (t = 0, r = n.length; t < r; t++) {
                f = null;
                if (n[t].querySelectorAll) f = n[t].querySelectorAll("[translatable], [translate]");
                if (!f) continue;
        ...
        e.noop = function un(e, n) {
            return arguments[arguments.length - 1];
        };
        var be = e.gettext;
        e.message = function cn(e) {
        ...
        function Ee(n, t) {
            ...
            i.request = function c(n) {
                ...
                delete n.headers;
                l(n, t);
                if (t.headers && s) n.headers = l({}, t.headers, s); else if (t.headers) n.headers = t.headers; else n.headers = s;
                ...
                function g(e, n) {
                    ...
                    if (n.problem) {
                        ...
                        if (p && (p.status < 200 || p.status > 299)) {
                            var s;
                            var l = _e(p.headers, "Content-Type");
                            if (l && !c.binary) {
                                if (l.indexOf("text/plain") === 0) s = a;
                            }
        ...
        function je(n) {
            ...
            t.is_superuser = n ? n._is_superuser : null;
            var r = null;
            var i = false;
            if (n) r = n.group;
            if (n && n.admin) i = true;
            function o(e) {
                ...
                if (r) return !!(e.groups || []).includes(r);
                if (i) return t.is_superuser;
                if (e.id === undefined) return null;
                return false;
            }
            if (t.user && t.is_superuser !== null) {
                t.allowed = o(t.user);
            } else {
                e.all(e.user(), xe()).done(function(e, n) {
                    t.user = e;
                    t.is_superuser = n;
                    var r = o(e);
                    if (t.allowed !== r) {
        ...
        function Le(n, t, r) {
            ...
            i.close = function v(e) {
                var n, t = o.length;
                if (i.series) i.series.close();
                for (n = 0; n < t; n++) o[n].close(e);
            };
        }
        e.metrics = function vn(e, n) {
            return new Le(e, n);
        };
        e.oops = function pn() {
            if (window.parent !== window && window.name.indexOf("cockpit1:") === 0) window.parent.postMessage('\n{ "command": "oops" }', b);
        };
        var Ce = window.onerror;
        window.onerror = function(n, t, r) {
            e.oops();
            if (Ce) return Ce(n, t, r);
            return false;
        };
        return e;
    }
    var D;
    var P = document.scripts[document.scripts.length - 1].src || "";
    var q = P.indexOf("/cockpit.js");
    if (q === -1) q = P.indexOf("/cockpit.min.js");
    if (q !== -1) q = P.substring(0, q).lastIndexOf("/");
    if (q !== -1) {
        D = P.substring(q + 1, P.indexOf(".", q + 1));
        window.cockpit = T();
    }
