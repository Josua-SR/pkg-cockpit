...
(function() {
    ...
    function P() {
        ...
        e.format_number = function Ge(e) {
            if (!e && e !== 0) return ""; else if (e % 1 === 0) return e.toString(); else if (e > 0 && e <= .001) return "0.001"; else if (e < 0 && e >= -.001) return "-0.001"; else if (e > 999 || e < -999) return e.toFixed(0); else return e.toPrecision(3);
        };
        function z(n, t, r, i) {
            var o;
            var a = null;
