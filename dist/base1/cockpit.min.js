...
(function() {
    ...
    function P() {
        e.channel = function Le(e) {
            return new U(e);
        };
        e.event_target = function Ce(e) {
            O(e, {});
            return e;
        };
        e.extend = f;
        ...
        e.base64_encode = E;
        e.base64_decode = x;
        e.kill = function Be(n, t) {
            var r = {};
            if (n) r.host = n;
            if (t) r.group = t;
            e.transport.control("kill", r);
        };
        e.hint = function Me(n, t) {
            if (!u) return;
            if (!t) t = h;
        ...
        function X(e, n, t) {
            ...
            function c(e, n, t) {
                ...
                w = i.length;
                for (g = 0; g < w; g++) {
                    if (i[g].items.length > 0) break;
                }
                i.splice(0, g);
            }
            var d = {};
            r._register = function h(n, t) {
                if (n.interval != e) throw Error("mismatched metric interval between grid and sink");
                var r = d[t];
                if (!r) {
                    r = d[t] = {
                        grid: n,
        ...
        function ne(e, n, t) {
            ...
            r.add = function g() {
                ...
                if (o(arguments[0])) {
                    ...
                    n = n["series"] || n;
                    t = arguments[1];
                    if (!t) t = []; else if (typeof t === "string") t = t.split(".");
                    s = n._register(r, c);
                    if (!s.length) l.push({
                        sink: n,
                        links: s
                    ...
                    u = [ arguments[0], e ];
                    if (arguments[1] === true) f.unshift(u); else f.push(u);
        ...
        function ae() {
            ...
            function f(e, t, i) {
                ...
                var l = [];
                function u(e) {
                    l.push(encodeURIComponent(a) + "=" + encodeURIComponent(e));
                }
                if (t) {
                    for (a in t) {
                        f = t[a];
        ...
        function Ee(n, t) {
            ...
            if (n !== undefined) {
                if (n.indexOf && n.indexOf("/") === 0) {
                    ...
                    var s = parseInt(n, 10);
                    if (!isNaN(s)) t.port = s; else throw Error("The endpoint must be either a unix path or port number");
                }
            }
            if (t.address) {
        ...
        function xe(n) {
            ...
            if (t.user && t.is_superuser !== null) {
                ...
                e.all(e.user(), Se()).done(function(e, n) {
                    t.user = e;
                    t.is_superuser = n;
                    var r = o(e);
                    if (t.allowed !== r) {
            ...
            function l(t, r, s) {
                ...
                c.addEventListener("message", function(e, o) {
                    ...
                    if (y === undefined) {
                        d = a;
                        b = 0;
                        if (d.now && d.timestamp) b = d.timestamp + (Date.now() - d.now);
                        p = Math.floor(b / n);
                        r(p, d, null, t[0]);
                        i.meta = d;
                        i.dispatchEvent("changed");
    ...
    var q = D.indexOf("/cockpit.js");
    if (q === -1) q = D.indexOf("/cockpit.min.js");
    if (q !== -1) q = D.substring(0, q).lastIndexOf("/");
    if (q !== -1) {
        T = D.substring(q + 1, D.indexOf(".", q + 1));
        window.cockpit = P();
    }
