 ...
 */
    function(n) {
        ...
        k = "sizzle" + 1 * new Date(), y = n.document, S = 0, i = 0, d = le(), b = le(), E = le(), $ = le(), A = function(e, t) {
            if (e === t) {
                f = true;
            }
            return 0;
        ...
        // Optimize for push.apply( _, NodeList )
                try {
            I.apply(t = P.call(y.childNodes), y.childNodes);
            // Support: Android<4.0
 ...
 */        C = se.setDocument = function(e) {
	...
	---------------------------------------------------------------------- */
        ...
        se.matchesSelector = function(e, t) {
            ...
            if (p.matchesSelector && D && !$[t + " "] && (!s || !s.test(t)) && (!v || !v.test(t))) {
                try {
                    var n = u.call(e, t);
			...
			*/
            ...
            pseudos: {
                ...
                not: fe(function(e) {
                    ...
                    return s[k] ? fe(function(e, t, n, i) {
                ...
                if (t = w.relative[e[s].type]) {
                    ...
                    // Return special upon seeing a positional matcher
                        ...
                        e.slice(0, s - 1).concat({
                            value: e[s - 2].type === " " ? "*" : ""
                        })).replace(_, "$1"), t, s < n && ke(e.slice(s, n)), n < i && ke(e = e.slice(n)), n < i && be(e));
                    }
                    u.push(t);
                }
            }
 ...
 */    k.Callbacks = function(i) {
    ...
    function de(e, t, n, i) {
        ...
        u = e.nodeType && (k.cssNumber[t] || f !== "px" && +l) && oe.exec(k.css(e, t));
        if (u && u[3] !== f) {
            // Support: Firefox <=54
    ...
    var De = /^key/, ke = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Se = /^([^.]*)(?:\.(.+)|)/;
    function Ee() {
        return true;
    }
    function $e() {
 ...
 */    k.event = {
            ...
            click: {
                ...
                setup: function(e) {
                    ...
                    // Claim the first handler
                                        if (ve.test(t.type) && t.click && $(t, "input") && K.get(t, "click") === undefined) {
                ...
                _default: function(e) {
                    var t = e.target;
                    return ve.test(t.type) && t.click && $(t, "input") && K.get(t, "click") || $(t, "a");
                }
            },
            beforeunload: {
                ...
                if (e.isTrigger & 1 && this[r]) {
                    ...
                    if (!i) {
                        ...
                        // less bad than duplication.
                                        } else if ((k.event.special[r] || {}).delegateType) {
                        e.stopPropagation();
                    }
                    ...
                    K.set(this, r, k.event.trigger(
                    // Support: IE <=9 - 11+
                    // Extend with the prototype to reset the above stopImmediatePropagation()
                    k.extend(i.shift(), k.Event.prototype), i, this));
    ...
    // Includes all common event props including KeyEvent and MouseEvent specific props
        ...
        which: function(e) {
            ...
            // Add which for key events
                        if (e.which == null && De.test(e.type)) {
    ...
    Oe = /checked\s*(?:[^=]|=\s*.checked.)/i, Re = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ...
    function _e(n, i, r, o) {
        ...
        // We can't cloneNode fragments that contain checked, in WebKit
                if (h || c > 1 && typeof p === "string" && !m.checkClone && Oe.test(p)) {
            ...
            // Require either new content or an interest in ignored elements to invoke the callback
                ...
                if (s) {
                    ...
                    // Evaluate executable scripts on first document insertion
                                        for (u = 0; u < s; u++) {
                        l = a[u];
                        if (ye.test(l.type || "") && !K.access(l, "globalEval") && k.contains(f, l)) {
                            if (l.src && (l.type || "").toLowerCase() !== "module") {
                                // Optional AJAX dependency, but won't run scripts if not present
                                if (k._evalUrl && !l.noModule) {
                                    k._evalUrl(l.src, {
                                        nonce: l.nonce || l.getAttribute("nonce")
                                    });
                                }
                            } else {
                                w(l.textContent.replace(Re, ""), l, f);
                            }
                        }
                    }
                }
        ...
        html: function(e) {
            return z(this, function(e) {
                ...
                // See if we can take a shortcut and just use innerHTML
                                if (typeof e === "string" && !Pe.test(e) && !be[(me.exec(e) || [ "", "" ])[1].toLowerCase()]) {
                    e = k.htmlPrefilter(e);
                    try {
                        for (;n < i; n++) {
                            t = this[n] || {};
    ...
    function Ve(e, t, n) {
        ...
        //   .css('--customProperty) (#3144)
            ...
            // https://drafts.csswg.org/cssom/#resolved-values
                        if (!m.pixelBoxStyles() && We.test(a) && Ge.test(t)) {
    ...
    var Xe = [ "Webkit", "Moz", "ms" ], Ye = D.createElement("div").style, Je = {};
    ...
    function at(e, t, n) {
        ...
        r = !m.boxSizingReliable() || n, o = r && k.css(e, "boxSizing", false, i) === "border-box", a = o, s = Ve(e, t, i), l = "offset" + t[0].toUpperCase() + t.slice(1);
        // Support: Firefox <=54
        ...
        // In those cases, the computed value can be trusted to be border-box
                if ((!m.boxSizingReliable() && o || s === "auto" || !parseFloat(s) && k.css(e, "display", false, i) === "inline") && e.getClientRects().length) {
            o = k.css(e, "boxSizing", false, i) === "border-box";
        ...
        // Adjust for the element's box model
                return s + ot(e, t, n || (o ? "border" : "content"), a, i, 
    ...
    k.extend({
        ...
        style: function(e, t, n, i) {
            ...
            // Make sure that we're working with the right name
                        var r, o, a, s = X(t), l = tt.test(t), f = e.style;
        ...
        k.cssHooks[f] = {
            get: function(e, t, n) {
                if (t) {
                    ...
                    !e.getClientRects().length || !e.getBoundingClientRect().width) ? ce(e, nt, function() {
                        return at(e, f, n);
                    }) : at(e, f, n);
                }
            },
            set: function(e, t, n) {
                ...
                a = o || n, s = a && k.css(e, "boxSizing", false, r) === "border-box", l = n ? ot(e, f, n, s, r) : 0;
                // Account for unreliable border-box dimensions by comparing offset* to computed and
                // faking a content-box to get border and padding (gh-3699)
                                if (s && o) {
                    l -= Math.ceil(e["offset" + f[0].toUpperCase() + f.slice(1)] - parseFloat(r[f]) - ot(e, f, "border", false, r) - .5);
                }
    ...
    // Back compat <1.8 extension point
        k.fx.step = {};
    var lt, ft, ut = /^(?:toggle|show|hide)$/, ct = /queueHooks$/;
    function dt() {
        if (ft) {
            if (D.hidden === false && T.requestAnimationFrame) {
                T.requestAnimationFrame(dt);
            } else {
                T.setTimeout(dt, k.fx.interval);
            }
            k.fx.tick();
        }
    }
    ...
    function vt(e, t, n) {
        var i, r, o, a, s, l, f, u, c = "width" in t || "height" in t, d = this, p = {}, h = e.style, g = e.nodeType && ue(e), v = K.get(e, "fxshow");
    ...
    function yt(a, e, t) {
        var n, s, i = 0, r = yt.prefilters.length, l = k.Deferred().always(function() {
            ...
            var e = lt || pt(), t = Math.max(0, f.startTime + f.duration - e), 
            // Support: Android 2.3 only
        ...
        mt(u, f.opts.specialEasing);
        for (;i < r; i++) {
            n = yt.prefilters[i].call(f, a, u, f.opts);
            if (n) {
                if (y(n.stop)) {
    ...
    k.extend({
        attr: function(e, t, n) {
            ...
            // Grab necessary hook if one is defined
                        if (o !== 1 || !k.isXMLDoc(e)) {
                r = k.attrHooks[t.toLowerCase()] || (k.expr.match.bool.test(t) ? bt : undefined);
            }
            if (n !== undefined) {
                if (n === null) {
                    k.removeAttr(e, t);
    ...
    var xt = /^(?:input|select|textarea|button)$/i, Ct = /^(?:a|area)$/i;
    k.fn.extend({
        prop: function(e, t) {
        ...
        propHooks: {
            tabIndex: {
                get: function(e) {
                    ...
                    if (xt.test(e.nodeName) || Ct.test(e.nodeName) && e.href) {
                        return 0;
                    }
                    return -1;
                }
    ...
    k.fn.extend({
        ...
        toggleClass: function(r, t) {
            ...
            if (y(r)) {
                return this.each(function(e) {
                    k(this).toggleClass(r.call(this, e, Dt(this), t), t);
                });
            }
            return this.each(function() {
                var e, t, n, i;
        ...
        hasClass: function(e) {
            ...
            t = " " + e + " ";
            while (n = this[i++]) {
                if (n.nodeType === 1 && (" " + Tt(Dt(n)) + " ").indexOf(t) > -1) {
                    return true;
                }
            }
            return false;
    ...
    k.extend(k.event, {
        trigger: function(e, t, n, i) {
            ...
            // focus/blur morphs to focusin/out; ensure we're not firing them right now
                        if (Et.test(p + k.event.triggered)) {
                return;
            }
            if (p.indexOf(".") > -1) {
                ...
                if ((!u._default || u._default.apply(d.pop(), t) === false) && Y(n)) {
                    ...
                    if (l && y(n[p]) && !b(n)) {
                        ...
                        if (e.isPropagationStopped()) {
                            c.addEventListener(p, $t);
                        }
                        n[p]();
                        if (e.isPropagationStopped()) {
                            c.removeEventListener(p, $t);
                        }
    ...
    var jt = /\[\]$/, It = /\r?\n/g, Pt = /^(?:submit|button|image|reset|file)$/i, Ot = /^(?:input|select|textarea|keygen)/i;
    function Rt(n, e, i, r) {
        var t;
        if (Array.isArray(e)) {
            ...
            k.each(e, function(e, t) {
                if (i || jt.test(n)) {
                    ...
                    Rt(n + "[" + (typeof t === "object" && t != null ? e : "") + "]", t, i, r);
                }
            });
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                // Use .is( ":disabled" ) so that fieldset[disabled] works
                                return this.name && !k(this).is(":disabled") && Ot.test(this.nodeName) && !Pt.test(e) && (this.checked || !ve.test(e));
            }).map(function(e, t) {
                var n = k(this).val();
                if (n == null) {
                    return null;
    ...
    var Ht = /%20/g, qt = /#.*$/, Bt = /([?&])_=[^&]*/, Mt = /^(.*?):[ \t]*([^\r\n]*)$/gm, 
    // #7653, #8125, #8152: local protocol detection
    Ft = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, _t = /^(?:GET|HEAD)$/, Ut = /^\/\//, 
    /* Prefilters
		...
		*/
        ...
        ajax: function(e, t) {
            ...
            // We also use the url parameter if available
                        v.url = ((e || v.url || At.href) + "").replace(Ut, At.protocol + "//");
            ...
            // Set the Accepts header for the server, depending on the dataType
                        C.setRequestHeader("Accept", v.dataTypes[0] && v.accepts[v.dataTypes[0]] ? v.accepts[v.dataTypes[0]] + (v.dataTypes[0] !== "*" ? ", " + Gt + "; q=0.01" : "") : v.accepts["*"]);
        ...
        k.cssHooks[n] = Qe(m.pixelPosition, function(e, t) {
            if (t) {
                ...
                // If curCSS returns percentage, fallback to offset
                                return We.test(t) ? k(e).position()[n] + "px" : t;
            }
        });
    });
