...
(function(global) {
    ...
    function newContext(e) {
        ...
        function x(e, t, i) {
            var r, n, a, o, u, f, c, p, l, d, h, m, x = t && t.split("/"), b = s.map, v = b && b["*"];
            if (e) {
                e = e.split("/");
                c = e.length - 1;
        ...
        function E(e, t, i, n) {
            var a, s, o, u, f = null, c = t ? t.name : null, l = e, d = true, g = "";
            if (!e) {
                d = false;
                e = "_@r" + (h += 1);
            }
        ...
        function y(e, t, i) {
            ...
            if (hasProp(p, r) && (!n || n.defineEmitComplete)) {
                if (t === "defined") {
                    i(p[r]);
                }
            } else {
        ...
        function S() {
            if (globalDefQueue.length) {
                apsp.apply(c, [ c.length, 0 ].concat(globalDefQueue));
                globalDefQueue = [];
            }
        }
        n = {
            ...
            exports: function(e) {
                ...
                if (e.map.isDefine) {
                    if (e.exports) {
                        return p[e.map.id] = e.exports;
                    } else {
                        return e.exports = p[e.map.id] = {};
                    }
                }
            },
            module: function(e) {
        ...
        function j() {
            var e, i, n = s.waitSeconds * 1e3, o = n && r.startTime + n < new Date().getTime(), f = [], c = [], p = false, l = true;
            if (t) {
                return;
            }
            t = true;
        ...
        i.prototype = {
            ...
            callPlugin: function() {
                ...
                y(i, "defined", bind(this, function(i) {
                    var n, a, u, f = getOwn(d, this.map.id), c = this.map.name, p = this.map.parentMap ? this.map.parentMap.name : null, l = r.makeRequire(e.parentMap, {
                        enableBuildCallback: true
                    });
        ...
        r = {
            ...
            makeRequire: function(t, i) {
                ...
                mixin(a, {
                    ...
                    defined: function(e) {
                        return hasProp(p, E(e, t, false, true).id);
                    },
                    specified: function(e) {
                        e = E(e, t, false, true).id;
                        return hasProp(p, e) || hasProp(o, e);
                    }
                });
                if (!t) {
                    a.undef = function(e) {
                        S();
                        var i = E(e, t, true), r = getOwn(o, e);
                        b(e);
                        delete p[e];
                        delete l[i.url];
                        delete f[e];
            ...
            completeLoad: function(e) {
                var t, i, r, n = getOwn(s.shim, e) || {}, a = n.exports;
                S();
                while (c.length) {
                    i = c.shift();
                    if (i[0] === null) {
                ...
                r = getOwn(o, e);
                if (!t && !hasProp(p, e) && r && !r.inited) {
                    if (s.enforceDefine && (!a || !getGlobal(a))) {
                        if (v(e)) {
                            return;
                        } else {
                        ...
                        T([ e, n.deps || [], n.exportsFn ]);
                    }
                }
                j();
            },
            nameToUrl: function(e, t, i) {
                var n, a, o, u, f, c, p, l = getOwn(s.pkgs, e);
                if (l) {
                    e = l;
                }
                p = getOwn(d, e);
                if (p) {
                    return r.nameToUrl(p, t, i);
                }
            ...
            onScriptError: function(e) {
                var t = P(e);
                if (!v(t.id)) {
                    return k(makeError("scripterror", "Script error for: " + t.id, e, [ t.id ]));
                }
            }
        };
