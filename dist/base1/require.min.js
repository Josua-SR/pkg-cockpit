...
(function() {
    var e = document.scripts[document.scripts.length - 1];
    var t = e.getAttribute("data-main");
    if (t) {
...
(function(global) {
    ...
    function newContext(e) {
        ...
        function v(e, t, i) {
            var r, n, a, o, u, f, c, d, p, l, h, m, v = t && t.split("/"), x = s.map, b = x && x["*"];
            if (e) {
                e = e.split("/");
                c = e.length - 1;
        ...
        function E(e, t, i, n) {
            var a, s, o, u, f = null, c = t ? t.name : null, p = e, l = true, g = "";
            if (!e) {
                l = false;
                e = "_@r" + (h += 1);
            }
        ...
        function k(e, t) {
            var i = e.requireModules, r = false;
            if (t) {
                t(e);
            } else {
                each(i, function(t) {
        ...
        function j() {
            var e, i, n = s.waitSeconds * 1e3, o = n && r.startTime + n < new Date().getTime(), f = [], c = [], d = false, p = true;
            if (t) {
                return;
            }
            t = true;
        ...
        i.prototype = {
            ...
            check: function() {
                ...
                var e, t, i = this.map.id, n = this.depExports, a = this.exports, s = this.factory;
                if (!this.inited) {
                    ...
                    if (this.depCount < 1 && !this.defined) {
                        ...
                        if (this.map.isDefine && !this.ignore) {
                            ...
                            if (req.onResourceLoad) {
                                ...
                                req.onResourceLoad(r, this.map, u);
                            }
                        }
                        S(i);
                        this.defined = true;
            ...
            callPlugin: function() {
                var e = this.map, t = e.id, i = E(e.prefix);
                this.depMaps.push(i);
                y(i, "defined", bind(this, function(i) {
                    var n, a, u, f = getOwn(l, this.map.id), c = this.map.name, d = this.map.parentMap ? this.map.parentMap.name : null, p = r.makeRequire(e.parentMap, {
                        enableBuildCallback: true
                    });
                    if (this.map.unnormalized) {
                        if (i.normalize) {
                            c = i.normalize(c, function(e) {
                                return v(e, d, true);
                            }) || "";
                        }
                        a = E(e.prefix + "!" + c, this.map.parentMap);
                        y(a, "defined", bind(this, function(e) {
                        ...
                        if (u) {
                            ...
                            if (this.events.error) {
                                u.on("error", bind(this, function(e) {
                                    this.emit("error", e);
                                }));
                            }
                            u.enable();
                    ...
                    n.fromText = bind(this, function(i, a) {
                        var o = e.name, u = E(o), f = useInteractive;
                        if (a) {
                            i = a;
                        }
                        if (f) {
                        ...
                        try {
                            ...
                            return k(makeError("fromtexteval", "fromText eval for " + t + " failed: " + c, c, [ t ]));
                        }
                        if (f) {
                            useInteractive = true;
                        }
            ...
            enable: function() {
                ...
                each(this.depMaps, bind(this, function(e, t) {
                    ...
                    if (typeof e === "string") {
                        ...
                        this.depCount += 1;
                        y(e, "defined", bind(this, function(e) {
                            if (this.undefed) {
                                return;
                            }
                            this.defineDep(t, e);
                        ...
                        if (this.errback) {
                            ...
                            y(e, "error", bind(this, function(e) {
                                this.emit("error", e);
                            }));
                        }
                    }
        ...
        function A() {
            ...
            while (c.length) {
                e = c.shift();
                if (e[0] === null) {
                    return k(makeError("mismatch", "Mismatched anonymous define() module: " + e[e.length - 1]));
                } else {
                    T(e);
                }
            }
        ...
        r = {
            ...
            configure: function(e) {
                ...
                if (e.packages) {
                    each(e.packages, function(e) {
                        ...
                        s.pkgs[i] = e.name + "/" + (e.main || "main").replace(currDirRegExp, "").replace(jsSuffixRegExp, "");
                    });
                }
            ...
            makeRequire: function(t, i) {
                ...
                function a(s, u, f) {
                    ...
                    if (typeof s === "string") {
                        ...
                        c = p.id;
                        if (!hasProp(d, c)) {
                            return k(makeError("notloaded", 'Module name "' + c + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")));
                        }
                        return d[c];
                    }
                    A();
                ...
                mixin(a, {
                    isBrowser: isBrowser,
                    toUrl: function(e) {
                        var i, n = e.lastIndexOf("."), a = e.split("/")[0], s = a === "." || a === "..";
                        if (n !== -1 && (!s || n > 1)) {
                            i = e.substring(n, e.length);
                            e = e.substring(0, n);
                        }
                        return r.nameToUrl(v(e, t && t.id, true), i, true);
                    },
                    defined: function(e) {
            ...
            completeLoad: function(e) {
                var t, i, n, a = getOwn(s.shim, e) || {}, u = a.exports;
                M();
                while (c.length) {
                    i = c.shift();
                    if (i[0] === null) {
                ...
                if (!t && !hasProp(d, e) && n && !n.inited) {
                    if (s.enforceDefine && (!u || !getGlobal(u))) {
                        if (b(e)) {
                            ...
                            return k(makeError("nodefine", "No define call for " + e, null, [ e ]));
                        }
                    } else {
                        T([ e, a.deps || [], a.exportsFn ]);
                    }
                }
                j();
            },
            nameToUrl: function(e, t, i) {
                var n, a, o, u, f, c, d, p = getOwn(s.pkgs, e);
                if (p) {
                    e = p;
                }
                d = getOwn(l, e);
                ...
                if (req.jsExtRegExp.test(e)) {
                    ...
                    f = (f.charAt(0) === "/" || f.match(/^[\w\+\.\-]+:/) ? "" : s.baseUrl) + f;
                }
                return s.urlArgs ? f + ((f.indexOf("?") === -1 ? "?" : "&") + s.urlArgs) : f;
            },
            load: function(e, t) {
                req.load(r, e, t);
            },
            ...
            onScriptError: function(e) {
                ...
                if (!b(t.id)) {
                    ...
                    return k(makeError("scripterror", 'Script error for "' + t.id + (i.length ? '", needed by: ' + i.join(", ") : '"'), e, [ t.id ]));
                }
            }
        };
    ...
    e.load = function t(e, i, r, n) {
        ...
        s.onreadystatechange = function() {
            if (s.readyState != 4) {
                ...
                r.error(new Error(e + ": " + s.statusText));
            } else {
                r.error(new Error(e + ": " + s.status + " error"));
            }
        };
