!function(e) {
    ...
    !function() {
        function e() {
            ...
            function d() {
                function t() {
                    var e, t = g;
                    return e = "none" == t ? m.call("/Tuned", "com.redhat.tuned.control", "disable", []).then(function(e) {
                        return e[0] ? void c() : (console.warn("Failed to disable tuned profile:", e), r.reject(l("Failed to disable tuned profile")));
                    }) : m.call("/Tuned", "com.redhat.tuned.control", "switch_profile", [ t ]).then(function(e) {
                ...
                function n() {
                    ...
                    return m.call("/Tuned", "com.redhat.tuned.control", t, []).then(function(n) {
                ...
                function h() {
                    return m.call("/Tuned", "com.redhat.tuned.control", "profiles2", []).then(function(e) {
                        return e[0];
                    }, function() {
                        return m.call("/Tuned", "com.redhat.tuned.control", "profiles", []).then(function(e) {
                            return e[0];
                        });
                    });
                }
                function v() {
                    e(m).done(function(e, t, n) {
                ...
                p.start().done(function() {
                    c(), m = r.dbus("com.redhat.tuned", {
                        superuser: !0
                    }), v();
                }).fail(f);
            }
            var p = i.proxy("tuned.service"), u = t(n(11)), f = u.find(".action-trigger"), h = u.find("#tuned-status-tooltip");
            return h.tooltip({
                placement: "top"
            }), f.on("click", d), p.addEventListener("changed", c), c(), u[0];
        }
        var t = n(2), r = n(3), o = n(4), i = n(9), a = n(5), s = n(10), l = r.gettext;
        t(function() {
    ...
    !function(t, n) {
        ...
        function e(e, t, n, r, o) {
            ...
            return e !== $e && e !== ze || (i.uid = se()), i;
        }
        function t(e, t, n) {
            var r = e.vtype, o = null;
            return r ? r === Be ? o = l(e, t, n) : r === ze ? o = b(e, t, n) : r === $e ? o = v(e, t, n) : r === We && (o = document.createComment("react-text: " + (e.uid || se()))) : o = document.createTextNode(e), 
            o;
        }
        function n(e, t, n, o) {
            var i = e.vtype;
            if (i === ze) return k(e, t, n, o);
            if (i === $e) return m(e, t, n, o);
            if (i !== Be) return n;
        ...
        function o(e) {
            if (e) {
                ...
                e.shouldIgnore || (t.vtype ? t.vtype === Be ? f(t, e.newVnode, n, e.parentContext) : t.vtype === $e ? n = m(t, e.newVnode, n, e.parentContext) : t.vtype === ze && (n = k(t, e.newVnode, n, e.parentContext)) : n.replaceData(0, n.length, e.newVnode));
        ...
        function s(e, t) {
            var n = e.vtype;
            n === Be ? h(e, t) : n === ze ? x(e, t) : n === $e && g(e, t);
        }
        function l(e, t, n) {
        ...
        function u(e, t, n, r, o) {
            if (r.vchildren) {
                ...
                if (0 !== l) if (0 !== c) {
                    for (var p = Array(c), f = null, h = null, v = 0; v < l; v++) for (var m = a[v], g = 0; g < c; g++) if (!p[g]) {
                        var y = s[g];
                        if (m === y) {
                            p[g] = {
                                shouldIgnore: R(r),
                ...
                } else for (var v = 0; v < l; v++) oe(e.removes, {
                    vnode: a[v],
                    node: i[v]
                }); else if (c > 0) for (var v = 0; v < c; v++) oe(e.creates, {
                    vnode: s[v],
                    parentNode: r,
                    parentContext: o,
                    index: v
        ...
        function R(e) {
            ...
            if (t) for (var r = 0; r < t.length; r++) {
                var o = t[r];
                if ((o.vtype === ze || o.vtype === $e) && o.type.contextTypes) return !1;
            }
        ...
        function j(e, t, n) {
            ...
            if (r[t] = n, 1 === et[t]) return void (e[t] = q);
        ...
        function G(e) {
            ...
            for (var i in t) if (t.hasOwnProperty(i)) {
                ...
                ut[i] = {
                    ...
                    hasNumericValue: J(a, vt),
                    hasPositiveNumericValue: J(a, mt),
        ...
        function be(t, n, r) {
            ...
            if ("string" == typeof t) o = Be; else {
                ...
                o = t.prototype && t.prototype.isReactComponent ? ze : $e;
            }
            var i = null, a = null, s = {};
        ...
        var Ie = "dangerouslySetInnerHTML", Ve = "http://www.w3.org/2000/svg", qe = "liteid", Be = 2, $e = 3, ze = 4, We = 5, He = 1, Xe = 9, Ye = 11, Ge = null, Je = [], Ze = [], Ke = {
            updaters: [],
            isPending: !1,
            add: function(e) {
                oe(this.updaters, e);
