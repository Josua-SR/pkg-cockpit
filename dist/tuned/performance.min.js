!function(e) {
    ...
    !function() {
        function e() {
            ...
            var p = i.proxy("tuned.service"), u = t(n(10)), f = u.find(".action-trigger"), h = u.find("#tuned-status-tooltip");
            return h.tooltip({
                placement: "top"
            }), f.on("click", d), p.addEventListener("changed", c), c(), u[0];
        }
        var t = n(2), r = n(3), o = n(4), i = n(8), a = n(5), s = n(9), l = r.gettext;
        t(function() {
    ...
    var a = o.createClass({
        ...
        render: function() {
            ...
            var a, s, l = this, c = this.props.actions.map(function(e) {
                var t;
    ...
    !function(t, n) {
        ...
        function l(e, t, n) {
            ...
            "svg" === r || n === qe ? (i = document.createElementNS(qe, r), n = qe) : i = document.createElement(r), 
            c(e, i, t);
        ...
        function u(e, t, n, r, o) {
            if (r.vchildren) {
                ...
                if (0 !== l) if (0 !== c) {
                    ...
                    for (var v = 0; v < c; v++) {
                        var P = p[v];
                        P ? P.vnode.vtype === Be && u(e, P.vnode, P.newVnode, P.node, P.parentContext) : (h || (h = []), 
                        oe(h, {
                            vnode: s[v],
                            parentNode: r,
                            parentContext: o,
        ...
        function y(t, n) {
            var r = t.type, o = t.props, i = P(n, r.contextTypes), a = r(o, i);
        ...
        function b(e, n, r) {
            var o = e.type, i = e.props, a = e.uid, s = P(n, o.contextTypes), l = new o(i, s), c = l.$updater, d = l.$cache;
            ...
            var p = C(l), u = t(p, w(l, n), r);
            return u.cache = u.cache || {}, u.cache[a] = l, d.vnode = p, d.node = u, d.isMounted = !0, 
            oe(Je, l), null != e.ref && (oe(Ze, e), oe(Ze, l)), u;
        }
        function k(e, t, n, r) {
            var o = e.uid, i = n.cache[o], a = i.$updater, s = i.$cache, l = t.type, c = t.props, d = P(r, l.contextTypes);
        ...
        function j(e, t, n) {
            ...
            if (ot[t] || (document.addEventListener(t.substr(2), q, !1), ot[t] = !0), tt && t === rt) return void e.addEventListener("click", nt, !1);
            e.nodeName;
        ...
        function le(e, t, n, r) {
            _t.test(t) ? j(e, t, n) : "style" === t ? z(e.style, n) : t === Ie ? n && null != n.__html && (e.innerHTML = n.__html) : r ? null == n ? e.removeAttribute(t) : e.setAttribute(t, "" + n) : Z(e, t, n);
        }
        function ce(e, t, n, r) {
            _t.test(t) ? I(e, t) : "style" === t ? W(e.style, n) : t === Ie ? e.innerHTML = "" : r ? e.removeAttribute(t) : K(e, t);
        }
        ...
        var Ie = "dangerouslySetInnerHTML", qe = "http://www.w3.org/2000/svg", Ve = "liteid", Be = 2, $e = 3, ze = 4, We = 5, He = 1, Xe = 9, Ye = 11, Ge = null, Je = [], Ze = [], Ke = {
            updaters: [],
            isPending: !1,
            add: function(e) {
                oe(this.updaters, e);
        ...
        D.prototype = {
            ...
            forceUpdate: function(e) {
                ...
                if (n.isMounted) {
                    ...
                    var u = C(this), f = T(p, u, d, w(this, c));
        ...
        Object.keys(xt).map(function(e) {
            Pt.props[e] = 0, xt[e] && (Pt.domAttrs[e] = xt[e]);
        }), G(yt), G(Pt);
        var Ct = Array.isArray, wt = 0, _t = /^on/i;
    ...
    !function() {
        ...
        function o(e) {
            ...
            function o() {
                k.service = P, k.dispatchEvent("changed");
            }
            function l() {
                function e(e, t) {
                ...
                x && P && (e(x.path, "org.freedesktop.systemd1.Unit"), e(P.path, "org.freedesktop.systemd1.Service"));
            }
            ...
            e.indexOf(".") == -1 && (e += ".service"), r(function() {
                a.LoadUnit(e).done(function(e) {
                    ...
                    t(x, n), P = i.proxy("org.freedesktop.systemd1.Service", e), P.addEventListener("changed", o), 
                    t(P, o);
                }).fail(function(e) {
            ...
            return a.addEventListener("JobRemoved", function(e, t, n, r, o) {
                w[n] && ("done" == o ? w[n].resolve() : w[n].reject(o), delete w[n]);
            }), k;
        }
        var i, a, s = n(3);
        e.exports = {
