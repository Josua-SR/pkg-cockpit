!function(t) {
    ...
    !function() {
        ...
        function i(t, s) {
            ...
            return t.empty(), i.open(t[0]), e.typeable = function(t) {
                i.cursorHidden = !t, i.refresh(i.y, i.y), r = t;
            }, e.focus = function() {
                i.focus();
            }, e.close = function() {
                i.destroy();
        ...
        c.pull = function(t, e, i) {
            ...
            function u() {
                return d.connected = !1, y ? void (g = l.request(h.extend({}, n, y)).always(function() {
                    g = null;
                }).done(function(t) {
                    ...
                    c(t.message);
                })) : p(b === !1 ? "GET /v1.15/containers/" + encodeURIComponent(t) + "/logs?follow=1&stdout=1&stderr=1&tail=1000&timestamps=0 HTTP/1.0\r\nContent-Length: 0\r\n\r\n" : "POST /v1.15/containers/" + encodeURIComponent(t) + "/attach?logs=1&stream=1&stdin=1&stdout=1&stderr=1 HTTP/1.0\r\nContent-Length: 0\r\n\r\n");
            }
            function p(e) {
                k && k.close(), k = null;
                var l = h.extend({}, n, {
    ...
    (function(e) {
        (function() {
            ...
            var v = 0, x = 1, k = 2, g = 3, w = 4, M = 5, C = 6, S = {
                type: "udk"
            };
            ...
            h.vcolors = function() {
                ...
                h.focus === this && (this.sendFocus && this.send("[O"), h.focus = null);
                ...
                "useFocus" in this.options && !this.options.useFocus || _(function() {
                    e.element.focus();
                ...
                function i(t, s) {
                    ...
                    var i = [];
                    e(i, t), e(i, s.x), e(i, s.y), l.send("[M" + P.fromCharCode.apply(P, i));
                }
                function r(t) {
                    var s, e, i, r, o;
                    switch (t.type) {
                ...
                a(h, "mousedown", function(e) {
                    l.mouseEvents && (t(e), l.focus(), l.normalMouse && a(l.document, "mousemove", s), 
                ...
                var e, i, r, o, a, n, c, l, u, p, d, y, b;
                for (c = this.cols, i = t, s >= this.lines.length && (this.log("`end` is too large. Most likely a bad CSR."), 
                s = this.lines.length - 1); i <= s; i++) {
                    for (b = i + this.ydisp, o = this.lines[b], a = "", e = i !== this.y || this.ydisp !== this.ybase && !this.selectMode || this.cursorHidden ? -1 : this.x, 
                    u = this.defAttr, r = 0; r < c; r++) {
                        ...
                        p = 511 & l, d = l >> 9 & 511, y = l >> 18, 1 & y && (h.brokenBold || (a += "term-bold "), 
                        d < 8 && (d += 8)), 2 & y && (a += "term-underline "), 4 & y && (a += "term-blink "), 
                        8 & y && (p = l >> 9 & 511, d = 511 & l, 1 & y && d < 8 && (d += 8)), 16 & y && (a += "term-hidden "), 
                        256 !== p && (a += "term-bg-color-" + p + " "), 257 !== d && (a += "term-fg-color-" + d + " "), 
                        a += '">'))), n) {
                          case "&":
                            a += "&amp;";
                            break;
                ...
                this.maxRange()); o < r; o++, this.lch = i) switch (i = t[o], this.state) {
                  ...
                  case x:
                    switch (i) {
                      ...
                      case "P":
                        this.params = [], this.prefix = "", this.currentParam = "", this.state = M;
                        break;
                ...
                switch (t.keyCode) {
                  ...
                  default:
                    if (t.ctrlKey) if (t.keyCode >= 65 && t.keyCode <= 90) {
                        ...
                        if ((this.prefixMode || this.selectMode) && 67 === t.keyCode) return void (this.visualMode && _(function() {
                            e.leaveVisual();
                        }, 1));
                        s = P.fromCharCode(t.keyCode - 64);
                    } else 32 === t.keyCode ? s = P.fromCharCode(0) : t.keyCode >= 51 && t.keyCode <= 55 ? s = P.fromCharCode(t.keyCode - 51 + 27) : 56 === t.keyCode ? s = P.fromCharCode(127) : 219 === t.keyCode ? s = P.fromCharCode(27) : 221 === t.keyCode && (s = P.fromCharCode(29)); else t.altKey && (t.keyCode >= 65 && t.keyCode <= 90 ? s = "" + P.fromCharCode(t.keyCode + 32) : 192 === t.keyCode ? s = "`" : t.keyCode >= 48 && t.keyCode <= 57 && (s = "" + (t.keyCode - 48)));
                }
                return !s || (this.prefixMode ? (this.leavePrefix(), c(t)) : this.selectMode ? (this.keySelect(t, s), 
                c(t)) : (this.emit("keydown", t), this.emit("key", s, t), this.handler(s), c(t)));
                ...
                return !(!s || t.ctrlKey || t.altKey || t.metaKey) && (s = P.fromCharCode(s), this.prefixMode ? (this.leavePrefix(), 
                this.keyPrefix(t, s), !1) : this.selectMode ? (this.keySelect(t, s), !1) : (this.emit("keypress", s, t), 
                this.emit("key", s, t), this.handler(s), !1));
                ...
                if (this.emit("bell"), this.visualBell) {
                    var t = this;
                    this.element.style.borderColor = "white", _(function() {
            ...
            h.prototype.fillRectangle = function(t) {
                ...
                e = o; e < a; e++) s[e] = [ s[e][0], P.fromCharCode(i) ];
            ...
            h.prototype.requestLocatorPosition = function(t) {}, h.prototype.insertColumns = function() {
                ...
                if (this.searchMode || "n" === s || "N" === s) return this.keySearch(t, s);
                if ("" === s) {
            ...
            var P = this.String, _ = this.setTimeout;
            this.setInterval;
