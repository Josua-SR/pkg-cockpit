            ...
            (function() {
                ...
                o.vcolors = function() {
                    ...
                    a(o, "mousedown", function(s) {
                        h.mouseEvents && (t(s), h.focus(), h.normalMouse && a(h.document, "mousemove", e), 
                    ...
                    e = this.lines.length - 1); i <= e; i++) {
                        ...
                        u = this.defAttr, n = 0; n < l; n++) {
                            ...
                            h !== this.defAttr && (h === -1 ? a += '<span class="reverse-video terminal-cursor">' : (a += '<span class="', 
                            f = 511 & h, p = h >> 9 & 511, m = h >> 18, 1 & m && (o.brokenBold || (a += "term-bold "), 
                            p < 8 && (p += 8)), 2 & m && (a += "term-underline "), 4 & m && (a += "term-blink "), 
                            8 & m && (f = h >> 9 & 511, p = 511 & h, 1 & m && p < 8 && (p += 8)), 16 & m && (a += "term-hidden "), 
                ...
                var T = this.String, E = this.setTimeout;
                this.setInterval;
