!function(e) {
    ...
    !function() {
        ...
        n.test("bytes_from_format", function() {
            ...
            for (var s = 0; s < t.length; s++) {
                for (var n, r = [], i = void 0, o = 0; o < 16 && (n = e.json_skip(t[s][1], i), r.push(n), 
                0 !== n); o++) i = n;
                a.deepEqual(r, t[s][2], "json_skip(): " + t[s][0]);
            }
    ...
    !function() {
        ...
        function n(e, t) {
            var s = this, n = new d({
                ...
                inlineStyle: !1,
                useFocus: !1
            }), a = !0, r = o.utf8_decoder(), u = o.utf8_encoder();
            ...
            s.typeable(!1), s) : (i(t).on("close", function(e, a) {
                var r = a.problem || "disconnected";
                n.write("[31m" + r + "[m\r\n"), s.typeable(!1), i(t).off("message"), t = null;
            }), s.process = function(e) {
                return n.write(r.decode(e)), e.length;
        ...
        function a(e, t) {
            function s(e) {
                d.push(e), r || (r = window.setTimeout(function() {
                    r = null;
                    var e = a[0].scrollHeight - a.scrollTop() <= a.outerHeight(), t = i("<span>").text(d.join(""));
            ...
            return n.process = function(e) {
                ...
                return a;
            }, n.focus = function() {}, n.close = function() {}, i(t).on("close", function(e, n) {
                s(n.reason || "disconnected"), i(t).off(), t = null;
            }), n;
        }
        function r(e, t) {
            var s, n, a = t.length, r = e.length - a + 1;
            for (n = 0; n < r; n++) {
        ...
        var i = s(2), o = s(3), d = s(5), u = {}, l = o.http("/var/run/docker.sock", {
            superuser: !0
        });
        u.pull = function(e, s, n) {
            ...
            var r, o = {
                ...
                if (0 !== t) {
                    ...
                    d = d.substring(t), s.error ? r = s.error : s.status && a.notify(s.status, s);
                }
            }).fail(function(e) {
                a.reject(e);
            }).done(function() {
                r ? a.reject(new Error(r)) : a.resolve();
            }), c = a.promise();
            ...
            function _() {
                ...
                var t = l.request(i.extend({}, d, f)).always(function() {
                    t = null;
                }).done(function(e) {
            ...
            function c(s) {
                ...
                L = o.channel(l), t(s), L.send(s), i(L).on("close.attach", function(n, a) {
                    t(e + ": console close: ", a), i(L).off(".attach"), L = null, m.connected && !a.problem && window.setTimeout(function() {
                        m.connected && !L && c(s);
                    }, 1e3);
                });
                ...
                h.callback = function(s) {
                    var i, d = 0, l = 0;
                    if (null === _) {
                        if (l = r(s, [ 13, 10, 13, 10 ]), l == -1) return d;
                        if (_ = s.subarray ? o.utf8_decoder().decode(s.subarray(0, l)) : o.utf8_decoder().decode(s.slice(0, l)), 
                        t(e + ": console headers: ", _), i = _.split("\r\n", 1)[0].split(" "), "200" != i[1]) return u(i.slice(2).join(" ")), 
                    ...
                    Y = p ? new n(m, L) : new a(m, L), m.typeable(M), m.connected = !0, h.callback = Y.process;
                    var c = Y.process(s);
                    return d + c;
                };
            }
            function h() {
                Y && Y.typeable && Y.typeable(M && y);
            }
            var m = i("<div>").addClass("console-ct");
            m.connected = !1;
            var f, p, M = !1, y = !1, L = null, Y = null;
            ...
            return m.close = function(e) {
                m.connected = !1, g && g.close(e), L && L.close(e), Y && (Y.close(), Y = null);
            }, m.connect = function() {
                m.close("disconnected"), _();
            }, i(m).on("focusin", function() {
                y = !0, h(), Y.focus();
            ...
            var s, n = !1, a = e.length, r = 0, i = !1, o = !1, d = ' \t\n\r\v[{}]"', u = " \t\n\r\v";
            for (void 0 === t && (t = 0), a = e.length; t != a && !(n && r <= 0); t++) if (s = e[t], 
            i) d.indexOf(s) != -1 && (i = !1, r--, t--); else if (u.indexOf(s) == -1) if (o) switch (s) {
              case "\\":
                if (t + 1 == a) continue;
                t++;
                break;
            ...
            var a, r = [];
            for (a = 0, s(); a < e.length; ) r.push(n()), s();
            return r;
        };
        ...
        u.bytes_from_format = function(e, t) {
            var s = 1024;
            void 0 === t && (t = " ");
            var n = e.split(t).pop().toUpperCase(), a = _.indexOf(n), r = parseFloat(e);
            return a > 0 && !isNaN(r) ? r * Math.pow(s, a) : r;
    ...
    (function(s) {
        (function() {
            ...
            function i(e) {
                ...
                r.call(this), "number" == typeof e && (e = {
                    cols: arguments[0],
                    rows: arguments[1],
                    handler: arguments[2]
                }), e = e || {}, f(p(i.defaults), function(s) {
                    null == e[s] && (e[s] = i.options[s], i[s] !== i.defaults[s] && (e[s] = i[s])), 
                    t[s] = e[s];
                }), 8 === e.colors.length ? e.colors = e.colors.concat(i._colors.slice(8)) : 16 === e.colors.length ? e.colors = e.colors.concat(i._colors.slice(16)) : 10 === e.colors.length ? e.colors = e.colors.slice(0, -2).concat(i._colors.slice(8, -2), e.colors.slice(-2)) : 18 === e.colors.length && (e.colors = e.colors.slice(0, -2).concat(i._colors.slice(16, -2), e.colors.slice(-2))), 
            ...
            function m(e, t, s) {
                ...
                for (var a, r, o, d, u, l = 1 / 0, _ = -1, c = 0; c < i.vcolors.length; c++) {
                    if (a = i.vcolors[c], r = a[0], o = a[1], d = a[2], u = m.distance(e, t, s, r, o, d), 
                    0 === u) {
                        _ = c;
                        break;
                    }
            ...
            }, l(r, s), r.prototype.pipe = function(e, t) {
                function s() {
                    i.removeListener("data", n), i.removeListener("error", a), i.removeListener("end", r), 
                    e.removeListener("error", a), e.removeListener("close", s);
                }
                var n, a, r, i = this;
                return i.on("data", n = function(t) {
                    e.write(t);
                }), i.on("error", a = function(e) {
                    if (s(), !this.listeners("error").length) throw e;
                }), i.on("end", r = function() {
                    e.end(), s();
                }), e.on("error", a), e.on("close", s), e.emit("pipe", i), e;
            };
            var y = 0, L = 1, Y = 2, g = 3, k = 4, v = 5, b = 6, w = {
                type: "udk"
            };
            l(i, r), i.tangoColors = [ "#2e3436", "#cc0000", "#4e9a06", "#c4a000", "#3465a4", "#75507b", "#06989a", "#d3d7cf", "#555753", "#ef2929", "#8ae234", "#fce94f", "#729fcf", "#ad7fa8", "#34e2e2", "#eeeeec" ], 
            i.xtermColors = [ "#000000", "#cd0000", "#00cd00", "#cdcd00", "#0000ee", "#cd00cd", "#00cdcd", "#e5e5e5", "#7f7f7f", "#ff0000", "#00ff00", "#ffff00", "#5c5cff", "#ff00ff", "#00ffff", "#ffffff" ], 
            i.colors = function() {
                function e(e, s, a) {
                    n.push("#" + t(e) + t(s) + t(a));
                }
                ...
                var s, n = i.tangoColors.slice(), a = [ 0, 95, 135, 175, 215, 255 ];
                for (s = 0; s < 216; s++) e(a[s / 36 % 6 | 0], a[s / 6 % 6 | 0], a[s % 6]);
                for (s = 0; s < 24; s++) a = 8 + 10 * s, e(a, a, a);
                return n;
            }(), i.colors[256] = "#000000", i.colors[257] = "#f0f0f0", i._colors = i.colors.slice(), 
            i.vcolors = function() {
                for (var e, t = [], s = i.colors, n = 0; n < 256; n++) e = parseInt(s[n].substring(1), 16), 
                ...
                screenKeys: !1,
                debug: !1
            }, i.options = {}, f(p(i.defaults), function(e) {
                i[e] = i.defaults[e], i.options[e] = i.defaults[e];
            }), i.focus = null, i.prototype.focus = function() {
                i.focus !== this && (i.focus && i.focus.blur(), this.sendFocus && this.send("[I"), 
                i.focus = this);
            }, i.prototype.blur = function() {
                i.focus === this && (this.sendFocus && this.send("[O"), i.focus = null);
            }, i.prototype.initGlobal = function() {
                var e = this.document;
                i._boundDocs = i._boundDocs || [], ~c(i._boundDocs, e) || (i._boundDocs.push(e), 
                i.bindPaste(e), i.bindKeys(e), i.bindCopy(e), this.isMobile && this.fixMobile(e));
            }, i.bindPaste = function(e) {
                var t = e.defaultView;
                ...
                o(e, "keydown", function(e) {
                    if (i.focus) {
                        ...
                        if (t) return t === i.focus.element || t === i.focus.context || t === i.focus.document || t === i.focus.body || t === i._textarea || t === i.focus.parent ? i.focus.keyDown(e) : void 0;
                    }
                }, !0), o(e, "keypress", function(e) {
                    if (i.focus) {
                        var t = e.target || e.srcElement;
                        if (t) return t === i.focus.element || t === i.focus.context || t === i.focus.document || t === i.focus.body || t === i._textarea || t === i.focus.parent ? i.focus.keyPress(e) : void 0;
                    }
                }, !0), o(e, "mousedown", function(e) {
                    if (i.focus) {
                        var t = e.target || e.srcElement;
                        if (t) {
                            do if (t === i.focus.element) return; while (t = t.parentNode);
                            i.focus.blur();
                        }
                    }
                });
            }, i.bindCopy = function(e) {
                var t = e.defaultView;
                o(t, "copy", function(e) {
                    var t = i.focus;
                    if (t && t._selected) {
            ...
            }, i.prototype.fixMobile = function(e) {
                ...
                s.autocorrect = "off", e.getElementsByTagName("body")[0].appendChild(s), i._textarea = s, 
                T(function() {
                    s.focus();
                ...
                "useFocus" in this.options && !this.options.useFocus || (this.focus(), o(this.element, "focus", function() {
                    s.focus(), s.isMobile && i._textarea.focus();
                ...
                "useFocus" in this.options && !this.options.useFocus || T(function() {
                    s.element.focus();
                }, 100), null == i.brokenBold && (i.brokenBold = _(this.document)), this.emit("open");
            }, i.prototype.setRawMode = function(e) {
                this.isRaw = !!e;
            }, i.prototype.bindMouse = function() {
                function e(e) {
                    var t, s;
                    if (t = a(e), s = r(e)) switch (n(t, s), e.type) {
                      case "mousedown":
                        _ = t;
                        break;
                ...
                function a(e) {
                    ...
                    return s = e.shiftKey ? 4 : 0, n = e.metaKey ? 8 : 0, a = e.ctrlKey ? 16 : 0, r = s | n | a, 
                    l.vt200Mouse ? r &= a : l.normalMouse || (r = 0), t = 32 + (r << 2) + t;
                }
                function r(e) {
                    var t, s, n, a, r;
                    if (null != e.pageX) {
                        for (t = e.pageX, s = e.pageY, r = l.element; r && r !== l.document.documentElement; ) t -= r.offsetLeft, 
                ...
                var i = this.element, l = this, _ = 32, c = "onmousewheel" in this.context ? "mousewheel" : "DOMMouseScroll";
                o(i, "mousedown", function(s) {
            ...
            }, i.prototype.close = i.prototype.destroySoon = i.prototype.destroy = function() {
                ...
                var s, n, a, r, o, d, u, l, _, c, m, f, p;
                for (u = this.cols, n = e, t >= this.lines.length && (this.log("`end` is too large. Most likely a bad CSR."), 
                t = this.lines.length - 1); n <= t; n++) {
                    for (p = n + this.ydisp, r = this.lines[p], o = "", s = n !== this.y || this.ydisp !== this.ybase && !this.selectMode || this.cursorHidden ? -1 : this.x, 
                    _ = this.defAttr, a = 0; a < u; a++) {
                        switch (l = r[a][0], d = r[a][1], a === s && (l = -1), l !== _ && (_ !== this.defAttr && (o += "</span>"), 
                        l !== this.defAttr && (l === -1 ? o += '<span class="reverse-video terminal-cursor">' : (o += '<span class="', 
                        c = 511 & l, m = l >> 9 & 511, f = l >> 18, 1 & f && (i.brokenBold || (o += "term-bold "), 
                ...
                this.maxRange()); r < a; r++, this.lch = n) switch (n = e[r], this.state) {
                  ...
                  case L:
                    switch (n) {
                      ...
                      case "%":
                        this.setgLevel(0), this.setgCharset(0, i.charsets.US), this.state = y, r++;
                        break;
                  ...
                  case k:
                    switch (n) {
                      ...
                      case "Y":
                        s = i.charsets.Italian;
                        break;

                      case "E":
                      case "6":
                        s = i.charsets.NorwegianDanish;
                        break;

                      case "Z":
                        s = i.charsets.Spanish;
                        break;

                      case "H":
                      case "7":
                        s = i.charsets.Swedish;
                        break;
            ...
            }, i.prototype.resume = function() {}, i.prototype.pause = function() {}, i.prototype.keyDown = function(e) {
                var t, s = this;
                switch (e.keyCode) {
                  case 8:
                    if (e.altKey) {
                ...
                var s, n, a, r, i;
                if (e < 1 && (e = 1), t < 1 && (t = 1), r = this.cols, r < e) for (i = [ this.defAttr, " " ], 
                a = this.lines.length; a--; ) for (;this.lines[a].length < e; ) this.lines[a].push(i); else if (r > e) for (a = this.lines.length; a--; ) for (;this.lines[a].length > e; ) this.lines[a].pop();
                if (this.setupStops(r), this.cols = e, this.columns = e, r = this.rows, r < t) for (n = this.element; r++ < t; ) this.lines.length < t + this.ybase && this.lines.push(this.blankLine()), 
                this.children.length < t && (s = this.document.createElement("div"), n.appendChild(s), 
                this.children.push(s)); else if (r > t) for (;r-- > t; ) if (this.lines.length > t + this.ybase && this.lines.pop(), 
                ...
                this.eraseRight(0, e);
            }, i.prototype.blankLine = function(e) {
                ...
                this.options.rows = this.rows, this.options.cols = this.cols, i.call(this, this.options), 
                this.refresh(0, this.rows - 1);
                ...
                switch (e[0]) {
                  ...
                  case 3:                }
            }, i.prototype.eraseInLine = function(e) {
                switch (e[0]) {
                  case 0:
            ...
            }, i.prototype.charAttributes = function(e) {
                if (1 === e.length && 0 === e[0]) return void (this.curAttr = this.defAttr);
                for (var t, s = e.length, n = 0, a = this.curAttr >> 18, r = this.curAttr >> 9 & 511, i = 511 & this.curAttr; n < s; n++) t = e[n], 
                t >= 30 && t <= 37 ? r = t - 30 : t >= 40 && t <= 47 ? i = t - 40 : t >= 90 && t <= 97 ? (t += 8, 
                r = t - 90) : t >= 100 && t <= 107 ? (t += 8, i = t - 100) : 0 === t ? (a = this.defAttr >> 18, 
                r = this.defAttr >> 9 & 511, i = 511 & this.defAttr) : 1 === t ? a |= 1 : 4 === t ? a |= 2 : 5 === t ? a |= 4 : 7 === t ? a |= 8 : 8 === t ? a |= 16 : 22 === t ? a &= -2 : 24 === t ? a &= -3 : 25 === t ? a &= -5 : 27 === t ? a &= -9 : 28 === t ? a &= -17 : 39 === t ? r = this.defAttr >> 9 & 511 : 49 === t ? i = 511 & this.defAttr : 38 === t ? 2 === e[n + 1] ? (n += 2, 
                r = m(255 & e[n], 255 & e[n + 1], 255 & e[n + 2]), r === -1 && (r = 511), n += 2) : 5 === e[n + 1] && (n += 2, 
                t = 255 & e[n], r = t) : 48 === t ? 2 === e[n + 1] ? (n += 2, i = m(255 & e[n], 255 & e[n + 1], 255 & e[n + 2]), 
                i === -1 && (i = 511), n += 2) : 5 === e[n + 1] && (n += 2, t = 255 & e[n], i = t) : 100 === t ? (r = this.defAttr >> 9 & 511, 
                i = 511 & this.defAttr) : this.error("Unknown SGR attribute: %d.", t);
                this.curAttr = a << 18 | r << 9 | i;
            }, i.prototype.deviceStatus = function(e) {
                if (this.prefix) {
            ...
            }, i.prototype.insertChars = function(e) {
                var t, s, n, a;
                for (t = e[0], t < 1 && (t = 1), s = this.y + this.ybase, n = this.x, a = [ this.eraseAttr(), " " ]; t-- && n < this.cols; ) this.lines[s].splice(n++, 0, a), 
                this.lines[s].pop();
            }, i.prototype.cursorNextLine = function(e) {
                var t = e[0];
                t < 1 && (t = 1), this.y += t, this.y >= this.rows && (this.y = this.rows - 1), 
                this.x = 0;
            }, i.prototype.cursorPrecedingLine = function(e) {
                var t = e[0];
                t < 1 && (t = 1), this.y -= t, this.y < 0 && (this.y = 0), this.x = 0;
            }, i.prototype.cursorCharAbsolute = function(e) {
                var t = e[0];
                t < 1 && (t = 1), this.x = t - 1;
            }, i.prototype.insertLines = function(e) {
                var t, s, n;
            ...
            }, i.prototype.linePosAbsolute = function(e) {
                var t = e[0];
                t < 1 && (t = 1), this.y = t - 1, this.y >= this.rows && (this.y = this.rows - 1);
            }, i.prototype.VPositionRelative = function(e) {
                var t = e[0];
                t < 1 && (t = 1), this.y += t, this.y >= this.rows && (this.y = this.rows - 1);
            }, i.prototype.HVPosition = function(e) {
                ...
                if ("object" != typeof e) if (this.prefix) {
                    if ("?" === this.prefix) switch (e) {
                      ...
                      case 2:
                        this.setgCharset(0, i.charsets.US), this.setgCharset(1, i.charsets.US), this.setgCharset(2, i.charsets.US), 
                        this.setgCharset(3, i.charsets.US);
                        break;
            ...
            }, i.prototype.resetMode = function(e) {
                if ("object" != typeof e) if (this.prefix) {
                    if ("?" === this.prefix) switch (e) {
                      case 1:
            ...
            }, i.prototype.scrollDown = function(e) {
                for (var t = e[0] || 1; t--; ) this.lines.splice(this.ybase + this.scrollBottom, 1), 
                this.lines.splice(this.ybase + this.scrollTop, 0, this.blankLine());
                this.updateRange(this.scrollTop), this.updateRange(this.scrollBottom);
            }, i.prototype.initMouseTracking = function(e) {}, i.prototype.resetTitleModes = function(e) {}, 
            i.prototype.cursorBackwardTab = function(e) {
                for (var t = e[0] || 1; t--; ) this.x = this.prevStop();
            }, i.prototype.repeatPrecedingCharacter = function(e) {
                for (var t = e[0] || 1, s = this.lines[this.ybase + this.y], n = s[this.x - 1] || [ this.defAttr, " " ]; t--; ) s[this.x++] = n;
            }, i.prototype.tabClear = function(e) {
                var t = e[0];
                t <= 0 ? delete this.tabs[this.x] : 3 === t && (this.tabs = {});
            }, i.prototype.mediaCopy = function(e) {}, i.prototype.setResources = function(e) {}, 
            i.prototype.disableModifiers = function(e) {}, i.prototype.setPointerMode = function(e) {}, 
            i.prototype.softReset = function(e) {
                ...
                this.charsets = [ null ];
            }, i.prototype.requestAnsiMode = function(e) {}, i.prototype.requestPrivateMode = function(e) {}, 
            i.prototype.setConformanceLevel = function(e) {}, i.prototype.loadLEDs = function(e) {}, 
            i.prototype.setCursorStyle = function(e) {}, i.prototype.setCharProtectionAttr = function(e) {}, 
            i.prototype.restorePrivateValues = function(e) {}, i.prototype.setAttrInRectangle = function(e) {
                for (var t, s, n = e[0], a = e[1], r = e[2], i = e[3], o = e[4]; n < r + 1; n++) for (t = this.lines[this.ybase + n], 
                s = a; s < i; s++) t[s] = [ o, t[s][1] ];
                this.updateRange(e[0]), this.updateRange(e[2]);
            }, i.prototype.savePrivateValues = function(e) {}, i.prototype.manipulateWindow = function(e) {}, 
            i.prototype.reverseAttrInRectangle = function(e) {}, i.prototype.setTitleModeFeature = function(e) {}, 
            i.prototype.setWarningBellVolume = function(e) {}, i.prototype.setMarginBellVolume = function(e) {}, 
            i.prototype.copyRectangle = function(e) {}, i.prototype.enableFilterRectangle = function(e) {}, 
            i.prototype.requestParameters = function(e) {}, i.prototype.selectChangeExtent = function(e) {}, 
            i.prototype.fillRectangle = function(e) {
                for (var t, s, n = e[0], a = e[1], r = e[2], i = e[3], o = e[4]; a < i + 1; a++) for (t = this.lines[this.ybase + a], 
                s = r; s < o; s++) t[s] = [ t[s][0], D.fromCharCode(n) ];
                this.updateRange(e[1]), this.updateRange(e[3]);
            }, i.prototype.enableLocatorReporting = function(e) {
                e[0] > 0;
            }, i.prototype.eraseRectangle = function(e) {
                var t, s, n, a = e[0], r = e[1], i = e[2], o = e[3];
                for (n = [ this.eraseAttr(), " " ]; a < i + 1; a++) for (t = this.lines[this.ybase + a], 
                s = r; s < o; s++) t[s] = n;
                this.updateRange(e[0]), this.updateRange(e[2]);
            }, i.prototype.setLocatorEvents = function(e) {}, i.prototype.selectiveEraseRectangle = function(e) {}, 
            i.prototype.requestLocatorPosition = function(e) {}, i.prototype.insertColumns = function() {
                for (var e, t = params[0], s = this.ybase + this.rows, n = [ this.eraseAttr(), " " ]; t--; ) for (e = this.ybase; e < s; e++) this.lines[e].splice(this.x + 1, 0, n), 
                this.lines[e].pop();
                this.maxRange();
            }, i.prototype.deleteColumns = function() {
                for (var e, t = params[0], s = this.ybase + this.rows, n = [ this.eraseAttr(), " " ]; t--; ) for (e = this.ybase; e < s; e++) this.lines[e].splice(this.x, 1), 
                this.lines[e].push(n);
                this.maxRange();
            }, i.prototype.enterPrefix = function() {
                this.prefixMode = !0;
            }, i.prototype.leavePrefix = function() {
                this.prefixMode = !1;
            }, i.prototype.enterSelect = function() {
                this._real = {
                    x: this.x,
                    y: this.y,
                    ydisp: this.ydisp,
            ...
            }, i.prototype.leaveSelect = function() {
            ...
            }, i.prototype.enterSearch = function(e) {
            ...
            }, i.prototype.leaveSearch = function() {
            ...
            }, i.prototype.copyText = function(e) {
                var t = this, s = this.getCopyTextarea();
                this.emit("copy", e), s.focus(), s.textContent = e, s.value = e, s.setSelectionRange(0, e.length), 
                T(function() {
                    t.element.focus(), t.focus();
                }, 1);
            }, i.prototype.selectText = function(e, t, s, n) {
                var a, r, i, o, d, u, l, _, c;
                if (this._selected) {
                    for (a = this._selected.x1, r = this._selected.x2, i = this._selected.y1, o = this._selected.y2, 
                    o < i && (d = r, r = a, a = d, d = o, o = i, i = d), r < a && i === o && (d = r, 
                    r = a, a = d), l = i; l <= o; l++) for (u = 0, _ = this.cols - 1, l === i && (u = a), 
                    l === o && (_ = r); u <= _; u++) null != this.lines[l][u].old && (c = this.lines[l][u].old, 
            ...
            }, i.prototype.grabText = function(e, t, s, n) {
                var a, r, i, o, d, u = "", l = "";
                for (n < s && (d = t, t = e, e = d, d = n, n = s, s = d), t < e && s === n && (d = t, 
                t = e, e = d), i = s; i <= n; i++) {
                    for (r = 0, o = this.cols - 1, i === s && (r = e), i === n && (o = t); r <= o; r++) a = this.lines[i][r][1], 
                    " " !== a ? (l && (u += l, l = ""), u += a, h(a) && r++) : l += a;
                    l = "", u += "\n";
                }
                for (r = t, i = n; r < this.cols; r++) if (" " !== this.lines[i][r][1]) {
                    u = u.slice(0, -1);
                    break;
                }
                return u;
            }, i.prototype.keyPrefix = function(e, t) {
            ...
            }, i.prototype.keySelect = function(e, t) {
                ...
                if ("v" === t || " " === t) return void (this.visualMode ? this.leaveVisual() : this.enterVisual());
                {
                    if ("y" !== t) {
                        ...
                        if ("w" === t || "W" === t) {
                            for (var a = this.x, r = this.y, i = this.ydisp, n = this.x, s = this.y, o = this.ydisp, d = !1; ;) {
                            ...
                            return this.x = n, this.y = s, this.scrollDisp(-this.ydisp + o), void (this.visualMode && this.selectText(a, this.x, r + i, this.ydisp + this.y));
                        }
                        if ("b" === t || "B" === t) {
                            for (var a = this.x, r = this.y, i = this.ydisp, n = this.x, s = this.y, o = this.ydisp; ;) {
                        ...
                        if ("g" === t || "G" === t) {
                            var a = this.x, r = this.y, i = this.ydisp;
                            return "g" === t ? (this.x = 0, this.y = 0, this.scrollDisp(-this.ydisp)) : "G" === t && (this.x = 0, 
                            this.y = this.rows - 1, this.scrollDisp(this.ybase)), void (this.visualMode && this.selectText(a, this.x, r + i, this.ydisp + this.y));
                        }
                        if ("H" === t || "M" === t || "L" === t) {
                            var a = this.x, r = this.y;
                            return "H" === t ? (this.x = 0, this.y = 0) : "M" === t ? (this.x = 0, this.y = this.rows / 2 | 0) : "L" === t && (this.x = 0, 
                            this.y = this.rows - 1), void (this.visualMode ? this.selectText(a, this.x, this.ydisp + r, this.ydisp + this.y) : (this.refresh(r, r), 
                            this.refresh(this.y, this.y)));
                        }
                        if ("{" === t || "}" === t) {
                            var u, l, a = this.x, r = this.y, i = this.ydisp, _ = !1, c = !1, h = -1, s = this.y + ("{" === t ? -1 : 1), o = this.ydisp;
                            ...
                            this.x = 0, this.y = s, this.scrollDisp(-this.ydisp + o), void (this.visualMode && this.selectText(a, this.x, r + i, this.ydisp + this.y));
                        }
            ...
            }, i.prototype.keySearch = function(e, t) {
                if ("" === t) return void this.leaveSearch();
                if ("\r" === t || !this.searchMode && ("n" === t || "N" === t)) {
                    this.leaveSearch();
                    var s = this.entry;
                    if (!s) return void this.refresh(0, this.rows - 1);
                    for (var n, a, r, i = this.x, o = this.y, d = this.ydisp, u = !1, l = !1, _ = this.x + 1, c = this.ydisp + this.y, h = "N" === t ? this.searchDown : !this.searchDown; ;) {
                        for (n = this.lines[c]; _ < this.cols; ) {
                            for (r = 0; r < s.length && !(_ + r >= this.cols) && n[_ + r][1] === s[r]; r++) if (n[_ + r][1] === s[r] && r === s.length - 1) {
                                u = !0;
                                break;
                            }
                            if (u) break;
                    ...
                    void (this.visualMode && this.selectText(i, this.x, o + d, this.ydisp + this.y))) : void this.refresh(0, this.rows - 1);
                }
                if ("\b" === t || "" === t) {
                    ...
                    return this.lines[m][r] = [ this.lines[m][r][0], " " ], this.x--, this.refresh(this.rows - 1, this.rows - 1), 
                ...
                if (1 === t.length && t >= " " && t <= "~") {
                    ...
                    return this.lines[m][r] = [ this.defAttr & -512 | 4, t ], this.x++, this.refresh(this.rows - 1, this.rows - 1), 
                    void this.refresh(this.y, this.y);
                }
                return !1;
            }, i.charsets = {}, i.charsets.SCLD = {
                "`": "◆",
                a: "▒",
                b: "\t",
                c: "\f",
                ...
                "}": "£",
                "~": "·"
            }, i.charsets.UK = null, i.charsets.US = null, i.charsets.Dutch = null, i.charsets.Finnish = null, 
            i.charsets.French = null, i.charsets.FrenchCanadian = null, i.charsets.German = null, 
            i.charsets.Italian = null, i.charsets.NorwegianDanish = null, i.charsets.Spanish = null, 
            i.charsets.Swedish = null, i.charsets.Swiss = null, i.charsets.ISOLatin = null;
            var D = this.String, T = this.setTimeout;
            this.setInterval;
            m._cache = {}, m.distance = function(e, t, s, n, a, r) {
                return Math.pow(30 * (e - n), 2) + Math.pow(59 * (t - a), 2) + Math.pow(11 * (s - r), 2);
            }, i.EventEmitter = s, i.Stream = r, i.inherits = l, i.on = o, i.off = d, i.cancel = u, 
            n = [], a = function() {
                return i;
    ...
    e.exports = a.extend({}, r, {
        render: function(e, t, s) {
            return t || (t = {}), n(r.render(e, t, s));
        },
        to_html: function(e, t, s, a) {
            return t || (t = {}), n(r.to_html(e, t, s, a));
        },
        clearCache: function() {
    ...
    !function(s, i) {
        ...
        n = i, r = "function" == typeof n ? n.apply(t, a) : n, !(void 0 !== r && (e.exports = r)));
    }(this, function(e) {
        function t(e) {
        ...
        function d(t, s) {
            ...
            for (var b, w, D, T, S, x, H = new _(t); !H.eos(); ) {
                ...
                i(T) ? p.push(m.length) : y = !0, m.push([ "text", T, b, b + 1 ]), b += 1, "\n" === T && a();
                if (!H.scan(o)) break;
                if (M = !0, w = H.scan(v) || "name", H.scan(L), "=" === w ? (D = H.scanUntil(g), 
                H.scan(g), H.scanUntil(d)) : "{" === w ? (D = H.scanUntil(c), H.scan(k), H.scanUntil(d), 
                ...
                } else "name" === w || "{" === w || "&" === w ? y = !0 : "=" === w && r(D);
            }
            if (x = h.pop()) throw new Error('Unclosed section "' + x[1] + '" at ' + H.pos);
            return l(u(m));
        }
        function u(e) {
            for (var t, s, n = [], a = 0, r = e.length; a < r; ++a) t = e[a], t && ("text" === t[0] && s && "text" === s[0] ? (s[1] += t[1], 
            s[3] = t[3]) : (n.push(t), s = t));
            return n;
        }
        function l(e) {
            for (var t, s, n = [], a = n, r = [], i = 0, o = e.length; i < o; ++i) switch (t = e[i], 
            t[0]) {
              case "#":
              case "^":
              ...
              case "/":
                s = r.pop(), s[5] = t[2], a = r.length > 0 ? r[r.length - 1][4] : n;
                break;
        ...
        _.prototype.eos = function() {
            ...
            if (n.hasOwnProperty(e)) s = n[e]; else {
                for (var r, i, o = this, d = !1; o; ) {
                    if (e.indexOf(".") > 0) for (s = o.view, r = e.split("."), i = 0; null != s && i < r.length; ) i === r.length - 1 && (d = a(s, r[i])), 
                    s = s[r[i++]]; else s = o.view[e], d = a(o.view, e);
                    if (d) break;
                    o = o.parent;
                }
                n[e] = s;
            ...
            for (var a, r, i, o = "", d = 0, u = e.length; d < u; ++d) i = void 0, a = e[d], 
            r = a[0], "#" === r ? i = this.renderSection(a, t, s, n) : "^" === r ? i = this.renderInverted(a, t, s, n) : ">" === r ? i = this.renderPartial(a, t, s, n) : "&" === r ? i = this.unescapedValue(a, t) : "name" === r ? i = this.escapedValue(a, t) : "text" === r && (i = this.rawValue(a)), 
            void 0 !== i && (o += i);
            return o;
        }, h.prototype.renderSection = function(e, s, n, a) {
            function r(e) {
                return i.render(e, s, n);
            }
            var i = this, o = "", d = s.lookup(e[1]);
            if (d) {
                if (f(d)) for (var u = 0, l = d.length; u < l; ++u) o += this.renderTokens(e[4], s.push(d[u]), n, a); else if ("object" == typeof d || "string" == typeof d || "number" == typeof d) o += this.renderTokens(e[4], s.push(d), n, a); else if (t(d)) {
                    ...
                    d = d.call(s.view, a.slice(e[3], e[5]), r), null != d && (o += d);
        ...
        }, e.to_html = function(s, n, a, r) {
            var i = e.render(s, n, a);
    ...
    !function() {
        function t(e, t, s, a, r) {
            ...
            function o() {
                p = f.checked ? i(Math.round(Math.exp(L + g * h.value))) : void 0;
            }
            function d() {
                y = !0, void 0 !== p && n(h).prop("value", (Math.log(p) - L) / g), n(h).attr("disabled", !f.checked).trigger("change"), 
                y = !1;
            }
            function u() {
                var e;
                e = f.checked ? i(a(n(m).val())) : void 0, isNaN(e) && (e = void 0), p = e;
            }
            function l() {
                y = !0, void 0 !== p && n(m).val(r(p)), n(m).attr("disabled", void 0 === p), y = !1;
            }
            function _() {
                f.checked || (p = void 0);
            }
            ...
            t < 0 && (t = 0), s < 0 && (s = 0);
            var L = Math.log(t), Y = Math.log(s), g = Y - L;
            return h = e.find("div.slider").on("change", function() {
                ...
                set: function(e) {
                    e < 0 && (e = 0), s = e, Y = Math.log(s), g = Y - L, h && d();
                }
            }), M;
        }
        var n = s(2), a = s(3), r = s(7);
        s(12);
        var i = s(4), o = s(13), d = s(14), u = s(18);
        u.locale(a.language);
        var l = a.gettext, _ = {};
        _.resource_debug = function() {
            ...
            return i.quote_cmdline(e || []);
        }, _.unquote_cmdline = function(e) {
            return i.unquote_cmdline(e);
            ...
            var s, n = "", r = 1024;
            return t && (s = a.format_bytes(t, r, !0), n = " / " + s.join(" "), r = s[1]), e ? (s = a.format_bytes(e, r, !0), 
            n ? s[0] + n : s.join(" ")) : "?" + n;
            ...
            for (var a = n(e).find("tbody tr"), r = 0; r < a.length; r++) if (s(n(a[r]), t) > 0) {
                n(t).insertBefore(a[r]), t = null;
                break;
            }
        ...
        }, _.render_container = function(e, t, s, r, d, u) {
            var c = n(document.getElementById(s + r));
            ...
            if (!c.length) {
                ...
                var Y = n('<div class="spinner">'), g = n('<button class="btn btn-danger pficon pficon-delete btn-delete">').on("click", function() {
                    var t = this;
                    return n(t).hide().siblings("div.spinner").show(), _.docker_container_delete(e, r, function() {}, function() {
                        n(t).show().siblings("div.spinner").hide();
                    }), !1;
                }), k = n('<button class="btn btn-default btn-control-ct fa fa-play">').on("click", function() {
                    return n(this).hide().siblings("div.spinner").show(), e.start(r).fail(function(t) {
                        _.handle_scope_start_container(e, r, t.message);
                    }), !1;
                }), v = n('<button class="btn btn-default btn-control-ct fa fa-stop">').on("click", function() {
                    return n(this).hide().siblings("div.spinner").show(), e.stop(r).fail(function(e) {
                        _.show_unexpected_error(e);
                    }), !1;
                });
                c = n("<tr>", {
                    id: s + r
                }).append(n('<td class="container-column-name">'), n('<td class="container-column-image">'), n('<td class="container-column-command">'), n('<td class="container-column-cpu">'), n('<td class="container-column-memory-graph">').append(o.create("containers-containers")), n('<td class="container-column-memory-text">'), n('<td class="container-column-danger cell-buttons">').append(g, Y), n('<td class="container-column-actions cell-buttons">').append(k, v, Y.clone())), 
            ...
            var w = d.Image;
            d.ImageID && w == d.ImageID && (w = i.truncate_id(w)), n(b[1]).text(w), n(b[2]).text(_.render_container_cmdline(d)), 
            n(b[3]).text(h), _.update_memory_bar(n(b[4]).children("div").toggle(p), m, f), n(b[5]).css(y).text(M);
            var D = r in e.waiting;
            ...
            return new t(e, s, n, a, r);
        }, _.docker_container_delete = function(e, t, s, n) {
            e.rm(t).fail(function(r) {
                if (r.message.indexOf("remove a running container") > -1) {
                    var i, o = e.containers[t];
                    i = o.State.Running ? l("Container is currently running.") : l("Container is currently marked as not running, but regular stopping failed.") + " " + l("Error message from Docker:") + " '" + r.message + "'";
                    var d;
                    return d = o.Name ? o.Name : t, "/" === d.charAt(0) && (d = d.substring(1)), void _.confirm(a.format(l("Please confirm forced deletion of $0"), d), i, l("Force Delete")).done(function() {
                        e.rm(t, !0).fail(function(e) {
                            _.show_unexpected_error(e), n();
                        }).done(s);
                    }).fail(n);
                }
                _.show_unexpected_error(r), n();
            }).done(s);
        }, _.handle_scope_start_container = function(e, t, s, n, r) {
            var i = ".scope already exists", o = s.indexOf(i);
            if (o > -1) {
                ...
                return void a.spawn([ "systemctl", "stop", "docker-" + c + ".scope" ], {
                    ...
                    _.show_unexpected_error(a.format(l("Failed to stop Docker scope: $0"), e)), r && r();
                });
            }
            _.show_unexpected_error(s), r && r();
            ...
            n("#confirmation-dialog-confirm").text(s), n("#confirmation-dialog-confirm").click(function() {
                ...
                a(), r.reject();
            }), n("#confirmation-dialog").modal("show"), r.promise();
            ...
            o.push("SYSLOG_IDENTIFIER=abrt-notification"), o.push("PROBLEM_DIR=" + t), d.journalctl(o, {
                ...
                u = !0, r = a.location.encode(e[0].__CURSOR), r = "/system/logs#" + r, i = e[0].PROBLEM_REASON ? e[0].PROBLEM_REASON : e[0].MESSAGE, 
                n(s, r, i);
            }).done(function() {
    ...
    !function() {
        ...
        function n(e, t) {
            ...
            var r;
            t.message && (r = M("<div class='dialog-error help-block'>").text(t.message)), a.addClass("has-error").append(r), 
        ...
        function r(e, s) {
            ...
            s.forEach(function(t) {
                var s;
                t && (s = e.find(t.target), s && s.length ? n(s, t) : a(e, t), r = !0);
        ...
        function d(e, t, s) {
            function n() {
                ...
                n && n.promise === t && (o(e), s = t.state(), c || "resolved" == s && n.handle ? e.modal("hide") : "rejected" == s && n.handle && r(e, [ arguments[0] ]));
            }
            function a(s) {
        ...
        function u(t) {
            ...
            return t = t.find(".btn-onoff-ct").addBack().filter(".btn-onoff-ct"), t.each(function(t, n) {
                var a, r, i, o = M(n).attr("data-toggle", "buttons").addClass("btn-group"), d = o.onoff("value"), u = o.find(".btn"), l = o.find("input").first().attr("name") || e();
                for (a = u.length; a < 2; a++) r = M('<input type="radio" autocomplete="off">'), 
                i = document.createTextNode(s(0 === a ? "On" : "Off")), o.append(M('<label class="btn">').append(r, i)), 
                u = null;
        ...
        M.fn.dialog = function(e) {
            return "failure" === e ? r(this, Array.prototype.slice.call(arguments, 1)) : "wait" === e ? d(this, arguments[1]) : "promise" === e ? d(this, arguments[1], !0) : void console.warn("unknown dialog action: " + e);
            ...
            return n || (n = M(this)), r.each(function() {
                var e = "allowed-title";
                "undefined" != typeof M(this).data(e) && M(this).data(e) !== !1 || M(this).data(e, M(this).attr("title") || "");
                var r = {
                    html: !0
                };
                s && (r.placement = s), n.tooltip(r), M(this).hasClass("disabled") === a && (M(this).toggleClass("disabled", !a), 
    ...
    !function() {
        function t(e, t) {
            ...
            n.each(function() {
                ...
                if (isNaN(t) || 0 === n) i(this).css("visibility", "hidden"); else {
                    var a = i(this).data("bar-progress");
                    isNaN(n) ? (a.addClass("progress-no-limit"), n = t) : a.removeClass("progress-no-limit"), 
                    i(this).css("visibility", "visible"), a.css("width", n / r * 100 + "%"), i(this).data("bar-progress-bar").css("width", t / n * 100 + "%").toggle(t > 0);
                }
            });
        }
        function n(e, s) {
            return void 0 === e && s && (e = i(s).attr("graph")), e ? ("undefined" !== o[e] && window.clearTimeout(o[e]), 
            void (o[e] = window.setTimeout(function() {
                delete o[e], t(e);
            }, 10))) : void t(void 0, s);
        }
        function a(e) {
            var s = i("<div>").addClass("progress-bar"), a = i("<div>").addClass("progress").append(s);
            i(e).addClass("bar-row").append(a).data("bar-progress", a).data("bar-progress-bar", s), 
            e.reflow = function() {
                t(this.getAttribute("graph"), this);
            }, n(void 0, e);
        }
        function r() {
            i("div.bar-row").each(function() {
                a(this, !1);
            });
        }
        var i = s(2), o = {};
        i(document).ready(r), e.exports = {
            create: function(e) {
                var t = i("<div>").addClass("bar-row").attr("graph", e);
                return a(t), t;
            },
            update: function() {
                i("div.bar-row").each(function() {
    ...
    !function() {
        function t(e) {
            ...
            e.jquery && (e = e[0]), a.parse(r), a.parse(i), a.parse(o);
        ...
        var n = s(3), a = s(7), r = s(15), i = s(16), o = s(17), d = n.gettext, u = n.gettext, l = {};
        l.journalctl = function() {
            ...
            i.push("--"), i.push.apply(i, a);
            var o, d = new n.defer(), u = "", l = [], _ = [], c = null, h = n.spawn(i, {
                host: r.host,
                batch: 8192,
                latency: 300,
                superuser: "try"
        ...
        l.renderer = function(e) {
            ...
            function o() {
                ...
                p.line_present = !1), p.entry && (f.prepend(r(p)), p.line_present = !0);
            }
            function d(e) {
                var t = n(e);
                a(p.entry, t) ? (p.count += 1, p.first_time = t.time) : (o(), p.entry && (t.bootid != p.entry.bootid && f.prepend(f.render_reboot_separator()), 
                t.day != p.entry.day && f.prepend(f.render_day_header(p.entry.day))), i(), p.entry = t, 
            ...
            function c() {
                M.line_present && (f.remove_last(), M.line_present = !1), M.entry && (f.append(r(M)), 
                M.line_present = !0);
            }
            function h(e) {
                var t = n(e);
                ...
                i(), M.entry = t, M.count = 1, M.first_time = M.last_time = t.time, M.line_present = !1);
            }
            function m() {
                c();
            }
    ...
    (function(e) {
        !function(t, s) {
            ...
            function v(e, t, s) {
                var n, a = Math.min(e.length, t.length), r = Math.abs(e.length - t.length), i = 0;
                for (n = 0; n < a; n++) (s && e[n] !== t[n] || !s && k(e[n]) !== k(t[n])) && i++;
                return i + r;
            }
            function b(e) {
            ...
            function x(e, t) {
                var s, n = c({}, e);
                for (s in t) _(t, s) && (r(e[s]) && r(t[s]) ? (n[s] = {}, c(n[s], e[s]), c(n[s], t[s])) : null != t[s] ? n[s] = t[s] : delete n[s]);
                for (s in e) _(e, s) && !_(t, s) && r(e[s]) && (n[s] = c({}, n[s]));
                return n;
            }
            function H(e) {
                null != e && this.set(e);
            ...
            function J(e) {
                ...
                return function(t) {
                    var a, r = "";
                    for (a = 0; a < s; a++) r += T(n[a]) ? n[a].call(t, e) : n[a];
                    return r;
                };
            }
            function B(e, t) {
            ...
            function ae(e, s) {
                return function(n) {
                    return null != n ? (ie(this, e, n), t.updateOffset(this, s), this) : re(this, e);
                };
            }
            function re(e, t) {
            ...
            function de(e, t) {
                if ("object" == typeof e) {
                    e = R(e);
                    for (var s = N(e), n = 0; n < s.length; n++) this[s[n].unit](e[s[n].unit]);
            ...
            function he(e, t, s) {
                ...
                this._shortMonthsParse = [], n = 0; n < 12; ++n) r = h([ 2e3, n ]), this._shortMonthsParse[n] = this.monthsShort(r, "").toLocaleLowerCase(), 
                this._longMonthsParse[n] = this.months(r, "").toLocaleLowerCase();
                return s ? "MMM" === t ? (a = ga.call(this._shortMonthsParse, i), a !== -1 ? a : null) : (a = ga.call(this._longMonthsParse, i), 
                a !== -1 ? a : null) : "MMM" === t ? (a = ga.call(this._shortMonthsParse, i), a !== -1 ? a : (a = ga.call(this._longMonthsParse, i), 
                a !== -1 ? a : null)) : (a = ga.call(this._longMonthsParse, i), a !== -1 ? a : (a = ga.call(this._shortMonthsParse, i), 
                a !== -1 ? a : null));
            }
            function me(e, t, s) {
                var n, a, r;
                ...
                n = 0; n < 12; n++) {
                    ...
                    s || this._monthsParse[n] || (r = "^" + this.months(a, "") + "|^" + this.monthsShort(a, ""), 
                    this._monthsParse[n] = new RegExp(r.replace(".", ""), "i")), s && "MMMM" === t && this._longMonthsParse[n].test(e)) return n;
            ...
            function ye(e) {
                return this._monthsParseExact ? (_(this, "_monthsRegex") || Ye.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (_(this, "_monthsShortRegex") || (this._monthsShortRegex = Da), 
                this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex);
            }
            function Le(e) {
                return this._monthsParseExact ? (_(this, "_monthsRegex") || Ye.call(this), e ? this._monthsStrictRegex : this._monthsRegex) : (_(this, "_monthsRegex") || (this._monthsRegex = Ta), 
            ...
            function Ye() {
                ...
                r.push(this.months(s, "")), r.push(this.monthsShort(s, ""));
                for (n.sort(e), a.sort(e), r.sort(e), t = 0; t < 12; t++) n[t] = $(n[t]), a[t] = $(a[t]);
                for (t = 0; t < 24; t++) r[t] = $(r[t]);
            ...
            function ge(e, t, s, n, a, r, i) {
                var o = new Date(e, t, s, n, a, r, i);
            ...
            function be(e, t, s, n, a) {
                var r, i, o = (7 + s - n) % 7, d = ve(e, n, a), u = 1 + 7 * (t - 1) + o + d;
            ...
            function we(e, t, s) {
                var n, a, r = ve(e.year(), t, s), i = Math.floor((e.dayOfYear() - r - 1) / 7) + 1;
                return i < 1 ? (a = e.year() - 1, n = i + De(a, t, s)) : i > De(e.year(), t, s) ? (n = i - De(e.year(), t, s), 
                a = e.year() + 1) : (a = e.year(), n = i), {
                    week: n,
                    year: a
                };
            }
            ...
            function We(e, t, s) {
                ...
                this._minWeekdaysParse = [], n = 0; n < 7; ++n) r = h([ 2e3, 1 ]).day(n), this._minWeekdaysParse[n] = this.weekdaysMin(r, "").toLocaleLowerCase(), 
                ...
                return s ? "dddd" === t ? (a = ga.call(this._weekdaysParse, i), a !== -1 ? a : null) : "ddd" === t ? (a = ga.call(this._shortWeekdaysParse, i), 
                a !== -1 ? a : null) : (a = ga.call(this._minWeekdaysParse, i), a !== -1 ? a : null) : "dddd" === t ? (a = ga.call(this._weekdaysParse, i), 
                a !== -1 ? a : (a = ga.call(this._shortWeekdaysParse, i), a !== -1 ? a : (a = ga.call(this._minWeekdaysParse, i), 
                a !== -1 ? a : null))) : "ddd" === t ? (a = ga.call(this._shortWeekdaysParse, i), 
                a !== -1 ? a : (a = ga.call(this._weekdaysParse, i), a !== -1 ? a : (a = ga.call(this._minWeekdaysParse, i), 
                a !== -1 ? a : null))) : (a = ga.call(this._minWeekdaysParse, i), a !== -1 ? a : (a = ga.call(this._weekdaysParse, i), 
                a !== -1 ? a : (a = ga.call(this._shortWeekdaysParse, i), a !== -1 ? a : null)));
            }
            function Fe(e, t, s) {
                var n, a, r;
                ...
                this._shortWeekdaysParse = [], this._fullWeekdaysParse = []), n = 0; n < 7; n++) {
                    ...
                    this._weekdaysParse[n] = new RegExp(r.replace(".", ""), "i")), s && "dddd" === t && this._fullWeekdaysParse[n].test(e)) return n;
            ...
            function Je() {
                ...
                var t, s, n, a, r, i = [], o = [], d = [], u = [];
                for (t = 0; t < 7; t++) s = h([ 2e3, 1 ]).day(t), n = this.weekdaysMin(s, ""), a = this.weekdaysShort(s, ""), 
                r = this.weekdays(s, ""), i.push(n), o.push(a), d.push(r), u.push(n), u.push(a), 
                u.push(r);
                for (i.sort(e), o.sort(e), d.sort(e), u.sort(e), t = 0; t < 7; t++) o[t] = $(o[t]), 
                d[t] = $(d[t]), u[t] = $(u[t]);
            ...
            function Xe(e) {
                for (var t, s, n, a, r = 0; r < e.length; ) {
                    for (a = Ze(e[r]).split("-"), t = a.length, s = Ze(e[r + 1]), s = s ? s.split("-") : null; t > 0; ) {
            ...
            function st(e, t) {
                if (null !== t) {
                    ...
                    n = Ra[e]._config; else if (null != t.parentLocale) if (null != Ra[t.parentLocale]) n = Ra[t.parentLocale]._config; else {
                        if (s = et(t.parentLocale), null == s) return za[t.parentLocale] || (za[t.parentLocale] = []), 
                        za[t.parentLocale].push({
                            name: e,
                            config: t
                        }), null;
                        n = s._config;
                    }
                    return Ra[e] = new H(x(n, t)), za[e] && za[e].forEach(function(e) {
                        st(e.name, e.config);
                    }), tt(e), Ra[e];
                }
            ...
            function it(e) {
                ...
                f(e)._overflowWeekday && t === -1 && (t = Ya), f(e).overflow = t), e;
            }
            function ot(e, t, s) {
            ...
            function ut(e) {
                var t, s, n, a, r, i = [];
                if (!e._d) {
                    for (n = dt(e), e._w && null == e._a[ma] && null == e._a[ha] && lt(e), null != e._dayOfYear && (r = ot(e._a[ca], n[ca]), 
                    (e._dayOfYear > te(r) || 0 === e._dayOfYear) && (f(e)._overflowDayOfYear = !0), 
                    s = ke(r, 0, e._dayOfYear), e._a[ha] = s.getUTCMonth(), e._a[ma] = s.getUTCDate()), 
                    t = 0; t < 3 && null == e._a[t]; ++t) e._a[t] = i[t] = n[t];
                    for (;t < 7; t++) e._a[t] = i[t] = null == e._a[t] ? 2 === t ? 1 : 0 : e._a[t];
                    24 === e._a[fa] && 0 === e._a[pa] && 0 === e._a[Ma] && 0 === e._a[ya] && (e._nextDay = !0, 
                    e._a[fa] = 0), e._d = (e._useUTC ? ke : ge).apply(null, i), a = e._useUTC ? e._d.getUTCDay() : e._d.getDay(), 
            ...
            function lt(e) {
                var t, s, n, a, r, i, o, d;
                if (t = e._w, null != t.GG || null != t.W || null != t.E) r = 1, i = 4, s = ot(t.GG, e._a[ca], we(Tt(), 1, 4).year), 
                n = ot(t.W, 1), a = ot(t.E, 1), (a < 1 || a > 7) && (d = !0); else {
                    r = e._locale._week.dow, i = e._locale._week.doy;
                    var u = we(Tt(), r, i);
                    s = ot(t.gg, e._a[ca], u.year), n = ot(t.w, u.week), null != t.d ? (a = t.d, (a < 0 || a > 6) && (d = !0)) : null != t.e ? (a = t.e + r, 
                    (t.e < 0 || t.e > 6) && (d = !0)) : a = r;
                }
                n < 1 || n > De(s, r, i) ? f(e)._overflowWeeks = !0 : null != d ? f(e)._overflowWeekday = !0 : (o = be(s, n, a, r, i), 
                e._a[ca] = o.year, e._dayOfYear = o.dayOfYear);
            }
            function _t(e) {
                var t, s, n, a, r, i, o = e._i, d = Na.exec(o) || Ia.exec(o);
                if (d) {
            ...
            function ct(e, t, s, n, a, r) {
                var i = [ ht(e), wa.indexOf(t), parseInt(s, 10), parseInt(n, 10), parseInt(a, 10) ];
            ...
            function Lt(e) {
                ...
                e._a = [], f(e).empty = !0;
                var s, n, a, r, i, o = "" + e._i, d = o.length, u = 0;
                for (a = G(e._f, e._locale).match(Un) || [], s = 0; s < a.length; s++) r = a[s], 
                n = (o.match(Q(r, e)) || [])[0], n && (i = o.substr(0, o.indexOf(n)), i.length > 0 && f(e).unusedInput.push(i), 
                o = o.slice(o.indexOf(n) + n.length), u += n.length), Bn[r] ? (n ? f(e).empty = !1 : f(e).unusedTokens.push(r), 
                ee(r, n, e)) : e._strict && !n && f(e).unusedTokens.push(r);
                f(e).charsLeftOver = d - u, o.length > 0 && f(e).unusedInput.push(o), e._a[fa] <= 12 && f(e).bigHour === !0 && e._a[fa] > 0 && (f(e).bigHour = void 0), 
                f(e).parsedDateParts = e._a.slice(0), f(e).meridiem = e._meridiem, e._a[fa] = Yt(e._locale, e._a[fa], e._meridiem), 
                ut(e), it(e);
            }
            function Yt(e, t, s) {
                var n;
            ...
            function gt(e) {
                ...
                for (a = 0; a < e._f.length; a++) r = 0, t = y({}, e), null != e._useUTC && (t._useUTC = e._useUTC), 
                t._f = e._f[a], Lt(t), p(t) && (r += f(t).charsLeftOver, r += 10 * f(t).unusedTokens.length, 
                f(t).score = r, (null == n || r < n) && (n = r, s = t));
                c(e, s || t);
            }
            function kt(e) {
                if (!e._d) {
            ...
            function bt(e) {
                ...
                return e._locale = e._locale || at(e._l), null === t || void 0 === s && "" === t ? M({
                    nullInput: !0
                }) : ("string" == typeof t && (e._i = t = e._locale.preparse(t)), Y(t) ? new L(it(t)) : (u(t) ? e._d = t : a(s) ? gt(e) : s ? Lt(e) : wt(e), 
                p(e) || (e._d = null), e));
            }
            function wt(e) {
                var s = e._i;
                o(s) ? e._d = new Date(t.now()) : u(s) ? e._d = new Date(s.valueOf()) : "string" == typeof s ? yt(e) : a(s) ? (e._a = l(s.slice(0), function(e) {
                    return parseInt(e, 10);
                }), ut(e)) : r(s) ? kt(e) : d(s) ? e._d = new Date(s) : t.createFromInputFallback(e);
            }
            function Dt(e, t, s, n, o) {
                var d = {};
                return s !== !0 && s !== !1 || (n = s, s = void 0), (r(e) && i(e) || a(e) && 0 === e.length) && (e = void 0), 
            ...
            function jt(e) {
                for (var t in e) if (ga.call(Za, t) === -1 || null != e[t] && isNaN(e[t])) return !1;
            ...
            function Ot(e) {
                var t = R(e), s = t.year || 0, n = t.quarter || 0, a = t.month || 0, r = t.week || 0, i = t.day || 0, o = t.hour || 0, d = t.minute || 0, u = t.second || 0, l = t.millisecond || 0;
                this._isValid = jt(t), this._milliseconds = +l + 1e3 * u + 6e4 * d + 1e3 * o * 60 * 60, 
                this._days = +i + 7 * r, this._months = +a + 3 * n + 12 * s, this._data = {}, this._locale = at(), 
                this._bubble();
            }
            function At(e) {
            ...
            function Ft(e, t) {
                ...
                var n = s[s.length - 1] || [], a = (n + "").match(Xa) || [ "-", 0, 0 ], r = +(60 * a[1]) + k(a[2]);
                return 0 === r ? 0 : "+" === a[0] ? r : -r;
            }
            function Rt(e, s) {
                var n, a;
                return s._isUTC ? (n = s.clone(), a = (Y(e) || u(e) ? e.valueOf() : Tt(e).valueOf()) - n.valueOf(), 
            ...
            function Nt(e, s, n) {
                ...
                if (null != e) {
                    ...
                    return !this._isUTC && s && (a = zt(this)), this._offset = e, this._isUTC = !0, 
                    null != a && this.add(a, "m"), r !== e && (!s || this._changeInProgress ? ns(this, Zt(e - r, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, 
            ...
            function Zt(e, t) {
                var s, n, a, r = e, i = null;
                return At(e) ? r = {
                    ms: e._milliseconds,
                    d: e._days,
                    M: e._months
                } : d(e) ? (r = {}, t ? r[t] = e : r.milliseconds = e) : (i = er.exec(e)) ? (s = "-" === i[1] ? -1 : 1, 
                r = {
                    y: 0,
                    d: k(i[ma]) * s,
                    h: k(i[fa]) * s,
                    ...
                    m: Xt(i[7], s),
                    s: Xt(i[8], s)
                }) : null == r ? r = {} : "object" == typeof r && ("from" in r || "to" in r) && (a = ts(Tt(r.from), Tt(r.to)), 
                r = {}, r.ms = a.milliseconds, r.M = a.months), n = new Ot(r), At(e) && _(e, "_locale") && (n._locale = e._locale), 
                n;
            }
            function Xt(e, t) {
            ...
            function ss(e, t) {
                return function(s, n) {
                    ...
                    r = s, s = n, n = r), s = "string" == typeof s ? +s : s, a = Zt(s, n), ns(this, a, e), 
                    this;
                };
            }
            function ns(e, s, n, a) {
                var r = s._milliseconds, i = Ct(s._days), o = Ct(s._months);
                e.isValid() && (a = null == a || a, o && fe(e, re(e, "Month") + o * n), i && ie(e, "Date", re(e, "Date") + i * n), 
                r && e._d.setTime(e._d.valueOf() + r * n), a && t.updateOffset(e, i || o));
            }
            function as(e, t) {
            ...
            function rs(e, s) {
                var n = e || Tt(), a = Rt(n, this).startOf("day"), r = t.calendarFormat(this, a) || "sameElse", i = s && (T(s[r]) ? s[r].call(this, n) : s[r]);
            ...
            function ms(e, t) {
                var s, n, a = 12 * (t.year() - e.year()) + (t.month() - e.month()), r = e.clone().add(a, "months");
                return t - r < 0 ? (s = e.clone().add(a - 1, "months"), n = (t - r) / (r - s)) : (s = e.clone().add(a + 1, "months"), 
                n = (t - r) / (s - r)), -(a + n) || 0;
            }
            function fs() {
            ...
            function Ms() {
                ...
                t = "Z");
                var s = "[" + e + '("]', n = 0 <= this.year() && this.year() <= 9999 ? "YYYY" : "YYYYYY", a = "-MM-DD[T]HH:mm:ss.SSS", r = t + '[")]';
                return this.format(s + n + a + r);
            }
            function ys(e) {
            ...
            function Is(e, t, s, n, a) {
                var r;
                return null == e ? we(this, n, a).year : (r = De(e, n, a), t > r && (t = r), Us.call(this, e, t, s, n, a));
            }
            function Us(e, t, s, n, a) {
                var r = be(e, t, s, n, a), i = ke(r.year, 0, r.dayOfYear);
            ...
            function en(e, t, s, n) {
                ...
                var a = at(), r = e ? a._week.dow : 0;
                if (null != s) return Zs(t, (s + r) % 7, n, "day");
                var i, o = [];
                for (i = 0; i < 7; i++) o[i] = Zs(t, (i + r) % 7, n, "day");
                return o;
            }
            function tn(e, t) {
            ...
            function on() {
                var e = this._data;
                return this._milliseconds = cr(this._milliseconds), this._days = cr(this._days), 
                this._months = cr(this._months), e.milliseconds = cr(e.milliseconds), e.seconds = cr(e.seconds), 
                e.minutes = cr(e.minutes), e.hours = cr(e.hours), e.months = cr(e.months), e.years = cr(e.years), 
                this;
            }
            function dn(e, t, s, n) {
                var a = Zt(t, s);
            ...
            function cn() {
                var e, t, s, n, a, r = this._milliseconds, i = this._days, o = this._months, d = this._data;
                return r >= 0 && i >= 0 && o >= 0 || r <= 0 && i <= 0 && o <= 0 || (r += 864e5 * _n(mn(o) + i), 
                i = 0, o = 0), d.milliseconds = r % 1e3, e = g(r / 1e3), d.seconds = e % 60, t = g(e / 60), 
                d.minutes = t % 60, s = g(t / 60), d.hours = s % 24, i += g(s / 24), a = g(hn(i)), 
                o += a, i -= _n(mn(a)), n = g(o / 12), o %= 12, d.days = i, d.months = o, d.years = n, 
                this;
            }
            function hn(e) {
            ...
            function vn(e, t, s) {
                var n = Zt(e).abs(), a = Sr(n.as("s")), r = Sr(n.as("m")), i = Sr(n.as("h")), o = Sr(n.as("d")), d = Sr(n.as("M")), u = Sr(n.as("y")), l = a <= xr.ss && [ "s", a ] || a < xr.s && [ "ss", a ] || r <= 1 && [ "m" ] || r < xr.m && [ "mm", r ] || i <= 1 && [ "h" ] || i < xr.h && [ "hh", i ] || o <= 1 && [ "d" ] || o < xr.d && [ "dd", o ] || d <= 1 && [ "M" ] || d < xr.M && [ "MM", d ] || u <= 1 && [ "y" ] || [ "yy", u ];
            ...
            function wn(e, t) {
                return void 0 !== xr[e] && (void 0 === t ? xr[e] : (xr[e] = t, "s" === e && (xr.ss = t - 1), 
                !0));
            }
            function Dn(e) {
            ...
            function Sn() {
                if (!this.isValid()) return this.localeData().invalidDate();
                var e, t, s, n = Hr(this._milliseconds) / 1e3, a = Hr(this._days), r = Hr(this._months);
                e = g(n / 60), t = g(e / 60), n %= 60, e %= 60, s = g(r / 12), r %= 12;
                var i = s, o = r, d = a, u = t, l = e, _ = n ? n.toFixed(3).replace(/\.?0+$/, "") : "", c = this.asSeconds();
                if (!c) return "P0D";
                var h = c < 0 ? "-" : "", m = Tn(this._months) !== Tn(c) ? "-" : "", f = Tn(this._days) !== Tn(c) ? "-" : "", p = Tn(this._milliseconds) !== Tn(c) ? "-" : "";
                return h + "P" + (i ? m + i + "Y" : "") + (o ? m + o + "M" : "") + (d ? f + d + "D" : "") + (u || l || _ ? "T" : "") + (u ? p + u + "H" : "") + (l ? p + l + "M" : "") + (_ ? p + _ + "S" : "");
            }
            var xn, Hn;
            ...
            var An = {
            ...
            }, Wn = "Invalid date", Fn = "%d", Rn = /\d{1,2}/, zn = {
                future: "in %s",
                past: "%s ago",
                s: "a few seconds",
                ss: "%d seconds",
                ...
                y: "a year",
                yy: "%d years"
            }, Nn = {}, In = {}, Un = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, qn = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Jn = {}, Bn = {}, Gn = /\d/, Vn = /\d\d/, Qn = /\d{3}/, Kn = /\d{4}/, $n = /[+-]?\d{6}/, Zn = /\d\d?/, Xn = /\d\d\d\d?/, ea = /\d\d\d\d\d\d?/, ta = /\d{1,3}/, sa = /\d{1,4}/, na = /[+-]?\d{1,6}/, aa = /\d+/, ra = /[+-]?\d+/, ia = /Z|[+-]\d\d:?\d\d/gi, oa = /Z|[+-]\d\d(?::?\d\d)?/gi, da = /[+-]?\d+(\.\d{1,3})?/, ua = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, la = {}, _a = {}, ca = 0, ha = 1, ma = 2, fa = 3, pa = 4, Ma = 5, ya = 6, La = 7, Ya = 8;
            U("Y", 0, 0, function() {
                var e = this.year();
                return e <= 9999 ? "" + e : "+" + e;
            }), U(0, [ "YY", 2 ], 0, function() {
            ...
            W("year", "y"), z("year", 1), V("Y", ra), V("YY", Zn, Vn), V("YYYY", sa, Kn), V("YYYYY", na, $n), 
            ...
            }), W("month", "M"), z("month", 8), V("M", Zn), V("MM", Zn, Vn), V("MMM", function(e, t) {
            ...
            W("isoWeek", "W"), z("week", 5), z("isoWeek", 5), V("w", Zn), V("ww", Zn, Vn), V("W", Zn), 
            ...
            W("isoWeekday", "E"), z("day", 11), z("weekday", 11), z("isoWeekday", 11), V("d", Zn), 
            ...
            }), Ve("a", !0), Ve("A", !1), W("hour", "h"), z("hour", 13), V("a", Qe), V("A", Qe), 
            ...
            var sr = ss(1, "add"), nr = ss(-1, "subtract");
            t.defaultFormat = "YYYY-MM-DDTHH:mm:ssZ", t.defaultFormatUtc = "YYYY-MM-DDTHH:mm:ss[Z]";
            var ar = w("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", function(e) {
            ...
            z("isoWeekYear", 1), V("G", ra), V("g", ra), V("GG", Zn, Vn), V("gg", Zn, Vn), V("GGGG", sa, Kn), 
            ...
            }), U("Q", 0, "Qo", "quarter"), W("quarter", "Q"), z("quarter", 7), V("Q", Gn), 
            Z("Q", function(e, t) {
                t[ha] = 3 * (k(e) - 1);
            }), U("D", [ "DD", 2 ], "Do", "date"), W("date", "D"), z("date", 9), V("D", Zn), 
            ...
            V("DDD", ta), V("DDDD", Qn), Z([ "DDD", "DDDD" ], function(e, t, s) {
                s._dayOfYear = k(e);
            }), U("m", [ "mm", 2 ], 0, "minute"), W("minute", "m"), z("minute", 14), V("m", Zn), 
            V("mm", Zn, Vn), Z([ "m", "mm" ], pa);
            var ir = ae("Minutes", !1);
            U("s", [ "ss", 2 ], 0, "second"), W("second", "s"), z("second", 15), V("s", Zn), 
            ...
            }), W("millisecond", "ms"), z("millisecond", 16), V("S", ta, Gn), V("SS", ta, Vn), 
            V("SSS", ta, Qn);
            var dr;
            for (dr = "SSSS"; dr.length <= 9; dr += "S") V(dr, aa);
            for (dr = "S"; dr.length <= 9; dr += "S") Z(dr, Bs);
            var ur = ae("Milliseconds", !1);
            U("z", 0, 0, "zoneAbbr"), U("zz", 0, 0, "zoneName");
            var lr = L.prototype;
            lr.add = sr, lr.calendar = rs, lr.clone = is, lr.diff = hs, lr.endOf = Ds, lr.format = ys, 
            lr.from = Ls, lr.fromNow = Ys, lr.to = gs, lr.toNow = ks, lr.get = oe, lr.invalidAt = As, 
            lr.isAfter = os, lr.isBefore = ds, lr.isBetween = us, lr.isSame = ls, lr.isSameOrAfter = _s, 
            lr.isSameOrBefore = cs, lr.isValid = Es, lr.lang = ar, lr.locale = vs, lr.localeData = bs, 
            lr.max = Ka, lr.min = Qa, lr.parsingFlags = Os, lr.set = de, lr.startOf = ws, lr.subtract = nr, 
            lr.toArray = Hs, lr.toObject = js, lr.toDate = xs, lr.toISOString = ps, lr.inspect = Ms, 
            lr.toJSON = Ps, lr.toString = fs, lr.unix = Ss, lr.valueOf = Ts, lr.creationData = Cs, 
            lr.year = ka, lr.isLeapYear = ne, lr.weekYear = Fs, lr.isoWeekYear = Rs, lr.quarter = lr.quarters = qs, 
            lr.month = pe, lr.daysInMonth = Me, lr.week = lr.weeks = He, lr.isoWeek = lr.isoWeeks = je, 
            lr.weeksInYear = Ns, lr.isoWeeksInYear = zs, lr.date = rr, lr.day = lr.days = Re, 
            lr.weekday = ze, lr.isoWeekday = Ne, lr.dayOfYear = Js, lr.hour = lr.hours = Wa, 
            lr.minute = lr.minutes = ir, lr.second = lr.seconds = or, lr.millisecond = lr.milliseconds = ur, 
            lr.utcOffset = Nt, lr.utc = Ut, lr.local = qt, lr.parseZone = Jt, lr.hasAlignedHourOffset = Bt, 
            lr.isDST = Gt, lr.isLocal = Qt, lr.isUtcOffset = Kt, lr.isUtc = $t, lr.isUTC = $t, 
            lr.zoneAbbr = Gs, lr.zoneName = Vs, lr.dates = w("dates accessor is deprecated. Use date instead.", rr), 
            lr.months = w("months accessor is deprecated. Use month instead", pe), lr.years = w("years accessor is deprecated. Use year instead", ka), 
            lr.zone = w("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", It), 
            lr.isDSTShifted = w("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", Vt);
            var _r = H.prototype;
            _r.calendar = j, _r.longDateFormat = P, _r.invalidDate = E, _r.ordinal = O, _r.preparse = $s, 
            _r.postformat = $s, _r.relativeTime = A, _r.pastFuture = C, _r.set = S, _r.months = _e, 
            _r.monthsShort = ce, _r.monthsParse = me, _r.monthsRegex = Le, _r.monthsShortRegex = ye, 
            _r.week = Te, _r.firstDayOfYear = xe, _r.firstDayOfWeek = Se, _r.weekdays = Oe, 
            _r.weekdaysMin = Ce, _r.weekdaysShort = Ae, _r.weekdaysParse = Fe, _r.weekdaysRegex = Ie, 
            _r.weekdaysShortRegex = Ue, _r.weekdaysMinRegex = qe, _r.isPM = Ke, _r.meridiem = $e, 
            tt("en", {
            ...
            var cr = Math.abs, hr = Mn("ms"), mr = Mn("s"), fr = Mn("m"), pr = Mn("h"), Mr = Mn("d"), yr = Mn("w"), Lr = Mn("M"), Yr = Mn("y"), gr = Yn("milliseconds"), kr = Yn("seconds"), vr = Yn("minutes"), br = Yn("hours"), wr = Yn("days"), Dr = Yn("months"), Tr = Yn("years"), Sr = Math.round, xr = {
                ss: 44,
                s: 45,
                m: 45,
                h: 22,
                d: 26,
                M: 11
            }, Hr = Math.abs, jr = Ot.prototype;
            return jr.isValid = Pt, jr.abs = on, jr.add = un, jr.subtract = ln, jr.as = fn, 
            jr.asMilliseconds = hr, jr.asSeconds = mr, jr.asMinutes = fr, jr.asHours = pr, jr.asDays = Mr, 
            jr.asWeeks = yr, jr.asMonths = Lr, jr.asYears = Yr, jr.valueOf = pn, jr._bubble = cn, 
            jr.clone = yn, jr.get = Ln, jr.milliseconds = gr, jr.seconds = kr, jr.minutes = vr, 
            jr.hours = br, jr.days = wr, jr.weeks = gn, jr.months = Dr, jr.years = Tr, jr.humanize = Dn, 
            jr.toISOString = Sn, jr.toString = Sn, jr.toJSON = Sn, jr.locale = vs, jr.localeData = bs, 
            jr.toIsoString = w("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Sn), 
            jr.lang = ar, U("X", 0, 0, "unix"), U("x", 0, 0, "valueOf"), V("x", ra), V("X", da), 
            Z("X", function(e, t, s) {
                s._d = new Date(1e3 * parseFloat(e, 10));
            }), Z("x", function(e, t, s) {
                s._d = new Date(k(e));
            }), t.version = "2.22.2", n(Tt), t.fn = lr, t.min = xt, t.max = Ht, t.now = $a, 
            t.utc = h, t.unix = Qs, t.months = tn, t.isDate = u, t.locale = tt, t.invalid = M, 
            t.duration = Zt, t.isMoment = Y, t.weekdays = nn, t.parseZone = Ks, t.localeData = at, 
            t.isDuration = At, t.monthsShort = sn, t.weekdaysMin = rn, t.defineLocale = st, 
            t.updateLocale = nt, t.locales = rt, t.weekdaysShort = an, t.normalizeUnits = F, 
            t.relativeTimeRounding = bn, t.relativeTimeThreshold = wn, t.calendarFormat = as, 
            t.prototype = lr, t.HTML5_FMT = {
    ...
    !function(e, t) {
        ...
        function s(e, s, n, a) {
            ...
            switch (n) {
              ...
              case "ss":
                return s || a ? r + (t(e) ? "sekundy" : "sekund") : r + "sekundami";

              case "m":
                return s ? "minuta" : a ? "minutu" : "minutou";

              case "mm":
                return s || a ? r + (t(e) ? "minuty" : "minut") : r + "minutami";

              case "h":
                return s ? "hodina" : a ? "hodinu" : "hodinou";

              case "hh":
                return s || a ? r + (t(e) ? "hodiny" : "hodin") : r + "hodinami";

              case "d":
                return s || a ? "den" : "dnem";

              case "dd":
                return s || a ? r + (t(e) ? "dny" : "dní") : r + "dny";

              case "M":
                return s || a ? "měsíc" : "měsícem";

              case "MM":
                return s || a ? r + (t(e) ? "měsíce" : "měsíců") : r + "měsíci";

              case "y":
                return s || a ? "rok" : "rokem";

              case "yy":
                return s || a ? r + (t(e) ? "roky" : "let") : r + "lety";
            }
        }
        var n = "leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec".split("_"), a = "led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro".split("_"), r = e.defineLocale("cs", {
            months: n,
            monthsShort: a,
    ...
    !function(e, t) {
        ...
        var n = "nolla yksi kaksi kolme neljä viisi kuusi seitsemän kahdeksan yhdeksän".split(" "), a = [ "nolla", "yhden", "kahden", "kolmen", "neljän", "viiden", "kuuden", n[7], n[8], n[9] ], r = e.defineLocale("fi", {
    ...
    !function(e, t) {
        ...
        function s(e, s, n, a) {
            ...
            switch (n) {
              ...
              case "ss":
                return t(e) ? r + (s || a ? "sekúndur" : "sekúndum") : r + "sekúnda";

              case "m":
                return s ? "mínúta" : "mínútu";

              case "mm":
                return t(e) ? r + (s || a ? "mínútur" : "mínútum") : s ? r + "mínúta" : r + "mínútu";

              case "hh":
                return t(e) ? r + (s || a ? "klukkustundir" : "klukkustundum") : r + "klukkustund";

              case "d":
                return s ? "dagur" : a ? "dag" : "degi";

              case "dd":
                return t(e) ? s ? r + "dagar" : r + (a ? "daga" : "dögum") : s ? r + "dagur" : r + (a ? "dag" : "degi");

              case "M":
                return s ? "mánuður" : a ? "mánuð" : "mánuði";

              case "MM":
                return t(e) ? s ? r + "mánuðir" : r + (a ? "mánuði" : "mánuðum") : s ? r + "mánuður" : r + (a ? "mánuð" : "mánuði");

              case "y":
                return s || a ? "ár" : "ári";

              case "yy":
                return t(e) ? r + (s || a ? "ár" : "árum") : r + (s || a ? "ár" : "ári");
            }
        }
    ...
    !function(e, t) {
        ...
        function r(e, t, r, i) {
            var o = e + " ";
            return 1 === e ? o + s(e, t, r[0], i) : t ? o + (n(e) ? a(r)[1] : a(r)[0]) : i ? o + a(r)[1] : o + (n(e) ? a(r)[1] : a(r)[2]);
        }
        var i = {
    ...
    !function(e, t) {
        ...
        function s(e, s, n, a) {
            ...
            switch (n) {
              ...
              case "ss":
                return s || a ? r + (t(e) ? "sekundy" : "sekúnd") : r + "sekundami";

              case "m":
                return s ? "minúta" : a ? "minútu" : "minútou";

              case "mm":
                return s || a ? r + (t(e) ? "minúty" : "minút") : r + "minútami";

              case "h":
                return s ? "hodina" : a ? "hodinu" : "hodinou";

              case "hh":
                return s || a ? r + (t(e) ? "hodiny" : "hodín") : r + "hodinami";

              case "d":
                return s || a ? "deň" : "dňom";

              case "dd":
                return s || a ? r + (t(e) ? "dni" : "dní") : r + "dňami";

              case "M":
                return s || a ? "mesiac" : "mesiacom";

              case "MM":
                return s || a ? r + (t(e) ? "mesiace" : "mesiacov") : r + "mesiacmi";

              case "y":
                return s || a ? "rok" : "rokom";

              case "yy":
                return s || a ? r + (t(e) ? "roky" : "rokov") : r + "rokmi";
            }
        }
        var n = "január_február_marec_apríl_máj_jún_júl_august_september_október_november_december".split("_"), a = "jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec".split("_"), r = e.defineLocale("sk", {
            months: n,
            monthsShort: a,
    ...
    !function(e, t) {
        ...
        function a(e) {
            ...
            return t > 0 && (a += r[t] + "vatlh"), s > 0 && (a += ("" !== a ? " " : "") + r[s] + "maH"), 
            n > 0 && (a += ("" !== a ? " " : "") + r[n]), "" === a ? "pagh" : a;
        }
	 ...
	 */
        !function(e) {
            ...
            function _(e, t) {
                ...
                var s, n, a;
                if (e.stack) {
                    if (s = e.stack.split("\n"), /^error$/i.test(s[0]) && s.shift(), N) {
                        for (n = [], a = t; a < s.length && s[a].indexOf(N) === -1; a++) n.push(s[a]);
            ...
            function h(e) {
                ...
                var s, n, a, r = [ "begin", "done", "log", "testStart", "testDone", "moduleStart", "moduleDone" ];
                for (s = 0, n = r.length; s < n; s++) a = r[s], "undefined" === u(B.callbacks[a]) && (B.callbacks[a] = []), 
                e[a] = t(a);
            }
            function m(e, t) {
                var s, n, a;
            ...
            function M(e) {
                ...
                for (B.depth = (B.depth || 0) + 1; B.queue.length && !B.blocking; ) {
                    if (!(!z.setTimeout || B.updateRate <= 0 || C() - s < B.updateRate)) {
                        W(t, 13);
                        break;
                    }
                    B.current && (B.current.usedAsync = !1), B.queue.shift()();
                }
                B.depth--, !e || B.blocking || B.queue.length || 0 !== B.depth || Y();
            }
            function y() {
                B.blocking = !0, B.testTimeout && z.setTimeout && (F(B.timeout), B.timeout = W(function() {
                    if (!B.current) throw new Error("Test timed out");
                    B.current.semaphore = 0, O.pushFailure("Test timed out", c(2)), L();
                }, B.testTimeout));
            }
            function L() {
                U = !0, z.setTimeout ? W(function() {
            ...
            function v(e, t) {
                for (var s, n = 0, a = 0, r = e + "" + t, i = r.length; n < i; n++) a = (a << 5) - a + r.charCodeAt(n), 
                a |= 0;
            ...
            function T() {
                ...
                D(), e = r(B.pollution, s), e.length > 0 && O.pushFailure("Introduced global variable(s): " + e.join(", ")), 
                t = r(s, B.pollution), t.length > 0 && O.pushFailure("Deleted global variable(s): " + t.join(", "));
            }
            function S(e, t, s) {
            ...
            }, W = e.setTimeout, F = e.clearTimeout, R = e.window, z = {
            ...
            }, N = (c(0) || "").replace(/(:\d+)+\)?/, "").replace(/.+\//, ""), I = !1, U = !1, q = Object.prototype.toString, J = Object.prototype.hasOwnProperty, B = {
                queue: [],
                blocking: !0,
                reorder: !0,
                altertitle: !0,
            ...
            }(), O.isLocal = !(z.document && "file:" !== R.location.protocol), O.version = "1.23.1", 
            d(O, {
                module: function(e, t, s) {
                    function n() {
                        ...
                        return s && (d(r, s.testEnvironment), delete r.beforeEach, delete r.afterEach), 
                        d(r, t), a.testEnvironment = r, B.modules.push(a), a;
                    }
                    function a(e) {
                        B.currentModule = e;
                    }
                    var r, i, o = B.currentModule;
                    ...
                    r = n(), i = {
                        beforeEach: g(r, "beforeEach"),
                        afterEach: g(r, "afterEach")
                    }, "function" === u(s) && (B.moduleStack.push(r), a(r), s.call(r.testEnvironment, i), 
                    B.moduleStack.pop(), r = r.parentModule || o), a(r);
                },
                asyncTest: S,
                test: x,
                skip: H,
            ...
            k.count = 0, k.prototype = {
                ...
                queue: function() {
                    ...
                    var t, s = this;
                    if (this.valid()) return t = O.config.reorder && z.sessionStorage && +sessionStorage.getItem("qunit-test-" + this.module.name + "-" + this.testName), 
                    b(e, t, B.seed);
                },
                ...
                valid: function() {
                    ...
                    function t(e) {
                        return i(e.moduleId, B.moduleId) > -1 || e.parentModule && t(e.parentModule);
                    }
                    var s = B.filter, n = /^(!?)\/([\w\W]*)\/(i?$)/.exec(s), a = B.module && B.module.toLowerCase(), r = this.module.name + ": " + this.testName;
                    return !(!this.callback || !this.callback.validTest) || !(B.moduleId && B.moduleId.length > 0 && !t(this.module)) && (!(B.testId && B.testId.length > 0 && i(this.testId, B.testId) < 0) && (!(a && !e(this.module)) && (!s || (n ? this.regexFilter(!!n[1], n[2], n[3], r) : this.stringFilter(s, r)))));
                },
                regexFilter: function(e, t, s, n) {
                    var a = new RegExp(t, s), r = a.test(n);
                    return r !== e;
                },
                ...
                if (z.document) {
                    var e = z.document && document.getElementById && document.getElementById("qunit-fixture");
                ...
                push: function(e, t, s, n, a) {
                    var r = this instanceof P ? this : O.config.current.assert;
                    return r.pushResult({
                        result: e,
                        actual: t,
                        expected: s,
                ...
                throws: function(e, t, s) {
                    var n, a, r = t, i = !1, o = this instanceof P && this.test || O.config.current;
                    ...
                    o.ignoreGlobalErrors = !1, n && (a = O.objectType(t), t ? "regexp" === a ? i = t.test(E(n)) : "string" === a ? i = t === E(n) : "function" === a && n instanceof t ? i = !0 : "object" === a ? i = n instanceof t.constructor && n.name === t.name && n.message === t.message : "function" === a && t.call({}, n) === !0 && (r = null, 
                    i = !0) : (i = !0, r = null)), o.assert.pushResult({
                        result: i,
                        actual: n,
                        expected: r,
                        message: s
                ...
                var r = [], i = [], o = [], d = Object.getPrototypeOf || function(e) {
                    return e.__proto__;
                }, u = {
                    string: e,
                    boolean: e,
                    ...
                    array: function(e, t) {
                        ...
                        for (i.push(t), o.push(e), s = 0; s < r; s++) {
                            for (d = !1, n = 0; n < i.length; n++) if (u = i[n] === t[s], l = o[n] === e[s], 
                            u || l) {
                                if (!(t[s] === e[s] || u && l)) return i.pop(), o.pop(), !1;
                                d = !0;
                            }
                            if (!d && !a(t[s], e[s])) return i.pop(), o.pop(), !1;
                        }
                    ...
                    object: function(e, s) {
                        ...
                        if (t(s, e) === !1) return !1;
                        r.push(s.constructor), i.push(s), o.push(e);
                        for (n in s) {
                            for (u = !1, d = 0; d < i.length; d++) if (l = i[d] === s[n], _ = o[d] === e[n], 
                            l || _) {
                                if (!(s[n] === e[n] || l && _)) {
                                    c = !1;
                                    break;
                ...
                function s(e, t, s) {
                    var n = r.separator(), a = r.indent(), i = r.indent(1);
                    return t.join && (t = t.join("," + n + i)), t ? [ e, i + t, a + s ].join(n) : e + s;
                }
                function n(e, t) {
                ...
                var a = /^function (\w+)/, r = {
                    parse: function(e, t, s) {
                        ...
                        a = this.parsers[t], r = typeof a, "function" === r ? (s.push(e), n = a.call(this, e, s), 
                        s.pop(), n) : "string" === r ? a : this.parsers.error);
                    },
                    typeOf: function(e) {
                        var t;
                    ...
                    parsers: {
                        ...
                        function: function(e) {
                            ...
                            return n && (t += " " + n), t += "(", t = [ t, r.parse(e, "functionArgs"), "){" ].join(""), 
                            s(t, r.parse(e, "functionCode"), "}");
                        },
                        array: n,
                        nodelist: n,
                        arguments: n,
                        object: function(e, t) {
                            ...
                            for (a in e) n.push(a);
                            u = [ "message", "name" ];
                            for (d in u) a = u[d], a in e && i(a, n) < 0 && n.push(a);
                            for (n.sort(), d = 0; d < n.length; d++) a = n[d], o = e[a], l.push(r.parse(a, "key") + ": " + r.parse(o, void 0, t));
                            return r.down(), s("{", l, "}");
                        },
                        node: function(e) {
                            var t, s, n, a = r.HTML ? "&lt;" : "<", i = r.HTML ? "&gt;" : ">", o = e.nodeName.toLowerCase(), d = a + o, u = e.attributes;
                            if (u) for (s = 0, t = u.length; s < t; s++) n = u[s].nodeValue, n && "inherit" !== n && (d += " " + u[s].nodeName + "=" + r.parse(n, "attribute"));
                            return d += i, 3 !== e.nodeType && 4 !== e.nodeType || (d += e.nodeValue), d + a + "/" + o + i;
                        },
            ...
            function e() {
                var e, t, s, n, a = {}, r = x.search.slice(1).split("&"), i = r.length;
                for (e = 0; e < i; e++) r[e] && (t = r[e].split("="), s = decodeURIComponent(t[0]), 
            ...
            function i(e, t, s) {
                s || "undefined" == typeof s && !a(e, t) ? r(e, t) : o(e, t);
            }
            function o(e, t) {
            ...
            function u() {
                var e, s, n, a, r, i = !1, o = j.urlConfig, d = "";
                for (e = 0; e < o.length; e++) if (n = j.urlConfig[e], "string" == typeof n && (n = {
                    id: n,
                    label: n
                }), a = t(n.id), r = t(n.tooltip), n.value && "string" != typeof n.value) {
                    if (d += "<label for='qunit-urlconfig-" + a + "' title='" + r + "'>" + n.label + ": </label><select id='qunit-urlconfig-" + a + "' name='" + a + "' title='" + r + "'><option></option>", 
                    QUnit.is("array", n.value)) for (s = 0; s < n.value.length; s++) a = t(n.value[s]), 
                    d += "<option value='" + a + "'" + (j[n.id] === n.value[s] ? (i = !0) && " selected='selected'" : "") + ">" + a + "</option>"; else for (s in n.value) O.call(n.value, s) && (d += "<option value='" + t(s) + "'" + (j[n.id] === s ? (i = !0) && " selected='selected'" : "") + ">" + t(n.value[s]) + "</option>");
                    j[n.id] && !i && (a = t(j[n.id]), d += "<option value='" + a + "' selected='selected' disabled='disabled'>" + a + "</option>"), 
                    d += "</select>";
                } else d += "<input id='qunit-urlconfig-" + a + "' name='" + a + "' type='checkbox'" + (n.value ? " value='" + t(n.value) + "'" : "") + (j[n.id] ? " checked='checked'" : "") + " title='" + r + "' /><label for='qunit-urlconfig-" + a + "' title='" + r + "'>" + n.label + "</label>";
                return d;
            }
            function l() {
                var e, t, s, n = this, a = {};
                ...
                j[n.name] = t || !1, s = d("qunit-tests"), s && i(s, "hidepass", t || !1), window.history.replaceState(null, "", e)) : window.location = e;
            }
            function _(e) {
                var t, s, n, a = "?", r = window.location;
                ...
                return r.protocol + "//" + r.host + r.pathname + a.slice(0, -1);
            }
            function c() {
            ...
            function h() {
                ...
                return e.innerHTML = u(), r(e, "qunit-url-config"), n(e.getElementsByTagName("input"), "click", l), 
            ...
            function m() {
                ...
                return r(e, "qunit-filter"), t.innerHTML = "Filter: ", n.type = "text", n.value = j.filter || "", 
            ...
            function w(e) {
                var t, s, n, a, r, i;
                for (t = 0, s = e.length; t < s; t++) for (i = e[t], n = 0, a = i.tests.length; n < a; n++) r = i.tests[n], 
                D(r.name, r.testId, i.name);
            }
            function D(e, t, s) {
                var n, a, r, i, o = d("qunit-tests");
                o && (n = P.createElement("strong"), n.innerHTML = T(e, s), a = P.createElement("a"), 
                a.innerHTML = "Rerun", a.href = _({
                    testId: t
                }), r = P.createElement("li"), r.appendChild(n), r.appendChild(a), r.id = "qunit-test-output-" + t, 
                i = P.createElement("ol"), i.className = "qunit-assert-list", r.appendChild(i), 
                o.appendChild(r));
            }
            function T(e, s) {
                var n = "";
            ...
            if (x) {
                ...
                QUnit.config.urlConfig.push({
                    ...
                    QUnit.begin(function(e) {
                        ...
                        }), g(), b(), w(e.modules), n = d("qunit-tests"), n && j.hidepassed && r(n, "hidepass");
                    }), QUnit.done(function(e) {
                        var t, s, n = d("qunit-banner"), a = d("qunit-tests"), r = [ "Tests completed in ", e.runtime, " milliseconds.<br />", "<span class='passed'>", e.passed, "</span> assertions of <span class='total'>", e.total, "</span> passed, <span class='failed'>", e.failed, "</span> failed." ].join("");
                        if (n && (n.className = e.failed ? "qunit-fail" : "qunit-pass"), a && (d("qunit-testresult").innerHTML = r), 
                        ...
                        var s, n, a, r, i, o, u = !1, l = d("qunit-test-output-" + e.testId);
                        l && (a = t(e.message) || (e.result ? "okay" : "failed"), a = "<span class='test-message'>" + a + "</span>", 
                        a += "<span class='runtime'>@ " + e.runtime + " ms</span>", !e.result && O.call(e, "expected") ? (r = e.negative ? "NOT " + QUnit.dump.parse(e.expected) : QUnit.dump.parse(e.expected), 
                        i = QUnit.dump.parse(e.actual), a += "<table><tr class='test-expected'><th>Expected: </th><td><pre>" + t(r) + "</pre></td></tr>", 
                        i !== r ? (a += "<tr class='test-actual'><th>Result: </th><td><pre>" + t(i) + "</pre></td></tr>", 
                        /^(true|false)$/.test(i) || /^(true|false)$/.test(r) || (o = QUnit.diff(r, i), u = S(o).length !== S(r).length + S(i).length), 
                        u && (a += "<tr class='test-diff'><th>Diff: </th><td><pre>" + o + "</pre></td></tr>")) : a += r.indexOf("[object Array]") !== -1 || r.indexOf("[object Object]") !== -1 ? "<tr class='test-message'><th>Message: </th><td>Diff suppressed as the depth of object is more than current max depth (" + QUnit.config.maxDepth + ").<p>Hint: Use <code>QUnit.dump.maxDepth</code> to  run with a higher max depth or <a href='" + t(_({
                            maxDepth: -1
                        ...
                        0 === l ? r(o, "qunit-collapsed") : l && j.collapse && !E ? E = !0 : r(o, "qunit-collapsed"), 
                        ...
                        h.innerHTML = "<strong>Source: </strong>" + e.source, r(h, "qunit-source"), 0 === l && r(h, "qunit-collapsed"), 
                        s(t, "click", function() {
                            i(h, "qunit-collapsed");
                        }), a.appendChild(h)));
                    });
                    ...
                    QUnit.diff = function() {
                        ...
                        return e.prototype.DiffMain = function(e, t, s) {
                            ...
                            return e === t ? e ? [ [ a, e ] ] : [] : ("undefined" == typeof s && (s = !0), r = s, 
                            ...
                            t = t.substring(0, t.length - i), u = this.diffCompute(e, t, r, n), o && u.unshift([ a, o ]), 
                            d && u.push([ a, d ]), this.diffCleanupMerge(u), u);
                        }, e.prototype.diffCleanupEfficiency = function(e) {
                            var t, r, i, o, d, u, l, _, c;
                            for (t = !1, r = [], i = 0, o = null, d = 0, u = !1, l = !1, _ = !1, c = !1; d < e.length; ) e[d][0] === a ? (e[d][1].length < 4 && (_ || c) ? (r[i++] = d, 
                            u = _, l = c, o = e[d][1]) : (i = 0, o = null), _ = c = !1) : (e[d][0] === s ? c = !0 : _ = !0, 
                            o && (u && l && _ && c || o.length < 2 && u + l + _ + c === 3) && (e.splice(r[i - 1], 0, [ s, o ]), 
                            e[r[i - 1] + 1][0] = n, i--, o = null, u && l ? (_ = c = !0, i = 0) : (i--, d = i > 0 ? r[i - 1] : -1, 
                            _ = c = !1), t = !0)), d++;
                            t && this.diffCleanupMerge(e);
                        }, e.prototype.diffPrettyHtml = function(e) {
                            var r, i, o, d = [];
                            for (o = 0; o < e.length; o++) switch (r = e[o][0], i = e[o][1], r) {
                              case n:
                                d[o] = "<ins>" + t(i) + "</ins>";
                                break;
                            ...
                            for (a = 0, n = Math.min(e.length, t.length), s = n, r = 0; a < s; ) e.substring(r, s) === t.substring(r, s) ? (a = s, 
                            r = a) : n = s, s = Math.floor((n - a) / 2 + a);
                            return s;
                        }, e.prototype.diffCommonSuffix = function(e, t) {
                            var s, n, a, r;
                            if (!e || !t || e.charAt(e.length - 1) !== t.charAt(t.length - 1)) return 0;
                            for (a = 0, n = Math.min(e.length, t.length), s = n, r = 0; a < s; ) e.substring(e.length - s, e.length - r) === t.substring(t.length - s, t.length - r) ? (a = s, 
                            r = a) : n = s, s = Math.floor((n - a) / 2 + a);
                            return s;
                        }, e.prototype.diffCompute = function(e, t, r, i) {
                            ...
                            _ ? (c = _[0], m = _[1], h = _[2], f = _[3], p = _[4], M = this.DiffMain(c, h, r, i), 
                            y = this.DiffMain(m, f, r, i), M.concat([ [ a, p ] ], y)) : r && e.length > 100 && t.length > 100 ? this.diffLineMode(e, t, i) : this.diffBisect(e, t, i))) : [ [ s, e ] ] : [ [ n, t ] ];
                        }, e.prototype.diffHalfMatch = function(e, t) {
                            function s(e, t, s) {
                                var n, a, i, o, d, u, l, _, c;
                                for (n = e.substring(s, s + Math.floor(e.length / 4)), a = -1, i = ""; (a = t.indexOf(n, a + 1)) !== -1; ) o = r.diffCommonPrefix(e.substring(s), t.substring(a)), 
                                d = r.diffCommonSuffix(e.substring(0, s), t.substring(0, a)), i.length < d + o && (i = t.substring(a - d, a) + t.substring(a, a + o), 
                                u = e.substring(0, s - d), l = e.substring(s + o), _ = t.substring(0, a - d), c = t.substring(a + o));
                                return 2 * i.length >= e.length ? [ u, l, _, c, i ] : null;
                            }
                            var n, a, r, i, o, d, u, l, _, c, h;
                            return n = e.length > t.length ? e : t, a = e.length > t.length ? t : e, n.length < 4 || 2 * a.length < n.length ? null : (r = this, 
                            _ = s(n, a, Math.ceil(n.length / 4)), c = s(n, a, Math.ceil(n.length / 2)), _ || c ? (h = c ? _ && _[4].length > c[4].length ? _ : c : _, 
                            e.length > t.length ? (i = h[0], u = h[1], d = h[2], o = h[3]) : (d = h[0], o = h[1], 
                            i = h[2], u = h[3]), l = h[4], [ i, u, d, o, l ]) : null);
                        }, e.prototype.diffLineMode = function(e, t, r) {
                            var i, o, d, u, l, _, c, h, m;
                            for (i = this.diffLinesToChars(e, t), e = i.chars1, t = i.chars2, d = i.lineArray, 
                            o = this.DiffMain(e, t, !1, r), this.diffCharsToLines(o, d), this.diffCleanupSemantic(o), 
                            o.push([ a, "" ]), u = 0, _ = 0, l = 0, h = "", c = ""; u < o.length; ) {
                                switch (o[u][0]) {
                                  ...
                                  case a:
                                    if (_ >= 1 && l >= 1) {
                                        for (o.splice(u - _ - l, _ + l), u = u - _ - l, i = this.DiffMain(h, c, !1, r), 
                                        m = i.length - 1; m >= 0; m--) o.splice(u, 0, i[m]);
                                        u += i.length;
                                    }
                                    l = 0, _ = 0, h = "", c = "";
                                }
                            ...
                            var r, i, o, d, u, l, _, c, h, m, f, p, M, y, L, Y, g, k, v, b, w, D, T;
                            for (r = e.length, i = t.length, o = Math.ceil((r + i) / 2), d = o, u = 2 * o, l = new Array(u), 
                            _ = new Array(u), c = 0; c < u; c++) l[c] = -1, _[c] = -1;
                            for (l[d + 1] = 0, _[d + 1] = 0, h = r - i, m = h % 2 !== 0, f = 0, p = 0, M = 0, 
                            y = 0, w = 0; w < o && !(new Date().getTime() > a); w++) {
                                for (D = -w + f; D <= w - p; D += 2) {
                                    for (Y = d + D, g = D === -w || D !== w && l[Y - 1] < l[Y + 1] ? l[Y + 1] : l[Y - 1] + 1, 
                                    v = g - D; g < r && v < i && e.charAt(g) === t.charAt(v); ) g++, v++;
                                    if (l[Y] = g, g > r) p += 2; else if (v > i) f += 2; else if (m && (L = d + h - D, 
                                    L >= 0 && L < u && _[L] !== -1 && (k = r - _[L], g >= k))) return this.diffBisectSplit(e, t, g, v, a);
                                }
                                for (T = -w + M; T <= w - y; T += 2) {
                                    for (L = d + T, k = T === -w || T !== w && _[L - 1] < _[L + 1] ? _[L + 1] : _[L - 1] + 1, 
                                    b = k - T; k < r && b < i && e.charAt(r - k - 1) === t.charAt(i - b - 1); ) k++, 
                                    b++;
                                    if (_[L] = k, k > r) y += 2; else if (b > i) M += 2; else if (!m && (Y = d + h - T, 
                                    Y >= 0 && Y < u && l[Y] !== -1 && (g = l[Y], v = d + g - Y, k = r - k, g >= k))) return this.diffBisectSplit(e, t, g, v, a);
                                }
                            }
                            return [ [ s, e ], [ n, t ] ];
                        }, e.prototype.diffBisectSplit = function(e, t, s, n, a) {
                            var r, i, o, d, u, l;
                            return r = e.substring(0, s), o = t.substring(0, n), i = e.substring(s), d = t.substring(n), 
                            u = this.DiffMain(r, o, !1, a), l = this.DiffMain(i, d, !1, a), u.concat(l);
                        }, e.prototype.diffCleanupSemantic = function(e) {
                            var t, r, i, o, d, u, l, _, c, h, m, f, p;
                            for (t = !1, r = [], i = 0, o = null, d = 0, _ = 0, c = 0, u = 0, l = 0; d < e.length; ) e[d][0] === a ? (r[i++] = d, 
                            _ = u, c = l, u = 0, l = 0, o = e[d][1]) : (e[d][0] === n ? u += e[d][1].length : l += e[d][1].length, 
                            o && o.length <= Math.max(_, c) && o.length <= Math.max(u, l) && (e.splice(r[i - 1], 0, [ s, o ]), 
                            e[r[i - 1] + 1][0] = n, i--, i--, d = i > 0 ? r[i - 1] : -1, _ = 0, c = 0, u = 0, 
                            l = 0, o = null, t = !0)), d++;
                            ...
                            e === t) return a;
                            for (r = 0, i = 1; ;) {
                                if (o = e.substring(a - i), d = t.indexOf(o), d === -1) return r;
                                i += d, 0 !== d && e.substring(a - i) !== t.substring(0, i) || (r = i, i++);
                            }
                        }, e.prototype.diffLinesToChars = function(e, t) {
                            function s(e) {
                                var t, s, r, i, o;
                                for (t = "", s = 0, r = -1, i = n.length; r < e.length - 1; ) r = e.indexOf("\n", s), 
                                r === -1 && (r = e.length - 1), o = e.substring(s, r + 1), s = r + 1, (a.hasOwnProperty ? a.hasOwnProperty(o) : void 0 !== a[o]) ? t += String.fromCharCode(a[o]) : (t += String.fromCharCode(i), 
                                a[o] = i, n[i++] = o);
                                return t;
                            }
                            var n, a, r, i;
                            return n = [], a = {}, n[0] = "", r = s(e), i = s(t), {
                                chars1: r,
                                chars2: i,
                                lineArray: n
                            };
                            ...
                            for (s = 0; s < e.length; s++) {
                                for (n = e[s][1], a = [], r = 0; r < n.length; r++) a[r] = t[n.charCodeAt(r)];
                                e[s][1] = a.join("");
                            }
                        }, e.prototype.diffCleanupMerge = function(e) {
                            var t, r, i, o, d, u, l, _, c;
                            for (e.push([ a, "" ]), t = 0, r = 0, i = 0, d = "", o = ""; t < e.length; ) switch (e[t][0]) {
                              case n:
                                i++, o += e[t][1], t++;
                                break;
                              ...
                              case a:
                                r + i > 1 ? (0 !== r && 0 !== i && (u = this.diffCommonPrefix(o, d), 0 !== u && (t - r - i > 0 && e[t - r - i - 1][0] === a ? e[t - r - i - 1][1] += o.substring(0, u) : (e.splice(0, 0, [ a, o.substring(0, u) ]), 
                                ...
                                d = d.substring(0, d.length - u))), 0 === r ? e.splice(t - i, r + i, [ n, o ]) : 0 === i ? e.splice(t - r, r + i, [ s, d ]) : e.splice(t - r - i, r + i, [ s, d ], [ n, o ]), 
                                t = t - r - i + (r ? 1 : 0) + (i ? 1 : 0) + 1) : 0 !== t && e[t - 1][0] === a ? (e[t - 1][1] += e[t][1], 
                                e.splice(t, 1)) : t++, i = 0, r = 0, d = "", o = "";
                            }
                            ...
                            var n, a, r;
                            return n = new e(), a = n.DiffMain(t, s), n.diffCleanupEfficiency(a), r = n.diffPrettyHtml(a);
                        };
                    }();
                }
            }
    ...
    !function(r, i) {
        "use strict";
        n = i, a = "function" == typeof n ? n.call(t, s, t, e) : n, !(void 0 !== a && (e.exports = a));
    }(this, function() {
        "use strict";
        function e(e, t) {
            var s;
        ...
        function h(h, M, y) {
            ...
            function Y(e) {
                ...
                var t = [];
                return e.message && t.push(e.message), L("showExpectationOnFailure") && !i(e) && (l(t, "expected", e.expected, x), 
            ...
            w.explain = x, w.note = function(e) {
                ...
                var t = "";
                w.count += 1, r(e) && (t += "not "), t += "ok " + w.count, w.puts(c(t, Y(e)));
            }, w.testDone = function() {
                n(b.config) && (w.expectedCount += b.config.current.expected);
            }, w.done = function() {
                ("undefined" == typeof w.config.noPlan || w.config.noPlan) && g(n(b.config) ? w.expectedCount : w.count);
