!function(t) {
        ...
        !function() {
            ...
            function i(t, e) {
                ...
                return t.empty(), i.open(t[0]), s.typeable = function(t) {
                    i.cursorHidden = !t, t && i.showCursor(), i.refresh(i.y, i.y), n = t;
                }, s.focus = function() {
                    i.focus();
                }, s.close = function() {
                    i.destroy();
            ...
            var o = s(6), a = s(7), c = s(9), l = {}, h = a.http("/var/run/docker.sock", {
                superuser: !0
            });
            l.pull = function(t, s, i) {
                ...
                function f(s) {
                    ...
                    v = a.channel(h), e(s), v.send(s), o(v).on("close.attach", function(i, n) {
                        e(t + ": console close: ", n), o(v).off(".attach"), v = null, p.connected && !n.problem && window.setTimeout(function() {
                            p.connected && !v && f(s);
                        }, 1e3);
                    });
                    var u = null, d = v.buffer();
                    d.callback = function(s) {
                        var o, c = 0, h = 0;
                        if (null === u) {
                            if (h = r(s, [ 13, 10, 13, 10 ]), h == -1) return c;
                        ...
                        w = g ? new i(p, v) : new n(p, v), p.typeable(y), p.connected = !0, d.callback = w.process;
                        var f = w.process(s);
                        return c + f;
                    };
                }
                function d() {
                    w && w.typeable && w.typeable(y && b);
                }
                var p = o("<div>").addClass("console-ct");
                p.connected = !1;
                var m, g, y = !1, b = !1, v = null, w = null;
            ...
            l.bytes_from_format = function(t, e) {
                var s = 1024;
                void 0 === e && (e = " ");
                var i = t.split(e).pop().toUpperCase(), n = u.indexOf(i), r = parseFloat(t);
        ...
        (function(s) {
            (function() {
                ...
                function p(t, e, s) {
                    ...
                    for (var n, r, a, c, l, h = 1 / 0, u = -1, f = 0; f < o.vcolors.length; f++) {
                ...
                }, h(r, s), r.prototype.pipe = function(t, e) {
                    function s() {
                ...
                var b = 0, v = 1, w = 2, x = 3, k = 4, C = 5, M = 6, S = {
                    type: "udk"
                };
                h(o, r), o.tangoColors = [ "#2e3436", "#cc0000", "#4e9a06", "#c4a000", "#3465a4", "#75507b", "#06989a", "#d3d7cf", "#555753", "#ef2929", "#8ae234", "#fce94f", "#729fcf", "#ad7fa8", "#34e2e2", "#eeeeec" ], 
                ...
                o.vcolors = function() {
                    ...
                    function i(t, e) {
                        ...
                        var i = [];
                        s(i, t), s(i, e.x), s(i, e.y), h.send("[M" + T.fromCharCode.apply(T, i));
                    }
                    function n(t) {
                        var e, s, i, n, r;
                        switch (t.type) {
                        ...
                        h.vt200Mouse ? r &= n : h.normalMouse || (r = 0), e = 32 + (r << 2) + e;
                    }
                    function r(t) {
                        var e, s, i, n, r;
                        if (null != t.pageX) {
                            for (e = t.pageX, s = t.pageY, r = h.element; r && r !== h.document.documentElement; ) e -= r.offsetLeft, 
                            s -= r.offsetTop, r = "offsetParent" in r ? r.offsetParent : r.parentNode;
                            return i = h.element.clientWidth, n = h.element.clientHeight, e = Math.round(e / i * h.cols), 
                            s = Math.round(s / n * h.rows), e < 0 && (e = 0), e > h.cols && (e = h.cols), s < 0 && (s = 0), 
                    ...
                    var o = this.element, h = this, u = 32, f = "onmousewheel" in this.context ? "mousewheel" : "DOMMouseScroll";
                    ...
                    var s, i, n, r, a, c, l, h, u, f, p, m, g, y;
                    for (e - t >= this.rows / 2 && (y = this.element.parentNode, y && y.removeChild(this.element)), 
                    l = this.cols, i = t, e >= this.lines.length && (this.log("`end` is too large. Most likely a bad CSR."), 
                    e = this.lines.length - 1); i <= e; i++) {
                        for (g = i + this.ydisp, r = this.lines[g], a = "", s = i !== this.y || !this.cursorState || this.ydisp !== this.ybase && !this.selectMode || this.cursorHidden ? -1 : this.x, 
                        u = this.defAttr, n = 0; n < l; n++) {
                            switch (h = r[n][0], c = r[n][1], n === s && (h = -1), h !== u && (u !== this.defAttr && (a += "</span>"), 
                            h !== this.defAttr && (h === -1 ? a += '<span class="reverse-video terminal-cursor">' : (a += this.useStyle ? '<span class="' : '<span style="', 
                            f = 511 & h, p = h >> 9 & 511, m = h >> 18, 1 & m && (o.brokenBold || (a += this.useStyle ? "term-bold " : "font-weight:bold;"), 
                            ...
                            8 & m && (f = h >> 9 & 511, p = 511 & h, 1 & m && p < 8 && (p += 8)), 16 & m && (a += this.useStyle ? "term-hidden " : "visibility:hidden;"), 
                            256 !== f && (a += this.useStyle ? "term-bg-color-" + f + " " : "background-color:" + this.colors[f] + ";"), 
                    ...
                    if (this.cursorBlink) {
                        ...
                        this._blinker = function() {
                            t._cursorBlink();
                        }, this._blink = _(this._blinker, 500);
                    }
                }, o.prototype.refreshBlink = function() {
                    this.cursorBlink && this._blink && (clearInterval(this._blink), this._blink = _(this._blinker, 500));
                    ...
                    this.maxRange()); r < n; r++, this.lch = i) switch (i = t[r], this.state) {
                      ...
                      case v:
                        switch (i) {
                          ...
                          case "%":
                            this.setgLevel(0), this.setgCharset(0, o.charsets.US), this.state = b, r++;
                            break;
                    ...
                    switch (t.keyCode) {
                      ...
                      default:
                        if (t.ctrlKey) if (t.keyCode >= 65 && t.keyCode <= 90) {
                            ...
                            e = T.fromCharCode(t.keyCode - 64);
                        } else 32 === t.keyCode ? e = T.fromCharCode(0) : t.keyCode >= 51 && t.keyCode <= 55 ? e = T.fromCharCode(t.keyCode - 51 + 27) : 56 === t.keyCode ? e = T.fromCharCode(127) : 219 === t.keyCode ? e = T.fromCharCode(27) : 221 === t.keyCode && (e = T.fromCharCode(29)); else t.altKey && (t.keyCode >= 65 && t.keyCode <= 90 ? e = "" + T.fromCharCode(t.keyCode + 32) : 192 === t.keyCode ? e = "`" : t.keyCode >= 48 && t.keyCode <= 57 && (e = "" + (t.keyCode - 48)));
                    }
                    ...
                    return !(!e || t.ctrlKey || t.altKey || t.metaKey) && (e = T.fromCharCode(e), this.prefixMode ? (this.leavePrefix(), 
                ...
                o.prototype.fillRectangle = function(t) {
                    ...
                    s = r; s < a; s++) e[s] = [ e[s][0], T.fromCharCode(i) ];
                ...
                o.prototype.requestLocatorPosition = function(t) {}, o.prototype.insertColumns = function() {
                    ...
                    if (this._selected) {
                        ...
                        r = n, n = c), h = o; h <= a; h++) for (l = 0, u = this.cols - 1, h === o && (l = n), 
                        h === a && (u = r); l <= u; l++) null != this.lines[h][l].old && (f = this.lines[h][l].old, 
                        delete this.lines[h][l].old, this.lines[h][l] = [ f, this.lines[h][l][1] ]);
                    ...
                    h === i && (u = e); l <= u; l++) f = this.lines[h][l][0], this.lines[h][l] = [ f & -512 | 261636, this.lines[h][l][1] ], 
                    this.lines[h][l].old = f;
                    ...
                    if ("y" !== e) {
                        ...
                        if ("{" === e || "}" === e) {
                            var l, h, n = this.x, r = this.y, o = this.ydisp, u = !1, f = !1, d = -1, s = this.y + ("{" === e ? -1 : 1), a = this.ydisp;
                    ...
                    if ("\r" === e || !this.searchMode && ("n" === e || "N" === e)) {
                        ...
                        for (var i, n, r, o = this.x, a = this.y, c = this.ydisp, l = !1, h = !1, u = this.x + 1, f = this.ydisp + this.y, d = "N" === e ? this.searchDown : !this.searchDown; ;) {
                            for (i = this.lines[f]; u < this.cols; ) {
                                for (r = 0; r < s.length && !(u + r >= this.cols) && i[u + r][1] === s[r]; r++) if (i[u + r][1] === s[r] && r === s.length - 1) {
                                    l = !0;
                                    break;
                                }
                                if (l) break;
                        ...
                        n = this.ybase)) : (n = this.ybase, f -= this.ybase), this.x = u, this.y = f, this.scrollDisp(-this.ydisp + n), 
                ...
                var T = this.String, E = this.setTimeout, _ = this.setInterval;
                p._cache = {}, p.distance = function(t, e, s, i, n, r) {
                    return Math.pow(30 * (t - i), 2) + Math.pow(59 * (e - n), 2) + Math.pow(11 * (s - r), 2);
                }, o.EventEmitter = s, o.Stream = r, o.inherits = h, o.on = a, o.off = c, o.cancel = l, 
                i = [], n = function() {
                    return o;
    ...
    11: function(t, e, s) {
        ...
        t.exports = n.extend({}, r, {
            render: function(t, e, s) {
                return i(r.render(t, e, s));
            },
            to_html: function(t, e, s, n) {
                return i(r.to_html(t, e, s, n));
            },
            clearCache: function() {
	 ...
	 */
        !function(r, o) {
            if ("object" == typeof e && e) o(e); else {
                var a = {};
                o(a), i = a, n = "function" == typeof i ? i.call(e, s, e, t) : i, !(void 0 !== n && (t.exports = n));
            }
        }(this, function(t) {
            function e(t, e) {
                return v.call(t, e);
            ...
            function a(e, i) {
                function r() {
                    if (T && !E) for (;S.length; ) delete M[S.pop()]; else S = [];
                    T = !1, E = !1;
                }
                i = i || t.tags, e = e || "", "string" == typeof i && (i = i.split(p));
                for (var a, u, f, m, v, w, x = o(i), k = new h(e), C = [], M = [], S = [], T = !1, E = !1; !k.eos(); ) {
                    if (a = k.pos, f = k.scanUntil(x[0])) for (var _ = 0, q = f.length; _ < q; ++_) m = f.charAt(_), 
                    s(m) ? S.push(M.length) : E = !0, M.push([ "text", m, a, a + 1 ]), a += 1, "\n" === m && r();
                    if (!k.scan(x[0])) break;
                    if (T = !0, u = k.scan(b) || "name", k.scan(d), "=" === u ? (f = k.scanUntil(g), 
                    k.scan(g), k.scanUntil(x[1])) : "{" === u ? (f = k.scanUntil(new RegExp("\\s*" + n("}" + i[1]))), 
                    k.scan(y), k.scanUntil(x[1]), u = "&") : f = k.scanUntil(x[1]), !k.scan(x[1])) throw new Error("Unclosed tag at " + k.pos);
                    if (v = [ u, f, a, k.pos ], M.push(v), "#" === u || "^" === u) C.push(v); else if ("/" === u) {
                        if (w = C.pop(), !w) throw new Error('Unopened section "' + f + '" at ' + a);
                        if (w[1] !== f) throw new Error('Unclosed section "' + w[1] + '" at ' + a);
                    } else "name" === u || "{" === u || "&" === u ? E = !0 : "=" === u && (x = o(i = f.split(p)));
                }
            ...
            var d = /\s*/, p = /\s+/, m = /\S/, g = /\s*=/, y = /\s*\}/, b = /#|\^|\/|>|\{|&|=|!/, v = RegExp.prototype.test, w = Object.prototype.toString, x = Array.isArray || function(t) {
            ...
            h.prototype.eos = function() {
                ...
                if (t in this.cache) e = this.cache[t]; else {
                    for (var s = this; s; ) {
                        if (t.indexOf(".") > 0) {
                            e = s.view;
                            for (var n = t.split("."), r = 0; null != e && r < n.length; ) e = e[n[r++]];
                        } else e = s.view[t];
                        if (null != e) break;
                        s = s.parent;
                    }
            ...
            }, f.prototype.render = function(t, e, s) {
                var i = this.parse(t), n = e instanceof u ? e : new u(e);
                return this.renderTokens(i, n, s, t);
            }, f.prototype.renderTokens = function(e, s, n, r) {
                function o(t) {
                    return h.render(t, s, n);
                }
                for (var a, c, l = "", h = this, u = 0, f = e.length; u < f; ++u) switch (a = e[u], 
                a[0]) {
                  case "#":
                    if (c = s.lookup(a[1]), !c) continue;
                    if (x(c)) for (var d = 0, p = c.length; d < p; ++d) l += this.renderTokens(a[4], s.push(c[d]), n, r); else if ("object" == typeof c || "string" == typeof c) l += this.renderTokens(a[4], s.push(c), n, r); else if (i(c)) {
                        if ("string" != typeof r) throw new Error("Cannot use higher-order sections without the original template");
                        c = c.call(s.view, r.slice(a[3], a[5]), o), null != c && (l += c);
                    } else l += this.renderTokens(a[4], s, n, r);
                    break;

                  case "^":
                    c = s.lookup(a[1]), (!c || x(c) && 0 === c.length) && (l += this.renderTokens(a[4], s, n, r));
                    break;

                  case ">":
                    if (!n) continue;
                    c = i(n) ? n(a[1]) : n[a[1]], null != c && (l += this.renderTokens(this.parse(c), s, n, c));
                    break;
            ...
            }, t.to_html = function(e, s, n, r) {
                var o = t.render(e, s, n);
                return i(r) ? void r(o) : o;
            }, t.escape = r, t.Scanner = h, t.Context = u, t.Writer = f;
        });
    },
    15: function(t, e, s) {
        "use strict";
        !function() {
            function e(t, e, s, n, r) {
                ...
                function a() {
                    g = m.checked ? o(Math.round(Math.exp(v + x * d.value))) : void 0;
                }
                function c() {
                    b = !0, void 0 !== g && i(d).prop("value", (Math.log(g) - v) / x), i(d).attr("disabled", void 0 === g).trigger("change"), 
                    b = !1;
                }
                function l() {
                    var t;
                ...
                function h() {
                    b = !0, void 0 !== g && i(p).val(r(g)), i(p).attr("disabled", void 0 === g), b = !1;
                }
                function u() {
                    m.checked || (g = void 0);
                }
                function f() {
                    b = !0, i(m).prop("checked", void 0 !== g), b = !1;
                }
                var d, p, m, g, y = this, b = !1;
                e < 0 && (e = 0), s < 0 && (s = 0);
                ...
                return d = t.find("div.slider").on("change", function() {
                    ...
                    set: function(t) {
                        t < 0 && (t = 0), s = t, w = Math.log(s), x = w - v, d && c();
                    }
                }), y;
            }
            var i = s(6), n = s(7), r = s(11);
            s(16);
            var o = s(8), a = s(17), c = n.gettext, l = {};
            l.resource_debug = function() {
                ...
                return t.Running ? n.format(c("Up since $StartedAt"), t) : n.format(c("Exited $ExitCode"), t);
                ...
                return t ? n.format(c("$0 shares"), Math.round(t)) : c("default");
            ...
            }, l.render_container = function(t, e, s, r, o, h) {
                var u = i(document.getElementById(s + r));
                if (!o) return u.remove(), void (e.find("table > tbody > tr").length || e.find("button.enable-danger").toggle(!1));
                var f, d, p, m, g, y;
                o.State && o.State.Running ? (f = l.format_cpu_usage(o.CpuUsage), d = o.MemoryUsage, 
                p = o.MemoryLimit, g = l.format_memory_and_limit(d, p), m = !0, y = {
                    color: "inherit"
                }) : (f = "", m = !1, g = c("Stopped"), y = {
                    color: "grey",
                    "text-align": "right"
                ...
                if (!u.length) {
                    ...
                    var v = i('<div class="spinner">'), w = i('<button class="btn btn-danger pficon pficon-delete btn-delete">').on("click", function() {
                        var e = this;
                        return i(e).hide().siblings("div.spinner").show(), l.docker_container_delete(t, r, function() {}, function() {
                        ...
                        return i(this).hide().siblings("div.spinner").show(), t.start(r).fail(function(e) {
                            l.handle_scope_start_container(t, r, e.message);
                        }), !1;
                ...
                i(C[3]).text(f), l.update_memory_bar(i(C[4]).children("div").toggle(m), d, p), i(C[5]).css(y).text(g);
                var M = r in t.waiting;
                i(C[6]).children("div.spinner").toggle(M), i(C[6]).children("button.btn-delete").toggle(!M).toggleClass("disabled", o.State.Running);
                var S = M || o.State.Running ? "You can only delete<br/> stopped containers" : "Delete immediately";
                i(C[6]).children("button.btn-delete").tooltip("destroy").attr("title", S).tooltip({
                    html: !0
                }), i(C[7]).children("div.spinner").toggle(M), i(C[7]).children("button.fa-play").toggle(!M && !o.State.Running), 
                i(C[7]).children("button.fa-stop").toggle(!M && o.State.Running), i(C[6]).toggle(h), 
                i(C[7]).toggle(!h), u.toggleClass("unimportant", !o.State.Running), b && l.insert_table_sorted(e.find("table"), u), 
                a.update();
                ...
                t.rm(e).fail(function(r) {
                    if (r.message.indexOf("remove a running container") > -1) {
                        ...
                        o = a.State.Running ? c("Container is currently running.") : c("Container is currently marked as not running, but regular stopping failed.") + " " + c("Error message from Docker:") + " '" + r.message + "'";
                        var h;
                        return h = a.Name ? a.Name : e, "/" === h.charAt(0) && (h = h.substring(1)), void l.confirm(n.format(c("Please confirm forced deletion of $0"), h), o, c("Force Delete")).done(function() {
                            t.rm(e, !0).fail(function(t) {
                                l.show_unexpected_error(t), i();
                            }).done(s);
                        }).fail(i);
                    }
                    l.show_unexpected_error(r), i();
                }).done(s);
            }, l.handle_scope_start_container = function(t, e, s, i, r) {
                var o = ".scope already exists", a = s.indexOf(o);
                if (a > -1) {
                    var h = "Unit docker-", u = s.indexOf(h) + h.length, f = s.substring(u, a);
                    return void n.spawn([ "systemctl", "stop", "docker-" + f + ".scope" ], {
                        ...
                        l.show_unexpected_error(n.format(c("Failed to stop Docker scope: $0"), t)), r && r();
                    });
                }
                l.show_unexpected_error(s), r && r();
    ...
    16: function(t, e, s) {
        ...
        !function() {
            ...
            function c(t, e, s) {
                ...
                var u = e.cancel || e.close, f = !1, d = t.find(".form-control").add(".btn", t);
                return u && (d = d.not("[data-dismiss]").not(".btn-cancel")), d.each(function() {
                    var t = y(this);
            ...
            function l(e) {
                var s = b.gettext || function(t) {
                    return t;
                };
                return e = e.find(".btn-onoff-ct").andSelf().filter(".btn-onoff-ct"), e.each(function(e, i) {
                    var n, r, o, a = y(i).attr("data-toggle", "buttons").addClass("btn-group"), c = a.onoff("value"), l = a.find(".btn"), h = a.find("input").first().attr("name") || t();
            ...
            y.fn.dialog = function(t) {
            ...
            }, y(document).ready(g), y.fn.update_privileged = function(t, e, s) {
                var i = t.allowed !== !1, n = this;
                return n.each(function() {
                    ...
                    s && (n.placement = s), y(this).tooltip(n), y(this).hasClass("disabled") === i && (y(this).toggleClass("disabled", !i).attr("data-original-title", null), 
                    i ? y(this).attr("title", y(this).data(t)) : y(this).attr("title", e), y(this).tooltip("fixTitle"));
                }), n;
            };
        }();
    },
    ...
    131: function(t, e, s) {
        "use strict";
        !function() {
            window.QUnit = s(132), window.qunitTap = s(134), s(135), s(136), t.exports = window.QUnit;
        }();
    },
    132: function(t, e, s) {
        var i;
	 ...
	 */
            !function(t) {
                ...
                function g() {
                    var t, e, s = [];
                    if (!$.started) {
                        for ($.started = N(), m(), "" === $.modules[0].name && 0 === $.modules[0].tests.length && $.modules.shift(), 
                ...
                function y(t) {
                    ...
                    for ($.depth = ($.depth || 0) + 1; $.queue.length && !$.blocking; ) {
                        if (!(!B.setTimeout || $.updateRate <= 0 || N() - s < $.updateRate)) {
                            O(e, 13);
                            break;
                        }
                ...
                function b() {
                    $.blocking = !0, $.testTimeout && B.setTimeout && (j($.timeout), $.timeout = O(function() {
                        if (!$.current) throw new Error("Test timed out");
                        $.current.semaphore = 0, D.pushFailure("Test timed out", f(2)), v();
                    }, $.testTimeout));
                }
                function v() {
                    Q = !0, B.setTimeout ? O(function() {
                        $.current && $.current.semaphore > 0 || ($.timeout && j($.timeout), g());
                    }, 13) : g();
                }
                function w() {
                    var t, e;
                    $.autorun = !0, $.previousModule && p("moduleDone", {
                        ...
                        runtime: N() - $.moduleStats.started
                    }), delete $.previousModule, t = N() - $.started, e = $.stats.all - $.stats.bad, 
                    p("done", {
                        failed: $.stats.bad,
                        passed: e,
                        total: $.stats.all,
                ...
                function k(t) {
                    ...
                    this.testId = C(this.module.name, this.testName), this.module.tests.push({
                        name: this.testName,
                        testId: this.testId
                    }), t.skip ? (this.callback = function() {}, this.async = !1, this.expected = 0) : this.assert = new L(this);
                }
                function C(t, e) {
                ...
                function M(t, e, s) {
                    var i, n = !e;
                    if ("array" !== D.objectType(t)) e ? $.queue.splice(X++, 0, t) : s ? (z || (z = S(s)), 
                    i = Math.floor(z() * ($.queue.length - X + 1)), $.queue.splice(X + i, 0, t)) : $.queue.push(t), 
                ...
                function E() {
                    var t, e, s = $.pollution;
                    T(), t = r($.pollution, s), t.length > 0 && D.pushFailure("Introduced global variable(s): " + t.join(", ")), 
                ...
                function P(t, e, s, i) {
                    var n;
                    W || (D.config.queue.length = 0, W = !0, 2 === arguments.length && (s = e, e = null), 
                    n = new k({
                        testName: t,
                        expected: e,
                        async: i,
                ...
                var D = {}, U = t.Date, N = U.now || function() {
                    return new U().getTime();
                }, O = t.setTimeout, j = t.clearTimeout, I = t.window, B = {
                    document: I && void 0 !== I.document,
                    setTimeout: void 0 !== O,
                ...
                }(), D.isLocal = !(B.document && "file:" !== I.location.protocol), D.version = "1.23.1", 
                c(D, {
                ...
                k.count = 0, k.prototype = {
                    ...
                    run: function() {
                        ...
                        var e;
                        if ($.current = this, this.async && D.stop(), this.callbackStarted = N(), $.notrycatch) return void t(this);
                        try {
                            t(this);
                        } catch (t) {
                            this.pushFailure("Died on test #" + (this.assertions.length + 1) + " " + this.stack + ": " + (t.message || t), u(t, 0)), 
                            T(), $.blocking && D.start();
                        }
                    },
                    after: function() {
                    ...
                    queueHook: function(t, e) {
                        ...
                        return function() {
                            ...
                            try {
                                ...
                                i.pushFailure(e + " failed on " + i.testName + ": " + (t.message || t), u(t, 0));
                            }
                        };
                    },
                    hooks: function(t) {
                    ...
                    finish: function() {
                        ...
                        var t, e = 0;
                        for (this.runtime = N() - this.started, $.stats.all += this.assertions.length, $.moduleStats.all += this.assertions.length, 
                    ...
                    resolvePromise: function(t, e) {
                        ...
                        null != t && (s = t.then, "function" === D.objectType(s) && (D.stop(), s.call(t, function() {
                            ...
                            n.pushFailure(i, u(t, 0)), T(), D.start();
                        })));
                    },
                    valid: function() {
                        function t(e) {
                    ...
                    pushResult: function(t) {
                        var e = this, s = e instanceof L && e.test || D.config.current;
                        ...
                        e instanceof L || (e = s.assert), e.test.pushResult(t);
                    },
                    ok: function(t, e) {
                    ...
                    throws: function(t, e, s) {
                        var i, n, r = e, o = !1, a = this instanceof L && this.test || D.config.current;
                        ...
                        a.ignoreGlobalErrors = !1, i && (n = D.objectType(e), e ? "regexp" === n ? o = e.test(R(i)) : "string" === n ? o = e === R(i) : "function" === n && i instanceof e ? o = !0 : "object" === n ? o = i instanceof e.constructor && i.name === e.name && i.message === e.message : "function" === n && e.call({}, i) === !0 && (r = null, 
                    ...
                    L.prototype.raises = L.prototype.throws;
                }(), D.equiv = function() {
                    function t(t, e) {
                    ...
                    var r = [], o = [], a = [], c = Object.getPrototypeOf || function(t) {
                        ...
                        array: function(t, e) {
                            ...
                            for (o.push(e), a.push(t), s = 0; s < r; s++) {
                                for (c = !1, i = 0; i < o.length; i++) if (l = o[i] === e[s], h = a[i] === t[s], 
                                l || h) {
                                    if (!(e[s] === t[s] || l && h)) return o.pop(), a.pop(), !1;
                                    c = !0;
                                }
                        ...
                        object: function(t, s) {
                            var i, c, l, h, u, f = !0, d = [], p = [];
                            if (e(s, t) === !1) return !1;
                            r.push(s.constructor), o.push(s), a.push(t);
                            for (i in s) {
                                for (l = !1, c = 0; c < o.length; c++) if (h = o[c] === s[i], u = a[c] === t[i], 
                                h || u) {
                                    if (!(s[i] === t[i] || h && u)) {
                                        f = !1;
                                        break;
                    ...
                    var n = /^function (\w+)/, r = {
                        ...
                        parsers: {
                            ...
                            object: function(t, e) {
                                ...
                                for (i.sort(), c = 0; c < i.length; c++) n = i[c], a = t[n], h.push(r.parse(n, "key") + ": " + r.parse(a, void 0, e));
                                return r.down(), s("{", h, "}");
                            },
                            node: function(t) {
                    ...
                    for (t = 0, e = s.length; t < e; t++) I[s[t]] = D[s[t]];
                }(), I.QUnit = D), "undefined" != typeof n && n && n.exports && (n.exports = D, 
                ...
                function t() {
                    var t, e, s, i, n = {}, r = q.search.slice(1).split("&"), o = r.length;
                ...
                function s(t, e, s) {
                    t.addEventListener ? t.addEventListener(e, s, !1) : t.attachEvent && t.attachEvent("on" + e, function() {
                        var e = window.event;
                        e.target || (e.target = e.srcElement || L), s.call(t, e);
                    });
                }
                function i(t, e, i) {
                ...
                function c(t) {
                    return L.getElementById && L.getElementById(t);
                }
                function l() {
                ...
                function h() {
                    ...
                    n[i.name] = e, t = u(n), "hidepassed" === i.name && "replaceState" in window.history ? (QUnit.urlParams[i.name] = e, 
                ...
                function f() {
                    ...
                    t = e ? decodeURIComponent(e.options[e.selectedIndex].value) : void 0, window.location = u({
                        module: "" === t ? void 0 : t,
                        filter: "" === s ? void 0 : s,
                        moduleId: void 0,
                        testId: void 0
                ...
                function d() {
                    ...
                    return t.innerHTML = l(), r(t, "qunit-url-config"), i(t.getElementsByTagName("input"), "click", h), 
                    i(t.getElementsByTagName("select"), "change", h), t;
                }
                function p() {
                    var t = L.createElement("form"), e = L.createElement("label"), i = L.createElement("input"), n = L.createElement("button");
                ...
                function m() {
                    ...
                    t = 0; t < O.length; t++) s += "<option value='" + e(encodeURIComponent(O[t])) + "' " + (QUnit.urlParams.module === O[t] ? "selected='selected'" : "") + ">" + e(O[t]) + "</option>";
                    return s += "</select>";
                }
                function g() {
                    var t = c("qunit-testrunner-toolbar"), e = L.createElement("span"), i = m();
                ...
                function w() {
                    ...
                    e && e.parentNode.removeChild(e), t && (t.innerHTML = "", e = L.createElement("p"), 
                ...
                function C() {
                    ...
                    t && (t.innerHTML = "", t.appendChild(L.createTextNode("QUnit " + QUnit.version + "; " + navigator.userAgent)));
                }
                function M() {
                    var t = c("qunit");
                    t && (t.innerHTML = "<h1 id='qunit-header'>" + e(L.title) + "</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar'></div>" + k() + "<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"), 
                    b(), v(), w(), C(), y();
                }
                function S(t) {
                    var e, s, i, n, r, o;
                    for (e = 0, s = t.length; e < s; e++) for (o = t[e], i = 0, n = o.tests.length; i < n; i++) r = o.tests[i], 
                    T(r.name, r.testId, o.name);
                }
                function T(t, e, s) {
                    var i, n, r, o, a = c("qunit-tests");
                    a && (i = L.createElement("strong"), i.innerHTML = E(t, s), n = L.createElement("a"), 
                    n.innerHTML = "Rerun", n.href = u({
                        testId: e
                    }), r = L.createElement("li"), r.appendChild(i), r.appendChild(n), r.id = "qunit-test-output-" + e, 
                    o = L.createElement("ol"), o.className = "qunit-assert-list", r.appendChild(o), 
                    a.appendChild(r));
                }
                function E(t, s) {
                    var i = "";
                ...
                var q = "undefined" != typeof window && window.location;
                if (q) {
                    var A = t();
                    ...
                    QUnit.config.urlConfig.push({
                        ...
                        void 0 === QUnit.config[e] && (QUnit.config[e] = A[e]);
                        ...
                        var P = QUnit.config, L = window.document, R = !1, D = Object.prototype.hasOwnProperty, U = u({
                            filter: void 0,
                            module: void 0,
                            moduleId: void 0,
                            testId: void 0
                        ...
                        QUnit.begin(function(t) {
                            var e, s, i;
                            for (e = 0; e < t.modules.length; e++) s = t.modules[e], s.name && O.push(s.name);
                            O.sort(function(t, e) {
                                return t.localeCompare(e);
                            }), x(), M(), S(t.modules), i = c("qunit-tests"), i && P.hidepassed && r(i, "hidepass");
                            ...
                            P.altertitle && L.title && (L.title = [ t.failed ? "✖" : "✔", L.title.replace(/^[\u2714\u2716] /i, "") ].join(" ")), 
                            P.reorder && N.sessionStorage && 0 === t.failed) for (e = 0; e < sessionStorage.length; e++) s = sessionStorage.key(e++), 
                            ...
                            var e, s, i;
                            s = c("qunit-test-output-" + t.testId), s ? s.className = "running" : T(t.name, t.testId, t.module), 
                            e = c("qunit-testresult"), e && (i = QUnit.config.reorder && N.sessionStorage && +sessionStorage.getItem("qunit-test-" + t.module + "-" + t.name), 
                            e.innerHTML = (i ? "Rerunning previously failed test: <br />" : "Running: <br />") + E(t.name, t.module));
                        }), QUnit.log(function(t) {
                            var s, i, n, r, o, a, l = !1, h = c("qunit-test-output-" + t.testId);
                            h && (n = e(t.message) || (t.result ? "okay" : "failed"), n = "<span class='test-message'>" + n + "</span>", 
                            ...
                            /^(true|false)$/.test(o) || /^(true|false)$/.test(r) || (a = QUnit.diff(r, o), l = _(a).length !== _(r).length + _(o).length), 
                            ...
                            s = h.getElementsByTagName("ol")[0], i = L.createElement("li"), i.className = t.result ? "pass" : "fail", 
                            i.innerHTML = n, s.appendChild(i));
                        }), QUnit.testDone(function(t) {
                            var e, i, n, a, l, h, u, f, d, p = c("qunit-tests");
                            p && (n = c("qunit-test-output-" + t.testId), a = n.getElementsByTagName("ol")[0], 
                            l = t.passed, h = t.failed, P.reorder && N.sessionStorage && (h ? sessionStorage.setItem("qunit-test-" + t.module + "-" + t.name, h) : sessionStorage.removeItem("qunit-test-" + t.module + "-" + t.name)), 
                            0 === h ? r(a, "qunit-collapsed") : h && P.collapse && !R ? R = !0 : r(a, "qunit-collapsed"), 
                            e = n.firstChild, u = h ? "<b class='failed'>" + h + "</b>, <b class='passed'>" + l + "</b>, " : "", 
                            e.innerHTML += " <b class='counts'>(" + u + t.assertions.length + ")</b>", t.skipped ? (n.className = "skipped", 
                            f = L.createElement("em"), f.className = "qunit-skipped-label", f.innerHTML = "skipped", 
                            n.insertBefore(f, e)) : (s(e, "click", function() {
                                o(a, "qunit-collapsed");
                            }), n.className = h ? "fail" : "pass", i = L.createElement("span"), i.className = "runtime", 
                            i.innerHTML = t.runtime + " ms", n.insertBefore(i, a)), t.source && (d = L.createElement("p"), 
                            d.innerHTML = "<strong>Source: </strong>" + t.source, r(d, "qunit-source"), 0 === h && r(d, "qunit-collapsed"), 
                            s(e, "click", function() {
                                o(d, "qunit-collapsed");
                            }), n.appendChild(d)));
                        });
                        ...
                        j && "complete" === L.readyState ? QUnit.load() : s(window, "load", QUnit.load), 
                        QUnit.diff = function() {
                            function t() {}
                            var s = -1, i = 1, n = 0;
                            return t.prototype.DiffMain = function(t, e, s) {
                                ...
                                var e, r, o, a, c, l, h, u, f;
                                for (e = !1, r = [], o = 0, a = null, c = 0, l = !1, h = !1, u = !1, f = !1; c < t.length; ) t[c][0] === n ? (t[c][1].length < 4 && (u || f) ? (r[o++] = c, 
                                l = u, h = f, a = t[c][1]) : (o = 0, a = null), u = f = !1) : (t[c][0] === s ? f = !0 : u = !0, 
                                a && (l && h && u && f || a.length < 2 && l + h + u + f === 3) && (t.splice(r[o - 1], 0, [ s, a ]), 
                                t[r[o - 1] + 1][0] = i, o--, a = null, l && h ? (u = f = !0, o = 0) : (o--, c = o > 0 ? r[o - 1] : -1, 
                                u = f = !1), e = !0)), c++;
                                ...
                                var a, c, l, h, u, f, d, p, m, g, y, b;
                                return t ? e ? (c = t.length > e.length ? t : e, l = t.length > e.length ? e : t, 
                                h = c.indexOf(l), h !== -1 ? (a = [ [ i, c.substring(0, h) ], [ n, l ], [ i, c.substring(h + l.length) ] ], 
                                t.length > e.length && (a[0][0] = a[2][0] = s), a) : 1 === l.length ? [ [ s, t ], [ i, e ] ] : (u = this.diffHalfMatch(t, e), 
                                u ? (f = u[0], p = u[1], d = u[2], m = u[3], g = u[4], y = this.DiffMain(f, d, r, o), 
                                b = this.DiffMain(p, m, r, o), y.concat([ [ n, g ] ], b)) : r && t.length > 100 && e.length > 100 ? this.diffLineMode(t, e, o) : this.diffBisect(t, e, o))) : [ [ s, t ] ] : [ [ i, e ] ];
                            }, t.prototype.diffHalfMatch = function(t, e) {
                                function s(t, e, s) {
                                    var i, n, o, a, c, l, h, u, f;
                                    ...
                                    l = t.substring(0, s - c), h = t.substring(s + a), u = e.substring(0, n - c), f = e.substring(n + a));
                                    return 2 * o.length >= t.length ? [ l, h, u, f, o ] : null;
                                }
                                var i, n, r, o, a, c, l, h, u, f, d;
                                return i = t.length > e.length ? t : e, n = t.length > e.length ? e : t, i.length < 4 || 2 * n.length < i.length ? null : (r = this, 
                                u = s(i, n, Math.ceil(i.length / 4)), f = s(i, n, Math.ceil(i.length / 2)), u || f ? (d = f ? u && u[4].length > f[4].length ? u : f : u, 
                                t.length > e.length ? (o = d[0], l = d[1], c = d[2], a = d[3]) : (c = d[0], a = d[1], 
                                o = d[2], l = d[3]), h = d[4], [ o, l, c, a, h ]) : null);
                            }, t.prototype.diffLineMode = function(t, e, r) {
                                var o, a, c, l, h, u, f, d, p;
                                ...
                                a.push([ n, "" ]), l = 0, u = 0, h = 0, d = "", f = ""; l < a.length; ) {
                                    switch (a[l][0]) {
                                      case i:
                                        h++, f += a[l][1];
                                        break;
                                      ...
                                      case n:
                                        if (u >= 1 && h >= 1) {
                                            for (a.splice(l - u - h, u + h), l = l - u - h, o = this.DiffMain(d, f, !1, r), 
                                ...
                                var r, o, a, c, l, h, u, f, d, p, m, g, y, b, v, w, x, k, C, M, S, T, E;
                                for (r = t.length, o = e.length, a = Math.ceil((r + o) / 2), c = a, l = 2 * a, h = new Array(l), 
                                u = new Array(l), f = 0; f < l; f++) h[f] = -1, u[f] = -1;
                                for (h[c + 1] = 0, u[c + 1] = 0, d = r - o, p = d % 2 !== 0, m = 0, g = 0, y = 0, 
                                b = 0, S = 0; S < a && !(new Date().getTime() > n); S++) {
                                    for (T = -S + m; T <= S - g; T += 2) {
                                        for (w = c + T, x = T === -S || T !== S && h[w - 1] < h[w + 1] ? h[w + 1] : h[w - 1] + 1, 
                                        C = x - T; x < r && C < o && t.charAt(x) === e.charAt(C); ) x++, C++;
                                        if (h[w] = x, x > r) g += 2; else if (C > o) m += 2; else if (p && (v = c + d - T, 
                                        v >= 0 && v < l && u[v] !== -1 && (k = r - u[v], x >= k))) return this.diffBisectSplit(t, e, x, C, n);
                                    }
                                    for (E = -S + y; E <= S - b; E += 2) {
                                        for (v = c + E, k = E === -S || E !== S && u[v - 1] < u[v + 1] ? u[v + 1] : u[v - 1] + 1, 
                                        M = k - E; k < r && M < o && t.charAt(r - k - 1) === e.charAt(o - M - 1); ) k++, 
                                        M++;
                                        if (u[v] = k, k > r) b += 2; else if (M > o) y += 2; else if (!p && (w = c + d - E, 
                                        w >= 0 && w < l && h[w] !== -1 && (x = h[w], C = c + x - w, k = r - k, x >= k))) return this.diffBisectSplit(t, e, x, C, n);
                                    }
                                }
                                return [ [ s, t ], [ i, e ] ];
                                ...
                                l = this.DiffMain(r, a, !1, n), h = this.DiffMain(o, c, !1, n), l.concat(h);
                            }, t.prototype.diffCleanupSemantic = function(t) {
                                var e, r, o, a, c, l, h, u, f, d, p, m, g;
                                for (e = !1, r = [], o = 0, a = null, c = 0, u = 0, f = 0, l = 0, h = 0; c < t.length; ) t[c][0] === n ? (r[o++] = c, 
                                u = l, f = h, l = 0, h = 0, a = t[c][1]) : (t[c][0] === i ? l += t[c][1].length : h += t[c][1].length, 
                                a && a.length <= Math.max(u, f) && a.length <= Math.max(l, h) && (t.splice(r[o - 1], 0, [ s, a ]), 
                                t[r[o - 1] + 1][0] = i, o--, o--, c = o > 0 ? r[o - 1] : -1, u = 0, f = 0, l = 0, 
                                h = 0, a = null, e = !0)), c++;
                                ...
                                for ("" === t[t.length - 1][1] && t.pop(), h = !1, e = 1; e < t.length - 1; ) t[e - 1][0] === n && t[e + 1][0] === n && (u = t[e][1], 
                                f = u.substring(u.length - t[e - 1][1].length), f === t[e - 1][1] ? (t[e][1] = t[e - 1][1] + t[e][1].substring(0, t[e][1].length - t[e - 1][1].length), 
                                t[e + 1][1] = t[e - 1][1] + t[e + 1][1], t.splice(e - 1, 1), h = !0) : u.substring(0, t[e + 1][1].length) === t[e + 1][1] && (t[e - 1][1] += t[e + 1][1], 
                                t[e][1] = t[e][1].substring(t[e + 1][1].length) + t[e + 1][1], t.splice(e + 1, 1), 
                                h = !0)), e++;
                                h && this.diffCleanupMerge(t);
                            }, function(e, s) {
                                var i, n, r;
    ...
    133: function(t, e) {
        ...
        f.removeAllListeners = l, f.emit = l, f.binding = function(t) {
    ...
    134: function(t, e, s) {
        ...
        !function(r, o) {
            ...
            function u(t, e, s, i, n) {
                t && "undefined" != typeof i && h(e, s, i, n);
            }
            function f(t, e) {
                return e ? t + " - " + a(e) : t;
            }
            function d(d, y, b) {
                ...
                function w(t) {
                    ...
                    var e = [];
                    return t.message && e.push(t.message), v("showExpectationOnFailure") && !o(t) && (h(e, "expected", t.expected, q), 
                    h(e, "got", t.actual, q)), u(v("showTestNameOnFailure"), e, "test", t.name, l), 
                ...
                function k(t) {
                    var i;
                    e(E, t) !== -1 && (i = M.config[t], "undefined" != typeof i && s(i, _[t]));
                }
                function C(t) {
                    var e;
                ...
                var M = d, S = {}, T = function(t, e) {
                    b && "object" == typeof b && "undefined" != typeof b[t] && (y('# WARNING: Option "' + t + '" is deprecated and will be removed in future version.'), 
                    e(b[t]));
                }, E = [ "moduleStart", "testStart", "log", "testDone", "done" ], _ = {}, q = function() {
                ...
                }), T("showDetailsOnFailure", function(t) {
                ...
                }), S.VERSION = p, S.puts = y, S.count = S.config.initialCount - 1, S.expectedCount = S.config.initialCount - 1, 
                S.explain = q, S.note = function(t) {
                    S.puts(a("# " + t));
                }, S.diag = function(t) {
                    return S.note(t), !1;
                    ...
                    var e = "";
                    S.count += 1, r(t) && (e += "not "), e += "ok " + S.count, S.puts(f(e, w(t)));
                }, S.testDone = function() {
                    i(M.config) && (S.expectedCount += M.config.current.expected);
                }, S.done = function() {
                    ("undefined" == typeof S.config.noPlan || S.config.noPlan) && x(i(M.config) ? S.expectedCount : S.count);
                }, S.unsubscribe = function() {
                    "undefined" != typeof M.config && C(0 === arguments.length ? E : m.apply(arguments));
                }, function() {
                    var t, e, s, i = g(M);
                    for (e = 0; e < E.length; e += 1) t = E[e], s = i(M, S, t), _[t] = s;
                }(), S;
            }
