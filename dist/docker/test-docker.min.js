!function(e) {
    ...
    !function() {
        ...
        n.test("bytes_from_format", function() {
            ...
            for (var s, n = 0; n < t.length; n++) {
                var i, r = [];
                s = void 0;
                for (var o = 0; o < 16 && (i = e.json_skip(t[n][1], s), r.push(i), 0 !== i); o++) s = i;
                a.deepEqual(r, t[n][2], "json_skip(): " + t[n][0]);
            }
    ...
    !function() {
        ...
        u.pull = function(e, s, n) {
            ...
            function _() {
                return m.connected = !1, f ? void (Y = l.request(r.extend({}, d, f)).always(function() {
                    Y = null;
                }).done(function(e) {
                    ...
                    u(e.message);
                })) : c(p === !1 ? "GET /v1.15/containers/" + encodeURIComponent(e) + "/logs?follow=1&stdout=1&stderr=1&tail=1000&timestamps=0 HTTP/1.0\r\nContent-Length: 0\r\n\r\n" : "POST /v1.15/containers/" + encodeURIComponent(e) + "/attach?logs=1&stream=1&stdin=1&stdout=1&stderr=1 HTTP/1.0\r\nContent-Length: 0\r\n\r\n");
            }
            function c(s) {
                g && g.close(), g = null;
                var l = r.extend({}, d, {
    ...
    !function() {
        ...
        l.journalctl = function() {
            ...
            var o, d = n.defer(), u = "", l = [], _ = [], c = null, h = n.spawn(r, {
                host: i.host,
                batch: 8192,
                latency: 300,
                superuser: "try"
