    ...
    function l() {
        ...
        function I(t, e) {
            ...
            function i(e, i, r, a, s, c, l) {
                ...
                n(e, "ignore-auto-routes", "b", t[e].ignore_auto_routes), n(e, "addresses", i, t[e].addresses.map(r)), 
                n(e, "dns", c, t[e].dns.map(l)), n(e, "dns-search", "as", t[e].dns_search), n(e, "routes", a, t[e].routes.map(s)), 
                delete o[e]["address-labels"];
            }
            var o = J.extend(!0, {}, e);
