!function(t) {
    ...
    function l() {
        ...
        var K, Z = {}, tt = {
            ...
            exporters: [ function(t) {
                ...
                return t.Device || 0 !== t.Connections.length ? (t.Device ? t.Device.AvailableConnections.forEach(function(n) {
                    e(n), n.Interfaces.push(t);
                }) : t.Connections.forEach(function(n) {
                    e(n), n.Interfaces.push(t);
                }), void (t.Device && t.Device.ActiveConnection && t.Device.ActiveConnection.Connection && (t.MainConnection = t.Device.ActiveConnection.Connection))) : void l(i(t).path);
            } ]
        }, st = {
    ...
    function E(t, e, n, i, o, r) {
        ...
        if (r) {
            var d;
            if (d = e ? e.Interfaces[0].Name : n.connection.interface_name, !d) return !1;
            ...
            if (l.master != n.connection.uuid) return l.slave_type = i, l.master = d, delete s.Settings.ipv4, 
            delete s.Settings.ipv6, delete s.Settings.team_port, delete s.Settings.bridge_port, 
        ...
        } else s && s.Masters.indexOf(e) != -1 && P(s);
        return !0;
    }
    ...
    b.prototype = {
        ...
        update_devices: function() {
            ...
            e.empty(), J("#networking-unmanaged-interfaces").hide(), n.model.list_interfaces().forEach(function(i) {
                function o(t) {
                    return t.Device && t.Device.ActiveConnection && t.Device.ActiveConnection.Master || t.MainConnection && t.MainConnection.Masters.length > 0;
                }
