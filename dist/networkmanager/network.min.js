!function(e) {
    ...
    function l() {
        ...
        function p(e, t, n) {
            ...
            return H.call(f(e), t, n, Array.prototype.slice.call(arguments, 3)).fail(function(e) {
                i.reject(e);
            }).done(function(e) {
                i.resolve.apply(i, e);
            }), i.promise();
        ...
        function _() {
            ...
            j || (j = !0, window.setTimeout(function() {
                j = !1, e();
            }, 300));
        }
        function x(e) {
        ...
        function N(e, t) {
            var n = c(e);
            n.uuid && delete X[n.uuid], e.Settings = t, n = c(e), n.uuid && (X[n.uuid] = e);
        }
        function z(t) {
            o(), t.Settings || (t.Settings = {
                connection: {}
            }), H.call(f(t), "org.freedesktop.NetworkManager.Settings.Connection", "GetSettings").always(r).fail(e).done(function(e) {
                var n = e[0];
                n && (i(t).orig = n, N(t, T(n)));
            });
        }
        function O(e) {
        ...
        var H = ee.dbus("org.freedesktop.NetworkManager", U);
        $.client = H;
        var j, L = {}, B = 0, Y = {}, q = 0;
        H.call("/org/freedesktop/NetworkManager", "org.freedesktop.DBus.Properties", "Get", [ "org.freedesktop.NetworkManager", "State" ], {
            flags: ""
        }).fail(e).done(function(e, t) {
            t.flags && (t.flags.indexOf(">") !== -1 ? te.set_byteorder("be") : t.flags.indexOf("<") !== -1 && te.set_byteorder("le"));
        });
        var G = H.subscribe({}, g), V = H.watch({});
        Z(H).on("notify", function(e, t) {
            ...
            G.remove(), V.remove(), Z(H).off("notify"), H.close("unused");
        };
        var J, X = {}, Q = {
            ...
            prototype: {
                ...
                activate: function(e, t) {
                    return p(a("/org/freedesktop/NetworkManager", J), "org.freedesktop.NetworkManager", "ActivateConnection", f(this), f(e), f(t));
                },
                delete_: function() {
            ...
            exporters: [ function(e) {
                ...
                var n, i, o = c(e);
                o.slave_type && (n = X[o.master], n ? (e.Masters.push(n), n.Slaves.push(e)) : (i = W(o.master), 
                i && (i.Device ? i.Device.AvailableConnections.forEach(t) : i.Connections.forEach(t))));
            } ]
        }, ie = {
            ...
            prototype: {
                deactivate: function() {
                    return p(a("/org/freedesktop/NetworkManager", J), "org.freedesktop.NetworkManager", "DeactivateConnection", f(this));
                }
            }
        }, oe = {
            ...
            prototype: {
                activate: function(e, t) {
                    return p(a("/org/freedesktop/NetworkManager", J), "org.freedesktop.NetworkManager", "ActivateConnection", f(e), f(this), f(t));
                },
                activate_with_settings: function(e, t) {
                    try {
                        return p(a("/org/freedesktop/NetworkManager", J), "org.freedesktop.NetworkManager", "AddAndActivateConnection", I(e), f(this), f(t));
                    } catch (e) {
                        return ee.reject(e);
                    }
                },
            ...
            interfaces: [],
            exporters: [ function(e) {
                e.Device = null, e.Connections = [], e.MainConnection = null;
            }, null, function(e) {
                function t(t) {
                    (!e.MainConnection || c(e.MainConnection).timestamp < c(t).timestamp) && (e.MainConnection = t);
                }
                return e.Device || 0 !== e.Connections.length ? (e.Device ? e.Device.AvailableConnections.forEach(function(n) {
            ...
            exporters: [ null, function(e) {
                e.Connections && e.Connections.forEach(function(e) {
                    function t(t) {
                        t && E(t).Connections.push(e);
                    }
                    e.Settings && (e.Settings.bond && t(e.Settings.bond.interface_name), e.Settings.team && t(e.Settings.team.interface_name), 
        ...
        return J = {
            ...
            return a("/org/freedesktop/NetworkManager", J);
        }, $.get_settings = function() {
            return a("/org/freedesktop/NetworkManager/Settings", se);
        }, $.at_least_version = function(e) {
            return F($.get_manager().Version, e) >= 0;
        }, h([ J, se, oe, Q, K, ne, ie ]), a("/org/freedesktop/NetworkManager", J), a("/org/freedesktop/NetworkManager/Settings", se), 
        $;
    }
    function d(e) {
    ...
    function y(e, t, n) {
        ...
        return n.hack_does_add_or_remove && !e.at_least_version("1.6") ? void t() : void s.checkpoint_create(n.devices || [], be).done(function(e) {
            return e ? (i(), void t().done(function() {
                window.setTimeout(function() {
                    s.checkpoint_destroy(e).always(o).fail(function(e) {
                        u.find("#confirm-breaking-change-text").html(n.fail_text), u.find(".modal-footer .btn-danger").off("click").text(n.anyway_text).click(function() {
                            u.modal("hide"), t();
                        }), u.modal("show");
                    });
                }, 1e3 * xe);
            }).fail(function() {
                o(), n.rollback_on_failure ? s.checkpoint_rollback(e) : s.checkpoint_destroy(e);
            })) : void t();
        });
    }
    function M(e) {
    ...
    function K() {
        ...
        var t, n, i;
        ee.translate(), t = new l(), n = new k(t), n.setup(), i = new M(t), i.setup(), J(new A()), 
        J(new H()), J(new j()), J(new L()), J(new B()), J(new Y()), J(new q()), J(new G()), 
        J(new V()), Z(ee).on("locationchanged", e), e();
    }
    var Z = n(2), ee = n(3), te = n(4), ne = n(5), ie = n(7), oe = n(11);
    n(15), n(16), n(18), n(19), n(20), n(21);
    var re = ee.gettext, ae = ee.gettext, se = ee.permission({
        admin: !0
    });
    Z(se).on("changed", m);
    var ce, le, de;
    k.prototype = {
        ...
        setup: function() {
            ...
            var n = this;
            m(), Z("#networking-add-bond").click(Z.proxy(this, "add_bond")), Z("#networking-add-team").click(Z.proxy(this, "add_team")), 
            Z("#networking-add-bridge").click(Z.proxy(this, "add_bridge")), Z("#networking-add-vlan").click(Z.proxy(this, "add_vlan")), 
            Z("#networking-add-team").hide(), ee.script("test -f /usr/bin/teamd && ( test -f /usr/lib64/NetworkManager/libnm-device-plugin-team.so ||   test -f /usr/lib/x86_64-linux-gnu/NetworkManager/libnm-device-plugin-team.so)", {
                err: "ignore"
            }).done(function() {
    ...
    M.prototype = {
        ...
        setup: function() {
            ...
            Z("#network-interface .breadcrumb a").on("click", function() {
                ee.location.go("/");
            }), Z("#network-interface-delete").click(Z.proxy(this, "delete_connections")), this.device_onoff = Z("#network-interface-delete-switch").onoff().on("change", function() {
        ...
        delete_connections: function() {
            ...
            function n(e) {
                return t(e.Device ? e.Device.AvailableConnections : e.Connections);
            }
            function i() {
        ...
        update: function() {
            ...
            function n(e, t) {
                ...
                function r() {
                    a.show_dialog(j, "#network-team-settings-dialog");
                }
                function s() {
                ...
                function m(e, t, n) {
                    ...
                    return 0 === i.length && i.push(re("Configure")), Z("<tr>").append(Z("<td>").text(e).css("vertical-align", t.length > 1 ? "top" : "center"), Z("<td>").append(Z('<a class="network-privileged">').append(i).click(function() {
                        n();
                    })));
                }
                function v(e, o) {
            ...
            function r(e) {
                ...
                a.tx_series.add_instance(a.dev_name), void Z("#network-interface-slaves").hide();
                ...
                e.Slaves.forEach(function(e) {
                    e.Interfaces.forEach(function(t) {
                        if (t.MainConnection == e) {
                            ...
                            }, "network-privileged")), Z('<td width="28px">').append(Z('<button class="btn btn-default btn-control-ct network-privileged fa fa-minus">').click(function() {
                ...
                var s = Z("<div>", {
                    ...
                    return N(t) && !i[t.Name] && t != a.iface ? Z('<li role="presentation">').append(Z('<a role="menuitem" class="network-privileged">').text(t.Name).click(function() {
                        y(a.model, function() {
                            var n = c(e);
            ...
            Z("#network-interface-mac").empty(), M ? Z("#network-interface-mac").append(Z("<a>").text(k).click(function() {
                a.set_mac();
            })) : Z("#network-interface-mac").text(k), this.device_onoff.onoff("disabled", !s), 
        ...
        enter: function() {
            Z("#network-ip-settings-error").hide(), this.settings = A.ghost_settings || A.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        ...
        apply: function() {
            function e() {
                return A.apply_settings(t.settings).then(function() {
                    if (Z("#network-ip-settings-dialog").modal("hide"), A.done) return A.done();
                }).fail(function(e) {
        ...
        enter: function() {
            Z("#network-bond-settings-error").hide(), this.settings = H.ghost_settings || H.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        ...
        update: function() {
            ...
            var o, c, l, d, u, f, p, h, g, m = this, v = H.model, _ = H.connection, x = m.settings.bond.options, b = m.settings.ethernet && m.settings.ethernet.assigned_mac_address || "", k = Z(ne.render(m.bond_settings_template, {
        ...
        apply: function() {
            function e() {
                return R(Z("#network-bond-settings-body"), H.model, H.apply_settings, H.connection, t.settings, "bond").then(function() {
                    if (Z("#network-bond-settings-dialog").modal("hide"), H.connection && ee.location.go([ t.settings.connection.interface_name ]), 
        ...
        enter: function() {
            Z("#network-team-settings-error").hide(), this.settings = j.ghost_settings || j.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        ...
        update: function() {
            ...
            var o, c, l, d, u, f, p, h = this, g = j.model, m = j.connection, v = h.settings.team.config;
        ...
        apply: function() {
            function e() {
                return R(Z("#network-team-settings-body"), j.model, j.apply_settings, j.connection, t.settings, "team").then(function() {
                    if (Z("#network-team-settings-dialog").modal("hide"), j.connection && ee.location.go([ t.settings.connection.interface_name ]), 
    ...
    !function(r, a) {
        ...
        function s(t, i) {
            ...
            i = i || e.tags, t = t || "", "string" == typeof i && (i = i.split(h));
            for (var s, u, f, g, x, b, k = a(i), w = new d(t), y = [], M = [], C = [], S = !1, T = !1; !w.eos(); ) {
                if (s = w.pos, f = w.scanUntil(k[0])) for (var I = 0, A = f.length; I < A; ++I) g = f.charAt(I), 
        ...
        var p = /\s*/, h = /\s+/, g = /\S/, m = /\s*=/, v = /\s*\}/, _ = /#|\^|\/|>|\{|&|=|!/, x = RegExp.prototype.test, b = Object.prototype.toString, k = Array.isArray || function(e) {
    ...
    a.plot = function(e, t, n) {
        ...
        var w, y, M = {}, C = {}, S = [], T = [], I = null, A = !1, D = 0, N = null, z = !1;
    ...
    !function(e) {
        ...
        function n(n, o, r, a) {
            ...
            function F(e) {
                e.lines.show && $(e), e.bars.show && H(e), e.points.show && R(e);
            }
            function $(e) {
            ...
            function R(e) {
                ...
                ce.lineWidth = n, ce.strokeStyle = e.color, t(e.datapoints, o, j(e.points, e.color), 0, !1, e.xaxis, e.yaxis, r), 
                ce.restore();
            }
    ...
    !function() {
        function t(e) {
            function t(e, t, n, i, r, s) {
                ...
                return i > 1 && (c.count = i), t < 4 && (c.warning = !0), o.render(a, c);
            }
            function n() {
                return u;
            }
        ...
        d.journalctl = function() {
            ...
            return void 0 === e ? c("[no data]") : "string" == typeof e ? e : void 0 !== e.length ? i.format(c("[$0 bytes of binary data]"), e.length) : c("[binary data]");
        };
