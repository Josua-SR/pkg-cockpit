!function(e) {
        ...
        var X, Q = {}, K = {
            ...
            prototype: {
                ...
                apply_settings: function(e) {
                    var t = this;
                    try {
                        return p(t, "org.freedesktop.NetworkManager.Settings.Connection", "Update", N(e, i(t).orig)).done(function() {
                            A(t, e);
                        });
                    } catch (e) {
                        return ee.reject(e);
            ...
            prototype: {
                ...
                activate_with_settings: function(e, t) {
                    try {
                        return p(a("/org/freedesktop/NetworkManager", X), "org.freedesktop.NetworkManager", "AddAndActivateConnection", N(e), f(this), f(t));
                    } catch (e) {
                        return ee.reject(e);
                    }
                },
    ...
    function y(e, t, n) {
        ...
        return n.hack_does_add_or_remove && !e.at_least_version("1.6") ? void t() : void s.checkpoint_create(n.devices || [], be).done(function(r) {
    ...
    function K() {
        ...
        var t, n, i;
        ee.translate(), t = new l(), n = new k(t), n.setup(), i = new M(t), i.setup(), J(new I()), 
    ...
    M.prototype = {
        ...
        update: function() {
            ...
            function n(e, t) {
                ...
                function s() {
                    L.master_settings = N, a.show_dialog(L, "#network-teamport-settings-dialog");
                }
                function c() {
                ...
                function M() {
                    ...
                    if (!N || !N.team || !N.team.config || !N.team.config.runner || "activebackup" != N.team.config.runner.name && "lacp" != N.team.config.runner.name) return null;
                ...
                if (!t) return [];
                var N = null;
                return e && e.Masters.length > 0 && (N = e.Masters[0].Settings), [ x(), g(), v("ipv4", re("IPv4")), v("ipv6", re("IPv6")), _(), T(), C(), S(), k(), y(), M() ];
            }
            function i() {
                var e = {
                    connection: {
            ...
            m(), a.main_connection && r(a.main_connection);
        }
    }, I.prototype = {
        _init: function() {
        ...
        enter: function() {
            Z("#network-ip-settings-error").hide(), this.settings = I.ghost_settings || I.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        ...
        apply: function() {
            function e() {
                return I.apply_settings(t.settings).then(function() {
                    if (Z("#network-ip-settings-dialog").modal("hide"), I.done) return I.done();
                }).fail(function(e) {
        ...
        apply: function() {
            ...
            j.connection ? S(j.model, e, {
                devices: t.slaves_changed ? [] : N(j.connection),
    ...
    !function(r, a) {
        ...
        function s(t, i) {
            ...
            for (var s, u, f, g, x, b, k = a(i), w = new d(t), y = [], M = [], C = [], S = !1, T = !1; !w.eos(); ) {
                if (s = w.pos, f = w.scanUntil(k[0])) for (var N = 0, I = f.length; N < I; ++N) g = f.charAt(N), 
    ...
    a.plot = function(e, t, n) {
        function i() {
            if (0 !== e.height() && 0 !== e.width()) {
                null === N && (N = o.plot(e, T, M)), N.setData(T);
                var t = N.getAxes();
                t.xaxis.options.min = y.beg * w, t.xaxis.options.max = (y.end - 2) * w, M.setup_hook && M.setup_hook(N), 
                t.xaxis.show = !0, t.xaxis.used = !0, t.yaxis.show = !0, t.yaxis.used = !0, N.setupGrid(), 
                N.draw();
            }
        }
        function a() {
        ...
        function l(e, t) {
            N && N.clearSelection(!0), w = 1e3 * Math.ceil(e / 1e3);
            var n;
        ...
        function u() {
            ...
            M = {}, S = [], T = [], N = null, o(e).empty(), o(e).data("flot_data", null);
        }
        function f() {
            0 !== e.height() && 0 !== e.width() && (N && N.resize(), a());
        }
        function p(e) {
            M = e, N = null;
        }
        ...
        function k(e, t) {
            N.clearSelection(!0), o(C).triggerHandler("zoom", [ (t.xaxis.to - t.xaxis.from) / 1e3, t.xaxis.to / 1e3 ]);
        }
        var w, y, M = {}, C = {}, S = [], T = [], N = null, I = !1, D = 0, A = null, z = !1;
