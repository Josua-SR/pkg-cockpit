!function(e) {
    ...
    y.prototype = {
        ...
        setup: function() {
            ...
            ne.script("test -f /usr/bin/teamd && ( test -f /usr/lib*/NetworkManager/libnm-device-plugin-team.so ||   test -f /usr/lib/*-linux-gnu/NetworkManager/libnm-device-plugin-team.so)", {
                err: "ignore"
            }).done(function() {
