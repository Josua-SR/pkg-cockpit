!function(e) {
    ...
    function l() {
        ...
        function p(e, t, n) {
            ...
            return U.call(f(e), t, n, Array.prototype.slice.call(arguments, 3)).fail(function(e) {
                i.reject(e);
            }).done(function(e) {
                i.resolve.apply(i, e);
            }), i.promise();
        ...
        function _() {
            function e() {
                ...
                ee($).trigger("changed"), V && (V.resolve(), V = null);
            }
        ...
        function x(e) {
            return [ ne.ip4_to_text(e[0]), ne.ip_prefix_to_text(e[1]), ne.ip4_to_text(e[2], !0) ];
        }
        function b(e) {
            return [ ne.ip4_from_text(e[0]), ne.ip4_prefix_from_text(e[1]), ne.ip4_from_text(e[2], !0) ];
        }
        function k(e) {
            return [ ne.ip4_to_text(e[0]), ne.ip_prefix_to_text(e[1]), ne.ip4_to_text(e[2], !0), ne.ip_metric_to_text(e[3]) ];
        }
        function w(e) {
            return [ ne.ip4_from_text(e[0]), ne.ip4_prefix_from_text(e[1]), ne.ip4_from_text(e[2], !0), ne.ip_metric_from_text(e[3]) ];
        }
        function y(e) {
            return [ ne.ip6_to_text(e[0]), ne.ip_prefix_to_text(e[1]), ne.ip6_to_text(e[2], !0) ];
        }
        function M(e) {
            return [ ne.ip6_from_text(e[0]), parseInt(e[1], 10) || 64, ne.ip6_from_text(e[2], !0) ];
        }
        function C(e) {
            return [ ne.ip6_to_text(e[0]), ne.ip_prefix_to_text(e[1]), ne.ip6_to_text(e[2], !0), ne.ip_metric_to_text(e[1]) ];
        }
        function S(e) {
            return [ ne.ip6_from_text(e[0]), ne.ip_prefix_from_text(e[1]), ne.ip6_from_text(e[2], !0), ne.ip_metric_from_text(e[3]) ];
        }
        function T(e) {
            function t(t, n, i) {
            ...
            return e.connection.master || (o.ipv4 = n("ipv4", x, k, ne.ip4_to_text), o.ipv6 = n("ipv6", y, C, ne.ip6_to_text)), 
        ...
        function I(e, t) {
            ...
            e.ipv4 ? i("ipv4", "aau", b, "aau", w, "au", ne.ip4_from_text) : delete o.ipv4, 
            e.ipv6 ? i("ipv6", "a(ayuay)", M, "a(ayuayu)", S, "aay", ne.ip6_from_text) : delete o.ipv6, 
        ...
        function D(e) {
            switch (e) {
              ...
              case 50:
                return ae("Configuring");

              case 60:
                return ae("Authenticating");

              case 70:
                return ae("Configuring IP");

              case 80:
                return ae("Checking IP");
        ...
        function z(t) {
            o(), U.call(f(t), "org.freedesktop.NetworkManager.Settings.Connection", "GetSettings").always(r).fail(e).done(function(e) {
                var n = e[0];
        ...
        var j = {};
        R.with_networkmanager_needs_root && (j.superuser = "try");
        var U = te.dbus("org.freedesktop.NetworkManager", j);
        $.client = U;
        var H, L = {}, B = 0, Y = {}, q = 0, V = null;
        $.synchronize = function() {
            return 0 === B ? te.resolve() : (V || (V = te.defer()), V.promise());
        }, U.call("/org/freedesktop/NetworkManager", "org.freedesktop.DBus.Properties", "Get", [ "org.freedesktop.NetworkManager", "State" ], {
            flags: ""
        }).fail(e).done(function(e, t) {
            t.flags && (t.flags.indexOf(">") !== -1 ? ne.set_byteorder("be") : t.flags.indexOf("<") !== -1 && ne.set_byteorder("le"));
        });
        var G = U.subscribe({}, g), J = U.watch({});
        ee(U).on("notify", function(e, t) {
            ...
            G.remove(), J.remove(), ee(U).off("notify"), U.close("unused");
        };
        var X, Q = {}, K = {
        ...
        }, h([ X, ce, re, K, Z, ie, oe ]), a("/org/freedesktop/NetworkManager", X), a("/org/freedesktop/NetworkManager/Settings", ce), 
        $;
    }
    function d(e) {
    ...
    function u(e) {
        return e ? 100 == e.State && e.Carrier === !1 ? ae("No carrier") : e.Managed || e.ActiveConnection || e.Ip4Config && 0 !== e.Ip4Config.Addresses.length || e.Ip6Config && 0 !== e.Ip6Config.Addresses.length ? e.StateText : ae("Inactive") : ae("Inactive");
    }
    function f(e) {
    ...
    function h(e, t, n) {
        ...
        var o, r = [];
        if (!e) return "";
        if (o = e.ActiveConnection, o && o.Master) return ee("<span>").append(ee("<span>").text(ae("Part of ")), t ? d(o.Master.Interface) : o.Master.Interface);
    ...
    function m(e) {
        return function(t) {
            var n = t.getAxes();
            ee(e).text(oe.bits_per_sec_tick_unit(n.yaxis));
        };
    }
    function v() {
        ee(".network-privileged").update_privileged(ce, te.format(ae("The user <b>$0</b> is not permitted to modify network settings"), ce.user ? ce.user.name : ""));
    }
    function _() {
        le || (de = {}, le = te.metrics(1e3, [ {
            source: "direct",
            metrics: [ {
            ...
            metrics_path_names: [ "rx", "tx" ]
        } ]), ue = te.grid(1e3, -1, -0), le.follow(), ue.walk());
    }
    function x(e) {
        de[e] = [ ue.add(le, [ "rx", e ]), ue.add(le, [ "tx", e ]) ];
    }
    function b(e, t) {
    ...
    function M(e, t, n) {
        ...
        return n.hack_does_add_or_remove ? void t() : void s.checkpoint_create(n.devices || [], ke).done(function(r) {
    ...
    function T(e, t, n) {
        M(e, t, ee.extend({
            fail_text: ae("Changing the settings will break the connection to the server, and will make the administration UI unavailable."),
            anyway_text: ae("Change the settings")
        }, n));
    }
    function I(e, t) {
    ...
    function W(e, t) {
        return ee('<ul class="list-group available-interfaces-group dialog-list-ct">').append(E(e, t).map(function(e) {
            return ee('<li class="list-group-item">').append(ee('<div class="checkbox">').css("margin", "0px").append(ee("<label>").append(ee("<input>", {
                type: "checkbox",
                "data-iface": e.Name
            }).prop("checked", !!P(t, e)), ee("<span>").text(e.Name))));
        }));
    }
    function F(e, t) {
        var n = [ {
    ...
    function R(e, t, n, i, o, r) {
        ...
        return s && s.Masters.indexOf(t) != -1 && $(s), !0;
    }
    ...
    function U(e, t, n) {
        ...
        }), i(ae("Permanent"), "permanent"), i(ae("Preserve"), "preserve"), i(ae("Random"), "random"), 
        i(ae("Stable"), "stable");
    }
    function H() {
        this._init();
    ...
    function Z() {
        function e() {
            ...
            t.synchronize().then(function() {
                0 === e.length ? (K(i), Q(n)) : 1 === e.length ? (K(n), Q(i, e[0])) : (console.warn("not a networking location: " + e), 
                te.location = ""), ee("body").show();
            });
        }
        var t, n, i;
        te.translate(), t = new l(), n = new w(t), n.setup(), i = new C(t), i.setup(), X(new D()), 
        X(new H()), X(new L()), X(new B()), X(new Y()), X(new q()), X(new V()), X(new G()), 
        X(new J()), ee(te).on("locationchanged", e), e();
    }
    var ee = n(2), te = n(3), ne = n(4), ie = n(5), oe = n(7), re = n(11);
    n(15), n(16), n(18), n(19), n(20), n(21);
    var ae = te.gettext, se = te.gettext;
    ee.fn.extend({
    ...
    w.prototype = {
        ...
        getTitle: function() {
            return se("page-title", "Networking");
        },
        setup: function() {
            function e(e, t) {
            ...
            function t() {
                for (var e in de) {
                    var t = de[e], n = t[0][0], i = t[1][0], o = ee('#networking-interfaces tr[data-sample-id="' + encodeURIComponent(e) + '"]');
            ...
            var i = {
                ...
                derive: "rate",
                threshold: 200
            }, o = oe.plot_simple_template();
            ee.extend(o.yaxis, {
                tickFormatter: oe.format_bits_per_sec_tick_no_unit
            }), ee.extend(o.grid, {
                hoverable: !0,
                autoHighlight: !1
            }), o.setup_hook = g, o.post_hook = m("#networking-rx-unit"), this.rx_plot = oe.plot(ee("#networking-rx-graph"), 300), 
            ...
            var r = {
                ...
                derive: "rate",
                threshold: 200
            }, a = oe.plot_simple_template();
            ee.extend(a.yaxis, {
                tickFormatter: oe.format_bits_per_sec_tick_no_unit
            }), ee.extend(a.grid, {
                hoverable: !0,
                autoHighlight: !1
            }), a.setup_hook = g, a.post_hook = m("#networking-tx-unit"), this.tx_plot = oe.plot(ee("#networking-tx-graph"), 300), 
            ...
            var s = oe.setup_plot_controls(ee("#networking"), ee("#networking-graph-toolbar"));
            s.reset([ this.rx_plot, this.tx_plot ]), _(), ee(ue).on("notify", function(e, n, i) {
                t();
        ...
        enter: function() {
            this.log_box = re.logbox([ "_SYSTEMD_UNIT=NetworkManager.service", "_SYSTEMD_UNIT=firewalld.service" ], 10), 
    ...
    var fe = [ {
        ...
        choice: "balance-rr",
        title: ae("Round Robin")
    }, {
        choice: "active-backup",
        title: ae("Active Backup")
    }, {
        choice: "balance-xor",
        title: ae("XOR")
    }, {
        ...
        choice: "balance-tlb",
        title: ae("Adaptive transmit load balancing")
    }, {
        choice: "balance-alb",
        title: ae("Adaptive load balancing")
    } ], ge = [ {
        choice: "mii",
        title: ae("MII (Recommended)")
    }, {
        choice: "arp",
        title: ae("ARP")
    } ], me = [ {
        ...
        choice: "loadbalance",
        title: ae("Load Balancing")
    }, {
        choice: "broadcast",
        title: ae("Broadcast")
    }, {
        choice: "lacp",
        title: ae("802.3ad LACP")
    } ], ve = [ {
        choice: "none",
        title: ae("Passive")
    }, {
    ...
    C.prototype = {
        ...
        setup: function() {
            ...
            function t() {
                for (var e in de) {
                    var t = de[e], n = t[0][0], i = t[1][0], o = ee('#network-interface-slaves tr[data-sample-id="' + encodeURIComponent(e) + '"]');
            ...
            ee.extend(o.yaxis, {
                ...
                hoverable: !0,
                autoHighlight: !1
            }), o.setup_hook = g, o.post_hook = m("#network-interface-rx-unit"), this.rx_plot = oe.plot(ee("#network-interface-rx-graph"), 300), 
            this.rx_plot.set_options(o), this.rx_series = this.rx_plot.add_metrics_stacked_instances_series(i, {}), 
            this.rx_plot.start_walking(), ee(this.rx_series).on("hover", e);
            var r = {
                direct: "network.interface.out.bytes",
            ...
            ee.extend(a.yaxis, {
                ...
                hoverable: !0,
                autoHighlight: !1
            }), a.setup_hook = g, a.post_hook = m("#network-interface-tx-unit"), this.tx_plot = oe.plot(ee("#network-interface-tx-graph"), 300), 
            this.tx_plot.set_options(a), this.tx_series = this.tx_plot.add_metrics_stacked_instances_series(r, {}), 
            this.tx_plot.start_walking(), ee(this.tx_series).on("hover", e), ee(te).on("resize", function() {
                n.rx_plot.resize(), n.tx_plot.resize();
            });
            var s = oe.setup_plot_controls(ee("#network-interface"), ee("#network-interface-graph-toolbar"));
            s.reset([ this.rx_plot, this.tx_plot ]), _(), ee(ue).on("notify", function(e, n, i) {
                t();
            }), ee(window).on("resize", function() {
                n.rx_plot.resize(), n.tx_plot.resize();
        ...
        delete_connections: function() {
            ...
            r.iface && M(r.model, i, {
                devices: r.dev ? [ r.dev ] : [],
                fail_text: te.format(ae("Deleting <b>$0</b> will break the connection to the server, and will make the administration UI unavailable."), r.dev_name),
                anyway_text: te.format(ae("Delete $0"), r.dev_name),
        ...
        connect: function() {
            ...
            return n.main_connection || n.dev && n.ghost_settings ? void M(n.model, t, {
                devices: n.dev ? [ n.dev ] : [],
                fail_text: te.format(ae("Switching on <b>$0</b> will break the connection to the server, and will make the administration UI unavailable."), n.dev_name),
                anyway_text: te.format(ae("Switch on $0"), n.dev_name)
            }) : void n.update();
        },
        disconnect: function() {
            function e() {
            ...
            return t.dev ? void M(t.model, e, {
                devices: [ t.dev ],
                fail_text: te.format(ae("Switching off <b>$0</b>  will break the connection to the server, and will make the administration UI unavailable."), t.dev_name),
                anyway_text: te.format(ae("Switch off $0"), t.dev_name)
            }) : (console.log("Trying to switch off without a device?"), void t.update());
        },
        update: function() {
            function e() {
                return l && void 0 !== l.Carrier ? ee("<tr>").append(ee("<td>").text(ae("Carrier")), ee("<td>").append(l.Carrier ? l.Speed ? te.format_bits_per_sec(1e6 * l.Speed) : ae("Yes") : ae("No"))) : null;
            }
            function t() {
                var e;
                return a.main_connection && a.main_connection.Masters.length > 0 ? null : (e = l ? d && 100 != l.State ? l.StateText : null : ae("Inactive"), 
                ee("<tr>").append(ee("<td>").text(ae("Status")), ee("<td>").append(h(l, !0, !1), " ", e ? ee("<span>").text(e) : null)));
            }
            function n(e, t) {
                function n(e) {
                    var n = t[e], i = [];
                    "manual" != n.method && i.push(y("ipv4" == e ? fe : pe, n.method, ae("Unknown configuration")));
                    var o = "manual" != n.method, r = [];
                    n.addresses.forEach(function(e) {
                        var t = e[0] + "/" + e[1];
                        e[2] && "0.0.0.0" != e[2] && "0:0:0:0:0:0:0:0" != e[2] && (t += " via " + e[2]), 
                        r.push(t);
                    }), r.length > 0 && i.push(te.format(ae(o ? "Additional address $val" : "Address $val"), {
                        val: r.join(", ")
                    }));
                    var a = !n["ignore-auto-dns"] && "manual" != n.method;
                    return n.dns.length > 0 && i.push(te.format(ae(a ? "Additional DNS $val" : "DNS $val"), {
                        val: n.dns.join(", ")
                    })), n.dns_search.length > 0 && i.push(te.format(ae(a ? "Additional DNS Search Domains $val" : "DNS Search Domains $val"), {
                        val: n.dns_search.join(", ")
                    })), i;
                }
                function i(e) {
                    D.topic = e, a.show_dialog(D, "#network-ip-settings-dialog");
                }
                function o() {
                ...
                function s() {
                    B.master_settings = I, a.show_dialog(B, "#network-teamport-settings-dialog");
                }
                function c() {
                ...
                function g() {
                    if (void 0 !== t.connection.autoconnect) return ee("<tr>").append(ee("<td>").text(ae("General")), ee('<td class="networking-controls">').append(ee("<label>").append(ee('<input type="checkbox">').prop("checked", t.connection.autoconnect).change(function() {
                        t.connection.autoconnect = ee(this).prop("checked"), k(a.model, a.dev, e)(t);
                    }), ee("<span>").text(ae("Connect automatically")))));
                }
                function m(e, t, n) {
                    for (var i = [], o = 0; o < t.length; o++) i.push(t[o]), o < t.length - 1 && i.push(ee("<br>"));
                    return 0 === i.length && i.push(ae("Configure")), ee("<tr>").append(ee("<td>").text(e).css("vertical-align", t.length > 1 ? "top" : "center"), ee("<td>").append(ee('<a class="network-privileged">').append(i).syn_click(a.model, function() {
                        n();
                    })));
                }
                function v(e, o) {
                ...
                function _() {
                    ...
                    var n = [], i = t.ethernet;
                    return i ? (i.mtu ? e(ae("$mtu"), i) : e(ae("Automatic"), i), m(ae("MTU"), n, h)) : null;
                }
                function x() {
                    return e && e.Masters.length > 0 ? ee("<tr>").append(ee("<td>").text(ae("Master")), ee("<td>").append(p(e.Masters.map(f), ", "))) : null;
                }
                function b() {
                    var e, n = [], i = [];
                    return t.bond ? (e = t.bond.options, n.push(y(he, e.mode, e.mode)), e.arp_interval && n.push(ae("ARP Monitoring")), 
                    n.length > 0 && i.push(n.join(", ")), m(ae("Bond"), i, o)) : null;
                }
                function w() {
                    var e = [], n = [];
                    if (!t.team) return null;
                    var i = t.team.config;
                    return null === i ? e.push(ae("Broken configuration")) : (i.runner && e.push(y(me, i.runner.name, i.runner.name)), 
                    i.link_watch && "ethtool" != i.link_watch.name && e.push(y(_e, i.link_watch.name, i.link_watch.name))), 
                    e.length > 0 && n.push(e.join(", ")), m(ae("Team"), n, r);
                }
                function M() {
                    var e = [], n = [];
                    ...
                    return null === i && e.push(ae("Broken configuration")), e.length > 0 && n.push(e.join(", ")), 
                    m(ae("Team Port"), n, s);
                }
                function C() {
                    function e(e, t) {
                    ...
                    var n = [], i = t.bridge;
                    return i ? (i.stp && (e(ae("Spanning Tree Protocol")), 32768 != i.priority && e(ae("Priority $priority"), i), 
                    15 != i.forward_delay && e(ae("Forward delay $forward_delay"), i), 2 != i.hello_time && e(ae("Hello time $hello_time"), i), 
                    20 != i.max_age && e(ae("Maximum message age $max_age"), i)), m(ae("Bridge"), n, c)) : null;
                }
                function S() {
                    function e(e, t) {
                        n.push(te.format(e, t));
                    ...
                    return i ? (32 != i.priority && e(ae("Priority $priority"), i), 100 != i.path_cost && e(ae("Path cost $path_cost"), i), 
                    i.hairpin_mode && e(ae("Hairpin mode")), m(ae("Bridge port"), n, l)) : null;
                }
                function T() {
                    function e(e, t) {
                        n.push(te.format(e, t));
                    ...
                    var n = [], i = t.vlan;
                    return i ? (e(ae("Parent $parent"), i), e(ae("Id $id"), i), m(ae("VLAN"), n, u)) : null;
                }
                if (!d) return ee("<tr>").append(ee("<td>"), ee("<td>").text(ae("This device cannot be managed here.")));
                if (!t) return [];
                var I = null;
                return e && e.Masters.length > 0 && (I = e.Masters[0].Settings), [ x(), g(), v("ipv4", ae("IPv4")), v("ipv6", ae("IPv6")), _(), T(), C(), S(), b(), w(), M() ];
            }
            function i() {
                var e = {
                    connection: {
            ...
            function r(e) {
                ...
                ee("#network-interface-slaves thead th:first-child").text(ae("bond" == r.type ? "Members" : "Ports")), 
                e.Slaves.forEach(function(e) {
                    e.Interfaces.forEach(function(t) {
                        if (t.MainConnection == e) {
                            ...
                            x(t.Name), i[t.Name] = !0, n[t.Name] = ee("<tr>", {
                                "data-interface": encodeURIComponent(t.Name),
                                "data-sample-id": s ? encodeURIComponent(t.Name) : null
                            }).append(ee("<td>").text(t.Name), s ? [ ee("<td>").text(""), ee("<td>").text("") ] : ee('<td colspan="2">').text(u(r)), ee('<td class="networking-row-configure">').append(S(!(!r || !r.ActiveConnection), function(n) {
                                n ? M(a.model, function() {
                                    return e.activate(r).fail(o);
                                }, {
                                    devices: r ? [ r ] : [],
                                    fail_text: te.format(ae("Switching on <b>$0</b> will break the connection to the server, and will make the administration UI unavailable."), t.Name),
                                    anyway_text: te.format(ae("Switch on $0"), t.Name)
                                }) : r && M(a.model, function() {
                                    return r.disconnect().fail(o);
                                }, {
                                    devices: [ r ],
                                    fail_text: te.format(ae("Switching off <b>$0</b> will break the connection to the server, and will make the administration UI unavailable."), t.Name),
                                    anyway_text: te.format(ae("Switch off $0"), t.Name)
                                });
                                ...
                                return M(a.model, function() {
                                    ...
                                    devices: r ? [ r ] : [],
                                    fail_text: te.format(ae("Removing <b>$0</b> will break the connection to the server, and will make the administration UI unavailable."), t.Name),
                                    anyway_text: te.format(ae("Remove $0"), t.Name),
                                    hack_does_add_or_remove: !0
                                }), !1;
                            }))).click(function(e) {
                ...
                var s = ee("<div>", {
                    ...
                    return z(t) && !i[t.Name] && t != a.iface ? ee('<li role="presentation">').append(ee('<a role="menuitem" class="network-privileged">').text(t.Name).syn_click(a.model, function() {
                        M(a.model, function() {
                            ...
                            fail_text: te.format(ae("Adding <b>$0</b> will break the connection to the server, and will make the administration UI unavailable."), t.Name),
                            anyway_text: te.format(ae("Add $0"), t.Name),
                            hack_does_add_or_remove: !0
                        });
                    })) : null;
                })));
            ...
            a.iface = s, a.dev = l;
            var g, m;
            l ? g = "ethernet" == l.DeviceType || l.IdVendor || l.IdModel ? te.format("$IdVendor $IdModel $Driver", l) : "bond" == l.DeviceType ? ae("Bond") : "team" == l.DeviceType ? ae("Team") : "vlan" == l.DeviceType ? ae("VLAN") : "bridge" == l.DeviceType ? ae("Bridge") : te.format(ae('Unknown "$0"'), l.DeviceType) : s ? (m = c(s.Connections[0]), 
            g = "bond" == m.type ? ae("Bond") : "team" == m.type ? ae("Team") : "vlan" == m.type ? ae("VLAN") : "bridge" == m.type ? ae("Bridge") : m.type ? te.format(ae('Unknown "$0"'), m.type) : ae("Unknown")) : g = ae("Unknown"), 
            ...
            var C = s && !l || l && ("bond" == l.DeviceType || "team" == l.DeviceType || "vlan" == l.DeviceType || "bridge" == l.DeviceType);
            ee("#network-interface-delete").toggle(C && d), a.ghost_settings = null, a.main_connection = null, 
        ...
        enter: function() {
            ee("#network-ip-settings-error").hide(), this.settings = D.ghost_settings || D.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        update: function() {
            ...
            function t(e, t) {
                var n, i = ee("<span>").append(ee('<span class="inverted-switchbox">').text(e), n = S(!m[t], function(e) {
                    m[t] = !e, h.update();
                }));
            ...
            function i() {
                var i = ae("ipv4" == g ? "Prefix length or Netmask" : "Prefix length"), r = ee("<div>").append(s = n(ae("Addresses"), "addresses", [ "Address", i, "Gateway" ], [ "", "", "" ], o = e("method", "ipv4" == g ? fe : pe).css("display", "inline-block")), ee("<br>"), l = n(ae("DNS"), "dns", "Server", "", c = t(ae("Automatic"), "ignore_auto_dns")), ee("<br>"), u = n(ae("DNS Search Domains"), "dns_search", "Search Domain", "", d = t(ae("Automatic"), "ignore_auto_dns")), ee("<br>"), p = n(ae("Routes"), "routes", [ "Address", i, "Gateway", "Metric" ], [ "", "", "", "" ], f = t(ae("Automatic"), "ignore_auto_routes")));
                return r;
            }
            var o, s, c, l, d, u, f, p, h = this, g = D.topic, m = h.settings[g];
            ...
            _ || (m.addresses = [], m.dns = [], m.dns_search = []), v && (m.routes = []), ee("#network-ip-settings-dialog .modal-title").text(ae("ipv4" == g ? "IPv4 Settings" : "IPv6 Settings")), 
        ...
        apply: function() {
            function e() {
                return D.apply_settings(t.settings).then(function() {
                    if (ee("#network-ip-settings-dialog").modal("hide"), D.done) return D.done();
                }).fail(function(e) {
                    I("#network-ip-settings-error", e);
                });
            }
            var t = this;
            T(D.model, e, {
                devices: N(D.connection)
            });
        }
    }, H.prototype = {
        _init: function() {
            this.id = "network-bond-settings-dialog", this.bond_settings_template = ee("#network-bond-settings-template").html(), 
            ie.parse(this.bond_settings_template);
        },
        setup: function() {
        ...
        find_slave_con: function(e) {
            return H.connection ? O(H.connection.Slaves, function(t) {
        ...
        update: function() {
            ...
            var o, c, l, d, u, f, p, h, g, m = this, v = H.model, _ = H.connection, x = m.settings.bond.options, b = m.settings.ethernet && m.settings.ethernet.assigned_mac_address || "", k = ee(ie.render(m.bond_settings_template, {
            ...
            }), k.find("#network-bond-settings-members").append(o = W(v, _).change(e)), U(k.find("#network-bond-settings-mac-menu"), c = k.find("#network-bond-settings-mac-input"), v), 
            c.change(t), k.find("#network-bond-settings-mode-select").append(l = r(n, he, "form-control")), 
            k.find("#network-bond-settings-primary-select").append(d = F(n, o, "form-control")), 
            k.find("#network-bond-settings-link-monitoring-select").append(u = r(i, ge, "form-control")), 
        ...
        apply: function() {
            function e() {
                return j(ee("#network-bond-settings-body"), H.model, H.apply_settings, H.connection, t.settings, "bond").then(function() {
                    ...
                    I("#network-bond-settings-error", e);
                });
            }
            var t = this;
            H.connection ? T(H.model, e, {
                devices: t.slaves_changed ? [] : N(H.connection),
                hack_does_add_or_remove: t.slaves_changed,
                rollback_on_failure: t.slaves_changed
            }) : M(H.model, e, {
                fail_text: ae("Creating this bond will break the connection to the server, and will make the administration UI unavailable."),
                anyway_text: ae("Create it"),
                hack_does_add_or_remove: !0,
                rollback_on_failure: !0
            });
        }
        ...
        _init: function() {
            ...
            ie.parse(this.team_settings_template);
        },
        setup: function() {
        ...
        update: function() {
            ...
            var _ = ee(ie.render(h.team_settings_template, {
            ...
            }), _.find("#network-team-settings-members").append(W(g, m).change(e)), _.find("#network-team-settings-runner-select").append(o = r(t, me, "form-control")), 
            _.find("#network-team-settings-balancer-select").append(c = r(n, ve, "form-control")), 
            _.find("#network-team-settings-link-watch-select").append(l = r(i, _e, "form-control")), 
        ...
        apply: function() {
            function e() {
                return j(ee("#network-team-settings-body"), L.model, L.apply_settings, L.connection, t.settings, "team").then(function() {
                    ...
                    I("#network-team-settings-error", e);
                });
            }
            var t = this;
            L.connection ? T(L.model, e, {
                ...
                fail_text: ae("Creating this team will break the connection to the server, and will make the administration UI unavailable."),
                anyway_text: ae("Create it"),
                hack_does_add_or_remove: !0,
                rollback_on_failure: !0
            });
        ...
        _init: function() {
            ...
            ie.parse(this.team_port_settings_template);
        },
        setup: function() {
        ...
        update: function() {
            ...
            var c = ee(ie.render(r.team_port_settings_template, s));
        ...
        leave: function() {},
        find_slave_con: function(e) {
            return Y.connection ? O(Y.connection.Slaves, function(t) {
                return t.Interfaces.indexOf(e) >= 0;
            }) || null : null;
        },
        update: function() {
            ...
            var n, i, o, r, a, s = this, c = Y.model, l = Y.connection, d = s.settings.bridge, u = ee(ie.render(s.bridge_settings_template, {
            ...
            }), u.find("#network-bridge-settings-slave-interfaces").append(W(c, l).change(e)).parent().toggle(!l), 
        ...
        apply: function() {
            function e() {
                return j(ee("#network-bridge-settings-body"), Y.model, Y.apply_settings, Y.connection, t.settings, "bridge").then(function() {
            ...
            var t = this;
            Y.connection ? T(Y.model, e, {
                devices: t.slaves_changed ? [] : N(Y.connection),
                hack_does_add_or_remove: t.slaves_changed,
                rollback_on_failure: t.slaves_changed
            }) : M(Y.model, e, {
                fail_text: ae("Creating this bridge will break the connection to the server, and will make the administration UI unavailable."),
                anyway_text: ae("Create it"),
                hack_does_add_or_remove: !0,
                rollback_on_failure: !0
            });
        ...
        _init: function() {
            ...
            ie.parse(this.bridge_port_settings_template);
        },
        setup: function() {
        ...
        update: function() {
            ...
            var t, n, i, o = this, r = o.settings.bridge_port, a = ee(ie.render(o.bridge_port_settings_template, {
                priority: r.priority,
        ...
        update: function() {
            ...
            l.list_interfaces().forEach(function(e) {
                !A(e, V.connection) && z(e) && f.push({
                    title: e.Name,
                    choice: e.Name
                });
            });
            var p = ee(ie.render(c.vlan_settings_template, {
                vlan_id: d.id || "1",
        ...
        apply: function() {
            function e() {
                return V.apply_settings(t.settings).then(function() {
                    ...
                    I("#network-vlan-settings-error", e);
                });
            }
            ...
            V.connection ? T(n, e, {
                ...
                fail_text: ae("Creating this VLAN will break the connection to the server, and will make the administration UI unavailable."),
                anyway_text: ae("Create it"),
                hack_does_add_or_remove: !0
            });
        }
        ...
        _init: function() {
            ...
            ie.parse(this.ethernet_settings_template);
        },
        setup: function() {
        ...
        leave: function() {},
        update: function() {
            var e = this, t = e.settings.ethernet, n = ee(ie.render(e.ethernet_settings_template, t));
        ...
        apply: function() {
            function e(e) {
                I("#network-mtu-settings-error", e);
            }
            function t() {
            ...
            if (ee("#network-mtu-settings-auto").prop("checked")) n.settings.ethernet.mtu = 0; else {
                ...
                if (!/^[0-9]+$/.test(o)) return void e(ae("MTU must be a positive number"));
                n.settings.ethernet.mtu = parseInt(o, 10);
            }
            T(i, t, {
                devices: N(G.connection)
            });
        }
    }, J.prototype = {
        _init: function() {
        ...
        update: function() {
            var e = this, t = e.settings.ethernet, n = ee(ie.render(e.ethernet_settings_template, t));
            ee("#network-mac-settings-body").html(n), U(ee("#network-mac-settings-menu"), ee("#network-mac-settings-input"), J.model);
        },
        cancel: function() {
        ...
        apply: function() {
            function e(e) {
                I("#network-mac-settings-error", e);
            }
            function t() {
    ...
    !function(n, a) {
        ...
        function c(t, n) {
            ...
            function r(e) {
                if ("string" == typeof e && (e = e.split(b, 2)), !g(e) || 2 !== e.length) throw new Error("Invalid tags: " + e);
                s = new RegExp(i(e[0]) + "\\s*"), c = new RegExp("\\s*" + i(e[1])), f = new RegExp("\\s*" + i("}" + e[1]));
            }
            if (!t) return [];
            var s, c, f, p = [], h = [], m = [], v = !1, _ = !1;
            r(n || e.tags);
            for (var M, C, S, T, I, N, D = new u(t); !D.eos(); ) {
                if (M = D.pos, S = D.scanUntil(s)) for (var A = 0, z = S.length; A < z; ++A) T = S.charAt(A), 
                a(T) ? m.push(h.length) : _ = !0, h.push([ "text", T, M, M + 1 ]), M += 1, "\n" === T && o();
                if (!D.scan(s)) break;
                if (v = !0, C = D.scan(y) || "name", D.scan(x), "=" === C ? (S = D.scanUntil(k), 
                D.scan(k), D.scanUntil(c)) : "{" === C ? (S = D.scanUntil(f), D.scan(w), D.scanUntil(c), 
                C = "&") : S = D.scanUntil(c), !D.scan(c)) throw new Error("Unclosed tag at " + D.pos);
                if (I = [ C, S, M, D.pos ], h.push(I), "#" === C || "^" === C) p.push(I); else if ("/" === C) {
                    if (N = p.pop(), !N) throw new Error('Unopened section "' + S + '" at ' + M);
                    if (N[1] !== S) throw new Error('Unclosed section "' + N[1] + '" at ' + M);
                } else "name" === C || "{" === C || "&" === C ? _ = !0 : "=" === C && r(S);
            }
    ...
    a.plot = function(e, t, n) {
        function i() {
            if (0 !== e.height() && 0 !== e.width()) {
                ...
                I.draw(), M.post_hook && M.post_hook(I);
            }
        }
        function a() {
    ...
    !function(e) {
        ...
        function n(n, o, r, a) {
            ...
            function F(e) {
                e.lines.show && $(e), e.bars.show && U(e), e.points.show && R(e);
            }
            function $(e) {
            ...
            function j(e, t, n, i, o, r, a, s, c, l, d) {
            ...
            function U(e) {
                function t(t, n, i, o, r, a) {
                    for (var s = t.points, c = t.pointsize, l = 0; l < s.length; l += c) null != s[l] && j(s[l], s[l + 1], s[l + 2], n, i, o, r, a, ce, e.bars.horizontal, e.bars.lineWidth);
                }
            ...
            function te(t, n) {
                ...
                le.lineWidth = t.bars.lineWidth, le.strokeStyle = o, j(n[0], n[1], n[2] || 0, i, i + t.bars.barWidth, function() {
                    return r;
