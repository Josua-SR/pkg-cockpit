!function(e) {
    ...
    function o(e) {
        var t = e.message || e || "???";
        console.warn(t), ee("#error-popup-message").text(t), ee('.modal[role="dialog"]').modal("hide"), 
        ee("#error-popup").modal("show");
    }
    function r(e, t, n) {
        function i(e) {
            return ee("<li>", {
                value: e.choice
            }).append(ee("<a>").text(e.title));
        }
        function o(e) {
            ee("button span", c).text(ee("li[value='" + e + "']", c).text()), a = e;
        }
        function r() {
            return a;
        }
        var a = t[0].choice, s = ee('<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">').append(ee('<span class="pull-left"></span>'), ee('<div class="caret"></div>')), c = ee('<div class="btn-group bootstrap-select dropdown">').append(s, ee('<ul class="dropdown-menu">').append(t.map(i)));
        return c.on("click", "li", function() {
            a = ee(this).attr("value"), o(a), e(a);
        }), o(a), ee.data(c[0], "cockpit-select-btn-funcs", {
            select: o,
            selected: r
        }), n && c.addClass(n), c;
    }
    function a(e, t) {
        ee.data(e[0], "cockpit-select-btn-funcs").select(t);
    }
    function s(e) {
        return ee.data(e[0], "cockpit-select-btn-funcs").selected();
    }
    function c(e) {
    ...
    function l() {
        ...
        function p(e, t, n) {
            var i = new ee.Deferred();
            return $.call(f(e), t, n, Array.prototype.slice.call(arguments, 3)).fail(function(e) {
                i.reject(e);
            }).done(function(e) {
                i.resolve.apply(i, e);
            }), i.promise();
        ...
        function _() {
            function e() {
                ...
                ee(W).trigger("changed"), V && (V.resolve(), V = null);
            }
        ...
        function b(e) {
            return [ ie.ip4_to_text(e[0]), ie.ip_prefix_to_text(e[1]), ie.ip4_to_text(e[2], !0) ];
        }
        function x(e) {
            return [ ie.ip4_from_text(e[0]), ie.ip4_prefix_from_text(e[1]), ie.ip4_from_text(e[2], !0) ];
        }
        function k(e) {
            return [ ie.ip4_to_text(e[0]), ie.ip_prefix_to_text(e[1]), ie.ip4_to_text(e[2], !0), ie.ip_metric_to_text(e[3]) ];
        }
        function w(e) {
            return [ ie.ip4_from_text(e[0]), ie.ip4_prefix_from_text(e[1]), ie.ip4_from_text(e[2], !0), ie.ip_metric_from_text(e[3]) ];
        }
        function y(e) {
            return [ ie.ip6_to_text(e[0]), ie.ip_prefix_to_text(e[1]), ie.ip6_to_text(e[2], !0) ];
        }
        function S(e) {
            return [ ie.ip6_from_text(e[0]), parseInt(e[1], 10) || 64, ie.ip6_from_text(e[2], !0) ];
        }
        function M(e) {
            return [ ie.ip6_to_text(e[0]), ie.ip_prefix_to_text(e[1]), ie.ip6_to_text(e[2], !0), ie.ip_metric_to_text(e[1]) ];
        }
        function C(e) {
            return [ ie.ip6_from_text(e[0]), ie.ip_prefix_from_text(e[1]), ie.ip6_from_text(e[2], !0), ie.ip_metric_from_text(e[3]) ];
        }
        function D(e) {
            function t(t, n, i) {
            ...
            return e.connection.master || (o.ipv4 = n("ipv4", b, k, ie.ip4_to_text), o.ipv6 = n("ipv6", y, M, ie.ip6_to_text)), 
            e["802-3-ethernet"] && (o.ethernet = {
                mtu: t("802-3-ethernet", "mtu"),
                assigned_mac_address: t("802-3-ethernet", "assigned-mac-address")
            }), e.bond && (o.bond = {
                options: ee.extend({}, t("bond", "options", {})),
        ...
        function T(e, t) {
            function n(e, t, n, i, r) {
                void 0 === i && (i = r), o[e] || (o[e] = {}), void 0 !== i ? o[e][t] = te.variant(n, i) : delete o[e][t];
            }
            ...
            e.ipv4 ? i("ipv4", "aau", x, "aau", w, "au", ie.ip4_from_text) : delete o.ipv4, 
            e.ipv6 ? i("ipv6", "a(ayuay)", S, "a(ayuayu)", C, "aay", ie.ip6_from_text) : delete o.ipv6, 
        ...
        function I(e) {
            switch (e) {
              ...
              case 50:
                return se("Configuring");

              case 60:
                return se("Authenticating");

              case 70:
                return se("Configuring IP");

              case 80:
                return se("Checking IP");
        ...
        function z(t) {
            o(), $.call(f(t), "org.freedesktop.NetworkManager.Settings.Connection", "GetSettings").always(r).fail(e).done(function(e) {
                var n = e[0];
                n && (i(t).orig = n, N(t, D(n)));
            });
        }
        function E(e) {
            0 === e.Udi.indexOf("/sys/") && (o(), te.spawn([ "udevadm", "info", e.Udi ], {
                err: "message"
            }).done(function(t) {
                function n(e, t, n) {
                    var o = "E: " + t + "=";
        ...
        var W = this, R = {};
        te.manifests.network && te.manifests.network.hacks && (R = te.manifests.network.hacks);
        var U = {};
        R.with_networkmanager_needs_root && (U.superuser = "try");
        var $ = te.dbus("org.freedesktop.NetworkManager", U);
        W.client = $;
        var H, L = {}, B = 0, Y = {}, q = 0, V = null;
        W.synchronize = function() {
            return 0 === B ? te.resolve() : (V || (V = te.defer()), V.promise());
        }, $.call("/org/freedesktop/NetworkManager", "org.freedesktop.DBus.Properties", "Get", [ "org.freedesktop.NetworkManager", "State" ], {
            flags: ""
        }).fail(e).done(function(e, t) {
            t.flags && (t.flags.indexOf(">") !== -1 ? ie.set_byteorder("be") : t.flags.indexOf("<") !== -1 && ie.set_byteorder("le"));
        });
        var G = $.subscribe({}, g), J = $.watch({});
        ee($).on("notify", function(e, t) {
            ...
            G.remove(), J.remove(), ee($).off("notify"), $.close("unused");
        };
        var X, Q = {}, Z = {
            ...
            prototype: {
                copy_settings: function() {
                    return ee.extend(!0, {}, this.Settings);
                },
                apply_settings: function(e) {
                    var t = this;
                    try {
                        return p(t, "org.freedesktop.NetworkManager.Settings.Connection", "Update", T(e, i(t).orig)).done(function() {
                            N(t, e);
                        });
                    } catch (e) {
                        return te.reject(e);
            ...
            exporters: [ function(e) {
                ...
                var n, i, o = c(e);
                o.slave_type && (n = Q[o.master], n ? (e.Masters.push(n), n.Slaves.push(e)) : (i = j(o.master), 
            ...
            prototype: {
                ...
                activate_with_settings: function(e, t) {
                    try {
                        return p(a("/org/freedesktop/NetworkManager", X), "org.freedesktop.NetworkManager", "AddAndActivateConnection", T(e), f(this), f(t));
                    } catch (e) {
                        return te.reject(e);
                    }
                },
            ...
            prototype: {
                add_connection: function(e) {
                    var t = ee.Deferred();
                    try {
                        p(this, "org.freedesktop.NetworkManager.Settings", "AddConnection", T(e, {})).done(function(e) {
                            t.resolve(a(e, ne));
                        }).fail(function(e) {
                            t.reject(e);
                        });
            ...
            exporters: [ null, function(e) {
                e.Connections && e.Connections.forEach(function(e) {
                    function t(t) {
                        if (t) {
                            var n = O(t)._NonDeviceConnections;
        ...
        return X = {
            ...
            prototype: {
                ...
                checkpoint_destroy: function(e) {
                    return e ? p(this, "org.freedesktop.NetworkManager", "CheckpointDestroy", e) : ee.when();
                },
                checkpoint_rollback: function(e) {
                    return e ? p(this, "org.freedesktop.NetworkManager", "CheckpointRollback", e) : ee.when();
                }
            },
            exporters: [ null, function(e) {
            ...
            conv: n(t(re)),
            def: []
        }, W.list_interfaces = function() {
            var e, t, n = [];
            for (e in L) t = L[e], i(t).type === ae && n.push(t);
            return n.sort(function(e, t) {
                return e.Name.localeCompare(t.Name);
            });
        }, W.find_interface = j, W.get_manager = function() {
            return a("/org/freedesktop/NetworkManager", X);
        }, W.get_settings = function() {
            return a("/org/freedesktop/NetworkManager/Settings", ce);
        }, W.at_least_version = function(e) {
            return P(W.get_manager().Version, e) >= 0;
        }, h([ X, ce, re, Z, K, ne, oe ]), a("/org/freedesktop/NetworkManager", X), a("/org/freedesktop/NetworkManager/Settings", ce), 
        W;
    }
    function d(e) {
        return ee("<a>").text(e).click(function() {
            te.location.go([ e ]);
        });
    }
    function u(e) {
        return e ? 100 == e.State && e.Carrier === !1 ? se("No carrier") : e.Managed || e.ActiveConnection || e.Ip4Config && 0 !== e.Ip4Config.Addresses.length || e.Ip6Config && 0 !== e.Ip6Config.Addresses.length ? e.StateText : se("Inactive") : se("Inactive");
    }
    function f(e) {
        var t = ee("<span>").append(p(e.Interfaces.map(function(e) {
            return ee("<a>").text(e.Name).click(function() {
                te.location.go([ e.Name ]);
            });
        }), ", "));
        return t;
    }
    ...
    function h(e, t, n) {
        ...
        var o, r = [];
        if (!e) return "";
        if (o = e.ActiveConnection, o && o.Master) return ee("<span>").append(ee("<span>").text(se("Part of ")), t ? d(o.Master.Interface) : o.Master.Interface);
    ...
    function m(e) {
        return function(t) {
            var n = t.getAxes();
            ee(e).text(re.bits_per_sec_tick_unit(n.yaxis));
        };
    }
    function v() {
        ee(".network-privileged").update_privileged(le, te.format(se("The user <b>$0</b> is not permitted to modify network settings"), le.user ? le.user.name : ""));
    }
    function _() {
        de || (ue = {}, de = te.metrics(1e3, [ {
            source: "direct",
            metrics: [ {
            ...
            metrics_path_names: [ "rx", "tx" ]
        } ]), fe = te.grid(1e3, -1, -0), de.follow(), fe.walk());
    }
    function b(e) {
        ue[e] = [ fe.add(de, [ "rx", e ]), fe.add(de, [ "tx", e ]) ];
    }
    function x(e, t) {
    ...
    function k(e, t, n) {
        return function(i) {
            return n ? n.apply_settings(i) : i.connection.type ? e.get_settings().add_connection(i) : t ? t.activate_with_settings(i) : (te.warn("No way to apply settings", n, i), 
            te.resolve());
        };
    }
    function w(e) {
    ...
    function S(e, t, n) {
        function i() {
            te.hint("ignore_transport_health_check", {
                data: !0
            }), r = window.setTimeout(function() {
                r = null, l.show(), d.hide(), c.show();
            }, 1e3 * xe), a = window.setTimeout(function() {
                a = null, l.hide(), d.show();
            }, 1e3 * we);
        }
        function o() {
            r && window.clearTimeout(r), r = null, a && window.clearTimeout(a), c.hide(), te.hint("ignore_transport_health_check", {
                data: !1
            });
        }
        var r, a, s = e.get_manager(), c = ee("#testing-connection-curtain"), l = ee("#testing-connection-curtain-testing"), d = ee("#testing-connection-curtain-restoring"), u = ee("#confirm-breaking-change-popup");
        return n.hack_does_add_or_remove ? void t() : void s.checkpoint_create(n.devices || [], we).done(function(r) {
    ...
    function C(e, t) {
        var n = ee('<div class="btn-onoff-ct">').onoff();
    ...
    function D(e, t, n) {
        S(e, t, ee.extend({
            fail_text: se("Changing the settings will break the connection to the server, and will make the administration UI unavailable."),
            anyway_text: se("Change the settings")
        }, n));
    }
    function T(e, t) {
        var n = t.message || t.toString();
        console.warn(n), ee(e).show().find("span").text(n);
    }
    function A(e) {
        var t = [];
    ...
    function F(e, t) {
        return e && E(e.Slaves, function(e) {
            return N(t, e);
        });
    }
    function O(e, t) {
    ...
    function j(e, t) {
        return ee('<ul class="list-group available-interfaces-group dialog-list-ct">').append(O(e, t).map(function(e) {
            return ee('<li class="list-group-item">').append(ee('<div class="checkbox">').css("margin", "0px").append(ee("<label>").append(ee("<input>", {
                type: "checkbox",
                "data-iface": e.Name
            }).prop("checked", !!F(t, e)), ee("<span>").text(e.Name))));
        }));
    }
    function P(e, t) {
        var n = [ {
        ...
        return t.find("input[data-iface]").each(function(e, t) {
            var i = ee(t).attr("data-iface");
            ee(t).prop("checked") && n.push({
                title: i,
                choice: i
            });
        }), r(e, n, "form-control");
    ...
    function R(e, t, n, i, o, r) {
        ...
        if (s = a.MainConnection, r) {
            ...
            var l;
            if (s) {
                if (l = s.Settings, l.connection.master == n.connection.uuid || l.connection.master == n.connection.id || l.connection.master == c) return te.resolve();
            ...
            return k(e, a.Device, s)(l).then(function() {
                if (t) {
    ...
    function U(e, t, n, i, o, r) {
        ...
        s && s.MainConnection && c.push(s.MainConnection.Settings)) : e.find("input[data-iface]").map(function(e, n) {
            var i;
            ee(n).prop("checked") && (i = t.find_interface(ee(n).attr("data-iface")), i.Device && i.Device.ActiveConnection && i.Device.ActiveConnection.Connection && c.push(i.Device.ActiveConnection.Connection.Settings));
        }), 1 == c.length && (o.ipv4 = ee.extend(!0, {}, c[0].ipv4), o.ipv6 = ee.extend(!0, {}, c[0].ipv6)), 
    ...
    function $(e, t, n) {
        function i(n, i) {
            e.append(ee('<li class="presentation">').append(ee("<a>").text(n).click(function() {
                t.val(i).trigger("change");
            })));
        }
        e.empty(), n.list_interfaces().forEach(function(e) {
            e.Device && e.Device.HwAddress && "00:00:00:00:00:00" !== e.Device.HwAddress && i(te.format("$0 ($1)", e.Device.HwAddress, e.Name), e.Device.HwAddress);
        }), i(se("Permanent"), "permanent"), i(se("Preserve"), "preserve"), i(se("Random"), "random"), 
        i(se("Stable"), "stable");
    }
    function H() {
        this._init();
    ...
    function X(e) {
        e.setup(), ee("#" + e.id).on("show.bs.modal", function() {
            e.enter();
    ...
    function Q(e, t) {
        e._entered_ && e.leave(), e.enter(t), e._entered_ = !0, ee("#" + e.id).show(), e.show();
    }
    function Z(e) {
        ee("#" + e.id).hide(), e._entered_ && (e.leave(), e._entered_ = !1);
    }
    function K() {
        function e() {
            var e = te.location.path;
            t.synchronize().then(function() {
                0 === e.length ? (Z(i), Q(n)) : 1 === e.length ? (Z(n), Q(i, e[0])) : (console.warn("not a networking location: " + e), 
                te.location = ""), ee("body").show();
            });
        }
        var t, n, i;
        te.translate(), t = new l(), n = new w(t), n.setup(), i = new M(t), i.setup(), X(new I()), 
        X(new H()), X(new L()), X(new B()), X(new Y()), X(new q()), X(new V()), X(new G()), 
        X(new J()), ee(te).on("locationchanged", e), e();
    }
    var ee = n(18), te = n(2), ne = n(4).default, ie = n(19), oe = n(20), re = n(22), ae = n(26);
    n(30), n(12), n(15), n(31), n(32), n(16);
    var se = te.gettext, ce = te.gettext;
    ee.fn.extend({
    ...
    w.prototype = {
        ...
        getTitle: function() {
            return ce("page-title", "Networking");
        },
        setup: function() {
            function e(e, t) {
                ee("#networking-interfaces tr").removeClass("highlight-ct"), t && ee('#networking-interfaces tr[data-interface="' + encodeURIComponent(t) + '"]').addClass("highlight-ct");
            }
            function t() {
                for (var e in ue) {
                    var t = ue[e], n = t[0][0], i = t[1][0], o = ee('#networking-interfaces tr[data-sample-id="' + encodeURIComponent(e) + '"]');
                    void 0 !== n && void 0 !== i && o.length > 0 && (o.find("td:nth-child(3)").text(te.format_bits_per_sec(8 * i)), 
                    o.find("td:nth-child(4)").text(te.format_bits_per_sec(8 * n)));
                }
            }
            var n = this;
            v(), ee("#networking-add-bond").syn_click(n.model, ee.proxy(this, "add_bond")), 
            ee("#networking-add-team").syn_click(n.model, ee.proxy(this, "add_team")), ee("#networking-add-bridge").syn_click(n.model, ee.proxy(this, "add_bridge")), 
            ee("#networking-add-vlan").syn_click(n.model, ee.proxy(this, "add_vlan")), ee("#networking-add-team").hide(), 
            te.script("test -f /usr/bin/teamd && ( test -f /usr/lib*/NetworkManager/libnm-device-plugin-team.so ||   test -f /usr/lib/*-linux-gnu/NetworkManager/libnm-device-plugin-team.so)", {
                err: "ignore"
            }).done(function() {
                ee("#networking-add-team").show();
            }).always(function() {
                ee("#networking-add-team").attr("data-test-stable", "yes");
            });
            var i = {
                ...
                derive: "rate",
                threshold: 200
            }, o = re.plot_simple_template();
            ee.extend(o.yaxis, {
                tickFormatter: re.format_bits_per_sec_tick_no_unit
            }), ee.extend(o.grid, {
                hoverable: !0,
                autoHighlight: !1
            }), o.setup_hook = g, o.post_hook = m("#networking-rx-unit"), this.rx_plot = re.plot(ee("#networking-rx-graph"), 300), 
            this.rx_plot.set_options(o), this.rx_series = this.rx_plot.add_metrics_stacked_instances_series(i, {}), 
            this.rx_plot.start_walking(), ee(this.rx_series).on("hover", e);
            var r = {
                ...
                derive: "rate",
                threshold: 200
            }, a = re.plot_simple_template();
            ee.extend(a.yaxis, {
                tickFormatter: re.format_bits_per_sec_tick_no_unit
            }), ee.extend(a.grid, {
                hoverable: !0,
                autoHighlight: !1
            }), a.setup_hook = g, a.post_hook = m("#networking-tx-unit"), this.tx_plot = re.plot(ee("#networking-tx-graph"), 300), 
            this.tx_plot.set_options(a), this.tx_series = this.tx_plot.add_metrics_stacked_instances_series(r, {}), 
            this.tx_plot.start_walking(), ee(this.tx_series).on("hover", e), ee(te).on("resize", function() {
                n.rx_plot.resize(), n.tx_plot.resize();
            });
            var s = re.setup_plot_controls(ee("#networking"), ee("#networking-graph-toolbar"));
            s.reset([ this.rx_plot, this.tx_plot ]), _(), ee(fe).on("notify", function(e, n, i) {
                t();
        ...
        enter: function() {
            this.log_box = ae.logbox([ "_SYSTEMD_UNIT=NetworkManager.service", "_SYSTEMD_UNIT=firewalld.service" ], 10), 
            ee("#networking-log").empty().append(this.log_box), ee(this.model).on("changed.networking", ee.proxy(this, "update_devices")), 
            this.update_devices();
        },
        show: function() {
        ...
        leave: function() {
            this.log_box && this.log_box.stop(), ee(this.model).off(".networking");
        },
        update_devices: function() {
            var e, t, n = this;
            e = ee("#networking-interfaces tbody"), e.empty(), t = ee("#networking-unmanaged-interfaces tbody"), 
            t.empty(), ee("#networking-unmanaged-interfaces").hide(), n.model.list_interfaces().forEach(function(i) {
                function o(e) {
                ...
                if (!(i.Device && "loopback" == i.Device.DeviceType || o(i))) {
                    ...
                    n.rx_series.add_instance(i.Name), n.tx_series.add_instance(i.Name), b(i.Name);
                    var s = ee("<tr>", {
                        "data-interface": encodeURIComponent(i.Name),
                        "data-sample-id": a ? encodeURIComponent(i.Name) : null
                    }).append(ee("<td>").text(i.Name), ee("<td>").html(h(r, !1, !0)), a ? [ ee("<td>").text(""), ee("<td>").text("") ] : ee('<td colspan="2">').text(u(r)));
                    !r || r.Managed ? e.append(s.click(function() {
                        te.location.go([ i.Name ]);
                    })) : (t.append(s), ee("#networking-unmanaged-interfaces").show());
                }
            });
        },
        add_bond: function() {
            ...
            H.model = this.model, H.done = null, H.connection = null, H.apply_settings = k(this.model), 
            H.ghost_settings = {
                connection: {
                    id: e,
                    autoconnect: !0,
            ...
            }, ee("#network-bond-settings-dialog").modal("show");
        },
        add_team: function() {
            var e, t, n;
            for (n = i(), t = 0; t < 100 && (e = "team" + t, this.model.find_interface(e)); t++) ;
            L.model = this.model, L.done = null, L.connection = null, L.apply_settings = k(this.model), 
            L.ghost_settings = {
                connection: {
                    id: e,
                    autoconnect: !0,
            ...
            }, ee("#network-team-settings-dialog").modal("show");
        },
        add_bridge: function() {
            var e, t, n;
            for (n = i(), t = 0; t < 100 && (e = "bridge" + t, this.model.find_interface(e)); t++) ;
            Y.model = this.model, Y.done = null, Y.connection = null, Y.apply_settings = k(this.model), 
            Y.ghost_settings = {
                connection: {
                    id: e,
                    autoconnect: !0,
            ...
            }, ee("#network-bridge-settings-dialog").modal("show");
        },
        add_vlan: function() {
            var e;
            e = i(), V.model = this.model, V.done = null, V.connection = null, V.apply_settings = k(this.model), 
            V.ghost_settings = {
                connection: {
                    id: "",
                    autoconnect: !0,
            ...
            }, ee("#network-vlan-settings-dialog").modal("show");
        }
    };
    var pe = [ {
        choice: "auto",
        title: se("Automatic (DHCP)")
    }, {
        choice: "link-local",
        title: se("Link local")
    }, {
        ...
        choice: "balance-rr",
        title: se("Round Robin")
    }, {
        choice: "active-backup",
        title: se("Active Backup")
    }, {
        choice: "balance-xor",
        title: se("XOR")
    }, {
        ...
        choice: "balance-tlb",
        title: se("Adaptive transmit load balancing")
    }, {
        choice: "balance-alb",
        title: se("Adaptive load balancing")
    } ], me = [ {
        choice: "mii",
        title: se("MII (Recommended)")
    }, {
        choice: "arp",
        title: se("ARP")
    } ], ve = [ {
        ...
        choice: "loadbalance",
        title: se("Load Balancing")
    }, {
        choice: "broadcast",
        title: se("Broadcast")
    }, {
        choice: "lacp",
        title: se("802.3ad LACP")
    } ], _e = [ {
        choice: "none",
        title: se("Passive")
    }, {
    ...
    M.prototype = {
        ...
        setup: function() {
            function e(e, t) {
                ee("#network-interface-slaves tr").removeClass("highlight-ct"), t && ee('#network-interface-slaves tr[data-interface="' + encodeURIComponent(t) + '"]').addClass("highlight-ct");
            }
            function t() {
                for (var e in ue) {
                    var t = ue[e], n = t[0][0], i = t[1][0], o = ee('#network-interface-slaves tr[data-sample-id="' + encodeURIComponent(e) + '"]');
                    o.length > 0 && (o.find("td:nth-child(2)").text(te.format_bits_per_sec(8 * i)), 
                    o.find("td:nth-child(3)").text(te.format_bits_per_sec(8 * n)));
                }
            }
            var n = this;
            ee("#network-interface .breadcrumb a").on("click", function() {
                te.location.go("/");
            }), ee("#networking-firewall-link, #networking-firewall-summary").on("click", function() {
                return te.jump("/network/firewall", te.transport.host), !1;
            }), ee("#network-interface-delete").syn_click(n.model, ee.proxy(this, "delete_connections")), 
            this.device_onoff = ee("#network-interface-delete-switch").onoff().on("change", function() {
                var e = ee(this).onoff("value");
            ...
            ee.extend(o.yaxis, {
                ...
                hoverable: !0,
                autoHighlight: !1
            }), o.setup_hook = g, o.post_hook = m("#network-interface-rx-unit"), this.rx_plot = re.plot(ee("#network-interface-rx-graph"), 300), 
            this.rx_plot.set_options(o), this.rx_series = this.rx_plot.add_metrics_stacked_instances_series(i, {}), 
            this.rx_plot.start_walking(), ee(this.rx_series).on("hover", e);
            var r = {
                direct: "network.interface.out.bytes",
            ...
            ee.extend(a.yaxis, {
                ...
                hoverable: !0,
                autoHighlight: !1
            }), a.setup_hook = g, a.post_hook = m("#network-interface-tx-unit"), this.tx_plot = re.plot(ee("#network-interface-tx-graph"), 300), 
            this.tx_plot.set_options(a), this.tx_series = this.tx_plot.add_metrics_stacked_instances_series(r, {}), 
            this.tx_plot.start_walking(), ee(this.tx_series).on("hover", e), ee(te).on("resize", function() {
                n.rx_plot.resize(), n.tx_plot.resize();
            });
            var s = re.setup_plot_controls(ee("#network-interface"), ee("#network-interface-graph-toolbar"));
            s.reset([ this.rx_plot, this.tx_plot ]), _(), ee(fe).on("notify", function(e, n, i) {
                t();
            }), ne.addEventListener("changed", function() {
                if (!ne.installed) return void ee("#networking-firewall").hide();
                ee("#networking-firewall").show(), ee("#networking-firewall-switch").onoff("value", ne.enabled);
                var e = ne.enabledServices.size, t = te.format(te.ngettext("$0 Active Rule", "$0 Active Rules", e), e.toString());
                ee("#networking-firewall-summary").text(t);
            }), ee("#networking-firewall-switch").on("change", function() {
                function e() {
                    ee(this).onoff("disabled", !1);
                }
                ee(this).onoff("disabled"), ee(this).onoff("value") ? ne.enable().then(e) : ne.disable().then(e);
            }), ee(window).on("resize", function() {
                n.rx_plot.resize(), n.tx_plot.resize();
            });
        },
        enter: function(e) {
            var t = this;
            ee(t.model).on("changed.network-interface", ee.proxy(t, "update")), t.dev_name = e, 
            ee("#network-interface .breadcrumb .active").text(t.dev_name), t.rx_series.clear_instances(), 
            t.tx_series.clear_instances(), ee("#network-interface-delete").hide(), t.dev = null, 
            t.update();
        },
        show: function() {
            this.rx_plot.resize(), this.tx_plot.resize();
        ...
        leave: function() {
            ee(this.model).off(".network-interface"), this.dev = null;
        },
        show_dialog: function(e, t) {
            ...
            e.apply_settings = k(i.model, i.dev, r), e.done = n, ee(t).modal("show");
        },
        set_mac: function() {
            this.show_dialog(J, "#network-mac-settings-dialog");
        },
        delete_connections: function() {
            function e(e) {
                return te.all(e.delete_(), te.all(e.Slaves.map(function(e) {
                    return W(e);
                })));
            }
            function t(t) {
                return te.all(t.map(e));
            }
            function n(e) {
            ...
            var r = this, a = te.location;
            r.iface && S(r.model, i, {
                devices: r.dev ? [ r.dev ] : [],
                fail_text: te.format(se("Deleting <b>$0</b> will break the connection to the server, and will make the administration UI unavailable."), r.dev_name),
                anyway_text: te.format(se("Delete $0"), r.dev_name),
        ...
        connect: function() {
            ...
            var n = this;
            return n.main_connection || n.dev && n.ghost_settings ? void S(n.model, t, {
                devices: n.dev ? [ n.dev ] : [],
                fail_text: te.format(se("Switching on <b>$0</b> will break the connection to the server, and will make the administration UI unavailable."), n.dev_name),
                anyway_text: te.format(se("Switch on $0"), n.dev_name)
            }) : void n.update();
        },
        disconnect: function() {
            function e() {
            ...
            var t = this;
            return t.dev ? void S(t.model, e, {
                devices: [ t.dev ],
                fail_text: te.format(se("Switching off <b>$0</b>  will break the connection to the server, and will make the administration UI unavailable."), t.dev_name),
                anyway_text: te.format(se("Switch off $0"), t.dev_name)
            }) : (console.log("Trying to switch off without a device?"), void t.update());
        },
        update: function() {
            function e() {
                return l && void 0 !== l.Carrier ? ee("<tr>").append(ee("<td>").text(se("Carrier")), ee("<td>").append(l.Carrier ? l.Speed ? te.format_bits_per_sec(1e6 * l.Speed) : se("Yes") : se("No"))) : null;
            }
            function t() {
                var e;
                return a.main_connection && a.main_connection.Masters.length > 0 ? null : (e = l ? d && 100 != l.State ? l.StateText : null : se("Inactive"), 
                ee("<tr>").append(ee("<td>").text(se("Status")), ee("<td>").append(h(l, !0, !1), " ", e ? ee("<span>").text(e) : null)));
            }
            function n(e, t) {
                function n(e) {
                    var n = t[e], i = [];
                    "manual" != n.method && i.push(y("ipv4" == e ? pe : he, n.method, se("Unknown configuration")));
                    var o = "manual" != n.method, r = [];
                    n.addresses.forEach(function(e) {
                        var t = e[0] + "/" + e[1];
                        e[2] && "0.0.0.0" != e[2] && "0:0:0:0:0:0:0:0" != e[2] && (t += " via " + e[2]), 
                        r.push(t);
                    }), r.length > 0 && i.push(te.format(se(o ? "Additional address $val" : "Address $val"), {
                        val: r.join(", ")
                    }));
                    var a = !n["ignore-auto-dns"] && "manual" != n.method;
                    return n.dns.length > 0 && i.push(te.format(se(a ? "Additional DNS $val" : "DNS $val"), {
                        val: n.dns.join(", ")
                    })), n.dns_search.length > 0 && i.push(te.format(se(a ? "Additional DNS Search Domains $val" : "DNS Search Domains $val"), {
                ...
                function o() {
                    a.show_dialog(H, "#network-bond-settings-dialog");
                }
                function r() {
                    a.show_dialog(L, "#network-team-settings-dialog");
                }
                function s() {
                    B.master_settings = T, a.show_dialog(B, "#network-teamport-settings-dialog");
                }
                function c() {
                    a.show_dialog(Y, "#network-bridge-settings-dialog");
                }
                function l() {
                    a.show_dialog(q, "#network-bridgeport-settings-dialog");
                }
                function u() {
                    a.show_dialog(V, "#network-vlan-settings-dialog");
                }
                function h() {
                    a.show_dialog(G, "#network-mtu-settings-dialog");
                }
                function g() {
                    if (void 0 !== t.connection.autoconnect) return ee("<tr>").append(ee("<td>").text(se("General")), ee('<td class="networking-controls">').append(ee("<label>").append(ee('<input type="checkbox">').prop("checked", t.connection.autoconnect).change(function() {
                        t.connection.autoconnect = ee(this).prop("checked"), k(a.model, a.dev, e)(t);
                    }), ee("<span>").text(se("Connect automatically")))));
                }
                function m(e, t, n) {
                    for (var i = [], o = 0; o < t.length; o++) i.push(t[o]), o < t.length - 1 && i.push(ee("<br>"));
                    return 0 === i.length && i.push(se("Configure")), ee("<tr>").append(ee("<td>").text(e).css("vertical-align", t.length > 1 ? "top" : "center"), ee("<td>").append(ee('<a class="network-privileged">').append(i).syn_click(a.model, function() {
                        n();
                    })));
                }
                function v(e, o) {
                ...
                function _() {
                    function e(e, t) {
                        n.push(te.format(e, t));
                    }
                    var n = [], i = t.ethernet;
                    return i ? (i.mtu ? e(se("$mtu"), i) : e(se("Automatic"), i), m(se("MTU"), n, h)) : null;
                }
                function b() {
                    return e && e.Masters.length > 0 ? ee("<tr>").append(ee("<td>").text(se("Master")), ee("<td>").append(p(e.Masters.map(f), ", "))) : null;
                }
                function x() {
                    var e, n = [], i = [];
                    return t.bond ? (e = t.bond.options, n.push(y(ge, e.mode, e.mode)), e.arp_interval && n.push(se("ARP Monitoring")), 
                    n.length > 0 && i.push(n.join(", ")), m(se("Bond"), i, o)) : null;
                }
                function w() {
                    var e = [], n = [];
                    if (!t.team) return null;
                    var i = t.team.config;
                    return null === i ? e.push(se("Broken configuration")) : (i.runner && e.push(y(ve, i.runner.name, i.runner.name)), 
                    i.link_watch && "ethtool" != i.link_watch.name && e.push(y(be, i.link_watch.name, i.link_watch.name))), 
                    e.length > 0 && n.push(e.join(", ")), m(se("Team"), n, r);
                }
                function S() {
                    var e = [], n = [];
                    ...
                    return null === i && e.push(se("Broken configuration")), e.length > 0 && n.push(e.join(", ")), 
                    m(se("Team Port"), n, s);
                }
                function M() {
                    function e(e, t) {
                    ...
                    var n = [], i = t.bridge;
                    return i ? (i.stp && (e(se("Spanning Tree Protocol")), 32768 != i.priority && e(se("Priority $priority"), i), 
                    15 != i.forward_delay && e(se("Forward delay $forward_delay"), i), 2 != i.hello_time && e(se("Hello time $hello_time"), i), 
                    20 != i.max_age && e(se("Maximum message age $max_age"), i)), m(se("Bridge"), n, c)) : null;
                }
                function C() {
                    function e(e, t) {
                        n.push(te.format(e, t));
                    ...
                    return i ? (32 != i.priority && e(se("Priority $priority"), i), 100 != i.path_cost && e(se("Path cost $path_cost"), i), 
                    i.hairpin_mode && e(se("Hairpin mode")), m(se("Bridge port"), n, l)) : null;
                }
                function D() {
                    function e(e, t) {
                        n.push(te.format(e, t));
                    ...
                    var n = [], i = t.vlan;
                    return i ? (e(se("Parent $parent"), i), e(se("Id $id"), i), m(se("VLAN"), n, u)) : null;
                }
                if (!d) return ee("<tr>").append(ee("<td>"), ee("<td>").text(se("This device cannot be managed here.")));
                if (!t) return [];
                var T = null;
                return e && e.Masters.length > 0 && (T = e.Masters[0].Settings), [ b(), g(), v("ipv4", se("IPv4")), v("ipv6", se("IPv6")), _(), D(), M(), C(), x(), w(), S() ];
            }
            function i() {
                var e = {
                    connection: {
            ...
            function r(e) {
                var t = ee("#network-interface-slaves tbody"), n = {}, i = {};
                ...
                ee("#network-interface-slaves thead th:first-child").text(se("bond" == r.type ? "Members" : "Ports")), 
                e.Slaves.forEach(function(e) {
                    e.Interfaces.forEach(function(t) {
                        if (t.MainConnection == e) {
                            ...
                            b(t.Name), i[t.Name] = !0, n[t.Name] = ee("<tr>", {
                                "data-interface": encodeURIComponent(t.Name),
                                "data-sample-id": s ? encodeURIComponent(t.Name) : null
                            }).append(ee("<td>").text(t.Name), s ? [ ee("<td>").text(""), ee("<td>").text("") ] : ee('<td colspan="2">').text(u(r)), ee('<td class="networking-row-configure">').append(C(!(!r || !r.ActiveConnection), function(n) {
                                n ? S(a.model, function() {
                                    return e.activate(r).fail(o);
                                }, {
                                    devices: r ? [ r ] : [],
                                    fail_text: te.format(se("Switching on <b>$0</b> will break the connection to the server, and will make the administration UI unavailable."), t.Name),
                                    anyway_text: te.format(se("Switch on $0"), t.Name)
                                }) : r && S(a.model, function() {
                                    return r.disconnect().fail(o);
                                }, {
                                    devices: [ r ],
                                    fail_text: te.format(se("Switching off <b>$0</b> will break the connection to the server, and will make the administration UI unavailable."), t.Name),
                                    anyway_text: te.format(se("Switch off $0"), t.Name)
                                });
                            }, "network-privileged")), ee('<td width="28px">').append(ee('<button class="btn btn-default btn-control-ct network-privileged fa fa-minus">').syn_click(a.model, function() {
                                return S(a.model, function() {
                                    return e.delete_().fail(o);
                                }, {
                                    devices: r ? [ r ] : [],
                                    fail_text: te.format(se("Removing <b>$0</b> will break the connection to the server, and will make the administration UI unavailable."), t.Name),
                                    anyway_text: te.format(se("Remove $0"), t.Name),
                                    hack_does_add_or_remove: !0
                                }), !1;
                            }))).click(function(e) {
                                ee(e.target).hasClass("btn") || te.location.go([ t.Name ]);
                            }));
                        }
                    });
                ...
                var s = ee("<div>", {
                    ...
                    return z(t) && !i[t.Name] && t != a.iface ? ee('<li role="presentation">').append(ee('<a role="menuitem" class="network-privileged">').text(t.Name).syn_click(a.model, function() {
                        S(a.model, function() {
                            var n = c(e);
                            return R(a.model, e, e.Settings, n.type, t.Name, !0).fail(o);
                        }, {
                            devices: t.Device ? [ t.Device ] : [],
                            fail_text: te.format(se("Adding <b>$0</b> will break the connection to the server, and will make the administration UI unavailable."), t.Name),
                            anyway_text: te.format(se("Add $0"), t.Name),
                            hack_does_add_or_remove: !0
                        });
                    })) : null;
                })));
                ee("#network-interface-slaves thead th:nth-child(5)").html(s), ee("#network-interface-slaves").show(), 
                v();
            }
            var a = this, s = a.model.find_interface(a.dev_name), l = s && s.Device, d = s && (!l || l.Managed);
            a.iface = s, a.dev = l;
            var g, m;
            l ? g = "ethernet" == l.DeviceType || l.IdVendor || l.IdModel ? te.format("$IdVendor $IdModel $Driver", l) : "bond" == l.DeviceType ? se("Bond") : "team" == l.DeviceType ? se("Team") : "vlan" == l.DeviceType ? se("VLAN") : "bridge" == l.DeviceType ? se("Bridge") : te.format(se('Unknown "$0"'), l.DeviceType) : s ? (m = c(s.Connections[0]), 
            g = "bond" == m.type ? se("Bond") : "team" == m.type ? se("Team") : "vlan" == m.type ? se("VLAN") : "bridge" == m.type ? se("Bridge") : m.type ? te.format(se('Unknown "$0"'), m.type) : se("Unknown")) : g = se("Unknown"), 
            ee("#network-interface-name").text(a.dev_name), ee("#network-interface-hw").text(g);
            var _;
            l && l.HwAddress ? _ = l.HwAddress : s && s.MainConnection && s.MainConnection.Settings && s.MainConnection.Settings.ethernet && s.MainConnection.Settings.ethernet.assigned_mac_address && (_ = s.MainConnection.Settings.ethernet.assigned_mac_address);
            var w = s && s.MainConnection && ("802-3-ethernet" == c(s.MainConnection).type && a.model.at_least_version("1.4") || "bond" == c(s.MainConnection).type && a.model.at_least_version("1.6"));
            ee("#network-interface-mac").empty(), w ? ee("#network-interface-mac").append(ee("<a>").text(_).syn_click(a.model, function() {
                a.set_mac();
            })) : ee("#network-interface-mac").text(_), this.device_onoff.onoff("disabled", !(s && (!l || 20 != l.State))), 
            this.device_onoff.onoff("value", !(!l || !l.ActiveConnection)), this.device_onoff.toggle(d);
            var M = s && !l || l && ("bond" == l.DeviceType || "team" == l.DeviceType || "vlan" == l.DeviceType || "bridge" == l.DeviceType);
            ee("#network-interface-delete").toggle(M && d), a.ghost_settings = null, a.main_connection = null, 
            ...
            a.connection_settings = a.ghost_settings)), ee("#network-interface-settings").empty().append(t()).append(e()).append(n(a.main_connection, a.connection_settings)), 
            v(), ee("#network-interface-slaves").hide(), a.main_connection && r(a.main_connection);
        }
    }, I.prototype = {
        _init: function() {
        ...
        setup: function() {
            ee("#network-ip-settings-cancel").click(ee.proxy(this, "cancel")), ee("#network-ip-settings-apply").click(ee.proxy(this, "apply"));
        },
        enter: function() {
            ee("#network-ip-settings-error").hide(), this.settings = I.ghost_settings || I.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        update: function() {
            ...
            function t(e, t) {
                var n, i = ee("<span>").append(ee('<span class="inverted-switchbox">').text(e), n = C(!m[t], function(e) {
                    m[t] = !e, h.update();
                }));
            ...
            function n(e, t, n, i, o) {
                ...
                var u = ee('<div class="network-ip-settings-row">').append(ee("<div>").append(ee("<strong>").text(e), ee('<div class="pull-right">').append(o, l = ee('<button class="btn btn-default fa fa-plus">').css("margin-left", "10px").click(s()))), ee('<table width="100%">').append(m[t].map(function(e, t) {
                    return ee("<tr>").append(n.map(function(e, n) {
                        return ee("<td>").append(ee('<input class="form-control">').val(r(t, n)).attr("placeholder", e).change(function(e) {
                            a(t, n, ee(e.target).val());
                        }));
                    }), ee("<td>").append(ee('<button class="btn btn-default fa fa-minus">').click(c(t))));
                })));
            ...
            function i() {
                var i = se("ipv4" == g ? "Prefix length or Netmask" : "Prefix length"), r = ee("<div>").append(s = n(se("Addresses"), "addresses", [ "Address", i, "Gateway" ], [ "", "", "" ], o = e("method", "ipv4" == g ? pe : he).css("display", "inline-block")), ee("<br>"), l = n(se("DNS"), "dns", "Server", "", c = t(se("Automatic"), "ignore_auto_dns")), ee("<br>"), u = n(se("DNS Search Domains"), "dns_search", "Search Domain", "", d = t(se("Automatic"), "ignore_auto_dns")), ee("<br>"), p = n(se("Routes"), "routes", [ "Address", i, "Gateway", "Metric" ], [ "", "", "", "" ], f = t(se("Automatic"), "ignore_auto_routes")));
                return r;
            }
            var o, s, c, l, d, u, f, p, h = this, g = I.topic, m = h.settings[g];
            ...
            _ || (m.addresses = [], m.dns = [], m.dns_search = []), v && (m.routes = []), ee("#network-ip-settings-dialog .modal-title").text(se("ipv4" == g ? "IPv4 Settings" : "IPv6 Settings")), 
            ee("#network-ip-settings-body").html(i());
            var b = "auto" == m.method || "dhcp" == m.method;
            c.enable(b), d.enable(b), f.enable(b), s.enable_add(_), l.enable_add(_), u.enable_add(_), 
            p.enable_add(!v);
        },
        cancel: function() {
            ee("#network-ip-settings-dialog").modal("hide");
        },
        apply: function() {
            function e() {
                return I.apply_settings(t.settings).then(function() {
                    if (ee("#network-ip-settings-dialog").modal("hide"), I.done) return I.done();
                }).fail(function(e) {
            ...
            var t = this;
            D(I.model, e, {
                devices: A(I.connection)
            });
        }
    }, H.prototype = {
        _init: function() {
            this.id = "network-bond-settings-dialog", this.bond_settings_template = ee("#network-bond-settings-template").html(), 
            oe.parse(this.bond_settings_template);
        },
        setup: function() {
            ee("#network-bond-settings-cancel").click(ee.proxy(this, "cancel")), ee("#network-bond-settings-apply").click(ee.proxy(this, "apply"));
        },
        enter: function() {
            ee("#network-bond-settings-error").hide(), this.settings = H.ghost_settings || H.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        find_slave_con: function(e) {
            return H.connection ? E(H.connection.Slaves, function(t) {
        ...
        update: function() {
            function e() {
                var e = P(n, o);
                d.replaceWith(e), d = e, a(d, b.primary), n(), m.slaves_changed = !0;
            }
            function t() {
                console.log("mac"), m.settings.ethernet || (m.settings.ethernet = {}), m.settings.ethernet.assigned_mac_address = c.val();
            }
            function n() {
                b.mode = s(l), d.parents("tr").toggle("active-backup" == b.mode), "active-backup" == b.mode ? b.primary = s(d) : delete b.primary;
            }
            function i() {
                var e = "mii" == s(u);
            ...
            var o, c, l, d, u, f, p, h, g, m = this, v = H.model, _ = H.connection, b = m.settings.bond.options, x = m.settings.ethernet && m.settings.ethernet.assigned_mac_address || "", k = ee(oe.render(m.bond_settings_template, {
            ...
            k.find("#network-bond-settings-interface-name-input").change(function(e) {
                var t = ee(e.target).val();
                m.settings.bond.interface_name = t, m.settings.connection.id = t, m.settings.connection.interface_name = t;
            }), k.find("#network-bond-settings-members").append(o = j(v, _).change(e)), $(k.find("#network-bond-settings-mac-menu"), c = k.find("#network-bond-settings-mac-input"), v), 
            c.change(t), k.find("#network-bond-settings-mode-select").append(l = r(n, ge, "form-control")), 
            k.find("#network-bond-settings-primary-select").append(d = P(n, o, "form-control")), 
            k.find("#network-bond-settings-link-monitoring-select").append(u = r(i, me, "form-control")), 
            ...
            a(l, b.mode), a(u, 0 !== b.miimon ? "mii" : "arp"), e(), n(), i(), m.slaves_changed = !1, 
            ee("#network-bond-settings-body").html(k);
        },
        cancel: function() {
            ee("#network-bond-settings-dialog").modal("hide");
        },
        apply: function() {
            function e() {
                return U(ee("#network-bond-settings-body"), H.model, H.apply_settings, H.connection, t.settings, "bond").then(function() {
                    if (ee("#network-bond-settings-dialog").modal("hide"), H.connection && te.location.go([ t.settings.connection.interface_name ]), 
            ...
            var t = this;
            H.connection ? D(H.model, e, {
                devices: t.slaves_changed ? [] : A(H.connection),
                hack_does_add_or_remove: t.slaves_changed,
                rollback_on_failure: t.slaves_changed
            }) : S(H.model, e, {
                fail_text: se("Creating this bond will break the connection to the server, and will make the administration UI unavailable."),
                anyway_text: se("Create it"),
                hack_does_add_or_remove: !0,
                rollback_on_failure: !0
            });
        }
        ...
        _init: function() {
            this.id = "network-team-settings-dialog", this.team_settings_template = ee("#network-team-settings-template").html(), 
            oe.parse(this.team_settings_template);
        },
        setup: function() {
            ee("#network-team-settings-cancel").click(ee.proxy(this, "cancel")), ee("#network-team-settings-apply").click(ee.proxy(this, "apply"));
        },
        enter: function() {
            ee("#network-team-settings-error").hide(), this.settings = L.ghost_settings || L.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        find_slave_con: function(e) {
            return L.connection ? E(L.connection.Slaves, function(t) {
                return t.Interfaces.indexOf(e) >= 0;
            }) || null : null;
        },
        update: function() {
            ...
            var o, c, l, d, u, f, p, h = this, g = L.model, m = L.connection, v = h.settings.team.config;
            ...
            var _ = ee(oe.render(h.team_settings_template, {
            ...
            }), _.find("#network-team-settings-members").append(j(g, m).change(e)), _.find("#network-team-settings-runner-select").append(o = r(t, ve, "form-control")), 
            _.find("#network-team-settings-balancer-select").append(c = r(n, _e, "form-control")), 
            _.find("#network-team-settings-link-watch-select").append(l = r(i, be, "form-control")), 
            ...
            t(), i(), h.slaves_changed = !1, ee("#network-team-settings-body").html(_);
        },
        cancel: function() {
            ee("#network-team-settings-dialog").modal("hide");
        },
        apply: function() {
            function e() {
                return U(ee("#network-team-settings-body"), L.model, L.apply_settings, L.connection, t.settings, "team").then(function() {
                    if (ee("#network-team-settings-dialog").modal("hide"), L.connection && te.location.go([ t.settings.connection.interface_name ]), 
            ...
            var t = this;
            L.connection ? D(L.model, e, {
                devices: t.slaves_changed ? [] : A(L.connection),
                hack_does_add_or_remove: t.slaves_changed,
                rollback_on_failure: t.slaves_changed
            }) : S(L.model, e, {
                fail_text: se("Creating this team will break the connection to the server, and will make the administration UI unavailable."),
                anyway_text: se("Create it"),
                hack_does_add_or_remove: !0,
                rollback_on_failure: !0
            });
        ...
        _init: function() {
            this.id = "network-teamport-settings-dialog", this.team_port_settings_template = ee("#network-team-port-settings-template").html(), 
            oe.parse(this.team_port_settings_template);
        },
        setup: function() {
            ee("#network-teamport-settings-cancel").click(ee.proxy(this, "cancel")), ee("#network-teamport-settings-apply").click(ee.proxy(this, "apply"));
        },
        enter: function() {
            ee("#network-teamport-settings-error").hide(), this.settings = B.ghost_settings || B.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        update: function() {
            ...
            var t, n, i, o, r = this, a = B.master_settings.team.config, s = r.settings.team_port.config;
            s || (r.settings.team_port.config = s = {});
            var c = ee(oe.render(r.team_port_settings_template, s));
            ...
            o.parents("tr").toggle("lacp" == a.runner.name), ee("#network-teamport-settings-body").html(c);
        },
        cancel: function() {
            ee("#network-teamport-settings-dialog").modal("hide");
        },
        apply: function() {
            function e() {
                return B.apply_settings(t.settings).then(function() {
                    if (ee("#network-teamport-settings-dialog").modal("hide"), B.done) return B.done();
                }).fail(function(e) {
                    T("#network-teamport-settings-error", e);
                });
            }
            var t = this, n = B.model;
            D(n, e, {
                devices: A(B.connection)
            });
        }
    }, Y.prototype = {
        _init: function() {
            this.id = "network-bridge-settings-dialog", this.bridge_settings_template = ee("#network-bridge-settings-template").html(), 
            oe.parse(this.bridge_settings_template);
        },
        setup: function() {
            ee("#network-bridge-settings-cancel").click(ee.proxy(this, "cancel")), ee("#network-bridge-settings-apply").click(ee.proxy(this, "apply"));
        },
        enter: function() {
            ee("#network-bridge-settings-error").hide(), this.settings = Y.ghost_settings || Y.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        find_slave_con: function(e) {
            return Y.connection ? E(Y.connection.Slaves, function(t) {
                return t.Interfaces.indexOf(e) >= 0;
            }) || null : null;
        },
        update: function() {
            ...
            var n, i, o, r, a, s = this, c = Y.model, l = Y.connection, d = s.settings.bridge, u = ee(oe.render(s.bridge_settings_template, {
            ...
            a.change(t), t(), s.slaves_changed = !1, ee("#network-bridge-settings-body").html(u);
        },
        cancel: function() {
            ee("#network-bridge-settings-dialog").modal("hide");
        },
        apply: function() {
            function e() {
                return U(ee("#network-bridge-settings-body"), Y.model, Y.apply_settings, Y.connection, t.settings, "bridge").then(function() {
                    if (ee("#network-bridge-settings-dialog").modal("hide"), Y.connection && te.location.go([ t.settings.connection.interface_name ]), 
                    Y.done) return Y.done();
                }).fail(function(e) {
                    ee("#network-bridge-settings-error").show().find("span").text(e.message || e.toString());
                });
            }
            var t = this;
            Y.connection ? D(Y.model, e, {
                devices: t.slaves_changed ? [] : A(Y.connection),
                hack_does_add_or_remove: t.slaves_changed,
                rollback_on_failure: t.slaves_changed
            }) : S(Y.model, e, {
                fail_text: se("Creating this bridge will break the connection to the server, and will make the administration UI unavailable."),
                anyway_text: se("Create it"),
                hack_does_add_or_remove: !0,
                rollback_on_failure: !0
            });
        ...
        _init: function() {
            this.id = "network-bridgeport-settings-dialog", this.bridge_port_settings_template = ee("#network-bridge-port-settings-template").html(), 
            oe.parse(this.bridge_port_settings_template);
        },
        setup: function() {
            ee("#network-bridgeport-settings-cancel").click(ee.proxy(this, "cancel")), ee("#network-bridgeport-settings-apply").click(ee.proxy(this, "apply"));
        },
        enter: function() {
            ee("#network-bridgeport-settings-error").hide(), this.settings = q.ghost_settings || q.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        update: function() {
            ...
            var t, n, i, o = this, r = o.settings.bridge_port, a = ee(oe.render(o.bridge_port_settings_template, {
                priority: r.priority,
            ...
            ee("#network-bridgeport-settings-body").html(a);
        },
        cancel: function() {
            ee("#network-bridgeport-settings-dialog").modal("hide");
        },
        apply: function() {
            function e() {
                return q.apply_settings(t.settings).then(function() {
                    if (ee("#network-bridgeport-settings-dialog").modal("hide"), q.done) return q.done();
                }).fail(function(e) {
            ...
            D(n, e, {
                devices: A(q.connection)
            });
        }
    }, V.prototype = {
        _init: function() {
            this.id = "network-vlan-settings-dialog", this.vlan_settings_template = ee("#network-vlan-settings-template").html(), 
            oe.parse(this.vlan_settings_template);
        },
        setup: function() {
            ee("#network-vlan-settings-cancel").click(ee.proxy(this, "cancel")), ee("#network-vlan-settings-apply").click(ee.proxy(this, "apply"));
        },
        enter: function() {
            ee("#network-vlan-settings-error").hide(), this.settings = V.ghost_settings || V.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        update: function() {
            function e() {
                d.parent = s(n), ee("#network-vlan-settings-apply").toggleClass("disabled", !d.parent), 
            ...
            var n, i, o, c = this, l = V.model, d = c.settings.vlan, u = !0, f = [];
            l.list_interfaces().forEach(function(e) {
                !N(e, V.connection) && z(e) && f.push({
                    title: e.Name,
                    choice: e.Name
                });
            });
            var p = ee(oe.render(c.vlan_settings_template, {
                vlan_id: d.id || "1",
            ...
            a(n, d.parent || (f[0] ? f[0].choice : "")), e(), ee("#network-vlan-settings-body").html(p);
        },
        cancel: function() {
            ee("#network-vlan-settings-dialog").modal("hide");
        },
        apply: function() {
            function e() {
                return V.apply_settings(t.settings).then(function() {
                    if (ee("#network-vlan-settings-dialog").modal("hide"), V.connection && te.location.go([ t.settings.connection.interface_name ]), 
                    V.done) return V.done();
                }).fail(function(e) {
            ...
            V.connection ? D(n, e, {
                ...
                fail_text: se("Creating this VLAN will break the connection to the server, and will make the administration UI unavailable."),
                anyway_text: se("Create it"),
                hack_does_add_or_remove: !0
            });
        }
        ...
        _init: function() {
            this.id = "network-mtu-settings-dialog", this.ethernet_settings_template = ee("#network-mtu-settings-template").html(), 
            oe.parse(this.ethernet_settings_template);
        },
        setup: function() {
            ee("#network-mtu-settings-cancel").click(ee.proxy(this, "cancel")), ee("#network-mtu-settings-apply").click(ee.proxy(this, "apply"));
        },
        enter: function() {
            ee("#network-mtu-settings-error").hide(), this.settings = G.ghost_settings || G.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        update: function() {
            var e = this, t = e.settings.ethernet, n = ee(oe.render(e.ethernet_settings_template, t));
            ee("#network-mtu-settings-body").html(n), ee("#network-mtu-settings-input").focus(function() {
                ee("#network-mtu-settings-custom").prop("checked", !0);
            });
        },
        cancel: function() {
            ee("#network-mtu-settings-dialog").modal("hide");
        },
        apply: function() {
            function e(e) {
            ...
            function t() {
                return G.apply_settings(n.settings).then(function() {
                    if (ee("#network-mtu-settings-dialog").modal("hide"), G.done) return G.done();
                }).fail(e);
            }
            var n = this, i = G.model;
            if (ee("#network-mtu-settings-auto").prop("checked")) n.settings.ethernet.mtu = 0; else {
                var o = ee("#network-mtu-settings-input").val();
                if (!/^[0-9]+$/.test(o)) return void e(se("MTU must be a positive number"));
                n.settings.ethernet.mtu = parseInt(o, 10);
            }
            D(i, t, {
                devices: A(G.connection)
            });
        }
    }, J.prototype = {
        _init: function() {
            this.id = "network-mac-settings-dialog", this.ethernet_settings_template = ee("#network-mac-settings-template").html(), 
            oe.parse(this.ethernet_settings_template);
        },
        setup: function() {
            ee("#network-mac-settings-cancel").click(ee.proxy(this, "cancel")), ee("#network-mac-settings-apply").click(ee.proxy(this, "apply"));
        },
        enter: function() {
            ee("#network-mac-settings-error").hide(), this.settings = J.ghost_settings || J.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        update: function() {
            var e = this, t = e.settings.ethernet, n = ee(oe.render(e.ethernet_settings_template, t));
            ee("#network-mac-settings-body").html(n), $(ee("#network-mac-settings-menu"), ee("#network-mac-settings-input"), J.model);
        },
        cancel: function() {
            ee("#network-mac-settings-dialog").modal("hide");
        },
        apply: function() {
            function e(e) {
            ...
            function t() {
                return J.apply_settings(n.settings).then(function() {
                    if (ee("#network-mac-settings-dialog").modal("hide"), J.done) return J.done();
                }).fail(e);
            }
            var n = this, i = J.model;
            n.settings.ethernet || (n.settings.ethernet = {}), n.settings.ethernet.assigned_mac_address = ee("#network-mac-settings-input").val(), 
            D(i, t, {
                devices: A(J.connection)
            });
        }
    }, ee(K);
}, function(e, t) {
    ...
    !function(n, a) {
        ...
        function c(t, n) {
            ...
            r(n || e.tags);
            for (var S, M, C, D, T, A, I = new u(t); !I.eos(); ) {
                if (S = I.pos, C = I.scanUntil(s)) for (var N = 0, z = C.length; N < z; ++N) D = C.charAt(N), 
                a(D) ? m.push(h.length) : _ = !0, h.push([ "text", D, S, S + 1 ]), S += 1, "\n" === D && o();
                if (!I.scan(s)) break;
                if (v = !0, M = I.scan(y) || "name", I.scan(b), "=" === M ? (C = I.scanUntil(k), 
                I.scan(k), I.scanUntil(c)) : "{" === M ? (C = I.scanUntil(f), I.scan(w), I.scanUntil(c), 
                M = "&") : C = I.scanUntil(c), !I.scan(c)) throw new Error("Unclosed tag at " + I.pos);
                if (T = [ M, C, S, I.pos ], h.push(T), "#" === M || "^" === M) p.push(T); else if ("/" === M) {
            ...
            if (A = p.pop()) throw new Error('Unclosed section "' + A[1] + '" at ' + I.pos);
            return d(l(h));
        }
        function l(e) {
    ...
    a.plot = function(e, t, n) {
        ...
        function l(e, t) {
            ...
            if (y && y.interval == w) y.move(i, s); else {
                y && y.close(), y = r.grid(w, i, s), I++;
                for (var c = 0; c < C.length; c++) C[c].reset();
                I--, d(), o(y).on("notify", function(e, t, n) {
                    a();
                });
            }
        }
        ...
        function m(e, t) {
            ...
            function a() {
                ...
                f && f.close(), f = r.metrics(w, h), o(f).on("changed", e), e(), I++;
        ...
        function v(e, t) {
            N != e ? (N && N.hover(!1), N = e, z = t, N && N.hover(z)) : z != t && (z = t, N && N.hover(z));
        }
        function _(e, t, n) {
        ...
        var w, y, S = {}, M = {}, C = [], D = [], T = null, A = !1, I = 0, N = null, z = !1;
    ...
    !function() {
        ...
        var i = n(2), o = n(20), r = n(27), a = n(28), s = n(29), c = i.gettext, l = i.gettext, d = {};
