!function(e) {
    ...
    function l() {
        ...
        function _() {
            function e() {
                ...
                ee($).trigger("changed"), G && (G.resolve(), G = null);
            }
        ...
        var j = te.dbus("org.freedesktop.NetworkManager", U);
        $.client = j;
        var H, L = {}, B = 0, Y = {}, q = 0, G = null;
        $.synchronize = function() {
            return 0 === B ? te.resolve() : (G || (G = te.defer()), G.promise());
        ...
        ee(j).on("notify", function(e, t) {
            ...
            V.remove(), J.remove(), ee(j).off("notify"), j.close("unused");
        };
        var X, Q = {}, K = {
    ...
    function Z() {
        ...
        var t, n, i;
        te.translate(), t = new l(), n = new w(t), n.setup(), i = new C(t), i.setup(), X(new A()), 
        X(new H()), X(new L()), X(new B()), X(new Y()), X(new q()), X(new G()), X(new V()), 
    ...
    w.prototype = {
        ...
        add_vlan: function() {
            var e;
            e = i(), G.model = this.model, G.done = null, G.connection = null, G.apply_settings = k(this.model), 
            G.ghost_settings = {
                connection: {
                    id: "",
                    autoconnect: !0,
    ...
    C.prototype = {
        ...
        update: function() {
            ...
            function n(e, t) {
                ...
                function i(e) {
                    A.topic = e, a.show_dialog(A, "#network-ip-settings-dialog");
                }
                function o() {
                ...
                function h() {
                    a.show_dialog(V, "#network-mtu-settings-dialog");
                }
                function g() {
        ...
        enter: function() {
            ee("#network-ip-settings-error").hide(), this.settings = A.ghost_settings || A.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        update: function() {
            ...
            var o, s, c, l, d, u, f, p, h = this, g = A.topic, m = h.settings[g];
        ...
        apply: function() {
            function e() {
                return A.apply_settings(t.settings).then(function() {
                    if (ee("#network-ip-settings-dialog").modal("hide"), A.done) return A.done();
                }).fail(function(e) {
        ...
        update: function() {
            ...
            }), k.find("#network-bond-settings-members").append(o = W(v, _).change(e)), j(k.find("#network-bond-settings-mac-menu"), c = k.find("#network-bond-settings-mac-input"), v), 
        ...
        enter: function() {
            ee("#network-vlan-settings-error").hide(), this.settings = G.ghost_settings || G.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        update: function() {
            ...
            var n, i, o, c = this, l = G.model, d = c.settings.vlan, u = !0, f = [];
            l.list_interfaces().forEach(function(e) {
                !D(e, G.connection) && z(e) && f.push({
                    title: e.Name,
                    choice: e.Name
                });
            });
        ...
        apply: function() {
            function e() {
                return G.apply_settings(t.settings).then(function() {
                    if (ee("#network-vlan-settings-dialog").modal("hide"), G.connection && te.location.go([ t.settings.connection.interface_name ]), 
        ...
        enter: function() {
            ee("#network-mtu-settings-error").hide(), this.settings = V.ghost_settings || V.connection.copy_settings(), 
            this.update();
        },
        show: function() {},
        leave: function() {},
        ...
        apply: function() {
            ...
            function t() {
                return V.apply_settings(n.settings).then(function() {
                    if (ee("#network-mtu-settings-dialog").modal("hide"), V.done) return V.done();
                }).fail(e);
            }
        ...
        update: function() {
            var e = this, t = e.settings.ethernet, n = ee(ie.render(e.ethernet_settings_template, t));
            ee("#network-mac-settings-body").html(n), j(ee("#network-mac-settings-menu"), ee("#network-mac-settings-input"), J.model);
        },
        cancel: function() {
    ...
    a.plot = function(e, t, n) {
        ...
        function l(e, t) {
            ...
            if (y && y.interval == w) y.move(i, s); else {
                ...
                A--, d(), o(y).on("notify", function(e, t, n) {
                    a();
                });
            }
        }
        ...
        function m(e, t) {
            ...
            function a() {
                ...
                f && f.close(), f = r.metrics(w, h), o(f).on("changed", e), e(), A++;
        ...
        function v(e, t) {
            D != e ? (D && D.hover(!1), D = e, z = t, D && D.hover(z)) : z != t && (z = t, D && D.hover(z));
        }
        function _(e, t, n) {
