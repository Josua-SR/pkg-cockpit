	 ...
	 */
        !function(e, s) {
            ...
            function t(t, e, s, i, r) {
                ...
                return t !== Vt && t !== qt || (o.uid = rt()), o;
            }
            function e(t, e, s) {
                var i = t.vtype, r = null;
                return i ? i === It ? r = h(t, e, s) : i === qt ? r = x(t, e, s) : i === Vt ? r = y(t, e, s) : i === Ht && (r = document.createComment("react-text: " + (t.uid || rt()))) : r = document.createTextNode(t), 
                r;
            }
            function s(t, e, s, r) {
                var o = t.vtype;
                if (o === qt) return g(t, e, s, r);
                if (o === Vt) return m(t, e, s, r);
                if (o !== It) return s;
                var n = t.props[Bt] && t.props[Bt].__html;
                return null != n ? (d(t, e, s, r), c(e, s, r)) : (i(t, e, s, r), d(t, e, s, r)), 
                s;
            }
            function i(t, e, s, i) {
                var a = {
                ...
                u(a, t, e, s, i), st(a.removes, o), st(a.updates, r), st(a.creates, n);
            }
            function r(t) {
                if (t) {
                    var e = t.vnode, s = t.node;
                    t.shouldIgnore || (e.vtype ? e.vtype === It ? d(e, t.newVnode, s, t.parentContext) : e.vtype === Vt ? s = m(e, t.newVnode, s, t.parentContext) : e.vtype === qt && (s = g(e, t.newVnode, s, t.parentContext)) : s.replaceData(0, s.length, t.newVnode));
            ...
            function a(t, e) {
                var s = t.vtype;
                s === It ? f(t, e) : s === qt ? k(t, e) : s === Vt && v(t, e);
            }
            function h(t, e, s) {
                var i = t.type, r = t.props, o = null;
                "svg" === i || s === Ut ? (o = document.createElementNS(Ut, i), s = Ut) : o = document.createElement(i), 
                c(t, o, e);
                var n = i.indexOf("-") >= 0 || null != r.is;
                return ht(o, r, n), null != t.ref && (et(Yt, t), et(Yt, o)), o;
            }
            function c(t, s, i) {
                for (var r = s.vchildren = l(t), o = s.namespaceURI, n = 0, a = r.length; n < a; n++) s.appendChild(e(r[n], i, o));
            }
            function l(t) {
                var e = t.props.children, s = [];
                return ge(e) ? st(e, p, s) : p(e, s), s;
            }
            function p(t, e) {
                if (null != t && "boolean" != typeof t) {
                    if (!t.vtype) {
                        if (t.toJS) return t = t.toJS(), void (ge(t) ? st(t, p, e) : p(t, e));
                        t = "" + t;
                    }
                    e[e.length] = t;
                }
            ...
            function u(t, e, s, i, r) {
                var o = i.childNodes, n = i.vchildren, a = i.vchildren = l(s), h = n.length, c = a.length;
                if (0 !== h) if (0 !== c) {
                    for (var p = Array(c), d = null, f = null, y = 0; y < h; y++) for (var m = n[y], v = 0; v < c; v++) if (!p[v]) {
                        var b = a[v];
                        if (m === b) {
                            var x = !0;
                            r && (m.vtype !== qt && m.vtype !== Vt || m.type.contextTypes && (x = !1)), p[v] = {
                                shouldIgnore: x,
                                vnode: m,
                                newVnode: b,
                                node: o[y],
                    ...
                    for (var y = 0; y < h; y++) {
                        var g = n[y];
                        if (null !== g) {
                            for (var k = !0, v = 0; v < c; v++) if (!p[v]) {
                                var w = a[v];
                                if (w.type === g.type && w.key === g.key && w.refs === g.refs) {
                                    p[v] = {
                                        vnode: g,
                                        newVnode: w,
                                        node: o[y],
                    ...
                    for (var y = 0; y < c; y++) {
                        var C = p[y];
                        C ? C.vnode.vtype === It && u(t, C.vnode, C.newVnode, C.node, C.parentContext) : (f || (f = []), 
                        et(f, {
                            vnode: a[y],
                            parentNode: i,
                            parentContext: r,
                    ...
                    d && et(t.removes, d), f && et(t.creates, f), et(t.updates, p);
                } else for (var y = 0; y < h; y++) et(t.removes, {
                    vnode: n[y],
                    node: o[y]
                }); else if (c > 0) for (var y = 0; y < c; y++) et(t.creates, {
                    vnode: a[y],
                    parentNode: i,
                    parentContext: r,
                    index: y
            ...
            function d(t, e, s) {
                ...
                return ct(s, t.props, e.props, i), t.ref !== e.ref && (O(t.refs, t.ref, s), D(e.refs, e.ref, s)), 
                s;
            }
            function f(t, e) {
                for (var s = (t.props, e.vchildren), i = e.childNodes, r = 0, o = s.length; r < o; r++) a(s[r], i[r]);
                O(t.refs, t.ref, e), e.eventStore = e.vchildren = null;
            }
            function y(t, s, i) {
                var r = b(t, s), o = e(r, s, i);
                return o.cache = o.cache || {}, o.cache[t.uid] = r, o;
            }
            function m(t, e, s, i) {
                var r = t.uid, o = s.cache[r];
                delete s.cache[r];
                var n = b(e, i), a = A(o, n, s, i);
                return a.cache = a.cache || {}, a.cache[e.uid] = n, a !== s && _(a.cache, s.cache, a), 
                a;
            }
            function v(t, e) {
            ...
            function b(e, s) {
                var i = e.type, r = e.props, o = w(s, i.contextTypes), n = i(r, o);
                if (n && n.render && (n = n.render()), null === n || n === !1) n = t(Ht); else if (!n || !n.vtype) throw new Error("@" + i.name + "#render:You may have returned undefined, an array or some other invalid object");
                return n;
            }
            function x(t, s, i) {
                var r = t.type, o = t.props, n = t.uid, a = w(s, r.contextTypes), h = new r(o, a), c = h.$updater, l = h.$cache;
                l.parentContext = s, c.isPending = !0, h.props = h.props || o, h.context = h.context || a, 
                h.componentWillMount && (h.componentWillMount(), h.state = c.getState());
                var p = C(h), u = e(p, M(h, s), i);
                return u.cache = u.cache || {}, u.cache[n] = h, l.vnode = p, l.node = u, l.isMounted = !0, 
                et(Wt, h), null != t.ref && (et(Yt, t), et(Yt, h)), u;
            }
            function g(t, e, s, i) {
                var r = t.uid, o = s.cache[r], n = o.$updater, a = o.$cache, h = e.type, c = e.props, l = w(i, h.contextTypes);
                if (delete s.cache[r], s.cache[e.uid] = o, a.parentContext = i, o.componentWillReceiveProps) {
                    var p = !n.isPending;
                    p && (n.isPending = !0), o.componentWillReceiveProps(c, l), p && (n.isPending = !1);
                }
                return t.ref !== e.ref && (O(t.refs, t.ref, o), D(e.refs, e.ref, o)), n.emitUpdate(c, l), 
                a.node;
            }
            function k(t, e) {
                var s = t.uid, i = e.cache[s], r = i.$cache;
                delete e.cache[s], O(t.refs, t.ref, i), i.setState = i.forceUpdate = J, i.componentWillUnmount && i.componentWillUnmount(), 
            ...
            function C(e, s) {
                $t = e.refs;
                var i = e.render();
                if (null === i || i === !1) i = t(Ht); else if (!i || !i.vtype) throw new Error("@" + e.constructor.name + "#render:You may have returned undefined, an array or some other invalid object");
                return $t = null, i;
            }
            function M(t, e) {
            ...
            function A(t, i, r, o) {
                ...
                n = e(i, o, r.namespaceURI), r.parentNode.replaceChild(n, r)) : (t !== i || o) && (n = s(t, i, r, o)), 
                n;
            }
            function E() {
                return this;
            ...
            function D(t, e, s) {
                null != e && s && (s.nodeName && !s.getDOMNode && (s.getDOMNode = E), Z(e) ? e(s) : t && (t[e] = s));
            }
            function O(t, e, s) {
                null != e && (Z(e) ? e(null) : t && t[e] === s && delete t[e]);
            }
            function _(t, e, s) {
            ...
            function U(t, e, s) {
                ...
                if (i[e] = s, 1 === Zt[e]) return void (t[e] = V);
                if (ee[e] || (document.addEventListener(e.substr(2), I, !1), ee[e] = !0), Jt && e === te) return void t.addEventListener("click", Qt, !1);
                t.nodeName;
                "onchange" === e && U(t, "oninput", s);
            }
            function F(t, e) {
                e = B(e);
                var s = t.eventStore || (t.eventStore = {});
                if (delete s[e], 1 === Zt[e]) return void (t[e] = null);
                if (Jt && e === te) return void t.removeEventListener("click", Qt, !1);
                t.nodeName;
                "onchange" === e && delete s.oninput;
            }
            function I(t) {
                var e = t.target, s = t.type, i = "on" + s, r = void 0;
                for (Xt.isPending = !0; e; ) {
                    var o = e, n = o.eventStore, a = n && n[i];
                    if (a) {
                        if (r || (r = q(t)), r.currentTarget = e, a.call(e, r), r.$cancelBubble) break;
                        e = e.parentNode;
                    } else e = e.parentNode;
                }
                Xt.isPending = !1, Xt.batchUpdate();
            }
            function V(t) {
                var e = t.currentTarget || t.target, s = "on" + t.type, i = q(t);
                i.currentTarget = e, Xt.isPending = !0;
                var r = e.eventStore, o = r && r[s];
                o && o.call(e, i), Xt.isPending = !1, Xt.batchUpdate();
            }
            function q(t) {
                var e = {}, s = function() {
            ...
            function z(t, e, s) {
                if (e !== s) {
                    if (!s && e) return void K(t, e);
                    if (s && !e) return void H(t, s);
                    for (var i in e) s.hasOwnProperty(i) ? s[i] !== e[i] && $(t, i, s[i]) : t[i] = "";
                    for (var i in s) e.hasOwnProperty(i) || $(t, i, s[i]);
                }
            }
            function j(t, e) {
            ...
            function $(t, e, s) {
                return !se[e] && re.test(s) ? void (t[e] = s + "px") : ("float" === e && (e = "cssFloat"), 
            ...
            function W(t) {
                ...
                for (var o in e) if (e.hasOwnProperty(o)) {
                    ...
                    ce[o] = {
                        ...
                        mustUseProperty: Y(n, le),
                        hasBooleanValue: Y(n, pe),
                        hasNumericValue: Y(n, ue),
                        hasPositiveNumericValue: Y(n, de),
                        hasOverloadedBooleanValue: Y(n, fe)
                    };
                }
            }
            function Y(t, e) {
            ...
            function X(t, e, s) {
                var i = ce.hasOwnProperty(e) && ce[e];
                if (i) if (null == s || i.hasBooleanValue && !s || i.hasNumericValue && isNaN(s) || i.hasPositiveNumericValue && s < 1 || i.hasOverloadedBooleanValue && s === !1) G(t, e); else if (i.mustUseProperty) {
                    var r = i.propertyName;
                    "value" === r && "" + t[r] == "" + s || (t[r] = s);
                } else {
                    var o = i.attributeName, n = i.attributeNamespace;
                    n ? t.setAttributeNS(n, o, "" + s) : i.hasBooleanValue || i.hasOverloadedBooleanValue && s === !0 ? t.setAttribute(o, "") : t.setAttribute(o, "" + s);
                } else he(e) && ae.test(e) && (null == s ? t.removeAttribute(e) : t.setAttribute(e, "" + s));
            }
            function G(t, e) {
                var s = ce.hasOwnProperty(e) && ce[e];
                if (s) if (s.mustUseProperty) {
                    var i = s.propertyName;
                    s.hasBooleanValue ? t[i] = !1 : "value" === i && "" + t[i] == "" || (t[i] = "");
                } else t.removeAttribute(s.attributeName); else he(e) && t.removeAttribute(e);
            }
            function Z(t) {
            ...
            function ot(t, e, s, i) {
                we.test(e) ? U(t, e, s) : "style" === e ? H(t.style, s) : e === Bt ? s && null != s.__html && (t.innerHTML = s.__html) : i ? null == s ? t.removeAttribute(e) : t.setAttribute(e, "" + s) : X(t, e, s);
            }
            function nt(t, e, s, i) {
                we.test(e) ? F(t, e) : "style" === e ? K(t.style, s) : e === Bt ? t.innerHTML = "" : i ? t.removeAttribute(e) : G(t, e);
            }
            function at(t, e, s, i, r) {
                if ("value" !== e && "checked" !== e || (i = t[e]), s !== i) return void 0 === s ? void nt(t, e, i, r) : void ("style" === e ? z(t.style, i, s) : ot(t, e, s, r));
            }
            function ht(t, e, s) {
                for (var i in e) "children" !== i && ot(t, i, e[i], s);
            }
            function ct(t, e, s, i) {
                for (var r in e) "children" !== r && (s.hasOwnProperty(r) ? at(t, r, s[r], e[r], i) : nt(t, r, e[r], i));
                for (var r in s) "children" === r || e.hasOwnProperty(r) || ot(t, r, s[r], i);
            }
            function lt(t) {
                return !(!t || t.nodeType !== Kt && t.nodeType !== zt && t.nodeType !== jt);
            }
            function pt(t, s, i, r) {
                if (!t.vtype) throw new Error("cannot render " + t + " to container");
                if (!lt(s)) throw new Error("container " + s + " is not a DOM element");
                var o = s[Ft] || (s[Ft] = rt()), n = Ce[o];
                if (n) return void (n === !0 ? Ce[o] = n = {
                    vnode: t,
                    callback: i,
                    parentContext: r
                } : (n.vnode = t, n.parentContext = r, n.callback = n.callback ? tt(n.callback, i) : i));
                Ce[o] = !0;
                var a = null, h = null;
                if (a = Me[o]) h = A(a, t, s.firstChild, r); else {
                ...
                Me[o] = t;
                var l = Xt.isPending;
                Xt.isPending = !0, T(), n = Ce[o], delete Ce[o];
                var p = null;
                return "object" == typeof n ? p = pt(n.vnode, s, n.callback, n.parentContext) : t.vtype === It ? p = h : t.vtype === qt && (p = h.cache[t.uid]), 
                l || (Xt.isPending = !1, Xt.batchUpdate()), i && i.call(p), p;
            }
            function ut(t, e, s) {
                return pt(t, e, s);
            }
            ...
            function ft(t) {
                ...
                var e = t[Ft], s = null;
                return !!(s = Me[e]) && (a(s, t.firstChild), t.removeChild(t.firstChild), delete Me[e], 
                !0);
            }
            function yt(t) {
            ...
            function mt(e, s, i) {
                var r = null;
                if ("string" == typeof e) r = It; else {
                    if ("function" != typeof e) throw new Error("React.createElement: unexpect type [ " + e + " ]");
                    r = e.prototype && e.prototype.isReactComponent ? qt : Vt;
                }
                var o = null, n = null, a = {};
                if (null != s) for (var h in s) s.hasOwnProperty(h) && ("key" === h ? void 0 !== s.key && (o = "" + s.key) : "ref" === h ? void 0 !== s.ref && (n = s.ref) : a[h] = s[h]);
            ...
            function wt(t, e, s) {
                ...
                kt(t, function(t, o) {
                    ...
                    var a = n.key = St(t, o);
                    r.hasOwnProperty(a) ? r[a] += 1 : r[a] = 0, n.index = r[a], et(i, n);
                });
                var o = [];
                return i.forEach(function(t) {
                    var e = t.child, s = t.key, i = t.index, n = t.isEqual;
                    if (null != e && "boolean" != typeof e) {
                        if (!vt(e) || null == s) return void et(o, e);
                        0 !== r[s] && (s += ":" + i), n || (s = Pt(e.key || "") + "/" + s), e = bt(e, {
                            key: s
                        }), et(o, e);
                    }
                }), o;
            ...
            function St(t, e) {
                var s = void 0;
                return s = vt(t) && "string" == typeof t.key ? ".$" + t.key : "." + e.toString(36);
            }
            function Pt(t) {
                return ("" + t).replace(De, "//");
            }
            function Tt(t, e) {
                t.forEach(function(t) {
                    t && (ge(t.mixins) && Tt(t.mixins, e), e(t));
                });
            }
            function At(t, e) {
                for (var s in e) if (e.hasOwnProperty(s)) {
                    ...
                    if ("getInitialState" !== s) {
                        var r = t[s];
                        Z(r) && Z(i) ? t[s] = tt(r, i) : t[s] = i;
                    } else et(t.$getInitialStates, i);
                }
            }
            function Et(t, e) {
                ...
                it(t, e.statics), Z(e.getDefaultProps) && (t.defaultProps = t.defaultProps || {}, 
                it(t.defaultProps, e.getDefaultProps()));
            }
            function Dt(t, e) {
                for (var s in e) e.hasOwnProperty(s) && Z(e[s]) && (t[s] = e[s].bind(t));
            }
            function Ot() {
                var t = this, e = {}, s = this.setState;
                return this.setState = _e, this.$getInitialStates.forEach(function(s) {
                    Z(s) && it(e, s.call(t));
                }), this.setState = s, e;
            }
            function _t(t) {
                function e(s, i) {
                    L.call(this, s, i), this.constructor = e, t.autobind !== !1 && Dt(this, e.prototype), 
                ...
                var r = e.prototype = new _e();
                return r.$getInitialStates = [], Tt(i, function(t) {
                    At(r, t), Et(e, t);
                }), r.getInitialState = Ot, t.mixins = s, e;
            }
            function Rt(t, e) {
                if (t === e) return !0;
            ...
            var Bt = "dangerouslySetInnerHTML", Ut = "http://www.w3.org/2000/svg", Ft = "liteid", It = 2, Vt = 3, qt = 4, Ht = 5, Kt = 1, zt = 9, jt = 11, $t = null, Wt = [], Yt = [], Xt = {
                updaters: [],
                isPending: !1,
                add: function(t) {
                    et(this.updaters, t);
            ...
            R.prototype = {
                emitUpdate: function(t, e) {
                    this.nextProps = t, this.nextContext = e, t || !Xt.isPending ? this.updateComponent() : Xt.add(this);
                },
                updateComponent: function() {
                    ...
                    N(t, s, this.getState(), i, this.clearCallbacks));
                },
                addState: function(t) {
                ...
                getState: function() {
                    ...
                    return e.length && (s = it({}, s), e.forEach(function(e) {
                        var r = ge(e);
                        r && (e = e[0]), Z(e) && (e = e.call(t, s, i)), r ? s = it({}, e) : it(s, e);
                    }), e.length = 0), s;
                },
            ...
            L.prototype = {
                ...
                forceUpdate: function(t) {
                    ...
                    if (s.isMounted) {
                        var n = s.props || i, a = s.state || r, h = s.context || o, c = s.parentContext, l = s.node, p = s.vnode;
                        ...
                        d !== l && (d.cache = d.cache || {}, _(d.cache, l.cache, d)), s.vnode = u, s.node = d, 
                        T(), this.componentDidUpdate && this.componentDidUpdate(i, r, o), t && t.call(this), 
            ...
            var Zt = {
                ...
                ondragover: 1,
                oncontextmenu: 1
            }, Jt = "ontouchstart" in document, Qt = function() {}, te = "onclick", ee = {}, se = {
            ...
            var re = /^-?\d+(\.\d+)?$/, oe = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", ne = oe + "\\-.0-9\\uB7\\u0300-\\u036F\\u203F-\\u2040", ae = new RegExp("^[" + oe + "][" + ne + "]*$"), he = RegExp.prototype.test.bind(new RegExp("^(data|aria)-[" + ne + "]*$")), ce = {}, le = 1, pe = 4, ue = 8, de = 24, fe = 32, ye = {
                props: {
                    accept: 0,
                    acceptCharset: 0,
                    accessKey: 0,
                ...
                domProps: {}
            }, me = "http://www.w3.org/1999/xlink", ve = "http://www.w3.org/XML/1998/namespace", be = {
            ...
            Object.keys(be).map(function(t) {
                xe.props[t] = 0, be[t] && (xe.domAttrs[t] = be[t]);
            }), W(ye), W(xe);
            var ge = Array.isArray, ke = 0, we = /^on/i;
            Object.freeze || (Object.freeze = Q);
            var Ce = {}, Me = {}, Se = Object.freeze({
                render: ut,
                unstable_renderSubtreeIntoContainer: dt,
                unmountComponentAtNode: ft,
                findDOMNode: yt
            }), Pe = "a|abbr|address|area|article|aside|audio|b|base|bdi|bdo|big|blockquote|body|br|button|canvas|caption|cite|code|col|colgroup|data|datalist|dd|del|details|dfn|dialog|div|dl|dt|em|embed|fieldset|figcaption|figure|footer|form|h1|h2|h3|h4|h5|h6|head|header|hgroup|hr|html|i|iframe|img|input|ins|kbd|keygen|label|legend|li|link|main|map|mark|menu|menuitem|meta|meter|nav|noscript|object|ol|optgroup|option|output|p|param|picture|pre|progress|q|rp|rt|ruby|s|samp|script|section|select|small|source|span|strong|style|sub|summary|sup|table|tbody|td|textarea|tfoot|th|thead|time|title|tr|track|u|ul|var|video|wbr|circle|clipPath|defs|ellipse|g|image|line|linearGradient|mask|path|pattern|polygon|polyline|radialGradient|rect|stop|svg|text|tspan", Te = {};
            ...
            _e.prototype = L.prototype, Lt.prototype = Object.create(L.prototype), Lt.prototype.constructor = Lt, 
            Lt.prototype.isPureReactComponent = !0, Lt.prototype.shouldComponentUpdate = Nt;
            var Re = it({
                version: "0.15.1",
                cloneElement: bt,
                isValidElement: vt,
            ...
            return Re.__SECRET_DOM_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Se, Re;
        });
    },
    121: function(t, e, s) {
        "use strict";
        ...
        (function(s) {
            (function() {
                ...
                function f(t, e, s) {
                    ...
                    for (var r, o, a, h, c, l = 1 / 0, p = -1, u = 0; u < n.vcolors.length; u++) {
                        if (r = n.vcolors[u], o = r[0], a = r[1], h = r[2], c = f.distance(t, e, s, o, a, h), 
                        0 === c) {
                            p = u;
                            break;
                        }
                ...
                }, l(o, s), o.prototype.pipe = function(t, e) {
                    function s() {
                ...
                var b = 0, x = 1, g = 2, k = 3, w = 4, C = 5, M = 6, S = {
                    type: "udk"
                };
                l(n, o), n.tangoColors = [ "#2e3436", "#cc0000", "#4e9a06", "#c4a000", "#3465a4", "#75507b", "#06989a", "#d3d7cf", "#555753", "#ef2929", "#8ae234", "#fce94f", "#729fcf", "#ad7fa8", "#34e2e2", "#eeeeec" ], 
                ...
                n.vcolors = function() {
                    ...
                    var t = this.document;
                    n._boundDocs = n._boundDocs || [], ~u(n._boundDocs, t) || (n._boundDocs.push(t), 
                    ...
                    "useFocus" in this.options && !this.options.useFocus || T(function() {
                        s.element.focus();
                    }, 100), null == n.brokenBold && (n.brokenBold = p(this.document)), this.emit("open");
                    ...
                    function i(t, e) {
                        ...
                        var i = [];
                        s(i, t), s(i, e.x), s(i, e.y), l.send("[M" + P.fromCharCode.apply(P, i));
                    }
                    function r(t) {
                        var e, s, i, r, o;
                        switch (t.type) {
                        ...
                        l.vt200Mouse ? o &= r : l.normalMouse || (o = 0), e = 32 + (o << 2) + e;
                    }
                    function o(t) {
                        var e, s, i, r, o;
                        if (null != t.pageX) {
                            for (e = t.pageX, s = t.pageY, o = l.element; o && o !== l.document.documentElement; ) e -= o.offsetLeft, 
                    ...
                    var n = this.element, l = this, p = 32, u = "onmousewheel" in this.context ? "mousewheel" : "DOMMouseScroll";
                    a(n, "mousedown", function(s) {
                        if (l.mouseEvents) return t(s), l.focus(), l.normalMouse && a(l.document, "mousemove", e), 
                    ...
                    var s, i, r, o, a, h, c, l, p, u, f, y, m, v;
                    for (e - t >= this.rows / 2 && (v = this.element.parentNode, v && v.removeChild(this.element)), 
                    c = this.cols, i = t, e >= this.lines.length && (this.log("`end` is too large. Most likely a bad CSR."), 
                    e = this.lines.length - 1); i <= e; i++) {
                        ...
                        p = this.defAttr, r = 0; r < c; r++) {
                            switch (l = o[r][0], h = o[r][1], r === s && (l = -1), l !== p && (p !== this.defAttr && (a += "</span>"), 
                            l !== this.defAttr && (l === -1 ? a += '<span class="reverse-video terminal-cursor">' : (a += this.useStyle ? '<span class="' : '<span style="', 
                            u = 511 & l, f = l >> 9 & 511, y = l >> 18, 1 & y && (n.brokenBold || (a += this.useStyle ? "term-bold " : "font-weight:bold;"), 
                            ...
                            8 & y && (u = l >> 9 & 511, f = 511 & l, 1 & y && f < 8 && (f += 8)), 16 & y && (a += this.useStyle ? "term-hidden " : "visibility:hidden;"), 
                            256 !== u && (a += this.useStyle ? "term-bg-color-" + u + " " : "background-color:" + this.colors[u] + ";"), 
                    ...
                    c(t)) : (this.emit("keydown", t), this.emit("key", e, t), this.showCursor(), this.handler(e), 
                    c(t)));
                ...
                n.prototype.requestLocatorPosition = function(t) {}, n.prototype.insertColumns = function() {
                    ...
                    if (this._selected) {
                        ...
                        o = r, r = h), l = n; l <= a; l++) for (c = 0, p = this.cols - 1, l === n && (c = r), 
                        l === a && (p = o); c <= p; c++) null != this.lines[l][c].old && (u = this.lines[l][c].old, 
                    ...
                    if ("y" !== e) {
                        ...
                        if ("{" === e || "}" === e) {
                            var c, l, r = this.x, o = this.y, n = this.ydisp, p = !1, u = !1, d = -1, s = this.y + ("{" === e ? -1 : 1), a = this.ydisp;
                    ...
                    if ("\r" === e || !this.searchMode && ("n" === e || "N" === e)) {
                        ...
                        for (var i, r, o, n = this.x, a = this.y, h = this.ydisp, c = !1, l = !1, p = this.x + 1, u = this.ydisp + this.y, d = "N" === e ? this.searchDown : !this.searchDown; ;) {
                            for (i = this.lines[u]; p < this.cols; ) {
                                for (o = 0; o < s.length && !(p + o >= this.cols) && i[p + o][1] === s[o]; o++) if (i[p + o][1] === s[o] && o === s.length - 1) {
                                    c = !0;
                                    break;
                                }
                                if (c) break;
                ...
                }, n.EventEmitter = s, n.Stream = o, n.inherits = l, n.on = a, n.off = h, n.cancel = c, 
                i = [], r = function() {
                    return n;
