!function(t) {
    ...
    5: function(t, e, i) {
        ...
        t.exports = s.extend({}, o, {
            render: function(t, e, i) {
                return e || (e = {}), n(o.render(t, e, i));
            },
            to_html: function(t, e, i, s) {
                return e || (e = {}), n(o.to_html(t, e, i, s));
            },
            clearCache: function() {
	 ...
	 */
        !function(i, a) {
            "object" == typeof e && e && "string" != typeof e.nodeName ? a(e) : (s = [ e ], 
            n = a, o = "function" == typeof n ? n.apply(e, s) : n, !(void 0 !== o && (t.exports = o)));
        }(this, function(t) {
            function e(t) {
            ...
            function l(e, i) {
                ...
                for (var D, C, T, M, S, z, U = new u(e); !U.eos(); ) {
                    if (D = U.pos, T = U.scanUntil(r)) for (var $ = 0, F = T.length; $ < F; ++$) M = T.charAt($), 
                    a(M) ? g.push(f.length) : y = !0, f.push([ "text", M, D, D + 1 ]), D += 1, "\n" === M && s();
                    if (!U.scan(r)) break;
                    if (v = !0, C = U.scan(k) || "name", U.scan(_), "=" === C ? (T = U.scanUntil(b), 
                    U.scan(b), U.scanUntil(l)) : "{" === C ? (T = U.scanUntil(d), U.scan(w), U.scanUntil(l), 
            ...
            u.prototype.eos = function() {
                ...
                if (n.hasOwnProperty(t)) i = n[t]; else {
                    for (var o, a, r = this, l = !1; r; ) {
                        if (t.indexOf(".") > 0) for (i = r.view, o = t.split("."), a = 0; null != i && a < o.length; ) a === o.length - 1 && (l = s(i, o[a])), 
                        i = i[o[a++]]; else i = r.view[t], l = s(r.view, t);
                        if (l) break;
                        r = r.parent;
                    }
                    n[t] = i;
                ...
                var n = this.parse(t), s = e instanceof d ? e : new d(e);
                return this.renderTokens(n, s, i, t);
            }, p.prototype.renderTokens = function(t, e, i, n) {
                for (var s, o, a, r = "", l = 0, c = t.length; l < c; ++l) a = void 0, s = t[l], 
                o = s[0], "#" === o ? a = this.renderSection(s, e, i, n) : "^" === o ? a = this.renderInverted(s, e, i, n) : ">" === o ? a = this.renderPartial(s, e, i, n) : "&" === o ? a = this.unescapedValue(s, e) : "name" === o ? a = this.escapedValue(s, e) : "text" === o && (a = this.rawValue(s)), 
                void 0 !== a && (r += a);
                return r;
            }, p.prototype.renderSection = function(t, i, n, s) {
                function o(t) {
                    return a.render(t, i, n);
                }
                var a = this, r = "", l = i.lookup(t[1]);
                if (l) {
                    if (m(l)) for (var c = 0, h = l.length; c < h; ++c) r += this.renderTokens(t[4], i.push(l[c]), n, s); else if ("object" == typeof l || "string" == typeof l || "number" == typeof l) r += this.renderTokens(t[4], i.push(l), n, s); else if (e(l)) {
                        if ("string" != typeof s) throw new Error("Cannot use higher-order sections without the original template");
                        l = l.call(i.view, s.slice(t[3], t[5]), o), null != l && (r += l);
                    } else r += this.renderTokens(t[4], i, n, s);
                    return r;
                }
            }, p.prototype.renderInverted = function(t, e, i, n) {
                var s = e.lookup(t[1]);
                if (!s || m(s) && 0 === s.length) return this.renderTokens(t[4], e, i, n);
            }, p.prototype.renderPartial = function(t, i, n) {
                if (n) {
                    var s = e(n) ? n(t[1]) : n[t[1]];
            ...
            t.clearCache = function() {
                ...
                var a = t.render(i, n, s);
                return e(o) ? void o(a) : a;
            }, t.escape = r, t.Scanner = u, t.Context = d, t.Writer = p;
        });
    },
    132: function(t, e, i) {
        "use strict";
        ...
        !function(t, e) {
            ...
            c.prototype = {
                ...
                _process_options: function(s) {
                    ...
                    switch (m[a] || (a = a.split("-")[0], m[a] || (a = p.language)), o.language = a, 
                    o.startView) {
                      case 2:
                      case "decade":
                        o.startView = 2;
                    ...
                    if (o.defaultViewDate) {
                        var u = o.defaultViewDate.year || new Date().getFullYear(), d = o.defaultViewDate.month || 0, f = o.defaultViewDate.day || 1;
                        o.defaultViewDate = i(u, d, f);
                ...
                place: function() {
                    ...
                    var c = Math.max.apply(Math, l) + 10, h = this.component ? this.component.parent().offset() : this.element.offset(), u = this.component ? this.component.outerHeight(!0) : this.element.outerHeight(!1), d = this.component ? this.component.outerWidth(!0) : this.element.outerWidth(!1), p = h.left - r.left, f = h.top - r.top;
                    ...
                    p = h.left + d - e) : this.picker.addClass("datepicker-orient-left");
                    var m, g, v = this.o.orientation.y;
                    if ("auto" === v && (m = -a + f - i, g = a + o - (f + u + i), v = Math.max(m, g) === g ? "top" : "bottom"), 
                    this.picker.addClass("datepicker-orient-" + v), "top" === v ? f += u : f -= i + parseInt(this.picker.css("padding-top")), 
                    this.o.rtl) {
                        var y = s - (p + d);
                        this.picker.css({
                            top: f,
                ...
                fill: function() {
                    ...
                    if (!isNaN(o) && !isNaN(a)) {
                        ...
                        var p = i(o, a - 1, 28), f = g.getDaysInMonth(p.getUTCFullYear(), p.getUTCMonth());
                        p.setUTCDate(f), p.setUTCDate(f - (p.getUTCDay() - this.o.weekStart + 7) % 7);
                        var v = new Date(p);
                        v.setUTCDate(v.getUTCDate() + 42), v = v.valueOf();
                        for (var y, _ = []; p.valueOf() < v; ) {
                            if (p.getUTCDay() === this.o.weekStart && (_.push("<tr>"), this.o.calendarWeeks)) {
                                var x = new Date(+p + (this.o.weekStart - p.getUTCDay() - 7) % 7 * 864e5), b = new Date(Number(x) + (11 - x.getUTCDay()) % 7 * 864e5), w = new Date(Number(w = i(b.getUTCFullYear(), 0, 1)) + (11 - w.getUTCDay()) % 7 * 864e5), k = (b - w) / 864e5 / 7 + 1;
                            ...
                            y = t.unique(y), _.push('<td class="' + y.join(" ") + '"' + (n ? ' title="' + n + '"' : "") + ">" + p.getUTCDate() + "</td>"), 
                            n = null, p.getUTCDay() === this.o.weekEnd && _.push("</tr>"), p.setUTCDate(p.getUTCDate() + 1);
                        }
            ...
            var u = t.fn.datepicker, d = function(i) {
                ...
                return this.each(function() {
                    ...
                    if (!l) {
                        var d = a(this, "date"), f = t.extend({}, p, d, u), m = r(f.language), g = t.extend({}, p, m, d, u);
            ...
            var m = t.fn.datepicker.dates = {
                ...
                parseDate: function(n, s, o) {
                    ...
                    var p, f, v = {}, y = [ "yyyy", "yy", "M", "MM", "m", "mm", "d", "dd" ], _ = {
                        yyyy: function(t, e) {
                    ...
                    if (d.length !== x.length && (x = t(x).filter(function(e, i) {
                        ...
                        var b;
                        for (h = 0, b = x.length; h < b; h++) {
                            if (p = parseInt(d[h], 10), r = x[h], isNaN(p)) switch (r) {
                              case "MM":
                                f = t(m[o].months).filter(a), p = t.inArray(f[0], m[o].months) + 1;
                                break;

                              case "M":
                                f = t(m[o].monthsShort).filter(a), p = t.inArray(f[0], m[o].monthsShort) + 1;
                            }
                            v[r] = p;
                        }
                        var w, k;
    ...
    134: function(t, e, i) {
        ...
        function r() {
            var t = this, e = y.dbus("org.freedesktop.timedate1"), i = e.proxy(), n = null, s = null;
            ...
            t.timesyncd_service = b.proxy("systemd-timesyncd.service"), Object.defineProperty(t, "utc_fake_now", {
                ...
                return null === s ? t.update() : y.resolve();
            }, t.update = function() {
                return y.spawn([ "date", "+%s:%:z" ], {
                    ...
                    n = o - r.valueOf(), s = a, v(t).triggerHandler("changed");
                }).fail(function(t) {
                    console.log("Couldn't calculate server time offset: " + y.message(t));
                });
            }, t.change_time = function(e, n, s) {
                var o = v.Deferred();
                return y.spawn([ "date", "--date=" + e + " " + n + ":" + s, "+%s" ]).fail(function(t) {
                    o.reject(t);
                }).done(function(e) {
        ...
        var v = i(2), y = i(3), _ = i(5), x = i(135), b = i(139);
        i(132), i(133), i(140);
        var w = i(141), k = i(142), D = y.gettext, C = y.gettext, T = y.permission({
            admin: !0
        });
        v(T).on("changed", n), v(T).on("changed", s);
        var M, S = {};
        l.prototype = {
            _init: function() {
            ...
            setup: function() {
                ...
                function e() {
                    a.exists ? s || (v("#server-pmlogger-switch").onoff("value", a.enabled), v("#server-pmlogger-onoff-row").show()) : v("#server-pmlogger-onoff-row").hide();
                }
                var i = this;
                ...
                }), i.plot_controls = x.setup_plot_controls(v("#server"), v("#server-graph-toolbar"));
                var s, o = b.proxy("pmcd"), a = b.proxy("pmlogger");
                v("#server-pmlogger-switch").on("change", function(t) {
                    var i = v(this).onoff("value");
                    a.exists && (s = i ? y.all(o.enable(), o.start(), a.enable(), a.start()).fail(function(t) {
            ...
            enter: function() {
                ...
                var s, r = {
                    ...
                    derive: "rate",
                    factor: .1
                }, l = x.plot_simple_template();
                v.extend(l.yaxis, {
                    tickFormatter: function(t) {
                        return t.toFixed(0);
                    },
                    max: 100
                }), i.cpu_plot = x.plot(v("#server_cpu_graph"), 300), i.cpu_plot.set_options(l), 
                s = i.cpu_plot.add_metrics_sum_series(r, {});
                var c = {
                ...
                v.extend(h.yaxis, {
                    ...
                    var e = t.getAxes();
                    v("#server_memory_unit").text(x.bytes_tick_unit(e.yaxis));
                }, i.memory_plot = x.plot(v("#server_memory_graph"), 300), i.memory_plot.set_options(h), 
                s = i.memory_plot.add_metrics_sum_series(c, {});
                var u = {
                ...
                v.extend(d.yaxis, {
                    ...
                    var e = t.getAxes();
                    v("#server_network_traffic_unit").text(x.bits_per_sec_tick_unit(e.yaxis));
                }, i.network_plot = x.plot(v("#server_network_traffic_graph"), 300), i.network_plot.set_options(d), 
                s = i.network_plot.add_metrics_sum_series(u, {});
                var p = {
                    direct: [ "disk.all.total_bytes" ],
                    internal: [ "disk.all.read", "disk.all.written" ],
                    units: "bytes",
                    derive: "rate"
                }, f = x.plot_simple_template();
                v.extend(f.yaxis, {
                    ticks: x.memory_ticks,
                    ...
                    var e = t.getAxes();
                    v("#server_disk_io_unit").text(x.bytes_per_sec_tick_unit(e.yaxis));
                }, i.disk_plot = x.plot(v("#server_disk_io_graph"), 300), i.disk_plot.set_options(f), 
                s = i.disk_plot.add_metrics_sum_series(p, {}), a().done(function(t) {
                ...
                v(window).on("resize.server", function() {
                    ...
                    v("#system-info-asset-row").toggle(!1), o("couldn't read serial dmi info: " + t);
                }), y.spawn([ "hostname" ], {
                    err: "ignore"
                }).done(function(t) {
                    i.kernel_hostname = v.trim(t), e();
                }).fail(function(t) {
                    e(), o("couldn't read kernel hostname: " + t);
            ...
            host_keys_update: function() {
                var t = this, e = /^\((.*)\)$/, i = v("#system_information_ssh_keys .spinner"), n = v("#system_information_ssh_keys .content"), s = v("#system_information_ssh_keys .alert");
                y.script(k, [], {
                    superuser: "try",
                    err: "message"
                }).done(function(o) {
            ...
            _on_apply_button: function(t) {
                var e = this, i = v("#sich-pretty-hostname").val(), n = v("#sich-hostname").val(), s = e.hostname_proxy.call("SetStaticHostname", [ n, !0 ]), o = e.hostname_proxy.call("SetPrettyHostname", [ i, !0 ]);
                v("#system_information_change_hostname").dialog("promise", y.all(s, o));
            },
            _on_full_name_changed: function(t) {
                ...
                if (this._always_update_from_pretty || this._initial_pretty_hostname != e) {
                    var i = v("#sich-hostname").val(), n = i.indexOf("."), s = e.toLowerCase().replace(/['".]+/g, "").replace(/[^a-zA-Z0-9]+/g, "-");
                    s = s.substr(0, 64), n >= 0 && (s += i.substr(n)), v("#sich-hostname").val(s), this._always_update_from_pretty = !0;
                }
                this._update();
            },
            ...
            _update: function() {
                for (var t = v("#sich-apply-button"), e = v("#sich-note-1"), i = v("#sich-note-2"), n = !1, s = !1, o = !1, a = D("Real host name can only contain lower-case characters, digits, dashes, and periods (with populated subdomains)"), r = D("Real host name must be 64 characters or less"), l = v("#sich-hostname").val().length <= 64, c = v("#sich-hostname").val(), h = v("#sich-pretty-hostname").val(), u = !0, d = 0, p = 0; p < v("#sich-hostname").val().length; p++) if ("." == v("#sich-hostname").val()[p] ? d++ : d = 0, 
                d > 1) {
                    u = !1;
                    break;
                }
                ...
                l && f && (s = !0), n && s && (o = !0), s ? (v(e).css("visibility", "hidden"), v(i).css("visibility", "hidden"), 
            ...
            get_timezones: function() {
                function t(t) {
                    ...
                    for (var s = 0; s < i.length; s++) v("#systime-timezones").append(v("<option>", {
                        value: i[s],
            ...
            get_ntp_servers: function(t) {
                function e() {
                    if ((n.exists === !1 || n.unit) && null !== s.exists) {
                        if (v([ n, s ]).off(".get_ntp_servers"), !n.exists || "systemd-timedated.service" !== n.unit.Id) return console.log("systemd-timedated not in use, ntp server configuration not supported"), 
                        void t();
                ...
                v([ n, s ]).on("changed.get_ntp_servers", e), e();
            },
            ...
            check_input: function() {
                var t, e = !1, i = !1, n = v("#systime-time-hours").val(), s = v("#systime-time-minutes").val(), o = !/^[0-9]+$/.test(n.trim()) || !/^[0-9]+$/.test(s.trim());
                return o || (n = Number(n), s = Number(s), o = n < 0 || n > 23 || s < 0 || s > 59), 
                t = new Date(v("#systime-date-input").val()), (isNaN(t.getTime()) || t.getTime() < 0) && (e = !0), 
                o && e ? v("#systime-parse-error").text(D("Invalid date format and invalid time format")) : o ? v("#systime-parse-error").text(D("Invalid time format")) : e && v("#systime-parse-error").text(D("Invalid date format")), 
                ...
                v("#systime-timezones").toggleClass("has-error", !i), v("#systime-time-hours").toggleClass("has-error", !o), 
                v("#systime-time-minutes").toggleClass("has-error", !o), v("#systime-date-input").toggleClass("has-error", !e), 
                v("#systime-parse-error").parents("tr").toggleClass("has-error", o || e), v("#systime-parse-error").toggle(o || e), 
                v("#systime-timezone-error").parents("tr").toggle(i), o || e || i ? (v("#systime-apply-button").prop("disabled", !0), 
            ...
            enter: function() {
                ...
                t.channel.follow(), t.grid.walk(), this.plot = x.setup_complicated_plot("#cpu_status_graph", t.grid, n, e), 
                a().done(function(e) {
    ...
    135: function(t, e, i) {
        ...
        function n(t, e, i, n) {
            ...
            function l() {
                g && v.width() > 0 && v.height() > 0 ? (p ? u() : (o(), p = s.plot(y, i, m)), _ && window.clearInterval(_)) : _ || (_ = window.setInterval(l, 500));
            }
            function c() {
                g = !1;
            }
            ...
            function u() {
                p && g && (o(), y.width() > 0 && y.height() > 0 && p.resize(), h());
            }
            function d() {
                s(f).trigger("destroyed"), s(window).off("resize", u), s(v).empty(), p = null;
            }
            var p, f, m = {
                colors: [ "#0099d3" ],
                legend: {
        ...
        a.plot = function(t, e, i) {
            ...
            function g(t, e) {
                ...
                function a() {
                    ...
                    d && d.close(), d = o.metrics(w, f), s(d).on("changed", t), t(), U++;
                    ...
                    function o() {
                        r = k.add(d, [ "a", i ]), l.data = k.add(function(t, e, i) {
                            for (var n = 0; n < i; n++) {
                                ...
                                p && (a = p.data[e + n][1] ? p.data[e + n][1] : p.data[e + n][2]), Math.abs(s) > u ? (t[e + n] = [ o, a + s, a ], 
            ...
            return s(t).on("plothover", y), s(t).on("mouseleave", _), s(t).on("plotselecting", x), 
            s(t).on("plotselected", b), s(t).data("flot_data", M), c(e, i), s.extend(C, {
                archives: !1,
                start_walking: r,
                stop_walking: l,
                refresh: a,
        ...
        a.format_date_tick = function(t, e) {
            ...
            var p = new Date(t), f = " ";
            return o >= n && o <= s && (f += p.getFullYear().toFixed() + " "), a >= n && a <= s && (f += c[p.getMonth()] + " "), 
            r >= n && r <= s && (f += p.getDate().toFixed() + " "), l >= n && l <= s && (f += i(p.getHours()) + ":" + i(p.getMinutes()) + " "), 
        ...
        !function(t) {
            ...
            function i(i, s, o, a) {
                ...
                function y() {
                    ...
                    var i, n, s, o, a, l, c, h, u, d, f, m, g = Number.POSITIVE_INFINITY, v = Number.NEGATIVE_INFINITY, y = Number.MAX_VALUE;
                    ...
                    for (i = 0; i < nt.length; ++i) {
                        ...
                        if (null == a.datapoints.pointsize) {
                            ...
                            for (a.xaxis.used = a.yaxis.used = !0, n = s = 0; n < f.length; ++n, s += c) {
                                d = f[n];
                                var b = null == d;
                                if (!b) for (o = 0; o < c; ++o) h = d[o], u = m[o], u && (u.number && null != h && (h = +h, 
                                isNaN(h) ? h = null : h == 1 / 0 ? h = y : h == -(1 / 0) && (h = -y)), null == h && (u.required && (b = !0), 
                                null != u.defaultValue && (h = u.defaultValue))), l[s + o] = h;
                                if (b) for (o = 0; o < c; ++o) h = l[s + o], null != h && (u = m[o], u.autoscale !== !1 && (u.x && e(a.xaxis, h, h), 
                                u.y && e(a.yaxis, h, h))), l[s + o] = null; else if (x && s > 0 && null != l[s - c] && l[s - c] != l[s] && l[s - c + 1] != l[s + 1]) {
                ...
                function w(t) {
                    ...
                    "x" == t.direction ? (i = t.scale = pt / Math.abs(s(t.max) - s(t.min)), n = Math.min(s(t.max), s(t.min))) : (i = t.scale = ft / Math.abs(s(t.max) - s(t.min)), 
                ...
                function M() {
                    ...
                    pt = ot.width - dt.left - dt.right, ft = ot.height - dt.bottom - dt.top, t.each(i, function(t, e) {
                        w(e);
                    }), n && W(), R();
                }
                function S(t) {
                ...
                function F() {
                    ...
                    var t = st.grid;
                    t.show && t.backgroundColor && I(), t.show && !t.aboveData && N();
                    for (var e = 0; e < nt.length; ++e) r(mt.drawSeries, [ lt, nt[e] ]), O(nt[e]);
                    r(mt.draw, [ lt ]), t.show && t.aboveData && N(), ot.render(), G();
                }
                function A(t, e) {
                    for (var i, n, s, o, a = p(), r = 0; r < a.length; ++r) if (i = a[r], i.direction == e && (o = e + i.n + "axis", 
                ...
                function I() {
                    lt.save(), lt.translate(dt.left, dt.top), lt.fillStyle = it(st.grid.backgroundColor, ft, 0, "rgba(255, 255, 255, 0)"), 
                ...
                function N() {
                    ...
                    i = p(), n = st.grid.borderWidth;
                    for (var f = 0; f < i.length; ++f) {
                        var m, g, v, y, _ = i[f], x = _.box, b = _.tickLength;
                        if (_.show && 0 != _.ticks.length) {
                            for (lt.lineWidth = 1, "x" == _.direction ? (m = 0, g = "full" == b ? "top" == _.position ? 0 : ft : x.top - dt.top + ("top" == _.position ? x.height : 0)) : (g = 0, 
                            m = "full" == b ? "left" == _.position ? 0 : pt : x.left - dt.left + ("left" == _.position ? x.width : 0)), 
                            ...
                            lt.beginPath(), e = 0; e < _.ticks.length; ++e) {
                                var w = _.ticks[e].v;
                                v = y = 0, isNaN(w) || w < _.min || w > _.max || "full" == b && ("object" == typeof n && n[_.position] > 0 || n > 0) && (w == _.min || w == _.max) || ("x" == _.direction ? (m = _.p2c(w), 
                                y = "full" == b ? -ft : b, "top" == _.position && (y = -y)) : (g = _.p2c(w), v = "full" == b ? -pt : b, 
                    ...
                    n.left > 0 && (lt.strokeStyle = s.left, lt.lineWidth = n.left, lt.beginPath(), lt.moveTo(0 - n.left / 2, ft + n.bottom), 
                ...
                function E(t) {
                    function e(t, e, i, n, s) {
                        ...
                        for (var c = a; c < o.length; c += a) {
                            var h = o[c - a], u = o[c - a + 1], d = o[c], p = o[c + 1];
                            if (null != h && null != d) {
                                if (u <= p && u < s.min) {
                                    if (p < s.min) continue;
                                    h = (s.min - u) / (p - u) * (d - h) + h, u = s.min;
                                } else if (p <= u && p < s.min) {
                                    if (u < s.min) continue;
                                    d = (s.min - u) / (p - u) * (d - h) + h, p = s.min;
                                }
                                if (u >= p && u > s.max) {
                                    if (p > s.max) continue;
                                    h = (s.max - u) / (p - u) * (d - h) + h, u = s.max;
                                } else if (p >= u && p > s.max) {
                                    if (u > s.max) continue;
                                    d = (s.max - u) / (p - u) * (d - h) + h, p = s.max;
                                }
                                if (h <= d && h < n.min) {
                                    if (d < n.min) continue;
                                ...
                                h == r && u == l || lt.moveTo(n.p2c(h) + e, s.p2c(u) + i), r = d, l = p, lt.lineTo(n.p2c(d) + e, s.p2c(p) + i);
                            }
                        }
                        lt.stroke();
                    }
                    function i(t, e, i) {
                        for (var n = t.points, s = t.pointsize, o = Math.min(Math.max(0, i.min), i.max), a = 0, r = !1, l = 1, c = 0, h = 0; ;) {
                            ...
                            a += s;
                            var u = n[a - s], d = n[a - s + l], p = n[a], f = n[a + l];
                            if (r) {
                                if (s > 0 && null != u && null == p) {
                                    h = a, s = -s, l = 2;
                                    continue;
                                }
                                if (s < 0 && a == c + s) {
                            ...
                            if (null != u && null != p) {
                                ...
                                if (r || (lt.beginPath(), lt.moveTo(e.p2c(u), i.p2c(o)), r = !0), d >= i.max && f >= i.max) lt.lineTo(e.p2c(u), i.p2c(i.max)), 
                ...
                function Y(t, e, i, n, s, o, a, r, l, c, h) {
                    ...
                    c ? (y = g = v = !0, m = !1, u = i, d = t, f = e + n, p = e + s, d < u && (_ = d, 
                    ...
                    v = !1), u = a.p2c(u), p = r.p2c(p), d = a.p2c(d), f = r.p2c(f), o && (l.fillStyle = o(p, f), 
                    ...
                    st.legend.show) {
                        ...
                        if (a && s.push("</tr>"), 0 != s.length) {
                            ...
                            if (null != st.legend.container) t(st.legend.container).html(u); else {
                                var d = "", p = st.legend.position, f = st.legend.margin;
                    ...
                    for (n = nt.length - 1; n >= 0; --n) if (i(nt[n])) {
                        ...
                        u.options.inverseTransform && (g = Number.MAX_VALUE), c.lines.show || c.points.show) for (s = 0; s < d.length; s += o) {
                            ...
                            if (null != v && !(v - p > m || v - p < -m || y - f > g || y - f < -g)) {
                                var _ = Math.abs(h.p2c(v) - t), x = Math.abs(u.p2c(y) - e), b = _ * _ + x * x;
                                b < r && (r = b, l = [ n, s / o ]);
                            }
                        }
                        if (c.bars.show && !l) {
                            ...
                            for (k = w + c.bars.barWidth, s = 0; s < d.length; s += o) {
                                ...
                                null != v && (nt[n].bars.horizontal ? p <= Math.max(D, v) && p >= Math.min(D, v) && f >= y + w && f <= y + k : p >= v + w && p <= v + k && f >= Math.min(D, y) && f <= Math.max(D, y)) && (l = [ n, s / o ]);
                            }
                        }
                    }
                ...
                function V(t) {
                    st.grid.hoverable && J("plothover", t, function(t) {
                ...
                function J(t, e, n) {
                    var s = rt.offset(), o = e.pageX - s.left - dt.left, a = e.pageY - s.top - dt.top, r = f({
                        left: o,
                        top: a
                    });
                ...
                gt.setData = h, gt.setupGrid = M, gt.draw = F, gt.getPlaceholder = function() {
                    ...
                    b(), i.removeData("plot").empty(), nt = [], st = null, ot = null, at = null, rt = null, 
                    lt = null, ct = null, ht = [], ut = [], mt = null, vt = [], gt = null;
                }, gt.resize = function() {
                    var t = i.width(), e = i.height();
                    ot.resize(t, e), at.resize(t, e);
                }, gt.hooks = mt, l(gt), c(o), _(), h(s), M(), F(), x();
                var vt = [], yt = null;
            }
            function n(t, e) {
            ...
            t.fn.detach || (t.fn.detach = function() {
                ...
                if (null == n) {
                    ...
                    if (null != r) for (var l in r) if (s.call(r, l)) {
                        var c = r[l];
                        for (var h in c) if (s.call(c, h)) for (var u, d = c[h].positions, p = 0; u = d[p]; p++) u.active = !1;
                    }
                } else for (var u, d = this.getTextInfo(t, n, o, a).positions, p = 0; u = d[p]; p++) u.x == e && u.y == i && (u.active = !1);
        ...
        !function(t) {
            function e(e) {
                ...
                function d(t, i) {
                    ...
                    "y" == s.selection.mode ? (f.first.x = 0, f.second.x = e.width()) : (n = u(t, "x"), 
                    f.first.x = n.axis.p2c(n.from), f.second.x = n.axis.p2c(n.to)), "x" == s.selection.mode ? (f.first.y = 0, 
                ...
                n.hooks.processOptions.push(function(n, o) {
                    t.each(n.getAxes(), function(t, n) {
                        ...
                        "time" == o.mode && (n.tickGenerator = function(t) {
                            ...
                            var y, _ = 0, x = Number.NaN;
                            do if (y = x, x = n.getTime(), i.push(x), "month" == p || "quarter" == p) if (g < 1) {
                                n.setDate(1);
                                var b = n.getTime();
                                n.setMonth(n.getMonth() + ("quarter" == p ? 3 : 1));
                                var w = n.getTime();
                                n.setTime(x + _ * r.hour + (w - b) * g), _ = n.getHours(), n.setHours(0);
                            } else n.setMonth(n.getMonth() + g * ("quarter" == p ? 3 : 1)); else "year" == p ? n.setFullYear(n.getFullYear() + g) : n.setTime(x + v); while (x < t.max && x != y);
                            return i;
                            ...
                            var p = i(n, a, o.monthNames, o.dayNames);
                            return p;
                        });
                    });
                });
    ...
    139: function(t, e, i) {
        ...
        !function() {
            ...
            function s(t) {
                function i() {
                    x.exists = "not-found" != b.LoadState || "inactive" != b.ActiveState, "activating" == b.ActiveState ? x.state = "starting" : "deactivating" == b.ActiveState ? x.state = "stopping" : "active" == b.ActiveState || "reloading" == b.ActiveState ? x.state = "running" : "failed" == b.ActiveState ? x.state = "failed" : "inactive" == b.ActiveState && x.exists ? x.state = "stopped" : x.state = void 0, 
                    "enabled" == b.UnitFileState || "linked" == b.UnitFileState ? x.enabled = !0 : "disabled" == b.UnitFileState || "masked" == b.UnitFileState ? x.enabled = !1 : x.enabled = void 0, 
                    x.unit = b, x.dispatchEvent("changed"), k.resolve();
                }
                function s() {
                ...
                t.indexOf(".") == -1 && (t += ".service"), n(function() {
                    a.LoadUnit(t).done(function(t) {
                        ...
                        e(b, i), w = o.proxy("org.freedesktop.systemd1.Service", t), w.addEventListener("changed", s), 
                        e(w, s);
                    }).fail(function(t) {
                ...
                return a.addEventListener("JobRemoved", function(t, e, i, n, s) {
                    D[i] && ("done" == s ? D[i].resolve() : D[i].reject(s), delete D[i]);
                }), x;
            }
            var o, a, r = i(3);
            t.exports = {
        ...
        !function(t) {
            ...
            e.prototype = {
                ...
                fixMenuScroll: function() {
                    ...
                    if (t.length) {
                        var e = t.position().top, i = e + t.height(), n = this.$menu.scrollTop(), s = this.$menu.height();
                        i > s ? this.$menu.scrollTop(n + i - s) : e < 0 && this.$menu.scrollTop(n + e);
                    }
                },
                keydown: function(e) {
    ...
    141: function(t, e, i) {
        ...
        function s() {
            ...
            var p = null;
            if (o && d ? p = new Error(l("Invalid date format and invalid time format")) : o ? p = new Error(l("Invalid time format")) : d && (p = new Error(l("Invalid date format"))), 
