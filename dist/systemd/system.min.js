!function(t) {
	 ...
	 */
        !function(o, a) {
            ...
            function r(e, n) {
                ...
                for (var r, u, d, f, p, m, g = a(n), v = new h(e), k = [], D = [], C = [], T = !1, M = !1; !v.eos(); ) {
                    if (r = v.pos, d = v.scanUntil(g[0])) for (var S = 0, z = d.length; S < z; ++S) f = d.charAt(S), 
                    i(f) ? C.push(D.length) : M = !0, D.push([ "text", f, r, r + 1 ]), r += 1, "\n" === f && o();
                    if (!v.scan(g[0])) break;
                    if (T = !0, u = v.scan(w) || "name", v.scan(y), "=" === u ? (d = v.scanUntil(b), 
                    v.scan(b), v.scanUntil(g[1])) : "{" === u ? (d = v.scanUntil(new RegExp("\\s*" + s("}" + n[1]))), 
                    v.scan(x), v.scanUntil(g[1]), u = "&") : d = v.scanUntil(g[1]), !v.scan(g[1])) throw new Error("Unclosed tag at " + v.pos);
                    if (p = [ u, d, r, v.pos ], D.push(p), "#" === u || "^" === u) k.push(p); else if ("/" === u) {
            ...
            var f = RegExp.prototype.test, p = /\S/, m = Object.prototype.toString, g = Array.isArray || function(t) {
            ...
            h.prototype.eos = function() {
                ...
                r[0]) {
                  case "#":
                    ...
                    if (g(l)) for (var f = 0, p = l.length; f < p; ++f) c += this.renderTokens(r[4], i.push(l[f]), s, o); else if ("object" == typeof l || "string" == typeof l) c += this.renderTokens(r[4], i.push(l), s, o); else if (n(l)) {
    ...
    101: function(t, e, i) {
        ...
        function g() {
            function t() {
                ...
                0 === t.length ? (m(n), m(i), p(e)) : 1 === t.length && "cpu" == t[0] ? (m(e), m(i), 
                p(n)) : 1 === t.length && "memory" == t[0] ? (m(e), m(n), p(i)) : (console.warn("not a system location: " + t), 
                y.location = ""), v("body").removeAttr("hidden");
            }
            var e, i, n;
            y.translate(), e = new l(), e.setup(), n = new u(), i = new d(), f(new c()), f(M = new h()), 
            v(y).on("locationchanged", t), t();
        }
        var v = i(2), y = i(3), _ = i(5), b = i(102), x = i(106);
        i(99), i(100), i(107);
        ...
        l.prototype = {
            ...
            setup: function() {
                ...
                var s, o = x.proxy("pmcd"), a = x.proxy("pmlogger");
            ...
            enter: function() {
                ...
                v.extend(d.yaxis, {
                    ...
                    e.yaxis.options.min = 0, v("#server_network_traffic_unit").text(b.bits_per_sec_tick_unit(e.yaxis));
                ...
                v.extend(p.yaxis, {
                    ...
                    var e = t.getAxes();
                    e.yaxis.datamax < 1e5 ? e.yaxis.options.max = 1e5 : e.yaxis.options.max = null, 
                    e.yaxis.options.min = 0, v("#server_disk_io_unit").text(b.bytes_per_sec_tick_unit(e.yaxis));
                }, i.disk_plot = b.plot(v("#server_disk_io_graph"), 300), i.disk_plot.set_options(p), 
                s = i.disk_plot.add_metrics_sum_series(f, {}), a().done(function(t) {
            ...
            _update: function() {
                ...
                l && p && (s = !0), n && s && (o = !0), s ? (v(e).css("visibility", "hidden"), v(i).css("visibility", "hidden"), 
                v("#sich-hostname-error").removeClass("has-error")) : !l && p ? (v("#sich-hostname-error").addClass("has-error"), 
                v(e).text(r), v(e).css("visibility", "visible"), v(i).css("visibility", "hidden")) : l && !p ? (v("#sich-hostname-error").addClass("has-error"), 
    ...
    102: function(t, e, i) {
        ...
        function n(t, e, i, n) {
            ...
            function l() {
                g && v.width() > 0 && v.height() > 0 ? (f ? u() : (o(), f = s.plot(y, i, m)), _ && window.clearInterval(_)) : _ || (_ = window.setInterval(l, 500));
            }
            function c() {
                g = !1;
            }
        ...
        !function(t) {
            ...
            function i(i, s, o, a) {
                ...
                function F() {
                    ...
                    r(mt.draw, [ lt ]), t.show && t.aboveData && N(), ot.render(), J();
                }
                function A(t, e) {
            ...
            function s(t) {
                ...
                t.indexOf(".") == -1 && (t += ".service"), n(function() {
                    a.LoadUnit(t).done(function(t) {
                        x = o.proxy("org.freedesktop.systemd1.Unit", t), x.addEventListener("changed", i), 
                        e(x, i), w = o.proxy("org.freedesktop.systemd1.Service", t), w.addEventListener("changed", s), 
                        e(w, s);
                    }).fail(function(t) {
