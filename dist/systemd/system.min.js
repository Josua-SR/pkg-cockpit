!function(t) {
        ...
        !function(i, a) {
            ...
            function l(e, i) {
                ...
                for (var D, T, C, M, S, A, E = new h(e); !E.eos(); ) {
                    if (D = E.pos, C = E.scanUntil(r)) for (var U = 0, N = C.length; U < N; ++U) M = C.charAt(U), 
    ...
    154: function(t, e, i) {
        ...
        i(3);
        var g = i(19), v = i(2), y = i(15), _ = i(155), b = i(21), x = i(156), w = i(160);
        i(152), i(153), i(161);
        var k = i(162), D = i(163), T = v.gettext, C = v.gettext, M = v.permission({
            admin: !0
        });
        ...
        r.prototype = {
            ...
            setup: function() {
                ...
                function o() {
                    ...
                    r.os_updates_icon.className = _.getSeverityIcon(n), e = T(n == _.Enum.INFO_SECURITY ? "Security Updates Available" : n >= _.Enum.INFO_NORMAL ? "Bug Fix Updates Available" : "Enhancement Updates Available"), 
                ...
                function s() {
                    r.os_updates = null, _.cancellableTransaction("GetUpdates", [ 0 ], function(t) {
                        ...
                        Package: function(t) {
                            (t < _.Enum.INFO_LOW || t > _.Enum.INFO_SECURITY) && (t = _.Enum.INFO_NORMAL), r.os_updates[t] = (r.os_updates[t] || 0) + 1;
                        }
    ...
    155: function(t, e, i) {
        ...
        function s(t, e, i) {
            ...
            }), i && (n = p.watch(t), s.push(n), p.addEventListener("notify", function(e) {
                t in e.detail && f in e.detail[t] && i(e.detail[t][f], t);
            })), s.push(p.subscribe({
                interface: f,
                path: t,
                member: "Finished"
        ...
        function a(t, e, i, n) {
            return new Promise(function(o, a) {
                p.call("/org/freedesktop/PackageKit", "org.freedesktop.PackageKit", "CreateTransaction", [], {
                    timeout: 5e3
                }).done(function(r) {
                    var l = r[0], c = void 0;
                    (i || n) && (c = s(l, i, n)), c || (c = h.default.resolve()), c.done(function() {
                        t ? p.call(l, f, t, e).done(function() {
                            return o(l);
                        }).fail(a) : o(l);
                    }).fail(a);
                }).fail(a);
        ...
        function r(t, e, i, n) {
            ...
            return new Promise(function(o, s) {
                function r(t, e) {
                    function n() {
                        p.call(e, f, "Cancel", []), l = !0;
                    }
                    i && ("Status" in t && (c = t.Status), h.waiting = u && (c === d.STATUS_WAIT || c === d.STATUS_WAITING_FOR_LOCK), 
                    "Percentage" in t && t.Percentage <= 100 && (h.percentage = t.Percentage), "AllowCancel" in t && (h.cancel = t.AllowCancel ? n : null), 
                    i(h));
                }
                var l = !1, c = void 0, u = !1, h = {
                    waiting: !1,
                    percentage: 0,
                    cancel: null
                };
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.dbus_client = e.transactionInterface = e.Enum = void 0, e.watchTransaction = s, 
        e.transaction = a, e.cancellableTransaction = r, e.getSeverityIcon = l, e.watchRedHatSubscription = c;
        var u = i(2), h = n(u), d = e.Enum = {
            EXIT_SUCCESS: 1,
            EXIT_FAILED: 2,
            EXIT_CANCELLED: 3,
        ...
        }, f = e.transactionInterface = "org.freedesktop.PackageKit.Transaction", p = e.dbus_client = h.default.dbus("org.freedesktop.PackageKit", {
            superuser: "try",
            track: !0
        }), m = [ 0, 3, 4 ];
    },
    156: function(t, e, i) {
        ...
        a.plot = function(t, e, i) {
            ...
            function v(t, e) {
                U != t ? (U && U.hover(!1), U = t, N = e, U && U.hover(N)) : N != e && (N = e, U && U.hover(N));
            }
            function y(t, e, i) {
            ...
            var w, k, D = {}, T = {}, C = [], M = [], S = null, A = !1, E = 0, U = null, N = !1;
    ...
    157: function(t, e) {
        !function(t) {
            ...
            function i(i, o, s, a) {
                ...
                function b() {
                    ot.grid.hoverable && (rt.mousemove(H), rt.bind("mouseleave", q)), ot.grid.clickable && rt.click(B), 
                    r(mt.bindEvents, [ rt ]);
                }
                function x() {
                    yt && clearTimeout(yt), rt.unbind("mousemove", H), rt.unbind("mouseleave", q), rt.unbind("click", B), 
                    r(mt.shutdown, [ rt ]);
                }
                function w(t) {
                    function e(t) {
                ...
                function N() {
                    ...
                    var t = ot.grid;
                    t.show && t.backgroundColor && O(), t.show && !t.aboveData && I();
                    for (var e = 0; e < nt.length; ++e) r(mt.drawSeries, [ lt, nt[e] ]), $(nt[e]);
                    r(mt.draw, [ lt ]), t.show && t.aboveData && I(), st.render(), J();
                }
                function z(t, e) {
                ...
                function $(t) {
                    t.lines.show && P(t), t.bars.show && L(t), t.points.show && W(t);
                }
                function P(t) {
                ...
                function R(t, e, i, n, o, s, a, r, l, c, u) {
                ...
                function L(t) {
                    function e(e, i, n, o, s, a) {
                        for (var r = e.points, l = e.pointsize, c = 0; c < r.length; c += l) null != r[c] && R(r[c], r[c + 1], r[c + 2], i, n, o, s, a, lt, t.bars.horizontal, t.bars.lineWidth);
                    }
                ...
                gt.setData = u, gt.setupGrid = M, gt.draw = N, gt.getPlaceholder = function() {
                    return i;
                ...
                }, gt.hooks = mt, l(gt), c(s), _(), u(o), M(), N(), b();
                var vt = [], yt = null;
            }
            function n(t, e) {
