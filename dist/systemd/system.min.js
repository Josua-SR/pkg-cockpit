!function(t) {
    ...
    135: function(t, e, i) {
        ...
        var g = i(2), v = i(3), y = i(136).machine_info, _ = i(5), b = i(137), x = i(141);
        i(133), i(134), i(142);
        var w = i(143), k = i(144), D = v.gettext, C = v.gettext, T = v.permission({
            admin: !0
        });
            ...
            enter: function() {
                ...
                function e() {
                    if (i.hostname_proxy) {
                        ...
                        g("#system_information_os_text").text(i.hostname_proxy.OperatingSystemPrettyName || "");
                    }
                }
                ...
                var o = {
                    ...
                    derive: "rate",
                    factor: .1
                }, a = b.plot_simple_template();
                g.extend(a.yaxis, {
                    tickFormatter: function(t) {
                        return t.toFixed(0);
                    },
                    max: 100
                }), i.cpu_plot = b.plot(g("#server_cpu_graph"), 300), i.cpu_plot.set_options(a);
                var r = {
                ...
                }), l.post_hook = function(t) {
                    var e = t.getAxes();
                    g("#server_memory_unit").text(b.bytes_tick_unit(e.yaxis));
                }, i.memory_plot = b.plot(g("#server_memory_graph"), 300), i.memory_plot.set_options(l), 
                i.memory_plot.add_metrics_sum_series(r, {});
                var c = {
                ...
                }, i.network_plot = b.plot(g("#server_network_traffic_graph"), 300), i.network_plot.set_options(h), 
                i.network_plot.add_metrics_sum_series(c, {});
                var u = {
                ...
                }, i.disk_plot = b.plot(g("#server_disk_io_graph"), 300), i.disk_plot.set_options(d), 
                i.disk_plot.add_metrics_sum_series(u, {}), y().done(function(t) {
                    g("#link-cpu").text(v.format(v.ngettext("of $0 CPU core", "of $0 CPU cores", t.cpus), t.cpus)), 
                    o.factor = .1 / t.cpus, i.cpu_plot.add_metrics_sum_series(o, {}), l.yaxis.max = t.memory, 
                    i.memory_plot.set_options(l);
    ...
    136: function(t, e, i) {
        ...
        function o(t) {
            var e, i = r[t];
            return i || (e = a.default.defer(), r[t] = i = e.promise(), a.default.spawn([ "cat", "/proc/meminfo", "/proc/cpuinfo" ], {
                host: t
            }).done(function(t) {
