!function(t) {
	 ...
	 */
        !function(o, a) {
            ...
            function r(e, n) {
                ...
                n = n || t.tags, e = e || "", "string" == typeof n && (n = n.split(f));
                for (var r, u, d, m, _, b, x = a(n), w = new h(e), k = [], D = [], C = [], T = !1, M = !1; !w.eos(); ) {
                    ...
                    if (!w.scan(x[0])) break;
                    if (T = !0, u = w.scan(y) || "name", w.scan(p), "=" === u ? (d = w.scanUntil(g), 
                    ...
                    } else "name" === u || "{" === u || "&" === u ? M = !0 : "=" === u && (x = a(n = d.split(f)));
                }
            ...
            var p = /\s*/, f = /\s+/, m = /\S/, g = /\s*=/, v = /\s*\}/, y = /#|\^|\/|>|\{|&|=|!/, _ = RegExp.prototype.test, b = Object.prototype.toString, x = Array.isArray || function(t) {
            ...
            h.prototype.eos = function() {
                ...
                r[0]) {
                  case "#":
                    ...
                    if (x(l)) for (var p = 0, f = l.length; p < f; ++p) c += this.renderTokens(r[4], i.push(l[p]), s, o); else if ("object" == typeof l || "string" == typeof l) c += this.renderTokens(r[4], i.push(l), s, o); else if (n(l)) {
                    ...
                    if (!isNaN(o) && !isNaN(a)) {
                        ...
                        for (var y, _ = []; p.valueOf() < v; ) {
                            if (p.getUTCDay() === this.o.weekStart && (_.push("<tr>"), this.o.calendarWeeks)) {
                                var b = new Date(+p + (this.o.weekStart - p.getUTCDay() - 7) % 7 * 864e5), x = new Date(Number(b) + (11 - b.getUTCDay()) % 7 * 864e5), w = new Date(Number(w = i(x.getUTCFullYear(), 0, 1)) + (11 - w.getUTCDay()) % 7 * 864e5), k = (x - w) / 864e5 / 7 + 1;
                ...
                parseDate: function(n, s, o) {
                    ...
                    if (d.length !== b.length && (b = t(b).filter(function(e, i) {
                        ...
                        for (h = 0, x = b.length; h < x; h++) {
                            if (p = parseInt(d[h], 10), r = b[h], isNaN(p)) switch (r) {
                              case "MM":
    ...
    100: function(t, e, i) {
        ...
        function d(t) {
            t.setup();
            g("#" + t.id).on("show.bs.modal", function(e) {
        ...
        var g = i(2), v = i(3), y = i(5), _ = i(101), b = i(105);
        i(98), i(99), i(106);
        var x = i(107), w = i(108), k = v.gettext, D = v.gettext, C = v.permission({
            admin: !0
        });
        g(C).on("changed", n);
        var T, M = {};
        r.prototype = {
            ...
            enter: function() {
                ...
                }, i.disk_plot = _.plot(g("#server_disk_io_graph"), 300), i.disk_plot.set_options(f), 
                a = i.disk_plot.add_metrics_sum_series(p, {}), o().done(function(t) {
            ...
            _update: function() {
                ...
                l && f && (s = !0), n && s && (o = !0), s ? (g(e).css("visibility", "hidden"), g(i).css("visibility", "hidden"), 
            ...
            set_ntp_servers: function(t, e) {
                var i, n = this;
                return i = v.format("# This file is automatically generated by Cockpit\n\n[Time]\n${0}NTP=${1}\n", e ? "" : "#", t.join(" ")), 
                v.spawn([ "mkdir", "-p", "/etc/systemd/timesyncd.conf.d" ], {
                    superuser: "try"
                }).then(function() {
    ...
    101: function(t, e, i) {
        ...
        function n(t, e, i, n) {
            ...
            function l() {
                g && 0 !== v.width() && 0 !== v.height() && (p ? u() : (o(), p = s.plot(y, i, m)));
            }
            function c() {
                g = !1;
            }
