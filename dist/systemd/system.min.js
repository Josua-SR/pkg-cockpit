!function(t) {
    ...
    8: function(t, e, i) {
        ...
        function o(t) {
            var e, i = d[t];
            return i || (e = h.default.defer(), d[t] = i = e.promise(), h.default.spawn([ "cat", "/proc/meminfo", "/proc/cpuinfo" ], {
                host: t
            }).done(function(t) {
        ...
        function s(t) {
            ...
            return t.split("\n").map(function(t) {
                ...
                if (!(i <= 0)) {
                    ...
                    e[n] = o, "chassis_type" === n && (e[n + "_str"] = p[parseInt(o)] || p[2]);
                }
            }), e;
        }
        function a(t) {
            var e, i = f[t];
            return i || (e = h.default.defer(), f[t] = i = e.promise(), h.default.spawn([ "grep", "-r", "." ], {
        ...
        function l(t) {
            var e, i = v[t];
            return i || (e = h.default.defer(), v[t] = i = e.promise(), h.default.spawn([ "udevadm", "info", "--export-db" ], {
                err: "message"
            }).done(function(t) {
	 ...
	 */
        !function(a) {
            o = [ i(12) ], n = a, s = "function" == typeof n ? n.apply(e, o) : n, !(void 0 !== s && (t.exports = s));
        }(function(t, e) {
            function i() {
    ...
    147: function(t, e, i) {
        "use strict";
        function n() {
            g(".hostname-privileged").update_privileged(T, v.format(D("The user <b>$0</b> is not permitted to modify hostnames"), T.user ? T.user.name : ""));
        }
        function o() {
            g(".shutdown-privileged").update_privileged(T, v.format(D("The user <b>$0</b> is not permitted to shutdown or restart this server"), T.user ? T.user.name : ""));
        }
        function s() {
        ...
        function m() {
            function t() {
                ...
                0 === t.length ? (f(n), f(i), p(e)) : 1 === t.length && "cpu" == t[0] ? (f(e), f(i), 
                p(n)) : 1 === t.length && "memory" == t[0] ? (f(e), f(n), p(i)) : (console.warn("not a system location: " + t), 
                v.location = ""), g("body").removeAttr("hidden");
            }
            var e, i, n;
            v.translate(), e = new r(), e.setup(), n = new h(), i = new u(), d(new l()), d(M = new c()), 
            g(v).on("locationchanged", t), t();
        }
        var g = i(12), v = i(2), y = i(8), _ = i(14), b = i(148), x = i(152);
        i(145), i(146), i(153);
        var w = i(154), k = i(155), D = v.gettext, C = v.gettext, T = v.permission({
            admin: !0
        });
        g(T).on("changed", n), g(T).on("changed", o);
        var M;
        r.prototype = {
            _init: function() {
            ...
            setup: function() {
                ...
                function e() {
                    r.exists ? o || (g("#server-pmlogger-switch").onoff("value", r.enabled), g("#server-pmlogger-onoff-row").show()) : g("#server-pmlogger-onoff-row").hide();
                }
                var i = this;
                ...
                }), i.ntp_status_tmpl = g("#ntp-status-tmpl").html(), _.parse(this.ntp_status_tmpl), 
                i.ntp_status_icon_tmpl = g("#ntp-status-icon-tmpl").html(), _.parse(this.ntp_status_icon_tmpl), 
                i.ssh_host_keys_tmpl = g("#ssh-host-keys-tmpl").html(), _.parse(this.ssh_host_keys_tmpl), 
                ...
                }), i.plot_controls = b.setup_plot_controls(g("#server"), g("#server-graph-toolbar"));
                var o, s = x.proxy("pmcd"), r = x.proxy("pmlogger");
                g("#server-pmlogger-switch").on("change", function(t) {
                    var i = g(this).onoff("value");
                    r.exists && (o = i ? v.all(s.enable(), s.start(), r.enable(), r.start()).fail(function(t) {
            ...
            enter: function() {
                function t() {
                    if (e.hostname_proxy) {
                        ...
                        t && i && i != t ? n = t + " (" + i + ")" : i && (n = i), n || (n = D("Set Host name")), 
                ...
                var n = {
                    ...
                    derive: "rate",
                    factor: .1
                }, o = b.plot_simple_template();
                g.extend(o.yaxis, {
                    tickFormatter: function(t) {
                        return t.toFixed(0);
                    },
                    max: 100
                }), e.cpu_plot = b.plot(g("#server_cpu_graph"), 300), e.cpu_plot.set_options(o);
                var a = {
                    direct: [ "mem.util.used" ],
                    internal: [ "memory.used" ],
                    units: "bytes"
                }, r = b.plot_simple_template();
                g.extend(r.yaxis, {
                    ticks: b.memory_ticks,
                    tickFormatter: b.format_bytes_tick_no_unit
                }), r.post_hook = function(t) {
                    var e = t.getAxes();
                    g("#server_memory_unit").text(b.bytes_tick_unit(e.yaxis));
                }, e.memory_plot = b.plot(g("#server_memory_graph"), 300), e.memory_plot.set_options(r), 
                ...
                g.extend(c.yaxis, {
                    ...
                    var e = t.getAxes();
                    g("#server_network_traffic_unit").text(b.bits_per_sec_tick_unit(e.yaxis));
                }, e.network_plot = b.plot(g("#server_network_traffic_graph"), 300), e.network_plot.set_options(c), 
                ...
                var h = {
                    ...
                    units: "bytes",
                    derive: "rate"
                }, u = b.plot_simple_template();
                g.extend(u.yaxis, {
                    ticks: b.memory_ticks,
                    tickFormatter: b.format_bytes_per_sec_tick_no_unit
                }), u.setup_hook = function(t) {
                    var e = t.getAxes();
                    e.yaxis.datamax < 1e5 ? e.yaxis.options.max = 1e5 : e.yaxis.options.max = null, 
                    e.yaxis.options.min = 0;
                }, u.post_hook = function(t) {
                    var e = t.getAxes();
                    g("#server_disk_io_unit").text(b.bytes_per_sec_tick_unit(e.yaxis));
                }, e.disk_plot = b.plot(g("#server_disk_io_graph"), 300), e.disk_plot.set_options(u), 
                e.disk_plot.add_metrics_sum_series(h, {}), y.cpu_ram_info().done(function(t) {
                ...
                g(window).on("resize.server", function() {
                    ...
                    g("#system_information_hardware_text").text(t.sys_vendor + " " + t.product_name);
            ...
            host_keys_update: function() {
                ...
                v.script(k, [], {
                    ...
                    var e = v.format(D("failed to list ssh host keys: $0"), t.message);
            ...
            _update: function() {
                for (var t = g("#sich-apply-button"), e = g("#sich-note-1"), i = g("#sich-note-2"), n = !1, o = !1, s = !1, a = D("Real host name can only contain lower-case characters, digits, dashes, and periods (with populated subdomains)"), r = D("Real host name must be 64 characters or less"), l = g("#sich-hostname").val().length <= 64, c = g("#sich-hostname").val(), h = g("#sich-pretty-hostname").val(), u = !0, d = 0, p = 0; p < g("#sich-hostname").val().length; p++) if ("." == g("#sich-hostname").val()[p] ? d++ : d = 0, 
                d > 1) {
                    u = !1;
                    break;
                }
                ...
                l && f && (o = !0), n && o && (s = !0), o ? (g(e).css("visibility", "hidden"), g(i).css("visibility", "hidden"), 
                g("#sich-hostname-error").removeClass("has-error")) : !l && f ? (g("#sich-hostname-error").addClass("has-error"), 
                g(e).text(r), g(e).css("visibility", "visible"), g(i).css("visibility", "hidden")) : l && !f ? (g("#sich-hostname-error").addClass("has-error"), 
            ...
            setup: function() {
                ...
                _.parse(this.ntp_servers_tmpl), g("#systime-ntp-servers").on("click", '[data-action="add"]', function() {
            ...
            check_input: function() {
                ...
                s && e ? g("#systime-parse-error").text(D("Invalid date format and invalid time format")) : s ? g("#systime-parse-error").text(D("Invalid time format")) : e && g("#systime-parse-error").text(D("Invalid date format")), 
            ...
            update_ntp_servers: function() {
                ...
                g("#systime-ntp-servers").html(_.render(t.ntp_servers_tmpl, e));
            },
            ...
            enter: function() {
                ...
                t.channel.follow(), t.grid.walk(), this.plot = b.setup_complicated_plot("#cpu_status_graph", t.grid, o, i), 
            ...
            return v.jump("/system/hwinfo", v.transport.host), !1;
        }), g(m);
    },
    148: function(t, e, i) {
        "use strict";
        ...
        !function(t) {
            ...
            function i(i, o, s, a) {
                ...
                function A() {
                    ...
                    var t = ot.grid;
                    t.show && t.backgroundColor && F(), t.show && !t.aboveData && O();
                    for (var e = 0; e < nt.length; ++e) r(mt.drawSeries, [ lt, nt[e] ]), I(nt[e]);
                    r(mt.draw, [ lt ]), t.show && t.aboveData && O(), st.render(), J();
                }
                function N(t, e) {
                ...
                function I(t) {
                    t.lines.show && E(t), t.bars.show && Y(t), t.points.show && P(t);
                }
                function E(t) {
