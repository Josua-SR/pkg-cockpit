!function(t) {
	 ...
	 */
        !function(o, a) {
            ...
            function r(e, n) {
                ...
                n = n || t.tags, e = e || "", "string" == typeof n && (n = n.split(_));
                for (var r, u, d, p, f, m, g = a(n), v = new h(e), k = [], D = [], C = [], T = !1, M = !1; !v.eos(); ) {
                    if (r = v.pos, d = v.scanUntil(g[0])) for (var S = 0, z = d.length; S < z; ++S) p = d.charAt(S), 
                    i(p) ? C.push(D.length) : M = !0, D.push([ "text", p, r, r + 1 ]), r += 1, "\n" === p && o();
                    if (!v.scan(g[0])) break;
                    if (T = !0, u = v.scan(w) || "name", v.scan(y), "=" === u ? (d = v.scanUntil(x), 
                    v.scan(x), v.scanUntil(g[1])) : "{" === u ? (d = v.scanUntil(new RegExp("\\s*" + s("}" + n[1]))), 
                    v.scan(b), v.scanUntil(g[1]), u = "&") : d = v.scanUntil(g[1]), !v.scan(g[1])) throw new Error("Unclosed tag at " + v.pos);
                    if (f = [ u, d, r, v.pos ], D.push(f), "#" === u || "^" === u) k.push(f); else if ("/" === u) {
                        if (m = k.pop(), !m) throw new Error('Unopened section "' + d + '" at ' + r);
                        if (m[1] !== d) throw new Error('Unclosed section "' + m[1] + '" at ' + r);
                    } else "name" === u || "{" === u || "&" === u ? M = !0 : "=" === u && (g = a(n = d.split(_)));
                }
                if (m = k.pop()) throw new Error('Unclosed section "' + m[1] + '" at ' + v.pos);
                return c(l(D));
            }
            function l(t) {
            ...
            var p = RegExp.prototype.test, f = /\S/, m = Object.prototype.toString, g = Array.isArray || function(t) {
            ...
            h.prototype.eos = function() {
                ...
                r[0]) {
                  case "#":
                    ...
                    if (g(l)) for (var p = 0, f = l.length; p < f; ++p) c += this.renderTokens(r[4], i.push(l[p]), s, o); else if ("object" == typeof l || "string" == typeof l) c += this.renderTokens(r[4], i.push(l), s, o); else if (n(l)) {
                  ...
                  case "^":
                    l = i.lookup(r[1]), (!l || g(l) && 0 === l.length) && (c += this.renderTokens(r[4], i, s, o));
                    break;
    ...
    101: function(t, e, i) {
        ...
        var v = i(2), y = i(3), _ = i(5), x = i(102), b = i(106);
        i(99), i(100), i(107);
        var w = i(108), k = i(109), D = y.gettext, C = y.gettext, T = y.permission({
            admin: !0
        });
