!function(e) {
    ...
    !function() {
        function t(e) {
            function t(e, t, a, n, s, r) {
                ...
                return n > 1 && (o.count = n), "abrt-notification" === e ? (o.problem = !0, o.service = r.PROBLEM_BINARY) : t < 4 && (o.warning = !0), 
                i.render(d, o);
            }
            function a() {
                return l;
            ...
            e.jquery && (e = e[0]), i.parse(r), i.parse(d), i.parse(o);
            var u = _("Reboot"), l = i.render(o, {
                message: u
            });
            return {
                render_line: t,
                ...
                append: function(t) {
                    "string" == typeof t && (t = s(t)), e.appendChild(t);
                },
                prepend: function(t) {
                    "string" == typeof t && (t = s(t)), e.firstChild ? e.insertBefore(t, e.firstChild) : e.appendChild(t);
                },
        ...
        var s = a(2), i = a(156), r = a(158), d = a(159), o = a(160), _ = s.gettext, u = s.gettext, l = {};
        l.journalctl = function() {
            function e() {
                var e, t;
                if (m.length && l.length > 0) for (e = l, l = [], t = 0; t < m.length; t++) m[t].apply(o, [ e ]); else window.clearInterval(c), 
                c = null;
            }
            var t, a, i = [], r = {
                follow: !0
            };
            for (t = 0; t < arguments.length; t++) if (a = arguments[t], "string" == typeof a) i.push(a); else if ("object" == ("undefined" == typeof a ? "undefined" : n(a))) {
            ...
            var d = [ "journalctl", "-q", "--output=json" ];
            r.count ? d.push("--lines=" + r.count) : d.push("--no-tail"), r.directory && d.push("--directory=" + r.directory), 
            r.boot ? d.push("--boot=" + r.boot) : void 0 !== r.boot && d.push("--boot"), r.since && d.push("--since=" + r.since), 
            r.until && d.push("--until=" + r.until), r.cursor && d.push("--cursor=" + r.cursor), 
            r.after && d.push("--after=" + r.after), r.reverse ? d.push("--reverse") : r.follow && d.push("--follow"), 
            d.push("--"), d.push.apply(d, i);
            var o, _ = s.defer(), u = "", l = [], m = [], c = null, h = s.spawn(d, {
                host: r.host,
                batch: 8192,
                latency: 300,
                superuser: "try"
                ...
                }), m.length && null === c && (c = window.setInterval(e, 300));
            }).done(function() {
                e(), _.resolve(l);
            }).fail(function(t) {
                "cancelled" == t.problem || 1 === t.exit_status ? (e(), _.resolve(l)) : _.reject(t);
            }).always(function() {
                window.clearInterval(c);
            });
            return o = _.promise(), o.stream = function(e) {
                return m.push(e), this;
            }, o.stop = function() {
                h.close("cancelled");
            }, o;
        }, l.printable = function(e) {
            return void 0 === e || null === e ? _("[no data]") : "string" == typeof e ? e : void 0 !== e.length ? s.format(_("[$0 bytes of binary data]"), e.length) : _("[binary data]");
        };
        var m = [ u("month-name", "January"), u("month-name", "February"), u("month-name", "March"), u("month-name", "April"), u("month-name", "May"), u("month-name", "June"), u("month-name", "July"), u("month-name", "August"), u("month-name", "September"), u("month-name", "October"), u("month-name", "November"), u("month-name", "December") ];
        l.renderer = function(e) {
            ...
            function n(e) {
                ...
                return {
                    cursor: e.__CURSOR,
                    full: e,
                    day: m[a.getMonth()] + " " + a.getDate().toFixed() + ", " + a.getFullYear().toFixed(),
            ...
            function c(e) {
                var t = n(e);
                s(p.entry, t) ? (p.count += 1, p.last_time = t.time) : (u(), p.entry && t.day == p.entry.day || (f.append(f.render_day_header(t.day)), 
            ...
            function a() {
                for (var e = l.renderer(s); s.firstChild; ) s.removeChild(s.firstChild);
    ...
    var i = a(154), r = s(i), d = a(156), o = n(d), _ = a(2), u = s(_), l = a(3), m = s(l), c = a(155), h = s(c);
    a(162), a(163), (0, r.default)(function() {
        function e(e, t) {
        ...
        function n() {
            ...
            function a(e, t) {
                ...
                a("Id"), a("Description"), a("LoadState"), a("ActiveState"), a("SubState"), t.Id && (f[e.Id] = e.path), 
                n(e);
            }
            function n(e) {
                var t = e.LoadState, a = e.ActiveState, n = e.SubState;
                if ("loaded" == t && (t = ""), e.HasFailed = "failed" == a || "" !== t, t = H(t), 
                a = H(a), n = H(n), "" !== n && n != a && (a = a + " (" + n + ")"), "" !== t && (a = t + " / " + a), 
            ...
            function i(e, t) {
                t.LastTriggerTime = (0, m.default)(e.LastTriggerUSec / 1e3).calendar();
                var a = 1e3 * j.valueOf() - x;
                e.LastTriggerUSec !== -1 && 0 !== e.LastTriggerUSec || (t.LastTriggerTime = H("unknown"));
                var n = 0;
                ...
                t.NextRunTime = (0, m.default)(n / 1e3).calendar(), e.NextElapseUSecMonotonic <= 0 && e.NextElapseUSecRealtime <= 0 && (t.NextRunTime = H("unknown"));
            }
            function d() {
                function t(e, t) {
                    return h[e].Id.localeCompare(h[t].Id);
                }
                function a(e, t, a) {
                    var n = o.render(M, {
                        heading: t,
                ...
                var n = (0, r.default)("#services-filter button.active").attr("data-pattern"), s = Object.keys(h).sort(t), i = [], d = [], _ = [], u = {
                    Description: H("Description"),
                    Id: H("Id"),
                    is_timer: ~n.indexOf("timer"),
                    Next_Run_Time: H("Next Run"),
                    Last_Trigger_Time: H("Last Trigger"),
                    Current_State: H("State")
                };
                u.is_timer ? (0, r.default)("#create-timer").show() : (0, r.default)("#create-timer").hide(), 
                s.forEach(function(t) {
                    var a = h[t];
                    a.Id && n && a.Id.match(n) && (a.UnitFileState && e(a.UnitFileState, "enabled") ? i.push(a) : a.UnitFileState && e(a.UnitFileState, "disabled") ? d.push(a) : _.push(a));
                }), a((0, r.default)("#services-list-enabled"), H("Enabled"), i), a((0, r.default)("#services-list-disabled"), H("Disabled"), d), 
                a((0, r.default)("#services-list-static"), H("Static"), _);
            }
            function _() {
                p ? y = !0 : (d(), p = window.setTimeout(l, 200));
            }
            function l() {
                p = null, y && (y = !1, d());
            }
            function c() {
                ...
                function i(e) {
                    function t(t) {
                        function i(t) {
                            t.Id == a ? t.UnitFileState = e[1] : t.aliases.push(a), n(t);
                        }
                        var r = h[t];
                        r ? i(r) : s(t, i);
                    }
                    var a = e[0].split("/").pop();
                    return d[a] = !0, a.indexOf("@") != -1 ? (h[a] = {
                        Id: a,
                        Description: u.default.format(H("$0 Template"), a),
                        UnitFileState: e[1],
                        is_timer: "timer" == a.slice(-5)
                    }, void (f[a] = a)) : void (f[a] ? t(f[a]) : U.LoadUnit(a).fail(function(e) {
                        console.log(e);
                    }).done(t));
                }
                var r = ++L, d = {};
                    ...
                    if (r == L) {
                        ...
                        U.ListUnitFiles().fail(e).done(function(e) {
                            ...
                            if (r == L) {
                                ...
                                for (a = Object.keys(h), t = 0; t < a; t++) d[h[a[t]].Id] || (console.log("R", a[t]), 
                                delete h[a[t]]);
                                _();
                            }
                        });
            ...
            var h = {}, f = {}, M = (0, r.default)("#services-units-tmpl").html();
            o.parse(M);
            var p, y, L = 0;
            (0, r.default)(U).on("UnitNew", function(e, t, a) {
                f[t] = a;
            }), (0, r.default)(U).on("JobNew JobRemoved", function(e, t, a, n, i) {
                var r = f[n];
                r && s(r);
            }), C.subscribe({
                ...
                var i = h[e];
                i && (a(i, s[1]), _());
            }), (0, r.default)(U).on("UnitFilesChanged", function(e) {
                c();
            }), (0, r.default)("#services-filter button").on("click", function() {
                (0, r.default)("#services-filter button").removeClass("active").removeAttr("aria-current"), 
                (0, r.default)(this).addClass("active").attr("aria-current", !0), _();
            }), c();
        }
        function s() {
            var e = (0, r.default)(this).attr("data-action").split(":"), t = e[0], a = e[1];
            P && U.call(t, [ O, a || "fail" ]).fail(function(e) {
                (0, r.default)("#service-error-dialog-message").text(e.toString()), (0, r.default)("#service-error-dialog").modal("show");
            });
        }
        function i() {
            var e = (0, r.default)(this).attr("data-action").split(":"), t = e[0], a = e[1];
            if (P) {
                var n = [ [ O ], !1 ];
                void 0 !== a && n.push("true" == a), U.call(t, n).done(function(e) {
                    2 != e.length || e[0] || (0, r.default)("#service-no-install-info-dialog").modal("show"), 
                    U.Reload();
                }).fail(function(e) {
                    (0, r.default)("#service-error-dialog-message").text(e.toString()), (0, r.default)("#service-error-dialog").modal("show");
                });
        ...
        function d() {
            (0, r.default)("#service-unit-primary-action>button").update_privileged(G, u.default.format(H("The user <b>$0</b> is not permitted to start or stop services"), G.user ? G.user.name : "")), 
            (0, r.default)("#service-unit-action>button").update_privileged(G, u.default.format(H("The user <b>$0</b> is not permitted to start or stop services"), G.user ? G.user.name : "")), 
            (0, r.default)("#service-file-action>button").update_privileged(G, u.default.format(H("The user <b>$0</b> is not permitted to enable or disable services"), G.user ? G.user.name : ""));
        }
        function _(e) {
            function t() {
                if (P.valid) {
                    var e, t = P.ActiveState;
                    e = "active" == t || "reloading" == t || "activating" == t ? 1 : 0;
                    var a, n = P.LoadState, _ = P.UnitFileState;
                    a = "masked" == n ? 7 : "static" == _ ? 5 : "enabled" == _ ? 2 : 0;
                    var l;
                    l = "active" == t || "reloading" == t ? P.ActiveEnterTimestamp : "inactive" == t || "failed" == t ? P.InactiveEnterTimestamp : "activating" == t ? P.InactiveExitTimestamp : P.ActiveExitTimestamp;
                    var c = "";
                    l && (c = u.default.format(H("Since $0"), (0, m.default)(l / 1e3).format("LLL")));
                    var h = o.render(N, {
                    ...
                    if (F) {
                        var p = o.render('<a data-goto-unit="{{unit}}">{{unit}}</a>', {
                            unit: F
                        });
                        M = u.default.format(H("This unit is an instance of the $0 template."), p);
                    }
                    for (var y = P.Conditions, L = [], Y = 0; Y < y.length; Y++) y[Y][4] < 0 && L.push(u.default.format(H("Condition $0=$1 was not met"), y[Y][0], y[Y][3]));
                    var k = o.render(J, {
                        Unit: P,
                        Since: c,
                        HasLoadError: "loaded" !== P.LoadState,
                        LoadError: P.LoadError ? P.LoadError[1] : null,
                        UnitFileState: W,
                        ...
                        Relationships: [ {
                            ...
                            Name: H("Conflicted By"),
                            Units: P.ConflictedBy
                        }, {
                            Name: H("Before"),
                            Units: P.Before
                        }, {
                            ...
                            Name: H("Propagates Reload To"),
                            Units: P.PropagatesReloadTo
                        }, {
                            Name: H("Reload Propagated From"),
                            Units: P.ReloadPropagatedFrom
                        }, {
                            Name: H("Joins Namespace Of"),
                            Units: P.JoinsNamespaceOf
                        } ]
                    });
                    (0, r.default)("#service-unit").html(k), (0, r.default)("#service-unit-action").on("click", "[data-action]", s), 
                    (0, r.default)("#service-unit-primary-action").on("click", "[data-action]", s), 
                    (0, r.default)("#service-file-action").on("click", "[data-action]", i), d();
                }
            }
            function a() {
                var e = o.render(I, {
                    Description: u.default.format(H("$0 Template"), O)
                });
                (0, r.default)("#service-template").html(e);
            }
            if (P && ((0, r.default)(P).off("changed"), P = null, W = null), A && (A.stop(), 
            A = null), (0, r.default)("#service-valid").hide(), (0, r.default)("#service-template").hide(), 
            (0, r.default)("#service-invalid").hide(), (0, r.default)("#service").hide(), O = e) {
                (0, r.default)("#service .breadcrumb .active").text(e);
                var n = O.indexOf("@"), _ = O.lastIndexOf(".");
                if (E = n != -1 && (n + 1 == _ || n + 1 == O.length), F = void 0, n == -1 || E || (F = O.substring(0, n + 1), 
                _ != -1 && (F += O.substring(_))), E) return a(), (0, r.default)("#service-template").show(), 
                void (0, r.default)("#service").show();
                U.LoadUnit(e).done(function(a) {
                    if (O == e) {
                        var n = C.proxy("org.freedesktop.systemd1.Unit", a);
                        P = n, n.wait(function() {
                            P == n && (t(), (0, r.default)(P).on("changed", t), (0, r.default)("#service-valid").show(), 
                            (0, r.default)("#service").show());
                        });
                    }
                }).fail(function(e) {
                    (0, r.default)("#service-error-message").text(e.toString()), (0, r.default)("#service-invalid").show(), 
                    (0, r.default)("#service").show();
                }), M(), A = h.default.logbox([ "_SYSTEMD_UNIT=" + O, "+", "COREDUMP_UNIT=" + O, "+", "UNIT=" + O ], 10), 
                (0, r.default)("#service-log").empty().append(A);
            }
        }
        function l() {
            u.default.location.go([ (0, r.default)(this).attr("data-goto-unit") ]);
        }
        function c(e) {
            if (O) {
                var a = O.indexOf("@"), n = O.lastIndexOf(".");
                if (a != -1) {
                    var s = O.substring(0, a + 1);
                    s += t(e), n != -1 && (s += O.substring(n)), u.default.location.go([ s ]);
                }
            }
        }
        function f() {
        ...
        function M() {
            ...
            e && U.GetUnitFileState(e).done(function(t) {
                O == e && (W = t, P && (0, r.default)(P).triggerHandler("changed"));
            });
        }
        function p() {
            var e = u.default.location.path;
            0 === e.length ? (_(null), a(), (0, r.default)("#services").show()) : 1 == e.length ? ((0, 
            r.default)("#services").hide(), _(u.default.location.path[0])) : (console.warn("not a init location: " + e), 
            u.default.location = ""), (0, r.default)("body").show();
        }
        function y() {
            u.default.spawn([ "cat", "/proc/uptime" ]).fail(function(e) {
                console.log(e);
            }).done(function(e) {
                var t = parseFloat(e.split(" ")[0]);
                x = parseInt(1e6 * t, 10);
            }), u.default.spawn([ "date", "+%s" ]).fail(function(e) {
                console.log(e);
            }).done(function(e) {
                j = m.default.unix(parseInt(e));
            });
        }
        function L() {
            (0, r.default)("#command").val(""), (0, r.default)("#description").val(""), (0, 
            r.default)("#servicename").val(""), v(1), (0, r.default)("span", (0, r.default)("#boot-or-specific-time")).first().text(H("After system boot")), 
            (0, r.default)("span", (0, r.default)("#drop-time")).first().text(H("Seconds")), 
            (0, r.default)("span", (0, r.default)("#drop-time")).first().attr("value", "1"), 
            (0, r.default)(".form-control").removeClass("has-error"), (0, r.default)(".has-error").hide(), 
            K = [], q = {
        ...
        function Y(e) {
            (0, r.default)("#specific-time-error-row").is(":visible") && ((0, r.default)("#specific-time-error-row").hide(), 
            (0, r.default)("#hr").removeClass("has-error"), (0, r.default)("#min").removeClass("has-error")), 
            ne.map(function(t) {
                t.index === e && (q.repeat = t);
            }), 0 === e ? ((0, r.default)("#specific-time-without-repeat").show(), (0, r.default)("#repeat-time-option").hide(), 
            (0, r.default)("#close_button").hide(), (0, r.default)("#hr").val("00"), (0, r.default)("#min").val("00")) : ((0, 
            r.default)("#specific-time-without-repeat").hide(), (0, r.default)("#repeat-time-option").show(), 
            K = [], k());
        }
        function k() {
            var e = {
                ...
                days_value: "1",
                days_text: "Monday",
                date_to_parse: new Date(j),
                date: (0, m.default)().format("YYYY-MM-DD")
            };
            44640 === q.repeat.index && (e.days_text = "1st"), D(), K.push(e), 1 === K.length ? K[0].close = "disabled" : K[0].close = "enabled", 
            g(), Z && T();
        }
        function g() {
            if ((0, r.default)("#repeat-time").html(o.render(q.repeat.render, {
                repeat: K
            })), 525600 === q.repeat.index) for (var e = new Date(j), t = new Date(e.getFullYear(), e.getMonth(), e.getDate(), 0, 0, 0, 0), a = 0; a < K.length; a++) (0, 
            r.default)("[data-index='" + a + "'][data-content='datepicker']").datepicker({
                autoclose: !0,
                todayHighlight: !0,
                format: "yyyy-mm-dd",
        ...
        function D() {
            var e = 0;
            if (60 === q.repeat.index) for (;e < K.length; e++) K[e].minutes = (0, r.default)("[data-index='" + e + "'][data-content='minutes']").val().trim(); else if (1440 === q.repeat.index) for (;e < K.length; e++) K[e].minutes = (0, 
            r.default)("[data-index='" + e + "'][data-content='minutes']").val().trim(), K[e].hours = (0, 
            r.default)("[data-index='" + e + "'][data-content='hours']").val().trim(); else if (10080 === q.repeat.index) for (;e < K.length; e++) K[e].minutes = (0, 
            r.default)("[data-index='" + e + "'][data-content='minutes']").val().trim(), K[e].hours = (0, 
            r.default)("[data-index='" + e + "'][data-content='hours']").val().trim(), K[e].days_text = (0, 
            r.default)("span", (0, r.default)("[data-content='week-days'][data-index='" + e + "']")).first().text(), 
            K[e].days_value = (0, r.default)("span", (0, r.default)("[data-content='week-days'][data-index='" + e + "']")).first().attr("value"); else if (44640 === q.repeat.index) for (;e < K.length; e++) K[e].minutes = (0, 
            r.default)("[data-index='" + e + "'][data-content='minutes']").val().trim(), K[e].hours = (0, 
            r.default)("[data-index='" + e + "'][data-content='hours']").val().trim(), K[e].days_text = (0, 
            r.default)("span", (0, r.default)("[data-content='month-days'][data-index='" + e + "']")).first().text(), 
            K[e].days_value = (0, r.default)("span", (0, r.default)("[data-content='month-days'][data-index='" + e + "']")).first().attr("value"); else if (525600 === q.repeat.index) for (;e < K.length; e++) K[e].minutes = (0, 
            r.default)("[data-index='" + e + "'][data-content='minutes']").val().trim(), K[e].hours = (0, 
            r.default)("[data-index='" + e + "'][data-content='hours']").val().trim(), K[e].date_to_parse = new Date((0, 
            r.default)("[data-index='" + e + "'] .bootstrap-datepicker").val()), K[e].date = (0, 
            m.default)(K[e].date_to_parse).format("YYYY-MM-DD");
        }
        function v(e) {
            1 == e ? ((0, r.default)("#boot").show(), (0, r.default)("#boot-error-row").hide(), 
            (0, r.default)("#specific-time-without-repeat").hide(), (0, r.default)("#specific-time-error-row").hide(), 
            (0, r.default)("#repeat-options").hide(), (0, r.default)("#repeat-time-option").hide(), 
            (0, r.default)("#boot-time").val("00"), (0, r.default)("#boot-time").removeClass("has-error"), 
            q.Calendar_or_Boot = "Boot") : 2 == e && ((0, r.default)("#boot").hide(), (0, r.default)("#boot-error-row").hide(), 
            (0, r.default)("#specific-time-error-row").hide(), (0, r.default)("#repeat-options").show(), 
            Y(0), (0, r.default)("span", (0, r.default)("#drop-repeat")).first().text(H("Don't Repeat")), 
            q.Calendar_or_Boot = "Calendar");
        }
        function w(e) {
            switch (e = Number(e)) {
              case 1:
                q.boot_time_unit = "sec";
                break;

              case 60:
                q.boot_time_unit = "min";
                break;
              ...
              case 604800:
                q.boot_time_unit = "weeks";
            }
        }
        function T() {
            Z = !1;
            var e = (0, r.default)("#servicename").val();
            if (e.trim().length < 1 ? ((0, r.default)("#servicename-error").text(H("This field cannot be empty.")), 
            (0, r.default)("#servicename-error-row").show(), (0, r.default)("#servicename").addClass("has-error"), 
            Z = !0) : /^[a-zA-Z0-9:_.@-]+$/.test(e) || ((0, r.default)("#servicename-error").text(H("Only alphabets, numbers, : , _ , . , @ , - are allowed.")), 
            (0, r.default)("#servicename-error-row").show(), (0, r.default)("#servicename").addClass("has-error"), 
            Z = !0), e = (0, r.default)("#description").val().trim(), e.length < 1 && ((0, r.default)("#description-error").text(H("This field cannot be empty.")), 
            (0, r.default)("#description-error-row").show(), (0, r.default)("#description").addClass("has-error"), 
            Z = !0), e = (0, r.default)("#command").val().trim(), e.length < 1 && ((0, r.default)("#command-error").text(H("This field cannot be empty.")), 
            (0, r.default)("#command-error-row").show(), (0, r.default)("#command").addClass("has-error"), 
            Z = !0), "Boot" == q.Calendar_or_Boot) e = (0, r.default)("#boot-time").val(), /^[0-9]+$/.test(e.trim()) || ((0, 
            r.default)("#boot-error").text(H("Invalid number.")), (0, r.default)("#boot-error-row").show(), 
            (0, r.default)("#boot-time").addClass("has-error"), Z = !0); else {
                var t = 0;
                if (0 === q.repeat.index) {
                    var a = (0, r.default)("#hr").val().trim(), n = (0, r.default)("#min").val().trim();
                    (0, r.default)("#hr-error").text(""), (0, r.default)("#min-error").text(""), /^[0-9]+$/.test(a) && a <= 23 && a >= 0 || ((0, 
                    r.default)("#hr-error").text(H("Hour needs to be a number between 0-23")), (0, r.default)("#specific-time-error-row").show(), 
                    (0, r.default)("#hr").addClass("has-error"), Z = !0), /^[0-9]+$/.test(n) && n <= 59 && n >= 0 || ((0, 
                    r.default)("#min-error").text(H("Minute needs to be a number between 0-59")), (0, 
                    r.default)("#specific-time-error-row").show(), (0, r.default)("#min").addClass("has-error"), 
                    Z = !0);
                } else if (60 === q.repeat.index) for (;t < K.length; t++) /^[0-9]+$/.test(K[t].minutes.trim()) && K[t].minutes.trim() <= 59 && K[t].minutes.trim() >= 0 || ((0, 
                r.default)("[data-index='" + t + "'][data-content='minutes']").addClass("has-error"), 
                (0, r.default)("[data-index='" + t + "'][data-content='min-error']").text(H("Minute needs to be a number between 0-59")), 
                Z = !0); else for (;t < K.length; t++) /^[0-9]+$/.test(K[t].minutes.trim()) && K[t].minutes.trim() <= 59 && K[t].minutes.trim() >= 0 || (Z = !0, 
                (0, r.default)("[data-index='" + t + "'][data-content='minutes']").addClass("has-error"), 
                (0, r.default)("[data-index='" + t + "'][data-content='min-error']").text(H("Minute needs to be a number between 0-59"))), 
                /^[0-9]+$/.test(K[t].hours.trim()) && K[t].hours.trim() <= 23 && K[t].hours.trim() >= 0 || (Z = !0, 
                (0, r.default)("[data-index='" + t + "'][data-content='hours']").addClass("has-error"), 
                (0, r.default)("[data-index='" + t + "'][data-content='hr-error']").text(H("Hour needs to be a number between 0-23"))), 
                525600 === q.repeat.index && (isNaN(K[t].date_to_parse.getTime()) || K[t].date_to_parse.getTime() < 0) && (Z = !0, 
                (0, r.default)("[data-index='" + t + "'][data-content='datepicker']").addClass("has-error"), 
                (0, r.default)("[data-index='" + t + "'][data-content='date-error']").text(H("Invalid date format."))), 
                44640 === q.repeat.index && "31" === K[t].days_value && (0, r.default)("[data-index='" + t + "'][data-content='day-error']").html(H("This day doesn't exist in all months.<br> The timer will only be executed in months that have 31st."));
            }
            return Z;
        }
        function b() {
            ...
            var e = T();
            if (e) return !1;
            if (q.name = (0, r.default)("#servicename").val().replace(/\s/g, ""), q.Description = (0, 
            r.default)("#description").val(), q.Command = (0, r.default)("#command").val(), 
            q.boot_time = (0, r.default)("#boot-time").val(), 0 === q.repeat.index) {
                q.repeat_hour = Number((0, r.default)("#hr").val().trim()), q.repeat_minute = Number((0, 
                r.default)("#min").val().trim());
                var t = new Date(j);
                q.OnCalendar = "OnCalendar=" + t.getFullYear() + "-" + (t.getMonth() + 1) + "-" + t.getDate() + " " + q.repeat_hour + ":" + q.repeat_minute + ":00";
            } else 60 === q.repeat.index ? (q.repeat_minute = K.map(function(e) {
                return Number(e.minutes);
            }), q.OnCalendar = "OnCalendar=*-*-* *:" + q.repeat_minute + ":00") : 1440 === q.repeat.index ? q.OnCalendar = K.map(function(e) {
                return "OnCalendar=*-*-* " + Number(e.hours) + ":" + Number(e.minutes) + ":00";
            }) : 10080 === q.repeat.index ? q.OnCalendar = K.map(function(e) {
                return "OnCalendar=" + e.days_text.slice(0, 3) + " *-*-* " + Number(e.hours) + ":" + Number(e.minutes) + ":00";
            }) : 44640 === q.repeat.index ? q.OnCalendar = K.map(function(e) {
                return "OnCalendar=*-*-" + e.days_value + " " + Number(e.hours) + ":" + Number(e.minutes) + ":00";
            }) : 525600 === q.repeat.index && (q.OnCalendar = K.map(function(e) {
                return "OnCalendar=*-" + (0, m.default)(e.date_to_parse).format("MM") + "-" + (0, 
                m.default)(e.date_to_parse).format("DD") + " " + Number(e.hours) + ":" + Number(e.minutes) + ":00";
            }));
            60 !== q.repeat.index && (q.OnCalendar = q.OnCalendar.toString().replace(/,/g, "\n"));
            var a = S();
            return !a && (n(), !0);
        }
        function S() {
            var e = "[Unit]\nDescription=", t = "\n[Service]\nExecStart=", a = "\n[Timer]\n", n = "[Install]\nWantedBy=timers.target\n", s = e + q.Description + t + q.Command + "\n", i = " ";
            if ("Boot" == q.Calendar_or_Boot) {
                var r = a + "OnBootSec=" + q.boot_time + q.boot_time_unit + "\n";
                i = e + q.Description + r;
            } else if ("Calendar" == q.Calendar_or_Boot) {
                var d = a + q.OnCalendar + "\n";
                i = e + q.Description + d;
            }
            i += n;
            var o = "/etc/systemd/system/" + q.name + ".service", _ = u.default.file(o, {
                superuser: "try"
            });
            _.replace(s).fail(function(e) {
                console.log(e);
            });
            var l = "/etc/systemd/system/" + q.name + ".timer";
            _ = u.default.file(l, {
                superuser: "try"
            }), _.replace(i).done(function(e) {
                U.Reload().done(function(e) {
                    U.EnableUnitFiles([ q.name + ".timer" ], !1, !1).fail(function(e) {
                        console.warn("Failed to enable timer unit:", e);
                    }), "Calendar" == q.Calendar_or_Boot && U.StartUnit(q.name + ".timer", "replace").fail(function(e) {
        ...
        u.default.translate();
        var H = u.default.gettext;
        m.default.locale(u.default.language);
        var j, x, O, P, W, E, F, A, C = u.default.dbus("org.freedesktop.systemd1", {
            superuser: "try"
        }), U = C.proxy("org.freedesktop.systemd1.Manager", "/org/freedesktop/systemd1"), z = !1, N = (0, 
        r.default)("#action-btn-tmpl").html();
        o.parse(N);
        var J = (0, r.default)("#service-unit-tmpl").html();
        o.parse(J);
        var I = (0, r.default)("#service-template-tmpl").html();
        o.parse(I);
        var R = [ {
            title: H("Start"),
            action: "StartUnit"
            ...
            title: H("Reload"),
            action: "ReloadUnit"
        } ], G = u.default.permission({
            admin: !0
        });
        (0, r.default)(G).on("changed", d);
        var B = [ {
            title: H("Enable"),
            action: "EnableUnitFiles:false"
        }, {
            title: H("Enable Forcefully"),
            ...
            title: H("Preset Forcefully"),
            action: "PresetUnitFiles:true"
        }, {
            title: H("Mask"),
            action: "MaskUnitFiles:false"
        }, {
            title: H("Mask Forcefully"),
            action: "MaskUnitFiles:true"
        }, {
            title: H("Unmask"),
            action: "UnmaskUnitFiles"
        } ];
        (0, r.default)(U).on("Reloading", function(e, t) {
            t || f();
        }), (0, r.default)(U).on("JobNew JobRemoved", function(e, t, a, n, s) {
            O == n && f();
        }), (0, r.default)(U).on("UnitFilesChanged", function(e) {
            M();
        }), (0, r.default)(u.default).on("locationchanged", p), (0, r.default)("#service-navigate-home").on("click", function() {
            u.default.location.go("/");
        }), (0, r.default)("body").on("click", "[data-goto-unit]", l), (0, r.default)("#service-template").on("click", "button", function() {
            c((0, r.default)("#service-template input").val());
        }), (0, r.default)(G).on("changed", function() {
            G.allowed === !1 && ((0, r.default)("#create-timer").addClass("accounts-privileged"), 
            (0, r.default)(".accounts-privileged").update_privileged(G, u.default.format(H("The user <b>$0</b> does not have permissions for creating timers"), G.user ? G.user.name : ""), "left"));
        }), (0, r.default)("#create-timer").on("click", function() {
            L(), (0, r.default)("#timer-dialog").modal("show"), y();
        }), (0, r.default)("#timer-dialog").on("click", "#timer-save-button", function() {
            var e = b();
            e && (0, r.default)("#timer-dialog").modal("toggle");
        }), y();
        var $ = u.default.dbus("org.freedesktop.timedate1");
        $.subscribe({
            interface: "org.freedesktop.DBus.Properties",
            member: "PropertiesChanged"
        }, y);
        var q = {}, K = [], Z = !1, Q = (0, r.default)("#repeat-hourly-tmpl").html();
        o.parse(Q);
        var X = (0, r.default)("#repeat-daily-tmpl").html();
        o.parse(X);
        var ee = (0, r.default)("#repeat-weekly-tmpl").html();
        o.parse(ee);
        var te = (0, r.default)("#repeat-monthly-tmpl").html();
        o.parse(te);
        var ae = (0, r.default)("#repeat-yearly-tmpl").html();
        o.parse(ae);
        var ne = [ {
            index: 0,
            render: ""
        ...
        (0, r.default)("#timer-dialog").on("keypress", ".form-control", function() {
            (0, r.default)(this).removeClass("has-error"), "hr" == (0, r.default)(this).attr("id") ? (0, 
            r.default)("#hr-error").text("") : "min" == (0, r.default)(this).attr("id") ? (0, 
            r.default)("#min-error").text("") : "hours" == (0, r.default)(this).attr("data-content") ? (0, 
            r.default)(this).siblings("[data-content='hr-error']").text("") : "minutes" == (0, 
            r.default)(this).attr("data-content") ? (0, r.default)(this).siblings("[data-content='min-error']").text("") : (0, 
            r.default)(this).parents("tr").next().hide();
        });
        var se = 0, ie = 0;
        (0, r.default)("#timer-dialog").on("click", "[data-content='datepicker']", function() {
            se = (0, r.default)("#timer-dialog").scrollTop(), (0, r.default)(this).removeClass("has-error"), 
            (0, r.default)("[data-index='" + (0, r.default)(this).attr("data-index") + "'][data-content='date-error']").text(""), 
            (0, r.default)(".datepicker-dropdown").css("margin-top", (0, r.default)("#timer-dialog").scrollTop()), 
            (0, r.default)(".datepicker-dropdown").css("visibility", "visible"), (0, r.default)(".datepicker-dropdown .next").show(), 
            (0, r.default)(".datepicker-dropdown .prev").show();
        }), (0, r.default)("#timer-dialog").on("click", ".datepicker.datepicker-dropdown.dropdown-menu", function() {
            ie > se ? (0, r.default)(".datepicker.datepicker-dropdown.dropdown-menu").css("margin-top", ie) : (0, 
            r.default)(".datepicker.datepicker-dropdown.dropdown-menu").css("margin-top", se);
        }), (0, r.default)("#timer-dialog").on("mouseenter", ".datepicker.datepicker-dropdown [class*='datepicker-'] thead", function() {
            ie = (0, r.default)("#timer-dialog").scrollTop();
        }), (0, r.default)(".form-table-ct").on("click", "[value]", ".btn-group.bootstrap-select.dropdown.form-control", function(e) {
            var t = (0, r.default)(this).closest(".btn-group.bootstrap-select.dropdown.form-control");
            switch ((0, r.default)("span", t).first().text(e.target.text), (0, r.default)("span", t).first().attr("value", e.currentTarget.value), 
            t.attr("id")) {
              case "boot-or-specific-time":
                v(Number(e.currentTarget.value));
                break;
        ...
        }), (0, r.default)("#repeat-time-option").on("click", ".btn.btn-default.dropdown-toggle.fa.fa-plus", k), 
        (0, r.default)(".form-table-ct").on("click", ".btn.btn-default.dropdown-toggle.pficon-close", function() {
            D(), K.splice((0, r.default)(this).attr("data-index"), 1);
            for (var e = 0; e < K.length; e++) K[e].index = e;
            1 === K.length ? K[0].close = "disabled" : K[0].close = "enabled", g(), Z && T();
        }), U.wait(function() {
	 ...
	 */
    !function(r) {
        s = [ a(154) ], n = r, i = "function" == typeof n ? n.apply(t, s) : n, !(void 0 !== i && (e.exports = i));
    }(function(e, t) {
        function a() {
