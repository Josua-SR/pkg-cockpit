!function(e) {
    ...
    n(function() {
                ...
                if (O.valid) {
                    ...
                    var p = T.render(J, {
                        ...
                        Relationships: [ {
                            ...
                            Name: A("Conflicted By"),
                            Units: O.ConflictedBy
                        }, {
                            Name: A("Before"),
                            Units: O.Before
                        }, {
                            ...
                            Name: A("Propagates Reload To"),
                            Units: O.PropagatesReloadTo
                        }, {
                            Name: A("Reload Propagated From"),
                            Units: O.ReloadPropagatedFrom
                        }, {
                            Name: A("Joins Namespace Of"),
                            Units: O.JoinsNamespaceOf
                        } ]
                    });
        ...
        function p() {
            ...
            44640 === $.repeat.index && (e.days_text = "1st"), L(), q.push(e), 1 === q.length ? q[0].close = "disabled" : q[0].close = "enabled", 
            y(), K && D();
        }
        function y() {
            if (n("#repeat-time").html(T.render($.repeat.render, {
                repeat: q
            })), 525600 === $.repeat.index) for (var e = new Date(H), t = new Date(e.getFullYear(), e.getMonth(), e.getDate(), 0, 0, 0, 0), a = 0; a < q.length; a++) n("[data-index='" + a + "'][data-content='datepicker']").datepicker({
                autoclose: !0,
                todayHighlight: !0,
                format: "yyyy-mm-dd",
        ...
        function L() {
            var e = 0;
            if (60 === $.repeat.index) for (;e < q.length; e++) q[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(); else if (1440 === $.repeat.index) for (;e < q.length; e++) q[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(), 
            q[e].hours = n("[data-index='" + e + "'][data-content='hours']").val().trim(); else if (10080 === $.repeat.index) for (;e < q.length; e++) q[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(), 
            q[e].hours = n("[data-index='" + e + "'][data-content='hours']").val().trim(), q[e].days_text = n("span", n("[data-content='week-days'][data-index='" + e + "']")).first().text(), 
            q[e].days_value = n("span", n("[data-content='week-days'][data-index='" + e + "']")).first().attr("value"); else if (44640 === $.repeat.index) for (;e < q.length; e++) q[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(), 
            q[e].hours = n("[data-index='" + e + "'][data-content='hours']").val().trim(), q[e].days_text = n("span", n("[data-content='month-days'][data-index='" + e + "']")).first().text(), 
            q[e].days_value = n("span", n("[data-content='month-days'][data-index='" + e + "']")).first().attr("value"); else if (525600 === $.repeat.index) for (;e < q.length; e++) q[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(), 
            q[e].hours = n("[data-index='" + e + "'][data-content='hours']").val().trim(), q[e].date_to_parse = new Date(n("[data-index='" + e + "'] .bootstrap-datepicker").val()), 
            q[e].date = b(q[e].date_to_parse).format("YYYY-MM-DD");
        }
        function Y(e) {
        ...
        function D() {
            ...
            n("#servicename-error-row").show(), n("#servicename").addClass("has-error"), K = !0) : /^[a-zA-Z0-9:_.@-]+$/.test(e) || (n("#servicename-error").text(A("Only alphabets, numbers, : , _ , . , @ , - are allowed.")), 
            n("#servicename-error-row").show(), n("#servicename").addClass("has-error"), K = !0), 
            e = n("#description").val().trim(), e.length < 1 && (n("#description-error").text(A("This field cannot be empty.")), 
            n("#description-error-row").show(), n("#description").addClass("has-error"), K = !0), 
            e = n("#command").val().trim(), e.length < 1 && (n("#command-error").text(A("This field cannot be empty.")), 
            n("#command-error-row").show(), n("#command").addClass("has-error"), K = !0), "Boot" == $.Calendar_or_Boot) e = n("#boot-time").val(), 
            /^[0-9]+$/.test(e.trim()) || (n("#boot-error").text(A("Invalid number.")), n("#boot-error-row").show(), 
            n("#boot-time").addClass("has-error"), K = !0); else {
                var t = 0;
                if (0 === $.repeat.index) {
                    ...
                    n("#specific-time-error-row").show(), n("#hr").addClass("has-error"), K = !0), /^[0-9]+$/.test(s) && s <= 59 && s >= 0 || (n("#min-error").text(A("Minute needs to be a number between 0-59")), 
                    n("#specific-time-error-row").show(), n("#min").addClass("has-error"), K = !0);
                } else if (60 === $.repeat.index) for (;t < q.length; t++) /^[0-9]+$/.test(q[t].minutes.trim()) && q[t].minutes.trim() <= 59 && q[t].minutes.trim() >= 0 || (n("[data-index='" + t + "'][data-content='minutes']").addClass("has-error"), 
                n("[data-index='" + t + "'][data-content='min-error']").text(A("Minute needs to be a number between 0-59")), 
                K = !0); else for (;t < q.length; t++) /^[0-9]+$/.test(q[t].minutes.trim()) && q[t].minutes.trim() <= 59 && q[t].minutes.trim() >= 0 || (K = !0, 
                ...
                /^[0-9]+$/.test(q[t].hours.trim()) && q[t].hours.trim() <= 23 && q[t].hours.trim() >= 0 || (K = !0, 
                ...
                525600 === $.repeat.index && (isNaN(q[t].date_to_parse.getTime()) || q[t].date_to_parse.getTime() < 0) && (K = !0, 
                ...
                44640 === $.repeat.index && "31" === q[t].days_value && n("[data-index='" + t + "'][data-content='day-error']").html(A("This day doesn't exist in all months.<br> The timer will only be executed in months that have 31st."));
            }
            return K;
        }
        function g() {
            ...
            } else 60 === $.repeat.index ? ($.repeat_minute = q.map(function(e) {
                return Number(e.minutes);
            }), $.OnCalendar = "OnCalendar=*-*-* *:" + $.repeat_minute + ":00") : 1440 === $.repeat.index ? $.OnCalendar = q.map(function(e) {
                return "OnCalendar=*-*-* " + Number(e.hours) + ":" + Number(e.minutes) + ":00";
            }) : 10080 === $.repeat.index ? $.OnCalendar = q.map(function(e) {
                return "OnCalendar=" + e.days_text.slice(0, 3) + " *-*-* " + Number(e.hours) + ":" + Number(e.minutes) + ":00";
            }) : 44640 === $.repeat.index ? $.OnCalendar = q.map(function(e) {
                return "OnCalendar=*-*-" + e.days_value + " " + Number(e.hours) + ":" + Number(e.minutes) + ":00";
            }) : 525600 === $.repeat.index && ($.OnCalendar = q.map(function(e) {
        ...
        var $ = {}, q = [], K = !1, Z = n("#repeat-hourly-tmpl").html();
        T.parse(Z);
        ...
        n(".form-table-ct").on("click", ".btn.btn-default.dropdown-toggle.pficon-close", function() {
            L(), q.splice(n(this).attr("data-index"), 1);
            for (var e = 0; e < q.length; e++) q[e].index = e;
            1 === q.length ? q[0].close = "disabled" : q[0].close = "enabled", y(), K && D();
        }), U.wait(function() {
    ...
    (function(e) {
        !function(t, a) {
            ...
            function Lt(e) {
                ...
                n = (d.match(q(i, e)) || [])[0], n && (r = d.substr(0, d.indexOf(n)), r.length > 0 && M(e).unusedInput.push(r), 
            ...
            var En = {
                ...
                y: "a year",
                yy: "%d years"
            }, Nn = {}, Jn = {}, In = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, Rn = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Vn = {}, Gn = {}, Bn = /\d/, $n = /\d\d/, qn = /\d{3}/, Kn = /\d{4}/, Zn = /[+-]?\d{6}/, Qn = /\d\d?/, Xn = /\d\d\d\d?/, es = /\d\d\d\d\d\d?/, ts = /\d{1,3}/, as = /\d{1,4}/, ns = /[+-]?\d{1,6}/, ss = /\d+/, is = /[+-]?\d+/, rs = /Z|[+-]\d\d:?\d\d/gi, ds = /Z|[+-]\d\d(?::?\d\d)?/gi, os = /[+-]?\d+(\.\d{1,3})?/, _s = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, us = {}, ls = {}, ms = 0, cs = 1, hs = 2, Ms = 3, fs = 4, ps = 5, ys = 6, Ls = 7, Ys = 8;
            I("Y", 0, 0, function() {
                var e = this.year();
                return e <= 9999 ? "" + e : "+" + e;
            }), I(0, [ "YY", 2 ], 0, function() {
            ...
            Q("X", function(e, t, a) {
                ...
                a._d = new Date(D(e));
            }), t.version = "2.22.1", n(bt), t.fn = ui, t.min = Ht, t.max = jt, t.now = Zs, 
