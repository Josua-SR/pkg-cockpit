!function(e) {
    ...
    !function() {
        ...
        var n = a(2), s = a(147), i = a(149), r = a(150), d = a(151), o = n.gettext, _ = n.gettext, u = {};
    ...
    n(function() {
        ...
        function o() {
            n("#service-unit-action>button").update_privileged(G, T.format(j("The user <b>$0</b> is not permitted to start or stop services"), G.user ? G.user.name : "")), 
            n("#service-file-action>button").update_privileged(G, T.format(j("The user <b>$0</b> is not permitted to enable or disable services"), G.user ? G.user.name : ""));
        }
        function _(e) {
            function t() {
                if (W.valid) {
                    ...
                    n("#service-file-action").on("click", "[data-action]", d), o();
                }
            }
            function a() {
                var e = b.render(R, {
        ...
        function p(e) {
            ...
            n("#hr").removeClass("has-error"), n("#min").removeClass("has-error")), ne.map(function(t) {
        ...
        function y() {
            ...
            44640 === q.repeat.index && (e.days_text = "1st"), Y(), K.push(e), 1 === K.length ? K[0].close = "disabled" : K[0].close = "enabled", 
            L(), Z && D();
        }
        function L() {
            if (n("#repeat-time").html(b.render(q.repeat.render, {
                repeat: K
            })), 525600 === q.repeat.index) for (var e = new Date(x), t = new Date(e.getFullYear(), e.getMonth(), e.getDate(), 0, 0, 0, 0), a = 0; a < K.length; a++) n("[data-index='" + a + "'][data-content='datepicker']").datepicker({
                autoclose: !0,
                todayHighlight: !0,
                format: "yyyy-mm-dd",
        ...
        function Y() {
            var e = 0;
            if (60 === q.repeat.index) for (;e < K.length; e++) K[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(); else if (1440 === q.repeat.index) for (;e < K.length; e++) K[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(), 
            K[e].hours = n("[data-index='" + e + "'][data-content='hours']").val().trim(); else if (10080 === q.repeat.index) for (;e < K.length; e++) K[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(), 
            ...
            K[e].days_value = n("span", n("[data-content='week-days'][data-index='" + e + "']")).first().attr("value"); else if (44640 === q.repeat.index) for (;e < K.length; e++) K[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(), 
            ...
            K[e].days_value = n("span", n("[data-content='month-days'][data-index='" + e + "']")).first().attr("value"); else if (525600 === q.repeat.index) for (;e < K.length; e++) K[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(), 
            K[e].hours = n("[data-index='" + e + "'][data-content='hours']").val().trim(), K[e].date_to_parse = new Date(n("[data-index='" + e + "'] .bootstrap-datepicker").val()), 
            K[e].date = S(K[e].date_to_parse).format("YYYY-MM-DD");
        }
        function k(e) {
            ...
            n("#boot-time").val("00"), n("#boot-time").removeClass("has-error"), q.Calendar_or_Boot = "Boot") : 2 == e && (n("#boot").hide(), 
            n("#boot-error-row").hide(), n("#specific-time-error-row").hide(), n("#repeat-options").show(), 
            p(0), n("span", n("#drop-repeat")).first().text(j("Don't Repeat")), q.Calendar_or_Boot = "Calendar");
        }
        function g(e) {
            switch (e = Number(e)) {
              case 1:
        ...
        function D() {
            ...
            n("#servicename-error-row").show(), n("#servicename").addClass("has-error"), Z = !0) : /^[a-zA-Z0-9:_.@-]+$/.test(e) || (n("#servicename-error").text(j("Only alphabets, numbers, : , _ , . , @ , - are allowed.")), 
            ...
            n("#command-error-row").show(), n("#command").addClass("has-error"), Z = !0), "Boot" == q.Calendar_or_Boot) e = n("#boot-time").val(), 
            ...
            n("#boot-time").addClass("has-error"), Z = !0); else {
                ...
                if (0 === q.repeat.index) {
                    ...
                    n("#specific-time-error-row").show(), n("#hr").addClass("has-error"), Z = !0), /^[0-9]+$/.test(s) && s <= 59 && s >= 0 || (n("#min-error").text(j("Minute needs to be a number between 0-59")), 
                    n("#specific-time-error-row").show(), n("#min").addClass("has-error"), Z = !0);
                } else if (60 === q.repeat.index) for (;t < K.length; t++) /^[0-9]+$/.test(K[t].minutes.trim()) && K[t].minutes.trim() <= 59 && K[t].minutes.trim() >= 0 || (n("[data-index='" + t + "'][data-content='minutes']").addClass("has-error"), 
                ...
                44640 === q.repeat.index && "31" === K[t].days_value && n("[data-index='" + t + "'][data-content='day-error']").html(j("This day doesn't exist in all months.<br> The timer will only be executed in months that have 31st."));
            }
            return Z;
        }
        function v() {
            ...
            var e = D();
            if (e) return !1;
            if (q.name = n("#servicename").val().replace(/\s/g, ""), q.Description = n("#description").val(), 
            q.Command = n("#command").val(), q.boot_time = n("#boot-time").val(), 0 === q.repeat.index) {
                q.repeat_hour = Number(n("#hr").val().trim()), q.repeat_minute = Number(n("#min").val().trim());
                var t = new Date(x);
        ...
        function w() {
            ...
            i += n;
            var o = "/etc/systemd/system/" + q.name + ".service", _ = T.file(o, {
                superuser: "try"
            });
            _.replace(s).fail(function(e) {
                console.log(e);
            });
            var u = "/etc/systemd/system/" + q.name + ".timer";
            _ = T.file(u, {
                superuser: "try"
            }), _.replace(i).done(function(e) {
                z.Reload().done(function(e) {
                    z.EnableUnitFiles([ q.name + ".timer" ], !1, !1).fail(function(e) {
                        console.warn("Failed to enable timer unit:", e);
                    }), "Calendar" == q.Calendar_or_Boot && z.StartUnit(q.name + ".timer", "replace").fail(function(e) {
        ...
        var T = a(2), b = a(147), S = a(3), H = a(146);
        a(153), a(154), T.translate();
        var j = T.gettext;
        S.locale(T.language);
        ...
        n(z).on("Reloading", function(e, t) {
            ...
            G.allowed === !1 && (n("#create-timer").addClass("accounts-privileged"), n(".accounts-privileged").update_privileged(G, T.format(j("The user <b>$0</b> does not have permissions for creating timers"), G.user ? G.user.name : ""), "left"));
        ...
        var q = {}, K = [], Z = !1, Q = n("#repeat-hourly-tmpl").html();
        b.parse(Q);
        var X = n("#repeat-daily-tmpl").html();
        b.parse(X);
        var ee = n("#repeat-weekly-tmpl").html();
        b.parse(ee);
        var te = n("#repeat-monthly-tmpl").html();
        b.parse(te);
        var ae = n("#repeat-yearly-tmpl").html();
        b.parse(ae);
        var ne = [ {
            index: 0,
            render: ""
        ...
        n("#timer-dialog").on("click", "[data-content='datepicker']", function() {
            se = n("#timer-dialog").scrollTop(), n(this).removeClass("has-error"), n("[data-index='" + n(this).attr("data-index") + "'][data-content='date-error']").text(""), 
            ...
            ie > se ? n(".datepicker.datepicker-dropdown.dropdown-menu").css("margin-top", ie) : n(".datepicker.datepicker-dropdown.dropdown-menu").css("margin-top", se);
        }), n("#timer-dialog").on("mouseenter", ".datepicker.datepicker-dropdown [class*='datepicker-'] thead", function() {
            ie = n("#timer-dialog").scrollTop();
        ...
        n(".form-table-ct").on("click", ".btn.btn-default.dropdown-toggle.pficon-close", function() {
            Y(), K.splice(n(this).attr("data-index"), 1);
            for (var e = 0; e < K.length; e++) K[e].index = e;
            1 === K.length ? K[0].close = "disabled" : K[0].close = "enabled", L(), Z && D();
        }), z.wait(function() {
	 ...
	 */
    !function(r) {
        s = [ a(145) ], n = r, i = "function" == typeof n ? n.apply(t, s) : n, !(void 0 !== i && (e.exports = i));
    }(function(e, t) {
        function a() {
