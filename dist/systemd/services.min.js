!function(e) {
    ...
    !function() {
        ...
        var n = a(2), s = a(14), i = a(16), r = a(17), d = a(18), o = n.gettext, _ = n.gettext, u = {};
    ...
    !function(a, r) {
        ...
        function o(t, a) {
            function s() {
                if (p && !y) for (;f.length; ) delete h[f.pop()]; else f = [];
                p = !1, y = !1;
            }
            function i(e) {
            ...
            if (!t) return [];
            var d, o, m, c = [], h = [], f = [], p = !1, y = !1;
            i(a || e.tags);
            for (var v, w, T, b, S, H, j = new l(t); !j.eos(); ) {
                if (v = j.pos, T = j.scanUntil(d)) for (var x = 0, O = T.length; x < O; ++x) b = T.charAt(x), 
                r(b) ? f.push(h.length) : y = !0, h.push([ "text", b, v, v + 1 ]), v += 1, "\n" === b && s();
                if (!j.scan(d)) break;
                if (p = !0, w = j.scan(g) || "name", j.scan(L), "=" === w ? (T = j.scanUntil(k), 
                j.scan(k), j.scanUntil(o)) : "{" === w ? (T = j.scanUntil(m), j.scan(D), j.scanUntil(o), 
    ...
    n(function() {
        ...
        function i() {
            ...
            function s(e) {
                ...
                if ("loaded" == t && (t = ""), e.HasFailed = "failed" == a || "" !== t, t = A(t), 
                a = A(a), n = A(n), "" !== n && n != a && (a = a + " (" + n + ")"), "" !== t && (a = t + " / " + a), 
            ...
            function r(e, t) {
                ...
                t.NextRunTime = b(n / 1e3).calendar(), e.NextElapseUSecMonotonic <= 0 && e.NextElapseUSecRealtime <= 0 && (t.NextRunTime = A("unknown"));
            }
            function d() {
                function t(e, t) {
                ...
                }), a(n("#services-list-enabled"), A("Enabled"), r), a(n("#services-list-disabled"), A("Disabled"), d), 
                a(n("#services-list-static"), A("Static"), o);
            }
            function o() {
                h ? M = !0 : (d(), h = window.setTimeout(_, 200));
            }
            function _() {
                h = null, M && (M = !1, d());
            }
            function u() {
                ...
                function n(e) {
                    ...
                    return d[a] = !0, a.indexOf("@") != -1 ? (l[a] = {
                        Id: a,
                        Description: w.format(A("$0 Template"), a),
                        UnitFileState: e[1],
        ...
        function o(e) {
            function t() {
                if (O.valid) {
                    ...
                    var _ = "";
                    o && (_ = w.format(A("Since $0"), new Date(o / 1e3).toLocaleString()));
                    var u = T.render(N, {
                    ...
                    if (E) {
                        var c = T.render('<a data-goto-unit="{{unit}}">{{unit}}</a>', {
                            unit: E
                        });
                        m = w.format(A("This unit is an instance of the $0 template."), c);
                    }
                    for (var h = O.Conditions, M = [], f = 0; f < h.length; f++) h[f][4] < 0 && M.push(w.format(A("Condition $0=$1 was not met"), h[f][0], h[f][3]));
                    var p = T.render(J, {
                        Unit: O,
                        Since: _,
            ...
            function a() {
                var e = T.render(I, {
                    Description: w.format(A("$0 Template"), x)
                });
                n("#service-template").html(e);
            }
            if (O && (n(O).off("changed"), O = null, W = null), F && (F.stop(), F = null), n("#service-valid").hide(), 
            ...
            x = e) {
                ...
                if (P = s != -1 && (s + 1 == i || s + 1 == x.length), E = void 0, s == -1 || P || (E = x.substring(0, s + 1), 
                i != -1 && (E += x.substring(i))), P) return a(), n("#service-template").show(), 
                void n("#service").show();
        ...
        function m() {
            ...
            e && U.GetUnitFileState(e).done(function(t) {
                x == e && (W = t, O && n(O).triggerHandler("changed"));
            });
        }
        function c() {
        ...
        function h() {
            w.spawn([ "cat", "/proc/uptime" ]).fail(function(e) {
                console.log(e);
            }).done(function(e) {
        ...
        function M() {
            ...
            n("span", n("#boot-or-specific-time")).first().text(A("After system boot")), n("span", n("#drop-time")).first().text(A("Seconds")), 
        ...
        function Y(e) {
            ...
            f(0), n("span", n("#drop-repeat")).first().text(A("Don't Repeat")), $.Calendar_or_Boot = "Calendar");
        }
        function k(e) {
            switch (e = Number(e)) {
              case 1:
        ...
        function D() {
            ...
            if (e.trim().length < 1 ? (n("#servicename-error").text(A("This field cannot be empty.")), 
            n("#servicename-error-row").show(), n("#servicename").addClass("has-error"), Z = !0) : /^[a-zA-Z0-9:_.@-]+$/.test(e) || (n("#servicename-error").text(A("Only alphabets, numbers, : , _ , . , @ , - are allowed.")), 
            n("#servicename-error-row").show(), n("#servicename").addClass("has-error"), Z = !0), 
            e = n("#description").val().trim(), e.length < 1 && (n("#description-error").text(A("This field cannot be empty.")), 
            n("#description-error-row").show(), n("#description").addClass("has-error"), Z = !0), 
            e = n("#command").val().trim(), e.length < 1 && (n("#command-error").text(A("This field cannot be empty.")), 
            n("#command-error-row").show(), n("#command").addClass("has-error"), Z = !0), "Boot" == $.Calendar_or_Boot) e = n("#boot-time").val(), 
            /^[0-9]+$/.test(e.trim()) || (n("#boot-error").text(A("Invalid number.")), n("#boot-error-row").show(), 
            n("#boot-time").addClass("has-error"), Z = !0); else {
                var t = 0;
                if (0 === $.repeat.index) {
                    var a = n("#hr").val().trim(), s = n("#min").val().trim();
                    n("#hr-error").text(""), n("#min-error").text(""), /^[0-9]+$/.test(a) && a <= 23 && a >= 0 || (n("#hr-error").text(A("Hour needs to be a number between 0-23")), 
                    n("#specific-time-error-row").show(), n("#hr").addClass("has-error"), Z = !0), /^[0-9]+$/.test(s) && s <= 59 && s >= 0 || (n("#min-error").text(A("Minute needs to be a number between 0-59")), 
                ...
                n("[data-index='" + t + "'][data-content='min-error']").text(A("Minute needs to be a number between 0-59")), 
                Z = !0); else for (;t < K.length; t++) /^[0-9]+$/.test(K[t].minutes.trim()) && K[t].minutes.trim() <= 59 && K[t].minutes.trim() >= 0 || (Z = !0, 
                n("[data-index='" + t + "'][data-content='minutes']").addClass("has-error"), n("[data-index='" + t + "'][data-content='min-error']").text(A("Minute needs to be a number between 0-59"))), 
                /^[0-9]+$/.test(K[t].hours.trim()) && K[t].hours.trim() <= 23 && K[t].hours.trim() >= 0 || (Z = !0, 
                n("[data-index='" + t + "'][data-content='hours']").addClass("has-error"), n("[data-index='" + t + "'][data-content='hr-error']").text(A("Hour needs to be a number between 0-23"))), 
                ...
                n("[data-index='" + t + "'][data-content='date-error']").text(A("Invalid date format."))), 
                44640 === $.repeat.index && "31" === K[t].days_value && n("[data-index='" + t + "'][data-content='day-error']").html(A("This day doesn't exist in all months.<br> The timer will only be executed in months that have 31st."));
            }
            return Z;
        }
        function g() {
        ...
        var w = a(2), T = a(14), b = a(20), S = a(13);
        a(145), a(146), w.translate();
        var H, j, x, O, W, P, E, F, A = w.gettext, C = w.dbus("org.freedesktop.systemd1", {
            superuser: "try"
        ...
        n(U).on("Reloading", function(e, t) {
            ...
            m();
        }), n(w).on("locationchanged", c), n("#service-navigate-home").on("click", function() {
            w.location.go("/");
        ...
        n(G).on("changed", function() {
            G.allowed === !1 && (n("#create-timer").addClass("accounts-privileged"), n(".accounts-privileged").update_privileged(G, w.format(A("The user <b>$0</b> does not have permissions for creating timers"), G.user ? G.user.name : ""), "left"));
        }), n("#create-timer").on("click", function() {
            M(), n("#timer-dialog").modal("show"), h();
        ...
        n(".form-table-ct").on("click", ".btn.btn-default.dropdown-toggle.pficon-close", function() {
            ...
            1 === K.length ? K[0].close = "disabled" : K[0].close = "enabled", y(), Z && D();
        }), U.wait(function() {
    ...
    (function(e) {
        !function(t, a) {
            ...
            function T(e, a) {
                null != t.deprecationHandler && t.deprecationHandler(e, a), Wn[e] || (v(a), Wn[e] = !0);
            }
            function b(e) {
            ...
            function ve(e, t, a, n, s) {
                var i, r, d = (7 + a - n) % 7, o = ge(e, n, s), _ = 1 + 7 * (t - 1) + d + o;
            ...
            function we(e, t, a) {
                var n, s, i = ge(e.year(), t, a), r = Math.floor((e.dayOfYear() - i - 1) / 7) + 1;
            ...
            function Ie(e) {
                return this._weekdaysParseExact ? (l(this, "_weekdaysRegex") || Ve.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (l(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Ws), 
                this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
            }
            function Re(e) {
                return this._weekdaysParseExact ? (l(this, "_weekdaysRegex") || Ve.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (l(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Ps), 
            ...
            function rt(e) {
                var t, a = e._a;
                return a && M(e).overflow === -2 && (t = a[cs] < 0 || a[cs] > 11 ? cs : a[hs] < 1 || a[hs] > ue(a[ms], a[cs]) ? hs : a[Ms] < 0 || a[Ms] > 24 || 24 === a[Ms] && (0 !== a[fs] || 0 !== a[ps] || 0 !== a[ys]) ? Ms : a[fs] < 0 || a[fs] > 59 ? fs : a[ps] < 0 || a[ps] > 59 ? ps : a[ys] < 0 || a[ys] > 999 ? ys : -1, 
            ...
            function _t(e) {
                ...
                if (!e._d) {
                    ...
                    a = De(i, 0, e._dayOfYear), e._a[cs] = a.getUTCMonth(), e._a[hs] = a.getUTCDate()), 
                    t = 0; t < 3 && null == e._a[t]; ++t) e._a[t] = r[t] = n[t];
                    for (;t < 7; t++) e._a[t] = r[t] = null == e._a[t] ? 2 === t ? 1 : 0 : e._a[t];
                    24 === e._a[Ms] && 0 === e._a[fs] && 0 === e._a[ps] && 0 === e._a[ys] && (e._nextDay = !0, 
                    e._a[Ms] = 0), e._d = (e._useUTC ? De : ke).apply(null, r), s = e._useUTC ? e._d.getUTCDay() : e._d.getDay(), 
            ...
            function Qt(e, t) {
                ...
                i = {}, i.ms = s.milliseconds, i.M = s.months), n = new Pt(i), Et(e) && l(e, "_locale") && (n._locale = e._locale), 
                n;
            }
            function Xt(e, t) {
            ...
            function Tn(e) {
                ...
                var t = this.localeData(), a = gn(this, !e, t);
            ...
            function Sn() {
                ...
                if (!m) return "P0D";
                var c = m < 0 ? "-" : "", h = bn(this._months) !== bn(m) ? "-" : "", M = bn(this._days) !== bn(m) ? "-" : "", f = bn(this._milliseconds) !== bn(m) ? "-" : "";
            ...
            var xn = t.momentProperties = [], On = !1, Wn = {};
            ...
            var En = {
                ...
                y: "a year",
                yy: "%d years"
            }, Nn = {}, Jn = {}, In = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, Rn = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Vn = {}, Gn = {}, Bn = /\d/, $n = /\d\d/, Kn = /\d{3}/, Zn = /\d{4}/, qn = /[+-]?\d{6}/, Qn = /\d\d?/, Xn = /\d\d\d\d?/, es = /\d\d\d\d\d\d?/, ts = /\d{1,3}/, as = /\d{1,4}/, ns = /[+-]?\d{1,6}/, ss = /\d+/, is = /[+-]?\d+/, rs = /Z|[+-]\d\d:?\d\d/gi, ds = /Z|[+-]\d\d(?::?\d\d)?/gi, os = /[+-]?\d+(\.\d{1,3})?/, _s = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, us = {}, ls = {}, ms = 0, cs = 1, hs = 2, Ms = 3, fs = 4, ps = 5, ys = 6, Ls = 7, Ys = 8;
            I("Y", 0, 0, function() {
                var e = this.year();
                return e <= 9999 ? "" + e : "+" + e;
            }), I(0, [ "YY", 2 ], 0, function() {
            ...
            A("year", "y"), z("year", 1), $("Y", is), $("YY", Qn, $n), $("YYYY", as, Zn), $("YYYYY", ns, qn), 
            ...
            ks = Array.prototype.indexOf ? Array.prototype.indexOf : function(e) {
                ...
                null != s ? t[cs] = s : M(a).invalidMonth = e;
            });
            var gs = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/, vs = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ws = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), Ts = _s, bs = _s;
            ...
            var Hs = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), js = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), xs = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), Os = _s, Ws = _s, Ps = _s;
            ...
            Qt.fn = Pt.prototype, Qt.invalid = Wt;
            ...
            ui.from = La, ui.fromNow = Ya, ui.to = ka, ui.toNow = Da, ui.get = de, ui.invalidAt = Ea, 
            ui.isAfter = da, ui.isBefore = oa, ui.isBetween = _a, ui.isSame = ua, ui.isSameOrAfter = la, 
            ui.isSameOrBefore = ma, ui.isValid = Wa, ui.lang = si, ui.locale = ga, ui.localeData = va, 
            ui.max = Zs, ui.min = Ks, ui.parsingFlags = Pa, ui.set = oe, ui.startOf = wa, ui.subtract = ni, 
            ...
            ui.year = Ds, ui.isLeapYear = ne, ui.weekYear = Ca, ui.isoWeekYear = Ua, ui.quarter = ui.quarters = Ra, 
            ...
            var li = j.prototype;
            li.calendar = x, li.longDateFormat = O, li.invalidDate = W, li.ordinal = P, li.preparse = qa, 
            li.postformat = qa, li.relativeTime = E, li.pastFuture = F, li.set = S, li.months = le, 
            li.monthsShort = me, li.monthsParse = he, li.monthsRegex = Le, li.monthsShortRegex = ye, 
            li.week = be, li.firstDayOfYear = He, li.firstDayOfWeek = Se, li.weekdays = Pe, 
            li.weekdaysMin = Fe, li.weekdaysShort = Ee, li.weekdaysParse = Ce, li.weekdaysRegex = Je, 
            li.weekdaysShortRegex = Ie, li.weekdaysMinRegex = Re, li.isPM = Ze, li.meridiem = qe, 
            tt("en", {
            ...
            var mi = Math.abs, ci = pn("ms"), hi = pn("s"), Mi = pn("m"), fi = pn("h"), pi = pn("d"), yi = pn("w"), Li = pn("M"), Yi = pn("y"), ki = Yn("milliseconds"), Di = Yn("seconds"), gi = Yn("minutes"), vi = Yn("hours"), wi = Yn("days"), Ti = Yn("months"), bi = Yn("years"), Si = Math.round, Hi = {
                ss: 44,
                s: 45,
                m: 45,
                h: 22,
                d: 26,
                M: 11
            }, ji = Math.abs, xi = Pt.prototype;
            return xi.isValid = Ot, xi.abs = dn, xi.add = _n, xi.subtract = un, xi.as = Mn, 
            xi.asMilliseconds = ci, xi.asSeconds = hi, xi.asMinutes = Mi, xi.asHours = fi, xi.asDays = pi, 
            xi.asWeeks = yi, xi.asMonths = Li, xi.asYears = Yi, xi.valueOf = fn, xi._bubble = mn, 
            xi.clone = yn, xi.get = Ln, xi.milliseconds = ki, xi.seconds = Di, xi.minutes = gi, 
            xi.hours = vi, xi.days = wi, xi.weeks = kn, xi.months = Ti, xi.years = bi, xi.humanize = Tn, 
            xi.toISOString = Sn, xi.toString = Sn, xi.toJSON = Sn, xi.locale = ga, xi.localeData = va, 
            ...
            Q("X", function(e, t, a) {
                ...
                a._d = new Date(D(e));
            }), t.version = "2.21.0", n(bt), t.fn = ui, t.min = Ht, t.max = jt, t.now = qs, 
            t.utc = c, t.unix = Ka, t.months = tn, t.isDate = _, t.locale = tt, t.invalid = p, 
    ...
    }, n.resolve = s, e.exports = n, n.id = 22;
}, function(e, t, a) {
    !function(e, t) {
        t(a(20));
    }(this, function(e) {
	 ...
	 */
    !function(r) {
        s = [ a(12) ], n = r, i = "function" == typeof n ? n.apply(t, s) : n, !(void 0 !== i && (e.exports = i));
    }(function(e, t) {
        function a() {
        ...
        u.prototype = {
            ...
            _process_options: function(t) {
                ...
                f[i] || (i = i.split("-")[0], f[i] || (i = h.language)), s.language = i, s.startView = this._resolveViewName(s.startView), 
            ...
            place: function() {
                ...
                if ("auto" === f && (M = -r + h - a, f = M < 0 ? "bottom" : "top"), this.picker.addClass("datepicker-orient-" + f), 
                "top" === f ? h -= a + parseInt(this.picker.css("padding-top")) : h += l, this.o.rtl) {
                    var p = i - (c + m);
                    this.picker.css({
                        top: h,
                        right: p,
            ...
            _fill_yearsView: function(a, n, s, i, r, d, o) {
                for (var _, u, l, m = "", c = s / 10, h = this.picker.find(a), M = Math.floor(i / s) * s, f = M + 9 * c, p = Math.floor(this.viewDate.getFullYear() / c) * c, y = e.map(this.dates, function(e) {
                    return Math.floor(e.getUTCFullYear() / c) * c;
                }), L = M - c; L <= f + c; L += c) _ = [ n ], u = null, L === M - c ? _.push("old") : L === f + c && _.push("new"), 
                ...
                h.find(".datepicker-switch").text(M + "-" + f), h.find("td").html(m);
            },
            fill: function() {
                var n, s, i = new Date(this.viewDate), r = i.getUTCFullYear(), d = i.getUTCMonth(), o = this.o.startDate !== -(1 / 0) ? this.o.startDate.getUTCFullYear() : -(1 / 0), _ = this.o.startDate !== -(1 / 0) ? this.o.startDate.getUTCMonth() : -(1 / 0), u = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCFullYear() : 1 / 0, l = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCMonth() : 1 / 0, m = f[this.o.language].today || f.en.today || "", c = f[this.o.language].clear || f.en.clear || "", h = f[this.o.language].titleFormat || f.en.titleFormat;
                if (!isNaN(r) && !isNaN(d)) {
                    ...
                    L = L.valueOf();
                    for (var Y, k, D = []; M.valueOf() < L; ) {
                        if (Y = M.getUTCDay(), Y === this.o.weekStart && (D.push("<tr>"), this.o.calendarWeeks)) {
                            var g = new Date(+M + (this.o.weekStart - Y - 7) % 7 * 864e5), v = new Date(Number(g) + (11 - g.getUTCDay()) % 7 * 864e5), w = new Date(Number(w = a(v.getUTCFullYear(), 0, 1)) + (11 - w.getUTCDay()) % 7 * 864e5), T = (v - w) / 864e5 / 7 + 1;
                        ...
                        D.push('<td class="' + k.join(" ") + '"' + (n ? ' title="' + n + '"' : "") + ' data-date="' + M.getTime().toString() + '">' + b + "</td>"), 
                        n = null, Y === this.o.weekEnd && D.push("</tr>"), M.setUTCDate(M.getUTCDate() + 1);
                    }
        ...
        var m = e.fn.datepicker, c = function(a) {
            ...
            if (this.each(function() {
                ...
                if (!i) {
                    var _ = d(this, "date"), m = e.extend({}, h, _, r), c = o(m.language), M = e.extend({}, h, c, _, r);
        ...
        var f = e.fn.datepicker.dates = {
            ...
            parseDate: function(a, s, i, r) {
                ...
                if (a in y && (a = y[a]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(a)) {
                    ...
                    m = Number(l[1]), h = M[l[2].toLowerCase()], a = u.prototype[h](a, m);
                    return u.prototype._zero_utc_time(a);
                }
                _ = a && a.match(this.nonpunctuation) || [];
                var L, Y, k = {}, D = [ "yyyy", "yy", "M", "MM", "m", "mm", "d", "dd" ], g = {
                    yyyy: function(e, t) {
                ...
                g.yy = g.yyyy, g.M = g.MM = g.mm = g.m, g.dd = g.d, a = n();
                var v = s.parts.slice();
                if (_.length !== v.length && (v = e(v).filter(function(t, a) {
                    return e.inArray(a, D) !== -1;
                    ...
                    var T, b;
                    for (c = 0; c < D.length; c++) b = D[c], b in k && !isNaN(k[b]) && (T = new Date(a), 
                    g[b](T, k[b]), isNaN(T) || (a = T));
                }
                return a;
            },
