!function(e) {
    ...
    !function() {
        ...
        var n = a(3), s = a(5), i = a(7), r = a(8), d = a(9), o = n.gettext, _ = n.gettext, u = {};
        u.journalctl = function() {
            ...
            var d, o = new n.defer(), _ = "", u = [], l = [], m = null, h = n.spawn(r, {
                host: i.host,
                batch: 8192,
                latency: 300,
                superuser: "try"
        ...
        u.renderer = function(e) {
            ...
            function i(e) {
                return M.render_line(e.entry.ident, e.entry.prio, e.entry.message, e.count, e.last_time, e.entry.full);
            }
            function r() {
                f === p && f.entry && (f = a(p));
            }
            function d() {
                f.header_present && (M.remove_first(), f.header_present = !1), f.line_present && (M.remove_first(), 
                f.line_present = !1), f.entry && (M.prepend(i(f)), f.line_present = !0);
            }
            function o(e) {
                var t = n(e);
                s(f.entry, t) ? (f.count += 1, f.first_time = t.time) : (d(), f.entry && (t.bootid != f.entry.bootid && M.prepend(M.render_reboot_separator()), 
                t.day != f.entry.day && M.prepend(M.render_day_header(f.entry.day))), r(), f.entry = t, 
                f.count = 1, f.first_time = f.last_time = t.time, f.line_present = !1);
            }
            function _() {
                d(), f.entry && (M.prepend(M.render_day_header(f.entry.day)), f.header_present = !0);
            }
            function m() {
                p.line_present && (M.remove_last(), p.line_present = !1), p.entry && (M.append(i(p)), 
                p.line_present = !0);
            }
            function h(e) {
                var t = n(e);
                s(p.entry, t) ? (p.count += 1, p.last_time = t.time) : (m(), p.entry && t.day == p.entry.day || (M.append(M.render_day_header(t.day)), 
                p.header_present = !0), p.entry && t.bootid != p.entry.bootid && M.append(M.render_reboot_separator()), 
    ...
    !function(a, r) {
        ...
        function o(t, a) {
            function s() {
                if (p && !y) for (;f.length; ) delete c[f.pop()]; else f = [];
                p = !1, y = !1;
            }
            function i(e) {
                if ("string" == typeof e && (e = e.split(Y, 2)), !M(e) || 2 !== e.length) throw new Error("Invalid tags: " + e);
                d = new RegExp(n(e[0]) + "\\s*"), o = new RegExp("\\s*" + n(e[1])), m = new RegExp("\\s*" + n("}" + e[1]));
            }
            if (!t) return [];
            var d, o, m, h = [], c = [], f = [], p = !1, y = !1;
            i(a || e.tags);
            for (var v, w, T, b, S, H, j = new l(t); !j.eos(); ) {
                if (v = j.pos, T = j.scanUntil(d)) for (var x = 0, O = T.length; x < O; ++x) b = T.charAt(x), 
                r(b) ? f.push(c.length) : y = !0, c.push([ "text", b, v, v + 1 ]), v += 1, "\n" === b && s();
                if (!j.scan(d)) break;
                if (p = !0, w = j.scan(k) || "name", j.scan(L), "=" === w ? (T = j.scanUntil(g), 
                j.scan(g), j.scanUntil(o)) : "{" === w ? (T = j.scanUntil(m), j.scan(D), j.scanUntil(o), 
                w = "&") : T = j.scanUntil(o), !j.scan(o)) throw new Error("Unclosed tag at " + j.pos);
                if (S = [ w, T, v, j.pos ], c.push(S), "#" === w || "^" === w) h.push(S); else if ("/" === w) {
                    if (H = h.pop(), !H) throw new Error('Unopened section "' + T + '" at ' + v);
                    if (H[1] !== T) throw new Error('Unclosed section "' + H[1] + '" at ' + v);
                } else "name" === w || "{" === w || "&" === w ? y = !0 : "=" === w && i(T);
            }
            if (H = h.pop()) throw new Error('Unclosed section "' + H[1] + '" at ' + j.pos);
            return u(_(c));
        }
        function _(e) {
        ...
        var c = Object.prototype.toString, M = Array.isArray || function(e) {
            return "[object Array]" === c.call(e);
        }, f = RegExp.prototype.test, p = /\S/, y = {
            "&": "&amp;",
            "<": "&lt;",
            ">": "&gt;",
            '"': "&quot;",
        ...
        l.prototype.eos = function() {
            ...
            void 0 !== r && (d += r);
            return d;
        }, h.prototype.renderSection = function(e, a, n, s) {
            function i(e) {
                return r.render(e, a, n);
            }
            var r = this, d = "", o = a.lookup(e[1]);
            if (o) {
                if (M(o)) for (var _ = 0, u = o.length; _ < u; ++_) d += this.renderTokens(e[4], a.push(o[_]), n, s); else if ("object" == typeof o || "string" == typeof o || "number" == typeof o) d += this.renderTokens(e[4], a.push(o), n, s); else if (t(o)) {
        ...
        }, h.prototype.renderInverted = function(e, t, a, n) {
            var s = t.lookup(e[1]);
            if (!s || M(s) && 0 === s.length) return this.renderTokens(e[4], t, a, n);
        }, h.prototype.renderPartial = function(e, a, n) {
            if (n) {
            ...
            var a = t.lookup(e[1]);
            if (null != a) return a;
        }, h.prototype.escapedValue = function(t, a) {
            var n = a.lookup(t[1]);
        ...
        }, e.escape = d, e.Scanner = l, e.Context = m, e.Writer = h;
    });
}, function(e, t) {
    ...
    n(function() {
        ...
        function i() {
            ...
            function s(e) {
                ...
                if ("loaded" == t && (t = ""), e.HasFailed = "failed" == a || "" !== t, t = C(t), 
                a = C(a), n = C(n), "" !== n && n != a && (a = a + " (" + n + ")"), "" !== t && (a = t + " / " + a), 
                e.CombinedState = a, "timer" == e.Id.slice(-5) && (e.is_timer = !0, "active" == e.ActiveState)) {
                    var s = A.proxy("org.freedesktop.systemd1.Timer", e.path);
                    s.wait(function() {
                        s.valid && r(s, e);
                    });
                }
            ...
            function i(e, n) {
                A.call(e, "org.freedesktop.DBus.Properties", "GetAll", [ "org.freedesktop.systemd1.Unit" ]).fail(function(e) {
                    console.log(e);
                }).done(function(s) {
                    var i = t(e);
                    a(i, s[0]), n && n(i), o();
            ...
            function r(e, t) {
                ...
                var a = 1e3 * H.valueOf() - j;
                e.LastTriggerUSec !== -1 && 0 !== e.LastTriggerUSec || (t.LastTriggerTime = C("unknown"));
                var n = 0;
                ...
                t.NextRunTime = b(n / 1e3).calendar(), e.NextElapseUSecMonotonic <= 0 && e.NextElapseUSecRealtime <= 0 && (t.NextRunTime = C("unknown"));
            }
            function d() {
                function t(e, t) {
                ...
                var s = n("#services-filter button.active").attr("data-pattern"), i = Object.keys(l).sort(t), r = [], d = [], o = [], _ = {
                    ...
                    Next_Run_Time: C("Next Run"),
                    Last_Trigger_Time: C("Last Trigger"),
                ...
                }), a(n("#services-list-enabled"), C("Enabled"), r), a(n("#services-list-disabled"), C("Disabled"), d), 
                a(n("#services-list-static"), C("Static"), o);
            }
            function o() {
                c ? M = !0 : (d(), c = window.setTimeout(_, 200));
            }
            function _() {
                c = null, M && (M = !1, d());
            }
            function u() {
                ...
                function n(e) {
                    ...
                    return d[a] = !0, a.indexOf("@") != -1 ? (l[a] = {
                        Id: a,
                        Description: w.format(C("$0 Template"), a),
                        UnitFileState: e[1],
                        is_timer: "timer" == a.slice(-5)
                    }, void (m[a] = a)) : void (m[a] ? t(m[a]) : U.LoadUnit(a).fail(function(e) {
                        console.log(e);
                    }).done(t));
                }
                var r = ++f, d = {};
                U.ListUnits().fail(e).done(function(t) {
                    if (r == f) {
                        for (var s = 0; s < t.length; s++) a(t[s]);
                        U.ListUnitFiles().fail(e).done(function(e) {
                            var t, a;
                            if (r == f) {
            ...
            var l = {}, m = {}, h = n("#services-units-tmpl").html();
            T.parse(h);
            var c, M, f = 0;
            n(U).on("UnitNew", function(e, t, a) {
                m[t] = a;
            }), n(U).on("JobNew JobRemoved", function(e, t, a, n, s) {
                var r = m[n];
                r && i(r);
            }), A.subscribe({
                ...
                var i = l[e];
                i && (a(i, s[1]), o());
            }), n(U).on("UnitFilesChanged", function(e) {
                u();
            }), n("#services-filter button").on("click", function() {
                n("#services-filter button").removeClass("active"), n(this).addClass("active"), 
                o();
            }), u();
        }
        function r() {
            var e = n(this).attr("data-action").split(":"), t = e[0], a = e[1];
            O && U.call(t, [ x, a || "fail" ]).fail(function(e) {
        ...
        function d() {
            ...
            if (O) {
                var s = [ [ x ], !1 ];
                void 0 !== a && s.push("true" == a), U.call(t, s).done(function(e) {
                    2 != e.length || e[0] || n("#service-no-install-info-dialog").modal("show"), U.Reload();
                }).fail(function(e) {
                    n("#service-error-dialog-message").text(e.toString()), n("#service-error-dialog").modal("show");
                });
            }
        ...
        function o(e) {
            function t() {
                if (O.valid) {
                    var e, t = O.ActiveState;
                    e = "active" == t || "reloading" == t || "activating" == t ? 1 : 0;
                    var a, s = O.LoadState, i = O.UnitFileState;
                    a = "masked" == s ? 7 : "static" == i ? 5 : "enabled" == i ? 2 : 0;
                    var o;
                    o = "active" == t || "reloading" == t ? O.ActiveEnterTimestamp : "inactive" == t || "failed" == t ? O.InactiveEnterTimestamp : "activating" == t ? O.InactiveExitTimestamp : O.ActiveExitTimestamp;
                    var _ = "";
                    o && (_ = w.format(C("Since $0"), new Date(o / 1e3).toLocaleString()));
                    var u = T.render(N, {
                    ...
                    if (E) {
                        var h = T.render('<a data-goto-unit="{{unit}}">{{unit}}</a>', {
                            unit: E
                        });
                        m = w.format(C("This unit is an instance of the $0 template."), h);
                    }
                    for (var c = O.Conditions, M = [], f = 0; f < c.length; f++) c[f][4] < 0 && M.push(w.format(C("Condition $0=$1 was not met"), c[f][0], c[f][3]));
                    var p = T.render(J, {
                        Unit: O,
                        Since: _,
                        HasLoadError: "loaded" !== O.LoadState,
                        LoadError: O.LoadError ? O.LoadError[1] : null,
                        UnitFileState: P,
                    ...
                    n("#service-unit").html(p), n("#service-unit-action").on("click", "[data-action]", r), 
                    n("#service-file-action").on("click", "[data-action]", d);
                }
            }
            function a() {
                var e = T.render(I, {
                    Description: w.format(C("$0 Template"), x)
                });
                n("#service-template").html(e);
            }
            if (O && (n(O).off("changed"), O = null, P = null), F && (F.stop(), F = null), n("#service-valid").hide(), 
            ...
            x = e) {
                ...
                if (W = s != -1 && (s + 1 == i || s + 1 == x.length), E = void 0, s == -1 || W || (E = x.substring(0, s + 1), 
                i != -1 && (E += x.substring(i))), W) return a(), n("#service-template").show(), 
                void n("#service").show();
                U.LoadUnit(e).done(function(a) {
                    if (x == e) {
                        var s = A.proxy("org.freedesktop.systemd1.Unit", a);
                        O = s, s.wait(function() {
                            O == s && (t(), n(O).on("changed", t), n("#service-valid").show(), n("#service").show());
                        });
                    }
                }).fail(function(e) {
                    n("#service-error-message").text(e.toString()), n("#service-invalid").show(), n("#service").show();
                }), m(), F = S.logbox([ "_SYSTEMD_UNIT=" + x, "+", "COREDUMP_UNIT=" + x, "+", "UNIT=" + x ], 10), 
                n("#service-log").empty().append(F);
            }
        }
        function _() {
            w.location.go([ n(this).attr("data-goto-unit") ]);
        }
        function u(e) {
            if (x) {
                var a = x.indexOf("@"), n = x.lastIndexOf(".");
                if (a != -1) {
                    var s = x.substring(0, a + 1);
                    s += t(e), n != -1 && (s += x.substring(n)), w.location.go([ s ]);
                }
            }
        }
        function l() {
            var e = O;
            e && A.call(e.path, "org.freedesktop.DBus.Properties", "GetAll", [ "org.freedesktop.systemd1.Unit" ]).fail(function(e) {
                console.log(e);
            }).done(function(t) {
                var a = {};
                ...
                var i = {};
                i[e.path] = s, A.notify(i);
            });
        }
        function m() {
            var e = x;
            e && U.GetUnitFileState(e).done(function(t) {
                x == e && (P = t, O && n(O).triggerHandler("changed"));
            });
        }
        function h() {
            var e = w.location.path;
            0 === e.length ? (o(null), s(), n("#services").show()) : 1 == e.length ? (n("#services").hide(), 
            o(w.location.path[0])) : (console.warn("not a init location: " + e), w.location = ""), 
            n("body").show();
        }
        function c() {
            w.spawn([ "grep", "\\w", "timer_list" ], {
                directory: "/proc"
            }).fail(function(e) {
                console.log(e);
            }).done(function(e) {
                j = parseInt(e.match(/now at (\d+)/)[1] / 1e3, 10);
            }), w.spawn([ "date", "-R" ]).fail(function(e) {
                console.log(e);
            }).done(function(e) {
        ...
        function M() {
            n("#command").val(""), n("#description").val(""), n("#servicename").val(""), Y(1), 
            n("span", n("#boot-or-specific-time")).first().text(C("After system boot")), n("span", n("#drop-time")).first().text(C("Seconds")), 
        ...
        function f(e) {
            ...
            n("#hr").removeClass("has-error"), n("#min").removeClass("has-error")), ae.map(function(t) {
                t.index === e && ($.repeat = t);
        ...
        function p() {
            ...
            44640 === $.repeat.index && (e.days_text = "1st"), L(), K.push(e), 1 === K.length ? K[0].close = "disabled" : K[0].close = "enabled", 
            y(), q && D();
        }
        function y() {
            if (n("#repeat-time").html(T.render($.repeat.render, {
                repeat: K
            })), 525600 === $.repeat.index) for (var e = new Date(H), t = new Date(e.getFullYear(), e.getMonth(), e.getDate(), 0, 0, 0, 0), a = 0; a < K.length; a++) n("[data-index='" + a + "'][data-content='datepicker']").datepicker({
                autoclose: !0,
                todayHighlight: !0,
                format: "yyyy-mm-dd",
        ...
        function L() {
            var e = 0;
            if (60 === $.repeat.index) for (;e < K.length; e++) K[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(); else if (1440 === $.repeat.index) for (;e < K.length; e++) K[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(), 
            K[e].hours = n("[data-index='" + e + "'][data-content='hours']").val().trim(); else if (10080 === $.repeat.index) for (;e < K.length; e++) K[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(), 
            K[e].hours = n("[data-index='" + e + "'][data-content='hours']").val().trim(), K[e].days_text = n("span", n("[data-content='week-days'][data-index='" + e + "']")).first().text(), 
            K[e].days_value = n("span", n("[data-content='week-days'][data-index='" + e + "']")).first().attr("value"); else if (44640 === $.repeat.index) for (;e < K.length; e++) K[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(), 
            K[e].hours = n("[data-index='" + e + "'][data-content='hours']").val().trim(), K[e].days_text = n("span", n("[data-content='month-days'][data-index='" + e + "']")).first().text(), 
            K[e].days_value = n("span", n("[data-content='month-days'][data-index='" + e + "']")).first().attr("value"); else if (525600 === $.repeat.index) for (;e < K.length; e++) K[e].minutes = n("[data-index='" + e + "'][data-content='minutes']").val().trim(), 
            K[e].hours = n("[data-index='" + e + "'][data-content='hours']").val().trim(), K[e].date_to_parse = new Date(n("[data-index='" + e + "'] .bootstrap-datepicker").val()), 
        ...
        function Y(e) {
            ...
            n("#boot-time").val("00"), n("#boot-time").removeClass("has-error"), $.Calendar_or_Boot = "Boot") : 2 == e && (n("#boot").hide(), 
            n("#boot-error-row").hide(), n("#specific-time-error-row").hide(), n("#repeat-options").show(), 
            f(0), n("span", n("#drop-repeat")).first().text(C("Don't Repeat")), $.Calendar_or_Boot = "Calendar");
        }
        function g(e) {
            switch (e = Number(e)) {
              case 1:
              ...
              case 604800:
                $.boot_time_unit = "weeks";
            }
        }
        function D() {
            q = !1;
            var e = n("#servicename").val();
            if (e.trim().length < 1 ? (n("#servicename-error").text(C("This field cannot be empty.")), 
            n("#servicename-error-row").show(), n("#servicename").addClass("has-error"), q = !0) : /^[a-zA-Z0-9:_.@-]+$/.test(e) || (n("#servicename-error").text(C("Only alphabets, numbers, : , _ , . , @ , - are allowed.")), 
            n("#servicename-error-row").show(), n("#servicename").addClass("has-error"), q = !0), 
            e = n("#description").val().trim(), e.length < 1 && (n("#description-error").text(C("This field cannot be empty.")), 
            n("#description-error-row").show(), n("#description").addClass("has-error"), q = !0), 
            e = n("#command").val().trim(), e.length < 1 && (n("#command-error").text(C("This field cannot be empty.")), 
            n("#command-error-row").show(), n("#command").addClass("has-error"), q = !0), "Boot" == $.Calendar_or_Boot) e = n("#boot-time").val(), 
            /^[0-9]+$/.test(e.trim()) || (n("#boot-error").text(C("Invalid number.")), n("#boot-error-row").show(), 
            n("#boot-time").addClass("has-error"), q = !0); else {
                var t = 0;
                if (0 === $.repeat.index) {
                    var a = n("#hr").val().trim(), s = n("#min").val().trim();
                    n("#hr-error").text(""), n("#min-error").text(""), /^[0-9]+$/.test(a) && a <= 23 && a >= 0 || (n("#hr-error").text(C("Hour needs to be a number between 0-23")), 
                    n("#specific-time-error-row").show(), n("#hr").addClass("has-error"), q = !0), /^[0-9]+$/.test(s) && s <= 59 && s >= 0 || (n("#min-error").text(C("Minute needs to be a number between 0-59")), 
                    n("#specific-time-error-row").show(), n("#min").addClass("has-error"), q = !0);
                } else if (60 === $.repeat.index) for (;t < K.length; t++) /^[0-9]+$/.test(K[t].minutes.trim()) && K[t].minutes.trim() <= 59 && K[t].minutes.trim() >= 0 || (n("[data-index='" + t + "'][data-content='minutes']").addClass("has-error"), 
                n("[data-index='" + t + "'][data-content='min-error']").text(C("Minute needs to be a number between 0-59")), 
                q = !0); else for (;t < K.length; t++) /^[0-9]+$/.test(K[t].minutes.trim()) && K[t].minutes.trim() <= 59 && K[t].minutes.trim() >= 0 || (q = !0, 
                n("[data-index='" + t + "'][data-content='minutes']").addClass("has-error"), n("[data-index='" + t + "'][data-content='min-error']").text(C("Minute needs to be a number between 0-59"))), 
                /^[0-9]+$/.test(K[t].hours.trim()) && K[t].hours.trim() <= 23 && K[t].hours.trim() >= 0 || (q = !0, 
                n("[data-index='" + t + "'][data-content='hours']").addClass("has-error"), n("[data-index='" + t + "'][data-content='hr-error']").text(C("Hour needs to be a number between 0-23"))), 
                525600 === $.repeat.index && (isNaN(K[t].date_to_parse.getTime()) || K[t].date_to_parse.getTime() < 0) && (q = !0, 
                n("[data-index='" + t + "'][data-content='datepicker']").addClass("has-error"), 
                n("[data-index='" + t + "'][data-content='date-error']").text(C("Invalid date format."))), 
                44640 === $.repeat.index && "31" === K[t].days_value && n("[data-index='" + t + "'][data-content='day-error']").html(C("This day doesn't exist in all months.<br> The timer will only be executed in months that have 31st."));
            }
            return q;
        }
        function k() {
            ...
            var e = D();
            if (e) return !1;
            if ($.name = n("#servicename").val().replace(/\s/g, ""), $.Description = n("#description").val(), 
            $.Command = n("#command").val(), $.boot_time = n("#boot-time").val(), 0 === $.repeat.index) {
                $.repeat_hour = Number(n("#hr").val().trim()), $.repeat_minute = Number(n("#min").val().trim());
                var t = new Date(H);
                $.OnCalendar = "OnCalendar=" + t.getFullYear() + "-" + (t.getMonth() + 1) + "-" + t.getDate() + " " + $.repeat_hour + ":" + $.repeat_minute + ":00";
            } else 60 === $.repeat.index ? ($.repeat_minute = K.map(function(e) {
                return Number(e.minutes);
            }), $.OnCalendar = "OnCalendar=*-*-* *:" + $.repeat_minute + ":00") : 1440 === $.repeat.index ? $.OnCalendar = K.map(function(e) {
                return "OnCalendar=*-*-* " + Number(e.hours) + ":" + Number(e.minutes) + ":00";
            }) : 10080 === $.repeat.index ? $.OnCalendar = K.map(function(e) {
                return "OnCalendar=" + e.days_text.slice(0, 3) + " *-*-* " + Number(e.hours) + ":" + Number(e.minutes) + ":00";
            }) : 44640 === $.repeat.index ? $.OnCalendar = K.map(function(e) {
                return "OnCalendar=*-*-" + e.days_value + " " + Number(e.hours) + ":" + Number(e.minutes) + ":00";
            }) : 525600 === $.repeat.index && ($.OnCalendar = K.map(function(e) {
                return "OnCalendar=*-" + b(e.date_to_parse).format("MM") + "-" + b(e.date_to_parse).format("DD") + " " + Number(e.hours) + ":" + Number(e.minutes) + ":00";
            }));
            60 !== $.repeat.index && ($.OnCalendar = $.OnCalendar.toString().replace(/,/g, "\n"));
            var a = v();
            return !a && (i(), !0);
        }
        function v() {
            var e = "[Unit]\nDescription=", t = "\n[Service]\nExecStart=", a = "\n[Timer]\n", n = "[Install]\nWantedBy=timers.target\n", s = e + $.Description + t + $.Command + "\n", i = " ";
            if ("Boot" == $.Calendar_or_Boot) {
                var r = a + "OnBootSec=" + $.boot_time + $.boot_time_unit + "\n";
                i = e + $.Description + r;
            } else if ("Calendar" == $.Calendar_or_Boot) {
                var d = a + $.OnCalendar + "\n";
                i = e + $.Description + d;
            }
            i += n;
            var o = "/etc/systemd/system/" + $.name + ".service", _ = w.file(o, {
                superuser: "try"
            });
            _.replace(s).fail(function(e) {
                console.log(e);
            });
            var u = "/etc/systemd/system/" + $.name + ".timer";
            _ = w.file(u, {
                superuser: "try"
            }), _.replace(i).done(function(e) {
                U.Reload().done(function(e) {
                    U.EnableUnitFiles([ $.name + ".timer" ], !1, !1).fail(function(e) {
                        console.warn("Failed to enable timer unit:", e);
                    }), "Calendar" == $.Calendar_or_Boot && U.StartUnit($.name + ".timer", "replace").fail(function(e) {
        ...
        var w = a(3), T = a(5), b = a(11), S = a(4);
        a(132), a(133), w.translate();
        var H, j, x, O, P, W, E, F, C = w.gettext, A = w.dbus("org.freedesktop.systemd1", {
            superuser: "try"
        }), U = A.proxy("org.freedesktop.systemd1.Manager", "/org/freedesktop/systemd1"), z = !1, N = n("#action-btn-tmpl").html();
        T.parse(N);
        var J = n("#service-unit-tmpl").html();
        T.parse(J);
        var I = n("#service-template-tmpl").html();
        T.parse(I);
        var R = [ {
            title: C("Start"),
            action: "StartUnit"
            ...
            title: C("Preset Forcefully"),
            action: "PresetUnitFiles:true"
        }, {
            title: C("Mask"),
            action: "MaskUnitFiles:false"
        }, {
            title: C("Mask Forcefully"),
            action: "MaskUnitFiles:true"
        }, {
            title: C("Unmask"),
            action: "UnmaskUnitFiles"
        } ];
        n(U).on("Reloading", function(e, t) {
            t || l();
        }), n(U).on("JobNew JobRemoved", function(e, t, a, n, s) {
            x == n && l();
        }), n(U).on("UnitFilesChanged", function(e) {
            m();
        }), n(w).on("locationchanged", h), n("#service-navigate-home").on("click", function() {
            w.location.go("/");
        }), n("body").on("click", "[data-goto-unit]", _), n("#service-template").on("click", "button", function() {
            u(n("#service-template input").val());
        });
        var G = w.permission({
            admin: !0
        });
        n(G).on("changed", function() {
            G.allowed === !1 && (n("#create-timer").addClass("accounts-privileged"), n(".accounts-privileged").update_privileged(G, w.format(C("The user <b>$0</b> does not have permissions for creating timers"), G.user ? G.user.name : ""), "left"));
        }), n("#create-timer").on("click", function() {
            M(), n("#timer-dialog").modal("show"), c();
        }), n("#timer-dialog").on("click", "#timer-save-button", function() {
            var e = k();
            e && n("#timer-dialog").modal("toggle");
        }), c();
        var B = w.dbus("org.freedesktop.timedate1");
        B.subscribe({
            interface: "org.freedesktop.DBus.Properties",
            member: "PropertiesChanged"
        }, c);
        var $ = {}, K = [], q = !1, Z = n("#repeat-hourly-tmpl").html();
        T.parse(Z);
        var Q = n("#repeat-daily-tmpl").html();
        T.parse(Q);
        var X = n("#repeat-weekly-tmpl").html();
        T.parse(X);
        var ee = n("#repeat-monthly-tmpl").html();
        T.parse(ee);
        var te = n("#repeat-yearly-tmpl").html();
        T.parse(te);
        var ae = [ {
            index: 0,
            render: ""
        ...
        n("#timer-dialog").on("click", "[data-content='datepicker']", function() {
            ne = n("#timer-dialog").scrollTop(), n(this).removeClass("has-error"), n("[data-index='" + n(this).attr("data-index") + "'][data-content='date-error']").text(""), 
            ...
            se > ne ? n(".datepicker.datepicker-dropdown.dropdown-menu").css("margin-top", se) : n(".datepicker.datepicker-dropdown.dropdown-menu").css("margin-top", ne);
        }), n("#timer-dialog").on("mouseenter", ".datepicker.datepicker-dropdown [class*='datepicker-'] thead", function() {
            se = n("#timer-dialog").scrollTop();
    ...
    (function(e) {
        !function(t, a) {
            ...
            function f(e) {
                if (null == e._isValid) {
                    var t = M(e), a = jn.call(t.parsedDateParts, function(e) {
                        return null != e;
            ...
            function y(e, t) {
                ...
                d(t._pf) || (e._pf = M(t)), d(t._locale) || (e._locale = t._locale), xn.length > 0) for (a = 0; a < xn.length; a++) n = xn[a], 
                s = t[n], d(s) || (e[n] = s);
                return e;
            }
            function L(e) {
            ...
            function k(e, t, a) {
                ...
                for (n = 0; n < s; n++) (a && e[n] !== t[n] || !a && D(e[n]) !== D(t[n])) && r++;
                return r + i;
            }
            function v(e) {
            ...
            function U(e) {
                var t, a, n = {};
                for (a in e) l(e, a) && (t = A(a), t && (n[t] = e[a]));
                return n;
            }
            function z(e, t) {
                Jn[e] = t;
            ...
            function K(e, t) {
                return l(us, e) ? us[e](t._strict, t._locale) : new RegExp(q(e));
            }
            function q(e) {
            ...
            function de(e) {
                return e = A(e), b(this[e]) ? this[e]() : this;
            }
            function oe(e, t) {
                if ("object" == typeof e) {
                    e = U(e);
                    for (var a = N(e), n = 0; n < a.length; n++) this[a[n].unit](e[a[n].unit]);
                } else if (e = A(e), b(this[e])) return this[e](t);
                return this;
            }
            function _e(e, t) {
                return (e % t + t) % t;
            ...
            function le(e, t) {
                return e ? s(this._months) ? this._months[e.month()] : this._months[(this._months.isFormat || ks).test(t) ? "format" : "standalone"][e.month()] : s(this._months) ? this._months : this._months.standalone;
            }
            function me(e, t) {
                return e ? s(this._monthsShort) ? this._monthsShort[e.month()] : this._monthsShort[ks.test(t) ? "format" : "standalone"][e.month()] : s(this._monthsShort) ? this._monthsShort : this._monthsShort.standalone;
            }
            function he(e, t, a) {
                ...
                return a ? "MMM" === t ? (s = gs.call(this._shortMonthsParse, r), s !== -1 ? s : null) : (s = gs.call(this._longMonthsParse, r), 
                s !== -1 ? s : null) : "MMM" === t ? (s = gs.call(this._shortMonthsParse, r), s !== -1 ? s : (s = gs.call(this._longMonthsParse, r), 
                s !== -1 ? s : null)) : (s = gs.call(this._longMonthsParse, r), s !== -1 ? s : (s = gs.call(this._shortMonthsParse, r), 
                s !== -1 ? s : null));
            }
            function ce(e, t, a) {
                var n, s, i;
                if (this._monthsParseExact) return he.call(this, e, t, a);
                for (this._monthsParse || (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = []), 
                n = 0; n < 12; n++) {
                    if (s = h([ 2e3, n ]), a && !this._longMonthsParse[n] && (this._longMonthsParse[n] = new RegExp("^" + this.months(s, "").replace(".", "") + "$", "i"), 
            ...
            function Me(e, t) {
                ...
                if ("string" == typeof t) if (/^\d+$/.test(t)) t = D(t); else if (t = e.localeData().monthsParse(t), 
                !o(t)) return e;
                return a = Math.min(e.date(), ue(e.year(), t)), e._d["set" + (e._isUTC ? "UTC" : "") + "Month"](t, a), 
                e;
            }
            function fe(e) {
                return null != e ? (Me(this, e), t.updateOffset(this, !0), this) : ie(this, "Month");
            }
            function pe() {
            ...
            function Ye() {
                ...
                var t, a, n = [], s = [], i = [];
                for (t = 0; t < 12; t++) a = h([ 2e3, t ]), n.push(this.monthsShort(a, "")), s.push(this.months(a, "")), 
            ...
            function ke(e, t, a) {
                var n = 7 + t - a, s = (7 + De(e, 0, n).getUTCDay() - t) % 7;
                return -s + n - 1;
            }
            function ve(e, t, a, n, s) {
                var i, r, d = (7 + a - n) % 7, o = ke(e, n, s), _ = 1 + 7 * (t - 1) + d + o;
            ...
            function we(e, t, a) {
                var n, s, i = ke(e.year(), t, a), r = Math.floor((e.dayOfYear() - i - 1) / 7) + 1;
            ...
            function Ce(e, t, a) {
                ...
                return a ? "dddd" === t ? (s = gs.call(this._weekdaysParse, r), s !== -1 ? s : null) : "ddd" === t ? (s = gs.call(this._shortWeekdaysParse, r), 
                s !== -1 ? s : null) : (s = gs.call(this._minWeekdaysParse, r), s !== -1 ? s : null) : "dddd" === t ? (s = gs.call(this._weekdaysParse, r), 
                s !== -1 ? s : (s = gs.call(this._shortWeekdaysParse, r), s !== -1 ? s : (s = gs.call(this._minWeekdaysParse, r), 
                s !== -1 ? s : null))) : "ddd" === t ? (s = gs.call(this._shortWeekdaysParse, r), 
                s !== -1 ? s : (s = gs.call(this._weekdaysParse, r), s !== -1 ? s : (s = gs.call(this._minWeekdaysParse, r), 
                s !== -1 ? s : null))) : (s = gs.call(this._minWeekdaysParse, r), s !== -1 ? s : (s = gs.call(this._weekdaysParse, r), 
                s !== -1 ? s : (s = gs.call(this._shortWeekdaysParse, r), s !== -1 ? s : null)));
            }
            function Ae(e, t, a) {
                var n, s, i;
                ...
                this._shortWeekdaysParse = [], this._fullWeekdaysParse = []), n = 0; n < 7; n++) {
                    if (s = h([ 2e3, 1 ]).day(n), a && !this._fullWeekdaysParse[n] && (this._fullWeekdaysParse[n] = new RegExp("^" + this.weekdays(s, "").replace(".", ".?") + "$", "i"), 
            ...
            function Ve() {
                ...
                for (t = 0; t < 7; t++) a = h([ 2e3, 1 ]).day(t), n = this.weekdaysMin(a, ""), s = this.weekdaysShort(a, ""), 
            ...
            function tt(e, t) {
                var a;
                return e && (a = d(t) ? st(e) : at(e, t), a && (Es = a)), Es._abbr;
            }
            function at(e, t) {
                if (null !== t) {
                    var a = As;
                    ...
                    a = Us[e]._config; else if (null != t.parentLocale) {
                        if (null == Us[t.parentLocale]) return zs[t.parentLocale] || (zs[t.parentLocale] = []), 
                        zs[t.parentLocale].push({
                            name: e,
                            config: t
                        }), null;
                        a = Us[t.parentLocale]._config;
                    }
                    return Us[e] = new j(H(a, t)), zs[e] && zs[e].forEach(function(e) {
                        at(e.name, e.config);
                    }), tt(e), Us[e];
                }
            ...
            function rt(e) {
                var t, a = e._a;
                return a && M(e).overflow === -2 && (t = a[hs] < 0 || a[hs] > 11 ? hs : a[cs] < 1 || a[cs] > ue(a[ms], a[hs]) ? cs : a[Ms] < 0 || a[Ms] > 24 || 24 === a[Ms] && (0 !== a[fs] || 0 !== a[ps] || 0 !== a[ys]) ? Ms : a[fs] < 0 || a[fs] > 59 ? fs : a[ps] < 0 || a[ps] > 59 ? ps : a[ys] < 0 || a[ys] > 999 ? ys : -1, 
                M(e)._overflowDayOfYear && (t < ms || t > cs) && (t = cs), M(e)._overflowWeeks && t === -1 && (t = Ls), 
                M(e)._overflowWeekday && t === -1 && (t = Ys), M(e).overflow = t), e;
            }
            function dt(e, t, a) {
            ...
            function _t(e) {
                var t, a, n, s, i = [];
                if (!e._d) {
                    for (n = ot(e), e._w && null == e._a[cs] && null == e._a[hs] && ut(e), null != e._dayOfYear && (s = dt(e._a[ms], n[ms]), 
                    (e._dayOfYear > te(s) || 0 === e._dayOfYear) && (M(e)._overflowDayOfYear = !0), 
                    a = De(s, 0, e._dayOfYear), e._a[hs] = a.getUTCMonth(), e._a[cs] = a.getUTCDate()), 
                    t = 0; t < 3 && null == e._a[t]; ++t) e._a[t] = i[t] = n[t];
                    for (;t < 7; t++) e._a[t] = i[t] = null == e._a[t] ? 2 === t ? 1 : 0 : e._a[t];
                    24 === e._a[Ms] && 0 === e._a[fs] && 0 === e._a[ps] && 0 === e._a[ys] && (e._nextDay = !0, 
                    e._a[Ms] = 0), e._d = (e._useUTC ? De : ge).apply(null, i), null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), 
                    e._nextDay && (e._a[Ms] = 24), e._w && "undefined" != typeof e._w.d && e._w.d !== e._d.getDay() && (M(e).weekdayMismatch = !0);
                }
            }
            function ut(e) {
                var t, a, n, s, i, r, d, o;
                ...
                n < 1 || n > Te(a, i, r) ? M(e)._overflowWeeks = !0 : null != o ? M(e)._overflowWeekday = !0 : (d = ve(a, n, s, i, r), 
                e._a[ms] = d.year, e._dayOfYear = d.dayOfYear);
            }
            function lt(e) {
                var t, a, n, s, i, r, d = e._i, o = Ns.exec(d) || Js.exec(d);
                if (o) {
                    for (M(e).iso = !0, t = 0, a = Rs.length; t < a; t++) if (Rs[t][1].exec(o[1])) {
                        s = Rs[t][0], n = Rs[t][2] !== !1;
                        break;
                    }
            ...
            function mt(e, t, a, n, s, i) {
                var r = [ ht(e), ws.indexOf(t), parseInt(a, 10), parseInt(n, 10), parseInt(s, 10) ];
            ...
            function pt(e) {
                var t = Bs.exec(ct(e._i));
                if (t) {
                    var a = mt(t[4], t[3], t[2], t[5], t[6], t[7]);
                    if (!Mt(t[1], a, e)) return;
                    e._a = a, e._tzm = ft(t[8], t[9], t[10]), e._d = De.apply(null, e._a), e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), 
                    M(e).rfc2822 = !0;
                } else e._isValid = !1;
            }
            function yt(e) {
            ...
            function Lt(e) {
                ...
                n = (d.match(K(i, e)) || [])[0], n && (r = d.substr(0, d.indexOf(n)), r.length > 0 && M(e).unusedInput.push(r), 
                d = d.slice(d.indexOf(n) + n.length), _ += n.length), Gn[i] ? (n ? M(e).empty = !1 : M(e).unusedTokens.push(i), 
                ee(i, n, e)) : e._strict && !n && M(e).unusedTokens.push(i);
                M(e).charsLeftOver = o - _, d.length > 0 && M(e).unusedInput.push(d), e._a[Ms] <= 12 && M(e).bigHour === !0 && e._a[Ms] > 0 && (M(e).bigHour = void 0), 
                M(e).parsedDateParts = e._a.slice(0), M(e).meridiem = e._meridiem, e._a[Ms] = Yt(e._locale, e._a[Ms], e._meridiem), 
                _t(e), rt(e);
            }
            function Yt(e, t, a) {
                var n;
            ...
            function gt(e) {
                ...
                t._f = e._f[s], Lt(t), f(t) && (i += M(t).charsLeftOver, i += 10 * M(t).unusedTokens.length, 
                M(t).score = i, (null == n || i < n) && (n = i, a = t));
                m(e, a || t);
            }
            function Dt(e) {
                if (!e._d) {
            ...
            function vt(e) {
                ...
                return e._locale = e._locale || st(e._l), null === t || void 0 === a && "" === t ? p({
                    nullInput: !0
                }) : ("string" == typeof t && (e._i = t = e._locale.preparse(t)), Y(t) ? new L(rt(t)) : (_(t) ? e._d = t : s(a) ? gt(e) : a ? Lt(e) : wt(e), 
                f(e) || (e._d = null), e));
            }
            function wt(e) {
                var a = e._i;
                ...
                }), _t(e)) : i(a) ? Dt(e) : o(a) ? e._d = new Date(a) : t.createFromInputFallback(e);
            }
            ...
            function xt(e) {
                for (var t in e) if (gs.call(Qs, t) === -1 || null != e[t] && isNaN(e[t])) return !1;
                for (var a = !1, n = 0; n < Qs.length; ++n) if (e[Qs[n]]) {
                    if (a) return !1;
                    parseFloat(e[Qs[n]]) !== D(e[Qs[n]]) && (a = !0);
                }
                return !0;
            }
            function Ot() {
            ...
            function At(e, t) {
                ...
                var n = a[a.length - 1] || [], s = (n + "").match(Xs) || [ "-", 0, 0 ], i = +(60 * s[1]) + D(s[2]);
            ...
            function Nt(e, a, n) {
                ...
                if (null != e) {
                    if ("string" == typeof e) {
                        if (e = At(ds, e), null === e) return this;
            ...
            function na(e, a, n, s) {
                ...
                e.isValid() && (s = null == s || s, d && Me(e, ie(e, "Month") + d * n), r && re(e, "Date", ie(e, "Date") + r * n), 
            ...
            function da(e, t) {
                var a = Y(e) ? e : bt(e);
                return !(!this.isValid() || !a.isValid()) && (t = A(d(t) ? "millisecond" : t), "millisecond" === t ? this.valueOf() > a.valueOf() : a.valueOf() < this.clone().startOf(t).valueOf());
            }
            function oa(e, t) {
                var a = Y(e) ? e : bt(e);
                return !(!this.isValid() || !a.isValid()) && (t = A(d(t) ? "millisecond" : t), "millisecond" === t ? this.valueOf() < a.valueOf() : this.clone().endOf(t).valueOf() < a.valueOf());
            }
            function _a(e, t, a, n) {
            ...
            function ua(e, t) {
                var a, n = Y(e) ? e : bt(e);
                return !(!this.isValid() || !n.isValid()) && (t = A(t || "millisecond"), "millisecond" === t ? this.valueOf() === n.valueOf() : (a = n.valueOf(), 
            ...
            function fa() {
                ...
                return e.year() < 0 || e.year() > 9999 ? G(e, "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]") : b(Date.prototype.toISOString) ? this.toDate().toISOString() : G(e, "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]");
            }
            function pa() {
            ...
            function Ia(e, t, a, n, s) {
                var i = ve(e, t, a, n, s), r = De(i.year, 0, i.dayOfYear);
            ...
            function mn() {
                ...
                return i >= 0 && r >= 0 && d >= 0 || i <= 0 && r <= 0 && d <= 0 || (i += 864e5 * ln(cn(d) + r), 
                r = 0, d = 0), o.milliseconds = i % 1e3, e = g(i / 1e3), o.seconds = e % 60, t = g(e / 60), 
                o.minutes = t % 60, a = g(t / 60), o.hours = a % 24, r += g(a / 24), s = g(hn(r)), 
                d += s, r -= ln(cn(s)), n = g(d / 12), d %= 12, o.days = r, o.months = d, o.years = n, 
                this;
            }
            function hn(e) {
            ...
            function Mn(e) {
                ...
                if (e = A(e), "month" === e || "year" === e) return t = this._days + n / 864e5, 
                a = this._months + hn(t), "month" === e ? a : a / 12;
            ...
            function kn(e, t, a) {
                ...
                return u[2] = t, u[3] = +e > 0, u[4] = a, Dn.apply(null, u);
            }
            function vn(e) {
            ...
            function Tn(e) {
                ...
                var t = this.localeData(), a = kn(this, !e, t);
            ...
            function Sn() {
                ...
                e = g(n / 60), t = g(e / 60), n %= 60, e %= 60, a = g(i / 12), i %= 12;
                var r = a, d = i, o = s, _ = t, u = e, l = n ? n.toFixed(3).replace(/\.?0+$/, "") : "", m = this.asSeconds();
                if (!m) return "P0D";
                var h = m < 0 ? "-" : "", c = bn(this._months) !== bn(m) ? "-" : "", M = bn(this._days) !== bn(m) ? "-" : "", f = bn(this._milliseconds) !== bn(m) ? "-" : "";
                return h + "P" + (r ? c + r + "Y" : "") + (d ? c + d + "M" : "") + (o ? M + o + "D" : "") + (_ || u || l ? "T" : "") + (_ ? f + _ + "H" : "") + (u ? f + u + "M" : "") + (l ? f + l + "S" : "");
            }
            var Hn, jn;
            ...
            var En = {
            ...
            }, Cn = "Invalid date", An = "%d", Un = /\d{1,2}/, zn = {
                future: "in %s",
                past: "%s ago",
                s: "a few seconds",
                ss: "%d seconds",
                ...
                y: "a year",
                yy: "%d years"
            }, Nn = {}, Jn = {}, In = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, Rn = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Vn = {}, Gn = {}, Bn = /\d/, $n = /\d\d/, Kn = /\d{3}/, qn = /\d{4}/, Zn = /[+-]?\d{6}/, Qn = /\d\d?/, Xn = /\d\d\d\d?/, es = /\d\d\d\d\d\d?/, ts = /\d{1,3}/, as = /\d{1,4}/, ns = /[+-]?\d{1,6}/, ss = /\d+/, is = /[+-]?\d+/, rs = /Z|[+-]\d\d:?\d\d/gi, ds = /Z|[+-]\d\d(?::?\d\d)?/gi, os = /[+-]?\d+(\.\d{1,3})?/, _s = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, us = {}, ls = {}, ms = 0, hs = 1, cs = 2, Ms = 3, fs = 4, ps = 5, ys = 6, Ls = 7, Ys = 8;
            I("Y", 0, 0, function() {
                var e = this.year();
                return e <= 9999 ? "" + e : "+" + e;
            }), I(0, [ "YY", 2 ], 0, function() {
            ...
            C("year", "y"), z("year", 1), $("Y", is), $("YY", Qn, $n), $("YYYY", as, qn), $("YYYYY", ns, Zn), 
            $("YYYYYY", ns, Zn), Q([ "YYYYY", "YYYYYY" ], ms), Q("YYYY", function(e, a) {
                a[ms] = 2 === e.length ? t.parseTwoDigitYear(e) : D(e);
            }), Q("YY", function(e, a) {
            ...
            gs = Array.prototype.indexOf ? Array.prototype.indexOf : function(e) {
            ...
            }), C("month", "M"), z("month", 8), $("M", Qn), $("MM", Qn, $n), $("MMM", function(e, t) {
                ...
                null != s ? t[hs] = s : M(a).invalidMonth = e;
            });
            var ks = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/, vs = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ws = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), Ts = _s, bs = _s;
            I("w", [ "ww", 2 ], "wo", "week"), I("W", [ "WW", 2 ], "Wo", "isoWeek"), C("week", "w"), 
            C("isoWeek", "W"), z("week", 5), z("isoWeek", 5), $("w", Qn), $("ww", Qn, $n), $("W", Qn), 
            ...
            C("isoWeekday", "E"), z("day", 11), z("weekday", 11), z("isoWeekday", 11), $("d", Qn), 
            ...
            }), $e("a", !0), $e("A", !1), C("hour", "h"), z("hour", 13), $("a", Ke), $("A", Ke), 
            $("H", Qn), $("h", Qn), $("k", Qn), $("HH", Qn, $n), $("hh", Qn, $n), $("kk", Qn, $n), 
            $("hmm", Xn), $("hmmss", es), $("Hmm", Xn), $("Hmmss", es), Q([ "H", "HH" ], Ms), 
            Q([ "k", "kk" ], function(e, t, a) {
                ...
                t[Ms] = D(e), M(a).bigHour = !0;
            }), Q("hmm", function(e, t, a) {
                var n = e.length - 2;
                t[Ms] = D(e.substr(0, n)), t[fs] = D(e.substr(n)), M(a).bigHour = !0;
            }), Q("hmmss", function(e, t, a) {
                var n = e.length - 4, s = e.length - 2;
                t[Ms] = D(e.substr(0, n)), t[fs] = D(e.substr(n, 2)), t[ps] = D(e.substr(s)), M(a).bigHour = !0;
            }), Q("Hmm", function(e, t, a) {
                var n = e.length - 2;
                t[Ms] = D(e.substr(0, n)), t[fs] = D(e.substr(n));
            }), Q("Hmmss", function(e, t, a) {
                var n = e.length - 4, s = e.length - 2;
                t[Ms] = D(e.substr(0, n)), t[fs] = D(e.substr(n, 2)), t[ps] = D(e.substr(s));
            });
            var Es, Fs = /[ap]\.?m?\.?/i, Cs = se("Hours", !0), As = {
                calendar: En,
                longDateFormat: Fn,
                invalidDate: Cn,
                ordinal: An,
            ...
            var Ks = w("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
                var e = bt.apply(null, arguments);
                return this.isValid() && e.isValid() ? e < this ? this : e : p();
            }), qs = w("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
                var e = bt.apply(null, arguments);
                return this.isValid() && e.isValid() ? e > this ? this : e : p();
            }), Zs = function() {
                return Date.now ? Date.now() : +new Date();
            }, Qs = [ "year", "quarter", "month", "week", "day", "hour", "minute", "second", "millisecond" ];
            Ct("Z", ":"), Ct("ZZ", ""), $("Z", ds), $("ZZ", ds), Q([ "Z", "ZZ" ], function(e, t, a) {
                a._useUTC = !0, a._tzm = At(ds, e);
            });
            var Xs = /([\+\-]|\d\d)/gi;
            ...
            }), Ca("gggg", "weekYear"), Ca("ggggg", "weekYear"), Ca("GGGG", "isoWeekYear"), 
            Ca("GGGGG", "isoWeekYear"), C("weekYear", "gg"), C("isoWeekYear", "GG"), z("weekYear", 1), 
            z("isoWeekYear", 1), $("G", is), $("g", is), $("GG", Qn, $n), $("gg", Qn, $n), $("GGGG", as, qn), 
            $("gggg", as, qn), $("GGGGG", ns, Zn), $("ggggg", ns, Zn), X([ "gggg", "ggggg", "GGGG", "GGGGG" ], function(e, t, a, n) {
                t[n.substr(0, 2)] = D(e);
            }), X([ "gg", "GG" ], function(e, a, n, s) {
                a[s] = t.parseTwoDigitYear(e);
            }), I("Q", 0, "Qo", "quarter"), C("quarter", "Q"), z("quarter", 7), $("Q", Bn), 
            Q("Q", function(e, t) {
                t[hs] = 3 * (D(e) - 1);
            }), I("D", [ "DD", 2 ], "Do", "date"), C("date", "D"), z("date", 9), $("D", Qn), 
            $("DD", Qn, $n), $("Do", function(e, t) {
                return e ? t._dayOfMonthOrdinalParse || t._ordinalParse : t._dayOfMonthOrdinalParseLenient;
            }), Q([ "D", "DD" ], cs), Q("Do", function(e, t) {
                t[cs] = D(e.match(Qn)[0], 10);
            });
            var ii = se("Date", !0);
            I("DDD", [ "DDDD", 3 ], "DDDo", "dayOfYear"), C("dayOfYear", "DDD"), z("dayOfYear", 4), 
            $("DDD", ts), $("DDDD", Kn), Q([ "DDD", "DDDD" ], function(e, t, a) {
                a._dayOfYear = D(e);
            }), I("m", [ "mm", 2 ], 0, "minute"), C("minute", "m"), z("minute", 14), $("m", Qn), 
            $("mm", Qn, $n), Q([ "m", "mm" ], fs);
            var ri = se("Minutes", !1);
            I("s", [ "ss", 2 ], 0, "second"), C("second", "s"), z("second", 15), $("s", Qn), 
            $("ss", Qn, $n), Q([ "s", "ss" ], ps);
            var di = se("Seconds", !1);
            I("S", 0, 0, function() {
            ...
            }), C("millisecond", "ms"), z("millisecond", 16), $("S", ts, Bn), $("SS", ts, $n), 
            $("SSS", ts, Kn);
            var oi;
            ...
            var ui = L.prototype;
            ui.add = ai, ui.calendar = ia, ui.clone = ra, ui.diff = ha, ui.endOf = Ta, ui.format = ya, 
            ui.from = La, ui.fromNow = Ya, ui.to = ga, ui.toNow = Da, ui.get = de, ui.invalidAt = Ea, 
            ui.isAfter = da, ui.isBefore = oa, ui.isBetween = _a, ui.isSame = ua, ui.isSameOrAfter = la, 
            ui.isSameOrBefore = ma, ui.isValid = Pa, ui.lang = si, ui.locale = ka, ui.localeData = va, 
            ui.max = qs, ui.min = Ks, ui.parsingFlags = Wa, ui.set = oe, ui.startOf = wa, ui.subtract = ni, 
            ui.toArray = ja, ui.toObject = xa, ui.toDate = Ha, ui.toISOString = fa, ui.inspect = pa, 
            ui.toJSON = Oa, ui.toString = Ma, ui.unix = Sa, ui.valueOf = ba, ui.creationData = Fa, 
            ui.year = Ds, ui.isLeapYear = ne, ui.weekYear = Aa, ui.isoWeekYear = Ua, ui.quarter = ui.quarters = Ra, 
            ui.month = fe, ui.daysInMonth = pe, ui.week = ui.weeks = je, ui.isoWeek = ui.isoWeeks = xe, 
            ui.weeksInYear = Na, ui.isoWeeksInYear = za, ui.date = ii, ui.day = ui.days = Ue, 
            ui.weekday = ze, ui.isoWeekday = Ne, ui.dayOfYear = Va, ui.hour = ui.hours = Cs, 
            ...
            ui.isDST = Bt, ui.isLocal = Kt, ui.isUtcOffset = qt, ui.isUtc = Zt, ui.isUTC = Zt, 
            ui.zoneAbbr = Ba, ui.zoneName = $a, ui.dates = w("dates accessor is deprecated. Use date instead.", ii), 
            ui.months = w("months accessor is deprecated. Use month instead", fe), ui.years = w("years accessor is deprecated. Use year instead", Ds), 
            ...
            li.monthsShort = me, li.monthsParse = ce, li.monthsRegex = Le, li.monthsShortRegex = ye, 
            li.week = be, li.firstDayOfYear = He, li.firstDayOfWeek = Se, li.weekdays = We, 
            li.weekdaysMin = Fe, li.weekdaysShort = Ee, li.weekdaysParse = Ae, li.weekdaysRegex = Je, 
            li.weekdaysShortRegex = Ie, li.weekdaysMinRegex = Re, li.isPM = qe, li.meridiem = Ze, 
            tt("en", {
                dayOfMonthOrdinalParse: /\d{1,2}(th|st|nd|rd)/,
                ordinal: function(e) {
                    var t = e % 10, a = 1 === D(e % 100 / 10) ? "th" : 1 === t ? "st" : 2 === t ? "nd" : 3 === t ? "rd" : "th";
                    return e + a;
                }
            ...
            var mi = Math.abs, hi = pn("ms"), ci = pn("s"), Mi = pn("m"), fi = pn("h"), pi = pn("d"), yi = pn("w"), Li = pn("M"), Yi = pn("y"), gi = Yn("milliseconds"), Di = Yn("seconds"), ki = Yn("minutes"), vi = Yn("hours"), wi = Yn("days"), Ti = Yn("months"), bi = Yn("years"), Si = Math.round, Hi = {
                ss: 44,
                s: 45,
                m: 45,
                h: 22,
            ...
            return xi.isValid = Ot, xi.abs = dn, xi.add = _n, xi.subtract = un, xi.as = Mn, 
            xi.asMilliseconds = hi, xi.asSeconds = ci, xi.asMinutes = Mi, xi.asHours = fi, xi.asDays = pi, 
            xi.asWeeks = yi, xi.asMonths = Li, xi.asYears = Yi, xi.valueOf = fn, xi._bubble = mn, 
            xi.clone = yn, xi.get = Ln, xi.milliseconds = gi, xi.seconds = Di, xi.minutes = ki, 
            xi.hours = vi, xi.days = wi, xi.weeks = gn, xi.months = Ti, xi.years = bi, xi.humanize = Tn, 
            xi.toISOString = Sn, xi.toString = Sn, xi.toJSON = Sn, xi.locale = ka, xi.localeData = va, 
            ...
            Q("X", function(e, t, a) {
                ...
                a._d = new Date(D(e));
            }), t.version = "2.19.2", n(bt), t.fn = ui, t.min = Ht, t.max = jt, t.now = Zs, 
            t.utc = h, t.unix = Ka, t.months = tn, t.isDate = _, t.locale = tt, t.invalid = p, 
            t.duration = Qt, t.isMoment = Y, t.weekdays = nn, t.parseZone = qa, t.localeData = st, 
            t.isDuration = Et, t.monthsShort = an, t.weekdaysMin = rn, t.defineLocale = at, 
            t.updateLocale = nt, t.locales = it, t.weekdaysShort = sn, t.normalizeUnits = A, 
    ...
    }, n.resolve = s, e.exports = n, n.id = 13;
}, function(e, t, a) {
    !function(e, t) {
        t(a(11));
    }(this, function(e) {
    ...
    !function(e, t) {
        ...
        }, r = [ "كانون الثاني يناير", "شباط فبراير", "آذار مارس", "نيسان أبريل", "أيار مايو", "حزيران يونيو", "تموز يوليو", "آب أغسطس", "أيلول سبتمبر", "تشرين الأول أكتوبر", "تشرين الثاني نوفمبر", "كانون الأول ديسمبر" ], d = e.defineLocale("ar", {
            months: r,
            monthsShort: r,
    ...
    !function() {
        ...
        function o(e, t, a) {
            ...
            var l = t.cancel || t.close, m = !1, h = e.find(".form-control").add(".btn", e);
            return l && (h = h.not("[data-dismiss]").not(".btn-cancel")), h.each(function() {
                var e = p(this);
        ...
        function _(t) {
            ...
            return t = t.find(".btn-onoff-ct").andSelf().filter(".btn-onoff-ct"), t.each(function(t, n) {
        ...
        function M(e) {
            p(e).attr("unselectable", "on"), Object.defineProperty(e, "value", {
                ...
                set: function(t) {
                    var a = String(t);
                    a != this.getAttribute("value") && (this.setAttribute("value", t), h(e), c(e));
                }
            ...
            }), h(e), c(e), p(e).on("change", function() {
                h(e), p(e).toggleClass("slider-disabled", e.disabled);
                ...
                p(e).trigger("change", [ e.value ]), c(e);
        ...
        p.fn.dialog = function(e) {
        ...
        }, p(document).ready(f), p.fn.update_privileged = function(e, t, a) {
            var n = e.allowed !== !1, s = this;
            return s.each(function() {
                ...
                a && (s.placement = a), p(this).tooltip(s), p(this).hasClass("disabled") === n && (p(this).toggleClass("disabled", !n).attr("data-original-title", null), 
                n ? p(this).attr("title", p(this).data(e)) : p(this).attr("title", t), p(this).tooltip("fixTitle"));
            }), s;
        };
    }();
}, function(e, t) {
    ...
    !function(e, t) {
        ...
        var o = function() {
            var t = {
                ...
                contains: function(e) {
                    for (var t = e && e.valueOf(), a = 0, n = this.length; a < n; a++) if (this[a].valueOf() === t) return a;
                    return -1;
                },
                remove: function(e) {
                    this.splice(e, 1);
            ...
            this._process_options(a), this.dates = new o(), this.viewDate = this.o.defaultViewDate, 
            ...
            this.picker = e(f.template), this._buildEvents(), this._attachEvents(), this.isInline ? this.picker.addClass("datepicker-inline").appendTo(this.element) : this.picker.addClass("datepicker-dropdown dropdown-menu"), 
        ...
        _.prototype = {
            ...
            _process_options: function(s) {
                ...
                switch (M[r] || (r = r.split("-")[0], M[r] || (r = h.language)), i.language = r, 
                i.startView) {
                  case 2:
                  case "decade":
                    i.startView = 2;
                ...
                var d = f.parseFormat(i.format);
                if (i.startDate !== -(1 / 0) && (i.startDate ? i.startDate instanceof Date ? i.startDate = this._local_to_utc(this._zero_time(i.startDate)) : i.startDate = f.parseDate(i.startDate, d, i.language) : i.startDate = -(1 / 0)), 
                i.endDate !== 1 / 0 && (i.endDate ? i.endDate instanceof Date ? i.endDate = this._local_to_utc(this._zero_time(i.endDate)) : i.endDate = f.parseDate(i.endDate, d, i.language) : i.endDate = 1 / 0), 
                ...
                i.daysOfWeekDisabled = e.map(i.daysOfWeekDisabled, function(e) {
                    ...
                    var o = [];
                    o.push(f.parseDate(i.datesDisabled, d, i.language)), i.datesDisabled = o;
                }
                i.datesDisabled = e.map(i.datesDisabled, function(e) {
                    return f.parseDate(e, d, i.language);
                });
                var _ = String(i.orientation).toLowerCase().split(/\s+/g), u = i.orientation.toLowerCase();
                if (_ = e.grep(_, function(e) {
                    return /^auto|left|right|top|bottom$/.test(e);
                }), i.orientation = {
                    x: "auto",
                    y: "auto"
                }, u && "auto" !== u) if (1 === _.length) switch (_[0]) {
                  case "top":
                  case "bottom":
                    i.orientation.y = _[0];
                    break;
                  ...
                  case "right":
                    i.orientation.x = _[0];
                } else u = e.grep(_, function(e) {
                    return /^left|right$/.test(e);
                }), i.orientation.x = u[0] || "auto", u = e.grep(_, function(e) {
                    return /^top|bottom$/.test(e);
                }), i.orientation.y = u[0] || "auto"; else ;
                if (i.defaultViewDate) {
                    var l = i.defaultViewDate.year || new Date().getFullYear(), m = i.defaultViewDate.month || 0, c = i.defaultViewDate.day || 1;
                    i.defaultViewDate = a(l, m, c);
            ...
            _trigger: function(t, a) {
                ...
                this.element.trigger({
                    ...
                    format: e.proxy(function(e, t) {
                        ...
                        return f.formatDate(a, t, this.o.language);
                    }, this)
                });
            },
            show: function() {
            ...
            place: function() {
                ...
                var t = this.picker.outerWidth(), a = this.picker.outerHeight(), n = 10, s = e(this.o.container).width(), i = e(this.o.container).height(), r = e(this.o.container).scrollTop(), d = e(this.o.container).offset(), o = [];
                this.element.parents().each(function() {
                    var t = e(this).css("z-index");
                    "auto" !== t && 0 !== t && o.push(parseInt(t));
                });
                var _ = Math.max.apply(Math, o) + 10, u = this.component ? this.component.parent().offset() : this.element.offset(), l = this.component ? this.component.outerHeight(!0) : this.element.outerHeight(!1), m = this.component ? this.component.outerWidth(!0) : this.element.outerWidth(!1), h = u.left - d.left, c = u.top - d.top;
                this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left"), 
                "auto" !== this.o.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.o.orientation.x), 
                "right" === this.o.orientation.x && (h -= t - m)) : u.left < 0 ? (this.picker.addClass("datepicker-orient-left"), 
                h -= u.left - n) : h + t > s ? (this.picker.addClass("datepicker-orient-right"), 
                h = u.left + m - t) : this.picker.addClass("datepicker-orient-left");
                var M, f, p = this.o.orientation.y;
                if ("auto" === p && (M = -r + c - a, f = r + i - (c + l + a), p = Math.max(M, f) === f ? "top" : "bottom"), 
                this.picker.addClass("datepicker-orient-" + p), "top" === p ? c += l : c -= a + parseInt(this.picker.css("padding-top")), 
                this.o.rtl) {
                    var y = s - (h + m);
                    this.picker.css({
                        top: c,
            ...
            update: function() {
                ...
                }, this)), n = !0) : (a = this.isInput ? this.element.val() : this.element.data("date") || this.element.find("input").val(), 
                ...
                }, this), !0), this.dates.replace(a), this.dates.length ? this.viewDate = new Date(this.dates.get(-1)) : this.viewDate < this.o.startDate ? this.viewDate = new Date(this.o.startDate) : this.viewDate > this.o.endDate && (this.viewDate = new Date(this.o.endDate)), 
                n ? this.setValue() : a.length && String(t) !== String(this.dates) && this._trigger("changeDate"), 
            ...
            fillMonths: function() {
                for (var e = "", t = 0; t < 12; ) e += '<span class="month">' + M[this.o.language].monthsShort[t++] + "</span>";
            ...
            getClassNames: function(t) {
                var a = [], n = this.viewDate.getUTCFullYear(), i = this.viewDate.getUTCMonth(), r = new Date();
                return t.getUTCFullYear() < n || t.getUTCFullYear() === n && t.getUTCMonth() < i ? a.push("old") : (t.getUTCFullYear() > n || t.getUTCFullYear() === n && t.getUTCMonth() > i) && a.push("new"), 
                this.focusDate && t.valueOf() === this.focusDate.valueOf() && a.push("focused"), 
                this.o.todayHighlight && t.getUTCFullYear() === r.getFullYear() && t.getUTCMonth() === r.getMonth() && t.getUTCDate() === r.getDate() && a.push("today"), 
                this.dates.contains(t) !== -1 && a.push("active"), (t.valueOf() < this.o.startDate || t.valueOf() > this.o.endDate || e.inArray(t.getUTCDay(), this.o.daysOfWeekDisabled) !== -1) && a.push("disabled"), 
                this.o.datesDisabled.length > 0 && e.grep(this.o.datesDisabled, function(e) {
                    return s(t, e);
                }).length > 0 && a.push("disabled", "disabled-date"), this.range && (t > this.range[0] && t < this.range[this.range.length - 1] && a.push("range"), 
                e.inArray(t.valueOf(), this.range) !== -1 && a.push("selected")), a;
            },
            fill: function() {
                var n, s = new Date(this.viewDate), i = s.getUTCFullYear(), r = s.getUTCMonth(), d = this.o.startDate !== -(1 / 0) ? this.o.startDate.getUTCFullYear() : -(1 / 0), o = this.o.startDate !== -(1 / 0) ? this.o.startDate.getUTCMonth() : -(1 / 0), _ = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCFullYear() : 1 / 0, u = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCMonth() : 1 / 0, l = M[this.o.language].today || M.en.today || "", m = M[this.o.language].clear || M.en.clear || "";
                if (!isNaN(i) && !isNaN(r)) {
                    this.picker.find(".datepicker-days thead .datepicker-switch").text(M[this.o.language].months[r] + " " + i), 
                    ...
                    var h = a(i, r - 1, 28), c = f.getDaysInMonth(h.getUTCFullYear(), h.getUTCMonth());
                    h.setUTCDate(c), h.setUTCDate(c - (h.getUTCDay() - this.o.weekStart + 7) % 7);
                    var p = new Date(h);
                    p.setUTCDate(p.getUTCDate() + 42), p = p.valueOf();
                    for (var y, L = []; h.valueOf() < p; ) {
                        if (h.getUTCDay() === this.o.weekStart && (L.push("<tr>"), this.o.calendarWeeks)) {
                            var Y = new Date(+h + (this.o.weekStart - h.getUTCDay() - 7) % 7 * 864e5), g = new Date(Number(Y) + (11 - Y.getUTCDay()) % 7 * 864e5), D = new Date(Number(D = a(g.getUTCFullYear(), 0, 1)) + (11 - D.getUTCDay()) % 7 * 864e5), k = (g - D) / 864e5 / 7 + 1;
                            L.push('<td class="cw">' + k + "</td>");
                        }
                        if (y = this.getClassNames(h), y.push("day"), this.o.beforeShowDay !== e.noop) {
                            var v = this.o.beforeShowDay(this._utc_to_local(h));
                            v === t ? v = {} : "boolean" == typeof v ? v = {
                                enabled: v
                            } : "string" == typeof v && (v = {
                                classes: v
                            }), v.enabled === !1 && y.push("disabled"), v.classes && (y = y.concat(v.classes.split(/\s+/))), 
                            v.tooltip && (n = v.tooltip);
                        }
                        y = e.unique(y), L.push('<td class="' + y.join(" ") + '"' + (n ? ' title="' + n + '"' : "") + ">" + h.getUTCDate() + "</td>"), 
                        n = null, h.getUTCDay() === this.o.weekEnd && L.push("</tr>"), h.setUTCDate(h.getUTCDate() + 1);
                    }
                    ...
                    }), (i < d || i > _) && w.addClass("disabled"), i === d && w.slice(0, o).addClass("disabled"), 
                    i === _ && w.slice(u + 1).addClass("disabled"), this.o.beforeShowMonth !== e.noop) {
                        var T = this;
                        e.each(w, function(t, a) {
                            if (!e(a).hasClass("disabled")) {
                                var n = new Date(i, t, 1), s = T.o.beforeShowMonth(n);
                                s === !1 && e(a).addClass("disabled");
                            }
                        });
                    }
                    ...
                    e.inArray(i, H) !== -1 && S.push("active"), (i < d || i > _) && S.push("disabled"), 
            ...
            updateNavArrows: function() {
                if (this._allow_update) {
                    var e = new Date(this.viewDate), t = e.getUTCFullYear(), a = e.getUTCMonth();
                    switch (this.viewMode) {
                      case 0:
                        this.o.startDate !== -(1 / 0) && t <= this.o.startDate.getUTCFullYear() && a <= this.o.startDate.getUTCMonth() ? this.picker.find(".prev").css({
                            visibility: "hidden"
                        }) : this.picker.find(".prev").css({
                            visibility: "visible"
                        }), this.o.endDate !== 1 / 0 && t >= this.o.endDate.getUTCFullYear() && a >= this.o.endDate.getUTCMonth() ? this.picker.find(".next").css({
                            visibility: "hidden"
            ...
            click: function(t) {
                t.preventDefault();
                var n, s, i, r = e(t.target).closest("span, td, th");
                if (1 === r.length) switch (r[0].nodeName.toLowerCase()) {
                  case "th":
                    switch (r[0].className) {
                      ...
                      case "prev":
                      case "next":
                        var d = f.modes[this.viewMode].navStep * ("prev" === r[0].className ? -1 : 1);
                        switch (this.viewMode) {
                          case 0:
                            this.viewDate = this.moveMonth(this.viewDate, d), this._trigger("changeMonth", this.viewDate);
                            break;

                          case 1:
                          case 2:
                            this.viewDate = this.moveYear(this.viewDate, d), 1 === this.viewMode && this._trigger("changeYear", this.viewDate);
                        }
                        this.fill();
                        break;
                      ...
                      case "today":
                        ...
                        var _ = "linked" === this.o.todayBtn ? null : "view";
                        this._setDate(o, _);
                        break;
                  ...
                  case "span":
                    ...
                    s = r.parent().find("span").index(r), n = this.viewDate.getUTCFullYear(), this.viewDate.setUTCMonth(s), 
                    this._trigger("changeMonth", this.viewDate), 1 === this.o.minViewMode && this._setDate(a(n, s, i))) : (i = 1, 
                    s = 0, n = parseInt(r.text(), 10) || 0, this.viewDate.setUTCFullYear(n), this._trigger("changeYear", this.viewDate), 
                    2 === this.o.minViewMode && this._setDate(a(n, s, i))), this.showMode(-1), this.fill());
                    break;

                  case "td":
                    r.hasClass("day") && !r.hasClass("disabled") && (i = parseInt(r.text(), 10) || 1, 
                    n = this.viewDate.getUTCFullYear(), s = this.viewDate.getUTCMonth(), r.hasClass("old") ? 0 === s ? (s = 11, 
                    n -= 1) : s -= 1 : r.hasClass("new") && (11 === s ? (s = 0, n += 1) : s += 1), this._setDate(a(n, s, i)));
                }
            ...
            _setDate: function(e, t) {
                ...
                a && a.change(), !this.o.autoclose || t && "date" !== t || this.hide();
            },
            moveMonth: function(e, a) {
                if (!e) return t;
                if (!a) return e;
                var n, s, i = new Date(e.valueOf()), r = i.getUTCDate(), d = i.getUTCMonth(), o = Math.abs(a);
                if (a = a > 0 ? 1 : -1, 1 === o) s = a === -1 ? function() {
                    return i.getUTCMonth() === d;
                } : function() {
                    return i.getUTCMonth() !== n;
                }, n = d + a, i.setUTCMonth(n), (n < 0 || n > 11) && (n = (n + 12) % 12); else {
                    for (var _ = 0; _ < o; _++) i = this.moveMonth(i, a);
                    n = i.getUTCMonth(), i.setUTCDate(r), s = function() {
                        return n !== i.getUTCMonth();
                    };
                }
                for (;s(); ) i.setUTCDate(--r), i.setUTCMonth(n);
                return i;
            },
            ...
            keydown: function(e) {
                ...
                var t, a, s, i = !1, r = this.focusDate || this.viewDate;
                switch (e.keyCode) {
                  case 27:
                  ...
                  case 39:
                    ...
                    t = 37 === e.keyCode ? -1 : 1, e.ctrlKey ? (a = this.moveYear(this.dates.get(-1) || n(), t), 
                    s = this.moveYear(r, t), this._trigger("changeYear", this.viewDate)) : e.shiftKey ? (a = this.moveMonth(this.dates.get(-1) || n(), t), 
                    s = this.moveMonth(r, t), this._trigger("changeMonth", this.viewDate)) : (a = new Date(this.dates.get(-1) || n()), 
                    a.setUTCDate(a.getUTCDate() + t), s = new Date(r), s.setUTCDate(r.getUTCDate() + t)), 
                  ...
                  case 40:
                    if (!this.o.keyboardNavigation) break;
                    t = 38 === e.keyCode ? -1 : 1, e.ctrlKey ? (a = this.moveYear(this.dates.get(-1) || n(), t), 
                    s = this.moveYear(r, t), this._trigger("changeYear", this.viewDate)) : e.shiftKey ? (a = this.moveMonth(this.dates.get(-1) || n(), t), 
                    s = this.moveMonth(r, t), this._trigger("changeMonth", this.viewDate)) : (a = new Date(this.dates.get(-1) || n()), 
                    a.setUTCDate(a.getUTCDate() + 7 * t), s = new Date(r), s.setUTCDate(r.getUTCDate() + 7 * t)), 
                    this.dateWithinRange(s) && (this.focusDate = this.viewDate = s, this.setValue(), 
                    this.fill(), e.preventDefault());
                    break;
            ...
            showMode: function(e) {
                ...
                this.picker.children("div").hide().filter(".datepicker-" + f.modes[this.viewMode].clsName).css("display", "block"), 
                this.updateNavArrows();
            }
        };
        var u = function(t, a) {
            this.element = e(t), this.inputs = e.map(a.inputs, function(e) {
                return e.jquery ? e[0] : e;
            }), delete a.inputs, m.call(e(this.inputs), a).bind("changeDate", e.proxy(this.dateUpdated, this)), 
        ...
        u.prototype = {
            ...
            dateUpdated: function(t) {
                if (!this.updating) {
                    this.updating = !0;
                    var a = e(t.target).data("datepicker"), n = a.getUTCDate(), s = e.inArray(t.target, this.inputs), i = s - 1, r = s + 1, d = this.inputs.length;
                    if (s !== -1) {
                        if (e.each(this.pickers, function(e, t) {
                            t.getUTCDate() || t.setUTCDate(n);
                        }), n < this.dates[i]) for (;i >= 0 && n < this.dates[i]; ) this.pickers[i--].setUTCDate(n); else if (n > this.dates[r]) for (;r < d && n > this.dates[r]; ) this.pickers[r++].setUTCDate(n);
        ...
        var l = e.fn.datepicker, m = function(a) {
            var n = Array.apply(null, arguments);
            n.shift();
            var s;
            return this.each(function() {
                var i = e(this), o = i.data("datepicker"), l = "object" == typeof a && a;
                if (!o) {
                    var m = r(this, "date"), c = e.extend({}, h, m, l), M = d(c.language), f = e.extend({}, h, M, m, l);
                    if (i.hasClass("input-daterange") || f.inputs) {
                        var p = {
                            inputs: f.inputs || i.find("input").toArray()
                        };
                        i.data("datepicker", o = new u(this, e.extend(f, p)));
                    } else i.data("datepicker", o = new _(this, f));
                }
                if ("string" == typeof a && "function" == typeof o[a] && (s = o[a].apply(o, n), 
                s !== t)) return !1;
            }), s !== t ? s : this;
        };
        e.fn.datepicker = m;
        var h = e.fn.datepicker.defaults = {
            ...
            enableOnReadonly: !0,
            container: "body"
        }, c = e.fn.datepicker.locale_opts = [ "format", "rtl", "weekStart" ];
        ...
        var M = e.fn.datepicker.dates = {
            ...
            parseDate: function(n, s, i) {
                function r() {
                    var e = this.slice(0, m[u].length), t = m[u].slice(0, e.length);
                    return e.toLowerCase() === t.toLowerCase();
                }
                if (!n) return t;
                if (n instanceof Date) return n;
                "string" == typeof s && (s = f.parseFormat(s));
                var d, o, u, l = /([\-+]\d+)([dmwy])/, m = n.match(/([\-+]\d+)([dmwy])/g);
                if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(n)) {
                    for (n = new Date(), u = 0; u < m.length; u++) switch (d = l.exec(m[u]), o = parseInt(d[1]), 
                    d[2]) {
                      case "d":
                      ...
                      case "m":
                        n = _.prototype.moveMonth.call(_.prototype, n, o);
                        break;
                      ...
                      case "y":
                        n = _.prototype.moveYear.call(_.prototype, n, o);
                    }
                    return a(n.getUTCFullYear(), n.getUTCMonth(), n.getUTCDate(), 0, 0, 0);
                }
                m = n && n.match(this.nonpunctuation) || [], n = new Date();
                var h, c, p = {}, y = [ "yyyy", "yy", "M", "MM", "m", "mm", "d", "dd" ], L = {
                    yyyy: function(e, t) {
                ...
                L.M = L.MM = L.mm = L.m, L.dd = L.d, n = a(n.getFullYear(), n.getMonth(), n.getDate(), 0, 0, 0);
                var Y = s.parts.slice();
                if (m.length !== Y.length && (Y = e(Y).filter(function(t, a) {
                    return e.inArray(a, y) !== -1;
                }).toArray()), m.length === Y.length) {
                    var g;
                    for (u = 0, g = Y.length; u < g; u++) {
                        if (h = parseInt(m[u], 10), d = Y[u], isNaN(h)) switch (d) {
                          case "MM":
                            c = e(M[i].months).filter(r), h = e.inArray(c[0], M[i].months) + 1;
                            break;

                          case "M":
                            c = e(M[i].monthsShort).filter(r), h = e.inArray(c[0], M[i].monthsShort) + 1;
                        }
                        p[d] = h;
                    }
                    var D, k;
                    for (u = 0; u < y.length; u++) k = y[u], k in p && !isNaN(p[k]) && (D = new Date(n), 
                    L[k](D, p[k]), isNaN(D) || (n = D));
                }
                return n;
            },
            formatDate: function(t, a, n) {
                if (!t) return "";
                "string" == typeof a && (a = f.parseFormat(a));
                var s = {
                    d: t.getUTCDate(),
        ...
        e.fn.datepicker.DPGlobal = f, e.fn.datepicker.noConflict = function() {
            ...
            var a = e(this);
            a.data("datepicker") || (t.preventDefault(), m.call(a, "show"));
        }), e(function() {
