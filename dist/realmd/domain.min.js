!function(e) {
    ...
    (function(e) {
        ...
        !function() {
            function a(e, a, r, m) {
                function f(e) {
                    H = e.attr("data-value"), A(".realms-op-auth span").text(e.text());
                    var a = (H || "").split("/"), t = a[0], r = a[1];
                ...
                function v(a) {
                    ...
                    t.always(function() {
                        ...
                        t.reject(o));
                        var d;
                        arguments[0][1] && (i = arguments[0][1]), l = i[0], l ? (P = e.proxy(p, l), A(P).on("changed", b), 
                        ...
                        r = null, P = null, S = null, t.reject(new Error(d))), b();
                    }), D = t.promise(), $ = a, D;
                }
                function h() {
                    if ("join" != a) {
                    ...
                    return A(".realms-op-address").val() === $ && D ? D : v();
                }
                function g(e, a) {
                    var t = null;
                ...
                function b() {
                    ...
                    if (r && P && !P.valid ? (t = n.format(s("Domain $0 is not supported"), r.Name), 
                    ...
                    N ? m.attr("disabled", "disabled") : m.removeAttr("disabled"), "join" == a) {
                        ...
                        var l = "";
                        P && P.SuggestedAdministrator && (l = n.format(s('e.g. "$0"'), P.SuggestedAdministrator)), 
                        A(".realms-op-admin")[0].placeholder = l;
                        var i = A(".realms-op-auth .dropdown-menu"), d = P && P.SupportedJoinCredentials || [];
                ...
                function y() {
                    ...
                    if ("password/administrator" !== H) return console.log("Installing kerberos keytab and SSL certificate not supported for auth mode", H), 
                    n.resolve();
                ...
                function x() {
                    var t = "cockpit-" + R;
                    R += 1, T(t), A(".realms-op-error").hide(), h().fail(function() {
                        T(null);
                    }).done(function(r) {
                        var o = {
                        ...
                        P.valid ? l = P.call("Join", [ w(), o ]).then(y) : (T(null), A(".realms-op-message").empty().text(s("Joining this domain is not supported")), 
                        A(".realms-op-error").show())) : "leave" == a && (l = k().then(function() {
                            r.Deconfigure(o);
                        })), l ? void l.fail(function(e) {
                            T(null), "org.freedesktop.realmd.Error.Cancelled" == e.name ? A(C).modal("hide") : (console.log("Failed to " + a + " domain: " + r.Name + ": " + e), 
                ...
                function j() {
                    return !!N && (e.call(l, i, "Cancel", [ N ]), T(null), !0);
                }
                var C = o.parseHTML(t(6))[0], A = function(e, a) {
                    return new o.fn.init(e, a || C);
                };
                A.fn = A.prototype = o.fn, o.extend(A, o);
                var N = null, D = null, $ = null, P = null, S = null;
                A(".realms-op-cancel").on("click", function() {
                    j() || A(C).modal("hide");
                }), A(C).on("hide.bs.modal", function() {
                    j();
                }), A(".realms-op-apply").on("click", x), A(".realms-op-field").on("keydown", function(e) {
                    13 == e.which && x();
                }), A(C).on("click", ".realms-op-more-diagnostics", function() {
                ...
                var E, J, L;
                "join" == a ? (E = s("page-title", s("Join a Domain")), J = s("Join"), A(".realms-op-join-only-row").show(), 
                A(".realms-op-leave-only-row").hide(), v("")) : (E = s("page-title", s("Leave Domain")), 
                J = s("Leave"), L = s("Are you sure you want to leave this domain?"), r && r.Name && (L = n.format(s("Are you sure you want to leave the '$0' domain?"), r.Name)), 
                ...
                A(".realms-op-title").text(E), A(".realms-op-apply").text(J), A(".realms-op-field").val("");
                var R = 1;
                return b(), C;
            }
            function r() {
