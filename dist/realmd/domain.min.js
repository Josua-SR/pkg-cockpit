!function(e) {
        ...
        !function() {
            function a(e, a, o, m) {
                function u(e) {
                    ...
                    var a = (P || "").split("/"), t = a[0], o = a[1];
                    j(".realms-op-admin-row").hide(), j(".realms-op-admin-password-row").hide(), j(".realms-op-user-row").hide(), 
                    j(".realms-op-user-password-row").hide(), j(".realms-op-otp-row").hide(), "password" == t && "administrator" == o ? (j(".realms-op-admin-row").show(), 
                    j(".realms-op-admin-password-row").show()) : "password" == t && "user" == o ? (j(".realms-op-user-row").show(), 
                ...
                function f(a) {
                    ...
                    t.always(function() {
                        ...
                        var r, l, i = [];
                        "rejected" == this.state() && (r = arguments[0], j(".realms-op-message").empty().text(r.message), 
                        t.reject(r));
                        var d;
                        arguments[0][1] && (i = arguments[0][1]), l = i[0], l ? (D = e.proxy(c, l), j(D).on("changed", g), 
                        o = e.proxy(p, l), j(o).on("changed", g), o.wait(function() {
                            t.resolve(o);
                        })) : (a && (d = n.format(s("Domain $0 could not be contacted"), a), j(".realms-op-address-error").show().attr("title", d)), 
                        o = null, D = null, t.reject(new Error(d))), g();
                    }), A = t.promise(), T = a, A;
                }
                function v() {
                    if ("join" != a) {
                        var e = j.Deferred();
                        return e.resolve(o), e.promise();
                    }
                ...
                function g() {
                    function e(e, a, t) {
                        var o, r, n, s = d.length;
                        for (n = 0; n < s; n++) if ((!e || e == d[n][1]) && a == d[n][0]) {
                            r = a + "/" + d[n][1], o = j("<li>").attr("data-value", r).append(j("<a>").text(t)), 
                            i.append(o), c && (u(o), c = !1), p += 1;
                            break;
                        }
                    }
                    var t;
                    ...
                    var r = h(o, "server-software");
                    if (o && D && !D.valid ? (t = n.format(s("Domain $0 is not supported"), o.Name), 
                    j(".realms-op-address-spinner").hide(), j(".realms-op-address-error").show().attr("title", t)) : j(".realms-op-address-error").hide(), 
                    C ? m.attr("disabled", "disabled") : m.removeAttr("disabled"), "join" == a) {
                        j(".realm-active-directory-only").toggle(!r || "active-directory" == r), o && o.Name && !j(".realms-op-address")[0].placeholder && (j(".realms-op-address")[0].placeholder = n.format(s('e.g. "$0"'), o.Name));
                        var l = "";
                ...
                function w() {
                    var e, a, t = (P || "").split("/"), o = t[0], r = t[1];
                    return "user" == r && "password" == o ? e = [ o, r, n.variant("(ss)", [ j(".realms-op-user").val(), j(".realms-op-user-password").val() ]) ] : "administrator" == r && "password" == o ? e = [ o, r, n.variant("(ss)", [ j(".realms-op-admin").val(), j(".realms-op-admin-password").val() ]) ] : "secret" == o ? (a = j(".realms-op-ot-password").val(), 
                    e = [ o, r, n.variant("ay", n.utf8_encoder().encode(a)) ]) : e = [ "automatic", r, n.variant("s", "") ], 
                    e;
                }
                function b() {
                    var t = "cockpit-" + E;
                    E += 1, y(t), j(".realms-op-error").hide(), v().fail(function() {
                        y(null);
                    }).done(function(o) {
                        var r = {
                            operation: n.variant("s", t)
                        };
                        j(".realms-op-message").empty(), j(".realms-op-diagnostics").empty().hide();
                        var l, i, d = "", c = e.subscribe({
                            member: "Diagnostics"
                        }, function(e, a, o, r) {
                            r[1] === t && (d += r[0]);
                        });
                        return "join" == a ? (i = j(".realms-join-computer-ou").val(), i && (r["computer-ou"] = n.variant("s", i)), 
                        D.valid ? l = D.call("Join", [ w(), r ]) : (y(null), j(".realms-op-message").empty().text(s("Joining this domain is not supported")), 
                        j(".realms-op-error").show())) : "leave" == a && (l = o.Deconfigure(r)), l ? void l.fail(function(e) {
                            y(null), "org.freedesktop.realmd.Error.Cancelled" == e.name ? j(k).modal("hide") : (console.log("Failed to join domain: " + o.Name + ": " + e), 
                            j(".realms-op-message").empty().text(e + " "), j(".realms-op-error").show(), d && (j(".realms-op-message").append('<a class="realms-op-more-diagnostics">' + s("More") + "</a>"), 
                ...
                var k = r.parseHTML(t(6))[0], j = function(e, a) {
                    return new r.fn.init(e, a || k);
                };
                j.fn = j.prototype = r.fn, r.extend(j, r);
                var C = null, A = null, T = null, D = null;
                j(".realms-op-cancel").on("click", function() {
                    x() || j(k).modal("hide");
                }), j(k).on("hide.bs.modal", function() {
                    x();
                }), j(".realms-op-apply").on("click", b), j(".realms-op-field").on("keydown", function(e) {
                    13 == e.which && b();
                ...
                j(".realms-op-leave-only-row").hide(), f("")) : (O = s("page-title", s("Leave Domain")), 
                S = s("Leave"), $ = s("Are you sure you want to leave this domain?"), o && o.Name && ($ = n.format(s("Are you sure you want to leave the '$0' domain?"), o.Name)), 
                $ = n.format(s("$0 Only users with local credentials will be able to log into this machine. This may also effect other services as DNS resolution settings and the list of trusted CAs may change."), $), 
                j(".realms-op-leave-only-row").text($), j(".realms-op-join-only-row").hide(), j(".realms-op-leave-only-row").show()), 
            ...
            function o() {
                function e() {
                    ...
                    e = c && c.length ? c.map(function(e) {
                        return e.Name;
                    }).join(", ") : s("Join Domain"), o.text(e);
                }
                var t = r, o = t("<a>"), i = n.dbus("org.freedesktop.realmd");
                i.watch(l);
                ...
                t(i).on("close", function(e, a) {
                    ...
                    o.addClass("disabled").attr("title", t).tooltip({
                        container: "body"
                    }).tooltip("fixTitle"), i = null;
                }), d.wait(function() {
                    function e() {
                        t(o).update_privileged(p, n.format(s("The user <b>$0</b> is not permitted to modify realms"), p.user ? p.user.name : ""));
                    }
                    i && (p = n.permission({
                        admin: !0
                    }), t(p).on("changed", e));
                ...
                return o.on("click", function() {
                    m && t(m).remove(), m = c && c.length ? a(i, "leave", c[0], o) : a(i, "join", null, o), 
                    t(m).attr("id", "realms-op").appendTo("body").modal("show"), n.translate();
                }), o.close = function() {
                    m && m.cancel(), o.remove(), i && i.close(), p && p.close();
                }, o;
            }
            var r = t(3), n = t(4);
            t(5);
            ...
            return r(function() {
                var e = r("#system-info-domain");
                e.length && (e.find(".button-location").append(o()), e.removeAttr("hidden"));
            }), e;
        }();
    }).call(a, t(2)(e));
}, function(e, a) {
    ...
    !function() {
        ...
        function o(e, a) {
            ...
            t = e.next(), t.is(".bootstrap-select") && t.selectpicker && (t.remove(), o = t.selectpicker), 
            e.remove().appendTo(r), o && o.call(e));
            var n;
            a.message && (n = g("<div class='dialog-error help-block'>").text(a.message)), r.addClass("has-error").append(n), 
        ...
        function r(e, a) {
            var t = g("<div class='alert alert-danger dialog-error'>"), o = a.message || a.toString();
            t.text(o), g("<span class='fa fa-exclamation-triangle'>").prependTo(t), console.warn(o);
            var r = e.find(".modal-footer");
            r.length ? t.prependTo(r) : t.appendTo(e);
        }
        function n(e, t) {
            ...
            t.forEach(function(a) {
                var t;
                a && (t = e.find(a.target), t && t.length ? o(t, a) : r(e, a), n = !0);
        ...
        function i(e, a, t) {
            function o() {
                var t, o = e.data("dialog-wait");
                o && o.promise === a && (l(e), t = a.state(), m || "resolved" == t && o.handle ? e.modal("hide") : "rejected" == t && o.handle && n(e, [ arguments[0] ]));
            }
            function r(t) {
                var o = e.data("dialog-wait");
                o && o.promise === a && ("string" != typeof t && (t = ""), d.text(t));
            }
            ...
            var p = a.cancel || a.close, m = !1, u = e.find(".form-control").add(".btn", e);
            return p && (u = u.not("[data-dismiss]").not(".btn-cancel")), u.each(function() {
                var e = g(this);
                ...
                return m = !0, p && p.apply(a), !1;
            }), e.on("hide.bs.modal.dialog-wait", function() {
                l(e);
            }), a.always(o).progress(r), e;
        }
        function d(a) {
            var t = w.gettext || function(e) {
                return e;
            };
            return a = a.find(".btn-onoff-ct").addBack().filter(".btn-onoff-ct"), a.each(function(a, o) {
                var r, n, s, l = g(o).attr("data-toggle", "buttons").addClass("btn-group"), i = l.onoff("value"), d = l.find(".btn"), c = l.find("input").first().attr("name") || e();
                for (r = d.length; r < 2; r++) n = g('<input type="radio" autocomplete="off">'), 
                s = document.createTextNode(t(0 === r ? "On" : "Off")), l.append(g('<label class="btn">').append(n, s)), 
                d = null;
        ...
        function p(e, a) {
            return e.each(function(e, t) {
                var o = g(t).find(".btn");
                o.first().toggleClass("active", !!a).find("input").prop("checked", !!a), o.last().toggleClass("active", !a).find("input").prop("checked", !a);
            });
        }
        function m(e, a, t, o) {
            var r = 0;
            o > t ? r = 1 : o < 0 || isNaN(o) ? r = 0 : !isNaN(t) && t > 0 && o >= 0 && (r = o / t), 
            g(a).css("width", 100 * r + "%").next("div").css("margin-left", g(a).css("width")), 
            e.value = r;
        }
        function u(e) {
            m(e, g(e).children("div.slider-bar").first()[0], 1, e.value);
        }
        function f(e) {
        ...
        function v(e) {
            g(e).attr("unselectable", "on"), Object.defineProperty(e, "value", {
                ...
                set: function(a) {
                    var t = String(a);
                    t != this.getAttribute("value") && (this.setAttribute("value", a), u(e), f(e));
                }
            ...
            }), u(e), f(e), g(e).on("change", function() {
                u(e), g(e).toggleClass("slider-disabled", e.disabled);
            }), e.disabled && g(e).addClass("slider-disabled"), g(e).on("mousedown", function(a) {
                if (e.disabled) return !0;
                var t, o = g(e).offset().left;
                if (g(a.target).hasClass("slider-thumb")) {
                    var r = a.offsetX || a.clientX - g(a.target).offset().left;
                    o += r - g(a.target).outerWidth() / 2, t = g(a.target).parent()[0];
                } else t = g(e).children("div.slider-bar").first()[0], m(e, t, g(e).width(), a.pageX - o), 
                g(e).trigger("change", [ e.value ]), f(e);
                return g(document).on("mousemove.slider", function(a) {
                    return m(e, t, g(e).width(), a.pageX - o), g(e).trigger("change", [ e.value ]), 
                    f(e), !1;
        ...
        g.fn.dialog = function(e) {
            ...
            return r.each(function() {
                ...
                t && (r.placement = t), g(this).tooltip(r), g(this).hasClass("disabled") === o && (g(this).toggleClass("disabled", !o).attr("data-original-title", null), 
                o ? g(this).attr("title", g(this).data(e)) : g(this).attr("title", a), g(this).tooltip("fixTitle"));
            }), r;
        };
    }();
}, function(e, a) {
