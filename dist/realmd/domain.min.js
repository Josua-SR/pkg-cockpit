    ...
    (function(e) {
        ...
        !function() {
            function a(e, a, r, u) {
                ...
                function w() {
                    ...
                    E += 1, y(t), v().fail(function() {
                        ...
                        l ? void l.fail(function(e) {
                            y(null), "com.redhat.Cockpit.Error.Cancelled" != e.name && (console.log("Failed to join domain: " + r.Name + ": " + e), 
                ...
                function x() {
                    return !!C && (e.call(i, l, "Cancel", [ C ]), y(null), !0);
                }
                ...
                var O, S;
                "join" == a ? (O = s("page-title", "Join a Domain"), S = s("Join"), j(".realms-op-join-only-row").show(), 
                f("")) : (O = s("page-title", "Leave Domain"), S = s("Leave"), j(".realms-op-join-only-row").hide()), 
            ...
            function r() {
                ...
                return r.on("click", function() {
                    ...
                    t(u).attr("id", "realms-op").appendTo("body").modal("show");
                }), r.close = function() {
