        ...
        !function() {
            function a(e, a, o, u) {
                ...
                function f(a) {
                    ...
                    t.always(function() {
                        ...
                        var r, l, i = [];
                        "rejected" == this.state() && (r = arguments[0], j(".realms-op-error").empty().text(r.message), 
                        t.reject(r));
                        var d;
                ...
                function b() {
                    ...
                    E += 1, y(t), v().fail(function() {
                        ...
                        D.valid ? l = D.call("Join", [ w(), r ]) : (y(null), j(".realms-op-error").empty().text(s("Joining this domain is not supported")).show())) : "leave" == a && (l = o.Deconfigure(r)), 
            ...
            function o() {
                ...
                return o.on("click", function() {
                    u && t(u).remove(), u = c && c.length ? a(i, "leave", c[0], o) : a(i, "join", null, o), 
                    t(u).attr("id", "realms-op").appendTo("body").modal("show"), n.translate();
                }), o.close = function() {
                    u && u.cancel(), o.remove(), i && i.close(), p && p.close();
                }, o;
            }
            var r = t(3), n = t(4);
            t(5);
