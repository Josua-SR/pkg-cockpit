        ...
        !function() {
            ...
            function o() {
                ...
                t(d).on("close", function(e, a) {
                    ...
                    i.addClass("disabled"), o.attr("title", t).tooltip({
                        container: "body"
                    }).tooltip("fixTitle"), d = null;
                }), c.wait(function() {
                    function e() {
                        t(i).update_privileged(u, n.format(s("The user <b>$0</b> is not permitted to modify realms"), u.user ? u.user.name : ""), null, o);
                    }
                    d && (u = n.permission({
                        admin: !0
                    }), t(u).on("changed", e));
                ...
                return i.on("click", function() {
                    ...
                    m && m.cancel(), o.remove(), d && d.close(), u && u.close();
                }, o;
            }
            var r = t(3), n = t(4);
            t(5);
    ...
    !function() {
        ...
        function i(e, a, t) {
            function o() {
                ...
                o && o.promise === a && (l(e), t = a.state(), u || "resolved" == t && o.handle ? e.modal("hide") : "rejected" == t && o.handle && n(e, [ arguments[0] ]));
            }
            function r(t) {
        ...
        function v(e) {
            g(e).attr("unselectable", "on"), Object.defineProperty(e, "value", {
                ...
                } else t = g(e).children("div.slider-bar").first()[0], u(e, t, g(e).width(), a.pageX - o), 
                g(e).trigger("change", [ e.value ]), f(e);
                return g(document).on("mousemove.slider", function(a) {
                    return u(e, t, g(e).width(), a.pageX - o), g(e).trigger("change", [ e.value ]), 
                    f(e), !1;
        ...
        }, g(document).ready(h), g.fn.update_privileged = function(e, a, t, o) {
            var r = e.allowed !== !1, n = this;
            return o || (o = g(this)), n.each(function() {
                var e = "allowed-title";
                "undefined" != typeof g(this).data(e) && g(this).data(e) !== !1 || g(this).data(e, g(this).attr("title") || "");
                var n = {
                    html: !0
                };
                t && (n.placement = t), o.tooltip(n), g(this).hasClass("disabled") === r && (g(this).toggleClass("disabled", !r), 
                o.attr("data-original-title", null), r ? o.attr("title", g(this).data(e)) : o.attr("title", a), 
                o.tooltip("fixTitle"));
            }), n;
        };
    }();
